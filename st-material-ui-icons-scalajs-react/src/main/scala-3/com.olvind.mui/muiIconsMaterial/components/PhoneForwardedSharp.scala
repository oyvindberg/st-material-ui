...
object PhoneForwardedSharp {
  ...
  @JSImport("@mui/icons-material/PhoneForwardedSharp", JSImport.Default)
  @js.native
  val component: js.Object = js.native
  
  type Props = DefaultComponentPropsSvgIconTypeMapsvg
  
  implicit def make(companion: PhoneForwardedSharp.type): SharedBuilder_DefaultComponentPropsSvgIconTypeMapsvg1028217032[SVGSVGElement] = new SharedBuilder_DefaultComponentPropsSvgIconTypeMapsvg1028217032[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
