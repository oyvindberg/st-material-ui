...
object PanoramaWideAngleSelectRounded {
  
  @JSImport("@mui/icons-material/PanoramaWideAngleSelectRounded", JSImport.Default)
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: PanoramaWideAngleSelectRounded.type): SharedBuilder_DefaultComponentPropsSvgIconTypeMapsvg1028217032[SVGSVGElement] = new SharedBuilder_DefaultComponentPropsSvgIconTypeMapsvg1028217032[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
