...
object popoverPopoverMod {
  ...
  @JSImport("@mui/material/Popover/Popover", JSImport.Namespace)
  @js.native
  ...
  object PopoverActions {
    ...
    @scala.inline
    implicit class PopoverActionsMutableBuilder[Self <: PopoverActions] (val x: Self) extends AnyVal {
  ...
  object PopoverOrigin {
    ...
    @scala.inline
    implicit class PopoverOriginMutableBuilder[Self <: PopoverOrigin] (val x: Self) extends AnyVal {
      
      @scala.inline
      def setHorizontal(value: left | center | right | Double): Self = StObject.set(x, "horizontal", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setVertical(value: top | center | bottom | Double): Self = StObject.set(x, "vertical", value.asInstanceOf[js.Any])
    }
  }
  ...
  object PopoverPosition {
    ...
    @scala.inline
    implicit class PopoverPositionMutableBuilder[Self <: PopoverPosition] (val x: Self) extends AnyVal {
  ...
  /* Inlined parent @mui/material.@mui/material.InternalStandardProps<@mui/material.@mui/material/Modal.ModalProps<@mui/material.@mui/material/Modal/Modal.ModalTypeMap<'div', {}>['defaultComponent'], {}>, 'children'> */
  @js.native
  trait PopoverProps extends StObject {
    
    var BackdropComponent: js.UndefOr[ReactElement] = js.native
    
    var BackdropProps: js.UndefOr[PartialBackdropPropsdefaultComponent] = js.native
    
    /**
      * Props applied to the [`Paper`](/api/paper/) element.
      * @default {}
      */
    var PaperProps: js.UndefOr[PartialPaperPropsPaperTypeMapdivdefaultC] = js.native
    ...
    /**
      ...
      */
    var action: js.UndefOr[Ref[PopoverActions]] = js.native
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialPopoverClasses] = js.native
  ...
  object PopoverProps {
    ...
    @scala.inline
    def apply(open: Boolean): PopoverProps = {
    ...
    implicit class PopoverPropsMutableBuilder[Self <: PopoverProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAction(value: Ref[PopoverActions]): Self = StObject.set(x, "action", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setAnchorElFunction1(value: /* element */ org.scalajs.dom.Element => org.scalajs.dom.Element): Self = StObject.set(x, "anchorEl", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setBackdropProps(value: PartialBackdropPropsdefaultComponent): Self = StObject.set(x, "BackdropProps", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setClasses(value: PartialPopoverClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setContainerFunction0(value: () => org.scalajs.dom.Element | Null): Self = StObject.set(x, "container", js.Any.fromFunction0(value))
      ...
      @scala.inline
      def setOnClose(value: (/* event */ js.Object, /* reason */ backdropClick | escapeKeyDown) => Unit): Self = StObject.set(x, "onClose", js.Any.fromFunction2(value))
      ...
      @scala.inline
      def setPaperProps(value: PartialPaperPropsPaperTypeMapdivdefaultC): Self = StObject.set(x, "PaperProps", value.asInstanceOf[js.Any])
  ...
  */
  ...
  object PopoverReference {
    ...
    @scala.inline
    def anchorEl: com.olvind.mui.muiMaterial.muiMaterialStrings.anchorEl = "anchorEl".asInstanceOf[com.olvind.mui.muiMaterial.muiMaterialStrings.anchorEl]
    
    @scala.inline
    def anchorPosition: com.olvind.mui.muiMaterial.muiMaterialStrings.anchorPosition = "anchorPosition".asInstanceOf[com.olvind.mui.muiMaterial.muiMaterialStrings.anchorPosition]
    
    @scala.inline
    def none: com.olvind.mui.muiMaterial.muiMaterialStrings.none = "none".asInstanceOf[com.olvind.mui.muiMaterial.muiMaterialStrings.none]
  }
}
