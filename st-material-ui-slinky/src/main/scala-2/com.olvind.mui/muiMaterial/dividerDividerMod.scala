...
object dividerDividerMod extends Shortcut {
  ...
  object DividerTypeMap {
    ...
    @scala.inline
    def apply[P, D /* <: ReactElement */](defaultComponent: D, props: P with Absolute): DividerTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[DividerTypeMap[P, D]]
    }
    
    @scala.inline
    implicit class DividerTypeMapMutableBuilder[Self <: DividerTypeMap[_, _], P, D /* <: ReactElement */] (val x: Self with (DividerTypeMap[P, D])) extends AnyVal {
