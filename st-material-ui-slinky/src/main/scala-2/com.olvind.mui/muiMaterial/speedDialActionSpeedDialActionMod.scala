...
object speedDialActionSpeedDialActionMod {
  ...
  trait SpeedDialActionProps extends StObject {
    ...
    var onClose: js.UndefOr[
        js.Function1[/* event */ (SyntheticEvent[Event, org.scalajs.dom.Element]) | Event, Unit]
      ] = js.native
  ...
  object SpeedDialActionProps {
    ...
    implicit class SpeedDialActionPropsMutableBuilder[Self <: SpeedDialActionProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnClose(value: /* event */ (SyntheticEvent[Event, org.scalajs.dom.Element]) | Event => Unit): Self = StObject.set(x, "onClose", js.Any.fromFunction1(value))
