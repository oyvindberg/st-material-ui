...
object ratingRatingMod {
  ...
  trait RatingProps extends StObject {
    ...
    /**
      ...
      * }
      */
    var IconContainerComponent: js.UndefOr[ReactElement] = js.native
    ...
    /**
      ...
      */
    var emptyIcon: js.UndefOr[ReactElement] = js.native
  ...
  object RatingProps {
    ...
    implicit class RatingPropsMutableBuilder[Self <: RatingProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setEmptyIcon(value: ReactElement): Self = StObject.set(x, "emptyIcon", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setIconContainerComponent(value: ReactElement): Self = StObject.set(x, "IconContainerComponent", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setOnChangeActive(value: (/* event */ SyntheticEvent[Event, org.scalajs.dom.Element], /* value */ Double) => Unit): Self = StObject.set(x, "onChangeActive", js.Any.fromFunction2(value))
