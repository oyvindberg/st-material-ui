...
object formControlLabelFormControlLabelMod {
  ...
  trait FormControlLabelProps extends StObject {
    ...
    /**
      ...
      */
    var label: String | Double | ReactElement = js.native
  ...
  object FormControlLabelProps {
    ...
    @scala.inline
    def apply(control: ReactElement, label: String | Double | ReactElement): FormControlLabelProps = {
    ...
    implicit class FormControlLabelPropsMutableBuilder[Self <: FormControlLabelProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnChange(value: (/* event */ SyntheticEvent[Event, org.scalajs.dom.Element], /* checked */ Boolean) => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction2(value))
