...
object autocompleteAutocompleteMod {
  ...
  object AutocompleteProps {
    ...
    @scala.inline
    def apply[T, Multiple /* <: js.UndefOr[Boolean] */, DisableClearable /* <: js.UndefOr[Boolean] */, FreeSolo /* <: js.UndefOr[Boolean] */, ChipComponent /* <: ReactElement */](options: js.Array[T], renderInput: AutocompleteRenderInputParams => ReactElement): AutocompleteProps[T, Multiple, DisableClearable, FreeSolo, ChipComponent] = {
    ...
    @scala.inline
    implicit class AutocompletePropsMutableBuilder[Self <: AutocompleteProps[_, _, _, _, _], T, Multiple /* <: js.UndefOr[Boolean] */, DisableClearable /* <: js.UndefOr[Boolean] */, FreeSolo /* <: js.UndefOr[Boolean] */, ChipComponent /* <: ReactElement */] (val x: Self with (AutocompleteProps[T, Multiple, DisableClearable, FreeSolo, ChipComponent])) extends AnyVal {
      ...
      @scala.inline
      def setRenderTags(value: (/* value */ js.Array[T], /* getTagProps */ AutocompleteRenderGetTagProps) => ReactElement): Self = StObject.set(x, "renderTags", js.Any.fromFunction2(value))
