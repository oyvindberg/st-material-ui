...
object formHelperTextFormHelperTextMod extends Shortcut {
  ...
  object FormHelperTextTypeMap {
    ...
    @scala.inline
    def apply[P, D /* <: ReactElement */](defaultComponent: D, props: P with Filled): FormHelperTextTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[FormHelperTextTypeMap[P, D]]
    }
    
    @scala.inline
    implicit class FormHelperTextTypeMapMutableBuilder[Self <: FormHelperTextTypeMap[_, _], P, D /* <: ReactElement */] (val x: Self with (FormHelperTextTypeMap[P, D])) extends AnyVal {
