...
object tableTableMod extends Shortcut {
  ...
  object TableTypeMap {
    ...
    @scala.inline
    def apply[P, D /* <: ReactElement */](defaultComponent: D, props: P with Padding): TableTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[TableTypeMap[P, D]]
    }
    
    @scala.inline
    implicit class TableTypeMapMutableBuilder[Self <: TableTypeMap[_, _], P, D /* <: ReactElement */] (val x: Self with (TableTypeMap[P, D])) extends AnyVal {
