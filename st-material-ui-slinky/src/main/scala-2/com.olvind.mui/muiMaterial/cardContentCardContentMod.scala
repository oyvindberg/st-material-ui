...
object cardContentCardContentMod extends Shortcut {
  ...
  object CardContentTypeMap {
    ...
    @scala.inline
    def apply[P, D /* <: ReactElement */](defaultComponent: D, props: P with ChildrenClasses): CardContentTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[CardContentTypeMap[P, D]]
    }
    
    @scala.inline
    implicit class CardContentTypeMapMutableBuilder[Self <: CardContentTypeMap[_, _], P, D /* <: ReactElement */] (val x: Self with (CardContentTypeMap[P, D])) extends AnyVal {
