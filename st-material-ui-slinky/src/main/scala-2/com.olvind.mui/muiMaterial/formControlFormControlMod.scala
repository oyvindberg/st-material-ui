...
object formControlFormControlMod extends Shortcut {
  ...
  object FormControlTypeMap {
    ...
    @scala.inline
    def apply[P, D /* <: ReactElement */](defaultComponent: D, props: P with Error): FormControlTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[FormControlTypeMap[P, D]]
    }
    
    @scala.inline
    implicit class FormControlTypeMapMutableBuilder[Self <: FormControlTypeMap[_, _], P, D /* <: ReactElement */] (val x: Self with (FormControlTypeMap[P, D])) extends AnyVal {
