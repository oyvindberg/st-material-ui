...
object containerContainerMod extends Shortcut {
  ...
  object ContainerTypeMap {
    ...
    @scala.inline
    def apply[P, D /* <: ReactElement */](defaultComponent: D, props: P with DisableGutters): ContainerTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[ContainerTypeMap[P, D]]
    }
    
    @scala.inline
    implicit class ContainerTypeMapMutableBuilder[Self <: ContainerTypeMap[_, _], P, D /* <: ReactElement */] (val x: Self with (ContainerTypeMap[P, D])) extends AnyVal {
