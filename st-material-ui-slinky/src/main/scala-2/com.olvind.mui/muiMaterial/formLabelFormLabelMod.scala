...
object formLabelFormLabelMod extends Shortcut {
  ...
  object FormLabelTypeMap {
    ...
    @scala.inline
    def apply[P, D /* <: ReactElement */](defaultComponent: D, props: P with FormLabelBaseProps with Focused): FormLabelTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[FormLabelTypeMap[P, D]]
    }
    
    @scala.inline
    implicit class FormLabelTypeMapMutableBuilder[Self <: FormLabelTypeMap[_, _], P, D /* <: ReactElement */] (val x: Self with (FormLabelTypeMap[P, D])) extends AnyVal {
