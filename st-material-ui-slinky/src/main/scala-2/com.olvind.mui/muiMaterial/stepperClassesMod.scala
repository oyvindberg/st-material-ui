...
object stepperClassesMod {
  ...
  */
  ...
  object StepperClasses {
    ...
    @scala.inline
    def apply(alternativeLabel: String, horizontal: String, root: String, vertical: String): StepperClasses = {
    ...
    @scala.inline
    implicit class StepperClassesMutableBuilder[Self <: StepperClasses] (val x: Self) extends AnyVal {
