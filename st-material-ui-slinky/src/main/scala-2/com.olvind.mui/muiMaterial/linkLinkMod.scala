...
object linkLinkMod extends Shortcut {
  ...
  object LinkTypeMap {
    ...
    @scala.inline
    def apply[P, D /* <: ReactElement */](defaultComponent: D, props: P with DistributiveOmitLinkBasePropsclasses with TypographyClasses): LinkTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[LinkTypeMap[P, D]]
    }
    
    @scala.inline
    implicit class LinkTypeMapMutableBuilder[Self <: LinkTypeMap[_, _], P, D /* <: ReactElement */] (val x: Self with (LinkTypeMap[P, D])) extends AnyVal {
