...
object TextField {
  ...
  object FilledTextFieldProps {
    ...
    class Builder (val args: js.Array[Any])
      ...
      @scala.inline
      def inputRefFunction1(value: /* instance */ Any | Null => Unit): this.type = set("inputRef", js.Any.fromFunction1(value))
      
      @scala.inline
      def inputRefNull: this.type = set("inputRef", null)
      
      @scala.inline
      def inputRefReactRef(value: ReactRef[Any]): this.type = set("inputRef", value.asInstanceOf[js.Any])
