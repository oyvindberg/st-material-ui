...
object Accordion {
  ...
  @scala.inline
  def apply(children: ReactElement | String | Double | Any | ReactPortal | Boolean): Builder = {
  ...
  class Builder (val args: js.Array[Any])
    ...
    @scala.inline
    def TransitionComponent(value: TransitionProps => ReactElement | Null): this.type = set("TransitionComponent", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def onChange(value: (/* event */ SyntheticEvent[Event, Element], /* expanded */ Boolean) => Unit): this.type = set("onChange", js.Any.fromFunction2(value))
