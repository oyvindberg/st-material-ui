...
object SliderUnstyled {
  ...
  class Builder (val args: js.Array[Any])
    extends StBuildingComponent[tag.type, HTMLSpanElement] {
    ...
    @scala.inline
    def valueLabelFormat(value: String | (js.Function2[/* value */ Double, /* index */ Double, ReactElement])): this.type = set("valueLabelFormat", value.asInstanceOf[js.Any])
    
    @scala.inline
    def valueLabelFormatFunction2(value: (/* value */ Double, /* index */ Double) => ReactElement): this.type = set("valueLabelFormat", js.Any.fromFunction2(value))
