...
object Slide {
  ...
  class Builder (val args: js.Array[Any])
    ...
    @scala.inline
    def container(value: Element | (js.Function1[/* element */ Element, Element])): this.type = set("container", value.asInstanceOf[js.Any])
    
    @scala.inline
    def containerFunction1(value: /* element */ Element => Element): this.type = set("container", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def direction(value: left | right | up | down): this.type = set("direction", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def in(value: Any): this.type = set("in", value.asInstanceOf[js.Any])
