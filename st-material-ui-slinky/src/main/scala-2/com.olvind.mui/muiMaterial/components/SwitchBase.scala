...
object SwitchBase {
  ...
  @scala.inline
  def apply(checkedIcon: ReactElement, icon: ReactElement): Builder = {
    val __props = js.Dynamic.literal(checkedIcon = checkedIcon.asInstanceOf[js.Any], icon = icon.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[SwitchBaseProps]))
  }
  ...
  class Builder (val args: js.Array[Any])
    extends StBuildingComponent[tag.type, HTMLButtonElement] {
    ...
    @scala.inline
    def actionFunction1(value: /* instance */ ButtonBaseActions | Null => Unit): this.type = set("action", js.Any.fromFunction1(value))
    
    @scala.inline
    def actionNull: this.type = set("action", null)
    
    @scala.inline
    def actionReactRef(value: ReactRef[ButtonBaseActions]): this.type = set("action", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def onFocusVisible(value: SyntheticFocusEvent[Any] => Unit): this.type = set("onFocusVisible", js.Any.fromFunction1(value))
