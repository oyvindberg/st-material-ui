...
object Rating {
  ...
  class Builder (val args: js.Array[Any])
    ...
    @scala.inline
    def onChange(value: (/* event */ SyntheticEvent[Event, Element], /* value */ Double | Null) => Unit): this.type = set("onChange", js.Any.fromFunction2(value))
    
    @scala.inline
    def onChangeActive(value: (/* event */ SyntheticEvent[Event, Element], /* value */ Double) => Unit): this.type = set("onChangeActive", js.Any.fromFunction2(value))
