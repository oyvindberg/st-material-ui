...
object Menu {
  ...
  class Builder (val args: js.Array[Any])
    extends StBuildingComponent[tag.type, HTMLDivElement] {
    
    @scala.inline
    def BackdropComponent(value: ReactElement): this.type = set("BackdropComponent", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def TransitionComponent(value: TransitionPropsAbout => ReactElement | Null): this.type = set("TransitionComponent", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def actionFunction1(value: /* instance */ PopoverActions | Null => Unit): this.type = set("action", js.Any.fromFunction1(value))
    
    @scala.inline
    def actionNull: this.type = set("action", null)
    
    @scala.inline
    def actionReactRef(value: ReactRef[PopoverActions]): this.type = set("action", value.asInstanceOf[js.Any])
    
    @scala.inline
    def anchorEl(value: Element | (js.Function1[/* element */ Element, Element])): this.type = set("anchorEl", value.asInstanceOf[js.Any])
    
    @scala.inline
    def anchorElFunction1(value: /* element */ Element => Element): this.type = set("anchorEl", js.Any.fromFunction1(value))
