...
object SpeedDialAction {
  ...
  class Builder (val args: js.Array[Any])
    ...
    @scala.inline
    def onClose(value: /* event */ (SyntheticEvent[Event, Element]) | Event => Unit): this.type = set("onClose", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def title(value: ReactElement | String | Double | Any | ReactPortal | Boolean): this.type = set("title", value.asInstanceOf[js.Any])
