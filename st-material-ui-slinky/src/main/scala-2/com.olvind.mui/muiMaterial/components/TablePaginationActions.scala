...
object TablePaginationActions {
  ...
  def apply(
    ...
    val __props = js.Dynamic.literal(count = count.asInstanceOf[js.Any], getItemAriaLabel = js.Any.fromFunction1(getItemAriaLabel), onPageChange = js.Any.fromFunction2(onPageChange), page = page.asInstanceOf[js.Any], rowsPerPage = rowsPerPage.asInstanceOf[js.Any], showFirstButton = showFirstButton.asInstanceOf[js.Any], showLastButton = showLastButton.asInstanceOf[js.Any])
