...
object Select {
  ...
  class Builder[T] (val args: js.Array[Any])
    ...
    @scala.inline
    def inputComponent(value: ReactElement): this.type = set("inputComponent", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def onChange(value: (/* event */ SelectChangeEvent[T], /* child */ ReactElement) => Unit): this.type = set("onChange", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def renderSuffix(value: /* state */ Disabled => ReactElement): this.type = set("renderSuffix", js.Any.fromFunction1(value))
    
    @scala.inline
    def renderValue(value: T => ReactElement): this.type = set("renderValue", js.Any.fromFunction1(value))
