...
object NativeSelectInput {
  ...
  @scala.inline
  def apply(IconComponent: ReactElement): Builder = {
  ...
  class Builder (val args: js.Array[Any])
    ...
    @scala.inline
    def inputRefFunction1(value: /* instance */ HTMLSelectElement | Null => Unit): this.type = set("inputRef", js.Any.fromFunction1(value))
    
    @scala.inline
    def inputRefNull: this.type = set("inputRef", null)
    
    @scala.inline
    def inputRefReactRef(value: ReactRef[HTMLSelectElement]): this.type = set("inputRef", value.asInstanceOf[js.Any])
