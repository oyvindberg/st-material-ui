...
object AutocompleteDiv {
  ...
  class Builder[T, Multiple /* <: js.UndefOr[Boolean] */, DisableClearable /* <: js.UndefOr[Boolean] */, FreeSolo /* <: js.UndefOr[Boolean] */] (val args: js.Array[Any])
    ...
    @scala.inline
    def ListboxComponent(value: HTMLAttributes[HTMLElement] => ReactElement | Null): this.type = set("ListboxComponent", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def PaperComponent(value: HTMLAttributes[HTMLElement] => ReactElement | Null): this.type = set("PaperComponent", js.Any.fromFunction1(value))
    
    @scala.inline
    def PopperComponent(value: PopperProps => ReactElement | Null): this.type = set("PopperComponent", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def onClose(value: (/* event */ SyntheticEvent[Event, Element], /* reason */ AutocompleteCloseReason) => Unit): this.type = set("onClose", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def renderTags(value: (/* value */ js.Array[T], /* getTagProps */ AutocompleteRenderGetTagProps) => ReactElement): this.type = set("renderTags", js.Any.fromFunction2(value))
