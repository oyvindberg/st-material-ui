...
object tablePaginationTablePaginationMod extends Shortcut {
  ...
  type TablePaginationProps[D /* <: ReactElement */, P] = OverrideProps[TablePaginationTypeMap[P, D], D]
  
  @js.native
  trait TablePaginationTypeMap[P, D /* <: ReactElement */] extends StObject {
  ...
  object TablePaginationTypeMap {
    ...
    @scala.inline
    def apply[P, D /* <: ReactElement */](defaultComponent: D, props: P with TablePaginationBaseProps with ActionsComponent): TablePaginationTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[TablePaginationTypeMap[P, D]]
    }
    
    @scala.inline
    implicit class TablePaginationTypeMapMutableBuilder[Self <: TablePaginationTypeMap[_, _], P, D /* <: ReactElement */] (val x: Self with (TablePaginationTypeMap[P, D])) extends AnyVal {
