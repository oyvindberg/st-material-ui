...
import com.olvind.mui.muiMaterial.anon.PartialMenuClasses
import com.olvind.mui.muiMaterial.anon.PartialMenuListPropsMenuListTypeMapuldef
...
object menuMenuMod {
  ...
  @JSImport("@mui/material/Menu/Menu", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @scala.inline
  def default(props: MenuProps): Element = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(props.asInstanceOf[js.Any]).asInstanceOf[Element]
  
  /* Inlined parent @mui/material.@mui/material.InternalStandardProps<@mui/material.@mui/material/Popover.PopoverProps, never> */
  @js.native
  trait MenuProps extends StObject {
    ...
    /**
      ...
      * @default {}
      */
    var MenuListProps: js.UndefOr[PartialMenuListPropsMenuListTypeMapuldef] = js.native
  ...
  object MenuProps {
    ...
    @scala.inline
    def apply(open: Boolean): MenuProps = {
    ...
    implicit class MenuPropsMutableBuilder[Self <: MenuProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setMenuListProps(value: PartialMenuListPropsMenuListTypeMapuldef): Self = StObject.set(x, "MenuListProps", value.asInstanceOf[js.Any])
