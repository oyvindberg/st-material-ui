...
object ratingClassesMod {
  ...
  @scala.inline
  def getRatingUtilityClass(slot: String): String = ^.asInstanceOf[js.Dynamic].applyDynamic("getRatingUtilityClass")(slot.asInstanceOf[js.Any]).asInstanceOf[String]
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - `com.olvind.mui`.muiMaterial.muiMaterialStrings.readOnly
    - `com.olvind.mui`.muiMaterial.muiMaterialStrings.disabled
    - `com.olvind.mui`.muiMaterial.muiMaterialStrings.focusVisible
    - `com.olvind.mui`.muiMaterial.muiMaterialStrings.visuallyHidden
    - `com.olvind.mui`.muiMaterial.muiMaterialStrings.label
    - `com.olvind.mui`.muiMaterial.muiMaterialStrings.labelEmptyValueActive
    - `com.olvind.mui`.muiMaterial.muiMaterialStrings.icon
    - `com.olvind.mui`.muiMaterial.muiMaterialStrings.iconEmpty
    - `com.olvind.mui`.muiMaterial.muiMaterialStrings.iconFilled
    - `com.olvind.mui`.muiMaterial.muiMaterialStrings.iconHover
    - `com.olvind.mui`.muiMaterial.muiMaterialStrings.iconFocus
    - `com.olvind.mui`.muiMaterial.muiMaterialStrings.iconActive
    - `com.olvind.mui`.muiMaterial.muiMaterialStrings.decimal
  */
  trait RatingClassKey extends StObject
  ...
  trait RatingClasses extends StObject {
    ...
    var iconActive: String = js.native
    
    /** Styles applied to the icon wrapping elements when empty. */
    var iconEmpty: String = js.native
    
    /** Styles applied to the icon wrapping elements when filled. */
    var iconFilled: String = js.native
    
    /** Styles applied to the icon wrapping elements when focus. */
    var iconFocus: String = js.native
    
    /** Styles applied to the icon wrapping elements when hover. */
    var iconHover: String = js.native
    
    /** Styles applied to the label elements. */
    var label: String = js.native
    
    /** Styles applied to the label of the "no value" input when it is active. */
    var labelEmptyValueActive: String = js.native
    ...
    var visuallyHidden: String = js.native
  }
  object RatingClasses {
    ...
    @scala.inline
    implicit class RatingClassesMutableBuilder[Self <: RatingClasses] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setLabelEmptyValueActive(value: String): Self = StObject.set(x, "labelEmptyValueActive", value.asInstanceOf[js.Any])
