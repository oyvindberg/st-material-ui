...
object appBarAppBarMod extends Shortcut {
  ...
  object AppBarTypeMap {
    ...
    @scala.inline
    def apply[P, D /* <: ReactElement */](defaultComponent: D, props: P with DistributiveOmitPaperPropsPaperTypeMapdi with Classes): AppBarTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[AppBarTypeMap[P, D]]
    }
    
    @scala.inline
    implicit class AppBarTypeMapMutableBuilder[Self <: AppBarTypeMap[_, _], P, D /* <: ReactElement */] (val x: Self with (AppBarTypeMap[P, D])) extends AnyVal {
