...
object imageListItemImageListItemMod extends Shortcut {
  ...
  object ImageListItemTypeMap {
    ...
    @scala.inline
    def apply[P, D /* <: ReactElement */](defaultComponent: D, props: P with Rows): ImageListItemTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[ImageListItemTypeMap[P, D]]
    }
    
    @scala.inline
    implicit class ImageListItemTypeMapMutableBuilder[Self <: ImageListItemTypeMap[_, _], P, D /* <: ReactElement */] (val x: Self with (ImageListItemTypeMap[P, D])) extends AnyVal {
