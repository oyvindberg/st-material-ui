...
object styledMod {
  ...
  @scala.inline
  def rootShouldForwardProp(prop: String): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("rootShouldForwardProp")(prop.asInstanceOf[js.Any]).asInstanceOf[Boolean]
  
  @scala.inline
  def slotShouldForwardProp(prop: String): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("slotShouldForwardProp")(prop.asInstanceOf[js.Any]).asInstanceOf[Boolean]
}
