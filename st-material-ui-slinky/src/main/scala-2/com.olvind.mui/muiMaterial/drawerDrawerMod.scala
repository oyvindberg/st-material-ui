...
object drawerDrawerMod {
  ...
  @JSImport("@mui/material/Drawer/Drawer", JSImport.Namespace)
  @js.native
  ...
  /* Inlined parent @mui/material.@mui/material.InternalStandardProps<@mui/material.@mui/material/Modal.ModalProps<@mui/material.@mui/material/Modal/Modal.ModalTypeMap<'div', {}>['defaultComponent'], {}>, 'open' | 'children'> */
  @js.native
  trait DrawerProps extends StObject {
    ...
    /**
      ...
      * @default {}
      */
    var ModalProps: js.UndefOr[PartialModalPropsModalTypeMapdivdefaultC] = js.native
  ...
  object DrawerProps {
    ...
    implicit class DrawerPropsMutableBuilder[Self <: DrawerProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setModalProps(value: PartialModalPropsModalTypeMapdivdefaultC): Self = StObject.set(x, "ModalProps", value.asInstanceOf[js.Any])
