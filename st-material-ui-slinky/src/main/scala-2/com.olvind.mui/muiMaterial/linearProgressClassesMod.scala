...
object linearProgressClassesMod {
  ...
  @scala.inline
  def getLinearProgressUtilityClass(slot: String): String = ^.asInstanceOf[js.Dynamic].applyDynamic("getLinearProgressUtilityClass")(slot.asInstanceOf[js.Any]).asInstanceOf[String]
  ...
  */
  ...
  trait LinearProgressClasses extends StObject {
    ...
    var bar1Buffer: String = js.native
    
    /** Styles applied to the bar1 element if `variant="determinate"`. */
    var bar1Determinate: String = js.native
    
    /** Styles applied to the bar1 element if `variant="indeterminate or query"`. */
    var bar1Indeterminate: String = js.native
    
    /** Styles applied to the bar2 element if `variant="buffer"`. */
    var bar2Buffer: String = js.native
    
    /** Styles applied to the bar2 element if `variant="indeterminate or query"`. */
    var bar2Indeterminate: String = js.native
    
    /** Styles applied to the bar elements if `color="primary"`; bar2 if `variant` not "buffer". */
    var barColorPrimary: String = js.native
    
    /** Styles applied to the bar elements if `color="secondary"`; bar2 if `variant` not "buffer". */
    var barColorSecondary: String = js.native
    ...
    var dashedColorPrimary: String = js.native
    
    /** Styles applied to the additional bar element if `variant="buffer"` and `color="secondary"`. */
    var dashedColorSecondary: String = js.native
  ...
  object LinearProgressClasses {
    ...
    @scala.inline
    implicit class LinearProgressClassesMutableBuilder[Self <: LinearProgressClasses] (val x: Self) extends AnyVal {
