...
object avatarAvatarMod extends Shortcut {
  ...
  object AvatarTypeMap {
    ...
    @scala.inline
    def apply[P, D /* <: ReactElement */](defaultComponent: D, props: P with Alt): AvatarTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[AvatarTypeMap[P, D]]
    }
    
    @scala.inline
    implicit class AvatarTypeMapMutableBuilder[Self <: AvatarTypeMap[_, _], P, D /* <: ReactElement */] (val x: Self with (AvatarTypeMap[P, D])) extends AnyVal {
