...
object dialogDialogMod {
  ...
  @JSImport("@mui/material/Dialog/Dialog", JSImport.Namespace)
  @js.native
  ...
  trait DialogProps extends StObject {
    ...
    /**
      ...
      * @default Paper
      */
    var PaperComponent: js.UndefOr[JSXElementConstructor[PaperPropsPaperTypeMapdivdefaultComponen]] = js.native
  ...
  object DialogProps {
    ...
    implicit class DialogPropsMutableBuilder[Self <: DialogProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setPaperComponent(value: PaperPropsPaperTypeMapdivdefaultComponen => ReactElement | Null): Self = StObject.set(x, "PaperComponent", js.Any.fromFunction1(value))
