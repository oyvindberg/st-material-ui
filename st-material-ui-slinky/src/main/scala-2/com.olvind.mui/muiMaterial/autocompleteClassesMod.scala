...
object autocompleteClassesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - `com.olvind.mui`.muiMaterial.muiMaterialStrings.tag
    - `com.olvind.mui`.muiMaterial.muiMaterialStrings.tagSizeSmall
    - `com.olvind.mui`.muiMaterial.muiMaterialStrings.tagSizeMedium
    - `com.olvind.mui`.muiMaterial.muiMaterialStrings.hasPopupIcon
    - `com.olvind.mui`.muiMaterial.muiMaterialStrings.hasClearIcon
    - `com.olvind.mui`.muiMaterial.muiMaterialStrings.inputRoot
    - `com.olvind.mui`.muiMaterial.muiMaterialStrings.input
    - `com.olvind.mui`.muiMaterial.muiMaterialStrings.inputFocused
    - `com.olvind.mui`.muiMaterial.muiMaterialStrings.endAdornment
    - `com.olvind.mui`.muiMaterial.muiMaterialStrings.clearIndicator
    - `com.olvind.mui`.muiMaterial.muiMaterialStrings.popupIndicator
    - `com.olvind.mui`.muiMaterial.muiMaterialStrings.popupIndicatorOpen
    - `com.olvind.mui`.muiMaterial.muiMaterialStrings.popper
    - `com.olvind.mui`.muiMaterial.muiMaterialStrings.popperDisablePortal
    - `com.olvind.mui`.muiMaterial.muiMaterialStrings.paper
    - `com.olvind.mui`.muiMaterial.muiMaterialStrings.listbox
    - `com.olvind.mui`.muiMaterial.muiMaterialStrings.loading
    - `com.olvind.mui`.muiMaterial.muiMaterialStrings.noOptions
    - `com.olvind.mui`.muiMaterial.muiMaterialStrings.option
    - `com.olvind.mui`.muiMaterial.muiMaterialStrings.groupLabel
    - `com.olvind.mui`.muiMaterial.muiMaterialStrings.groupUl
  */
  ...
  trait AutocompleteClasses extends StObject {
    ...
    var clearIndicator: String = js.native
    
    /** Styles applied to the endAdornment element. */
    var endAdornment: String = js.native
    ...
    var groupUl: String = js.native
    
    /** Styles applied when the clear icon is rendered. */
    var hasClearIcon: String = js.native
    
    /** Styles applied when the popup icon is rendered. */
    var hasPopupIcon: String = js.native
    
    /** Styles applied to the input element. */
    var input: String = js.native
    
    /** Styles applied to the input element if tag focused. */
    var inputFocused: String = js.native
    
    /** Styles applied to the Input element. */
    var inputRoot: String = js.native
    
    /** Styles applied to the listbox component. */
    var listbox: String = js.native
    
    /** Styles applied to the loading wrapper. */
    var loading: String = js.native
    
    /** Styles applied to the no option wrapper. */
    var noOptions: String = js.native
    ...
    var popperDisablePortal: String = js.native
    
    /** Styles applied to the popup indicator. */
    var popupIndicator: String = js.native
    
    /** Styles applied to the popup indicator if the popup is open. */
    var popupIndicatorOpen: String = js.native
    ...
    var tagSizeMedium: String = js.native
    
    /** Styles applied to the tag elements, e.g. the chips if `size="small"`. */
    var tagSizeSmall: String = js.native
  }
  object AutocompleteClasses {
    ...
    implicit class AutocompleteClassesMutableBuilder[Self <: AutocompleteClasses] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setHasClearIcon(value: String): Self = StObject.set(x, "hasClearIcon", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setHasPopupIcon(value: String): Self = StObject.set(x, "hasPopupIcon", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setTagSizeMedium(value: String): Self = StObject.set(x, "tagSizeMedium", value.asInstanceOf[js.Any])
