...
object tabClassesMod {
  ...
  @scala.inline
  def getTabUtilityClass(slot: String): String = ^.asInstanceOf[js.Dynamic].applyDynamic("getTabUtilityClass")(slot.asInstanceOf[js.Any]).asInstanceOf[String]
  ...
  */
  ...
  trait TabClasses extends StObject {
    ...
    var iconWrapper: String = js.native
    
    /** Styles applied to the root element if both `icon` and `label` are provided. */
    var labelIcon: String = js.native
    ...
    var textColorInherit: String = js.native
    
    /** Styles applied to the root element if the parent [`Tabs`](/api/tabs/) has `textColor="primary"`. */
    var textColorPrimary: String = js.native
    
    /** Styles applied to the root element if the parent [`Tabs`](/api/tabs/) has `textColor="secondary"`. */
    var textColorSecondary: String = js.native
    
    /** Styles applied to the root element if `wrapped={true}`. */
    var wrapped: String = js.native
  }
  object TabClasses {
    ...
    implicit class TabClassesMutableBuilder[Self <: TabClasses] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setIconWrapper(value: String): Self = StObject.set(x, "iconWrapper", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setWrapped(value: String): Self = StObject.set(x, "wrapped", value.asInstanceOf[js.Any])
    }
  }
}
