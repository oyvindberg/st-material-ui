...
object listItemTextListItemTextMod {
  ...
  @scala.inline
  def default[PrimaryTypographyComponent /* <: ReactElement */, SecondaryTypographyComponent /* <: ReactElement */](props: ListItemTextProps[PrimaryTypographyComponent, SecondaryTypographyComponent]): Element = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(props.asInstanceOf[js.Any]).asInstanceOf[Element]
  
  /* Inlined parent @mui/material.@mui/material.InternalStandardProps<react.react.HTMLAttributes<std.HTMLDivElement>, never> */
  @js.native
  trait ListItemTextProps[PrimaryTypographyComponent /* <: ReactElement */, SecondaryTypographyComponent /* <: ReactElement */] extends StObject {
  ...
  object ListItemTextProps {
    ...
    @scala.inline
    def apply[PrimaryTypographyComponent /* <: ReactElement */, SecondaryTypographyComponent /* <: ReactElement */](): ListItemTextProps[PrimaryTypographyComponent, SecondaryTypographyComponent] = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[ListItemTextProps[PrimaryTypographyComponent, SecondaryTypographyComponent]]
    }
    
    @scala.inline
    implicit class ListItemTextPropsMutableBuilder[Self <: ListItemTextProps[_, _], PrimaryTypographyComponent /* <: ReactElement */, SecondaryTypographyComponent /* <: ReactElement */] (val x: Self with (ListItemTextProps[PrimaryTypographyComponent, SecondaryTypographyComponent])) extends AnyVal {
