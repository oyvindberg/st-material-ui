...
object listItemListItemMod extends Shortcut {
  ...
  val default: (js.Function1[
    ...
    ReactElement | Null
  ]) with (js.Function1[/* props */ DefaultComponentPropsListItemTypeMapli, Element]) = js.native
  ...
  object ListItemTypeMap {
    ...
    @scala.inline
    def apply[P, D /* <: ReactElement */](defaultComponent: D, props: P with ListItemBaseProps with Components): ListItemTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[ListItemTypeMap[P, D]]
    }
    
    @scala.inline
    implicit class ListItemTypeMapMutableBuilder[Self <: ListItemTypeMap[_, _], P, D /* <: ReactElement */] (val x: Self with (ListItemTypeMap[P, D])) extends AnyVal {
  ...
  type _To = (js.Function1[
    /* props */ OverridePropsExtendButtonBaseTypeMapList | DefaultComponentPropsExtendButtonBaseTypAlignItems, 
    ReactElement | Null
  ]) with (js.Function1[/* props */ DefaultComponentPropsListItemTypeMapli, Element])
  
  /* This means you don't have to write `default`, but can instead just say `listItemListItemMod.foo` */
  override def _to: (js.Function1[
    /* props */ OverridePropsExtendButtonBaseTypeMapList | DefaultComponentPropsExtendButtonBaseTypAlignItems, 
    ReactElement | Null
  ]) with (js.Function1[/* props */ DefaultComponentPropsListItemTypeMapli, Element]) = default
}
