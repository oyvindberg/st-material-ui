...
object accordionAccordionMod {
  ...
  object AccordionProps {
    ...
    @scala.inline
    def apply(children: ReactElement | String | Double | Any | ReactPortal | Boolean): AccordionProps = {
    ...
    implicit class AccordionPropsMutableBuilder[Self <: AccordionProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnChange(
        value: (/* event */ SyntheticEvent[Event, org.scalajs.dom.Element], /* expanded */ Boolean) => Unit
