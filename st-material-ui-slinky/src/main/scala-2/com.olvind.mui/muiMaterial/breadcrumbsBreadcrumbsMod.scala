...
object breadcrumbsBreadcrumbsMod extends Shortcut {
  ...
  object BreadcrumbsTypeMap {
    ...
    @scala.inline
    def apply[P, D /* <: ReactElement */](defaultComponent: D, props: P with ExpandText): BreadcrumbsTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[BreadcrumbsTypeMap[P, D]]
    }
    
    @scala.inline
    implicit class BreadcrumbsTypeMapMutableBuilder[Self <: BreadcrumbsTypeMap[_, _], P, D /* <: ReactElement */] (val x: Self with (BreadcrumbsTypeMap[P, D])) extends AnyVal {
