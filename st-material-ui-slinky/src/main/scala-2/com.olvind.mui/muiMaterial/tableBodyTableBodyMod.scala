...
object tableBodyTableBodyMod extends Shortcut {
  ...
  object TableBodyTypeMap {
    ...
    @scala.inline
    def apply[P, D /* <: ReactElement */](defaultComponent: D, props: P with ChildrenClassesSx): TableBodyTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[TableBodyTypeMap[P, D]]
    }
    
    @scala.inline
    implicit class TableBodyTypeMapMutableBuilder[Self <: TableBodyTypeMap[_, _], P, D /* <: ReactElement */] (val x: Self with (TableBodyTypeMap[P, D])) extends AnyVal {
