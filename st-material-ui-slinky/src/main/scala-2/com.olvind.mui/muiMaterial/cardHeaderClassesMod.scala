...
object cardHeaderClassesMod {
  ...
  */
  ...
  object CardHeaderClasses {
    ...
    @scala.inline
    def apply(action: String, avatar: String, content: String, root: String, subheader: String, title: String): CardHeaderClasses = {
    ...
    @scala.inline
    implicit class CardHeaderClassesMutableBuilder[Self <: CardHeaderClasses] (val x: Self) extends AnyVal {
