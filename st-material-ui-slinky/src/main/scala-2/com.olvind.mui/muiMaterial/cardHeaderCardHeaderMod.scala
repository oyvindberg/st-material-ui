...
object cardHeaderCardHeaderMod extends Shortcut {
  ...
  type CardHeaderPropsWithComponent[DefaultComponent /* <: ReactElement */, Props, TitleTypographyComponent /* <: ReactElement */, SubheaderTypographyComponent /* <: ReactElement */] = `8`[DefaultComponent] with (CardHeaderProps[DefaultComponent, Props, TitleTypographyComponent, SubheaderTypographyComponent])
  ...
  object CardHeaderTypeMap {
    ...
    @scala.inline
    def apply[Props, DefaultComponent /* <: ReactElement */, TitleTypographyComponent /* <: ReactElement */, SubheaderTypographyComponent /* <: ReactElement */](
    ...
    @scala.inline
    implicit class CardHeaderTypeMapMutableBuilder[Self <: CardHeaderTypeMap[_, _, _, _], Props, DefaultComponent /* <: ReactElement */, TitleTypographyComponent /* <: ReactElement */, SubheaderTypographyComponent /* <: ReactElement */] (val x: Self with (CardHeaderTypeMap[Props, DefaultComponent, TitleTypographyComponent, SubheaderTypographyComponent])) extends AnyVal {
