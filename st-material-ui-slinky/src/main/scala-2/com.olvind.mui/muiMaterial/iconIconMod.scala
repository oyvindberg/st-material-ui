...
object iconIconMod {
  ...
  object IconTypeMap {
    ...
    @scala.inline
    def apply[P, D /* <: ReactElement */](defaultComponent: D, props: P with BaseClassName): IconTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[IconTypeMap[P, D]]
    }
    
    @scala.inline
    implicit class IconTypeMapMutableBuilder[Self <: IconTypeMap[_, _], P, D /* <: ReactElement */] (val x: Self with (IconTypeMap[P, D])) extends AnyVal {
