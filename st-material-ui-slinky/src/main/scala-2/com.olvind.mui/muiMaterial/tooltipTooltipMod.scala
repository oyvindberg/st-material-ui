...
object tooltipTooltipMod {
  ...
  trait TooltipProps extends StObject {
    ...
    /**
      ...
      */
    var title: ReactElement | String | Double | Any | ReactPortal | Boolean = js.native
  ...
  object TooltipProps {
    ...
    @scala.inline
    def apply(children: ReactElement, title: ReactElement | String | Double | Any | ReactPortal | Boolean): TooltipProps = {
