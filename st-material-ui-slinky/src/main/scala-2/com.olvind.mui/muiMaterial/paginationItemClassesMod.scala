...
object paginationItemClassesMod {
  ...
  @scala.inline
  def getPaginationItemUtilityClass(slot: String): String = ^.asInstanceOf[js.Dynamic].applyDynamic("getPaginationItemUtilityClass")(slot.asInstanceOf[js.Any]).asInstanceOf[String]
  ...
  */
  ...
  trait PaginationItemClasses extends StObject {
    ...
    var firstLast: String = js.native
    ...
    var previousNext: String = js.native
  ...
  object PaginationItemClasses {
    ...
    @scala.inline
    implicit class PaginationItemClassesMutableBuilder[Self <: PaginationItemClasses] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFirstLast(value: String): Self = StObject.set(x, "firstLast", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setPreviousNext(value: String): Self = StObject.set(x, "previousNext", value.asInstanceOf[js.Any])
