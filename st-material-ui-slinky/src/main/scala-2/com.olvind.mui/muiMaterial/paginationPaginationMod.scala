...
object paginationPaginationMod {
  ...
  trait PaginationProps extends StObject {
    ...
    /**
      ...
      */
    var onChange: js.UndefOr[js.Function2[/* event */ ChangeEvent[Any], /* page */ Double, Unit]] = js.native
    ...
    /**
      ...
      */
    var renderItem: js.UndefOr[js.Function1[/* params */ PaginationRenderItemParams, ReactElement]] = js.native
  ...
  object PaginationProps {
    ...
    implicit class PaginationPropsMutableBuilder[Self <: PaginationProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnChange(value: (/* event */ ChangeEvent[Any], /* page */ Double) => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction2(value))
      ...
      @scala.inline
      def setRenderItem(value: /* params */ PaginationRenderItemParams => ReactElement): Self = StObject.set(x, "renderItem", js.Any.fromFunction1(value))
  ...
  object PaginationRenderItemParams {
    ...
    def apply(
      disabled: Boolean,
      onClick: SyntheticEvent[Event, org.scalajs.dom.Element] => Unit,
      page: Double,
      selected: Boolean,
