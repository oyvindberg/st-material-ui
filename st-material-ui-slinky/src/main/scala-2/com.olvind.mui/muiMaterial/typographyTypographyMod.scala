...
object typographyTypographyMod extends Shortcut {
  ...
  object TypographyTypeMap {
    ...
    @scala.inline
    def apply[P, D /* <: ReactElement */](defaultComponent: D, props: P with SystemProps[Theme] with Align): TypographyTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[TypographyTypeMap[P, D]]
    }
    
    @scala.inline
    implicit class TypographyTypeMapMutableBuilder[Self <: TypographyTypeMap[_, _], P, D /* <: ReactElement */] (val x: Self with (TypographyTypeMap[P, D])) extends AnyVal {
