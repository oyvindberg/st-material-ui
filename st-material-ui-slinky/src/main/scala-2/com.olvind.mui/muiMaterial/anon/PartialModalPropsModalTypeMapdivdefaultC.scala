...
/* Inlined std.Partial<ModalProps<ModalTypeMap<'div', {}>['defaultComponent'], {}>> */
@js.native
trait PartialModalPropsModalTypeMapdivdefaultC extends StObject {
...
object PartialModalPropsModalTypeMapdivdefaultC {
  
  @scala.inline
  def apply(): PartialModalPropsModalTypeMapdivdefaultC = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialModalPropsModalTypeMapdivdefaultC]
  }
  
  @scala.inline
  implicit class PartialModalPropsModalTypeMapdivdefaultCMutableBuilder[Self <: PartialModalPropsModalTypeMapdivdefaultC] (val x: Self) extends AnyVal {
