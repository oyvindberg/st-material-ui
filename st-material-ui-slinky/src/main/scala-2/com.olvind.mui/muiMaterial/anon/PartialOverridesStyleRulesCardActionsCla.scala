...
object PartialOverridesStyleRulesCardActionsCla {
  ...
  @scala.inline
  def apply(): PartialOverridesStyleRulesCardActionsCla = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialOverridesStyleRulesCardActionsCla]
  }
  
  @scala.inline
  implicit class PartialOverridesStyleRulesCardActionsClaMutableBuilder[Self <: PartialOverridesStyleRulesCardActionsCla] (val x: Self) extends AnyVal {
