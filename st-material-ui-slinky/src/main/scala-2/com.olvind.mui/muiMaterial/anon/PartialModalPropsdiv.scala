...
/* Inlined std.Partial<ModalProps<'div', {}>> */
@js.native
trait PartialModalPropsdiv extends StObject {
...
object PartialModalPropsdiv {
  
  @scala.inline
  def apply(): PartialModalPropsdiv = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialModalPropsdiv]
  }
  
  @scala.inline
  implicit class PartialModalPropsdivMutableBuilder[Self <: PartialModalPropsdiv] (val x: Self) extends AnyVal {
