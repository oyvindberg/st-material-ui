...
trait ClassesColor extends StObject {
  ...
  var classes: js.UndefOr[
    (/* import warning: importer.ImportType#apply Failed type conversion: @mui/material.anon.SliderUnstyledTypeMapspanprops['classes'] */ js.Any) with ColorPrimary
  ] = js.native
...
object ClassesColor {
  ...
  @scala.inline
  def apply(): ClassesColor = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ClassesColor]
  }
  
  @scala.inline
  implicit class ClassesColorMutableBuilder[Self <: ClassesColor] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setClasses(
      value: (/* import warning: importer.ImportType#apply Failed type conversion: @mui/material.anon.SliderUnstyledTypeMapspanprops['classes'] */ js.Any) with ColorPrimary
