...
@js.native
trait ModalPropsModalTypeMapdivdefaultComponen extends StObject {
...
object ModalPropsModalTypeMapdivdefaultComponen {
  
  @scala.inline
  def apply(children: ReactElement, open: Boolean): ModalPropsModalTypeMapdivdefaultComponen = {
  ...
  @scala.inline
  implicit class ModalPropsModalTypeMapdivdefaultComponenMutableBuilder[Self <: ModalPropsModalTypeMapdivdefaultComponen] (val x: Self) extends AnyVal {
