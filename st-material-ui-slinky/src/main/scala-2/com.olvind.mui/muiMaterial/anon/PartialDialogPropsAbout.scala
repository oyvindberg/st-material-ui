...
@js.native
trait PartialDialogPropsAbout extends StObject {
...
object PartialDialogPropsAbout {
  
  @scala.inline
  def apply(): PartialDialogPropsAbout = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialDialogPropsAbout]
  }
  
  @scala.inline
  implicit class PartialDialogPropsAboutMutableBuilder[Self <: PartialDialogPropsAbout] (val x: Self) extends AnyVal {
