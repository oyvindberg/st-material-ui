...
object PartialInputLabelPropsAbout {
  ...
  implicit class PartialInputLabelPropsAboutMutableBuilder[Self <: PartialInputLabelPropsAbout] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRefFunction1(value: /* instance */ HTMLLabelElement | Null => Unit): Self = StObject.set(x, "ref", js.Any.fromFunction1(value))
    
    @scala.inline
    def setRefNull: Self = StObject.set(x, "ref", null)
    
    @scala.inline
    def setRefReactRef(value: ReactRef[HTMLLabelElement]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
