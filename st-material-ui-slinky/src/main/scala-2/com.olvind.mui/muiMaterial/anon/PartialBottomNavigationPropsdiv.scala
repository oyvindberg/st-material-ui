...
/* Inlined std.Partial<BottomNavigationProps<'div', {}>> */
@js.native
trait PartialBottomNavigationPropsdiv extends StObject {
...
object PartialBottomNavigationPropsdiv {
  
  @scala.inline
  def apply(): PartialBottomNavigationPropsdiv = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialBottomNavigationPropsdiv]
  }
  
  @scala.inline
  implicit class PartialBottomNavigationPropsdivMutableBuilder[Self <: PartialBottomNavigationPropsdiv] (val x: Self) extends AnyVal {
