...
object `11` {
  ...
  @scala.inline
  def apply[P, D /* <: ReactElement */](defaultComponent: D, props: P with Edge): `11`[P, D] = {
    val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
    __obj.asInstanceOf[`11`[P, D]]
  }
  
  @scala.inline
  implicit class `11MutableBuilder`[Self <: `11`[_, _], P, D /* <: ReactElement */] (val x: Self with (`11`[P, D])) extends AnyVal {
