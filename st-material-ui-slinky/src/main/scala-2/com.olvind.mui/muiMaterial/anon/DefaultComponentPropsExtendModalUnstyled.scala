...
object DefaultComponentPropsExtendModalUnstyled {
  
  @scala.inline
  def apply(children: ReactElement, open: Boolean): DefaultComponentPropsExtendModalUnstyled = {
  ...
  @scala.inline
  implicit class DefaultComponentPropsExtendModalUnstyledMutableBuilder[Self <: DefaultComponentPropsExtendModalUnstyled] (val x: Self) extends AnyVal {
