...
trait PartialAutocompletePropsanyanyanyanydiv extends StObject {
  ...
  var renderInput: js.UndefOr[js.Function1[/* params */ AutocompleteRenderInputParams, ReactElement]] = js.native
...
object PartialAutocompletePropsanyanyanyanydiv {
  ...
  implicit class PartialAutocompletePropsanyanyanyanydivMutableBuilder[Self <: PartialAutocompletePropsanyanyanyanydiv] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setListboxComponent(value: HTMLAttributes[HTMLElement] => ReactElement | Null): Self = StObject.set(x, "ListboxComponent", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOnChange(
      value: (/* event */ SyntheticEvent[Event, Element], /* value */ AutocompleteValue[Any, Any, Any, Any], /* reason */ AutocompleteChangeReason, /* details */ js.UndefOr[AutocompleteChangeDetails[Any]]) => Unit
    ...
    @scala.inline
    def setOnClose(value: (/* event */ SyntheticEvent[Event, Element], /* reason */ AutocompleteCloseReason) => Unit): Self = StObject.set(x, "onClose", js.Any.fromFunction2(value))
    ...
    def setOnHighlightChange(
      value: (/* event */ SyntheticEvent[Event, Element], /* option */ Any | Null, /* reason */ AutocompleteHighlightChangeReason) => Unit
    ...
    @scala.inline
    def setPaperComponent(value: HTMLAttributes[HTMLElement] => ReactElement | Null): Self = StObject.set(x, "PaperComponent", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setRenderInput(value: /* params */ AutocompleteRenderInputParams => ReactElement): Self = StObject.set(x, "renderInput", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setRenderOption(
      value: (/* props */ HTMLAttributes[HTMLLIElement], /* option */ Any, /* state */ AutocompleteRenderOptionState) => ReactElement
    ...
    @scala.inline
    def setRenderTags(
      value: (/* value */ js.Array[Any], /* getTagProps */ AutocompleteRenderGetTagProps) => ReactElement
