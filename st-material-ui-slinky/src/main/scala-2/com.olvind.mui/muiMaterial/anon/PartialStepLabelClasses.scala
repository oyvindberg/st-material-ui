...
/* Inlined std.Partial<@mui/material.@mui/material/StepLabel/stepLabelClasses.StepLabelClasses> */
@js.native
trait PartialStepLabelClasses extends StObject {
...
object PartialStepLabelClasses {
  
  @scala.inline
  def apply(): PartialStepLabelClasses = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialStepLabelClasses]
  }
  
  @scala.inline
  implicit class PartialStepLabelClassesMutableBuilder[Self <: PartialStepLabelClasses] (val x: Self) extends AnyVal {
