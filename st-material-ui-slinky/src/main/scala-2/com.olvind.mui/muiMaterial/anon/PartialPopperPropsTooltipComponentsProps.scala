...
@js.native
trait PartialPopperPropsTooltipComponentsProps extends StObject {
  ...
  var children: js.UndefOr[ReactElement | (js.Function1[/* props */ Placement, ReactElement])] = js.native
...
object PartialPopperPropsTooltipComponentsProps {
  
  @scala.inline
  def apply(): PartialPopperPropsTooltipComponentsProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialPopperPropsTooltipComponentsProps]
  }
  
  @scala.inline
  implicit class PartialPopperPropsTooltipComponentsPropsMutableBuilder[Self <: PartialPopperPropsTooltipComponentsProps] (val x: Self) extends AnyVal {
