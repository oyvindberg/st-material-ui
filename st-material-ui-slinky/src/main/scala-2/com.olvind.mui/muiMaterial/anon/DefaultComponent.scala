...
object DefaultComponent {
  ...
  @scala.inline
  def apply[P, D /* <: ReactElement */](defaultComponent: D, props: P with Children): DefaultComponent[P, D] = {
    val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
    __obj.asInstanceOf[DefaultComponent[P, D]]
  }
  
  @scala.inline
  implicit class DefaultComponentMutableBuilder[Self <: DefaultComponent[_, _], P, D /* <: ReactElement */] (val x: Self with (DefaultComponent[P, D])) extends AnyVal {
