...
trait DefaultComponentPropsExtendButtonBaseTypAlignItems extends StObject {
  ...
  /**
    ...
    */
  var secondaryAction: js.UndefOr[ReactElement] = js.native
...
object DefaultComponentPropsExtendButtonBaseTypAlignItems {
  ...
  implicit class DefaultComponentPropsExtendButtonBaseTypAlignItemsMutableBuilder[Self <: DefaultComponentPropsExtendButtonBaseTypAlignItems] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSecondaryAction(value: ReactElement): Self = StObject.set(x, "secondaryAction", value.asInstanceOf[js.Any])
