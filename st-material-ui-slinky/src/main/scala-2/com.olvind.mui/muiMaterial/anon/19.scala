...
object `19` {
  ...
  @scala.inline
  def apply[SecondaryTypographyComponent /* <: ReactElement */](): `19`[SecondaryTypographyComponent] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[`19`[SecondaryTypographyComponent]]
  }
  
  @scala.inline
  implicit class `19MutableBuilder`[Self <: `19`[_], SecondaryTypographyComponent /* <: ReactElement */] (val x: Self with `19`[SecondaryTypographyComponent]) extends AnyVal {
