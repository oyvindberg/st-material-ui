...
/* Inlined DefaultComponentProps<StackTypeMap<{}, 'div'>> & { readonly component :string | undefined} */
@js.native
...
object DefaultComponentPropsStackTypeMapdiv {
  ...
  @scala.inline
  def apply(): DefaultComponentPropsStackTypeMapdiv = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsStackTypeMapdiv]
  }
  
  @scala.inline
  implicit class DefaultComponentPropsStackTypeMapdivMutableBuilder[Self <: DefaultComponentPropsStackTypeMapdiv] (val x: Self) extends AnyVal {
