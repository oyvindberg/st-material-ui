...
@js.native
trait PartialPopperProps extends StObject {
...
object PartialPopperProps {
  
  @scala.inline
  def apply(): PartialPopperProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialPopperProps]
  }
  
  @scala.inline
  implicit class PartialPopperPropsMutableBuilder[Self <: PartialPopperProps] (val x: Self) extends AnyVal {
