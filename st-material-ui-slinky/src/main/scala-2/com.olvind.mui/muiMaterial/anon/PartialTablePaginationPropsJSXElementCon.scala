...
object PartialTablePaginationPropsJSXElementCon {
  ...
  implicit class PartialTablePaginationPropsJSXElementConMutableBuilder[Self <: PartialTablePaginationPropsJSXElementCon] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setActionsComponent(value: ReactElement): Self = StObject.set(x, "ActionsComponent", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnPageChange(value: (/* event */ SyntheticMouseEvent[HTMLButtonElement] | Null, /* page */ Double) => Unit): Self = StObject.set(x, "onPageChange", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def setOnRowsPerPageChange(value: ChangeEvent[HTMLTextAreaElement | HTMLInputElement] => Unit): Self = StObject.set(x, "onRowsPerPageChange", js.Any.fromFunction1(value))
