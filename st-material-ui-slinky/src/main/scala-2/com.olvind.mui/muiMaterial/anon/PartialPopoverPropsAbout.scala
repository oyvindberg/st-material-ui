...
@js.native
trait PartialPopoverPropsAbout extends StObject {
...
object PartialPopoverPropsAbout {
  
  @scala.inline
  def apply(): PartialPopoverPropsAbout = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialPopoverPropsAbout]
  }
  
  @scala.inline
  implicit class PartialPopoverPropsAboutMutableBuilder[Self <: PartialPopoverPropsAbout] (val x: Self) extends AnyVal {
