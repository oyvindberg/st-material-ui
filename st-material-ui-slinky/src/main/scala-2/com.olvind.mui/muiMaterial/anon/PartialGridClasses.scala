...
trait PartialGridClasses extends StObject {
  ...
  var `spacing-xs-1`: js.UndefOr[String] = js.native
  
  var `spacing-xs-10`: js.UndefOr[String] = js.native
  
  var `spacing-xs-2`: js.UndefOr[String] = js.native
  
  var `spacing-xs-3`: js.UndefOr[String] = js.native
  
  var `spacing-xs-4`: js.UndefOr[String] = js.native
  
  var `spacing-xs-5`: js.UndefOr[String] = js.native
  
  var `spacing-xs-6`: js.UndefOr[String] = js.native
  
  var `spacing-xs-7`: js.UndefOr[String] = js.native
  
  var `spacing-xs-8`: js.UndefOr[String] = js.native
  
  var `spacing-xs-9`: js.UndefOr[String] = js.native
  
  var `wrap-xs-nowrap`: js.UndefOr[String] = js.native
  
  var `wrap-xs-wrap-reverse`: js.UndefOr[String] = js.native
  
  var zeroMinWidth: js.UndefOr[String] = js.native
}
object PartialGridClasses {
  
  @scala.inline
  def apply(): PartialGridClasses = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialGridClasses]
  }
  
  @scala.inline
  implicit class PartialGridClassesMutableBuilder[Self <: PartialGridClasses] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def `setDirection-xs-column-reverseUndefined`: Self = StObject.set(x, "direction-xs-column-reverse", js.undefined)
    
    @scala.inline
    def `setDirection-xs-columnUndefined`: Self = StObject.set(x, "direction-xs-column", js.undefined)
    
    @scala.inline
    def `setDirection-xs-row-reverse`(value: String): Self = StObject.set(x, "direction-xs-row-reverse", value.asInstanceOf[js.Any])
    
    @scala.inline
    def `setDirection-xs-row-reverseUndefined`: Self = StObject.set(x, "direction-xs-row-reverse", js.undefined)
