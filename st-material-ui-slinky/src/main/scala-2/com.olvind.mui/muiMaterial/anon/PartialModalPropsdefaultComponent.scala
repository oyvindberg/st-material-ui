...
/* Inlined std.Partial<ModalProps<{}['defaultComponent'], {}>> */
@js.native
trait PartialModalPropsdefaultComponent extends StObject {
...
object PartialModalPropsdefaultComponent {
  
  @scala.inline
  def apply(): PartialModalPropsdefaultComponent = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialModalPropsdefaultComponent]
  }
  
  @scala.inline
  implicit class PartialModalPropsdefaultComponentMutableBuilder[Self <: PartialModalPropsdefaultComponent] (val x: Self) extends AnyVal {
