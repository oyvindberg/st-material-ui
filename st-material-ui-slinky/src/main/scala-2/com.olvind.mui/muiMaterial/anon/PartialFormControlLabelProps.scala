...
trait PartialFormControlLabelProps extends StObject {
  ...
  var label: js.UndefOr[String | Double | ReactElement] = js.native
...
object PartialFormControlLabelProps {
  ...
  implicit class PartialFormControlLabelPropsMutableBuilder[Self <: PartialFormControlLabelProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLabel(value: String | Double | ReactElement): Self = StObject.set(x, "label", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnChange(value: (/* event */ SyntheticEvent[Event, Element], /* checked */ Boolean) => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction2(value))
