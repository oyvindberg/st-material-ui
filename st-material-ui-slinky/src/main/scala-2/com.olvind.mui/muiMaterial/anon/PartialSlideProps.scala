...
trait PartialSlideProps extends StObject {
  ...
  var container: js.UndefOr[Null | Element | (js.Function1[/* element */ Element, Element])] = js.native
...
object PartialSlideProps {
  ...
  implicit class PartialSlidePropsMutableBuilder[Self <: PartialSlideProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setContainer(value: Element | (js.Function1[/* element */ Element, Element])): Self = StObject.set(x, "container", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setContainerFunction1(value: /* element */ Element => Element): Self = StObject.set(x, "container", js.Any.fromFunction1(value))
