...
/* Inlined @mui/material.@mui/material/Modal.ModalProps<{  props :{} & {},   defaultComponent :'div'}['defaultComponent'], {}> */
@js.native
trait ModalPropsdefaultComponent extends StObject {
...
object ModalPropsdefaultComponent {
  
  @scala.inline
  def apply(children: ReactElement, open: Boolean): ModalPropsdefaultComponent = {
  ...
  @scala.inline
  implicit class ModalPropsdefaultComponentMutableBuilder[Self <: ModalPropsdefaultComponent] (val x: Self) extends AnyVal {
