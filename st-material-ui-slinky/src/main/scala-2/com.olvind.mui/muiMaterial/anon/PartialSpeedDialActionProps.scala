...
trait PartialSpeedDialActionProps extends StObject {
  ...
  var onClose: js.UndefOr[js.Function1[/* event */ (SyntheticEvent[Event, Element]) | Event, Unit]] = js.native
  ...
  var title: js.UndefOr[ReactElement | String | Double | Any | ReactPortal | Boolean] = js.native
  ...
  var tooltipTitle: js.UndefOr[ReactElement] = js.native
...
object PartialSpeedDialActionProps {
  ...
  implicit class PartialSpeedDialActionPropsMutableBuilder[Self <: PartialSpeedDialActionProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnClose(value: /* event */ (SyntheticEvent[Event, Element]) | Event => Unit): Self = StObject.set(x, "onClose", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setPopperComponent(value: PopperProps => ReactElement | Null): Self = StObject.set(x, "PopperComponent", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setTitle(value: ReactElement | String | Double | Any | ReactPortal | Boolean): Self = StObject.set(x, "title", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTooltipTitle(value: ReactElement): Self = StObject.set(x, "tooltipTitle", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTooltipTitleUndefined: Self = StObject.set(x, "tooltipTitle", js.undefined)
    
    @scala.inline
    def setTransitionComponent(value: TransitionPropsAbout => ReactElement | Null): Self = StObject.set(x, "TransitionComponent", js.Any.fromFunction1(value))
