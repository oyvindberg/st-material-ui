...
object DefaultComponentProps {
  ...
  @scala.inline
  def apply[P, D /* <: ReactElement */](defaultComponent: D, props: P with PartialOmitFadePropschildren with Open): DefaultComponentProps[P, D] = {
    val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
    __obj.asInstanceOf[DefaultComponentProps[P, D]]
  }
  
  @scala.inline
  implicit class DefaultComponentPropsMutableBuilder[Self <: DefaultComponentProps[_, _], P, D /* <: ReactElement */] (val x: Self with (DefaultComponentProps[P, D])) extends AnyVal {
