...
/* Inlined std.Partial<@mui/material.@mui/material/Drawer.DrawerProps> */
@js.native
trait PartialDrawerPropsAbout extends StObject {
...
object PartialDrawerPropsAbout {
  
  @scala.inline
  def apply(): PartialDrawerPropsAbout = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialDrawerPropsAbout]
  }
  
  @scala.inline
  implicit class PartialDrawerPropsAboutMutableBuilder[Self <: PartialDrawerPropsAbout] (val x: Self) extends AnyVal {
