...
object OmitTypographyTypeMapspanpropsclasses {
  
  @scala.inline
  def apply(): OmitTypographyTypeMapspanpropsclasses = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[OmitTypographyTypeMapspanpropsclasses]
  }
  
  @scala.inline
  implicit class OmitTypographyTypeMapspanpropsclassesMutableBuilder[Self <: OmitTypographyTypeMapspanpropsclasses] (val x: Self) extends AnyVal {
