...
/* Inlined @mui/material.@mui/material/Modal.ModalProps<'div', {}> */
@js.native
trait ModalPropsdiv extends StObject {
...
object ModalPropsdiv {
  
  @scala.inline
  def apply(children: ReactElement, open: Boolean): ModalPropsdiv = {
  ...
  @scala.inline
  implicit class ModalPropsdivMutableBuilder[Self <: ModalPropsdiv] (val x: Self) extends AnyVal {
