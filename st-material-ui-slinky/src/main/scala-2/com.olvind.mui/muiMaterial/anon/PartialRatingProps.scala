...
object PartialRatingProps {
  ...
  implicit class PartialRatingPropsMutableBuilder[Self <: PartialRatingProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnChange(value: (/* event */ SyntheticEvent[Event, Element], /* value */ Double | Null) => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction2(value))
    
    @scala.inline
    def setOnChangeActive(value: (/* event */ SyntheticEvent[Event, Element], /* value */ Double) => Unit): Self = StObject.set(x, "onChangeActive", js.Any.fromFunction2(value))
