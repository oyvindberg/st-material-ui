...
object DefaultComponentPropsSvgIconTypeMapsvg {
  ...
  @scala.inline
  def apply(): DefaultComponentPropsSvgIconTypeMapsvg = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsSvgIconTypeMapsvg]
  }
  
  @scala.inline
  implicit class DefaultComponentPropsSvgIconTypeMapsvgMutableBuilder[Self <: DefaultComponentPropsSvgIconTypeMapsvg] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRefReactRef(value: ReactRef[SVGSVGElement]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
