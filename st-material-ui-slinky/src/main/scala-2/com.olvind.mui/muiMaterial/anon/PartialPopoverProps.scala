...
/* Inlined std.Partial<@mui/material.@mui/material/Popover.PopoverProps> */
@js.native
trait PartialPopoverProps extends StObject {
  ...
  var container: js.UndefOr[
    /* import warning: importer.ImportType#apply Failed type conversion: @mui/material.anon.ModalPropsdefaultComponent['container'] */ js.Any
  ] = js.native
  ...
  var onClose: js.UndefOr[
    /* import warning: importer.ImportType#apply Failed type conversion: @mui/material.anon.ModalPropsdefaultComponent['onClose'] */ js.Any
  ] = js.native
...
object PartialPopoverProps {
  ...
  implicit class PartialPopoverPropsMutableBuilder[Self <: PartialPopoverProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setContainer(
      value: /* import warning: importer.ImportType#apply Failed type conversion: @mui/material.anon.ModalPropsdefaultComponent['container'] */ js.Any
    ...
    @scala.inline
    def setOnClose(
      value: /* import warning: importer.ImportType#apply Failed type conversion: @mui/material.anon.ModalPropsdefaultComponent['onClose'] */ js.Any
