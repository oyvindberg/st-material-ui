...
trait PartialAccordionProps extends StObject {
  ...
  var children: js.UndefOr[ReactElement | String | Double | Any | ReactPortal | Boolean] = js.native
  ...
  var onChange: js.UndefOr[
    js.Function2[/* event */ SyntheticEvent[Event, Element], /* expanded */ Boolean, Unit]
  ] = js.native
...
object PartialAccordionProps {
  ...
  implicit class PartialAccordionPropsMutableBuilder[Self <: PartialAccordionProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnChange(value: (/* event */ SyntheticEvent[Event, Element], /* expanded */ Boolean) => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction2(value))
