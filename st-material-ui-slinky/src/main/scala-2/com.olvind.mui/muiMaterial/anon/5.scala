...
object `5` {
  ...
  @scala.inline
  def apply[P, D /* <: ReactElement */](defaultComponent: D, props: P with FocusVisibleClassName): `5`[P, D] = {
    val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
    __obj.asInstanceOf[`5`[P, D]]
  }
  
  @scala.inline
  implicit class `5MutableBuilder`[Self <: `5`[_, _], P, D /* <: ReactElement */] (val x: Self with (`5`[P, D])) extends AnyVal {
