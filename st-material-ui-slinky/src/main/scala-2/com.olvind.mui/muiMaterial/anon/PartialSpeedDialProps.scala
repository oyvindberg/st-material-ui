...
object PartialSpeedDialProps {
  ...
  implicit class PartialSpeedDialPropsMutableBuilder[Self <: PartialSpeedDialProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTransitionComponent(value: com.olvind.mui.muiMaterial.transitionMod.TransitionProps => ReactElement | Null): Self = StObject.set(x, "TransitionComponent", js.Any.fromFunction1(value))
