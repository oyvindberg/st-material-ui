...
object `29` {
  ...
  @scala.inline
  def apply[P, D /* <: ReactElement */](defaultComponent: D, props: P with IconPosition): `29`[P, D] = {
    val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
    __obj.asInstanceOf[`29`[P, D]]
  }
  
  @scala.inline
  implicit class `29MutableBuilder`[Self <: `29`[_, _], P, D /* <: ReactElement */] (val x: Self with (`29`[P, D])) extends AnyVal {
