...
/* Inlined @mui/material.@mui/material/Modal.ModalProps<@mui/material.@mui/material/Modal/Modal.ModalTypeMap<'div', {}>['defaultComponent'], {}> */
@js.native
trait ModalPropsModalTypeMapdivdefaultComponenAbout extends StObject {
...
object ModalPropsModalTypeMapdivdefaultComponenAbout {
  
  @scala.inline
  def apply(children: ReactElement, open: Boolean): ModalPropsModalTypeMapdivdefaultComponenAbout = {
    val __obj = js.Dynamic.literal(children = children.asInstanceOf[js.Any], open = open.asInstanceOf[js.Any])
    __obj.asInstanceOf[ModalPropsModalTypeMapdivdefaultComponenAbout]
  }
  
  @scala.inline
  implicit class ModalPropsModalTypeMapdivdefaultComponenAboutMutableBuilder[Self <: ModalPropsModalTypeMapdivdefaultComponenAbout] (val x: Self) extends AnyVal {
