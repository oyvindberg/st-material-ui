...
trait SliderPropsSliderTypeMapspandefaultCompo extends StObject {
  ...
  /**
    ...
    * @default (x) => x
    */
  var valueLabelFormat: js.UndefOr[String | (js.Function2[/* value */ Double, /* index */ Double, ReactElement])] = js.native
...
object SliderPropsSliderTypeMapspandefaultCompo {
  ...
  implicit class SliderPropsSliderTypeMapspandefaultCompoMutableBuilder[Self <: SliderPropsSliderTypeMapspandefaultCompo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRefReactRef(value: ReactRef[HTMLSpanElement]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setValueLabelFormat(value: String | (js.Function2[/* value */ Double, /* index */ Double, ReactElement])): Self = StObject.set(x, "valueLabelFormat", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setValueLabelFormatFunction2(value: (/* value */ Double, /* index */ Double) => ReactElement): Self = StObject.set(x, "valueLabelFormat", js.Any.fromFunction2(value))
