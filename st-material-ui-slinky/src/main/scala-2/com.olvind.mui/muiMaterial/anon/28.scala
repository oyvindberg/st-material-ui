...
trait `28` extends StObject {
  ...
  var props: js.Object with ClassesColor = js.native
}
object `28` {
  
  @scala.inline
  def apply(props: js.Object with ClassesColor): `28` = {
  ...
  implicit class `28MutableBuilder`[Self <: `28`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setProps(value: js.Object with ClassesColor): Self = StObject.set(x, "props", value.asInstanceOf[js.Any])
  }
}
