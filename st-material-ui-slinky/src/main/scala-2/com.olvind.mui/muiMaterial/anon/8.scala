...
object `8` {
  ...
  @scala.inline
  def apply[DefaultComponent /* <: ReactElement */](): `8`[DefaultComponent] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[`8`[DefaultComponent]]
  }
  
  @scala.inline
  implicit class `8MutableBuilder`[Self <: `8`[_], DefaultComponent /* <: ReactElement */] (val x: Self with `8`[DefaultComponent]) extends AnyVal {
