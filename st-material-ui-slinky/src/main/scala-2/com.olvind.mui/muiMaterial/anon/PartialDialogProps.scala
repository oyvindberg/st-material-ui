...
/* Inlined std.Partial<@mui/material.@mui/material/Dialog.DialogProps> */
@js.native
trait PartialDialogProps extends StObject {
  ...
  var PaperComponent: js.UndefOr[JSXElementConstructor[PaperPropsdiv]] = js.native
  ...
  var classes: js.UndefOr[PartialDialogClasses] = js.native
  ...
  var onBackdropClick: js.UndefOr[
    /* import warning: importer.ImportType#apply Failed type conversion: @mui/material.anon.ModalPropsdefaultComponent['onBackdropClick'] */ js.Any
  ] = js.native
  ...
  var open: js.UndefOr[
    /* import warning: importer.ImportType#apply Failed type conversion: @mui/material.anon.ModalPropsdefaultComponent['open'] */ js.Any
  ] = js.native
...
object PartialDialogProps {
  ...
  implicit class PartialDialogPropsMutableBuilder[Self <: PartialDialogProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialDialogClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnBackdropClick(
      value: /* import warning: importer.ImportType#apply Failed type conversion: @mui/material.anon.ModalPropsdefaultComponent['onBackdropClick'] */ js.Any
    ): Self = StObject.set(x, "onBackdropClick", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOpen(
      value: /* import warning: importer.ImportType#apply Failed type conversion: @mui/material.anon.ModalPropsdefaultComponent['open'] */ js.Any
    ...
    @scala.inline
    def setPaperComponent(value: PaperPropsdiv => ReactElement | Null): Self = StObject.set(x, "PaperComponent", js.Any.fromFunction1(value))
