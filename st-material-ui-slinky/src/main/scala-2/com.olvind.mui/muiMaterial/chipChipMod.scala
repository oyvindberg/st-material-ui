...
object chipChipMod extends Shortcut {
  ...
  object ChipTypeMap {
    ...
    @scala.inline
    def apply[P, D /* <: ReactElement */](defaultComponent: D, props: P with Clickable): ChipTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[ChipTypeMap[P, D]]
    }
    
    @scala.inline
    implicit class ChipTypeMapMutableBuilder[Self <: ChipTypeMap[_, _], P, D /* <: ReactElement */] (val x: Self with (ChipTypeMap[P, D])) extends AnyVal {
