...
object mobileStepperMobileStepperMod {
  ...
  object MobileStepperProps {
    ...
    @scala.inline
    def apply(backButton: ReactElement, nextButton: ReactElement, steps: Double): MobileStepperProps = {
    ...
    implicit class MobileStepperPropsMutableBuilder[Self <: MobileStepperProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setBackButton(value: ReactElement): Self = StObject.set(x, "backButton", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setNextButton(value: ReactElement): Self = StObject.set(x, "nextButton", value.asInstanceOf[js.Any])
