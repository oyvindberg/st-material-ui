...
package object mod {
  ...
  type AnimationEventHandler[T] = com.olvind.mui.react.mod.EventHandler[slinky.web.SyntheticAnimationEvent[T]]
  ...
  */
  ...
  type ChangeEventHandler[T] = com.olvind.mui.react.mod.EventHandler[com.olvind.mui.react.mod.ChangeEvent[T]]
  
  type ClipboardEventHandler[T] = com.olvind.mui.react.mod.EventHandler[slinky.web.SyntheticClipboardEvent[T]]
  ...
  type ComponentPropsWithRef[T /* <: slinky.core.facade.ReactElement */] = com.olvind.mui.react.mod.PropsWithRef[com.olvind.mui.react.mod.ComponentProps[T]] | (com.olvind.mui.react.mod.PropsWithoutRef[scala.Any] with com.olvind.mui.react.mod.RefAttributes[com.olvind.mui.std.InstanceType[T]])
  
  type CompositionEventHandler[T] = com.olvind.mui.react.mod.EventHandler[slinky.web.SyntheticCompositionEvent[T]]
  ...
  type DragEventHandler[T] = com.olvind.mui.react.mod.EventHandler[com.olvind.mui.react.mod.DragEvent[T]]
  ...
  type FocusEventHandler[T] = com.olvind.mui.react.mod.EventHandler[slinky.web.SyntheticFocusEvent[T]]
  
  type FormEventHandler[T] = com.olvind.mui.react.mod.EventHandler[
  ...
  */
  ...
  type JSXElementConstructor[P] = js.Function1[/* props */ P, slinky.core.facade.ReactElement | scala.Null]
  
  type Key = java.lang.String | scala.Double
  
  type KeyboardEventHandler[T] = com.olvind.mui.react.mod.EventHandler[slinky.web.SyntheticKeyboardEvent[T]]
  ...
  type MouseEventHandler[T] = com.olvind.mui.react.mod.EventHandler[slinky.web.SyntheticMouseEvent[T]]
  ...
  type PointerEventHandler[T] = com.olvind.mui.react.mod.EventHandler[slinky.web.SyntheticPointerEvent[T]]
  ...
  type ReactEventHandler[T] = com.olvind.mui.react.mod.EventHandler[slinky.core.SyntheticEvent[org.scalajs.dom.Event, T]]
  ...
  type Ref[T] = com.olvind.mui.react.mod.RefCallback[T] | slinky.core.facade.ReactRef[T] | scala.Null
  ...
  type TouchEventHandler[T] = com.olvind.mui.react.mod.EventHandler[slinky.web.SyntheticTouchEvent[T]]
  
  type TransitionEventHandler[T] = com.olvind.mui.react.mod.EventHandler[slinky.web.SyntheticTransitionEvent[T]]
  
  type UIEventHandler[T] = com.olvind.mui.react.mod.EventHandler[slinky.web.SyntheticUIEvent[T]]
  ...
  type WheelEventHandler[T] = com.olvind.mui.react.mod.EventHandler[slinky.web.SyntheticWheelEvent[T]]
}
