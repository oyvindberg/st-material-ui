...
/* Rewritten from type alias, can be one of: 
  ...
  - `com.olvind.mui`.csstype.csstypeStrings.manual
...
object Hyphens {
  ...
  @scala.inline
  def manual: com.olvind.mui.csstype.csstypeStrings.manual = "manual".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.manual]
