...
/* Rewritten from type alias, can be one of: 
  ...
  - `com.olvind.mui`.csstype.csstypeStrings.railed
...
*/
trait MsScrollRails extends StObject
object MsScrollRails {
  ...
  @scala.inline
  def railed: com.olvind.mui.csstype.csstypeStrings.railed = "railed".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.railed]
