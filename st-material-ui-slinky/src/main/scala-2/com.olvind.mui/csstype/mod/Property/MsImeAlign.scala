...
/* Rewritten from type alias, can be one of: 
  - `com.olvind.mui`.csstype.csstypeStrings.after
...
object MsImeAlign {
  ...
  @scala.inline
  def after: com.olvind.mui.csstype.csstypeStrings.after = "after".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.after]
