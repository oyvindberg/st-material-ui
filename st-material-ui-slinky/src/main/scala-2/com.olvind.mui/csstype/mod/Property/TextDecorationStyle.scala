...
/* Rewritten from type alias, can be one of: 
  ...
  - `com.olvind.mui`.csstype.csstypeStrings.wavy
...
*/
trait TextDecorationStyle extends StObject
object TextDecorationStyle {
  ...
  @scala.inline
  def wavy: com.olvind.mui.csstype.csstypeStrings.wavy = "wavy".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.wavy]
}
