...
/* Rewritten from type alias, can be one of: 
  ...
  - `com.olvind.mui`.csstype.csstypeStrings.crispEdges
...
object ShapeRendering {
  ...
  @scala.inline
  def crispEdges: com.olvind.mui.csstype.csstypeStrings.crispEdges = "crispEdges".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.crispEdges]
