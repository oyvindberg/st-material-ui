...
/* Rewritten from type alias, can be one of: 
  - `com.olvind.mui`.csstype.csstypeStrings.contain
  - `com.olvind.mui`.csstype.csstypeStrings.cover
  - `com.olvind.mui`.csstype.csstypeStrings.fill
  - `com.olvind.mui`.csstype.csstypeStrings.none
  - `com.olvind.mui`.csstype.csstypeStrings.`scale-down`
...
object ObjectFit {
  ...
  @scala.inline
  def contain: com.olvind.mui.csstype.csstypeStrings.contain = "contain".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.contain]
  
  @scala.inline
  def cover: com.olvind.mui.csstype.csstypeStrings.cover = "cover".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.cover]
  
  @scala.inline
  def fill: com.olvind.mui.csstype.csstypeStrings.fill = "fill".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.fill]
  ...
  @scala.inline
  def `scale-down`: com.olvind.mui.csstype.csstypeStrings.`scale-down` = "scale-down".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.`scale-down`]
