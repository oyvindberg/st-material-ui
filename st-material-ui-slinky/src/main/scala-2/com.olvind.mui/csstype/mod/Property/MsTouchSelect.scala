...
/* Rewritten from type alias, can be one of: 
  - `com.olvind.mui`.csstype.csstypeStrings.grippers
...
*/
trait MsTouchSelect extends StObject
object MsTouchSelect {
  ...
  @scala.inline
  def grippers: com.olvind.mui.csstype.csstypeStrings.grippers = "grippers".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.grippers]
