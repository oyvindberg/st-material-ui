...
/* Rewritten from type alias, can be one of: 
  ...
  - `com.olvind.mui`.csstype.csstypeStrings.thin
...
*/
trait ScrollbarWidth extends StObject
object ScrollbarWidth {
  ...
  @scala.inline
  def thin: com.olvind.mui.csstype.csstypeStrings.thin = "thin".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.thin]
