...
/* Rewritten from type alias, can be one of: 
  ...
  - `com.olvind.mui`.csstype.csstypeStrings.collapse
  - `com.olvind.mui`.csstype.csstypeStrings.separate
...
*/
trait RubyMerge extends StObject
object RubyMerge {
  ...
  @scala.inline
  def collapse: com.olvind.mui.csstype.csstypeStrings.collapse = "collapse".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.collapse]
  ...
  @scala.inline
  def separate: com.olvind.mui.csstype.csstypeStrings.separate = "separate".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.separate]
