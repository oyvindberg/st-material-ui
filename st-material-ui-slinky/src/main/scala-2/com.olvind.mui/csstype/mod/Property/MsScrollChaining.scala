...
/* Rewritten from type alias, can be one of: 
  - `com.olvind.mui`.csstype.csstypeStrings.chained
...
*/
trait MsScrollChaining extends StObject
object MsScrollChaining {
  ...
  @scala.inline
  def chained: com.olvind.mui.csstype.csstypeStrings.chained = "chained".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.chained]
