...
/* Rewritten from type alias, can be one of: 
  ...
  - `com.olvind.mui`.csstype.csstypeStrings.clear
  - `com.olvind.mui`.csstype.csstypeStrings.end
  - `com.olvind.mui`.csstype.csstypeStrings.maximum
...
*/
trait MsWrapFlow extends StObject
object MsWrapFlow {
  ...
  @scala.inline
  def clear: com.olvind.mui.csstype.csstypeStrings.clear = "clear".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.clear]
  ...
  @scala.inline
  def maximum: com.olvind.mui.csstype.csstypeStrings.maximum = "maximum".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.maximum]
