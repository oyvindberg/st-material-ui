...
/* Rewritten from type alias, can be one of: 
  ...
  - `com.olvind.mui`.csstype.csstypeStrings.enabled
...
object MozUserInput {
  ...
  @scala.inline
  def disabled: com.olvind.mui.csstype.csstypeStrings.disabled = "disabled".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.disabled]
  
  @scala.inline
  def enabled: com.olvind.mui.csstype.csstypeStrings.enabled = "enabled".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.enabled]
