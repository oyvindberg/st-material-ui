...
/* Rewritten from type alias, can be one of: 
  ...
  - `com.olvind.mui`.csstype.csstypeStrings.linearRGB
  - `com.olvind.mui`.csstype.csstypeStrings.sRGB
...
*/
trait ColorInterpolation extends StObject
object ColorInterpolation {
  ...
  @scala.inline
  def linearRGB: com.olvind.mui.csstype.csstypeStrings.linearRGB = "linearRGB".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.linearRGB]
  
  @scala.inline
  def revert: com.olvind.mui.csstype.csstypeStrings.revert = "revert".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.revert]
  
  @scala.inline
  def sRGB: com.olvind.mui.csstype.csstypeStrings.sRGB = "sRGB".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.sRGB]
