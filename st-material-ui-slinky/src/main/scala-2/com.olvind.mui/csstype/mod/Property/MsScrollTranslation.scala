...
/* Rewritten from type alias, can be one of: 
  ...
  - `com.olvind.mui`.csstype.csstypeStrings.`vertical-to-horizontal`
...
*/
trait MsScrollTranslation extends StObject
object MsScrollTranslation {
  ...
  @scala.inline
  def `vertical-to-horizontal`: com.olvind.mui.csstype.csstypeStrings.`vertical-to-horizontal` = "vertical-to-horizontal".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.`vertical-to-horizontal`]
}
