...
import com.olvind.mui.csstype.csstypeStrings.scrollbar_
...
/* Rewritten from type alias, can be one of: 
  - `com.olvind.mui`.csstype.csstypeStrings.`-ms-autohiding-scrollbar`
  - `com.olvind.mui`.csstype.csstypeStrings.auto
  - `com.olvind.mui`.csstype.csstypeStrings.none
  - `com.olvind.mui`.csstype.csstypeStrings.scrollbar_
...
object MsOverflowStyle {
  ...
  @scala.inline
  def `-ms-autohiding-scrollbar`: com.olvind.mui.csstype.csstypeStrings.`-ms-autohiding-scrollbar` = "-ms-autohiding-scrollbar".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.`-ms-autohiding-scrollbar`]
