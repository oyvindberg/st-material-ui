...
/* Rewritten from type alias, can be one of: 
  - `com.olvind.mui`.csstype.csstypeStrings.anywhere
  - `com.olvind.mui`.csstype.csstypeStrings.auto
  - `com.olvind.mui`.csstype.csstypeStrings.loose
  - `com.olvind.mui`.csstype.csstypeStrings.normal
  - `com.olvind.mui`.csstype.csstypeStrings.strict
...
object LineBreak {
  ...
  @scala.inline
  def anywhere: com.olvind.mui.csstype.csstypeStrings.anywhere = "anywhere".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.anywhere]
  ...
  @scala.inline
  def loose: com.olvind.mui.csstype.csstypeStrings.loose = "loose".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.loose]
  ...
  @scala.inline
  def strict: com.olvind.mui.csstype.csstypeStrings.strict = "strict".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.strict]
