...
/* Rewritten from type alias, can be one of: 
  - `com.olvind.mui`.csstype.csstypeStrings.bt
  - `com.olvind.mui`.csstype.csstypeStrings.lr
  - `com.olvind.mui`.csstype.csstypeStrings.rl
  - `com.olvind.mui`.csstype.csstypeStrings.tb
...
object MsBlockProgression {
  ...
  @scala.inline
  def bt: com.olvind.mui.csstype.csstypeStrings.bt = "bt".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.bt]
  ...
  @scala.inline
  def lr: com.olvind.mui.csstype.csstypeStrings.lr = "lr".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.lr]
  
  @scala.inline
  def revert: com.olvind.mui.csstype.csstypeStrings.revert = "revert".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.revert]
  
  @scala.inline
  def rl: com.olvind.mui.csstype.csstypeStrings.rl = "rl".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.rl]
  
  @scala.inline
  def tb: com.olvind.mui.csstype.csstypeStrings.tb = "tb".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.tb]
