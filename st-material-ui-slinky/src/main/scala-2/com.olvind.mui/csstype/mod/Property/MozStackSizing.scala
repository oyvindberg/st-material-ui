...
object MozStackSizing {
  ...
  @scala.inline
  def `stretch-to-fit`: com.olvind.mui.csstype.csstypeStrings.`stretch-to-fit` = "stretch-to-fit".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.`stretch-to-fit`]
