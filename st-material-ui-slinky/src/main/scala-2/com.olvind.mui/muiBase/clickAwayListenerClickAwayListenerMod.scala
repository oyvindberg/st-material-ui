...
object clickAwayListenerClickAwayListenerMod {
  ...
  */
  ...
  object ClickAwayMouseEventHandler {
    ...
    @scala.inline
    def onClick: com.olvind.mui.muiBase.muiBaseStrings.onClick = "onClick".asInstanceOf[com.olvind.mui.muiBase.muiBaseStrings.onClick]
    
    @scala.inline
    def onMouseDown: com.olvind.mui.muiBase.muiBaseStrings.onMouseDown = "onMouseDown".asInstanceOf[com.olvind.mui.muiBase.muiBaseStrings.onMouseDown]
    
    @scala.inline
    def onMouseUp: com.olvind.mui.muiBase.muiBaseStrings.onMouseUp = "onMouseUp".asInstanceOf[com.olvind.mui.muiBase.muiBaseStrings.onMouseUp]
  }
  ...
  */
  ...
  object ClickAwayTouchEventHandler {
    ...
    @scala.inline
    def onTouchEnd: com.olvind.mui.muiBase.muiBaseStrings.onTouchEnd = "onTouchEnd".asInstanceOf[com.olvind.mui.muiBase.muiBaseStrings.onTouchEnd]
    
    @scala.inline
    def onTouchStart: com.olvind.mui.muiBase.muiBaseStrings.onTouchStart = "onTouchStart".asInstanceOf[com.olvind.mui.muiBase.muiBaseStrings.onTouchStart]
  }
}
