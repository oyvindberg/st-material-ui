...
/* Inlined @mui/base.@mui/base/SliderUnstyled/SliderUnstyled.SliderUnstyledTypeMap<{}, 'span'>['props'] */
@js.native
...
object SliderUnstyledTypeMapspanprops {
  ...
  @scala.inline
  def apply(): SliderUnstyledTypeMapspanprops = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SliderUnstyledTypeMapspanprops]
  }
  
  @scala.inline
  implicit class SliderUnstyledTypeMapspanpropsMutableBuilder[Self <: SliderUnstyledTypeMapspanprops] (val x: Self) extends AnyVal {
