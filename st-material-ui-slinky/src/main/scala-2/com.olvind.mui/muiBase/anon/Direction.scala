...
object Direction {
  ...
  @scala.inline
  def apply(onSelected: (Any, Any) => Unit, value: String | Double | `false`): Direction = {
  ...
  implicit class DirectionMutableBuilder[Self <: Direction] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnSelected(value: (Any, Any) => Unit): Self = StObject.set(x, "onSelected", js.Any.fromFunction2(value))
