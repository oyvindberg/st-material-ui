...
/* Inlined @mui/types.@mui/types.DefaultComponentProps<@mui/base.@mui/base/ModalUnstyled/ModalUnstyled.ModalUnstyledTypeMap<{}, 'div'>> */
@js.native
trait DefaultComponentPropsModalUnstyledTypeMa extends StObject {
...
object DefaultComponentPropsModalUnstyledTypeMa {
  
  @scala.inline
  def apply(children: ReactElement, open: Boolean): DefaultComponentPropsModalUnstyledTypeMa = {
    val __obj = js.Dynamic.literal(children = children.asInstanceOf[js.Any], open = open.asInstanceOf[js.Any])
    __obj.asInstanceOf[DefaultComponentPropsModalUnstyledTypeMa]
  }
  
  @scala.inline
  implicit class DefaultComponentPropsModalUnstyledTypeMaMutableBuilder[Self <: DefaultComponentPropsModalUnstyledTypeMa] (val x: Self) extends AnyVal {
