...
object tabsContextMod {
  ...
  trait TabsContextValue extends StObject {
    ...
    def onSelected(event: SyntheticEvent[Event, Element], value: String): Unit = js.native
    /**
      * Callback for setting new value.
      */
    def onSelected(event: SyntheticEvent[Event, Element], value: Double): Unit = js.native
    @JSName("onSelected")
    def onSelected_false(event: SyntheticEvent[Event, Element], value: `false`): Unit = js.native
