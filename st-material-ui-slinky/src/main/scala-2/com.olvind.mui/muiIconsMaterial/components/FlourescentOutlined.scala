...
object FlourescentOutlined {
  
  @JSImport("@mui/icons-material", "FlourescentOutlined")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: FlourescentOutlined.type): SharedBuilder_DefaultComponentPropsSvgIconTypeMapsvg1028217032[SVGSVGElement] = new SharedBuilder_DefaultComponentPropsSvgIconTypeMapsvg1028217032[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
