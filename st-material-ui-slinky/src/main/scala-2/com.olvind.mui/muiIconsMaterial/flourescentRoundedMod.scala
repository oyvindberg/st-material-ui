...
object flourescentRoundedMod {
  ...
  object default {
    ...
    @JSImport("@mui/icons-material/FlourescentRounded", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@mui/icons-material/FlourescentRounded", "default.muiName")
    @js.native
