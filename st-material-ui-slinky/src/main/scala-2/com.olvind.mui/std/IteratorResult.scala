...
object IteratorResult {
  ...
  @scala.inline
  def IteratorReturnResult[TReturn](value: TReturn): com.olvind.mui.std.IteratorReturnResult[TReturn] = {
    val __obj = js.Dynamic.literal(done = true, value = value.asInstanceOf[js.Any])
    __obj.asInstanceOf[com.olvind.mui.std.IteratorReturnResult[TReturn]]
  }
  
  @scala.inline
  def IteratorYieldResult[T](value: T): com.olvind.mui.std.IteratorYieldResult[T] = {
