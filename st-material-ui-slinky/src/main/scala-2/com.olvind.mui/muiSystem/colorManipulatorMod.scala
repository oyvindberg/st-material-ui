...
object colorManipulatorMod {
  ...
  */
  ...
  object ColorFormat {
    ...
    @scala.inline
    def hsl: com.olvind.mui.muiSystem.muiSystemStrings.hsl = "hsl".asInstanceOf[com.olvind.mui.muiSystem.muiSystemStrings.hsl]
    
    @scala.inline
    def hsla: com.olvind.mui.muiSystem.muiSystemStrings.hsla = "hsla".asInstanceOf[com.olvind.mui.muiSystem.muiSystemStrings.hsla]
    
    @scala.inline
    def rgb: com.olvind.mui.muiSystem.muiSystemStrings.rgb = "rgb".asInstanceOf[com.olvind.mui.muiSystem.muiSystemStrings.rgb]
    
    @scala.inline
    def rgba: com.olvind.mui.muiSystem.muiSystemStrings.rgba = "rgba".asInstanceOf[com.olvind.mui.muiSystem.muiSystemStrings.rgba]
  }
  
  @js.native
  trait ColorObject extends StObject {
    
    var colorSpace: js.UndefOr[srgb | `display-p3` | `a98-rgb` | `prophoto-rgb` | `rec-2020`] = js.native
  ...
  object ColorObject {
    ...
    implicit class ColorObjectMutableBuilder[Self <: ColorObject] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setColorSpace(value: srgb | `display-p3` | `a98-rgb` | `prophoto-rgb` | `rec-2020`): Self = StObject.set(x, "colorSpace", value.asInstanceOf[js.Any])
