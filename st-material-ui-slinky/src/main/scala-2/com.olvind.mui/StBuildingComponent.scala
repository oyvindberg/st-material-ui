...
trait StBuildingComponent[E, R <: js.Object] {
...
object StBuildingComponent {
  ...
  class Default[E, R <: js.Object] (val args: js.Array[Any]) extends StBuildingComponent[E, R]
