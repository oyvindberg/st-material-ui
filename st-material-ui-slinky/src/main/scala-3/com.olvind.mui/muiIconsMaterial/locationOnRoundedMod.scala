...
object locationOnRoundedMod {
  ...
  object default {
    ...
    @JSImport("@mui/icons-material/LocationOnRounded", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@mui/icons-material/LocationOnRounded", "default.muiName")
    @js.native
