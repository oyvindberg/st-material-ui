...
object flourescentOutlinedMod {
  ...
  object default {
    ...
    @JSImport("@mui/icons-material/FlourescentOutlined", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@mui/icons-material/FlourescentOutlined", "default.muiName")
    @js.native
