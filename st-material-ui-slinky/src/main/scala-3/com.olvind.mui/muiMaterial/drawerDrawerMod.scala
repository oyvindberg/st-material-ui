...
object drawerDrawerMod {
  ...
  trait DrawerProps extends StObject {
    ...
    /**
      ...
      * @default {}
      */
    var ModalProps: js.UndefOr[PartialModalPropsModalTypeMapdivdefaultC] = js.undefined
  ...
  object DrawerProps {
    ...
    extension [Self <: DrawerProps](x: Self) {
      ...
      inline def setModalProps(value: PartialModalPropsModalTypeMapdivdefaultC): Self = StObject.set(x, "ModalProps", value.asInstanceOf[js.Any])
