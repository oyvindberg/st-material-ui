...
object dialogContentDialogContentMod {
  ...
  inline def default(props: DialogContentProps): Element = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(props.asInstanceOf[js.Any]).asInstanceOf[Element]
  ...
  trait DialogContentProps extends StObject {
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialDialogContentClasses] = js.undefined
  ...
  object DialogContentProps {
    ...
    implicit open class MutableBuilder[Self <: DialogContentProps] (val x: Self) extends AnyVal {
      ...
      inline def setClasses(value: PartialDialogContentClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
