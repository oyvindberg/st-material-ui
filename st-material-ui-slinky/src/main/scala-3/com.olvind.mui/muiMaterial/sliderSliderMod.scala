...
object sliderSliderMod extends Shortcut {
  ...
  trait SliderOwnerState extends StObject {
    ...
    var onChangeCommitted: js.UndefOr[
        js.Function2[
          /* event */ (SyntheticEvent[Event, org.scalajs.dom.Element]) | Event, 
          /* value */ Double | js.Array[Double], 
          Unit
        ]
      ] = js.undefined
  ...
  object SliderOwnerState {
    ...
    implicit open class MutableBuilder[Self <: SliderOwnerState] (val x: Self) extends AnyVal {
      ...
      inline def setOnChangeCommitted(
        value: (/* event */ (SyntheticEvent[Event, org.scalajs.dom.Element]) | Event, /* value */ Double | js.Array[Double]) => Unit
  ...
  trait SliderTypeMap[D /* <: ReactElement */, P] extends StObject {
  ...
  object SliderTypeMap {
    ...
    inline def apply[D /* <: ReactElement */, P](defaultComponent: D, props: P & Arialabel): SliderTypeMap[D, P] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[SliderTypeMap[D, P]]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: SliderTypeMap[?, ?], D /* <: ReactElement */, P] (val x: Self & (SliderTypeMap[D, P])) extends AnyVal {
  ...
  trait SliderValueLabelProps
    ...
    @JSName("children")
    var children_SliderValueLabelProps: ReactElement
  ...
  object SliderValueLabelProps {
    ...
    inline def apply(children: ReactElement, index: Double, open: Boolean, value: Double): SliderValueLabelProps = {
      val __obj = js.Dynamic.literal(children = children.asInstanceOf[js.Any], index = index.asInstanceOf[js.Any], open = open.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
