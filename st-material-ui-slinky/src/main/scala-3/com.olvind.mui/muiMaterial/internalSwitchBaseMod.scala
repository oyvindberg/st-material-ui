...
object internalSwitchBaseMod extends Shortcut {
  ...
  trait SwitchBaseProps extends StObject {
    ...
    var action: js.UndefOr[Ref[ButtonBaseActions]] = js.undefined
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialSwitchBaseClasses] = js.undefined
    ...
    var touchRippleRef: js.UndefOr[Ref[TouchRippleActions]] = js.undefined
  ...
  object SwitchBaseProps {
    ...
    inline def apply(checkedIcon: ReactElement, icon: ReactElement): SwitchBaseProps = {
    ...
    extension [Self <: SwitchBaseProps](x: Self) {
      ...
      inline def setAction(value: Ref[ButtonBaseActions]): Self = StObject.set(x, "action", value.asInstanceOf[js.Any])
      ...
      inline def setClasses(value: PartialSwitchBaseClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      inline def setTouchRippleRef(value: Ref[TouchRippleActions]): Self = StObject.set(x, "touchRippleRef", value.asInstanceOf[js.Any])
