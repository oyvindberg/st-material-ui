...
object accordionActionsAccordionActionsMod {
  ...
  trait AccordionActionsProps extends StObject {
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialAccordionActionsClasses] = js.undefined
  ...
  object AccordionActionsProps {
    ...
    inline def apply(): AccordionActionsProps = {
    ...
    extension [Self <: AccordionActionsProps](x: Self) {
      ...
      inline def setClasses(value: PartialAccordionActionsClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
