...
object radioRadioMod {
  ...
  trait RadioProps extends StObject {
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialRadioClasses] = js.undefined
  ...
  object RadioProps {
    ...
    implicit open class MutableBuilder[Self <: RadioProps] (val x: Self) extends AnyVal {
      ...
      inline def setClasses(value: PartialRadioClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
