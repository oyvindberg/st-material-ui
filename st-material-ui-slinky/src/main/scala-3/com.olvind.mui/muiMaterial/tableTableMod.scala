...
object tableTableMod extends Shortcut {
  ...
  object TableTypeMap {
    ...
    inline def apply[P, D /* <: ReactElement */](defaultComponent: D, props: P & Padding): TableTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[TableTypeMap[P, D]]
    }
    
    extension [Self <: TableTypeMap[?, ?], P, D /* <: ReactElement */](x: Self & (TableTypeMap[P, D])) {
