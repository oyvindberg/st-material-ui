...
object cardHeaderCardHeaderMod extends Shortcut {
  ...
  object CardHeaderTypeMap {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: CardHeaderTypeMap[?, ?, ?, ?], Props, DefaultComponent /* <: ReactElement */, TitleTypographyComponent /* <: ReactElement */, SubheaderTypographyComponent /* <: ReactElement */] (val x: Self & (CardHeaderTypeMap[Props, DefaultComponent, TitleTypographyComponent, SubheaderTypographyComponent])) extends AnyVal {
