...
object PartialSpeedDialProps {
  ...
  implicit open class MutableBuilder[Self <: PartialSpeedDialProps] (val x: Self) extends AnyVal {
    ...
    inline def setTransitionComponent(value: com.olvind.mui.muiMaterial.transitionsTransitionMod.TransitionProps => ReactElement | Null): Self = StObject.set(x, "TransitionComponent", js.Any.fromFunction1(value))
