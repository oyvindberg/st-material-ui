...
object PartialSpeedDialProps {
  ...
  extension [Self <: PartialSpeedDialProps](x: Self) {
    ...
    inline def setTransitionComponent(value: com.olvind.mui.muiMaterial.transitionMod.TransitionProps => ReactElement | Null): Self = StObject.set(x, "TransitionComponent", js.Any.fromFunction1(value))
