...
trait PartialStepContentProps extends StObject {
  ...
  var classes: js.UndefOr[PartialStepContentClasses] = js.undefined
...
object PartialStepContentProps {
  ...
  inline def apply(): PartialStepContentProps = {
  ...
  extension [Self <: PartialStepContentProps](x: Self) {
    ...
    inline def setClasses(value: PartialStepContentClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
