...
trait `60` extends StObject {
  ...
  var styleOverrides: js.UndefOr[PartialOverridesStyleRulesDialogClassKey] = js.undefined
...
object `60` {
  ...
  extension [Self <: `60`](x: Self) {
    ...
    inline def setStyleOverrides(value: PartialOverridesStyleRulesDialogClassKey): Self = StObject.set(x, "styleOverrides", value.asInstanceOf[js.Any])
