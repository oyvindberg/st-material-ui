...
object OverridePropsExtendButtonBaseTypeMapStep {
  ...
  inline def apply(href: String): OverridePropsExtendButtonBaseTypeMapStep = {
    val __obj = js.Dynamic.literal(href = href.asInstanceOf[js.Any])
    __obj.asInstanceOf[OverridePropsExtendButtonBaseTypeMapStep]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: OverridePropsExtendButtonBaseTypeMapStep] (val x: Self) extends AnyVal {
