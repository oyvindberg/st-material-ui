...
/* Inlined @mui/types.@mui/types.DefaultComponentProps<@mui/base.@mui/base/SliderUnstyled/SliderUnstyled.types.ExtendSliderUnstyledTypeMap<@mui/material.@mui/material/Slider/Slider.SliderTypeMap<'span', {}>>> */
...
object DefaultComponentPropsExtendSliderUnstyle {
  ...
  inline def apply(): DefaultComponentPropsExtendSliderUnstyle = {
