...
/* Inlined std.Partial<@mui/material.@mui/material/ListItemText/listItemTextClasses.ListItemTextClasses> */
trait PartialListItemTextClasses extends StObject {
...
object PartialListItemTextClasses {
  
  inline def apply(): PartialListItemTextClasses = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialListItemTextClasses]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialListItemTextClasses] (val x: Self) extends AnyVal {
