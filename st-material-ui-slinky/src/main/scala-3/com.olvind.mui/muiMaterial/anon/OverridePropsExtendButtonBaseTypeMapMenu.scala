...
object OverridePropsExtendButtonBaseTypeMapMenu {
  ...
  inline def apply(href: String): OverridePropsExtendButtonBaseTypeMapMenu = {
    val __obj = js.Dynamic.literal(href = href.asInstanceOf[js.Any])
    __obj.asInstanceOf[OverridePropsExtendButtonBaseTypeMapMenu]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: OverridePropsExtendButtonBaseTypeMapMenu] (val x: Self) extends AnyVal {
