...
object OverridePropsExtendButtonBaseTypeMapIcon {
  ...
  inline def apply(href: String): OverridePropsExtendButtonBaseTypeMapIcon = {
    val __obj = js.Dynamic.literal(href = href.asInstanceOf[js.Any])
    __obj.asInstanceOf[OverridePropsExtendButtonBaseTypeMapIcon]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: OverridePropsExtendButtonBaseTypeMapIcon] (val x: Self) extends AnyVal {
