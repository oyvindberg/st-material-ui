...
object DefaultComponentPropsExtendButtonBaseTypAriacolindex {
  ...
  inline def apply(): DefaultComponentPropsExtendButtonBaseTypAriacolindex = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsExtendButtonBaseTypAriacolindex]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DefaultComponentPropsExtendButtonBaseTypAriacolindex] (val x: Self) extends AnyVal {
