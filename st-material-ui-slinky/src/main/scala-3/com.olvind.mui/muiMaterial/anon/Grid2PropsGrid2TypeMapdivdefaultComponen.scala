...
/* Inlined @mui/material.@mui/material/Unstable_Grid2.Grid2Props<@mui/material.@mui/material/Unstable_Grid2/Grid2Props.Grid2TypeMap<{}, 'div'>['defaultComponent'], {  component :react.react.ElementType<any> | undefined}> */
trait Grid2PropsGrid2TypeMapdivdefaultComponen extends StObject {
...
object Grid2PropsGrid2TypeMapdivdefaultComponen {
  
  inline def apply(): Grid2PropsGrid2TypeMapdivdefaultComponen = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Grid2PropsGrid2TypeMapdivdefaultComponen]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Grid2PropsGrid2TypeMapdivdefaultComponen] (val x: Self) extends AnyVal {
