...
/* Inlined std.Partial<@mui/material.@mui/material/Button/buttonClasses.ButtonClasses> */
trait PartialButtonClasses extends StObject {
  ...
  var containedSizeLarge: js.UndefOr[String] = js.undefined
  ...
  var endIcon: js.UndefOr[String] = js.undefined
  
  var focusVisible: js.UndefOr[String] = js.undefined
  
  var fullWidth: js.UndefOr[String] = js.undefined
  
  var iconSizeLarge: js.UndefOr[String] = js.undefined
  
  var iconSizeMedium: js.UndefOr[String] = js.undefined
  
  var iconSizeSmall: js.UndefOr[String] = js.undefined
  ...
  var outlinedSizeLarge: js.UndefOr[String] = js.undefined
  ...
  var startIcon: js.UndefOr[String] = js.undefined
  ...
  var textSizeLarge: js.UndefOr[String] = js.undefined
...
object PartialButtonClasses {
  ...
  inline def apply(): PartialButtonClasses = {
  ...
  implicit open class MutableBuilder[Self <: PartialButtonClasses] (val x: Self) extends AnyVal {
    ...
    inline def setContainedInheritUndefined: Self = StObject.set(x, "containedInherit", js.undefined)
    
    inline def setContainedPrimary(value: String): Self = StObject.set(x, "containedPrimary", value.asInstanceOf[js.Any])
    
    inline def setContainedPrimaryUndefined: Self = StObject.set(x, "containedPrimary", js.undefined)
    
    inline def setContainedSecondary(value: String): Self = StObject.set(x, "containedSecondary", value.asInstanceOf[js.Any])
    
    inline def setContainedSecondaryUndefined: Self = StObject.set(x, "containedSecondary", js.undefined)
    
    inline def setContainedSizeLarge(value: String): Self = StObject.set(x, "containedSizeLarge", value.asInstanceOf[js.Any])
    
    inline def setContainedSizeLargeUndefined: Self = StObject.set(x, "containedSizeLarge", js.undefined)
    
    inline def setContainedSizeMedium(value: String): Self = StObject.set(x, "containedSizeMedium", value.asInstanceOf[js.Any])
    
    inline def setContainedSizeMediumUndefined: Self = StObject.set(x, "containedSizeMedium", js.undefined)
    ...
    inline def setIconSizeLargeUndefined: Self = StObject.set(x, "iconSizeLarge", js.undefined)
    
    inline def setIconSizeMedium(value: String): Self = StObject.set(x, "iconSizeMedium", value.asInstanceOf[js.Any])
    
    inline def setIconSizeMediumUndefined: Self = StObject.set(x, "iconSizeMedium", js.undefined)
    
    inline def setIconSizeSmall(value: String): Self = StObject.set(x, "iconSizeSmall", value.asInstanceOf[js.Any])
    
    inline def setIconSizeSmallUndefined: Self = StObject.set(x, "iconSizeSmall", js.undefined)
    ...
    inline def setOutlinedSizeLargeUndefined: Self = StObject.set(x, "outlinedSizeLarge", js.undefined)
    
    inline def setOutlinedSizeMedium(value: String): Self = StObject.set(x, "outlinedSizeMedium", value.asInstanceOf[js.Any])
    
    inline def setOutlinedSizeMediumUndefined: Self = StObject.set(x, "outlinedSizeMedium", js.undefined)
    ...
    inline def setTextInheritUndefined: Self = StObject.set(x, "textInherit", js.undefined)
    
    inline def setTextPrimary(value: String): Self = StObject.set(x, "textPrimary", value.asInstanceOf[js.Any])
    
    inline def setTextPrimaryUndefined: Self = StObject.set(x, "textPrimary", js.undefined)
    
    inline def setTextSecondary(value: String): Self = StObject.set(x, "textSecondary", value.asInstanceOf[js.Any])
    
    inline def setTextSecondaryUndefined: Self = StObject.set(x, "textSecondary", js.undefined)
    
    inline def setTextSizeLarge(value: String): Self = StObject.set(x, "textSizeLarge", value.asInstanceOf[js.Any])
    
    inline def setTextSizeLargeUndefined: Self = StObject.set(x, "textSizeLarge", js.undefined)
    
    inline def setTextSizeMedium(value: String): Self = StObject.set(x, "textSizeMedium", value.asInstanceOf[js.Any])
    
    inline def setTextSizeMediumUndefined: Self = StObject.set(x, "textSizeMedium", js.undefined)
