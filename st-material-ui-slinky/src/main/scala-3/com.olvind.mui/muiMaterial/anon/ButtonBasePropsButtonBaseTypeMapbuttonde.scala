...
object ButtonBasePropsButtonBaseTypeMapbuttonde {
  ...
  inline def apply(): ButtonBasePropsButtonBaseTypeMapbuttonde = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ButtonBasePropsButtonBaseTypeMapbuttonde]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ButtonBasePropsButtonBaseTypeMapbuttonde] (val x: Self) extends AnyVal {
