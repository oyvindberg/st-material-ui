...
/* Inlined std.Partial<@mui/material.@mui/material/Typography/typographyClasses.TypographyClasses> */
trait PartialTypographyClasses extends StObject {
  ...
  var inherit: js.UndefOr[String] = js.undefined
...
object PartialTypographyClasses {
  
  inline def apply(): PartialTypographyClasses = {
