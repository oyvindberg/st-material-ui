...
trait PartialToggleButtonPropsdefaultComponent extends StObject {
  ...
  var value: js.UndefOr[NonNullable[Any]] = js.undefined
  
  var vocab: js.UndefOr[String] = js.undefined
}
object PartialToggleButtonPropsdefaultComponent {
  
  inline def apply(): PartialToggleButtonPropsdefaultComponent = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialToggleButtonPropsdefaultComponent]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialToggleButtonPropsdefaultComponent] (val x: Self) extends AnyVal {
