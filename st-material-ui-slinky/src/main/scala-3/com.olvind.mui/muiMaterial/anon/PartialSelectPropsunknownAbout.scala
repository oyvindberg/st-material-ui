...
trait PartialSelectPropsunknownAbout extends StObject {
  ...
  var onChange: js.UndefOr[js.Function2[/* event */ SelectChangeEvent[Any], /* child */ ReactElement, Unit]] = js.undefined
  ...
  var renderValue: js.UndefOr[js.Function1[/* value */ Any, ReactElement]] = js.undefined
...
object PartialSelectPropsunknownAbout {
  ...
  implicit open class MutableBuilder[Self <: PartialSelectPropsunknownAbout] (val x: Self) extends AnyVal {
    ...
    inline def setOnChange(value: (/* event */ SelectChangeEvent[Any], /* child */ ReactElement) => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction2(value))
    ...
    inline def setRenderValue(value: /* value */ Any => ReactElement): Self = StObject.set(x, "renderValue", js.Any.fromFunction1(value))
