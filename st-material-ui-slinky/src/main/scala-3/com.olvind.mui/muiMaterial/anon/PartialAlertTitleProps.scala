...
trait PartialAlertTitleProps extends StObject {
  ...
  var classes: js.UndefOr[PartialAlertTitleClasses] = js.undefined
...
object PartialAlertTitleProps {
  ...
  inline def apply(): PartialAlertTitleProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialAlertTitleProps]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialAlertTitleProps] (val x: Self) extends AnyVal {
    ...
    inline def setClasses(value: PartialAlertTitleClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
