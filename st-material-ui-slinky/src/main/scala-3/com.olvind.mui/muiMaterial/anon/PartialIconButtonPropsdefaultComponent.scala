...
object PartialIconButtonPropsdefaultComponent {
  ...
  inline def apply(): PartialIconButtonPropsdefaultComponent = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialIconButtonPropsdefaultComponent]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialIconButtonPropsdefaultComponent] (val x: Self) extends AnyVal {
