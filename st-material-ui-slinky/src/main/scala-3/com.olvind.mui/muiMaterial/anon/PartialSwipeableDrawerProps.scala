...
object PartialSwipeableDrawerProps {
  ...
  implicit open class MutableBuilder[Self <: PartialSwipeableDrawerProps] (val x: Self) extends AnyVal {
    ...
    inline def setOnClose(value: SyntheticEvent[Event, js.Object] => Unit): Self = StObject.set(x, "onClose", js.Any.fromFunction1(value))
    ...
    inline def setOnOpen(value: SyntheticEvent[Event, js.Object] => Unit): Self = StObject.set(x, "onOpen", js.Any.fromFunction1(value))
