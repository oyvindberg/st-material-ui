...
trait PartialAutocompletePropsanyanyanyanydiv extends StObject {
  ...
  var renderInput: js.UndefOr[js.Function1[/* params */ AutocompleteRenderInputParams, ReactElement]] = js.undefined
...
object PartialAutocompletePropsanyanyanyanydiv {
  ...
  implicit open class MutableBuilder[Self <: PartialAutocompletePropsanyanyanyanydiv] (val x: Self) extends AnyVal {
    ...
    inline def setRenderInput(value: /* params */ AutocompleteRenderInputParams => ReactElement): Self = StObject.set(x, "renderInput", js.Any.fromFunction1(value))
    ...
    inline def setRenderTags(
      value: (/* value */ js.Array[Any], /* getTagProps */ AutocompleteRenderGetTagProps, /* ownerState */ AutocompleteOwnerState[Any, Any, Any, Any, "div"]) => ReactElement
