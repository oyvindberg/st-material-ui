...
/* Inlined @mui/material.@mui/material/Stepper.StepperProps<@mui/material.@mui/material/Stepper/Stepper.StepperTypeMap<{}, 'div'>['defaultComponent'], {  component :react.react.ElementType<any> | undefined}> */
trait StepperPropsStepperTypeMapdivdefaultComp extends StObject {
...
object StepperPropsStepperTypeMapdivdefaultComp {
  
  inline def apply(): StepperPropsStepperTypeMapdivdefaultComp = {
