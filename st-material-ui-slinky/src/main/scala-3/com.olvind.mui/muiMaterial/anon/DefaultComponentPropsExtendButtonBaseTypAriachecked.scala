...
trait DefaultComponentPropsExtendButtonBaseTypAriachecked extends StObject {
  ...
  /**
    * Override or extend the styles applied to the component.
    */
  var classes: js.UndefOr[PartialMenuItemClasses] = js.undefined
...
object DefaultComponentPropsExtendButtonBaseTypAriachecked {
  ...
  inline def apply(): DefaultComponentPropsExtendButtonBaseTypAriachecked = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsExtendButtonBaseTypAriachecked]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DefaultComponentPropsExtendButtonBaseTypAriachecked] (val x: Self) extends AnyVal {
    ...
    inline def setClasses(value: PartialMenuItemClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
