...
trait PartialRadioGroupProps extends StObject {
  ...
  var classes: js.UndefOr[PartialFormGroupClasses] = js.undefined
...
object PartialRadioGroupProps {
  ...
  inline def apply(): PartialRadioGroupProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialRadioGroupProps]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialRadioGroupProps] (val x: Self) extends AnyVal {
    ...
    inline def setClasses(value: PartialFormGroupClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
