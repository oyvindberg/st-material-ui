...
/* Inlined @mui/material.@mui/material/OverridableComponent.DefaultComponentProps<@mui/material.@mui/material/ButtonBase/ButtonBase.ExtendButtonBaseTypeMap<@mui/material.@mui/material/AccordionSummary/AccordionSummary.AccordionSummaryTypeMap<{}, 'div'>>> */
trait DefaultComponentPropsExtendButtonBaseTyp extends StObject {
...
object DefaultComponentPropsExtendButtonBaseTyp {
  
  inline def apply(): DefaultComponentPropsExtendButtonBaseTyp = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsExtendButtonBaseTyp]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DefaultComponentPropsExtendButtonBaseTyp] (val x: Self) extends AnyVal {
