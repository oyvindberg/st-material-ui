...
/* Inlined DefaultComponentProps<StepTypeMap<{}, 'div'>> & { readonly component :string | undefined} */
trait DefaultComponentPropsStepTypeMapdiv extends StObject {
...
object DefaultComponentPropsStepTypeMapdiv {
  
  inline def apply(): DefaultComponentPropsStepTypeMapdiv = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsStepTypeMapdiv]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DefaultComponentPropsStepTypeMapdiv] (val x: Self) extends AnyVal {
