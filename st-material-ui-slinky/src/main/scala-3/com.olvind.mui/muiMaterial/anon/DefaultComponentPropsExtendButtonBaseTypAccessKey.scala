...
object DefaultComponentPropsExtendButtonBaseTypAccessKey {
  ...
  inline def apply(): DefaultComponentPropsExtendButtonBaseTypAccessKey = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsExtendButtonBaseTypAccessKey]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DefaultComponentPropsExtendButtonBaseTypAccessKey] (val x: Self) extends AnyVal {
