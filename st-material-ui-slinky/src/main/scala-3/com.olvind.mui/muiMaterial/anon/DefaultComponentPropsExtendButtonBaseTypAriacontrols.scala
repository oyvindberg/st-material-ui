...
object DefaultComponentPropsExtendButtonBaseTypAriacontrols {
  ...
  inline def apply(): DefaultComponentPropsExtendButtonBaseTypAriacontrols = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsExtendButtonBaseTypAriacontrols]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DefaultComponentPropsExtendButtonBaseTypAriacontrols] (val x: Self) extends AnyVal {
