...
object OverridePropsExtendButtonBaseTypeMapTogg {
  ...
  inline def apply(href: String, value: NonNullable[Any]): OverridePropsExtendButtonBaseTypeMapTogg = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: OverridePropsExtendButtonBaseTypeMapTogg] (val x: Self) extends AnyVal {
