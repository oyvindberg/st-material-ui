...
trait PartialOutlinedInputClasses extends StObject {
  ...
  var inputSizeSmall: js.UndefOr[String] = js.undefined
...
object PartialOutlinedInputClasses {
  ...
  inline def apply(): PartialOutlinedInputClasses = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialOutlinedInputClasses]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialOutlinedInputClasses] (val x: Self) extends AnyVal {
    ...
    inline def setNotchedOutlineUndefined: Self = StObject.set(x, "notchedOutline", js.undefined)
