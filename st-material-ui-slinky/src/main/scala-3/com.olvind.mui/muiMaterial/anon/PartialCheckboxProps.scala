...
trait PartialCheckboxProps extends StObject {
  ...
  var inputRef: js.UndefOr[com.olvind.mui.react.mod.Ref[HTMLInputElement]] = js.undefined
...
object PartialCheckboxProps {
  ...
  extension [Self <: PartialCheckboxProps](x: Self) {
    ...
    inline def setInputRef(value: com.olvind.mui.react.mod.Ref[HTMLInputElement]): Self = StObject.set(x, "inputRef", value.asInstanceOf[js.Any])
