...
/* Inlined @mui/material.@mui/material.IconButtonProps<{  props :{} & {},   defaultComponent :'button'}['defaultComponent'], {}> */
trait IconButtonPropsdefaultComponent extends StObject {
...
object IconButtonPropsdefaultComponent {
  
  inline def apply(): IconButtonPropsdefaultComponent = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[IconButtonPropsdefaultComponent]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: IconButtonPropsdefaultComponent] (val x: Self) extends AnyVal {
