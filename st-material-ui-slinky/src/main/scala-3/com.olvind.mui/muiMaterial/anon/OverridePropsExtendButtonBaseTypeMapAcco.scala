...
trait OverridePropsExtendButtonBaseTypeMapAcco extends StObject {
  ...
  /**
    * Override or extend the styles applied to the component.
    */
  var classes: js.UndefOr[PartialAccordionSummaryClasses] = js.undefined
...
object OverridePropsExtendButtonBaseTypeMapAcco {
  ...
  inline def apply(href: String): OverridePropsExtendButtonBaseTypeMapAcco = {
    val __obj = js.Dynamic.literal(href = href.asInstanceOf[js.Any])
    __obj.asInstanceOf[OverridePropsExtendButtonBaseTypeMapAcco]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: OverridePropsExtendButtonBaseTypeMapAcco] (val x: Self) extends AnyVal {
    ...
    inline def setClasses(value: PartialAccordionSummaryClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
    ...
    inline def setExpandIcon(value: ReactElement): Self = StObject.set(x, "expandIcon", value.asInstanceOf[js.Any])
