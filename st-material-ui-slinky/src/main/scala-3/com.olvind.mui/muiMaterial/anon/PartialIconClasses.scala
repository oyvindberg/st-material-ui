...
/* Inlined std.Partial<@mui/material.@mui/material/Icon/iconClasses.IconClasses> */
trait PartialIconClasses extends StObject {
...
object PartialIconClasses {
  
  inline def apply(): PartialIconClasses = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialIconClasses]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialIconClasses] (val x: Self) extends AnyVal {
