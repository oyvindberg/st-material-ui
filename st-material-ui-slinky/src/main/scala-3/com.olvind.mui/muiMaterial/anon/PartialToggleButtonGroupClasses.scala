...
/* Inlined std.Partial<@mui/material.@mui/material/ToggleButtonGroup/toggleButtonGroupClasses.ToggleButtonGroupClasses> */
trait PartialToggleButtonGroupClasses extends StObject {
...
object PartialToggleButtonGroupClasses {
  
  inline def apply(): PartialToggleButtonGroupClasses = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialToggleButtonGroupClasses]
  }
  
  extension [Self <: PartialToggleButtonGroupClasses](x: Self) {
