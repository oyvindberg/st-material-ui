...
/* Inlined {} & @mui/base.@mui/base/ModalUnstyled/ModalUnstyled.types.ModalUnstyledOwnProps */
trait ModalUnstyledOwnProps extends StObject {
...
object ModalUnstyledOwnProps {
  
  inline def apply(children: ReactElement, open: Boolean): ModalUnstyledOwnProps = {
