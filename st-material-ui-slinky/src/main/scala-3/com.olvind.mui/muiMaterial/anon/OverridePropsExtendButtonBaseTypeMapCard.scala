...
object OverridePropsExtendButtonBaseTypeMapCard {
  ...
  inline def apply(href: String): OverridePropsExtendButtonBaseTypeMapCard = {
    val __obj = js.Dynamic.literal(href = href.asInstanceOf[js.Any])
    __obj.asInstanceOf[OverridePropsExtendButtonBaseTypeMapCard]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: OverridePropsExtendButtonBaseTypeMapCard] (val x: Self) extends AnyVal {
