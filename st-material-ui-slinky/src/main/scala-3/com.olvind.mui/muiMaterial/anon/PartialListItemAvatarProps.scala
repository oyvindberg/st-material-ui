...
trait PartialListItemAvatarProps extends StObject {
  ...
  var classes: js.UndefOr[PartialListItemAvatarClasses] = js.undefined
...
object PartialListItemAvatarProps {
  ...
  inline def apply(): PartialListItemAvatarProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialListItemAvatarProps]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialListItemAvatarProps] (val x: Self) extends AnyVal {
    ...
    inline def setClasses(value: PartialListItemAvatarClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
