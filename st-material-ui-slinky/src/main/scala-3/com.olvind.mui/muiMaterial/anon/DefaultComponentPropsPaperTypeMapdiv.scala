...
trait DefaultComponentPropsPaperTypeMapdiv extends StObject {
  ...
  /**
    * Override or extend the styles applied to the component.
    */
  var classes: js.UndefOr[PartialPaperClasses] = js.undefined
...
object DefaultComponentPropsPaperTypeMapdiv {
  ...
  inline def apply(): DefaultComponentPropsPaperTypeMapdiv = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsPaperTypeMapdiv]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DefaultComponentPropsPaperTypeMapdiv] (val x: Self) extends AnyVal {
    ...
    inline def setClasses(value: PartialPaperClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
