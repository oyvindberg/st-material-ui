...
trait ClassesColor extends StObject {
  
  /**
    * Override or extend the styles applied to the component.
    */
  var classes: js.UndefOr[
    (/* import warning: importer.ImportType#apply Failed type conversion: @mui/material.anon.SliderUnstyledTypeMapspanprops['classes'] */ js.Any) & ColorPrimary
  ] = js.undefined
  ...
  var componentsProps: js.UndefOr[
    /* import warning: importer.ImportType#apply Failed type conversion: @mui/material.anon.SliderUnstyledTypeMapspanprops['slotProps'] */ js.Any
  ] = js.undefined
...
object ClassesColor {
  ...
  implicit open class MutableBuilder[Self <: ClassesColor] (val x: Self) extends AnyVal {
    ...
    inline def setComponentsProps(
      value: /* import warning: importer.ImportType#apply Failed type conversion: @mui/material.anon.SliderUnstyledTypeMapspanprops['slotProps'] */ js.Any
