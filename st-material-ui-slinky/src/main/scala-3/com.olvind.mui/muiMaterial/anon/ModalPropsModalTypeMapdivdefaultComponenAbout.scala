...
object ModalPropsModalTypeMapdivdefaultComponenAbout {
  ...
  inline def apply(children: ReactElement, open: Boolean): ModalPropsModalTypeMapdivdefaultComponenAbout = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ModalPropsModalTypeMapdivdefaultComponenAbout] (val x: Self) extends AnyVal {
