...
object StepButtonPropsButtonBaseTypeMapbuttonde {
  ...
  inline def apply(): StepButtonPropsButtonBaseTypeMapbuttonde = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[StepButtonPropsButtonBaseTypeMapbuttonde]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: StepButtonPropsButtonBaseTypeMapbuttonde] (val x: Self) extends AnyVal {
