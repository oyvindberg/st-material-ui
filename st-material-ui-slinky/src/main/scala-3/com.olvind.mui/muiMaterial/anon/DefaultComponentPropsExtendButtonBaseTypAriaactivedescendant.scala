...
object DefaultComponentPropsExtendButtonBaseTypAriaactivedescendant {
  ...
  inline def apply(): DefaultComponentPropsExtendButtonBaseTypAriaactivedescendant = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsExtendButtonBaseTypAriaactivedescendant]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DefaultComponentPropsExtendButtonBaseTypAriaactivedescendant] (val x: Self) extends AnyVal {
