...
/* Inlined std.Partial<@mui/material.@mui/material/Input/inputClasses.InputClasses> */
trait PartialInputClasses extends StObject {
...
object PartialInputClasses {
  
  inline def apply(): PartialInputClasses = {
