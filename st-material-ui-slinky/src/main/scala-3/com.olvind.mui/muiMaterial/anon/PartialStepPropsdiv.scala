...
/* Inlined std.Partial<StepProps<'div', {}>> */
trait PartialStepPropsdiv extends StObject {
...
object PartialStepPropsdiv {
  
  inline def apply(): PartialStepPropsdiv = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialStepPropsdiv]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialStepPropsdiv] (val x: Self) extends AnyVal {
