...
trait PartialSlideProps extends StObject {
  ...
  var container: js.UndefOr[Null | Element | (js.Function1[/* element */ Element, Element])] = js.undefined
...
object PartialSlideProps {
  ...
  implicit open class MutableBuilder[Self <: PartialSlideProps] (val x: Self) extends AnyVal {
    ...
    inline def setContainer(value: Element | (js.Function1[/* element */ Element, Element])): Self = StObject.set(x, "container", value.asInstanceOf[js.Any])
    
    inline def setContainerFunction1(value: /* element */ Element => Element): Self = StObject.set(x, "container", js.Any.fromFunction1(value))
