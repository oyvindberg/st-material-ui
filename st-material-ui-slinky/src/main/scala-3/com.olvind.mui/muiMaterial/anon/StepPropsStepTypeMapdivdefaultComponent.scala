...
/* Inlined @mui/material.@mui/material/Step.StepProps<@mui/material.@mui/material/Step/Step.StepTypeMap<{}, 'div'>['defaultComponent'], {  component :react.react.ElementType<any> | undefined}> */
trait StepPropsStepTypeMapdivdefaultComponent extends StObject {
...
object StepPropsStepTypeMapdivdefaultComponent {
  
  inline def apply(): StepPropsStepTypeMapdivdefaultComponent = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[StepPropsStepTypeMapdivdefaultComponent]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: StepPropsStepTypeMapdivdefaultComponent] (val x: Self) extends AnyVal {
