...
object OverridePropsExtendButtonBaseTypeMapBott {
  ...
  inline def apply(href: String): OverridePropsExtendButtonBaseTypeMapBott = {
    val __obj = js.Dynamic.literal(href = href.asInstanceOf[js.Any])
    __obj.asInstanceOf[OverridePropsExtendButtonBaseTypeMapBott]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: OverridePropsExtendButtonBaseTypeMapBott] (val x: Self) extends AnyVal {
