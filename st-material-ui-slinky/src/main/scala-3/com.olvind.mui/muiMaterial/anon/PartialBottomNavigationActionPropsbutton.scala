...
object PartialBottomNavigationActionPropsbutton {
  ...
  inline def apply(): PartialBottomNavigationActionPropsbutton = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialBottomNavigationActionPropsbutton]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialBottomNavigationActionPropsbutton] (val x: Self) extends AnyVal {
