...
/* Inlined std.Partial<@mui/material.@mui/material/TableCell/tableCellClasses.TableCellClasses> */
trait PartialTableCellClasses extends StObject {
...
object PartialTableCellClasses {
  
  inline def apply(): PartialTableCellClasses = {
