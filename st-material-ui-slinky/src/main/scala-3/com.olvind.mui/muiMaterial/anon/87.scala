...
trait `87` extends StObject {
  ...
  var styleOverrides: js.UndefOr[PartialOverridesStyleRulesInputBaseClass] = js.undefined
...
object `87` {
  ...
  extension [Self <: `87`](x: Self) {
    ...
    inline def setStyleOverrides(value: PartialOverridesStyleRulesInputBaseClass): Self = StObject.set(x, "styleOverrides", value.asInstanceOf[js.Any])
