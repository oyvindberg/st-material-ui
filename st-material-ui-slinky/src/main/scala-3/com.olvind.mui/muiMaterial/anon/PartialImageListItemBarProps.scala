...
trait PartialImageListItemBarProps extends StObject {
  ...
  var classes: js.UndefOr[PartialImageListItemBarClasses] = js.undefined
  ...
  var position: js.UndefOr[below | top | bottom] = js.undefined
...
object PartialImageListItemBarProps {
  ...
  inline def apply(): PartialImageListItemBarProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialImageListItemBarProps]
  }
  
  extension [Self <: PartialImageListItemBarProps](x: Self) {
    ...
    inline def setClasses(value: PartialImageListItemBarClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
    ...
    inline def setPosition(value: below | top | bottom): Self = StObject.set(x, "position", value.asInstanceOf[js.Any])
    ...
    inline def setSubtitle(value: ReactElement): Self = StObject.set(x, "subtitle", value.asInstanceOf[js.Any])
