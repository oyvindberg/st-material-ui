...
trait `45` extends StObject {
  ...
  var styleOverrides: js.UndefOr[PartialOverridesStyleRulesButtonClassKey] = js.undefined
...
object `45` {
  ...
  extension [Self <: `45`](x: Self) {
    ...
    inline def setStyleOverrides(value: PartialOverridesStyleRulesButtonClassKey): Self = StObject.set(x, "styleOverrides", value.asInstanceOf[js.Any])
