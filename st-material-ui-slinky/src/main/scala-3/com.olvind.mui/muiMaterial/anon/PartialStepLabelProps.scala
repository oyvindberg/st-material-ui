...
/* Inlined std.Partial<@mui/material.@mui/material/StepLabel.StepLabelProps> */
trait PartialStepLabelProps extends StObject {
...
object PartialStepLabelProps {
  
  inline def apply(): PartialStepLabelProps = {
