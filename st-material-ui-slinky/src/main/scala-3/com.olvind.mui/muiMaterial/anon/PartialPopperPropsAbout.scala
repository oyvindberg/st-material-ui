...
/* Inlined std.Partial<@mui/material.@mui/material/Popper.PopperProps> */
trait PartialPopperPropsAbout extends StObject {
...
object PartialPopperPropsAbout {
  
  inline def apply(): PartialPopperPropsAbout = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialPopperPropsAbout]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialPopperPropsAbout] (val x: Self) extends AnyVal {
