...
trait PartialFormControlLabelProps extends StObject {
  ...
  var label: js.UndefOr[String | Double | ReactElement] = js.undefined
...
object PartialFormControlLabelProps {
  ...
  extension [Self <: PartialFormControlLabelProps](x: Self) {
    ...
    inline def setLabel(value: String | Double | ReactElement): Self = StObject.set(x, "label", value.asInstanceOf[js.Any])
