...
/* Inlined DefaultComponentProps<StepperTypeMap<{}, 'div'>> & { readonly component :string | undefined} */
trait DefaultComponentPropsStepperTypeMapdiv extends StObject {
...
object DefaultComponentPropsStepperTypeMapdiv {
  
  inline def apply(): DefaultComponentPropsStepperTypeMapdiv = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsStepperTypeMapdiv]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DefaultComponentPropsStepperTypeMapdiv] (val x: Self) extends AnyVal {
