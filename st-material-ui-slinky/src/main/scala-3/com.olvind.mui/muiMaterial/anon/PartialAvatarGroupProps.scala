...
/* Inlined std.Partial<@mui/material.@mui/material/AvatarGroup.AvatarGroupProps> */
trait PartialAvatarGroupProps extends StObject {
  ...
  var componentsProps: js.UndefOr[`40`] = js.undefined
  ...
  var slotProps: js.UndefOr[`40`] = js.undefined
...
object PartialAvatarGroupProps {
  
  inline def apply(): PartialAvatarGroupProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialAvatarGroupProps]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialAvatarGroupProps] (val x: Self) extends AnyVal {
    ...
    inline def setComponentsProps(value: `40`): Self = StObject.set(x, "componentsProps", value.asInstanceOf[js.Any])
    ...
    inline def setSlotProps(value: `40`): Self = StObject.set(x, "slotProps", value.asInstanceOf[js.Any])
