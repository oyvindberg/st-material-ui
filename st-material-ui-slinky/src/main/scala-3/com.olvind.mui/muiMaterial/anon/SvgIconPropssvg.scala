...
/* Inlined @mui/material.@mui/material.SvgIconProps<'svg', {}> */
trait SvgIconPropssvg extends StObject {
...
object SvgIconPropssvg {
  
  inline def apply(): SvgIconPropssvg = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SvgIconPropssvg]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SvgIconPropssvg] (val x: Self) extends AnyVal {
