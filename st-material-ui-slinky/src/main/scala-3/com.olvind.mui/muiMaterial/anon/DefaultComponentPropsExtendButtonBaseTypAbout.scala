...
object DefaultComponentPropsExtendButtonBaseTypAbout {
  ...
  inline def apply(): DefaultComponentPropsExtendButtonBaseTypAbout = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsExtendButtonBaseTypAbout]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DefaultComponentPropsExtendButtonBaseTypAbout] (val x: Self) extends AnyVal {
