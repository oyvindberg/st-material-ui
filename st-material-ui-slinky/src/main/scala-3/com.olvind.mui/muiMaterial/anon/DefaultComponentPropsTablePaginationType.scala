...
/* Inlined DefaultComponentProps<TablePaginationTypeMap<{}, JSXElementConstructor<TablePaginationBaseProps>>> & { readonly component :string | undefined} */
@js.native
trait DefaultComponentPropsTablePaginationType extends StObject {
