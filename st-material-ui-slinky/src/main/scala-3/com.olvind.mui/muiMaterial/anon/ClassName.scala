...
object ClassName {
  ...
  inline def apply(className: String, `data-tag-index`: Double, disabled: Boolean, key: Double, onDelete: Any => Unit): ClassName = {
    val __obj = js.Dynamic.literal(className = className.asInstanceOf[js.Any], disabled = disabled.asInstanceOf[js.Any], key = key.asInstanceOf[js.Any], onDelete = js.Any.fromFunction1(onDelete), tabIndex = -1)
