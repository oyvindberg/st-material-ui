...
trait PartialSnackbarContentPropsAbout extends StObject {
  ...
  var classes: js.UndefOr[PartialSnackbarContentClasses] = js.undefined
...
object PartialSnackbarContentPropsAbout {
  ...
  inline def apply(): PartialSnackbarContentPropsAbout = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialSnackbarContentPropsAbout]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialSnackbarContentPropsAbout] (val x: Self) extends AnyVal {
    ...
    inline def setClasses(value: PartialSnackbarContentClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
