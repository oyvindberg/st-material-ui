...
object tabScrollButtonTabScrollButtonMod {
  ...
  object TabScrollButtonProps {
    ...
    inline def apply(direction: "left" | "right", orientation: "horizontal" | "vertical"): TabScrollButtonProps = {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: TabScrollButtonProps] (val x: Self) extends AnyVal {
      ...
      inline def setClasses(value: PartialTabScrollButtonClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
