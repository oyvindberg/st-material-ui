...
object speedDialActionSpeedDialActionMod {
  ...
  trait SpeedDialActionProps extends StObject {
    ...
    var title: js.UndefOr[ReactElement | String | Double | Any | ReactPortal | Boolean] = js.undefined
    ...
    /**
      ...
      */
    var tooltipTitle: js.UndefOr[ReactElement] = js.undefined
  ...
  object SpeedDialActionProps {
    ...
    extension [Self <: SpeedDialActionProps](x: Self) {
      ...
      inline def setOnClose(value: /* event */ (SyntheticEvent[Event, org.scalajs.dom.Element]) | Event => Unit): Self = StObject.set(x, "onClose", js.Any.fromFunction1(value))
      ...
      inline def setTitle(value: ReactElement | String | Double | Any | ReactPortal | Boolean): Self = StObject.set(x, "title", value.asInstanceOf[js.Any])
      ...
      inline def setTooltipTitle(value: ReactElement): Self = StObject.set(x, "tooltipTitle", value.asInstanceOf[js.Any])
