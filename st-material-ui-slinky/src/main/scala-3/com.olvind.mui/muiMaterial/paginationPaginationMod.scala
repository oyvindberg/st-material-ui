...
object paginationPaginationMod {
  ...
  trait PaginationProps extends StObject {
    ...
    /**
      ...
      */
    var renderItem: js.UndefOr[js.Function1[/* params */ PaginationRenderItemParams, ReactElement]] = js.undefined
  ...
  object PaginationProps {
    ...
    extension [Self <: PaginationProps](x: Self) {
      ...
      inline def setRenderItem(value: /* params */ PaginationRenderItemParams => ReactElement): Self = StObject.set(x, "renderItem", js.Any.fromFunction1(value))
