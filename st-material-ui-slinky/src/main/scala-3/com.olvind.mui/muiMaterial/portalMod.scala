...
object portalMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[PortalProps & RefAttributes[Element]] = js.native
  
  type _To = ReactComponentClass[PortalProps & RefAttributes[Element]]
  
  /* This means you don't have to write `default`, but can instead just say `portalMod.foo` */
  override def _to: ReactComponentClass[PortalProps & RefAttributes[Element]] = default
}
