...
object tooltipTooltipMod {
  ...
  trait TooltipProps extends StObject {
    ...
    /**
      ...
      */
    var title: ReactElement | String | Double | Any | ReactPortal | Boolean
  ...
  object TooltipProps {
    ...
    inline def apply(children: ReactElement, title: ReactElement | String | Double | Any | ReactPortal | Boolean): TooltipProps = {
