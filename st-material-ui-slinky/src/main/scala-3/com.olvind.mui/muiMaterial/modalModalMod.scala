...
import com.olvind.mui.muiMaterial.anon.BackdropComponent
...
import com.olvind.mui.muiMaterial.anon.OmitModalUnstyledTypeMapdivpropsslotProp
...
object modalModalMod extends Shortcut {
  ...
  type ModalClassKey = /* keyof std.NonNullable<@mui/material.anon.PartialModalUnstyledClasses | undefined> */ String
  
  type ModalClasses_ = Record[ModalClassKey, String]
  
  trait ModalComponentsPropsOverrides extends StObject
  
  /* Inlined parent @mui/material.@mui/material/Modal/Modal.ModalProps<@mui/material.@mui/material/Modal/Modal.ModalTypeMap<'div', {}>['defaultComponent'], {}> */
  ...
  object ModalOwnerState {
    ...
    inline def apply(children: ReactElement, exited: Boolean, open: Boolean): ModalOwnerState = {
      val __obj = js.Dynamic.literal(children = children.asInstanceOf[js.Any], exited = exited.asInstanceOf[js.Any], open = open.asInstanceOf[js.Any])
    ...
    implicit open class MutableBuilder[Self <: ModalOwnerState] (val x: Self) extends AnyVal {
      ...
      inline def setContainerFunction0(value: () => org.scalajs.dom.Element | Null): Self = StObject.set(x, "container", js.Any.fromFunction0(value))
  ...
  type ModalRootProps = /* import warning: importer.ImportType#apply Failed type conversion: std.NonNullable<@mui/material.anon.9 | undefined>['root'] */ js.Any
  
  trait ModalTypeMap[D /* <: ReactElement */, P] extends StObject {
    
    var defaultComponent: D
    
    var props: P & BackdropComponent & OmitModalUnstyledTypeMapdivpropsslotProp
  }
  object ModalTypeMap {
    
    inline def apply[D /* <: ReactElement */, P](defaultComponent: D, props: P & BackdropComponent & OmitModalUnstyledTypeMapdivpropsslotProp): ModalTypeMap[D, P] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[ModalTypeMap[D, P]]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: ModalTypeMap[?, ?], D /* <: ReactElement */, P] (val x: Self & (ModalTypeMap[D, P])) extends AnyVal {
      
      inline def setDefaultComponent(value: D): Self = StObject.set(x, "defaultComponent", value.asInstanceOf[js.Any])
      
      inline def setProps(value: P & BackdropComponent & OmitModalUnstyledTypeMapdivpropsslotProp): Self = StObject.set(x, "props", value.asInstanceOf[js.Any])
    }
  }
  
  type _To = js.Function1[/* props */ DefaultComponentPropsModalTypeMapdiv, Element]
  
  /* This means you don't have to write `default`, but can instead just say `modalModalMod.foo` */
  override def _to: js.Function1[/* props */ DefaultComponentPropsModalTypeMapdiv, Element] = default
}
