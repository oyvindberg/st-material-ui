...
object inputBaseInputBaseClassesMod {
  ...
  type InputBaseClassKey = "root" | "formControl" | "focused" | "disabled" | "adornedStart" | "adornedEnd" | "error" | "sizeSmall" | "multiline" | "colorSecondary" | "fullWidth" | "hiddenLabel" | "readOnly" | "input" | "inputSizeSmall" | "inputMultiline" | "inputTypeSearch" | "inputAdornedStart" | "inputAdornedEnd" | "inputHiddenLabel"
