...
object linkLinkMod extends Shortcut {
  ...
  object LinkBaseProps {
    ...
    inline def apply(): LinkBaseProps = {
  ...
  trait LinkTypeMap[P, D /* <: ReactElement */] extends StObject {
    ...
    var props: P & DistributiveOmitLinkBasePropsclasses & TypographyClasses
  }
  object LinkTypeMap {
    
    inline def apply[P, D /* <: ReactElement */](defaultComponent: D, props: P & DistributiveOmitLinkBasePropsclasses & TypographyClasses): LinkTypeMap[P, D] = {
    ...
    extension [Self <: LinkTypeMap[?, ?], P, D /* <: ReactElement */](x: Self & (LinkTypeMap[P, D])) {
      ...
      inline def setProps(value: P & DistributiveOmitLinkBasePropsclasses & TypographyClasses): Self = StObject.set(x, "props", value.asInstanceOf[js.Any])
    }
  }
