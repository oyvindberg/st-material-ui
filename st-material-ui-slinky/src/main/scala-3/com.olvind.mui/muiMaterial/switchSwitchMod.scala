...
object switchSwitchMod {
  ...
  trait SwitchProps extends StObject {
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialSwitchClasses] = js.undefined
  ...
  object SwitchProps {
    ...
    extension [Self <: SwitchProps](x: Self) {
      ...
      inline def setClasses(value: PartialSwitchClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
