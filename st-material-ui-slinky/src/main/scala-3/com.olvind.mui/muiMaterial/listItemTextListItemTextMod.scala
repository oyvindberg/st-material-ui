...
object listItemTextListItemTextMod {
  ...
  trait ListItemTextProps[PrimaryTypographyComponent /* <: ReactElement */, SecondaryTypographyComponent /* <: ReactElement */] extends StObject {
    ...
    /**
      ...
      */
    var primary: js.UndefOr[ReactElement] = js.undefined
    ...
    /**
      ...
      */
    var secondary: js.UndefOr[ReactElement] = js.undefined
  ...
  object ListItemTextProps {
    ...
    inline def apply[PrimaryTypographyComponent /* <: ReactElement */, SecondaryTypographyComponent /* <: ReactElement */](): ListItemTextProps[PrimaryTypographyComponent, SecondaryTypographyComponent] = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[ListItemTextProps[PrimaryTypographyComponent, SecondaryTypographyComponent]]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: ListItemTextProps[?, ?], PrimaryTypographyComponent /* <: ReactElement */, SecondaryTypographyComponent /* <: ReactElement */] (val x: Self & (ListItemTextProps[PrimaryTypographyComponent, SecondaryTypographyComponent])) extends AnyVal {
      ...
      inline def setPrimary(value: ReactElement): Self = StObject.set(x, "primary", value.asInstanceOf[js.Any])
      ...
      inline def setSecondary(value: ReactElement): Self = StObject.set(x, "secondary", value.asInstanceOf[js.Any])
