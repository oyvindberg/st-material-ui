...
object Tabs {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def ScrollButtonComponent(value: ReactElement): this.type = set("ScrollButtonComponent", value.asInstanceOf[js.Any])
    ...
    inline def actionFunction1(value: /* instance */ TabsActions | Null => Unit): this.type = set("action", js.Any.fromFunction1(value))
    
    inline def actionNull: this.type = set("action", null)
    
    inline def actionReactRef(value: ReactRef[TabsActions]): this.type = set("action", value.asInstanceOf[js.Any])
    ...
    inline def onChange(value: (/* event */ SyntheticEvent[Event, Element], /* value */ Any) => Unit): this.type = set("onChange", js.Any.fromFunction2(value))
