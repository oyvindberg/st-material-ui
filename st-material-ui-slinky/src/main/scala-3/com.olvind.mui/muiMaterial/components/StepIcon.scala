...
object StepIcon {
  ...
  inline def apply(icon: ReactElement): Builder = {
    val __props = js.Dynamic.literal(icon = icon.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[StepIconProps]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def classes(value: PartialStepIconClasses): this.type = set("classes", value.asInstanceOf[js.Any])
