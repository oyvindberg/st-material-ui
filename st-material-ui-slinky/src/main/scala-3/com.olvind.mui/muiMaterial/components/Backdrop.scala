...
object Backdrop {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def classes(value: PartialBackdropClasses): this.type = set("classes", value.asInstanceOf[js.Any])
    ...
    inline def easing(value: Any): this.type = set("easing", value.asInstanceOf[js.Any])
  ...
  type Props = /* props */ DefaultComponentPropsBackdropTypeMapdiv
  
  def styled: com.olvind.mui.StyledComponent.Builder[/* props */ DefaultComponentPropsBackdropTypeMapdiv, Builder] = new com.olvind.mui.StyledComponent.Builder[/* props */ DefaultComponentPropsBackdropTypeMapdiv, Builder](this.component, new js.Object, js.Array(), (newComponent: Any) => new Builder(js.Array(newComponent, js.Dictionary.empty)))
  
  def withProps(p: /* props */ DefaultComponentPropsBackdropTypeMapdiv): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
