...
import com.olvind.mui.muiMaterial.anon.PartialChipClasses
...
object Chip {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def classes(value: PartialChipClasses): this.type = set("classes", value.asInstanceOf[js.Any])
    
    inline def clickable(value: Boolean): this.type = set("clickable", value.asInstanceOf[js.Any])
    
    inline def color(value: "default" | "primary" | "secondary" | "error" | "info" | "success" | "warning"): this.type = set("color", value.asInstanceOf[js.Any])
    ...
    inline def deleteIcon(value: ReactElement): this.type = set("deleteIcon", value.asInstanceOf[js.Any])
    ...
    inline def onDelete(value: Any => Unit): this.type = set("onDelete", js.Any.fromFunction1(value))
    ...
    inline def skipFocusWhenDisabled(value: Boolean): this.type = set("skipFocusWhenDisabled", value.asInstanceOf[js.Any])
    ...
    inline def variant(value: "filled" | "outlined"): this.type = set("variant", value.asInstanceOf[js.Any])
