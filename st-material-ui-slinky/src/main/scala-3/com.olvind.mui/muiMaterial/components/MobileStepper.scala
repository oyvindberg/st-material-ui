...
object MobileStepper {
  ...
  inline def apply(backButton: ReactElement, nextButton: ReactElement, steps: Double): Builder = {
    val __props = js.Dynamic.literal(backButton = backButton.asInstanceOf[js.Any], nextButton = nextButton.asInstanceOf[js.Any], steps = steps.asInstanceOf[js.Any])
