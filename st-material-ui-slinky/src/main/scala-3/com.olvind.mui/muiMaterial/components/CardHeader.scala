...
object CardHeader {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def action(value: ReactElement): this.type = set("action", value.asInstanceOf[js.Any])
    ...
    inline def avatar(value: ReactElement): this.type = set("avatar", value.asInstanceOf[js.Any])
    ...
    inline def title(value: ReactElement): this.type = set("title", value.asInstanceOf[js.Any])
