...
object SpeedDial {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def TransitionComponent(value: TransitionProps => ReactElement | Null): this.type = set("TransitionComponent", js.Any.fromFunction1(value))
    ...
    inline def onClose(value: (/* event */ SyntheticEvent[Event, js.Object], /* reason */ CloseReason) => Unit): this.type = set("onClose", js.Any.fromFunction2(value))
    ...
    inline def onOpen(value: (/* event */ SyntheticEvent[Event, js.Object], /* reason */ OpenReason) => Unit): this.type = set("onOpen", js.Any.fromFunction2(value))
