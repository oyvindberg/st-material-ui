...
object Breadcrumbs {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def classes(value: PartialBreadcrumbsClasses): this.type = set("classes", value.asInstanceOf[js.Any])
    ...
    inline def expandText(value: String): this.type = set("expandText", value.asInstanceOf[js.Any])
    ...
    inline def itemsAfterCollapse(value: Double): this.type = set("itemsAfterCollapse", value.asInstanceOf[js.Any])
    
    inline def itemsBeforeCollapse(value: Double): this.type = set("itemsBeforeCollapse", value.asInstanceOf[js.Any])
    ...
    inline def separator(value: ReactElement): this.type = set("separator", value.asInstanceOf[js.Any])
  ...
  type Props = /* props */ DefaultComponentPropsBreadcrumbsTypeMapn
  
  implicit def make(companion: Breadcrumbs.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def styled: com.olvind.mui.StyledComponent.Builder[/* props */ DefaultComponentPropsBreadcrumbsTypeMapn, Builder] = new com.olvind.mui.StyledComponent.Builder[/* props */ DefaultComponentPropsBreadcrumbsTypeMapn, Builder](this.component, new js.Object, js.Array(), (newComponent: Any) => new Builder(js.Array(newComponent, js.Dictionary.empty)))
  
  def withProps(p: /* props */ DefaultComponentPropsBreadcrumbsTypeMapn): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
