...
object Menu {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def MenuListProps(value: PartialMenuListPropsMenuListTypeMapuldef): this.type = set("MenuListProps", value.asInstanceOf[js.Any])
    
    inline def PaperProps(value: PartialPaperPropsdiv): this.type = set("PaperProps", value.asInstanceOf[js.Any])
    
    inline def PopoverClasses(value: PartialPopoverClasses): this.type = set("PopoverClasses", value.asInstanceOf[js.Any])
    ...
    inline def action(value: Ref[PopoverActions]): this.type = set("action", value.asInstanceOf[js.Any])
    
    inline def actionFunction1(value: /* instance */ PopoverActions | Null => Unit): this.type = set("action", js.Any.fromFunction1(value))
    
    inline def actionNull: this.type = set("action", null)
    
    inline def actionReactRef(value: ReactRef[PopoverActions]): this.type = set("action", value.asInstanceOf[js.Any])
    
    inline def anchorEl(value: Element | (js.Function1[/* element */ Element, Element])): this.type = set("anchorEl", value.asInstanceOf[js.Any])
    
    inline def anchorElFunction1(value: /* element */ Element => Element): this.type = set("anchorEl", js.Any.fromFunction1(value))
    
    inline def anchorElNull: this.type = set("anchorEl", null)
    
    inline def anchorOrigin(value: PopoverOrigin): this.type = set("anchorOrigin", value.asInstanceOf[js.Any])
    
    inline def anchorPosition(value: PopoverPosition): this.type = set("anchorPosition", value.asInstanceOf[js.Any])
    
    inline def anchorReference(value: PopoverReference): this.type = set("anchorReference", value.asInstanceOf[js.Any])
    ...
    inline def classes(value: PartialMenuClasses): this.type = set("classes", value.asInstanceOf[js.Any])
    ...
    inline def disableAutoFocusItem(value: Boolean): this.type = set("disableAutoFocusItem", value.asInstanceOf[js.Any])
    ...
    inline def marginThreshold(value: Double): this.type = set("marginThreshold", value.asInstanceOf[js.Any])
    ...
    inline def onBackdropClick(value: SyntheticEvent[Event, js.Object] => Unit): this.type = set("onBackdropClick", js.Any.fromFunction1(value))
    ...
    inline def transformOrigin(value: PopoverOrigin): this.type = set("transformOrigin", value.asInstanceOf[js.Any])
    
    inline def transitionDuration(value: Any | "auto"): this.type = set("transitionDuration", value.asInstanceOf[js.Any])
  ...
  def styled: com.olvind.mui.StyledComponent.Builder[MenuProps, Builder] = new com.olvind.mui.StyledComponent.Builder[MenuProps, Builder](this.component, new js.Object, js.Array(), (newComponent: Any) => new Builder(js.Array(newComponent, js.Dictionary.empty)))
