...
object Pagination {
  ...
  @JSImport("@mui/material", "Pagination")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def boundaryCount(value: Double): this.type = set("boundaryCount", value.asInstanceOf[js.Any])
    
    inline def className(value: String): this.type = set("className", value.asInstanceOf[js.Any])
    
    inline def classes(value: PartialPaginationClasses): this.type = set("classes", value.asInstanceOf[js.Any])
    
    inline def color(value: "primary" | "secondary" | "standard"): this.type = set("color", value.asInstanceOf[js.Any])
    ...
    inline def getItemAriaLabel(
      value: (/* type */ "page" | "first" | "last" | "next" | "previous", /* page */ Double, /* selected */ Boolean) => String
    ): this.type = set("getItemAriaLabel", js.Any.fromFunction3(value))
    
    inline def hidden(value: Boolean): this.type = set("hidden", value.asInstanceOf[js.Any])
    
    inline def hideNextButton(value: Boolean): this.type = set("hideNextButton", value.asInstanceOf[js.Any])
    
    inline def hidePrevButton(value: Boolean): this.type = set("hidePrevButton", value.asInstanceOf[js.Any])
    ...
    inline def onChange(value: (/* event */ ChangeEvent[Any], /* page */ Double) => Unit): this.type = set("onChange", js.Any.fromFunction2(value))
    ...
    inline def onResize(value: SyntheticEvent[Event, HTMLElement] => Unit): this.type = set("onResize", js.Any.fromFunction1(value))
    ...
    inline def renderItem(value: /* params */ PaginationRenderItemParams => ReactElement): this.type = set("renderItem", js.Any.fromFunction1(value))
    ...
    inline def siblingCount(value: Double): this.type = set("siblingCount", value.asInstanceOf[js.Any])
  ...
  def styled: com.olvind.mui.StyledComponent.Builder[PaginationProps, Builder] = new com.olvind.mui.StyledComponent.Builder[PaginationProps, Builder](this.component, new js.Object, js.Array(), (newComponent: Any) => new Builder(js.Array(newComponent, js.Dictionary.empty)))
