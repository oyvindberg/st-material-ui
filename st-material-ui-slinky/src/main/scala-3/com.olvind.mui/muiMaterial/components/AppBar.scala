...
object AppBar {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def classes(value: PartialAppBarClasses): this.type = set("classes", value.asInstanceOf[js.Any])
    
    inline def color(value: Color | "transparent"): this.type = set("color", value.asInstanceOf[js.Any])
    ...
    inline def enableColorOnDark(value: Boolean): this.type = set("enableColorOnDark", value.asInstanceOf[js.Any])
    ...
    inline def position(value: "fixed" | "absolute" | "sticky" | "static" | "relative"): this.type = set("position", value.asInstanceOf[js.Any])
  ...
  type Props = /* props */ DefaultComponentPropsAppBarTypeMapheader
  
  implicit def make(companion: AppBar.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def styled: com.olvind.mui.StyledComponent.Builder[/* props */ DefaultComponentPropsAppBarTypeMapheader, Builder] = new com.olvind.mui.StyledComponent.Builder[/* props */ DefaultComponentPropsAppBarTypeMapheader, Builder](this.component, new js.Object, js.Array(), (newComponent: Any) => new Builder(js.Array(newComponent, js.Dictionary.empty)))
