...
object Select {
  ...
  open class Builder[T] (val args: js.Array[Any])
    ...
    inline def classes(value: PartialSelectClasses): this.type = set("classes", value.asInstanceOf[js.Any])
    ...
    inline def defaultValue(value: T): this.type = set("defaultValue", value.asInstanceOf[js.Any])
    ...
    inline def displayEmpty(value: Boolean): this.type = set("displayEmpty", value.asInstanceOf[js.Any])
    
    inline def draggable(value: Booleanish): this.type = set("draggable", value.asInstanceOf[js.Any])
    
    inline def endAdornment(value: ReactElement): this.type = set("endAdornment", value.asInstanceOf[js.Any])
    ...
    inline def input(value: ReactElement): this.type = set("input", value.asInstanceOf[js.Any])
    
    inline def inputComponent(value: ReactElement): this.type = set("inputComponent", value.asInstanceOf[js.Any])
    ...
    inline def notched(value: Boolean): this.type = set("notched", value.asInstanceOf[js.Any])
    ...
    inline def onBlur(value: SyntheticFocusEvent[HTMLInputElement | HTMLTextAreaElement] => Unit): this.type = set("onBlur", js.Any.fromFunction1(value))
    ...
    inline def onChange(value: (/* event */ SelectChangeEvent[T], /* child */ ReactElement) => Unit): this.type = set("onChange", js.Any.fromFunction2(value))
    ...
    inline def onFocus(value: SyntheticFocusEvent[HTMLInputElement | HTMLTextAreaElement] => Unit): this.type = set("onFocus", js.Any.fromFunction1(value))
    ...
    inline def onInvalid(value: SyntheticEvent[EventTarget & (HTMLInputElement | HTMLTextAreaElement), Event] => Unit): this.type = set("onInvalid", js.Any.fromFunction1(value))
    
    inline def onKeyDown(value: SyntheticKeyboardEvent[HTMLTextAreaElement | HTMLInputElement] => Unit): this.type = set("onKeyDown", js.Any.fromFunction1(value))
    ...
    inline def onKeyUp(value: SyntheticKeyboardEvent[HTMLTextAreaElement | HTMLInputElement] => Unit): this.type = set("onKeyUp", js.Any.fromFunction1(value))
    ...
    inline def renderValue(value: T => ReactElement): this.type = set("renderValue", js.Any.fromFunction1(value))
    ...
    inline def startAdornment(value: ReactElement): this.type = set("startAdornment", value.asInstanceOf[js.Any])
