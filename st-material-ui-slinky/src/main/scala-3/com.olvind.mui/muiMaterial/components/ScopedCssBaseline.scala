...
object ScopedCssBaseline {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def classes(value: PartialScopedCssBaselineClasses): this.type = set("classes", value.asInstanceOf[js.Any])
  ...
  type Props = /* props */ DefaultComponentPropsScopedCssBaselineTy
