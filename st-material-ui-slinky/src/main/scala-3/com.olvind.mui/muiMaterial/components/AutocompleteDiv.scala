...
object AutocompleteDiv {
  ...
  open class Builder[T, Multiple /* <: js.UndefOr[Boolean] */, DisableClearable /* <: js.UndefOr[Boolean] */, FreeSolo /* <: js.UndefOr[Boolean] */] (val args: js.Array[Any])
    ...
    inline def renderTags(value: (/* value */ js.Array[T], /* getTagProps */ AutocompleteRenderGetTagProps) => ReactElement): this.type = set("renderTags", js.Any.fromFunction2(value))
