...
object NativeSelect {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def classes(value: PartialNativeSelectClasses): this.type = set("classes", value.asInstanceOf[js.Any])
    ...
    inline def inputProps(value: PartialNativeSelectInputProps): this.type = set("inputProps", value.asInstanceOf[js.Any])
