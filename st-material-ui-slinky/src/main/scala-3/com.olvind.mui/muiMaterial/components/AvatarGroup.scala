...
object AvatarGroup {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def classes(value: PartialAvatarGroupClasses): this.type = set("classes", value.asInstanceOf[js.Any])
    
    inline def color(value: String): this.type = set("color", value.asInstanceOf[js.Any])
    
    inline def component(value: ReactElement): this.type = set("component", value.asInstanceOf[js.Any])
    
    inline def componentsProps(value: AdditionalAvatar): this.type = set("componentsProps", value.asInstanceOf[js.Any])
    ...
    inline def slotProps(value: AdditionalAvatar): this.type = set("slotProps", value.asInstanceOf[js.Any])
    
    inline def spacing(value: "small" | "medium" | Double): this.type = set("spacing", value.asInstanceOf[js.Any])
