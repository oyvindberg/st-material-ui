...
object TextField {
  ...
  object FilledTextFieldProps {
    ...
    open class Builder (val args: js.Array[Any])
      ...
      inline def classes(value: PartialTextFieldClasses): this.type = set("classes", value.asInstanceOf[js.Any])
      ...
      inline def helperText(value: ReactElement): this.type = set("helperText", value.asInstanceOf[js.Any])
      ...
      inline def margin(value: dense | normal | none): this.type = set("margin", value.asInstanceOf[js.Any])
