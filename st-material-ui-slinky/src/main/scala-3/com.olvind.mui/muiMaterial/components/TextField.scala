...
import com.olvind.mui.muiMaterial.textFieldTextFieldMod.FilledTextFieldProps
import com.olvind.mui.muiMaterial.textFieldTextFieldMod.OutlinedTextFieldProps
import com.olvind.mui.muiMaterial.textFieldTextFieldMod.StandardTextFieldProps
...
object TextField {
  ...
  object filled {
    ...
    inline def apply(): Builder = {
      ...
      new Builder(js.Array(this.component, __props.asInstanceOf[FilledTextFieldProps]))
    }
  ...
  object outlined {
    ...
    inline def apply(): Builder = {
      ...
      new Builder(js.Array(this.component, __props.asInstanceOf[OutlinedTextFieldProps]))
    }
