...
object Button {
  ...
  object href {
    ...
    open class Builder (val args: js.Array[Any])
      ...
      inline def endIcon(value: ReactElement): this.type = set("endIcon", value.asInstanceOf[js.Any])
      ...
      inline def startIcon(value: ReactElement): this.type = set("startIcon", value.asInstanceOf[js.Any])
