...
object Slide {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def container(value: Element | (js.Function1[/* element */ Element, Element])): this.type = set("container", value.asInstanceOf[js.Any])
    
    inline def containerFunction1(value: /* element */ Element => Element): this.type = set("container", js.Any.fromFunction1(value))
  ...
  def styled: com.olvind.mui.StyledComponent.Builder[SlideProps, Builder] = new com.olvind.mui.StyledComponent.Builder[SlideProps, Builder](this.component, new js.Object, js.Array(), (newComponent: Any) => new Builder(js.Array(newComponent, js.Dictionary.empty)))
