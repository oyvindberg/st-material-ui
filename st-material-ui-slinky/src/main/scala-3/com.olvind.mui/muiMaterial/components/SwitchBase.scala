...
import com.olvind.mui.muiMaterial.internalSwitchBaseMod.SwitchBaseProps
...
object SwitchBase {
  ...
  inline def apply(checkedIcon: ReactElement, icon: ReactElement): Builder = {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def classes(value: PartialSwitchBaseClasses): this.type = set("classes", value.asInstanceOf[js.Any])
