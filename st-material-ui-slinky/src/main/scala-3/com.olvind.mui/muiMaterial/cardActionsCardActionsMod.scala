...
object cardActionsCardActionsMod {
  ...
  trait CardActionsProps extends StObject {
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialCardActionsClasses] = js.undefined
  ...
  object CardActionsProps {
    ...
    extension [Self <: CardActionsProps](x: Self) {
      ...
      inline def setClasses(value: PartialCardActionsClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
