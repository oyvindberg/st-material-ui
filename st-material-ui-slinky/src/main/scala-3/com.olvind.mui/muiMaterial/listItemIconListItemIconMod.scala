...
object listItemIconListItemIconMod {
  ...
  trait ListItemIconProps extends StObject {
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialListItemIconClasses] = js.undefined
  ...
  object ListItemIconProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: ListItemIconProps] (val x: Self) extends AnyVal {
      ...
      inline def setClasses(value: PartialListItemIconClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
