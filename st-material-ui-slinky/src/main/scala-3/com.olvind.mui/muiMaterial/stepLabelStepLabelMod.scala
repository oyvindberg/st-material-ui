...
object stepLabelStepLabelMod {
  ...
  trait StepLabelProps extends StObject {
    ...
    /**
      ...
      */
    var StepIconComponent: js.UndefOr[ReactElement] = js.undefined
  ...
  object StepLabelProps {
    ...
    implicit open class MutableBuilder[Self <: StepLabelProps] (val x: Self) extends AnyVal {
      ...
      inline def setStepIconComponent(value: ReactElement): Self = StObject.set(x, "StepIconComponent", value.asInstanceOf[js.Any])
