...
object dialogDialogMod {
  ...
  object DialogProps {
    ...
    implicit open class MutableBuilder[Self <: DialogProps] (val x: Self) extends AnyVal {
      ...
      inline def setPaperComponent(value: PaperPropsPaperTypeMapdivdefaultComponen => ReactElement | Null): Self = StObject.set(x, "PaperComponent", js.Any.fromFunction1(value))
