...
object buttonGroupButtonGroupMod extends Shortcut {
  ...
  object ButtonGroupTypeMap {
    ...
    inline def apply[P, D /* <: ReactElement */](defaultComponent: D, props: P & DisableFocusRipple): ButtonGroupTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[ButtonGroupTypeMap[P, D]]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: ButtonGroupTypeMap[?, ?], P, D /* <: ReactElement */] (val x: Self & (ButtonGroupTypeMap[P, D])) extends AnyVal {
