...
object buttonBaseTouchRippleMod extends Shortcut {
  ...
  trait TouchRippleActions extends StObject {
    ...
    def pulsate(event: SyntheticEvent[Event, Element]): Unit = js.native
    ...
    def start(event: SyntheticEvent[Event, Element]): Unit = js.native
    def start(event: SyntheticEvent[Event, Element], options: StartActionOptions): Unit = js.native
    def start(event: SyntheticEvent[Event, Element], options: StartActionOptions, callback: js.Function0[Unit]): Unit = js.native
    def start(event: SyntheticEvent[Event, Element], options: Unit, callback: js.Function0[Unit]): Unit = js.native
    
    def stop(): Unit = js.native
    def stop(event: Unit, callback: js.Function0[Unit]): Unit = js.native
    def stop(event: SyntheticEvent[Event, Element]): Unit = js.native
    def stop(event: SyntheticEvent[Event, Element], callback: js.Function0[Unit]): Unit = js.native
  }
