...
/* Rewritten from type alias, can be one of: 
  - `com.olvind.mui`.csstype.csstypeStrings.element
  - `com.olvind.mui`.csstype.csstypeStrings.none
  - `com.olvind.mui`.csstype.csstypeStrings.text
...
object MsUserSelect {
  ...
  inline def element: com.olvind.mui.csstype.csstypeStrings.element = "element".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.element]
  ...
  inline def text: com.olvind.mui.csstype.csstypeStrings.text = "text".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.text]
