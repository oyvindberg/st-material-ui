...
object OverflowY {
  ...
  inline def `-moz-hidden-unscrollable`: com.olvind.mui.csstype.csstypeStrings.`-moz-hidden-unscrollable` = "-moz-hidden-unscrollable".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.`-moz-hidden-unscrollable`]
