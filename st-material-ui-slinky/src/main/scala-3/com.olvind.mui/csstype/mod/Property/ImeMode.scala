...
/* Rewritten from type alias, can be one of: 
  - `com.olvind.mui`.csstype.csstypeStrings.active
  - `com.olvind.mui`.csstype.csstypeStrings.auto
  - `com.olvind.mui`.csstype.csstypeStrings.disabled
  - `com.olvind.mui`.csstype.csstypeStrings.inactive
...
*/
trait ImeMode extends StObject
object ImeMode {
  ...
  inline def active: com.olvind.mui.csstype.csstypeStrings.active = "active".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.active]
  
  inline def auto: com.olvind.mui.csstype.csstypeStrings.auto = "auto".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.auto]
  
  inline def disabled: com.olvind.mui.csstype.csstypeStrings.disabled = "disabled".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.disabled]
  
  inline def inactive: com.olvind.mui.csstype.csstypeStrings.inactive = "inactive".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.inactive]
