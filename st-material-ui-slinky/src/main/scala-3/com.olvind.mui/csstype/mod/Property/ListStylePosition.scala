...
/* Rewritten from type alias, can be one of: 
  - `com.olvind.mui`.csstype.csstypeStrings.inside
  - `com.olvind.mui`.csstype.csstypeStrings.outside
...
object ListStylePosition {
  ...
  inline def inside: com.olvind.mui.csstype.csstypeStrings.inside = "inside".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.inside]
  
  inline def outside: com.olvind.mui.csstype.csstypeStrings.outside = "outside".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.outside]
