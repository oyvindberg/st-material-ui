...
/* Rewritten from type alias, can be one of: 
  ...
  - `com.olvind.mui`.csstype.csstypeStrings.`write-only`
...
*/
trait MozUserModify extends StObject
object MozUserModify {
  ...
  inline def `read-only`: com.olvind.mui.csstype.csstypeStrings.`read-only` = "read-only".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.`read-only`]
  
  inline def `read-write`: com.olvind.mui.csstype.csstypeStrings.`read-write` = "read-write".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.`read-write`]
  ...
  inline def `write-only`: com.olvind.mui.csstype.csstypeStrings.`write-only` = "write-only".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.`write-only`]
}
