...
/* Rewritten from type alias, can be one of: 
  - `com.olvind.mui`.csstype.csstypeStrings.evenodd
  - `com.olvind.mui`.csstype.csstypeStrings.nonzero
...
*/
trait ClipRule extends StObject
object ClipRule {
  ...
  inline def evenodd: com.olvind.mui.csstype.csstypeStrings.evenodd = "evenodd".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.evenodd]
  ...
  inline def nonzero: com.olvind.mui.csstype.csstypeStrings.nonzero = "nonzero".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.nonzero]
