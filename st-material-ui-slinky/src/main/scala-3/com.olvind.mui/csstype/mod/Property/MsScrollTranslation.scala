...
object MsScrollTranslation {
  ...
  inline def `vertical-to-horizontal`: com.olvind.mui.csstype.csstypeStrings.`vertical-to-horizontal` = "vertical-to-horizontal".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.`vertical-to-horizontal`]
}
