...
/* Rewritten from type alias, can be one of: 
  - `com.olvind.mui`.csstype.csstypeStrings.drag
  - `com.olvind.mui`.csstype.csstypeStrings.`no-drag`
...
*/
trait MozWindowDragging extends StObject
object MozWindowDragging {
  ...
  inline def drag: com.olvind.mui.csstype.csstypeStrings.drag = "drag".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.drag]
  ...
  inline def `no-drag`: com.olvind.mui.csstype.csstypeStrings.`no-drag` = "no-drag".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.`no-drag`]
