...
/* Rewritten from type alias, can be one of: 
  - `com.olvind.mui`.csstype.csstypeStrings.hide
  - `com.olvind.mui`.csstype.csstypeStrings.show
...
*/
trait EmptyCells extends StObject
object EmptyCells {
  ...
  inline def hide: com.olvind.mui.csstype.csstypeStrings.hide = "hide".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.hide]
  ...
  inline def show: com.olvind.mui.csstype.csstypeStrings.show = "show".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.show]
