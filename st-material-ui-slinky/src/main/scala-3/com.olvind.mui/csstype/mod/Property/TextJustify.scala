...
/* Rewritten from type alias, can be one of: 
  ...
  - `com.olvind.mui`.csstype.csstypeStrings.`inter-character`
  - `com.olvind.mui`.csstype.csstypeStrings.`inter-word`
...
object TextJustify {
  ...
  inline def `inter-character`: com.olvind.mui.csstype.csstypeStrings.`inter-character` = "inter-character".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.`inter-character`]
  
  inline def `inter-word`: com.olvind.mui.csstype.csstypeStrings.`inter-word` = "inter-word".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.`inter-word`]
