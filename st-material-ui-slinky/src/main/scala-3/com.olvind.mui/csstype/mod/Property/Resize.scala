...
object Resize {
  ...
  inline def block: com.olvind.mui.csstype.csstypeStrings.block = "block".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.block]
  
  inline def both: com.olvind.mui.csstype.csstypeStrings.both = "both".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.both]
  
  inline def horizontal: com.olvind.mui.csstype.csstypeStrings.horizontal = "horizontal".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.horizontal]
  ...
  inline def `inline`: com.olvind.mui.csstype.csstypeStrings.`inline` = "inline".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.`inline`]
  ...
  inline def vertical: com.olvind.mui.csstype.csstypeStrings.vertical = "vertical".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.vertical]
}
