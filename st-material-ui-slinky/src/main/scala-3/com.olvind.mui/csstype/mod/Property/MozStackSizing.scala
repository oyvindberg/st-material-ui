...
/* Rewritten from type alias, can be one of: 
  ...
  - `com.olvind.mui`.csstype.csstypeStrings.`stretch-to-fit`
...
object MozStackSizing {
  ...
  inline def ignore: com.olvind.mui.csstype.csstypeStrings.ignore = "ignore".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.ignore]
  ...
  inline def `stretch-to-fit`: com.olvind.mui.csstype.csstypeStrings.`stretch-to-fit` = "stretch-to-fit".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.`stretch-to-fit`]
