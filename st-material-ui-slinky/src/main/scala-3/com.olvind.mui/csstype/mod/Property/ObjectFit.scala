...
object ObjectFit {
  ...
  inline def contain: com.olvind.mui.csstype.csstypeStrings.contain = "contain".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.contain]
  
  inline def cover: com.olvind.mui.csstype.csstypeStrings.cover = "cover".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.cover]
  ...
  inline def `scale-down`: com.olvind.mui.csstype.csstypeStrings.`scale-down` = "scale-down".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.`scale-down`]
