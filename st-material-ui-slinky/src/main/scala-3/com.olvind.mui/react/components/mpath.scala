...
object mpath {
  ...
  implicit def make(companion: mpath.type): SharedBuilder_SVGProps_1009766722[SVGElement] = new SharedBuilder_SVGProps_1009766722[SVGElement](js.Array(this.component, js.Dictionary.empty))()
