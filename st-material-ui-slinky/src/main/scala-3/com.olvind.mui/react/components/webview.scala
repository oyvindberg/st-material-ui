...
object webview {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def allowpopups(value: Boolean): this.type = set("allowpopups", value.asInstanceOf[js.Any])
    ...
    inline def blinkfeatures(value: String): this.type = set("blinkfeatures", value.asInstanceOf[js.Any])
    ...
    inline def disableblinkfeatures(value: String): this.type = set("disableblinkfeatures", value.asInstanceOf[js.Any])
    
    inline def disableguestresize(value: Boolean): this.type = set("disableguestresize", value.asInstanceOf[js.Any])
    
    inline def disablewebsecurity(value: Boolean): this.type = set("disablewebsecurity", value.asInstanceOf[js.Any])
    
    inline def draggable(value: Booleanish): this.type = set("draggable", value.asInstanceOf[js.Any])
    
    inline def guestinstance(value: String): this.type = set("guestinstance", value.asInstanceOf[js.Any])
    
    inline def hidden(value: Boolean): this.type = set("hidden", value.asInstanceOf[js.Any])
    
    inline def httpreferrer(value: String): this.type = set("httpreferrer", value.asInstanceOf[js.Any])
    ...
    inline def nodeintegration(value: Boolean): this.type = set("nodeintegration", value.asInstanceOf[js.Any])
    ...
    inline def partition(value: String): this.type = set("partition", value.asInstanceOf[js.Any])
    
    inline def placeholder(value: String): this.type = set("placeholder", value.asInstanceOf[js.Any])
    
    inline def plugins(value: Boolean): this.type = set("plugins", value.asInstanceOf[js.Any])
  ...
  def styled: com.olvind.mui.StyledComponent.Builder[DetailedHTMLProps[WebViewHTMLAttributes[HTMLElement], HTMLElement], Builder] = new com.olvind.mui.StyledComponent.Builder[DetailedHTMLProps[WebViewHTMLAttributes[HTMLElement], HTMLElement], Builder](this.component, new js.Object, js.Array(), (newComponent: Any) => new Builder(js.Array(newComponent, js.Dictionary.empty)))
