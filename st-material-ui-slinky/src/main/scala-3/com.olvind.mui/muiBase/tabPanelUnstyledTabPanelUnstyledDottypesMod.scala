...
object tabPanelUnstyledTabPanelUnstyledDottypesMod {
  
  /* Inlined @mui/base.@mui/base/TabPanelUnstyled/TabPanelUnstyled.types.TabPanelUnstyledProps<@mui/base.@mui/base/TabPanelUnstyled/TabPanelUnstyled.types.TabPanelUnstyledTypeMap<{}, 'div'>['defaultComponent'], {}> & {  hidden :boolean} */
  trait TabPanelUnstyledOwnerState extends StObject {
    ...
    /**
      ...
      * @default {}
      */
    var slots: js.UndefOr[TabPanelUnstyledSlots] = js.undefined
  ...
  object TabPanelUnstyledOwnerState {
    
    inline def apply(value: Double | String): TabPanelUnstyledOwnerState = {
      val __obj = js.Dynamic.literal(value = value.asInstanceOf[js.Any])
      __obj.asInstanceOf[TabPanelUnstyledOwnerState]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: TabPanelUnstyledOwnerState] (val x: Self) extends AnyVal {
      ...
      inline def setSlots(value: TabPanelUnstyledSlots): Self = StObject.set(x, "slots", value.asInstanceOf[js.Any])
  ...
  trait TabPanelUnstyledRootSlotPropsOverrides extends StObject
  
  trait TabPanelUnstyledSlots extends StObject {
  ...
  object TabPanelUnstyledSlots {
    
    inline def apply(): TabPanelUnstyledSlots = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[TabPanelUnstyledSlots]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: TabPanelUnstyledSlots] (val x: Self) extends AnyVal {
