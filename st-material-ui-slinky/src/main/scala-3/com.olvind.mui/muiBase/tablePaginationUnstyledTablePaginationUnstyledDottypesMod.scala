...
object tablePaginationUnstyledTablePaginationUnstyledDottypesMod {
  ...
  /* Inlined @mui/base.@mui/base/TablePaginationUnstyled/TablePaginationUnstyled.types.TablePaginationUnstyledProps<@mui/base.@mui/base/TablePaginationUnstyled/TablePaginationUnstyled.types.TablePaginationUnstyledTypeMap<{}, 'td'>['defaultComponent'], {}> */
  @js.native
  trait TablePaginationUnstyledOwnerState extends StObject {
    ...
    var component: js.UndefOr["td"] = js.native
