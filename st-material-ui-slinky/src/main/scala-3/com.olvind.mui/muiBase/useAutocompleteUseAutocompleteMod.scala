...
import com.olvind.mui.muiBase.anon.Index
import com.olvind.mui.muiBase.anon.OmitHTMLAttributesHTMLLabelElementcolor
...
object useAutocompleteUseAutocompleteMod {
  ...
  type AutocompleteGetTagProps = js.Function1[/* param0 */ Index, Datatagindex]
  ...
  type AutocompleteHighlightChangeReason = "keyboard" | "mouse" | "auto" | "touch"
  ...
  trait UseAutocompleteRenderedOption[T] extends StObject {
    
    var index: Double
    
    var option: T
  }
  object UseAutocompleteRenderedOption {
    
    inline def apply[T](index: Double, option: T): UseAutocompleteRenderedOption[T] = {
      val __obj = js.Dynamic.literal(index = index.asInstanceOf[js.Any], option = option.asInstanceOf[js.Any])
      __obj.asInstanceOf[UseAutocompleteRenderedOption[T]]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: UseAutocompleteRenderedOption[?], T] (val x: Self & UseAutocompleteRenderedOption[T]) extends AnyVal {
  ...
  @js.native
  trait UseAutocompleteReturnValue[T, Multiple /* <: js.UndefOr[Boolean] */, DisableClearable /* <: js.UndefOr[Boolean] */, FreeSolo /* <: js.UndefOr[Boolean] */] extends StObject {
    ...
    /**
      ...
      */
    def getOptionProps(renderedOption: UseAutocompleteRenderedOption[T]): HTMLAttributes[HTMLLIElement] = js.native
