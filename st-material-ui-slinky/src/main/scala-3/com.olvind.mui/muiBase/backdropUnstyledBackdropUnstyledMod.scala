...
object backdropUnstyledBackdropUnstyledMod extends Shortcut {
  ...
  trait ExtendBackdropUnstyledTypeMap[M /* <: OverridableTypeMap */] extends StObject {
    ...
    var props: (/* import warning: importer.ImportType#apply Failed type conversion: M['props'] */ js.Any) & BackdropUnstyledTypeMapdivprops
  }
  object ExtendBackdropUnstyledTypeMap {
    ...
    inline def apply[M /* <: OverridableTypeMap */](
      ...
      props: (/* import warning: importer.ImportType#apply Failed type conversion: M['props'] */ js.Any) & BackdropUnstyledTypeMapdivprops
    ): ExtendBackdropUnstyledTypeMap[M] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[ExtendBackdropUnstyledTypeMap[M]]
    }
    
    extension [Self <: ExtendBackdropUnstyledTypeMap[?], M /* <: OverridableTypeMap */](x: Self & ExtendBackdropUnstyledTypeMap[M]) {
      ...
      inline def setProps(
        value: (/* import warning: importer.ImportType#apply Failed type conversion: M['props'] */ js.Any) & BackdropUnstyledTypeMapdivprops
