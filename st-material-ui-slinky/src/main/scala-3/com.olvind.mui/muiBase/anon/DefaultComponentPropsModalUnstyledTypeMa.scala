...
/* Inlined @mui/types.@mui/types.DefaultComponentProps<@mui/base.@mui/base/ModalUnstyled/ModalUnstyled.types.ModalUnstyledTypeMap<{}, 'div'>> */
...
object DefaultComponentPropsModalUnstyledTypeMa {
  ...
  inline def apply(children: ReactElement, open: Boolean): DefaultComponentPropsModalUnstyledTypeMa = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DefaultComponentPropsModalUnstyledTypeMa] (val x: Self) extends AnyVal {
