...
trait DefaultComponentPropsTabsListUnstyledTyp extends StObject {
  ...
  /**
    ...
    * @default {}
    */
  var componentsProps: js.UndefOr[`8`] = js.undefined
...
object DefaultComponentPropsTabsListUnstyledTyp {
  ...
  inline def apply(): DefaultComponentPropsTabsListUnstyledTyp = {
  ...
  extension [Self <: DefaultComponentPropsTabsListUnstyledTyp](x: Self) {
    ...
    inline def setComponentsProps(value: `8`): Self = StObject.set(x, "componentsProps", value.asInstanceOf[js.Any])
