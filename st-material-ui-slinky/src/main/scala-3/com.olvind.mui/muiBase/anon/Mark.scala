...
trait Mark extends StObject {
  ...
  var valueLabel: js.UndefOr[
    SlotComponentProps[ReactElement, SliderUnstyledValueLabelSlotPropsOverrides, SliderUnstyledOwnerState]
  ] = js.undefined
}
object Mark {
  ...
  implicit open class MutableBuilder[Self <: Mark] (val x: Self) extends AnyVal {
    ...
    inline def setValueLabel(
      value: SlotComponentProps[ReactElement, SliderUnstyledValueLabelSlotPropsOverrides, SliderUnstyledOwnerState]
    ): Self = StObject.set(x, "valueLabel", value.asInstanceOf[js.Any])
    
    inline def setValueLabelFunction1(
      value: SliderUnstyledOwnerState => Partial[ComponentPropsWithRef[ReactElement]] & SliderUnstyledValueLabelSlotPropsOverrides
