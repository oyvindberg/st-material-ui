...
trait DefaultComponentPropsFormControlUnstyled extends StObject {
  ...
  var componentsProps: js.UndefOr[`2`] = js.undefined
  ...
  /**
    ...
    * @default {}
    */
  var extraContextProperties: js.UndefOr[js.Object] = js.undefined
...
object DefaultComponentPropsFormControlUnstyled {
  ...
  inline def apply(): DefaultComponentPropsFormControlUnstyled = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsFormControlUnstyled]
  }
  
  extension [Self <: DefaultComponentPropsFormControlUnstyled](x: Self) {
    ...
    inline def setComponentsProps(value: `2`): Self = StObject.set(x, "componentsProps", value.asInstanceOf[js.Any])
    ...
    inline def setExtraContextProperties(value: js.Object): Self = StObject.set(x, "extraContextProperties", value.asInstanceOf[js.Any])
    
    inline def setExtraContextPropertiesUndefined: Self = StObject.set(x, "extraContextProperties", js.undefined)
