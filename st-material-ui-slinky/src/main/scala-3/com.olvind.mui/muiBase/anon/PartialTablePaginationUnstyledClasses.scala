...
/* Inlined std.Partial<@mui/base.@mui/base/TablePaginationUnstyled/tablePaginationUnstyledClasses.TablePaginationUnstyledClasses> */
trait PartialTablePaginationUnstyledClasses extends StObject {
...
object PartialTablePaginationUnstyledClasses {
  
  inline def apply(): PartialTablePaginationUnstyledClasses = {
