...
/* Inlined @mui/types.@mui/types.DefaultComponentProps<@mui/base.@mui/base/PopperUnstyled/PopperUnstyled.types.PopperUnstyledTypeMap<{}, 'div'>> */
trait DefaultComponentPropsPopperUnstyledTypeM extends StObject {
...
object DefaultComponentPropsPopperUnstyledTypeM {
  
  inline def apply(open: Boolean): DefaultComponentPropsPopperUnstyledTypeM = {
