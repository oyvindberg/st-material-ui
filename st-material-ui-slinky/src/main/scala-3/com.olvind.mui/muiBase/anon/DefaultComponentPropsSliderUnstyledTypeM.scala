...
/* Inlined @mui/types.@mui/types.DefaultComponentProps<@mui/base.@mui/base/SliderUnstyled/SliderUnstyled.types.SliderUnstyledTypeMap<{}, 'span'>> */
...
object DefaultComponentPropsSliderUnstyledTypeM {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DefaultComponentPropsSliderUnstyledTypeM] (val x: Self) extends AnyVal {
