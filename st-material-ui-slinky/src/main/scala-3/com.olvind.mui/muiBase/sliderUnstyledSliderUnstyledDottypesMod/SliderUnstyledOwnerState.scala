...
trait SliderUnstyledOwnerState
  ...
  var valueLabelFormat_SliderUnstyledOwnerState: String | (js.Function2[/* value */ Double, /* index */ Double, ReactElement])
}
object SliderUnstyledOwnerState {
  ...
  inline def apply(
    ...
    valueLabelFormat: String | (js.Function2[/* value */ Double, /* index */ Double, ReactElement])
