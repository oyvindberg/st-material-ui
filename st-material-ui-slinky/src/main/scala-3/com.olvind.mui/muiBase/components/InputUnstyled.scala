...
import com.olvind.mui.muiBase.inputUnstyledInputUnstyledDottypesMod.InputUnstyledSlots
...
object InputUnstyled {
  ...
  inline def apply(`type`: Unit): Builder = {
    val __props = js.Dynamic.literal(multiline = true)
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def inputRefFunction1(value: /* instance */ HTMLInputElement | Null => Unit): this.type = set("inputRef", js.Any.fromFunction1(value))
    
    inline def inputRefNull: this.type = set("inputRef", null)
    
    inline def inputRefReactRef(value: ReactRef[HTMLInputElement]): this.type = set("inputRef", value.asInstanceOf[js.Any])
    ...
    inline def onClick(value: SyntheticMouseEvent[Element] => Unit): this.type = set("onClick", js.Any.fromFunction1(value))
    ...
    inline def slotProps(value: Input): this.type = set("slotProps", value.asInstanceOf[js.Any])
    
    inline def slots(value: InputUnstyledSlots): this.type = set("slots", value.asInstanceOf[js.Any])
  ...
  type Props = /* props */ DefaultComponentPropsInputUnstyledTypeMa
