...
object TabsListUnstyled {
  ...
  @JSImport("@mui/base/TabsListUnstyled", JSImport.Default)
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def slots(value: TabsListUnstyledSlots): this.type = set("slots", value.asInstanceOf[js.Any])
  ...
  type Props = /* props */ DefaultComponentPropsTabsListUnstyledTyp
