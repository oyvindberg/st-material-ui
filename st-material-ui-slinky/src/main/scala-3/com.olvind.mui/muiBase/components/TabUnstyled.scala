...
object TabUnstyled {
  ...
  @JSImport("@mui/base/TabUnstyled", JSImport.Default)
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def actionFunction1(value: /* instance */ ButtonUnstyledActions | Null => Unit): this.type = set("action", js.Any.fromFunction1(value))
    
    inline def actionNull: this.type = set("action", null)
    
    inline def actionReactRef(value: ReactRef[ButtonUnstyledActions]): this.type = set("action", value.asInstanceOf[js.Any])
    ...
    inline def focusableWhenDisabled(value: Boolean): this.type = set("focusableWhenDisabled", value.asInstanceOf[js.Any])
    ...
    inline def onChange(value: (/* event */ SyntheticEvent[Event, Element], /* value */ Double | String) => Unit): this.type = set("onChange", js.Any.fromFunction2(value))
    ...
    inline def slots(value: TabUnstyledSlots): this.type = set("slots", value.asInstanceOf[js.Any])
  ...
  type Props = /* props */ DefaultComponentPropsTabUnstyledTypeMapb
  
  implicit def make(companion: TabUnstyled.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def styled: com.olvind.mui.StyledComponent.Builder[/* props */ DefaultComponentPropsTabUnstyledTypeMapb, Builder] = new com.olvind.mui.StyledComponent.Builder[/* props */ DefaultComponentPropsTabUnstyledTypeMapb, Builder](this.component, new js.Object, js.Array(), (newComponent: Any) => new Builder(js.Array(newComponent, js.Dictionary.empty)))
