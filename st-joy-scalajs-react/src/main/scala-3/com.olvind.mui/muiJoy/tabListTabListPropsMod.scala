...
import com.olvind.mui.muiJoy.anon.ChildrenColorSize
...
object tabListTabListPropsMod {
  ...
  /* Inlined @mui/joy.@mui/joy/TabList/TabListProps.TabListProps<@mui/joy.@mui/joy/TabList/TabListProps.TabListTypeMap<{}, 'div'>['defaultComponent'], {  component :react.react.ElementType<any> | undefined}> & {  isRtl :boolean,   orientation :'horizontal' | 'vertical'} */
  trait TabListOwnerState extends StObject {
  ...
  trait TabListTypeMap[P, D /* <: ElementType */] extends StObject {
    ...
    var props: P & ChildrenColorSize
  }
  object TabListTypeMap {
    
    inline def apply[P, D /* <: ElementType */](defaultComponent: D, props: P & ChildrenColorSize): TabListTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[TabListTypeMap[P, D]]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: TabListTypeMap[?, ?], P, D /* <: ElementType */] (val x: Self & (TabListTypeMap[P, D])) extends AnyVal {
      
      inline def setDefaultComponent(value: D): Self = StObject.set(x, "defaultComponent", value.asInstanceOf[js.Any])
      
      inline def setProps(value: P & ChildrenColorSize): Self = StObject.set(x, "props", value.asInstanceOf[js.Any])
    }
  }
}
