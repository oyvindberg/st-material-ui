...
object listItemListItemPropsMod {
  ...
  object ListItemTypeMap {
    ...
    inline def apply[P, D /* <: ElementType */](defaultComponent: D, props: P & ListItemSlotsAndSlotProps & Nested): ListItemTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[ListItemTypeMap[P, D]]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: ListItemTypeMap[?, ?], P, D /* <: ElementType */] (val x: Self & (ListItemTypeMap[P, D])) extends AnyVal {
