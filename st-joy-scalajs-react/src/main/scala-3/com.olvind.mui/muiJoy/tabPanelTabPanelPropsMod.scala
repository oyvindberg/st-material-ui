...
object tabPanelTabPanelPropsMod {
  ...
  type TabPanelProps[D /* <: ElementType */, P] = OverrideProps[TabPanelTypeMap[P, D], D]
  
  trait TabPanelPropsSizeOverrides extends StObject
  
  type TabPanelSlot = "root"
  
  trait TabPanelTypeMap[P, D /* <: ElementType */] extends StObject {
  ...
  object TabPanelTypeMap {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: TabPanelTypeMap[?, ?], P, D /* <: ElementType */] (val x: Self & (TabPanelTypeMap[P, D])) extends AnyVal {
