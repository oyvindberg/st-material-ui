...
object autocompleteListboxAutocompleteListboxClassesMod {
  
  @JSImport("@mui/joy/AutocompleteListbox/autocompleteListboxClasses", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@mui/joy/AutocompleteListbox/autocompleteListboxClasses", JSImport.Default)
  @js.native
  val default: AutocompleteListboxClasses = js.native
