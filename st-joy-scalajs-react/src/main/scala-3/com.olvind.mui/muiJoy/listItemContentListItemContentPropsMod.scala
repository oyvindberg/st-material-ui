...
object listItemContentListItemContentPropsMod {
  ...
  type ListItemContentProps[D /* <: ElementType */, P] = OverrideProps[ListItemContentTypeMap[P, D], D]
  
  type ListItemContentSlot = "root"
  
  trait ListItemContentTypeMap[P, D /* <: ElementType */] extends StObject {
  ...
  object ListItemContentTypeMap {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: ListItemContentTypeMap[?, ?], P, D /* <: ElementType */] (val x: Self & (ListItemContentTypeMap[P, D])) extends AnyVal {
