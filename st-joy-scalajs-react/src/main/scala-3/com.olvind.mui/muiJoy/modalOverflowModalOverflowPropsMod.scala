...
object modalOverflowModalOverflowPropsMod {
  ...
  type ModalOverflowProps[D /* <: ElementType */, P] = OverrideProps[ModalOverflowTypeMap[P, D], D]
  
  type ModalOverflowSlot = "root"
  
  trait ModalOverflowTypeMap[P, D /* <: ElementType */] extends StObject {
  ...
  object ModalOverflowTypeMap {
    ...
    inline def apply[P, D /* <: ElementType */](defaultComponent: D, props: P & `0`): ModalOverflowTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[ModalOverflowTypeMap[P, D]]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: ModalOverflowTypeMap[?, ?], P, D /* <: ElementType */] (val x: Self & (ModalOverflowTypeMap[P, D])) extends AnyVal {
