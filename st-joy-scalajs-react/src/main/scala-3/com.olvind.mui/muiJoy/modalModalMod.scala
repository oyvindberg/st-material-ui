...
object modalModalMod extends Shortcut {
  ...
  type _To = js.Function1[/* props */ DefaultComponentPropsModalTypeMapdiv, Element | Null]
  
  /* This means you don't have to write `default`, but can instead just say `modalModalMod.foo` */
  override def _to: js.Function1[/* props */ DefaultComponentPropsModalTypeMapdiv, Element | Null] = default
}
