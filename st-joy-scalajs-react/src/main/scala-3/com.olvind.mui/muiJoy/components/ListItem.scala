...
object ListItem {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def endAction(value: VdomNode): this.type = set("endAction", value.rawNode.asInstanceOf[js.Any])
    
    inline def endActionNull: this.type = set("endAction", null)
    
    inline def endActionVarargs(value: (Empty | String | JsNumber | Element)*): this.type = set("endAction", js.Array(value*))
    
    inline def endActionVdomElement(value: VdomElement): this.type = set("endAction", value.rawElement.asInstanceOf[js.Any])
    ...
    inline def onResize(value: ReactEventFrom[HTMLLIElement & org.scalajs.dom.Element] => Callback): this.type = set("onResize", js.Any.fromFunction1((t0: ReactEventFrom[HTMLLIElement & org.scalajs.dom.Element]) => value(t0).runNow()))
    ...
    inline def startAction(value: VdomNode): this.type = set("startAction", value.rawNode.asInstanceOf[js.Any])
    
    inline def startActionNull: this.type = set("startAction", null)
    
    inline def startActionVarargs(value: (Empty | String | JsNumber | Element)*): this.type = set("startAction", js.Array(value*))
    
    inline def startActionVdomElement(value: VdomElement): this.type = set("startAction", value.rawElement.asInstanceOf[js.Any])
