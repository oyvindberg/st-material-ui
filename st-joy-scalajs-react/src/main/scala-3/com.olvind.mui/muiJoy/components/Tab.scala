...
object Tab {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def color(value: OverridableStringUnion[ColorPaletteProp, TabPropsColorOverrides]): this.type = set("color", value.asInstanceOf[js.Any])
    ...
    inline def onChange(value: (/* event */ ReactEventFrom[Element], /* value */ Double | String) => Callback): this.type = set("onChange", js.Any.fromFunction2((t0: /* event */ ReactEventFrom[Element], t1: /* value */ Double | String) => (value(t0, t1)).runNow()))
    ...
    inline def variant(value: OverridableStringUnion[VariantProp, TabPropsVariantOverrides]): this.type = set("variant", value.asInstanceOf[js.Any])
    
    inline def vocab(value: String): this.type = set("vocab", value.asInstanceOf[js.Any])
  }
  
  type Props = /* props */ DefaultComponentPropsTabTypeMapbutton
  
  implicit def make(companion: Tab.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def styled: com.olvind.mui.StyledComponent.Builder[/* props */ DefaultComponentPropsTabTypeMapbutton, Builder] = new com.olvind.mui.StyledComponent.Builder[/* props */ DefaultComponentPropsTabTypeMapbutton, Builder](this.component, new js.Object, js.Array(), (newComponent: Any) => new Builder(js.Array(newComponent, js.Dictionary.empty)))
  
  def withProps(p: /* props */ DefaultComponentPropsTabTypeMapbutton): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
