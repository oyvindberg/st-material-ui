...
object TabPanel {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def size(value: OverridableStringUnion["sm" | "md" | "lg", TabPanelPropsSizeOverrides]): this.type = set("size", value.asInstanceOf[js.Any])
  ...
  def withProps(p: /* props */ DefaultComponentPropsTabPanelTypeMapdiv): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
