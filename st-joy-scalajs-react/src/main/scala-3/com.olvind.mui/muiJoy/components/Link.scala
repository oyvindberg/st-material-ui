...
object Link {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def color(value: OverridableStringUnion[ColorPaletteProp, LinkPropsColorOverrides]): this.type = set("color", value.asInstanceOf[js.Any])
    ...
    inline def underline(value: "none" | "hover" | "always"): this.type = set("underline", value.asInstanceOf[js.Any])
    
    inline def unselectable(value: "on" | "off"): this.type = set("unselectable", value.asInstanceOf[js.Any])
    
    inline def variant(value: OverridableStringUnion[VariantProp, LinkPropsVariantOverrides]): this.type = set("variant", value.asInstanceOf[js.Any])
