...
object AutocompleteOption {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def onChange(value: ReactEventFrom[HTMLLIElement & Element] => Callback): this.type = set("onChange", js.Any.fromFunction1((t0: ReactEventFrom[HTMLLIElement & Element]) => value(t0).runNow()))
    ...
    inline def onResize(value: ReactEventFrom[HTMLLIElement & Element] => Callback): this.type = set("onResize", js.Any.fromFunction1((t0: ReactEventFrom[HTMLLIElement & Element]) => value(t0).runNow()))
