...
object ChipDelete {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def color(value: OverridableStringUnion[ColorPaletteProp, ChipDeletePropsColorOverrides]): this.type = set("color", value.asInstanceOf[js.Any])
    ...
    ): this.type = set("onDelete", js.Any.fromFunction1((t0: ReactMouseEventFrom[HTMLButtonElement] | ReactKeyboardEventFrom[HTMLButtonElement]) => value(t0).runNow()))
    ...
    inline def variant(value: OverridableStringUnion[VariantProp, ChipDeletePropsVariantOverrides]): this.type = set("variant", value.asInstanceOf[js.Any])
    
    inline def vocab(value: String): this.type = set("vocab", value.asInstanceOf[js.Any])
  }
  
  type Props = /* props */ DefaultComponentPropsChipDeleteTypeMapbu
  
  implicit def make(companion: ChipDelete.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def styled: com.olvind.mui.StyledComponent.Builder[/* props */ DefaultComponentPropsChipDeleteTypeMapbu, Builder] = new com.olvind.mui.StyledComponent.Builder[/* props */ DefaultComponentPropsChipDeleteTypeMapbu, Builder](this.component, new js.Object, js.Array(), (newComponent: Any) => new Builder(js.Array(newComponent, js.Dictionary.empty)))
  
  def withProps(p: /* props */ DefaultComponentPropsChipDeleteTypeMapbu): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
