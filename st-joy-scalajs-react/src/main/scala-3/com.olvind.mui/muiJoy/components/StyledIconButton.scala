...
object StyledIconButton {
  ...
  inline def apply(ownerState: IconButtonOwnerState): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[/* props */ MUIStyledCommonPropsThemeDetailedHTMLProAbout]))
  }
  ...
  type Props = /* props */ MUIStyledCommonPropsThemeDetailedHTMLProAbout
  
  def styled: com.olvind.mui.StyledComponent.Builder[/* props */ MUIStyledCommonPropsThemeDetailedHTMLProAbout, Builder] = new com.olvind.mui.StyledComponent.Builder[/* props */ MUIStyledCommonPropsThemeDetailedHTMLProAbout, Builder](this.component, new js.Object, js.Array(), (newComponent: Any) => new Builder(js.Array(newComponent, js.Dictionary.empty)))
  
  def withProps(p: /* props */ MUIStyledCommonPropsThemeDetailedHTMLProAbout): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
