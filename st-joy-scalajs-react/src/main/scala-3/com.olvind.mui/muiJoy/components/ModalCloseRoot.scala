...
object ModalCloseRoot {
  ...
  inline def apply(ownerState: IconButtonOwnerState): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[/* props */ PickMUIStyledCommonPropsThemeClassAttribAbout]))
  }
  ...
  type Props = /* props */ PickMUIStyledCommonPropsThemeClassAttribAbout
  
  def styled: com.olvind.mui.StyledComponent.Builder[/* props */ PickMUIStyledCommonPropsThemeClassAttribAbout, Builder] = new com.olvind.mui.StyledComponent.Builder[/* props */ PickMUIStyledCommonPropsThemeClassAttribAbout, Builder](this.component, new js.Object, js.Array(), (newComponent: Any) => new Builder(js.Array(newComponent, js.Dictionary.empty)))
  
  def withProps(p: /* props */ PickMUIStyledCommonPropsThemeClassAttribAbout): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
