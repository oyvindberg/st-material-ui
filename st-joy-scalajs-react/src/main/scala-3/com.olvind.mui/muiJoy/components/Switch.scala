...
import com.olvind.mui.muiJoy.anon.StartDecoratorThumb
import com.olvind.mui.muiJoy.anon.ThumbTrack
...
object Switch {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def color(value: OverridableStringUnion[ColorPaletteProp, SwitchPropsColorOverrides]): this.type = set("color", value.asInstanceOf[js.Any])
    ...
    inline def endDecorator(value: Node | (js.Function1[/* ownerState */ SwitchOwnerState, Node])): this.type = set("endDecorator", value.asInstanceOf[js.Any])
    
    inline def endDecoratorFunction1(value: /* ownerState */ SwitchOwnerState => Node): this.type = set("endDecorator", js.Any.fromFunction1(value))
    ...
    inline def onBlur(value: ReactFocusEventFrom[org.scalajs.dom.Element & org.scalajs.dom.Element] => Callback): this.type = set("onBlur", js.Any.fromFunction1((t0: ReactFocusEventFrom[org.scalajs.dom.Element & org.scalajs.dom.Element]) => value(t0).runNow()))
    ...
    inline def onFocus(value: ReactFocusEventFrom[org.scalajs.dom.Element & org.scalajs.dom.Element] => Callback): this.type = set("onFocus", js.Any.fromFunction1((t0: ReactFocusEventFrom[org.scalajs.dom.Element & org.scalajs.dom.Element]) => value(t0).runNow()))
    
    inline def onFocusVisible(value: ReactFocusEventFrom[org.scalajs.dom.Element & org.scalajs.dom.Element] => Callback): this.type = set("onFocusVisible", js.Any.fromFunction1((t0: ReactFocusEventFrom[org.scalajs.dom.Element & org.scalajs.dom.Element]) => value(t0).runNow()))
    ...
    inline def size(value: OverridableStringUnion["sm" | "md" | "lg", SwitchPropsSizeOverrides]): this.type = set("size", value.asInstanceOf[js.Any])
    
    inline def slot(value: String): this.type = set("slot", value.asInstanceOf[js.Any])
    
    inline def slotProps(value: ThumbTrack): this.type = set("slotProps", value.asInstanceOf[js.Any])
    
    inline def slots(value: StartDecoratorThumb): this.type = set("slots", value.asInstanceOf[js.Any])
    
    inline def spellCheck(value: Booleanish): this.type = set("spellCheck", value.asInstanceOf[js.Any])
    
    inline def startDecorator(value: Node | (js.Function1[/* ownerState */ SwitchOwnerState, Node])): this.type = set("startDecorator", value.asInstanceOf[js.Any])
    
    inline def startDecoratorFunction1(value: /* ownerState */ SwitchOwnerState => Node): this.type = set("startDecorator", js.Any.fromFunction1(value))
    ...
    inline def variant(value: OverridableStringUnion[VariantProp, SwitchPropsVariantOverrides]): this.type = set("variant", value.asInstanceOf[js.Any])
    
    inline def vocab(value: String): this.type = set("vocab", value.asInstanceOf[js.Any])
  }
  
  type Props = /* props */ DefaultComponentPropsSwitchTypeMapdiv
  
  implicit def make(companion: Switch.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def styled: com.olvind.mui.StyledComponent.Builder[/* props */ DefaultComponentPropsSwitchTypeMapdiv, Builder] = new com.olvind.mui.StyledComponent.Builder[/* props */ DefaultComponentPropsSwitchTypeMapdiv, Builder](this.component, new js.Object, js.Array(), (newComponent: Any) => new Builder(js.Array(newComponent, js.Dictionary.empty)))
  
  def withProps(p: /* props */ DefaultComponentPropsSwitchTypeMapdiv): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
