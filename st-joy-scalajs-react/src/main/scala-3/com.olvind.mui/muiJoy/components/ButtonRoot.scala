...
object ButtonRoot {
  ...
  inline def apply(ownerState: ButtonOwnerState): Builder = {
    val __props = js.Dynamic.literal(ownerState = ownerState.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[/* props */ MUIStyledCommonPropsThemePickDetailedHTM]))
  }
  ...
  type Props = /* props */ MUIStyledCommonPropsThemePickDetailedHTM
  
  def styled: com.olvind.mui.StyledComponent.Builder[/* props */ MUIStyledCommonPropsThemePickDetailedHTM, Builder] = new com.olvind.mui.StyledComponent.Builder[/* props */ MUIStyledCommonPropsThemePickDetailedHTM, Builder](this.component, new js.Object, js.Array(), (newComponent: Any) => new Builder(js.Array(newComponent, js.Dictionary.empty)))
  
  def withProps(p: /* props */ MUIStyledCommonPropsThemePickDetailedHTM): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
