...
object IconButtonRoot {
  
  inline def apply(ownerState: IconButtonOwnerState): Builder = {
    val __props = js.Dynamic.literal(ownerState = ownerState.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[/* props */ PickMUIStyledCommonPropsThemeClassAttrib]))
  }
  ...
  type Props = /* props */ PickMUIStyledCommonPropsThemeClassAttrib
  
  def styled: com.olvind.mui.StyledComponent.Builder[/* props */ PickMUIStyledCommonPropsThemeClassAttrib, Builder] = new com.olvind.mui.StyledComponent.Builder[/* props */ PickMUIStyledCommonPropsThemeClassAttrib, Builder](this.component, new js.Object, js.Array(), (newComponent: Any) => new Builder(js.Array(newComponent, js.Dictionary.empty)))
  
  def withProps(p: /* props */ PickMUIStyledCommonPropsThemeClassAttrib): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
