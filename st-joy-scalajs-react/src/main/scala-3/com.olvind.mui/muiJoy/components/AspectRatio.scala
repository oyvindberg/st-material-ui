...
object AspectRatio {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def variant(value: OverridableStringUnion[VariantProp, AspectRatioPropsVariantOverrides]): this.type = set("variant", value.asInstanceOf[js.Any])
    
    inline def vocab(value: String): this.type = set("vocab", value.asInstanceOf[js.Any])
  }
  
  type Props = /* props */ DefaultComponentPropsAspectRatioTypeMapd
  
  implicit def make(companion: AspectRatio.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def styled: com.olvind.mui.StyledComponent.Builder[/* props */ DefaultComponentPropsAspectRatioTypeMapd, Builder] = new com.olvind.mui.StyledComponent.Builder[/* props */ DefaultComponentPropsAspectRatioTypeMapd, Builder](this.component, new js.Object, js.Array(), (newComponent: Any) => new Builder(js.Array(newComponent, js.Dictionary.empty)))
  
  def withProps(p: /* props */ DefaultComponentPropsAspectRatioTypeMapd): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
