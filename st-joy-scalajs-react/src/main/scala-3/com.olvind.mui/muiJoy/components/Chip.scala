...
import com.olvind.mui.muiJoy.anon.ActionEndDecorator
import com.olvind.mui.muiJoy.anon.DefaultComponentPropsChipTypeMapdiv
import com.olvind.mui.muiJoy.anon.PartialChipSlots
...
object Chip {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def color(value: OverridableStringUnion[ColorPaletteProp, ChipPropsColorOverrides]): this.type = set("color", value.asInstanceOf[js.Any])
    ...
    inline def size(value: OverridableStringUnion["sm" | "md" | "lg", ChipPropsSizeOverrides]): this.type = set("size", value.asInstanceOf[js.Any])
    
    inline def slot(value: String): this.type = set("slot", value.asInstanceOf[js.Any])
    
    inline def slotProps(value: ActionEndDecorator): this.type = set("slotProps", value.asInstanceOf[js.Any])
    
    inline def slots(value: PartialChipSlots): this.type = set("slots", value.asInstanceOf[js.Any])
    ...
    inline def variant(value: OverridableStringUnion[VariantProp, ChipPropsVariantOverrides]): this.type = set("variant", value.asInstanceOf[js.Any])
    
    inline def vocab(value: String): this.type = set("vocab", value.asInstanceOf[js.Any])
  }
  
  type Props = /* props */ DefaultComponentPropsChipTypeMapdiv
  
  implicit def make(companion: Chip.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def styled: com.olvind.mui.StyledComponent.Builder[/* props */ DefaultComponentPropsChipTypeMapdiv, Builder] = new com.olvind.mui.StyledComponent.Builder[/* props */ DefaultComponentPropsChipTypeMapdiv, Builder](this.component, new js.Object, js.Array(), (newComponent: Any) => new Builder(js.Array(newComponent, js.Dictionary.empty)))
  
  def withProps(p: /* props */ DefaultComponentPropsChipTypeMapdiv): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
