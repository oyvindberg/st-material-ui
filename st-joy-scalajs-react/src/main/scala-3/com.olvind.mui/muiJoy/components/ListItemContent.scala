...
object ListItemContent {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def classes(value: PartialListItemContentClasses): this.type = set("classes", value.asInstanceOf[js.Any])
  ...
  type Props = /* props */ DefaultComponentPropsListItemContentType
  
  implicit def make(companion: ListItemContent.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def styled: com.olvind.mui.StyledComponent.Builder[/* props */ DefaultComponentPropsListItemContentType, Builder] = new com.olvind.mui.StyledComponent.Builder[/* props */ DefaultComponentPropsListItemContentType, Builder](this.component, new js.Object, js.Array(), (newComponent: Any) => new Builder(js.Array(newComponent, js.Dictionary.empty)))
  
  def withProps(p: /* props */ DefaultComponentPropsListItemContentType): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
