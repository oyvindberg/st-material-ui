...
object Tabs {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def color(value: OverridableStringUnion[ColorPaletteProp, TabsPropsColorOverrides]): this.type = set("color", value.asInstanceOf[js.Any])
    ...
    inline def defaultValue(value: String | Double | false): this.type = set("defaultValue", value.asInstanceOf[js.Any])
    
    inline def dir(value: String): this.type = set("dir", value.asInstanceOf[js.Any])
    
    inline def direction(value: TabsUnstyledDirection): this.type = set("direction", value.asInstanceOf[js.Any])
    ...
    inline def onChange(value: (/* event */ ReactEventFrom[Element], /* value */ Double | String | Boolean) => Callback): this.type = set("onChange", js.Any.fromFunction2((t0: /* event */ ReactEventFrom[Element], t1: /* value */ Double | String | Boolean) => (value(t0, t1)).runNow()))
    ...
    inline def orientation(value: TabsUnstyledOrientation): this.type = set("orientation", value.asInstanceOf[js.Any])
    ...
    inline def size(value: OverridableStringUnion["sm" | "md" | "lg", TabsPropsSizeOverrides]): this.type = set("size", value.asInstanceOf[js.Any])
    ...
    inline def value(value: String | Double | false): this.type = set("value", value.asInstanceOf[js.Any])
    
    inline def variant(value: OverridableStringUnion[VariantProp, TabsPropsVariantOverrides]): this.type = set("variant", value.asInstanceOf[js.Any])
    
    inline def vocab(value: String): this.type = set("vocab", value.asInstanceOf[js.Any])
  }
  
  type Props = /* props */ DefaultComponentPropsTabsTypeMapdiv
  
  implicit def make(companion: Tabs.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def styled: com.olvind.mui.StyledComponent.Builder[/* props */ DefaultComponentPropsTabsTypeMapdiv, Builder] = new com.olvind.mui.StyledComponent.Builder[/* props */ DefaultComponentPropsTabsTypeMapdiv, Builder](this.component, new js.Object, js.Array(), (newComponent: Any) => new Builder(js.Array(newComponent, js.Dictionary.empty)))
  
  def withProps(p: /* props */ DefaultComponentPropsTabsTypeMapdiv): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
