...
object Select {
  ...
  implicit def make[TValue /* <: js.Object */](companion: Select.type): SharedBuilder_DefaultComponentProps_767698552[TValue] = new SharedBuilder_DefaultComponentProps_767698552[TValue](js.Array(this.component, js.Dictionary.empty))()
