...
object SvgIcon {
  ...
  implicit def make(companion: SvgIcon.type): SharedBuilder_DefaultComponentPropsSvgIconTypeMapsvg715442404[SVGSVGElement] = new SharedBuilder_DefaultComponentPropsSvgIconTypeMapsvg715442404[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
