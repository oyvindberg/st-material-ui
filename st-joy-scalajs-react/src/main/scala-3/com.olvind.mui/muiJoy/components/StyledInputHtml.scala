...
object StyledInputHtml {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def onResize(value: ReactEventFrom[HTMLInputElement & Element] => Callback): this.type = set("onResize", js.Any.fromFunction1((t0: ReactEventFrom[HTMLInputElement & Element]) => value(t0).runNow()))
