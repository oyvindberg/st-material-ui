...
object ModalClose {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def color(value: OverridableStringUnion[ColorPaletteProp, ModalClosePropsColorOverrides]): this.type = set("color", value.asInstanceOf[js.Any])
    ...
    inline def size(value: OverridableStringUnion["sm" | "md" | "lg", ModalClosePropsSizeOverrides]): this.type = set("size", value.asInstanceOf[js.Any])
    ...
    inline def variant(value: OverridableStringUnion[VariantProp, ModalClosePropsVariantOverrides]): this.type = set("variant", value.asInstanceOf[js.Any])
    
    inline def vocab(value: String): this.type = set("vocab", value.asInstanceOf[js.Any])
  }
  
  type Props = /* props */ DefaultComponentPropsModalCloseTypeMapbu
  
  implicit def make(companion: ModalClose.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def styled: com.olvind.mui.StyledComponent.Builder[/* props */ DefaultComponentPropsModalCloseTypeMapbu, Builder] = new com.olvind.mui.StyledComponent.Builder[/* props */ DefaultComponentPropsModalCloseTypeMapbu, Builder](this.component, new js.Object, js.Array(), (newComponent: Any) => new Builder(js.Array(newComponent, js.Dictionary.empty)))
  
  def withProps(p: /* props */ DefaultComponentPropsModalCloseTypeMapbu): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
