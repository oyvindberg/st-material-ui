...
@scala.inline
open class SharedBuilder_DefaultComponentPropsSvgIconTypeMapsvg715442404[R <: js.Object] (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def color(value: OverridableStringUnion["inherit" | ColorPaletteProp, SvgIconPropsSizeOverrides]): this.type = set("color", value.asInstanceOf[js.Any])
