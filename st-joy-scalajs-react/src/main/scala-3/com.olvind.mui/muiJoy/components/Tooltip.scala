...
import com.olvind.mui.muiJoy.anon.Arrow
import com.olvind.mui.muiJoy.anon.DefaultComponentPropsTooltipTypeMapdiv
import com.olvind.mui.muiJoy.anon.PartialTooltipSlots
...
object Tooltip {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def color(value: OverridableStringUnion[ColorPaletteProp, TooltipPropsColorOverrides]): this.type = set("color", value.asInstanceOf[js.Any])
    ...
    inline def onClose(value: /* event */ ReactEventFrom[Element] | Event => Callback): this.type = set("onClose", js.Any.fromFunction1((t0: /* event */ ReactEventFrom[Element] | Event) => value(t0).runNow()))
    ...
    inline def size(value: OverridableStringUnion["sm" | "md" | "lg", TooltipPropsSizeOverrides]): this.type = set("size", value.asInstanceOf[js.Any])
    
    inline def slot(value: String): this.type = set("slot", value.asInstanceOf[js.Any])
    
    inline def slotProps(value: Arrow): this.type = set("slotProps", value.asInstanceOf[js.Any])
    
    inline def slots(value: PartialTooltipSlots): this.type = set("slots", value.asInstanceOf[js.Any])
    ...
    inline def variant(value: OverridableStringUnion[VariantProp, TooltipPropsVariantOverrides]): this.type = set("variant", value.asInstanceOf[js.Any])
    
    inline def vocab(value: String): this.type = set("vocab", value.asInstanceOf[js.Any])
  }
  
  type Props = /* props */ DefaultComponentPropsTooltipTypeMapdiv
  
  implicit def make(companion: Tooltip.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def styled: com.olvind.mui.StyledComponent.Builder[/* props */ DefaultComponentPropsTooltipTypeMapdiv, Builder] = new com.olvind.mui.StyledComponent.Builder[/* props */ DefaultComponentPropsTooltipTypeMapdiv, Builder](this.component, new js.Object, js.Array(), (newComponent: Any) => new Builder(js.Array(newComponent, js.Dictionary.empty)))
  
  def withProps(p: /* props */ DefaultComponentPropsTooltipTypeMapdiv): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
