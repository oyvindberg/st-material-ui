...
object Tooltip {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def slotProps(value: ArrowRoot): this.type = set("slotProps", value.asInstanceOf[js.Any])
    
    inline def slots(value: Arrow): this.type = set("slots", value.asInstanceOf[js.Any])
