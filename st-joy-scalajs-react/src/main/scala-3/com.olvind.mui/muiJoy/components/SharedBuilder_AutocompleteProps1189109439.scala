...
@scala.inline
open class SharedBuilder_AutocompleteProps1189109439[T, Multiple /* <: js.UndefOr[Boolean] */, DisableClearable /* <: js.UndefOr[Boolean] */, FreeSolo /* <: js.UndefOr[Boolean] */] (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def color(value: OverridableStringUnion[ColorPaletteProp, AutocompletePropsColorOverrides]): this.type = set("color", value.asInstanceOf[js.Any])
  ...
  inline def getLimitTagsText(value: /* more */ String | Double => Node): this.type = set("getLimitTagsText", js.Any.fromFunction1(value))
  ...
  inline def onKeyDown(value: /* event */ KeyboardEventHTMLDivElement => Callback): this.type = set("onKeyDown", js.Any.fromFunction1((t0: /* event */ KeyboardEventHTMLDivElement) => value(t0).runNow()))
  ...
  inline def renderOption(
    value: (/* props */ OmitHTMLAttributesHTMLLIElementcolor, T, /* state */ AutocompleteRenderOptionState) => Node
  ...
  inline def size(value: OverridableStringUnion["sm" | "md" | "lg", AutocompletePropsSizeOverrides]): this.type = set("size", value.asInstanceOf[js.Any])
  
  inline def slot(value: String): this.type = set("slot", value.asInstanceOf[js.Any])
  
  inline def slotProps(value: com.olvind.mui.muiJoy.anon.Input): this.type = set("slotProps", value.asInstanceOf[js.Any])
  
  inline def slots(value: PartialAutocompleteSlots): this.type = set("slots", value.asInstanceOf[js.Any])
  ...
  inline def variant(value: OverridableStringUnion[VariantProp, AutocompletePropsVariantOverrides]): this.type = set("variant", value.asInstanceOf[js.Any])
