...
object Button {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def action(value: Ref[FocusVisible]): this.type = set("action", value.asInstanceOf[js.Any])
    
    inline def actionFunction1(value: FocusVisible | Null => Callback): this.type = set("action", js.Any.fromFunction1((t0: FocusVisible | Null) => value(t0).runNow()))
    ...
    inline def loadingIndicator(value: VdomNode): this.type = set("loadingIndicator", value.rawNode.asInstanceOf[js.Any])
    
    inline def loadingIndicatorNull: this.type = set("loadingIndicator", null)
    
    inline def loadingIndicatorVarargs(value: (Empty | String | JsNumber | Element)*): this.type = set("loadingIndicator", js.Array(value*))
    
    inline def loadingIndicatorVdomElement(value: VdomElement): this.type = set("loadingIndicator", value.rawElement.asInstanceOf[js.Any])
    
    inline def loadingPosition(value: "start" | "end" | "center"): this.type = set("loadingPosition", value.asInstanceOf[js.Any])
    ...
    inline def size(value: OverridableStringUnion["sm" | "md" | "lg", ButtonPropsSizeOverrides]): this.type = set("size", value.asInstanceOf[js.Any])
    ...
    inline def variant(value: OverridableStringUnion[VariantProp, ButtonPropsVariantOverrides]): this.type = set("variant", value.asInstanceOf[js.Any])
    
    inline def vocab(value: String): this.type = set("vocab", value.asInstanceOf[js.Any])
  }
  
  type Props = /* props */ OverridePropsExtendButtonTypeMapButtonTy
  
  implicit def make(companion: Button.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def styled: com.olvind.mui.StyledComponent.Builder[/* props */ OverridePropsExtendButtonTypeMapButtonTy, Builder] = new com.olvind.mui.StyledComponent.Builder[/* props */ OverridePropsExtendButtonTypeMapButtonTy, Builder](this.component, new js.Object, js.Array(), (newComponent: Any) => new Builder(js.Array(newComponent, js.Dictionary.empty)))
  
  def withProps(p: /* props */ OverridePropsExtendButtonTypeMapButtonTy): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
