...
object Component {
  ...
  inline def apply[T, Multiple /* <: js.UndefOr[Boolean] */, DisableClearable /* <: js.UndefOr[Boolean] */, FreeSolo /* <: js.UndefOr[Boolean] */](options: js.Array[T]): Builder[T, Multiple, DisableClearable, FreeSolo] = {
  ...
  open class Builder[T, Multiple /* <: js.UndefOr[Boolean] */, DisableClearable /* <: js.UndefOr[Boolean] */, FreeSolo /* <: js.UndefOr[Boolean] */] (val args: js.Array[Any])
    ...
    inline def slotProps(value: LimitTag): this.type = set("slotProps", value.asInstanceOf[js.Any])
    
    inline def slots(value: com.olvind.mui.muiJoy.anon.Input): this.type = set("slots", value.asInstanceOf[js.Any])
