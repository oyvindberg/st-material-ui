...
import com.olvind.mui.muiJoy.anon.PartialTextareaSlots
...
object Textarea {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def color(value: OverridableStringUnion[ColorPaletteProp, TextareaPropsColorOverrides]): this.type = set("color", value.asInstanceOf[js.Any])
    ...
    inline def onChange(value: ReactEventFrom[HTMLTextAreaElement & org.scalajs.dom.Element] => Callback): this.type = set("onChange", js.Any.fromFunction1((t0: ReactEventFrom[HTMLTextAreaElement & org.scalajs.dom.Element]) => value(t0).runNow()))
    ...
    inline def size(value: OverridableStringUnion["sm" | "md" | "lg", TextareaPropsSizeOverrides]): this.type = set("size", value.asInstanceOf[js.Any])
    
    inline def slot(value: String): this.type = set("slot", value.asInstanceOf[js.Any])
    
    inline def slotProps(value: com.olvind.mui.muiJoy.anon.Textarea): this.type = set("slotProps", value.asInstanceOf[js.Any])
    
    inline def slots(value: PartialTextareaSlots): this.type = set("slots", value.asInstanceOf[js.Any])
    ...
    inline def variant(value: OverridableStringUnion[VariantProp, TextareaPropsVariantOverrides]): this.type = set("variant", value.asInstanceOf[js.Any])
    
    inline def vocab(value: String): this.type = set("vocab", value.asInstanceOf[js.Any])
  }
  
  type Props = /* props */ DefaultComponentPropsTextareaTypeMapdiv
  
  implicit def make(companion: Textarea.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def styled: com.olvind.mui.StyledComponent.Builder[/* props */ DefaultComponentPropsTextareaTypeMapdiv, Builder] = new com.olvind.mui.StyledComponent.Builder[/* props */ DefaultComponentPropsTextareaTypeMapdiv, Builder](this.component, new js.Object, js.Array(), (newComponent: Any) => new Builder(js.Array(newComponent, js.Dictionary.empty)))
  
  def withProps(p: /* props */ DefaultComponentPropsTextareaTypeMapdiv): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
