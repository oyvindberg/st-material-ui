...
object Cancel {
  ...
  implicit def make(companion: Cancel.type): SharedBuilder_DefaultComponentPropsSvgIconTypeMapsvg715442404[SVGSVGElement] = new SharedBuilder_DefaultComponentPropsSvgIconTypeMapsvg715442404[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
