...
object ListItemButton {
  ...
  type Props = /* props */ OverridePropsExtendListItemButtonTypeMap
  
  implicit def make(companion: ListItemButton.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def styled: com.olvind.mui.StyledComponent.Builder[/* props */ OverridePropsExtendListItemButtonTypeMap, Builder] = new com.olvind.mui.StyledComponent.Builder[/* props */ OverridePropsExtendListItemButtonTypeMap, Builder](this.component, new js.Object, js.Array(), (newComponent: Any) => new Builder(js.Array(newComponent, js.Dictionary.empty)))
  
  def withProps(p: /* props */ OverridePropsExtendListItemButtonTypeMap): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
