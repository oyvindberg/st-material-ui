...
import com.olvind.mui.muiJoy.anon.OnClose
import com.olvind.mui.muiJoy.anon.PartialModalSlots
import com.olvind.mui.muiJoy.anon.PickModalUnstyledOwnPropschildrencontain
...
object modalModalPropsMod {
  
  /* Inlined parent @mui/joy.@mui/joy/Modal/ModalProps.ModalProps<@mui/joy.@mui/joy/Modal/ModalProps.ModalTypeMap<{}, 'div'>['defaultComponent'], {  component :react.react.ElementType<any> | undefined}> */
  trait ModalOwnerState extends StObject {
    ...
    var slots: js.UndefOr[PartialModalSlots] = js.undefined
  ...
  object ModalOwnerState {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(children = children.rawElement.asInstanceOf[js.Any], disableAutoFocus = disableAutoFocus.asInstanceOf[js.Any], disableEnforceFocus = disableEnforceFocus.asInstanceOf[js.Any], disableEscapeKeyDown = disableEscapeKeyDown.asInstanceOf[js.Any], disablePortal = disablePortal.asInstanceOf[js.Any], disableRestoreFocus = disableRestoreFocus.asInstanceOf[js.Any], disableScrollLock = disableScrollLock.asInstanceOf[js.Any], hideBackdrop = hideBackdrop.asInstanceOf[js.Any], keepMounted = keepMounted.asInstanceOf[js.Any], open = open.asInstanceOf[js.Any])
      __obj.asInstanceOf[ModalOwnerState]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: ModalOwnerState] (val x: Self) extends AnyVal {
      ...
      inline def setOnClose(
        value: (/* event */ js.Object, /* reason */ "backdropClick" | "escapeKeyDown" | "closeClick") => Callback
      ): Self = StObject.set(x, "onClose", js.Any.fromFunction2((t0: /* event */ js.Object, t1: /* reason */ "backdropClick" | "escapeKeyDown" | "closeClick") => (value(t0, t1)).runNow()))
      ...
      inline def setSlots(value: PartialModalSlots): Self = StObject.set(x, "slots", value.asInstanceOf[js.Any])
  ...
  type ModalProps[D /* <: ElementType */, P] = OverrideProps[ModalTypeMap[P, D], D]
  ...
  type ModalSlot = "root" | "backdrop"
  
  trait ModalSlots extends StObject {
  ...
  object ModalSlots {
    ...
    inline def apply(backdrop: ElementType, root: ElementType): ModalSlots = {
      val __obj = js.Dynamic.literal(backdrop = backdrop.asInstanceOf[js.Any], root = root.asInstanceOf[js.Any])
      __obj.asInstanceOf[ModalSlots]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: ModalSlots] (val x: Self) extends AnyVal {
  ...
  type ModalSlotsAndSlotProps = CreateSlotsAndSlotProps[ModalSlots, BackdropRoot]
  
  trait ModalTypeMap[P, D /* <: ElementType */] extends StObject {
    
    var defaultComponent: D
    
    var props: P & ModalSlotsAndSlotProps & PickModalUnstyledOwnPropschildrencontain & OnClose
  }
  object ModalTypeMap {
    
    inline def apply[P, D /* <: ElementType */](
      defaultComponent: D,
      props: P & ModalSlotsAndSlotProps & PickModalUnstyledOwnPropschildrencontain & OnClose
    ): ModalTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[ModalTypeMap[P, D]]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: ModalTypeMap[?, ?], P, D /* <: ElementType */] (val x: Self & (ModalTypeMap[P, D])) extends AnyVal {
      
      inline def setDefaultComponent(value: D): Self = StObject.set(x, "defaultComponent", value.asInstanceOf[js.Any])
      
      inline def setProps(value: P & ModalSlotsAndSlotProps & PickModalUnstyledOwnPropschildrencontain & OnClose): Self = StObject.set(x, "props", value.asInstanceOf[js.Any])
    }
  }
}
