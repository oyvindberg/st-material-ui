...
import com.olvind.mui.muiJoy.anon.BackdropSlotProps
...
object modalModalPropsMod {
  ...
  trait ModalOwnerState extends StObject {
    ...
    var slotProps: js.UndefOr[BackdropRoot] = js.undefined
    
    var slots: js.UndefOr[Backdrop] = js.undefined
  ...
  object ModalOwnerState {
    ...
    implicit open class MutableBuilder[Self <: ModalOwnerState] (val x: Self) extends AnyVal {
      ...
      inline def setSlotProps(value: BackdropRoot): Self = StObject.set(x, "slotProps", value.asInstanceOf[js.Any])
      
      inline def setSlotPropsUndefined: Self = StObject.set(x, "slotProps", js.undefined)
      
      inline def setSlotUndefined: Self = StObject.set(x, "slot", js.undefined)
      
      inline def setSlots(value: Backdrop): Self = StObject.set(x, "slots", value.asInstanceOf[js.Any])
  ...
  type ModalSlotsAndSlotProps = CreateSlotsAndSlotProps[ModalSlot, BackdropSlotProps]
