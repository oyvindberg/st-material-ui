...
object tabsTabsPropsMod {
  ...
  /* Inlined parent @mui/joy.@mui/joy/Tabs/TabsProps.TabsProps<@mui/joy.@mui/joy/Tabs/TabsProps.TabsTypeMap<{}, 'div'>['defaultComponent'], {  component :react.react.ElementType<any> | undefined}> */
  trait TabsOwnerState extends StObject {
  ...
  object TabsOwnerState {
    ...
    inline def apply(): TabsOwnerState = {
