...
import com.olvind.mui.muiJoy.anon.ArrowSlotProps
...
object tooltipTooltipPropsMod {
  ...
  /* Inlined parent @mui/joy.@mui/joy/Tooltip/TooltipProps.TooltipProps<@mui/joy.@mui/joy/Tooltip/TooltipProps.TooltipTypeMap<{}, 'div'>['defaultComponent'], {  component :react.react.ElementType<any> | undefined}> */
  trait TooltipOwnerState extends StObject {
  ...
  object TooltipOwnerState {
    ...
    inline def apply(children: VdomElement, touch: Boolean): TooltipOwnerState = {
      val __obj = js.Dynamic.literal(children = children.rawElement.asInstanceOf[js.Any], touch = touch.asInstanceOf[js.Any], title = null)
  ...
  type TooltipSlotsAndSlotProps = CreateSlotsAndSlotProps[TooltipSlot, ArrowSlotProps]
