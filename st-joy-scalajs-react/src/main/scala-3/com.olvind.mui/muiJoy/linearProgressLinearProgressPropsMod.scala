...
object linearProgressLinearProgressPropsMod {
  ...
  /* Inlined parent @mui/joy.@mui/joy/LinearProgress/LinearProgressProps.LinearProgressProps<@mui/joy.@mui/joy/LinearProgress/LinearProgressProps.LinearProgressTypeMap<{}, 'div'>['defaultComponent'], {  component :react.react.ElementType<any> | undefined}> */
  trait LinearProgressOwnerState extends StObject {
  ...
  type LinearProgressProps[D /* <: ElementType */, P] = OverrideProps[LinearProgressTypeMap[P, D], D]
  ...
  trait LinearProgressTypeMap[P, D /* <: ElementType */] extends StObject {
  ...
  object LinearProgressTypeMap {
    ...
    inline def apply[P, D /* <: ElementType */](defaultComponent: D, props: P & Thickness): LinearProgressTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[LinearProgressTypeMap[P, D]]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: LinearProgressTypeMap[?, ?], P, D /* <: ElementType */] (val x: Self & (LinearProgressTypeMap[P, D])) extends AnyVal {
