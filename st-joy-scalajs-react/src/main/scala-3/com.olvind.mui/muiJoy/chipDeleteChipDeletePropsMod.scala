...
object chipDeleteChipDeletePropsMod {
  ...
  type ChipDeleteProps[D /* <: ElementType */, P] = OverrideProps[ChipDeleteTypeMap[P, D], D]
  ...
  trait ChipDeleteTypeMap[P, D /* <: ElementType */] extends StObject {
  ...
  object ChipDeleteTypeMap {
    ...
    inline def apply[P, D /* <: ElementType */](defaultComponent: D, props: P & OnDelete): ChipDeleteTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[ChipDeleteTypeMap[P, D]]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: ChipDeleteTypeMap[?, ?], P, D /* <: ElementType */] (val x: Self & (ChipDeleteTypeMap[P, D])) extends AnyVal {
