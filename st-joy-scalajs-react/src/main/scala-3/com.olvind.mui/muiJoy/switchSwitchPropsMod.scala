...
import com.olvind.mui.muiJoy.anon.ActionEndDecoratorInput
...
object switchSwitchPropsMod {
  ...
  /* Inlined parent @mui/joy.@mui/joy/Switch/SwitchProps.SwitchProps<@mui/joy.@mui/joy/Switch/SwitchProps.SwitchTypeMap<{}, 'div'>['defaultComponent'], {  component :react.react.ElementType<any> | undefined}> */
  trait SwitchOwnerState extends StObject {
    ...
    /**
      ...
      */
    var endDecorator: js.UndefOr[Node | (js.Function1[/* ownerState */ this.type, Node])] = js.undefined
    ...
    var slotProps: js.UndefOr[ThumbTrack] = js.undefined
    
    var slots: js.UndefOr[StartDecoratorThumb] = js.undefined
    ...
    /**
      * The element that appears at the end of the switch.
      */
    var startDecorator: js.UndefOr[Node | (js.Function1[/* ownerState */ this.type, Node])] = js.undefined
  ...
  object SwitchOwnerState {
    ...
    implicit open class MutableBuilder[Self <: SwitchOwnerState] (val x: Self) extends AnyVal {
      ...
      inline def setEndDecorator(value: Node | (js.Function1[SwitchOwnerState, Node])): Self = StObject.set(x, "endDecorator", value.asInstanceOf[js.Any])
      
      inline def setEndDecoratorFunction1(value: SwitchOwnerState => Node): Self = StObject.set(x, "endDecorator", js.Any.fromFunction1(value))
      ...
      inline def setSlotProps(value: ThumbTrack): Self = StObject.set(x, "slotProps", value.asInstanceOf[js.Any])
      
      inline def setSlotPropsUndefined: Self = StObject.set(x, "slotProps", js.undefined)
      
      inline def setSlotUndefined: Self = StObject.set(x, "slot", js.undefined)
      
      inline def setSlots(value: StartDecoratorThumb): Self = StObject.set(x, "slots", value.asInstanceOf[js.Any])
      ...
      inline def setStartDecorator(value: Node | (js.Function1[SwitchOwnerState, Node])): Self = StObject.set(x, "startDecorator", value.asInstanceOf[js.Any])
      
      inline def setStartDecoratorFunction1(value: SwitchOwnerState => Node): Self = StObject.set(x, "startDecorator", js.Any.fromFunction1(value))
  ...
  type SwitchProps[D /* <: ElementType */, P] = OverrideProps[SwitchTypeMap[P, D], D]
  ...
  type SwitchSlotsAndSlotProps = CreateSlotsAndSlotProps[SwitchSlot, ActionEndDecoratorInput]
  
  trait SwitchTypeMap[P, D /* <: ElementType */] extends StObject {
  ...
  object SwitchTypeMap {
    ...
    inline def apply[P, D /* <: ElementType */](defaultComponent: D, props: P & SwitchSlotsAndSlotProps & UseSwitchParameters & ColorEndDecorator): SwitchTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[SwitchTypeMap[P, D]]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: SwitchTypeMap[?, ?], P, D /* <: ElementType */] (val x: Self & (SwitchTypeMap[P, D])) extends AnyVal {
