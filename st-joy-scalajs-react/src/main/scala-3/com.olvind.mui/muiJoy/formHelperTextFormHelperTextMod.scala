...
object formHelperTextFormHelperTextMod extends Shortcut {
  ...
  type _To = js.Function1[/* props */ DefaultComponentPropsFormHelperTextTypeM, Element | Null]
  
  /* This means you don't have to write `default`, but can instead just say `formHelperTextFormHelperTextMod.foo` */
  override def _to: js.Function1[/* props */ DefaultComponentPropsFormHelperTextTypeM, Element | Null] = default
}
