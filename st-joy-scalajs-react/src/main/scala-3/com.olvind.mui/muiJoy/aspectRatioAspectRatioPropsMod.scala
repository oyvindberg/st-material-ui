...
import com.olvind.mui.muiJoy.anon.ContentSlotProps
...
object aspectRatioAspectRatioPropsMod {
  ...
  /* Inlined parent @mui/joy.@mui/joy/AspectRatio/AspectRatioProps.AspectRatioProps<@mui/joy.@mui/joy/AspectRatio/AspectRatioProps.AspectRatioTypeMap<{}, 'div'>['defaultComponent'], {  component :react.react.ElementType<any> | undefined}> */
  trait AspectRatioOwnerState extends StObject {
    ...
    /**
      ...
      * @default 'neutral'
      */
    var color: js.UndefOr[OverridableStringUnion[ColorPaletteProp, AspectRatioPropsColorOverrides]] = js.undefined
    ...
    var slotProps: js.UndefOr[ContentRoot] = js.undefined
    
    var slots: js.UndefOr[Content] = js.undefined
  ...
  object AspectRatioOwnerState {
    
    inline def apply(): AspectRatioOwnerState = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[AspectRatioOwnerState]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: AspectRatioOwnerState] (val x: Self) extends AnyVal {
      ...
      inline def setColor(value: OverridableStringUnion[ColorPaletteProp, AspectRatioPropsColorOverrides]): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
      ...
      inline def setSlotProps(value: ContentRoot): Self = StObject.set(x, "slotProps", value.asInstanceOf[js.Any])
      
      inline def setSlotPropsUndefined: Self = StObject.set(x, "slotProps", js.undefined)
      
      inline def setSlotUndefined: Self = StObject.set(x, "slot", js.undefined)
      
      inline def setSlots(value: Content): Self = StObject.set(x, "slots", value.asInstanceOf[js.Any])
      ...
      inline def setVariant(value: OverridableStringUnion[VariantProp, AspectRatioPropsVariantOverrides]): Self = StObject.set(x, "variant", value.asInstanceOf[js.Any])
  ...
  type AspectRatioSlotsAndSlotProps = CreateSlotsAndSlotProps[AspectRatioSlot, ContentSlotProps]
