...
object textareaTextareaMod extends Shortcut {
  ...
  type _To = js.Function1[/* props */ DefaultComponentPropsTextareaTypeMapdiv, Element | Null]
  
  /* This means you don't have to write `default`, but can instead just say `textareaTextareaMod.foo` */
  override def _to: js.Function1[/* props */ DefaultComponentPropsTextareaTypeMapdiv, Element | Null] = default
}
