...
object breadcrumbsBreadcrumbsPropsMod {
  
  /* Inlined parent @mui/joy.@mui/joy/Breadcrumbs/BreadcrumbsProps.BreadcrumbsProps<@mui/joy.@mui/joy/Breadcrumbs/BreadcrumbsProps.BreadcrumbsTypeMap<{}, 'nav'>['defaultComponent'], {  component :react.react.ElementType<any> | undefined}> */
  trait BreadcrumbsOwnerState extends StObject {
  ...
  object BreadcrumbsOwnerState {
    
    inline def apply(): BreadcrumbsOwnerState = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[BreadcrumbsOwnerState]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: BreadcrumbsOwnerState] (val x: Self) extends AnyVal {
  ...
  trait BreadcrumbsPropsSizeOverrides extends StObject
  
  object BreadcrumbsSlot {
  ...
  trait BreadcrumbsSlots extends StObject {
    ...
    /**
      ...
      * @default 'li'
      */
    var separator: ElementType
  }
  object BreadcrumbsSlots {
    
    inline def apply(li: ElementType, ol: ElementType, root: ElementType, separator: ElementType): BreadcrumbsSlots = {
  ...
  object BreadcrumbsTypeMap {
    ...
    inline def apply[P, D /* <: ElementType */](defaultComponent: D, props: P & BreadcrumbsSlotsAndSlotProps & Separator): BreadcrumbsTypeMap[P, D] = {
