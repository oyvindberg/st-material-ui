...
object cardCoverCardCoverPropsMod {
  ...
  type CardCoverProps[D /* <: ElementType */, P] = OverrideProps[CardCoverTypeMap[P, D], D]
  
  type CardCoverSlot = "root"
  
  trait CardCoverTypeMap[P, D /* <: ElementType */] extends StObject {
  ...
  object CardCoverTypeMap {
    ...
    inline def apply[P, D /* <: ElementType */](defaultComponent: D, props: P & ChildrenSx): CardCoverTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[CardCoverTypeMap[P, D]]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: CardCoverTypeMap[?, ?], P, D /* <: ElementType */] (val x: Self & (CardCoverTypeMap[P, D])) extends AnyVal {
