...
object modalCloseModalClosePropsMod {
  ...
  type ModalCloseProps[D /* <: ElementType */, P] = OverrideProps[ModalCloseTypeMap[P, D], D]
  ...
  trait ModalCloseTypeMap[P, D /* <: ElementType */] extends StObject {
  ...
  object ModalCloseTypeMap {
    ...
    inline def apply[P, D /* <: ElementType */](defaultComponent: D, props: P & ColorSize): ModalCloseTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[ModalCloseTypeMap[P, D]]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: ModalCloseTypeMap[?, ?], P, D /* <: ElementType */] (val x: Self & (ModalCloseTypeMap[P, D])) extends AnyVal {
