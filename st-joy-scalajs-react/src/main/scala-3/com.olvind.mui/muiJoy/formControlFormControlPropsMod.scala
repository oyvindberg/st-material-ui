...
import com.olvind.mui.muiJoy.anon.Error
...
object formControlFormControlPropsMod {
  
  /* Inlined parent @mui/joy.@mui/joy/FormControl/FormControlProps.FormControlProps<@mui/joy.@mui/joy/FormControl/FormControlProps.FormControlTypeMap<{}, 'div'>['defaultComponent'], {  component :react.react.ElementType<any> | undefined}> */
  trait FormControlOwnerState extends StObject {
    ...
    /**
      ...
      */
    var color: js.UndefOr[OverridableStringUnion[ColorPaletteProp, FormControlPropsColorOverrides]] = js.undefined
    ...
    /**
      ...
      * @default 'md'
      */
    var size: js.UndefOr[OverridableStringUnion["sm" | "md" | "lg", FormControlPropsSizeOverrides]] = js.undefined
  ...
  object FormControlOwnerState {
    
    inline def apply(): FormControlOwnerState = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[FormControlOwnerState]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: FormControlOwnerState] (val x: Self) extends AnyVal {
      ...
      inline def setColor(value: OverridableStringUnion[ColorPaletteProp, FormControlPropsColorOverrides]): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
      ...
      inline def setSize(value: OverridableStringUnion["sm" | "md" | "lg", FormControlPropsSizeOverrides]): Self = StObject.set(x, "size", value.asInstanceOf[js.Any])
  ...
  object FormControlTypeMap {
    ...
    inline def apply[P, D /* <: ElementType */](defaultComponent: D, props: P & Error): FormControlTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[FormControlTypeMap[P, D]]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: FormControlTypeMap[?, ?], P, D /* <: ElementType */] (val x: Self & (FormControlTypeMap[P, D])) extends AnyVal {
