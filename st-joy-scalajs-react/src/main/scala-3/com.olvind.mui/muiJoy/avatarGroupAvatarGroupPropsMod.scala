...
object avatarGroupAvatarGroupPropsMod {
  ...
  type AvatarGroupProps[D /* <: ElementType */, P] = OverrideProps[AvatarGroupTypeMap[P, D], D]
  
  type AvatarGroupSlot = "root"
  
  trait AvatarGroupTypeMap[P, D /* <: ElementType */] extends StObject {
  ...
  object AvatarGroupTypeMap {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: AvatarGroupTypeMap[?, ?], P, D /* <: ElementType */] (val x: Self & (AvatarGroupTypeMap[P, D])) extends AnyVal {
