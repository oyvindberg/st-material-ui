...
trait VariantOutlinedDisabled extends StObject {
...
object VariantOutlinedDisabled {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[VariantOutlinedDisabled]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: VariantOutlinedDisabled] (val x: Self) extends AnyVal {
