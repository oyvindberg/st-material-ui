...
trait VariantSoftHover extends StObject {
...
object VariantSoftHover {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[VariantSoftHover]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: VariantSoftHover] (val x: Self) extends AnyVal {
