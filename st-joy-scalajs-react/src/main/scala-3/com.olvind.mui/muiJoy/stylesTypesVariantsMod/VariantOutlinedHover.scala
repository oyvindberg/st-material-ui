...
trait VariantOutlinedHover extends StObject {
...
object VariantOutlinedHover {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[VariantOutlinedHover]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: VariantOutlinedHover] (val x: Self) extends AnyVal {
