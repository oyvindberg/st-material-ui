...
trait VariantPlainActive extends StObject {
...
object VariantPlainActive {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[VariantPlainActive]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: VariantPlainActive] (val x: Self) extends AnyVal {
