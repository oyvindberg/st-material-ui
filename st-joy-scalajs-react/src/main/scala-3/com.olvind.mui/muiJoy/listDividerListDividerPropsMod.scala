...
object listDividerListDividerPropsMod {
  ...
  type ListDividerProps[D /* <: ElementType */, P] = OverrideProps[ListDividerTypeMap[P, D], D]
  
  type ListDividerSlot = "root"
  
  trait ListDividerTypeMap[P, D /* <: ElementType */] extends StObject {
  ...
  object ListDividerTypeMap {
    ...
    inline def apply[P, D /* <: ElementType */](defaultComponent: D, props: P & ChildrenInset): ListDividerTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[ListDividerTypeMap[P, D]]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: ListDividerTypeMap[?, ?], P, D /* <: ElementType */] (val x: Self & (ListDividerTypeMap[P, D])) extends AnyVal {
