...
object tabListTabListMod extends Shortcut {
  ...
  type _To = js.Function1[/* props */ DefaultComponentPropsTabListTypeMapdiv, Element | Null]
  
  /* This means you don't have to write `default`, but can instead just say `tabListTabListMod.foo` */
  override def _to: js.Function1[/* props */ DefaultComponentPropsTabListTypeMapdiv, Element | Null] = default
}
