...
import com.olvind.mui.muiJoy.linearProgressLinearProgressClassesMod.LinearProgressClasses
...
object mod {
  ...
  @JSImport("@mui/joy", JSImport.Namespace)
  @js.native
  ...
  @js.native
  val CircularProgress: js.Function1[/* props */ DefaultComponentPropsCircularProgressTyp, Element | Null] = js.native
  ...
  @JSImport("@mui/joy", "Container")
  @js.native
  val Container: js.Function1[/* props */ DefaultComponentPropsContainerTypeMapdiv, Element | Null] = js.native
  ...
  object CssBaseline {
    ...
    @JSImport("@mui/joy", "CssBaseline.propTypes")
    @js.native
  ...
  inline def GlobalStyles(props: GlobalStylesProps[Theme]): japgolly.scalajs.react.facade.React.Element = ^.asInstanceOf[js.Dynamic].applyDynamic("GlobalStyles")(props.asInstanceOf[js.Any]).asInstanceOf[japgolly.scalajs.react.facade.React.Element]
  
  @JSImport("@mui/joy", "Grid")
  @js.native
  ...
  @JSImport("@mui/joy", "avatarGroupClasses")
  @js.native
  val avatarGroupClasses: AvatarGroupClasses = js.native
  
  @JSImport("@mui/joy", "badgeClasses")
  @js.native
  val badgeClasses: BadgeClasses = js.native
  
  @JSImport("@mui/joy", "breadcrumbsClasses")
  @js.native
  val breadcrumbsClasses: BreadcrumbsClasses = js.native
  
  @JSImport("@mui/joy", "buttonClasses")
  @js.native
  val buttonClasses: ButtonClasses = js.native
  
  @JSImport("@mui/joy", "cardClasses")
  @js.native
  val cardClasses: CardClasses = js.native
  
  @JSImport("@mui/joy", "cardContentClasses")
  @js.native
  val cardContentClasses: CardContentClasses = js.native
  
  @JSImport("@mui/joy", "cardCoverClasses")
  @js.native
  val cardCoverClasses: CardCoverClasses = js.native
  
  @JSImport("@mui/joy", "cardOverflowClasses")
  @js.native
  val cardOverflowClasses: CardOverflowClasses = js.native
  
  @JSImport("@mui/joy", "checkboxClasses")
  @js.native
  val checkboxClasses: CheckboxClasses = js.native
  
  @JSImport("@mui/joy", "chipClasses")
  @js.native
  val chipClasses: ChipClasses = js.native
  
  @JSImport("@mui/joy", "chipDeleteClasses")
  @js.native
  val chipDeleteClasses: ChipDeleteClasses = js.native
  
  @JSImport("@mui/joy", "circularProgressClasses")
  @js.native
  val circularProgressClasses: CircularProgressClasses = js.native
  
  object colors {
    
    @JSImport("@mui/joy", "colors")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@mui/joy", "colors.blue")
    @js.native
    def blue: `100` = js.native
    inline def blue_=(x: `100`): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("blue")(x.asInstanceOf[js.Any])
    
    @JSImport("@mui/joy", "colors.green")
    @js.native
    def green: `100` = js.native
    inline def green_=(x: `100`): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("green")(x.asInstanceOf[js.Any])
    
    @JSImport("@mui/joy", "colors.grey")
    @js.native
    def grey: `100` = js.native
    inline def grey_=(x: `100`): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("grey")(x.asInstanceOf[js.Any])
    
    @JSImport("@mui/joy", "colors.purple")
    @js.native
    def purple: `100` = js.native
    inline def purple_=(x: `100`): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("purple")(x.asInstanceOf[js.Any])
    
    @JSImport("@mui/joy", "colors.red")
    @js.native
    def red: `100` = js.native
    inline def red_=(x: `100`): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("red")(x.asInstanceOf[js.Any])
    
    @JSImport("@mui/joy", "colors.yellow")
    @js.native
    def yellow: `100` = js.native
    inline def yellow_=(x: `100`): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("yellow")(x.asInstanceOf[js.Any])
  }
  
  @JSImport("@mui/joy", "containerClasses")
  @js.native
  ...
  @JSImport("@mui/joy", "dividerClasses")
  @js.native
  ...
  inline def getModalCloseUtilityClass(slot: String): String = ^.asInstanceOf[js.Dynamic].applyDynamic("getModalCloseUtilityClass")(slot.asInstanceOf[js.Any]).asInstanceOf[String]
  ...
  @JSImport("@mui/joy", "radioClasses")
  @js.native
  val radioClasses: RadioClasses = js.native
  
  @JSImport("@mui/joy", "radioGroupClasses")
  @js.native
  ...
  object scopedCssBaselineClasses {
    ...
    @JSImport("@mui/joy", "scopedCssBaselineClasses")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@mui/joy", "scopedCssBaselineClasses.root")
    @js.native
    def root: String = js.native
    inline def root_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("root")(x.asInstanceOf[js.Any])
  }
  
  @JSImport("@mui/joy", "selectClasses")
  @js.native
  val selectClasses: SelectClasses = js.native
  
  @JSImport("@mui/joy", "sheetClasses")
  @js.native
  ...
  @JSImport("@mui/joy", "tooltipClasses")
  @js.native
  val tooltipClasses: TooltipClasses = js.native
  
  @JSImport("@mui/joy", "typographyClasses")
  @js.native
