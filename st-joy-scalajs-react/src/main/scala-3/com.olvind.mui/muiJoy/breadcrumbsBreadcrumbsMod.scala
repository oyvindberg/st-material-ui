...
object breadcrumbsBreadcrumbsMod extends Shortcut {
  ...
  type _To = js.Function1[/* props */ DefaultComponentPropsBreadcrumbsTypeMapn, Element | Null]
  
  /* This means you don't have to write `default`, but can instead just say `breadcrumbsBreadcrumbsMod.foo` */
  override def _to: js.Function1[/* props */ DefaultComponentPropsBreadcrumbsTypeMapn, Element | Null] = default
}
