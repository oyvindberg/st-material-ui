...
import com.olvind.mui.muiJoy.anon.PartialRecordkeyofTypographySysteminheri
import com.olvind.mui.muiJoy.anon.`3`
...
object typographyTypographyPropsMod {
  ...
  /* Inlined parent @mui/joy.@mui/joy/Typography/TypographyProps.TypographyProps<@mui/joy.@mui/joy/Typography/TypographyProps.TypographyTypeMap<{}, 'span'>['defaultComponent'], {  component :react.react.ElementType<any> | undefined}> */
  trait TypographyOwnerState extends StObject {
  ...
  type TypographySlotsAndSlotProps = CreateSlotsAndSlotProps[TypographySlot, EndDecoratorSlotProps]
  ...
  object TypographyTypeMap {
    ...
    inline def apply[P, D /* <: ElementType */](defaultComponent: D, props: P & TypographySlotsAndSlotProps & OmitSystemPropscolor & GutterBottom): TypographyTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[TypographyTypeMap[P, D]]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: TypographyTypeMap[?, ?], P, D /* <: ElementType */] (val x: Self & (TypographyTypeMap[P, D])) extends AnyVal {
