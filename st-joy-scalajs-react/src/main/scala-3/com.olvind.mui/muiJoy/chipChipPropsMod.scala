...
import com.olvind.mui.muiJoy.anon.LabelRoot
...
object chipChipPropsMod {
  ...
  /* Inlined parent @mui/joy.@mui/joy/Chip/ChipProps.ChipProps<@mui/joy.@mui/joy/Chip/ChipProps.ChipTypeMap<{}, 'div'>['defaultComponent'], {  component :react.react.ElementType<any> | undefined}> */
  trait ChipOwnerState extends StObject {
  ...
  type ChipSlotsAndSlotProps = CreateSlotsAndSlotProps[ChipSlot, LabelRoot]
