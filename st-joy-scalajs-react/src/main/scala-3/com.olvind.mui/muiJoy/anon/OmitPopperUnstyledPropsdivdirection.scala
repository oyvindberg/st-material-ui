...
/* Inlined {  component :react.react.ElementType<any> | undefined,   sx :@mui/joy.@mui/joy/styles/types.SxProps | undefined} & Omit<PopperUnstyledProps<'div', {}>, 'direction'> */
trait OmitPopperUnstyledPropsdivdirection extends StObject {
...
object OmitPopperUnstyledPropsdivdirection {
  
  inline def apply(open: Boolean): OmitPopperUnstyledPropsdivdirection = {
    val __obj = js.Dynamic.literal(open = open.asInstanceOf[js.Any])
    __obj.asInstanceOf[OmitPopperUnstyledPropsdivdirection]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: OmitPopperUnstyledPropsdivdirection] (val x: Self) extends AnyVal {
