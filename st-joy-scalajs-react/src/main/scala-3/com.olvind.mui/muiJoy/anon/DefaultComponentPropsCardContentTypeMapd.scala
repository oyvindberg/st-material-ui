...
/* Inlined @mui/types.@mui/types.DefaultComponentProps<@mui/joy.@mui/joy/CardContent/CardContentProps.CardContentTypeMap<{}, 'div'>> */
...
object DefaultComponentPropsCardContentTypeMapd {
  ...
  inline def apply(): DefaultComponentPropsCardContentTypeMapd = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsCardContentTypeMapd]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DefaultComponentPropsCardContentTypeMapd] (val x: Self) extends AnyVal {
