...
/* Inlined @mui/types.@mui/types.DefaultComponentProps<@mui/system.@mui/system.BoxTypeMap<{}, 'div', @mui/joy.@mui/joy/styles/types.Theme>> */
trait DefaultComponentPropsBoxTypeMapdivTheme extends StObject {
...
object DefaultComponentPropsBoxTypeMapdivTheme {
  
  inline def apply(): DefaultComponentPropsBoxTypeMapdivTheme = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsBoxTypeMapdivTheme]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DefaultComponentPropsBoxTypeMapdivTheme] (val x: Self) extends AnyVal {
