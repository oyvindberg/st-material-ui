...
/* Inlined std.Partial<BreadcrumbsProps<BreadcrumbsTypeMap<{}, 'nav'>['defaultComponent'], {}>> */
trait PartialBreadcrumbsPropsBreadcrumbsTypeMa extends StObject {
...
object PartialBreadcrumbsPropsBreadcrumbsTypeMa {
  
  inline def apply(): PartialBreadcrumbsPropsBreadcrumbsTypeMa = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialBreadcrumbsPropsBreadcrumbsTypeMa]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialBreadcrumbsPropsBreadcrumbsTypeMa] (val x: Self) extends AnyVal {
