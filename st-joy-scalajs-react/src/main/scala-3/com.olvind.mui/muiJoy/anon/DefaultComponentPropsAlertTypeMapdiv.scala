...
/* Inlined @mui/types.@mui/types.DefaultComponentProps<@mui/joy.@mui/joy/Alert/AlertProps.AlertTypeMap<{}, 'div'>> */
trait DefaultComponentPropsAlertTypeMapdiv extends StObject {
...
object DefaultComponentPropsAlertTypeMapdiv {
  
  inline def apply(): DefaultComponentPropsAlertTypeMapdiv = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsAlertTypeMapdiv]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DefaultComponentPropsAlertTypeMapdiv] (val x: Self) extends AnyVal {
