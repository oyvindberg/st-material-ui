...
/* Inlined @mui/types.@mui/types.DefaultComponentProps<@mui/joy.@mui/joy/Menu/MenuProps.MenuTypeMap<{}, 'ul'>> */
trait DefaultComponentPropsMenuTypeMapul extends StObject {
...
object DefaultComponentPropsMenuTypeMapul {
  
  inline def apply(): DefaultComponentPropsMenuTypeMapul = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsMenuTypeMapul]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DefaultComponentPropsMenuTypeMapul] (val x: Self) extends AnyVal {
