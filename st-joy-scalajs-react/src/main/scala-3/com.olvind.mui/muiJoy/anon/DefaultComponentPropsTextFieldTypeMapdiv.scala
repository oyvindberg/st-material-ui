...
/* Inlined @mui/types.@mui/types.DefaultComponentProps<@mui/joy.@mui/joy/TextField/TextFieldProps.TextFieldTypeMap<{}, 'div'>> */
trait DefaultComponentPropsTextFieldTypeMapdiv extends StObject {
...
object DefaultComponentPropsTextFieldTypeMapdiv {
  
  inline def apply(): DefaultComponentPropsTextFieldTypeMapdiv = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsTextFieldTypeMapdiv]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DefaultComponentPropsTextFieldTypeMapdiv] (val x: Self) extends AnyVal {
