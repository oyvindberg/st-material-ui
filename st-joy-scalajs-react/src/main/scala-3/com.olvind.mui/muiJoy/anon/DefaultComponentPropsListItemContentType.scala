...
/* Inlined @mui/types.@mui/types.DefaultComponentProps<@mui/joy.@mui/joy/ListItemContent/ListItemContentProps.ListItemContentTypeMap<{}, 'div'>> */
trait DefaultComponentPropsListItemContentType extends StObject {
...
object DefaultComponentPropsListItemContentType {
  
  inline def apply(): DefaultComponentPropsListItemContentType = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsListItemContentType]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DefaultComponentPropsListItemContentType] (val x: Self) extends AnyVal {
