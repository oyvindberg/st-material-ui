...
/* Inlined @mui/types.@mui/types.DefaultComponentProps<@mui/joy.@mui/joy/FormControl/FormControlProps.FormControlTypeMap<{}, 'div'>> */
trait DefaultComponentPropsFormControlTypeMapd extends StObject {
...
object DefaultComponentPropsFormControlTypeMapd {
  
  inline def apply(): DefaultComponentPropsFormControlTypeMapd = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsFormControlTypeMapd]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DefaultComponentPropsFormControlTypeMapd] (val x: Self) extends AnyVal {
