...
/* Inlined @mui/types.@mui/types.DefaultComponentProps<@mui/joy.@mui/joy/AspectRatio/AspectRatioProps.AspectRatioTypeMap<{}, 'div'>> */
trait DefaultComponentPropsAspectRatioTypeMapd extends StObject {
...
object DefaultComponentPropsAspectRatioTypeMapd {
  
  inline def apply(): DefaultComponentPropsAspectRatioTypeMapd = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsAspectRatioTypeMapd]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DefaultComponentPropsAspectRatioTypeMapd] (val x: Self) extends AnyVal {
