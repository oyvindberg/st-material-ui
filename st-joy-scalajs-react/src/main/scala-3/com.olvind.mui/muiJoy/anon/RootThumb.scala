...
trait RootThumb extends StObject {
  ...
  var mark: js.UndefOr[
    com.olvind.mui.muiJoy.utilsTypesMod.SlotProps["span", js.Object, SliderOwnerStateAriabusy]
  ] = js.undefined
...
object RootThumb {
  ...
  inline def apply(): RootThumb = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[RootThumb]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: RootThumb] (val x: Self) extends AnyVal {
    ...
    inline def setMark(value: com.olvind.mui.muiJoy.utilsTypesMod.SlotProps["span", js.Object, SliderOwnerStateAriabusy]): Self = StObject.set(x, "mark", value.asInstanceOf[js.Any])
    
    inline def setMarkFunction1(
      value: SliderOwnerStateAriabusy => (Omit[ComponentPropsWithRef["span"], "color"]) & js.Object & SlotCommonProps & (Record[String, Any])
