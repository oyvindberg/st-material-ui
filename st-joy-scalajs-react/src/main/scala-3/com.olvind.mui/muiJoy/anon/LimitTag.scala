...
object LimitTag {
  ...
  inline def apply(): LimitTag = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[LimitTag]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: LimitTag] (val x: Self) extends AnyVal {
    
    inline def setClearIndicator(value: Any): Self = StObject.set(x, "clearIndicator", value.asInstanceOf[js.Any])
    ...
    inline def setLimitTag(value: Any): Self = StObject.set(x, "limitTag", value.asInstanceOf[js.Any])
    
    inline def setLimitTagUndefined: Self = StObject.set(x, "limitTag", js.undefined)
    
    inline def setListbox(value: Any): Self = StObject.set(x, "listbox", value.asInstanceOf[js.Any])
    ...
    inline def setNoOptions(value: Any): Self = StObject.set(x, "noOptions", value.asInstanceOf[js.Any])
    ...
    inline def setPopupIndicator(value: Any): Self = StObject.set(x, "popupIndicator", value.asInstanceOf[js.Any])
