...
/* Inlined @mui/types.@mui/types.DefaultComponentProps<@mui/joy.@mui/joy/Input/InputProps.InputTypeMap<{}, 'div'>> */
trait DefaultComponentPropsInputTypeMapdiv extends StObject {
...
object DefaultComponentPropsInputTypeMapdiv {
  
  inline def apply(): DefaultComponentPropsInputTypeMapdiv = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsInputTypeMapdiv]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DefaultComponentPropsInputTypeMapdiv] (val x: Self) extends AnyVal {
