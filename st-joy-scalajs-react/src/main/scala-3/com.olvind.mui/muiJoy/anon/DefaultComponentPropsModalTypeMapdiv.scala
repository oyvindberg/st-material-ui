...
/* Inlined @mui/types.@mui/types.DefaultComponentProps<@mui/joy.@mui/joy/Modal/ModalProps.ModalTypeMap<{}, 'div'>> */
trait DefaultComponentPropsModalTypeMapdiv extends StObject {
...
object DefaultComponentPropsModalTypeMapdiv {
  
  inline def apply(children: VdomElement, open: Boolean): DefaultComponentPropsModalTypeMapdiv = {
    val __obj = js.Dynamic.literal(children = children.rawElement.asInstanceOf[js.Any], open = open.asInstanceOf[js.Any])
    __obj.asInstanceOf[DefaultComponentPropsModalTypeMapdiv]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DefaultComponentPropsModalTypeMapdiv] (val x: Self) extends AnyVal {
