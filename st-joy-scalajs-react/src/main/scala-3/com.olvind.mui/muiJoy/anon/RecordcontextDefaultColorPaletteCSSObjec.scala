...
/* Inlined std.Record<'context' | @mui/joy.@mui/joy/styles/types/colorSystem.DefaultColorPalette, @mui/system.@mui/system.CSSObject> */
trait RecordcontextDefaultColorPaletteCSSObjec extends StObject {
...
object RecordcontextDefaultColorPaletteCSSObjec {
  ...
  inline def apply(
    ...
    success: CSSObject,
    warning: CSSObject
  ): RecordcontextDefaultColorPaletteCSSObjec = {
    ...
    __obj.asInstanceOf[RecordcontextDefaultColorPaletteCSSObjec]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: RecordcontextDefaultColorPaletteCSSObjec] (val x: Self) extends AnyVal {
