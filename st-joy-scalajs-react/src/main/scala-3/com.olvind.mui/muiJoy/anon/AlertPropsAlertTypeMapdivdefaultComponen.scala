...
/* Inlined @mui/joy.@mui/joy/Alert/AlertProps.AlertProps<@mui/joy.@mui/joy/Alert/AlertProps.AlertTypeMap<{}, 'div'>['defaultComponent'], {  component :react.react.ElementType<any> | undefined}> */
trait AlertPropsAlertTypeMapdivdefaultComponen extends StObject {
  ...
  var slotProps: js.UndefOr[EndDecorator] = js.undefined
  
  var slots: js.UndefOr[PartialAlertSlots] = js.undefined
...
object AlertPropsAlertTypeMapdivdefaultComponen {
  
  inline def apply(): AlertPropsAlertTypeMapdivdefaultComponen = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AlertPropsAlertTypeMapdivdefaultComponen]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: AlertPropsAlertTypeMapdivdefaultComponen] (val x: Self) extends AnyVal {
    ...
    inline def setSlotProps(value: EndDecorator): Self = StObject.set(x, "slotProps", value.asInstanceOf[js.Any])
    
    inline def setSlotPropsUndefined: Self = StObject.set(x, "slotProps", js.undefined)
    
    inline def setSlotUndefined: Self = StObject.set(x, "slot", js.undefined)
    
    inline def setSlots(value: PartialAlertSlots): Self = StObject.set(x, "slots", value.asInstanceOf[js.Any])
