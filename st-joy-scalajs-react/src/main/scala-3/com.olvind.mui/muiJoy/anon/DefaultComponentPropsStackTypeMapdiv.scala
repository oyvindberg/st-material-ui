...
/* Inlined @mui/types.@mui/types.DefaultComponentProps<@mui/joy.@mui/joy/Stack/StackProps.StackTypeMap<{}, 'div'>> */
trait DefaultComponentPropsStackTypeMapdiv extends StObject {
...
object DefaultComponentPropsStackTypeMapdiv {
  
  inline def apply(): DefaultComponentPropsStackTypeMapdiv = {
