...
/* Inlined std.Partial<StackProps<StackTypeMap<{}, 'div'>['defaultComponent'], {}>> */
trait PartialStackPropsStackTypeMapdivdefaultC extends StObject {
...
object PartialStackPropsStackTypeMapdivdefaultC {
  
  inline def apply(): PartialStackPropsStackTypeMapdivdefaultC = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialStackPropsStackTypeMapdivdefaultC]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialStackPropsStackTypeMapdivdefaultC] (val x: Self) extends AnyVal {
