...
/* Inlined std.Partial<SwitchProps<SwitchTypeMap<{}, 'div'>['defaultComponent'], {}>> */
trait PartialSwitchPropsSwitchTypeMapdivdefaul extends StObject {
...
object PartialSwitchPropsSwitchTypeMapdivdefaul {
  
  inline def apply(): PartialSwitchPropsSwitchTypeMapdivdefaul = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialSwitchPropsSwitchTypeMapdivdefaul]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialSwitchPropsSwitchTypeMapdivdefaul] (val x: Self) extends AnyVal {
