...
object Datatagindex {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(disabled = disabled.asInstanceOf[js.Any], key = key.asInstanceOf[js.Any], onClick = js.Any.fromFunction1((t0: ReactMouseEventFrom[HTMLButtonElement & Element]) => onClick(t0).runNow()), tabIndex = -1)
