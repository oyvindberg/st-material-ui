...
/* Inlined @mui/joy.@mui/joy/Chip/ChipProps.ChipProps<@mui/joy.@mui/joy/Chip/ChipProps.ChipTypeMap<{}, 'div'>['defaultComponent'], {  component :react.react.ElementType<any> | undefined}> */
...
object ChipPropsChipTypeMapdivdefaultComponent {
  ...
  inline def apply(): ChipPropsChipTypeMapdivdefaultComponent = {
