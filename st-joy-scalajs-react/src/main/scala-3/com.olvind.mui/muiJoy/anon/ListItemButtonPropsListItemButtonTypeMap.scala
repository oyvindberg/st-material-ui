...
/* Inlined @mui/joy.@mui/joy/ListItemButton/ListItemButtonProps.ListItemButtonProps<@mui/joy.@mui/joy/ListItemButton/ListItemButtonProps.ListItemButtonTypeMap<{}, 'div'>['defaultComponent'], {  component :react.react.ElementType<any> | undefined}> */
...
object ListItemButtonPropsListItemButtonTypeMap {
  ...
  inline def apply(): ListItemButtonPropsListItemButtonTypeMap = {
