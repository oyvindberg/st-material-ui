...
/* Inlined std.Partial<ChipProps<ChipTypeMap<{}, 'div'>['defaultComponent'], {}>> */
trait PartialChipPropsChipTypeMapdivdefaultCom extends StObject {
...
object PartialChipPropsChipTypeMapdivdefaultCom {
  
  inline def apply(): PartialChipPropsChipTypeMapdivdefaultCom = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialChipPropsChipTypeMapdivdefaultCom]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialChipPropsChipTypeMapdivdefaultCom] (val x: Self) extends AnyVal {
