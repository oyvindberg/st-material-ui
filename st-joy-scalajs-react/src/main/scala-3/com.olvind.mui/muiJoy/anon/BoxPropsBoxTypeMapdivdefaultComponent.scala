...
/* Inlined @mui/joy.@mui/joy/Box/BoxProps.BoxProps<@mui/joy.@mui/joy/Box/BoxProps.BoxTypeMap<{}, 'div'>['defaultComponent'], {}> */
trait BoxPropsBoxTypeMapdivdefaultComponent extends StObject {
...
object BoxPropsBoxTypeMapdivdefaultComponent {
  
  inline def apply(): BoxPropsBoxTypeMapdivdefaultComponent = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[BoxPropsBoxTypeMapdivdefaultComponent]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: BoxPropsBoxTypeMapdivdefaultComponent] (val x: Self) extends AnyVal {
