...
object Rail {
  ...
  inline def apply(): Rail = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Rail]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Rail] (val x: Self) extends AnyVal {
