...
/* Inlined std.Partial<AvatarProps<AvatarTypeMap<{}, 'div'>['defaultComponent'], {}>> */
trait PartialAvatarPropsAvatarTypeMapdivdefaul extends StObject {
...
object PartialAvatarPropsAvatarTypeMapdivdefaul {
  
  inline def apply(): PartialAvatarPropsAvatarTypeMapdivdefaul = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialAvatarPropsAvatarTypeMapdivdefaul]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialAvatarPropsAvatarTypeMapdivdefaul] (val x: Self) extends AnyVal {
