...
/* Inlined @mui/joy.@mui/joy/Tooltip/TooltipProps.TooltipProps<@mui/joy.@mui/joy/Tooltip/TooltipProps.TooltipTypeMap<{}, 'div'>['defaultComponent'], {  component :react.react.ElementType<any> | undefined}> */
trait TooltipPropsTooltipTypeMapdivdefaultComp extends StObject {
...
object TooltipPropsTooltipTypeMapdivdefaultComp {
  
  inline def apply(children: VdomElement): TooltipPropsTooltipTypeMapdivdefaultComp = {
    val __obj = js.Dynamic.literal(children = children.rawElement.asInstanceOf[js.Any], title = null)
    __obj.asInstanceOf[TooltipPropsTooltipTypeMapdivdefaultComp]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TooltipPropsTooltipTypeMapdivdefaultComp] (val x: Self) extends AnyVal {
