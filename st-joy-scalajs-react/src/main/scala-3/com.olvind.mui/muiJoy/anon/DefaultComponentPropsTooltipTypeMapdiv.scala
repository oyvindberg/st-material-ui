...
/* Inlined @mui/types.@mui/types.DefaultComponentProps<@mui/joy.@mui/joy/Tooltip/TooltipProps.TooltipTypeMap<{}, 'div'>> */
trait DefaultComponentPropsTooltipTypeMapdiv extends StObject {
...
object DefaultComponentPropsTooltipTypeMapdiv {
  
  inline def apply(children: VdomElement): DefaultComponentPropsTooltipTypeMapdiv = {
    val __obj = js.Dynamic.literal(children = children.rawElement.asInstanceOf[js.Any], title = null)
    __obj.asInstanceOf[DefaultComponentPropsTooltipTypeMapdiv]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DefaultComponentPropsTooltipTypeMapdiv] (val x: Self) extends AnyVal {
