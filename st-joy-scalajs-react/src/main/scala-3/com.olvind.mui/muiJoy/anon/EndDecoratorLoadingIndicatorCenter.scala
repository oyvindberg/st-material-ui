...
trait EndDecoratorLoadingIndicatorCenter extends StObject {
...
object EndDecoratorLoadingIndicatorCenter {
  
  inline def apply(): EndDecoratorLoadingIndicatorCenter = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[EndDecoratorLoadingIndicatorCenter]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: EndDecoratorLoadingIndicatorCenter] (val x: Self) extends AnyVal {
