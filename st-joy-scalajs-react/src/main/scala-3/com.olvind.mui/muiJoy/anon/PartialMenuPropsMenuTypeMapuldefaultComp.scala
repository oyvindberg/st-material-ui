...
/* Inlined std.Partial<MenuProps<MenuTypeMap<{}, 'ul'>['defaultComponent'], {}>> */
trait PartialMenuPropsMenuTypeMapuldefaultComp extends StObject {
...
object PartialMenuPropsMenuTypeMapuldefaultComp {
  
  inline def apply(): PartialMenuPropsMenuTypeMapuldefaultComp = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMenuPropsMenuTypeMapuldefaultComp]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMenuPropsMenuTypeMapuldefaultComp] (val x: Self) extends AnyVal {
