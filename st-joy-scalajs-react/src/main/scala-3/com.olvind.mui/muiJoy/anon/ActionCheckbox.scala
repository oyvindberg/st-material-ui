...
trait ActionCheckbox extends StObject {
...
object ActionCheckbox {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[ActionCheckbox]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ActionCheckbox] (val x: Self) extends AnyVal {
