...
/* Inlined @mui/types.@mui/types.DefaultComponentProps<@mui/joy.@mui/joy/Chip/ChipProps.ChipTypeMap<{}, 'div'>> */
trait DefaultComponentPropsChipTypeMapdiv extends StObject {
  ...
  var slotProps: js.UndefOr[EndDecoratorLabel] = js.undefined
  
  var slots: js.UndefOr[ActionEndDecorator] = js.undefined
...
object DefaultComponentPropsChipTypeMapdiv {
  ...
  inline def apply(): DefaultComponentPropsChipTypeMapdiv = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsChipTypeMapdiv]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DefaultComponentPropsChipTypeMapdiv] (val x: Self) extends AnyVal {
    ...
    inline def setSlotProps(value: EndDecoratorLabel): Self = StObject.set(x, "slotProps", value.asInstanceOf[js.Any])
    
    inline def setSlotPropsUndefined: Self = StObject.set(x, "slotProps", js.undefined)
    
    inline def setSlotUndefined: Self = StObject.set(x, "slot", js.undefined)
    
    inline def setSlots(value: ActionEndDecorator): Self = StObject.set(x, "slots", value.asInstanceOf[js.Any])
