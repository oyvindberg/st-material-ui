...
/* Inlined std.Partial<CardCoverProps<CardCoverTypeMap<{}, 'div'>['defaultComponent'], {}>> */
trait PartialCardCoverPropsCardCoverTypeMapdiv extends StObject {
...
object PartialCardCoverPropsCardCoverTypeMapdiv {
  
  inline def apply(): PartialCardCoverPropsCardCoverTypeMapdiv = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialCardCoverPropsCardCoverTypeMapdiv]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialCardCoverPropsCardCoverTypeMapdiv] (val x: Self) extends AnyVal {
