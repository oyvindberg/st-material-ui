...
/* Inlined @mui/types.@mui/types.DefaultComponentProps<@mui/joy.@mui/joy/ModalOverflow/ModalOverflowProps.ModalOverflowTypeMap<{}, 'div'>> */
trait DefaultComponentPropsModalOverflowTypeMa extends StObject {
...
object DefaultComponentPropsModalOverflowTypeMa {
  
  inline def apply(): DefaultComponentPropsModalOverflowTypeMa = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsModalOverflowTypeMa]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DefaultComponentPropsModalOverflowTypeMa] (val x: Self) extends AnyVal {
