...
/* Inlined std.Partial<ListSubheaderProps<ListSubheaderTypeMap<{}, 'div'>['defaultComponent'], {}>> */
trait PartialListSubheaderPropsListSubheaderTy extends StObject {
...
object PartialListSubheaderPropsListSubheaderTy {
  
  inline def apply(): PartialListSubheaderPropsListSubheaderTy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialListSubheaderPropsListSubheaderTy]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialListSubheaderPropsListSubheaderTy] (val x: Self) extends AnyVal {
