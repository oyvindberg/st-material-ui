...
/* Inlined std.Partial<ListItemButtonProps<ListItemButtonTypeMap<{}, 'div'>['defaultComponent'], {}>> */
trait PartialListItemButtonPropsListItemButton extends StObject {
...
object PartialListItemButtonPropsListItemButton {
  
  inline def apply(): PartialListItemButtonPropsListItemButton = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialListItemButtonPropsListItemButton]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialListItemButtonPropsListItemButton] (val x: Self) extends AnyVal {
