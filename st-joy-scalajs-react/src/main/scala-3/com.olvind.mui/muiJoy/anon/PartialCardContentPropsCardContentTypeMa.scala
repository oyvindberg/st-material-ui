...
/* Inlined std.Partial<CardContentProps<CardContentTypeMap<{}, 'div'>['defaultComponent'], {}>> */
trait PartialCardContentPropsCardContentTypeMa extends StObject {
...
object PartialCardContentPropsCardContentTypeMa {
  
  inline def apply(): PartialCardContentPropsCardContentTypeMa = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialCardContentPropsCardContentTypeMa]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialCardContentPropsCardContentTypeMa] (val x: Self) extends AnyVal {
