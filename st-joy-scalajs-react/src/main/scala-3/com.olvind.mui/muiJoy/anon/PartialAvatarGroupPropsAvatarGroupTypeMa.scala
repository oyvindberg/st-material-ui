...
/* Inlined std.Partial<AvatarGroupProps<AvatarGroupTypeMap<{}, 'div'>['defaultComponent'], {}>> */
trait PartialAvatarGroupPropsAvatarGroupTypeMa extends StObject {
...
object PartialAvatarGroupPropsAvatarGroupTypeMa {
  
  inline def apply(): PartialAvatarGroupPropsAvatarGroupTypeMa = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialAvatarGroupPropsAvatarGroupTypeMa]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialAvatarGroupPropsAvatarGroupTypeMa] (val x: Self) extends AnyVal {
