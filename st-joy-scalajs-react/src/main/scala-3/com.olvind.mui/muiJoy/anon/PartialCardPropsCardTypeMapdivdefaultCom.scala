...
/* Inlined std.Partial<CardProps<CardTypeMap<{}, 'div'>['defaultComponent'], {}>> */
trait PartialCardPropsCardTypeMapdivdefaultCom extends StObject {
...
object PartialCardPropsCardTypeMapdivdefaultCom {
  
  inline def apply(): PartialCardPropsCardTypeMapdivdefaultCom = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialCardPropsCardTypeMapdivdefaultCom]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialCardPropsCardTypeMapdivdefaultCom] (val x: Self) extends AnyVal {
