...
trait RailRoot extends StObject {
  
  var input: js.UndefOr[
    com.olvind.mui.muiJoy.utilsTypesMod.SlotProps["span", js.Object, SliderOwnerStateAriaautocomplete]
  ] = js.undefined
...
object RailRoot {
  ...
  inline def apply(): RailRoot = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[RailRoot]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: RailRoot] (val x: Self) extends AnyVal {
    
    inline def setInput(
      value: com.olvind.mui.muiJoy.utilsTypesMod.SlotProps["span", js.Object, SliderOwnerStateAriaautocomplete]
    ): Self = StObject.set(x, "input", value.asInstanceOf[js.Any])
    
    inline def setInputFunction1(
      value: SliderOwnerStateAriaautocomplete => (Omit[ComponentPropsWithRef["span"], "color"]) & js.Object & SlotCommonProps & (Record[String, Any])
