...
trait ButtonEndDecorator extends StObject {
...
object ButtonEndDecorator {
  
  inline def apply(): ButtonEndDecorator = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ButtonEndDecorator]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ButtonEndDecorator] (val x: Self) extends AnyVal {
