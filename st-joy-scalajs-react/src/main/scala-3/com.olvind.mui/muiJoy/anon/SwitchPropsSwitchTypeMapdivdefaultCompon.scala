...
object SwitchPropsSwitchTypeMapdivdefaultCompon {
  ...
  implicit open class MutableBuilder[Self <: SwitchPropsSwitchTypeMapdivdefaultCompon] (val x: Self) extends AnyVal {
    ...
    inline def setEndDecorator(value: Node | (js.Function1[SwitchPropsSwitchTypeMapdivdefaultCompon, Node])): Self = StObject.set(x, "endDecorator", value.asInstanceOf[js.Any])
    
    inline def setEndDecoratorFunction1(value: SwitchPropsSwitchTypeMapdivdefaultCompon => Node): Self = StObject.set(x, "endDecorator", js.Any.fromFunction1(value))
    ...
    inline def setStartDecorator(value: Node | (js.Function1[SwitchPropsSwitchTypeMapdivdefaultCompon, Node])): Self = StObject.set(x, "startDecorator", value.asInstanceOf[js.Any])
    
    inline def setStartDecoratorFunction1(value: SwitchPropsSwitchTypeMapdivdefaultCompon => Node): Self = StObject.set(x, "startDecorator", js.Any.fromFunction1(value))
