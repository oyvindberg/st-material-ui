...
trait ArrowSlotProps extends StObject {
...
object ArrowSlotProps {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[ArrowSlotProps]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ArrowSlotProps] (val x: Self) extends AnyVal {
