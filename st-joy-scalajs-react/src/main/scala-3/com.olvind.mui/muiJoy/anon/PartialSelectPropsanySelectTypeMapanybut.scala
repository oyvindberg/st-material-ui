...
/* Inlined std.Partial<SelectProps<any, SelectTypeMap<any, {}, 'button'>['defaultComponent']>> */
trait PartialSelectPropsanySelectTypeMapanybut extends StObject {
  ...
  var renderValue: js.UndefOr[js.Function1[/* option */ SelectOption[Any] | Null, Node]] = js.undefined
...
object PartialSelectPropsanySelectTypeMapanybut {
  
  inline def apply(): PartialSelectPropsanySelectTypeMapanybut = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialSelectPropsanySelectTypeMapanybut]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialSelectPropsanySelectTypeMapanybut] (val x: Self) extends AnyVal {
    ...
    inline def setGetSerializedValue(value: /* option */ SelectOption[Any] | Null => js.UndefOr[String | js.Array[String] | Double]): Self = StObject.set(x, "getSerializedValue", js.Any.fromFunction1(value))
    ...
    inline def setOnChange(
      value: (/* e */ ReactMouseEventFrom[Element] | ReactKeyboardEventFrom[Element] | ReactFocusEventFrom[Element] | Null, /* value */ Any | Null) => Callback
    ): Self = StObject.set(x, "onChange", js.Any.fromFunction2((t0: /* e */ ReactMouseEventFrom[Element] | ReactKeyboardEventFrom[Element] | ReactFocusEventFrom[Element] | Null, t1: /* value */ Any | Null) => (value(t0, t1)).runNow()))
    ...
    inline def setRenderValue(value: /* option */ SelectOption[Any] | Null => Node): Self = StObject.set(x, "renderValue", js.Any.fromFunction1(value))
