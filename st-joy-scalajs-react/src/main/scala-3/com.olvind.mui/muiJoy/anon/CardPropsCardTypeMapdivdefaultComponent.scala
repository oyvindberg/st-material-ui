...
/* Inlined @mui/joy.@mui/joy/Card/CardProps.CardProps<@mui/joy.@mui/joy/Card/CardProps.CardTypeMap<{}, 'div'>['defaultComponent'], {  component :react.react.ElementType<any> | undefined}> */
...
object CardPropsCardTypeMapdivdefaultComponent {
  ...
  inline def apply(): CardPropsCardTypeMapdivdefaultComponent = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CardPropsCardTypeMapdivdefaultComponent]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CardPropsCardTypeMapdivdefaultComponent] (val x: Self) extends AnyVal {
