...
/* Inlined @mui/types.@mui/types.DefaultComponentProps<@mui/joy.@mui/joy/Breadcrumbs/BreadcrumbsProps.BreadcrumbsTypeMap<{}, 'nav'>> */
...
object DefaultComponentPropsBreadcrumbsTypeMapn {
  ...
  inline def apply(): DefaultComponentPropsBreadcrumbsTypeMapn = {
