...
/* Inlined @mui/joy.@mui/joy/MenuItem/MenuItemProps.MenuItemTypeMap<{}, 'div'>['props'] */
trait MenuItemTypeMapdivprops extends StObject {
...
object MenuItemTypeMapdivprops {
  
  inline def apply(): MenuItemTypeMapdivprops = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[MenuItemTypeMapdivprops]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: MenuItemTypeMapdivprops] (val x: Self) extends AnyVal {
