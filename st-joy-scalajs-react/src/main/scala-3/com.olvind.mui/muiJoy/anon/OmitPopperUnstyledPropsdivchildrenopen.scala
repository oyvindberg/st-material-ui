...
/* Inlined std.Omit<PopperUnstyledProps<'div', {}>, 'children' | 'open'> */
trait OmitPopperUnstyledPropsdivchildrenopen extends StObject {
...
object OmitPopperUnstyledPropsdivchildrenopen {
  
  inline def apply(): OmitPopperUnstyledPropsdivchildrenopen = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[OmitPopperUnstyledPropsdivchildrenopen]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: OmitPopperUnstyledPropsdivchildrenopen] (val x: Self) extends AnyVal {
