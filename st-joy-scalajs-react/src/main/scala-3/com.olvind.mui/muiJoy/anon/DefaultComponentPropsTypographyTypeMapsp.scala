...
/* Inlined @mui/types.@mui/types.DefaultComponentProps<@mui/joy.@mui/joy/Typography/TypographyProps.TypographyTypeMap<{}, 'span'>> */
trait DefaultComponentPropsTypographyTypeMapsp extends StObject {
...
object DefaultComponentPropsTypographyTypeMapsp {
  
  inline def apply(): DefaultComponentPropsTypographyTypeMapsp = {
