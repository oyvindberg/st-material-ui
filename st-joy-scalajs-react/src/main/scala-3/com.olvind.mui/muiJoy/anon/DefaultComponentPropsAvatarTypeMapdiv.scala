...
/* Inlined @mui/types.@mui/types.DefaultComponentProps<@mui/joy.@mui/joy/Avatar/AvatarProps.AvatarTypeMap<{}, 'div'>> */
...
object DefaultComponentPropsAvatarTypeMapdiv {
  ...
  inline def apply(): DefaultComponentPropsAvatarTypeMapdiv = {
