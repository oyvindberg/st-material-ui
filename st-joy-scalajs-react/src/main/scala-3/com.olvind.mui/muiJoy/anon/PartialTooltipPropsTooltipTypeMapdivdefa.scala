...
/* Inlined std.Partial<TooltipProps<TooltipTypeMap<{}, 'div'>['defaultComponent'], {}>> */
trait PartialTooltipPropsTooltipTypeMapdivdefa extends StObject {
...
object PartialTooltipPropsTooltipTypeMapdivdefa {
  
  inline def apply(): PartialTooltipPropsTooltipTypeMapdivdefa = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialTooltipPropsTooltipTypeMapdivdefa]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialTooltipPropsTooltipTypeMapdivdefa] (val x: Self) extends AnyVal {
