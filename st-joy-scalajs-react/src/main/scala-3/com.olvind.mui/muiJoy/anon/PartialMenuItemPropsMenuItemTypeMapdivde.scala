...
/* Inlined std.Partial<MenuItemProps<MenuItemTypeMap<{}, 'div'>['defaultComponent'], {}>> */
trait PartialMenuItemPropsMenuItemTypeMapdivde extends StObject {
...
object PartialMenuItemPropsMenuItemTypeMapdivde {
  
  inline def apply(): PartialMenuItemPropsMenuItemTypeMapdivde = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMenuItemPropsMenuItemTypeMapdivde]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMenuItemPropsMenuItemTypeMapdivde] (val x: Self) extends AnyVal {
