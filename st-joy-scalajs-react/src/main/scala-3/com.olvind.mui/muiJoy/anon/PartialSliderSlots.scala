...
/* Inlined std.Partial<@mui/joy.@mui/joy/Slider/SliderProps.SliderSlots> */
trait PartialSliderSlots extends StObject {
...
object PartialSliderSlots {
  
  inline def apply(): PartialSliderSlots = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialSliderSlots]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialSliderSlots] (val x: Self) extends AnyVal {
