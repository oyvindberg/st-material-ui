...
trait ActionEndDecoratorInput extends StObject {
...
object ActionEndDecoratorInput {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[ActionEndDecoratorInput]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ActionEndDecoratorInput] (val x: Self) extends AnyVal {
