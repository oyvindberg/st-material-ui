...
/* Inlined std.Partial<LinearProgressProps<LinearProgressTypeMap<{}, 'div'>['defaultComponent'], {}>> */
trait PartialLinearProgressPropsLinearProgress extends StObject {
...
object PartialLinearProgressPropsLinearProgress {
  
  inline def apply(): PartialLinearProgressPropsLinearProgress = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialLinearProgressPropsLinearProgress]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialLinearProgressPropsLinearProgress] (val x: Self) extends AnyVal {
