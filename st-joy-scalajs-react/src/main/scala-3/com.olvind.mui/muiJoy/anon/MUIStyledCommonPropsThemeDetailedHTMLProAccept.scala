...
object MUIStyledCommonPropsThemeDetailedHTMLProAccept {
  ...
  implicit open class MutableBuilder[Self <: MUIStyledCommonPropsThemeDetailedHTMLProAccept] (val x: Self) extends AnyVal {
    ...
    inline def setOnResize(value: ReactEventFrom[HTMLInputElement & org.scalajs.dom.Element] => Callback): Self = StObject.set(x, "onResize", js.Any.fromFunction1((t0: ReactEventFrom[HTMLInputElement & org.scalajs.dom.Element]) => value(t0).runNow()))
