...
/* Inlined @mui/types.@mui/types.DefaultComponentProps<@mui/joy.@mui/joy/Sheet/SheetProps.SheetTypeMap<{}, 'div'>> */
trait DefaultComponentPropsSheetTypeMapdiv extends StObject {
...
object DefaultComponentPropsSheetTypeMapdiv {
  
  inline def apply(): DefaultComponentPropsSheetTypeMapdiv = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsSheetTypeMapdiv]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DefaultComponentPropsSheetTypeMapdiv] (val x: Self) extends AnyVal {
