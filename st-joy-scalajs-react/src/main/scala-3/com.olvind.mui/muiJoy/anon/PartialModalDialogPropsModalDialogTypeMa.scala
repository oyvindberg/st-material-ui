...
/* Inlined std.Partial<ModalDialogProps<ModalDialogTypeMap<{}, 'div'>['defaultComponent'], {}>> */
trait PartialModalDialogPropsModalDialogTypeMa extends StObject {
...
object PartialModalDialogPropsModalDialogTypeMa {
  
  inline def apply(): PartialModalDialogPropsModalDialogTypeMa = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialModalDialogPropsModalDialogTypeMa]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialModalDialogPropsModalDialogTypeMa] (val x: Self) extends AnyVal {
