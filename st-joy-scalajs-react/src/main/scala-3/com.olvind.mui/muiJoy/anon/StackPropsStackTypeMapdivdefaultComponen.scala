...
/* Inlined @mui/joy.@mui/joy/Stack/StackProps.StackProps<@mui/joy.@mui/joy/Stack/StackProps.StackTypeMap<{}, 'div'>['defaultComponent'], {}> */
trait StackPropsStackTypeMapdivdefaultComponen extends StObject {
  ...
  var direction: js.UndefOr[
    com.olvind.mui.muiSystem.mod.ResponsiveStyleValue["row" | "row-reverse" | "column" | "column-reverse"]
  ] = js.undefined
  ...
  /**
    ...
    */
  var divider: js.UndefOr[Node] = js.undefined
  ...
  /**
    ...
    * @default 0
    */
  var spacing: js.UndefOr[com.olvind.mui.muiSystem.mod.ResponsiveStyleValue[Double | String]] = js.undefined
...
object StackPropsStackTypeMapdivdefaultComponen {
  
  inline def apply(): StackPropsStackTypeMapdivdefaultComponen = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[StackPropsStackTypeMapdivdefaultComponen]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: StackPropsStackTypeMapdivdefaultComponen] (val x: Self) extends AnyVal {
    ...
    inline def setDirection(
      value: com.olvind.mui.muiSystem.mod.ResponsiveStyleValue["row" | "row-reverse" | "column" | "column-reverse"]
    ...
    inline def setSpacing(value: com.olvind.mui.muiSystem.mod.ResponsiveStyleValue[Double | String]): Self = StObject.set(x, "spacing", value.asInstanceOf[js.Any])
