...
/* Inlined std.Partial<CardOverflowProps<CardOverflowTypeMap<{}, 'div'>['defaultComponent'], {}>> */
trait PartialCardOverflowPropsCardOverflowType extends StObject {
...
object PartialCardOverflowPropsCardOverflowType {
  
  inline def apply(): PartialCardOverflowPropsCardOverflowType = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialCardOverflowPropsCardOverflowType]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialCardOverflowPropsCardOverflowType] (val x: Self) extends AnyVal {
