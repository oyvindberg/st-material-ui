...
/* Inlined @mui/joy.@mui/joy/Typography/TypographyProps.TypographyProps<@mui/joy.@mui/joy/Typography/TypographyProps.TypographyTypeMap<{}, 'span'>['defaultComponent'], {  component :react.react.ElementType<any> | undefined}> */
trait TypographyPropsTypographyTypeMapspandefa extends StObject {
...
object TypographyPropsTypographyTypeMapspandefa {
  
  inline def apply(): TypographyPropsTypographyTypeMapspandefa = {
