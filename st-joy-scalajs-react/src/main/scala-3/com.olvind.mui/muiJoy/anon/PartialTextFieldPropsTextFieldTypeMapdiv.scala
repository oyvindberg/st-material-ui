...
/* Inlined std.Partial<TextFieldProps<TextFieldTypeMap<{}, 'div'>['defaultComponent'], {}>> */
trait PartialTextFieldPropsTextFieldTypeMapdiv extends StObject {
...
object PartialTextFieldPropsTextFieldTypeMapdiv {
  
  inline def apply(): PartialTextFieldPropsTextFieldTypeMapdiv = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialTextFieldPropsTextFieldTypeMapdiv]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialTextFieldPropsTextFieldTypeMapdiv] (val x: Self) extends AnyVal {
