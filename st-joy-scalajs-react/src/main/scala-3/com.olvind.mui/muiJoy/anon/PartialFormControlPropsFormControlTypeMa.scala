...
/* Inlined std.Partial<FormControlProps<FormControlTypeMap<{}, 'div'>['defaultComponent'], {}>> */
trait PartialFormControlPropsFormControlTypeMa extends StObject {
...
object PartialFormControlPropsFormControlTypeMa {
  
  inline def apply(): PartialFormControlPropsFormControlTypeMa = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialFormControlPropsFormControlTypeMa]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialFormControlPropsFormControlTypeMa] (val x: Self) extends AnyVal {
