...
/* Inlined @mui/joy.@mui/joy/Grid/GridProps.GridProps<@mui/joy.@mui/joy/Grid/GridProps.GridTypeMap<{}, 'div'>['defaultComponent'], {  component :react.react.ElementType<any> | undefined}> */
trait GridPropsGridTypeMapdivdefaultComponent extends StObject {
...
object GridPropsGridTypeMapdivdefaultComponent {
  
  inline def apply(): GridPropsGridTypeMapdivdefaultComponent = {
