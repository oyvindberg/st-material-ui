...
/* Inlined @mui/types.@mui/types.DefaultComponentProps<@mui/joy.@mui/joy/LinearProgress/LinearProgressProps.LinearProgressTypeMap<{}, 'div'>> */
trait DefaultComponentPropsLinearProgressTypeM extends StObject {
...
object DefaultComponentPropsLinearProgressTypeM {
  
  inline def apply(): DefaultComponentPropsLinearProgressTypeM = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsLinearProgressTypeM]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DefaultComponentPropsLinearProgressTypeM] (val x: Self) extends AnyVal {
