...
/* Inlined std.Partial<ScopedCssBaselineProps<ScopedCssBaselineTypeMap<{}, 'div'>['defaultComponent'], {}>> */
trait PartialScopedCssBaselinePropsScopedCssBa extends StObject {
...
object PartialScopedCssBaselinePropsScopedCssBa {
  
  inline def apply(): PartialScopedCssBaselinePropsScopedCssBa = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialScopedCssBaselinePropsScopedCssBa]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialScopedCssBaselinePropsScopedCssBa] (val x: Self) extends AnyVal {
