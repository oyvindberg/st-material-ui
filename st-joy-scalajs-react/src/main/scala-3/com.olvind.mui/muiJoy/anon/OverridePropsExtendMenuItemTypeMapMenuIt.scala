...
/* Inlined @mui/types.@mui/types.OverrideProps<@mui/joy.@mui/joy/MenuItem/MenuItemProps.ExtendMenuItemTypeMap<@mui/joy.@mui/joy/MenuItem/MenuItemProps.MenuItemTypeMap<{}, 'div'>>, 'a'> */
trait OverridePropsExtendMenuItemTypeMapMenuIt extends StObject {
...
object OverridePropsExtendMenuItemTypeMapMenuIt {
  
  inline def apply(): OverridePropsExtendMenuItemTypeMapMenuIt = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[OverridePropsExtendMenuItemTypeMapMenuIt]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: OverridePropsExtendMenuItemTypeMapMenuIt] (val x: Self) extends AnyVal {
