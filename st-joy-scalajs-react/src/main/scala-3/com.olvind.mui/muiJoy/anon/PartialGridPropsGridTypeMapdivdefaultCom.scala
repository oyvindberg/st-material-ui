...
/* Inlined std.Partial<GridProps<GridTypeMap<{}, 'div'>['defaultComponent'], {}>> */
trait PartialGridPropsGridTypeMapdivdefaultCom extends StObject {
...
object PartialGridPropsGridTypeMapdivdefaultCom {
  
  inline def apply(): PartialGridPropsGridTypeMapdivdefaultCom = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialGridPropsGridTypeMapdivdefaultCom]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialGridPropsGridTypeMapdivdefaultCom] (val x: Self) extends AnyVal {
