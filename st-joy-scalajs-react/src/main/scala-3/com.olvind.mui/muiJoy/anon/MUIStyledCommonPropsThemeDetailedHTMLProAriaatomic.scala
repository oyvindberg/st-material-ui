...
object MUIStyledCommonPropsThemeDetailedHTMLProAriaatomic {
  ...
  implicit open class MutableBuilder[Self <: MUIStyledCommonPropsThemeDetailedHTMLProAriaatomic] (val x: Self) extends AnyVal {
    ...
    inline def setOnResize(value: ReactEventFrom[HTMLUListElement & org.scalajs.dom.Element] => Callback): Self = StObject.set(x, "onResize", js.Any.fromFunction1((t0: ReactEventFrom[HTMLUListElement & org.scalajs.dom.Element]) => value(t0).runNow()))
