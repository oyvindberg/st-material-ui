...
/* Inlined std.Partial<InputProps<InputTypeMap<{}, 'div'>['defaultComponent'], {}>> */
trait PartialInputPropsInputTypeMapdivdefaultC extends StObject {
...
object PartialInputPropsInputTypeMapdivdefaultC {
  
  inline def apply(): PartialInputPropsInputTypeMapdivdefaultC = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialInputPropsInputTypeMapdivdefaultC]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialInputPropsInputTypeMapdivdefaultC] (val x: Self) extends AnyVal {
