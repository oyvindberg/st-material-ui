...
/* Inlined std.Partial<@mui/joy.@mui/joy/Autocomplete/AutocompleteProps.AutocompleteSlots> */
trait PartialAutocompleteSlots extends StObject {
  
  var clearIndicator: js.UndefOr[ElementType] = js.undefined
  
  var endDecorator: js.UndefOr[ElementType] = js.undefined
  
  var input: js.UndefOr[ElementType] = js.undefined
  
  var limitTag: js.UndefOr[ElementType] = js.undefined
  
  var listbox: js.UndefOr[ElementType] = js.undefined
  
  var loading: js.UndefOr[ElementType] = js.undefined
  
  var noOptions: js.UndefOr[ElementType] = js.undefined
  
  var option: js.UndefOr[ElementType] = js.undefined
  
  var popupIndicator: js.UndefOr[ElementType] = js.undefined
  
  var root: js.UndefOr[ElementType] = js.undefined
  
  var startDecorator: js.UndefOr[ElementType] = js.undefined
  
  var wrapper: js.UndefOr[ElementType] = js.undefined
}
object PartialAutocompleteSlots {
  
  inline def apply(): PartialAutocompleteSlots = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialAutocompleteSlots]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialAutocompleteSlots] (val x: Self) extends AnyVal {
