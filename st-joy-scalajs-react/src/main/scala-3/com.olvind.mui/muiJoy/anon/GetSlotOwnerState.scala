...
trait GetSlotOwnerState[ElementType /* <: japgolly.scalajs.react.facade.React.ElementType */, OwnerState /* <: js.Object */, ExternalForwardedProps /* <: /* import warning: importer.ImportType#apply Failed type conversion: {  component :react.react.ElementType<any> | undefined,   slots :{[ k in T ]:? react.react.ElementType<any>} | undefined,   slotProps :{[ k in T ]:? @mui/joy.@mui/joy/utils/useSlot.WithCommonProps<ExternalSlotProps> | (ownerState : OwnerState): @mui/joy.@mui/joy/utils/useSlot.WithCommonProps<ExternalSlotProps>} | undefined} */ js.Any */, SlotProps, AdditionalProps, ExternalSlotProps /* <: /* import warning: importer.ImportType#apply Failed type conversion: {  component :react.react.ElementType<any> | undefined} */ js.Any */, T /* <: String */, SlotOwnerState /* <: js.Object */] extends StObject {
...
object GetSlotOwnerState {
  ...
  inline def apply[ElementType /* <: japgolly.scalajs.react.facade.React.ElementType */, OwnerState /* <: js.Object */, ExternalForwardedProps /* <: /* import warning: importer.ImportType#apply Failed type conversion: {  component :react.react.ElementType<any> | undefined,   slots :{[ k in T ]:? react.react.ElementType<any>} | undefined,   slotProps :{[ k in T ]:? @mui/joy.@mui/joy/utils/useSlot.WithCommonProps<ExternalSlotProps> | (ownerState : OwnerState): @mui/joy.@mui/joy/utils/useSlot.WithCommonProps<ExternalSlotProps>} | undefined} */ js.Any */, SlotProps, AdditionalProps, ExternalSlotProps /* <: /* import warning: importer.ImportType#apply Failed type conversion: {  component :react.react.ElementType<any> | undefined} */ js.Any */, T /* <: String */, SlotOwnerState /* <: js.Object */](elementType: ElementType, externalForwardedProps: ExternalForwardedProps, ownerState: OwnerState): GetSlotOwnerState[
    ElementType, 
    OwnerState, 
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GetSlotOwnerState[?, ?, ?, ?, ?, ?, ?, ?], ElementType /* <: japgolly.scalajs.react.facade.React.ElementType */, OwnerState /* <: js.Object */, ExternalForwardedProps /* <: /* import warning: importer.ImportType#apply Failed type conversion: {  component :react.react.ElementType<any> | undefined,   slots :{[ k in T ]:? react.react.ElementType<any>} | undefined,   slotProps :{[ k in T ]:? @mui/joy.@mui/joy/utils/useSlot.WithCommonProps<ExternalSlotProps> | (ownerState : OwnerState): @mui/joy.@mui/joy/utils/useSlot.WithCommonProps<ExternalSlotProps>} | undefined} */ js.Any */, SlotProps, AdditionalProps, ExternalSlotProps /* <: /* import warning: importer.ImportType#apply Failed type conversion: {  component :react.react.ElementType<any> | undefined} */ js.Any */, T /* <: String */, SlotOwnerState /* <: js.Object */] (val x: Self & (GetSlotOwnerState[
        ElementType, 
        OwnerState, 
        ExternalForwardedProps, 
        SlotProps, 
