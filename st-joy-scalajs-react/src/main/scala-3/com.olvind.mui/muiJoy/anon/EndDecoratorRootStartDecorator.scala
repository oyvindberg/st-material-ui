...
trait EndDecoratorRootStartDecorator extends StObject {
...
object EndDecoratorRootStartDecorator {
  
  inline def apply(): EndDecoratorRootStartDecorator = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[EndDecoratorRootStartDecorator]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: EndDecoratorRootStartDecorator] (val x: Self) extends AnyVal {
