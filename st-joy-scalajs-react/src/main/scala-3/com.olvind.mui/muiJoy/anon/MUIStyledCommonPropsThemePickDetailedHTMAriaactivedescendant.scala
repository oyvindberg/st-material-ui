...
/* Inlined MUIStyledCommonProps<Theme> & {} & Pick<DetailedHTMLProps<HTMLAttributes<HTMLDivElement>, HTMLDivElement>, keyof ClassAttributes<HTMLDivElement> | keyof HTMLAttributes<HTMLDivElement>> & {} */
trait MUIStyledCommonPropsThemePickDetailedHTMAriaactivedescendant extends StObject {
  ...
  var ownerState: ModalOverflowOwnerState
...
object MUIStyledCommonPropsThemePickDetailedHTMAriaactivedescendant {
  
  inline def apply(ownerState: ModalOverflowOwnerState): MUIStyledCommonPropsThemePickDetailedHTMAriaactivedescendant = {
    val __obj = js.Dynamic.literal(ownerState = ownerState.asInstanceOf[js.Any])
    __obj.asInstanceOf[MUIStyledCommonPropsThemePickDetailedHTMAriaactivedescendant]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: MUIStyledCommonPropsThemePickDetailedHTMAriaactivedescendant] (val x: Self) extends AnyVal {
    ...
    inline def setOwnerState(value: ModalOverflowOwnerState): Self = StObject.set(x, "ownerState", value.asInstanceOf[js.Any])
