...
/* Inlined @mui/types.@mui/types.DefaultComponentProps<@mui/joy.@mui/joy/Switch/SwitchProps.SwitchTypeMap<{}, 'div'>> */
trait DefaultComponentPropsSwitchTypeMapdiv extends StObject {
  ...
  /**
    ...
    */
  var endDecorator: js.UndefOr[Node | (js.Function1[/* ownerState */ SwitchOwnerState, Node])] = js.undefined
  ...
  /**
    * The element that appears at the end of the switch.
    */
  var startDecorator: js.UndefOr[Node | (js.Function1[/* ownerState */ SwitchOwnerState, Node])] = js.undefined
...
object DefaultComponentPropsSwitchTypeMapdiv {
  
  inline def apply(): DefaultComponentPropsSwitchTypeMapdiv = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsSwitchTypeMapdiv]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DefaultComponentPropsSwitchTypeMapdiv] (val x: Self) extends AnyVal {
    ...
    inline def setEndDecorator(value: Node | (js.Function1[/* ownerState */ SwitchOwnerState, Node])): Self = StObject.set(x, "endDecorator", value.asInstanceOf[js.Any])
    
    inline def setEndDecoratorFunction1(value: /* ownerState */ SwitchOwnerState => Node): Self = StObject.set(x, "endDecorator", js.Any.fromFunction1(value))
    ...
    inline def setStartDecorator(value: Node | (js.Function1[/* ownerState */ SwitchOwnerState, Node])): Self = StObject.set(x, "startDecorator", value.asInstanceOf[js.Any])
    
    inline def setStartDecoratorFunction1(value: /* ownerState */ SwitchOwnerState => Node): Self = StObject.set(x, "startDecorator", js.Any.fromFunction1(value))
