...
/* Inlined @mui/types.@mui/types.DefaultComponentProps<@mui/joy.@mui/joy/CardOverflow/CardOverflowProps.CardOverflowTypeMap<{}, 'div'>> */
trait DefaultComponentPropsCardOverflowTypeMap extends StObject {
...
object DefaultComponentPropsCardOverflowTypeMap {
  
  inline def apply(): DefaultComponentPropsCardOverflowTypeMap = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsCardOverflowTypeMap]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DefaultComponentPropsCardOverflowTypeMap] (val x: Self) extends AnyVal {
