...
trait ContentSlotProps extends StObject {
...
object ContentSlotProps {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[ContentSlotProps]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ContentSlotProps] (val x: Self) extends AnyVal {
