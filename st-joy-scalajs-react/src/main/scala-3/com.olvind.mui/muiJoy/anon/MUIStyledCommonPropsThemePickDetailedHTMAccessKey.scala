...
trait MUIStyledCommonPropsThemePickDetailedHTMAccessKey extends StObject {
...
object MUIStyledCommonPropsThemePickDetailedHTMAccessKey {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: MUIStyledCommonPropsThemePickDetailedHTMAccessKey] (val x: Self) extends AnyVal {
