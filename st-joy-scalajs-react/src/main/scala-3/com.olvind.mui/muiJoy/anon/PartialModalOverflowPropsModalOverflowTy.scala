...
/* Inlined std.Partial<ModalOverflowProps<ModalOverflowTypeMap<{}, 'div'>['defaultComponent'], {}>> */
trait PartialModalOverflowPropsModalOverflowTy extends StObject {
...
object PartialModalOverflowPropsModalOverflowTy {
  
  inline def apply(): PartialModalOverflowPropsModalOverflowTy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialModalOverflowPropsModalOverflowTy]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialModalOverflowPropsModalOverflowTy] (val x: Self) extends AnyVal {
