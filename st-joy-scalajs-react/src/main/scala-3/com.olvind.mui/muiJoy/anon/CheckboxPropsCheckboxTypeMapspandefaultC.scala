...
object CheckboxPropsCheckboxTypeMapspandefaultC {
  ...
  implicit open class MutableBuilder[Self <: CheckboxPropsCheckboxTypeMapspandefaultC] (val x: Self) extends AnyVal {
    ...
    inline def setUncheckedIconVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): Self = StObject.set(x, "uncheckedIcon", js.Array(value*))
