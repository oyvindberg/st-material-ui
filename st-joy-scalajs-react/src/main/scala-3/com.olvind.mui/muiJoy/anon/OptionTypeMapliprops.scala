...
/* Inlined @mui/joy.@mui/joy/Option/OptionProps.OptionTypeMap<{}, 'li'>['props'] */
trait OptionTypeMapliprops extends StObject {
...
object OptionTypeMapliprops {
  
  inline def apply(): OptionTypeMapliprops = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[OptionTypeMapliprops]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: OptionTypeMapliprops] (val x: Self) extends AnyVal {
