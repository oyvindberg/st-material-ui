...
import com.olvind.mui.muiJoy.autocompleteAutocompletePropsMod.AutocompleteRenderGetTagProps
import com.olvind.mui.muiJoy.autocompleteAutocompletePropsMod.AutocompleteRenderGroupParams
import com.olvind.mui.muiJoy.autocompleteAutocompletePropsMod.AutocompleteRenderOptionState
...
/* Inlined std.Partial<@mui/joy.@mui/joy/Autocomplete/AutocompleteProps.AutocompleteProps<any, any, any, any>> */
trait PartialAutocompletePropsanyanyanyany extends StObject {
...
object PartialAutocompletePropsanyanyanyany {
  
  inline def apply(): PartialAutocompletePropsanyanyanyany = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialAutocompletePropsanyanyanyany]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialAutocompletePropsanyanyanyany] (val x: Self) extends AnyVal {
    ...
    inline def setRenderOption(
      value: (/* props */ OmitHTMLAttributesHTMLLIElementcolor, /* option */ Any, /* state */ AutocompleteRenderOptionState) => Node
    ...
    inline def setRenderTags(
      value: (/* value */ js.Array[Any], /* getTagProps */ AutocompleteRenderGetTagProps, /* ownerState */ AutocompleteOwnerState[Any, Any, Any, Any]) => Node
