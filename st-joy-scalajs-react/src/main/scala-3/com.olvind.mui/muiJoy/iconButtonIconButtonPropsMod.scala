...
object iconButtonIconButtonPropsMod {
  ...
  trait IconButtonTypeMap[P, D /* <: ElementType */] extends StObject {
  ...
  object IconButtonTypeMap {
    ...
    inline def apply[P, D /* <: ElementType */](defaultComponent: D, props: P & FocusVisibleClassName): IconButtonTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[IconButtonTypeMap[P, D]]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: IconButtonTypeMap[?, ?], P, D /* <: ElementType */] (val x: Self & (IconButtonTypeMap[P, D])) extends AnyVal {
