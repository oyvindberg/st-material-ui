...
object radioGroupRadioGroupPropsMod {
  ...
  type RadioGroupProps[D /* <: ElementType */, P] = OverrideProps[RadioGroupTypeMap[P, D], D]
  
  type RadioGroupSlot = "root"
  
  trait RadioGroupTypeMap[P, D /* <: ElementType */] extends StObject {
  ...
  object RadioGroupTypeMap {
    ...
    inline def apply[P, D /* <: ElementType */](defaultComponent: D, props: P & DefaultValue): RadioGroupTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[RadioGroupTypeMap[P, D]]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: RadioGroupTypeMap[?, ?], P, D /* <: ElementType */] (val x: Self & (RadioGroupTypeMap[P, D])) extends AnyVal {
