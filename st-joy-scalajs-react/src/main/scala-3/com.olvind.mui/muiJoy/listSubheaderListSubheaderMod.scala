...
object listSubheaderListSubheaderMod extends Shortcut {
  ...
  type _To = js.Function1[/* props */ DefaultComponentPropsListSubheaderTypeMa, Element | Null]
  
  /* This means you don't have to write `default`, but can instead just say `listSubheaderListSubheaderMod.foo` */
  override def _to: js.Function1[/* props */ DefaultComponentPropsListSubheaderTypeMa, Element | Null] = default
}
