...
import com.olvind.mui.muiJoy.anon.DisableColorScheme
...
object scopedCssBaselineScopedCssBaselinePropsMod {
  
  /* Inlined parent @mui/joy.@mui/joy/ScopedCssBaseline/ScopedCssBaselineProps.ScopedCssBaselineProps<@mui/joy.@mui/joy/ScopedCssBaseline/ScopedCssBaselineProps.ScopedCssBaselineTypeMap<{}, 'div'>['defaultComponent'], {  component :react.react.ElementType<any> | undefined}> */
  trait ScopedCssBaselineOwnerState extends StObject {
  ...
  object ScopedCssBaselineOwnerState {
    
    inline def apply(): ScopedCssBaselineOwnerState = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[ScopedCssBaselineOwnerState]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: ScopedCssBaselineOwnerState] (val x: Self) extends AnyVal {
  ...
  type ScopedCssBaselineSlot = "root"
  
  trait ScopedCssBaselineTypeMap[P, D /* <: ElementType */] extends StObject {
    
    var defaultComponent: D
    
    var props: P & DisableColorScheme
  }
  object ScopedCssBaselineTypeMap {
    
    inline def apply[P, D /* <: ElementType */](defaultComponent: D, props: P & DisableColorScheme): ScopedCssBaselineTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[ScopedCssBaselineTypeMap[P, D]]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: ScopedCssBaselineTypeMap[?, ?], P, D /* <: ElementType */] (val x: Self & (ScopedCssBaselineTypeMap[P, D])) extends AnyVal {
      
      inline def setDefaultComponent(value: D): Self = StObject.set(x, "defaultComponent", value.asInstanceOf[js.Any])
      
      inline def setProps(value: P & DisableColorScheme): Self = StObject.set(x, "props", value.asInstanceOf[js.Any])
    }
  }
}
