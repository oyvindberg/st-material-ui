...
object cardOverflowCardOverflowPropsMod {
  ...
  /* Inlined parent @mui/joy.@mui/joy/CardOverflow/CardOverflowProps.CardOverflowProps<@mui/joy.@mui/joy/CardOverflow/CardOverflowProps.CardOverflowTypeMap<{}, 'div'>['defaultComponent'], {  component :react.react.ElementType<any> | undefined}> */
  trait CardOverflowOwnerState extends StObject {
  ...
  object CardOverflowOwnerState {
    
    inline def apply(): CardOverflowOwnerState = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[CardOverflowOwnerState]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: CardOverflowOwnerState] (val x: Self) extends AnyVal {
