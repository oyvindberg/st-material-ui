...
object textFieldTextFieldPropsMod {
  ...
  type TextFieldProps[D /* <: ElementType */, P] = OverrideProps[TextFieldTypeMap[P, D], D]
  
  type TextFieldSlot = "root"
  
  trait TextFieldTypeMap[P, D /* <: ElementType */] extends StObject {
  ...
  object TextFieldTypeMap {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: TextFieldTypeMap[?, ?], P, D /* <: ElementType */] (val x: Self & (TextFieldTypeMap[P, D])) extends AnyVal {
