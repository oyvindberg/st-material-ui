...
object formLabelFormLabelMod extends Shortcut {
  ...
  type _To = js.Function1[/* props */ DefaultComponentPropsFormLabelTypeMaplab, Element | Null]
  
  /* This means you don't have to write `default`, but can instead just say `formLabelFormLabelMod.foo` */
  override def _to: js.Function1[/* props */ DefaultComponentPropsFormLabelTypeMaplab, Element | Null] = default
}
