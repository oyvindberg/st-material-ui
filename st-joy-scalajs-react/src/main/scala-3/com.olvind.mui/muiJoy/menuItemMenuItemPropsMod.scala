...
object menuItemMenuItemPropsMod {
  ...
  /* Inlined parent @mui/joy.@mui/joy/MenuItem/MenuItemProps.MenuItemProps<@mui/joy.@mui/joy/MenuItem/MenuItemProps.MenuItemTypeMap<{}, 'div'>['defaultComponent'], {  component :react.react.ElementType<any> | undefined}> */
  trait MenuItemOwnerState extends StObject {
  ...
  object MenuItemTypeMap {
    ...
    inline def apply[P, D /* <: ElementType */](defaultComponent: D, props: P & ListItemButtonPropsListItemButtonTypeMap): MenuItemTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[MenuItemTypeMap[P, D]]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: MenuItemTypeMap[?, ?], P, D /* <: ElementType */] (val x: Self & (MenuItemTypeMap[P, D])) extends AnyVal {
