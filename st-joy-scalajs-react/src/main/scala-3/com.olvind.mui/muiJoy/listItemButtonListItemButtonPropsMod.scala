...
object listItemButtonListItemButtonPropsMod {
  ...
  /* Inlined parent @mui/joy.@mui/joy/ListItemButton/ListItemButtonProps.ListItemButtonProps<@mui/joy.@mui/joy/ListItemButton/ListItemButtonProps.ListItemButtonTypeMap<{}, 'div'>['defaultComponent'], {  component :react.react.ElementType<any> | undefined}> */
  trait ListItemButtonOwnerState extends StObject {
  ...
  trait ListItemButtonTypeMap[P, D /* <: ElementType */] extends StObject {
  ...
  object ListItemButtonTypeMap {
    ...
    inline def apply[P, D /* <: ElementType */](defaultComponent: D, props: P & AutoFocus): ListItemButtonTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[ListItemButtonTypeMap[P, D]]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: ListItemButtonTypeMap[?, ?], P, D /* <: ElementType */] (val x: Self & (ListItemButtonTypeMap[P, D])) extends AnyVal {
