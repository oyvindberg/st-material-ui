...
object listSubheaderListSubheaderPropsMod {
  ...
  /* Inlined parent @mui/joy.@mui/joy/ListSubheader/ListSubheaderProps.ListSubheaderProps<@mui/joy.@mui/joy/ListSubheader/ListSubheaderProps.ListSubheaderTypeMap<{}, 'div'>['defaultComponent'], {  component :react.react.ElementType<any> | undefined}> */
  trait ListSubheaderOwnerState extends StObject {
  ...
  object ListSubheaderOwnerState {
    
    inline def apply(): ListSubheaderOwnerState = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[ListSubheaderOwnerState]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: ListSubheaderOwnerState] (val x: Self) extends AnyVal {
