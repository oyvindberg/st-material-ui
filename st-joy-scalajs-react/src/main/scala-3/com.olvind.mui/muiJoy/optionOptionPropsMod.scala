...
object optionOptionPropsMod {
  ...
  trait OptionOwnerState extends StObject {
    ...
    var label: js.UndefOr[String | japgolly.scalajs.react.facade.React.Element] = js.undefined
  ...
  object OptionOwnerState {
    ...
    implicit open class MutableBuilder[Self <: OptionOwnerState] (val x: Self) extends AnyVal {
      ...
      inline def setLabel(value: String | japgolly.scalajs.react.facade.React.Element): Self = StObject.set(x, "label", value.asInstanceOf[js.Any])
  ...
  type OptionProps[D /* <: ElementType */, P] = OverrideProps[OptionTypeMap[P, D], D]
  ...
  trait OptionTypeMap[P, D /* <: ElementType */] extends StObject {
  ...
  object OptionTypeMap {
    ...
    inline def apply[P, D /* <: ElementType */](defaultComponent: D, props: P & Value): OptionTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[OptionTypeMap[P, D]]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: OptionTypeMap[?, ?], P, D /* <: ElementType */] (val x: Self & (OptionTypeMap[P, D])) extends AnyVal {
