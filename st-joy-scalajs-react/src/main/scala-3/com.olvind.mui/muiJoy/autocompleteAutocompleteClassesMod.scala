...
object autocompleteAutocompleteClassesMod {
  ...
  @JSImport("@mui/joy/Autocomplete/autocompleteClasses", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@mui/joy/Autocomplete/autocompleteClasses", JSImport.Default)
  @js.native
  ...
  object AutocompleteClasses {
    ...
    implicit open class MutableBuilder[Self <: AutocompleteClasses] (val x: Self) extends AnyVal {
      ...
      inline def setLimitTag(value: String): Self = StObject.set(x, "limitTag", value.asInstanceOf[js.Any])
