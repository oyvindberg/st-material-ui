...
object containerContainerMod extends Shortcut {
  ...
  @JSImport("@mui/joy/Container/Container", JSImport.Default)
  @js.native
  val default: js.Function1[/* props */ DefaultComponentPropsContainerTypeMapdiv, Element | Null] = js.native
  
  type _To = js.Function1[/* props */ DefaultComponentPropsContainerTypeMapdiv, Element | Null]
  
  /* This means you don't have to write `default`, but can instead just say `containerContainerMod.foo` */
  override def _to: js.Function1[/* props */ DefaultComponentPropsContainerTypeMapdiv, Element | Null] = default
}
