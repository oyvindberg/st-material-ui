...
object mod {
  ...
  type OverrideProps[M /* <: OverridableTypeMap */, C /* <: ElementType */] = BaseProps[M] with (DistributiveOmit[ComponentPropsWithRef[C], /* keyof @mui/types.@mui/types.BaseProps<M> */ String])
