...
object ListStylePosition {
  ...
  @scala.inline
  def inside: com.olvind.mui.csstype.csstypeStrings.inside = "inside".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.inside]
  
  @scala.inline
  def outside: com.olvind.mui.csstype.csstypeStrings.outside = "outside".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.outside]
