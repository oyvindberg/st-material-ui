...
object MsAccelerator {
  ...
  @scala.inline
  def `false`: com.olvind.mui.csstype.csstypeStrings.`false` = "false".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.`false`]
  ...
  @scala.inline
  def `true`: com.olvind.mui.csstype.csstypeStrings.`true` = "true".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.`true`]
