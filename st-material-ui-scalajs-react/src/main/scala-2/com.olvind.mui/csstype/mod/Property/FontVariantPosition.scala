...
/* Rewritten from type alias, can be one of: 
  ...
  - `com.olvind.mui`.csstype.csstypeStrings.sub
  - `com.olvind.mui`.csstype.csstypeStrings.`super`
...
*/
trait FontVariantPosition extends StObject
object FontVariantPosition {
  ...
  @scala.inline
  def sub: com.olvind.mui.csstype.csstypeStrings.sub = "sub".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.sub]
  
  @scala.inline
  def `super`: com.olvind.mui.csstype.csstypeStrings.`super` = "super".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.`super`]
