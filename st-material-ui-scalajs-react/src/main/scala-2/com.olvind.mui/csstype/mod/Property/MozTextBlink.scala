...
/* Rewritten from type alias, can be one of: 
  - `com.olvind.mui`.csstype.csstypeStrings.blink
...
object MozTextBlink {
  ...
  @scala.inline
  def blink: com.olvind.mui.csstype.csstypeStrings.blink = "blink".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.blink]
