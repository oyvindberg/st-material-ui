...
*/
trait TextAlignLast extends StObject
object TextAlignLast {
  ...
  @scala.inline
  def justify: com.olvind.mui.csstype.csstypeStrings.justify = "justify".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.justify]
