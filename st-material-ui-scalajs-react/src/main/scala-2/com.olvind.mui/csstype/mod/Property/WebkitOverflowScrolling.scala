...
/* Rewritten from type alias, can be one of: 
  ...
  - `com.olvind.mui`.csstype.csstypeStrings.touch
...
*/
trait WebkitOverflowScrolling extends StObject
object WebkitOverflowScrolling {
  ...
  @scala.inline
  def touch: com.olvind.mui.csstype.csstypeStrings.touch = "touch".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.touch]
