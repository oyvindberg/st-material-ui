...
/* Rewritten from type alias, can be one of: 
  - `com.olvind.mui`.csstype.csstypeStrings.`non-scaling-stroke`
...
object VectorEffect {
  ...
  @scala.inline
  def `non-scaling-stroke`: com.olvind.mui.csstype.csstypeStrings.`non-scaling-stroke` = "non-scaling-stroke".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.`non-scaling-stroke`]
