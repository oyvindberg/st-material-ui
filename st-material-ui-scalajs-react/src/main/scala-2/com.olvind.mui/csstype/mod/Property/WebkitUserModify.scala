...
/* Rewritten from type alias, can be one of: 
  - `com.olvind.mui`.csstype.csstypeStrings.`read-only`
  - `com.olvind.mui`.csstype.csstypeStrings.`read-write`
  - `com.olvind.mui`.csstype.csstypeStrings.`read-write-plaintext-only`
...
*/
trait WebkitUserModify extends StObject
object WebkitUserModify {
  ...
  @scala.inline
  def `read-only`: com.olvind.mui.csstype.csstypeStrings.`read-only` = "read-only".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.`read-only`]
  
  @scala.inline
  def `read-write`: com.olvind.mui.csstype.csstypeStrings.`read-write` = "read-write".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.`read-write`]
  
  @scala.inline
  def `read-write-plaintext-only`: com.olvind.mui.csstype.csstypeStrings.`read-write-plaintext-only` = "read-write-plaintext-only".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.`read-write-plaintext-only`]
