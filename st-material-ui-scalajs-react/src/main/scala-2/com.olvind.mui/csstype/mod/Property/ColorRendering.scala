...
/* Rewritten from type alias, can be one of: 
  ...
  - `com.olvind.mui`.csstype.csstypeStrings.optimizeQuality
...
object ColorRendering {
  ...
  @scala.inline
  def optimizeQuality: com.olvind.mui.csstype.csstypeStrings.optimizeQuality = "optimizeQuality".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.optimizeQuality]
