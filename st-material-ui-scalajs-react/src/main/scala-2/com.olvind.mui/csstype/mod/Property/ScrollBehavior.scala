...
/* Rewritten from type alias, can be one of: 
  ...
  - `com.olvind.mui`.csstype.csstypeStrings.smooth
...
object ScrollBehavior {
  ...
  @scala.inline
  def smooth: com.olvind.mui.csstype.csstypeStrings.smooth = "smooth".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.smooth]
