...
/* Rewritten from type alias, can be one of: 
  - `com.olvind.mui`.csstype.csstypeStrings.clone
  - `com.olvind.mui`.csstype.csstypeStrings.slice
...
object BoxDecorationBreak {
  ...
  @scala.inline
  def slice: com.olvind.mui.csstype.csstypeStrings.slice = "slice".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.slice]
