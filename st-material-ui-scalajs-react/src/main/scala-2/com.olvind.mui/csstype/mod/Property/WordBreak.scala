...
/* Rewritten from type alias, can be one of: 
  - `com.olvind.mui`.csstype.csstypeStrings.`break-all`
  - `com.olvind.mui`.csstype.csstypeStrings.`break-word`
  - `com.olvind.mui`.csstype.csstypeStrings.`keep-all`
...
object WordBreak {
  ...
  @scala.inline
  def `break-all`: com.olvind.mui.csstype.csstypeStrings.`break-all` = "break-all".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.`break-all`]
  
  @scala.inline
  def `break-word`: com.olvind.mui.csstype.csstypeStrings.`break-word` = "break-word".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.`break-word`]
  ...
  @scala.inline
  def `keep-all`: com.olvind.mui.csstype.csstypeStrings.`keep-all` = "keep-all".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.`keep-all`]
