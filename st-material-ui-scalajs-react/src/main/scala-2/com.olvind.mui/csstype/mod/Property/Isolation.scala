...
/* Rewritten from type alias, can be one of: 
  ...
  - `com.olvind.mui`.csstype.csstypeStrings.isolate
...
*/
trait Isolation extends StObject
object Isolation {
  ...
  @scala.inline
  def isolate: com.olvind.mui.csstype.csstypeStrings.isolate = "isolate".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.isolate]
