...
object WebkitMaskRepeatX {
  ...
  @scala.inline
  def `no-repeat`: com.olvind.mui.csstype.csstypeStrings.`no-repeat` = "no-repeat".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.`no-repeat`]
  
  @scala.inline
  def repeat: com.olvind.mui.csstype.csstypeStrings.repeat = "repeat".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.repeat]
  
  @scala.inline
  def revert: com.olvind.mui.csstype.csstypeStrings.revert = "revert".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.revert]
  
  @scala.inline
  def round: com.olvind.mui.csstype.csstypeStrings.round = "round".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.round]
  
  @scala.inline
  def space: com.olvind.mui.csstype.csstypeStrings.space = "space".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.space]
