...
/* Rewritten from type alias, can be one of: 
  - `com.olvind.mui`.csstype.csstypeStrings.multiple
  - `com.olvind.mui`.csstype.csstypeStrings.single
...
*/
trait BoxLines extends StObject
object BoxLines {
  ...
  @scala.inline
  def multiple: com.olvind.mui.csstype.csstypeStrings.multiple = "multiple".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.multiple]
  
  @scala.inline
  def revert: com.olvind.mui.csstype.csstypeStrings.revert = "revert".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.revert]
  
  @scala.inline
  def single: com.olvind.mui.csstype.csstypeStrings.single = "single".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.single]
