...
/* Rewritten from type alias, can be one of: 
  - `com.olvind.mui`.csstype.csstypeStrings.mandatory
  - `com.olvind.mui`.csstype.csstypeStrings.none
  - `com.olvind.mui`.csstype.csstypeStrings.proximity
...
*/
trait ScrollSnapTypeY extends StObject
object ScrollSnapTypeY {
  ...
  @scala.inline
  def mandatory: com.olvind.mui.csstype.csstypeStrings.mandatory = "mandatory".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.mandatory]
  
  @scala.inline
  def none: com.olvind.mui.csstype.csstypeStrings.none = "none".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.none]
  
  @scala.inline
  def proximity: com.olvind.mui.csstype.csstypeStrings.proximity = "proximity".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.proximity]
