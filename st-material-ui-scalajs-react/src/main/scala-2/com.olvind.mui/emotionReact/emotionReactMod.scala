...
object emotionReactMod {
  ...
  trait ClassNamesProps extends StObject {
    ...
    def children(content: ClassNamesContent): Node = js.native
  }
  object ClassNamesProps {
    
    @scala.inline
    def apply(children: ClassNamesContent => Node): ClassNamesProps = {
    ...
    implicit class ClassNamesPropsMutableBuilder[Self <: ClassNamesProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setChildren(value: ClassNamesContent => Node): Self = StObject.set(x, "children", js.Any.fromFunction1(value))
    }
  }
