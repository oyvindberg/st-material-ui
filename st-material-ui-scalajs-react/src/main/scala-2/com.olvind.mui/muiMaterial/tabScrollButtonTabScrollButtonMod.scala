...
object tabScrollButtonTabScrollButtonMod {
  
  @JSImport("@mui/material/TabScrollButton/TabScrollButton", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @scala.inline
  def default(props: TabScrollButtonProps): Element = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(props.asInstanceOf[js.Any]).asInstanceOf[Element]
  ...
  trait TabScrollButtonProps extends StObject {
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialTabScrollButtonClasses] = js.native
  ...
  object TabScrollButtonProps {
    ...
    @scala.inline
    def apply(direction: left | right, orientation: horizontal | vertical): TabScrollButtonProps = {
      val __obj = js.Dynamic.literal(direction = direction.asInstanceOf[js.Any], orientation = orientation.asInstanceOf[js.Any])
      __obj.asInstanceOf[TabScrollButtonProps]
    }
    
    @scala.inline
    implicit class TabScrollButtonPropsMutableBuilder[Self <: TabScrollButtonProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClasses(value: PartialTabScrollButtonClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
