...
object boxBoxMod extends Shortcut {
  ...
  object BoxTypeMap {
    ...
    @scala.inline
    def apply[P, D /* <: ElementType */](defaultComponent: D, props: P with SystemProps[Theme] with Component): BoxTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[BoxTypeMap[P, D]]
    }
    
    @scala.inline
    implicit class BoxTypeMapMutableBuilder[Self <: BoxTypeMap[_, _], P, D /* <: ElementType */] (val x: Self with (BoxTypeMap[P, D])) extends AnyVal {
