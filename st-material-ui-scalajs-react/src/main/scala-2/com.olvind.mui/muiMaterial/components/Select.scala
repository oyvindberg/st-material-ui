...
object Select {
  ...
  class Builder[T] (val args: js.Array[Any])
    ...
    @scala.inline
    def classes(value: PartialSelectClasses): this.type = set("classes", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def componentsProps(value: com.olvind.mui.muiMaterial.anon.Input): this.type = set("componentsProps", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def disableInjectingGlobalStyles(value: Boolean): this.type = set("disableInjectingGlobalStyles", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def displayEmpty(value: Boolean): this.type = set("displayEmpty", value.asInstanceOf[js.Any])
    
    @scala.inline
    def draggable(value: Booleanish): this.type = set("draggable", value.asInstanceOf[js.Any])
    
    @scala.inline
    def endAdornment(value: VdomNode): this.type = set("endAdornment", value.rawNode.asInstanceOf[js.Any])
    
    @scala.inline
    def endAdornmentNull: this.type = set("endAdornment", null)
    
    @scala.inline
    def endAdornmentVarargs(value: (Empty | String | JsNumber | Element)*): this.type = set("endAdornment", js.Array(value :_*))
    
    @scala.inline
    def endAdornmentVdomElement(value: VdomElement): this.type = set("endAdornment", value.rawElement.asInstanceOf[js.Any])
    ...
    @scala.inline
    def input(value: VdomElement): this.type = set("input", value.rawElement.asInstanceOf[js.Any])
    
    @scala.inline
    def inputComponent(value: ElementType): this.type = set("inputComponent", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def onChange(value: (/* event */ SelectChangeEvent[T], /* child */ Node) => Callback): this.type = set("onChange", js.Any.fromFunction2((t0: /* event */ SelectChangeEvent[T], t1: /* child */ Node) => (value(t0, t1)).runNow()))
    ...
    @scala.inline
    def onClose(value: /* event */ ReactEventFrom[org.scalajs.dom.Element] => Callback): this.type = set("onClose", js.Any.fromFunction1((t0: /* event */ ReactEventFrom[org.scalajs.dom.Element]) => value(t0).runNow()))
    ...
    @scala.inline
    def onKeyDown(
      value: ReactKeyboardEventFrom[(HTMLTextAreaElement | HTMLInputElement) with org.scalajs.dom.Element] => Callback
    ): this.type = set("onKeyDown", js.Any.fromFunction1((t0: ReactKeyboardEventFrom[(HTMLTextAreaElement | HTMLInputElement) with org.scalajs.dom.Element]) => value(t0).runNow()))
    ...
    def onKeyUp(
      value: ReactKeyboardEventFrom[(HTMLTextAreaElement | HTMLInputElement) with org.scalajs.dom.Element] => Callback
    ): this.type = set("onKeyUp", js.Any.fromFunction1((t0: ReactKeyboardEventFrom[(HTMLTextAreaElement | HTMLInputElement) with org.scalajs.dom.Element]) => value(t0).runNow()))
    ...
    @scala.inline
    def renderSuffix(value: /* state */ Disabled => Node): this.type = set("renderSuffix", js.Any.fromFunction1(value))
    
    @scala.inline
    def renderValue(value: T => Node): this.type = set("renderValue", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def startAdornment(value: VdomNode): this.type = set("startAdornment", value.rawNode.asInstanceOf[js.Any])
    
    @scala.inline
    def startAdornmentNull: this.type = set("startAdornment", null)
    
    @scala.inline
    def startAdornmentVarargs(value: (Empty | String | JsNumber | Element)*): this.type = set("startAdornment", js.Array(value :_*))
    
    @scala.inline
    def startAdornmentVdomElement(value: VdomElement): this.type = set("startAdornment", value.rawElement.asInstanceOf[js.Any])
