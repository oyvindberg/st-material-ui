...
import com.olvind.mui.muiMaterial.anon.PartialFabClasses
...
object Fab {
  ...
  object DefaultComponentPropsExtendButtonBaseTypAriaatomic {
    ...
    class Builder (val args: js.Array[Any]) extends StBuildingComponent[HTMLAnchorElement] {
      ...
      @scala.inline
      def classes(value: PartialFabClasses): this.type = set("classes", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def variant(value: circular | extended): this.type = set("variant", value.asInstanceOf[js.Any])
    ...
    def withProps(p: com.olvind.mui.muiMaterial.anon.DefaultComponentPropsExtendButtonBaseTypAriaatomic): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  ...
  object OverridePropsExtendButtonBaseTypeMapFabT {
    ...
    def withProps(p: com.olvind.mui.muiMaterial.anon.OverridePropsExtendButtonBaseTypeMapFabT): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
}
