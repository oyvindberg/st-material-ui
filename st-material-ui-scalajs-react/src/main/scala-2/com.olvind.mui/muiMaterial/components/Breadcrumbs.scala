...
object Breadcrumbs {
  ...
  @JSImport("@mui/material", "Breadcrumbs")
  @js.native
  ...
  class Builder (val args: js.Array[Any]) extends StBuildingComponent[HTMLElement] {
    ...
    @scala.inline
    def classes(value: PartialBreadcrumbsClasses): this.type = set("classes", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def expandText(value: String): this.type = set("expandText", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def itemsAfterCollapse(value: Double): this.type = set("itemsAfterCollapse", value.asInstanceOf[js.Any])
    
    @scala.inline
    def itemsBeforeCollapse(value: Double): this.type = set("itemsBeforeCollapse", value.asInstanceOf[js.Any])
    
    @scala.inline
    def lang(value: String): this.type = set("lang", value.asInstanceOf[js.Any])
    
    @scala.inline
    def maxItems(value: Double): this.type = set("maxItems", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def separator(value: VdomNode): this.type = set("separator", value.rawNode.asInstanceOf[js.Any])
    
    @scala.inline
    def separatorNull: this.type = set("separator", null)
    
    @scala.inline
    def separatorVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): this.type = set("separator", js.Array(value :_*))
    
    @scala.inline
    def separatorVdomElement(value: VdomElement): this.type = set("separator", value.rawElement.asInstanceOf[js.Any])
