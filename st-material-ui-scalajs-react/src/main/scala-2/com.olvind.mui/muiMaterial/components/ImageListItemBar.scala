...
object ImageListItemBar {
  
  @JSImport("@mui/material", "ImageListItemBar")
  @js.native
  ...
  class Builder (val args: js.Array[Any])
    ...
    @scala.inline
    def actionIcon(value: VdomNode): this.type = set("actionIcon", value.rawNode.asInstanceOf[js.Any])
    
    @scala.inline
    def actionIconNull: this.type = set("actionIcon", null)
    
    @scala.inline
    def actionIconVarargs(value: (Empty | String | JsNumber | Element)*): this.type = set("actionIcon", js.Array(value :_*))
    
    @scala.inline
    def actionIconVdomElement(value: VdomElement): this.type = set("actionIcon", value.rawElement.asInstanceOf[js.Any])
    ...
    @scala.inline
    def classes(value: PartialImageListItemBarClasses): this.type = set("classes", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def position(value: below | top | bottom): this.type = set("position", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def subtitle(value: VdomNode): this.type = set("subtitle", value.rawNode.asInstanceOf[js.Any])
    
    @scala.inline
    def subtitleNull: this.type = set("subtitle", null)
    
    @scala.inline
    def subtitleVarargs(value: (Empty | String | JsNumber | Element)*): this.type = set("subtitle", js.Array(value :_*))
    
    @scala.inline
    def subtitleVdomElement(value: VdomElement): this.type = set("subtitle", value.rawElement.asInstanceOf[js.Any])
  ...
  implicit def make(companion: ImageListItemBar.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ImageListItemBarProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
