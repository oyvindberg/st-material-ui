...
object SpeedDial {
  ...
  @scala.inline
  def apply(ariaLabel: String): Builder = {
    val __props = js.Dynamic.literal(ariaLabel = ariaLabel.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[SpeedDialProps]))
  }
  
  @JSImport("@mui/material", "SpeedDial")
  @js.native
  ...
  class Builder (val args: js.Array[Any])
    ...
    @scala.inline
    def FabProps(value: PartialFabPropsFabTypeMapbuttondefaultCo): this.type = set("FabProps", value.asInstanceOf[js.Any])
    
    @scala.inline
    def TransitionComponent(value: TransitionProps => Element | Null): this.type = set("TransitionComponent", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def classes(value: PartialSpeedDialClasses): this.type = set("classes", value.asInstanceOf[js.Any])
    ...
    ): this.type = set("onClose", js.Any.fromFunction2((t0: /* event */ ReactEventFrom[js.Object with org.scalajs.dom.Element], t1: /* reason */ CloseReason) => (value(t0, t1)).runNow()))
    ...
    ): this.type = set("onOpen", js.Any.fromFunction2((t0: /* event */ ReactEventFrom[js.Object with org.scalajs.dom.Element], t1: /* reason */ OpenReason) => (value(t0, t1)).runNow()))
