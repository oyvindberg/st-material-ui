...
object Menu {
  ...
  class Builder (val args: js.Array[Any]) extends StBuildingComponent[HTMLDivElement] {
    ...
    @scala.inline
    def MenuListProps(value: PartialMenuListPropsMenuListTypeMapuldef): this.type = set("MenuListProps", value.asInstanceOf[js.Any])
    
    @scala.inline
    def PaperProps(value: PartialPaperPropsdiv): this.type = set("PaperProps", value.asInstanceOf[js.Any])
    
    @scala.inline
    def PopoverClasses(value: PartialPopoverClasses): this.type = set("PopoverClasses", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def action(value: Ref[PopoverActions]): this.type = set("action", value.asInstanceOf[js.Any])
    
    @scala.inline
    def actionFunction1(value: PopoverActions | Null => Callback): this.type = set("action", js.Any.fromFunction1((t0: PopoverActions | Null) => value(t0).runNow()))
    ...
    @scala.inline
    def anchorElFunction1(value: /* element */ org.scalajs.dom.Element => org.scalajs.dom.Element): this.type = set("anchorEl", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def anchorPosition(value: PopoverPosition): this.type = set("anchorPosition", value.asInstanceOf[js.Any])
    
    @scala.inline
    def anchorReference(value: PopoverReference): this.type = set("anchorReference", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def classes(value: PartialMenuClasses): this.type = set("classes", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def container(value: org.scalajs.dom.Element | (js.Function0[org.scalajs.dom.Element | Null])): this.type = set("container", value.asInstanceOf[js.Any])
    
    @scala.inline
    def containerCallbackTo(value: CallbackTo[org.scalajs.dom.Element | Null]): this.type = set("container", value.toJsFn)
    ...
    @scala.inline
    def disableAutoFocusItem(value: Boolean): this.type = set("disableAutoFocusItem", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def marginThreshold(value: Double): this.type = set("marginThreshold", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def onBackdropClick(value: ReactEventFrom[js.Object with org.scalajs.dom.Element] => Callback): this.type = set("onBackdropClick", js.Any.fromFunction1((t0: ReactEventFrom[js.Object with org.scalajs.dom.Element]) => value(t0).runNow()))
    ...
    ): this.type = set("onClose", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def transformOrigin(value: PopoverOrigin): this.type = set("transformOrigin", value.asInstanceOf[js.Any])
    
    @scala.inline
    def transitionDuration(value: Any | auto): this.type = set("transitionDuration", value.asInstanceOf[js.Any])
