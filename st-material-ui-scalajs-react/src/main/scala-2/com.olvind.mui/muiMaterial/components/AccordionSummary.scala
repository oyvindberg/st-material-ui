...
import com.olvind.mui.muiMaterial.anon.PartialAccordionSummaryClasses
...
object AccordionSummary {
  ...
  object href {
    ...
    class Builder (val args: js.Array[Any]) extends StBuildingComponent[HTMLAnchorElement] {
      ...
      @scala.inline
      def classes(value: PartialAccordionSummaryClasses): this.type = set("classes", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def expandIcon(value: VdomNode): this.type = set("expandIcon", value.rawNode.asInstanceOf[js.Any])
      
      @scala.inline
      def expandIconNull: this.type = set("expandIcon", null)
      
      @scala.inline
      def expandIconVarargs(value: (Empty | String | JsNumber | Element)*): this.type = set("expandIcon", js.Array(value :_*))
      
      @scala.inline
      def expandIconVdomElement(value: VdomElement): this.type = set("expandIcon", value.rawElement.asInstanceOf[js.Any])
  ...
  object normal {
    ...
    def withProps(p: DefaultComponentPropsExtendButtonBaseTyp): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
}
