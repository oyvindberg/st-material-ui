...
object Alert {
  ...
  class Builder (val args: js.Array[Any]) extends StBuildingComponent[HTMLDivElement] {
    ...
    @scala.inline
    def classes(value: PartialAlertClasses): this.type = set("classes", value.asInstanceOf[js.Any])
    
    @scala.inline
    def closeText(value: String): this.type = set("closeText", value.asInstanceOf[js.Any])
    
    @scala.inline
    def color(value: AlertColor): this.type = set("color", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def iconMapping(value: PartialRecordAlertColorReactNode): this.type = set("iconMapping", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def severity(value: AlertColor): this.type = set("severity", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def variant(value: standard | filled | outlined): this.type = set("variant", value.asInstanceOf[js.Any])
