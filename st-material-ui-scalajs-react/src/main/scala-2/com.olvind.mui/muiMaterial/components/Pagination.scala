...
object Pagination {
  ...
  class Builder (val args: js.Array[Any])
    ...
    @scala.inline
    def boundaryCount(value: Double): this.type = set("boundaryCount", value.asInstanceOf[js.Any])
    
    @scala.inline
    def className(value: String): this.type = set("className", value.asInstanceOf[js.Any])
    
    @scala.inline
    def classes(value: PartialPaginationClasses): this.type = set("classes", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def hideNextButton(value: Boolean): this.type = set("hideNextButton", value.asInstanceOf[js.Any])
    
    @scala.inline
    def hidePrevButton(value: Boolean): this.type = set("hidePrevButton", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def onChange(value: (/* event */ ReactEventFrom[Any with Element], /* page */ Double) => Callback): this.type = set("onChange", js.Any.fromFunction2((t0: /* event */ ReactEventFrom[Any with Element], t1: /* page */ Double) => (value(t0, t1)).runNow()))
    ...
    @scala.inline
    def renderItem(value: /* params */ PaginationRenderItemParams => Node): this.type = set("renderItem", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def siblingCount(value: Double): this.type = set("siblingCount", value.asInstanceOf[js.Any])
