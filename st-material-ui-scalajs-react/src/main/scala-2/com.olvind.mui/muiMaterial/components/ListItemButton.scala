...
object ListItemButton {
  ...
  object href {
    ...
    class Builder (val args: js.Array[Any]) extends StBuildingComponent[HTMLAnchorElement] {
      ...
      @scala.inline
      def classes(value: PartialListItemButtonClasses): this.type = set("classes", value.asInstanceOf[js.Any])
    ...
    def withProps(p: OverridePropsExtendButtonBaseTypeMapListAbout): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  ...
  object normal {
    ...
    def withProps(p: DefaultComponentPropsExtendButtonBaseTypAriabusy): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
}
