...
object Dialog {
  ...
  class Builder (val args: js.Array[Any]) extends StBuildingComponent[HTMLDivElement] {
    ...
    @scala.inline
    def PaperComponent(value: PaperPropsPaperTypeMapdivdefaultComponen => Element | Null): this.type = set("PaperComponent", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def classes(value: PartialDialogClasses): this.type = set("classes", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def scroll(value: body | paper): this.type = set("scroll", value.asInstanceOf[js.Any])
