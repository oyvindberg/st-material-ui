...
object Chip {
  ...
  class Builder (val args: js.Array[Any]) extends StBuildingComponent[HTMLDivElement] {
    ...
    @scala.inline
    def avatar(value: VdomElement): this.type = set("avatar", value.rawElement.asInstanceOf[js.Any])
    
    @scala.inline
    def className(value: String): this.type = set("className", value.asInstanceOf[js.Any])
    
    @scala.inline
    def classes(value: PartialChipClasses): this.type = set("classes", value.asInstanceOf[js.Any])
    
    @scala.inline
    def clickable(value: Boolean): this.type = set("clickable", value.asInstanceOf[js.Any])
    
    @scala.inline
    def color(value: default | primary | secondary | error | info | success | warning): this.type = set("color", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def deleteIcon(value: VdomElement): this.type = set("deleteIcon", value.rawElement.asInstanceOf[js.Any])
    ...
    @scala.inline
    def icon(value: VdomElement): this.type = set("icon", value.rawElement.asInstanceOf[js.Any])
    ...
    @scala.inline
    def onDelete(value: Any => Callback): this.type = set("onDelete", js.Any.fromFunction1((t0: Any) => value(t0).runNow()))
    ...
    @scala.inline
    def variant(value: filled | outlined): this.type = set("variant", value.asInstanceOf[js.Any])
