...
object StepLabel {
  ...
  class Builder (val args: js.Array[Any])
    ...
    @scala.inline
    def StepIconComponent(value: ElementType): this.type = set("StepIconComponent", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def classes(value: PartialStepLabelClasses): this.type = set("classes", value.asInstanceOf[js.Any])
    
    @scala.inline
    def color(value: String): this.type = set("color", value.asInstanceOf[js.Any])
    
    @scala.inline
    def componentsProps(value: Label): this.type = set("componentsProps", value.asInstanceOf[js.Any])
