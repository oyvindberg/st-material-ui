...
object Stack {
  ...
  class Builder (val args: js.Array[Any])
    ...
    @scala.inline
    def directionVarargs(value: ((row | `row-reverse` | column | `column-reverse`) | Null)*): this.type = set("direction", js.Array(value :_*))
    ...
    @scala.inline
    def divider(value: VdomNode): this.type = set("divider", value.rawNode.asInstanceOf[js.Any])
    
    @scala.inline
    def dividerNull: this.type = set("divider", null)
    
    @scala.inline
    def dividerVarargs(value: (Empty | String | JsNumber | Element)*): this.type = set("divider", js.Array(value :_*))
    
    @scala.inline
    def dividerVdomElement(value: VdomElement): this.type = set("divider", value.rawElement.asInstanceOf[js.Any])
    ...
    @scala.inline
    def spacing(value: com.olvind.mui.muiSystem.mod.ResponsiveStyleValue[Double | String]): this.type = set("spacing", value.asInstanceOf[js.Any])
    
    @scala.inline
    def spacingVarargs(value: ((Double | String) | Null)*): this.type = set("spacing", js.Array(value :_*))
