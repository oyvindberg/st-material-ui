...
object Backdrop {
  ...
  def apply(open: Boolean): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[/* props */ DefaultComponentPropsBackdropTypeMapspan]))
  }
  ...
  class Builder (val args: js.Array[Any])
    ...
    @scala.inline
    def addEndListener(value: Any): this.type = set("addEndListener", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def easing(value: Any): this.type = set("easing", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def mountOnEnter(value: Any): this.type = set("mountOnEnter", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def onEnter(value: Any): this.type = set("onEnter", value.asInstanceOf[js.Any])
    
    @scala.inline
    def onEntered(value: Any): this.type = set("onEntered", value.asInstanceOf[js.Any])
    
    @scala.inline
    def onEntering(value: Any): this.type = set("onEntering", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def onExit(value: Any): this.type = set("onExit", value.asInstanceOf[js.Any])
    
    @scala.inline
    def onExited(value: Any): this.type = set("onExited", value.asInstanceOf[js.Any])
    
    @scala.inline
    def onExiting(value: Any): this.type = set("onExiting", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def timeout(value: Any): this.type = set("timeout", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def unmountOnExit(value: Any): this.type = set("unmountOnExit", value.asInstanceOf[js.Any])
  ...
  def withProps(p: /* props */ DefaultComponentPropsBackdropTypeMapspan): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
