...
object ToggleButton {
  ...
  object href {
    ...
    @scala.inline
    def apply(href: String, value: NonNullable[Any]): Builder = {
      val __props = js.Dynamic.literal(href = href.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
    ...
    class Builder (val args: js.Array[Any]) extends StBuildingComponent[HTMLAnchorElement] {
      ...
      @scala.inline
      def classes(value: PartialToggleButtonClasses): this.type = set("classes", value.asInstanceOf[js.Any])
      
      @scala.inline
      def color(value: standard | primary | secondary | error | info | success | warning): this.type = set("color", value.asInstanceOf[js.Any])
  ...
  object normal {
    ...
    @scala.inline
    def apply(value: NonNullable[Any]): Builder = {
    ...
    def withProps(p: DefaultComponentPropsExtendButtonBaseTypAriacolspan): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
}
