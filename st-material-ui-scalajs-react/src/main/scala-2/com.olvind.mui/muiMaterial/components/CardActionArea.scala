...
import com.olvind.mui.muiMaterial.anon.PartialCardActionAreaClasses
...
object CardActionArea {
  ...
  object href {
    ...
    class Builder (val args: js.Array[Any]) extends StBuildingComponent[HTMLAnchorElement] {
      ...
      @scala.inline
      def classes(value: PartialCardActionAreaClasses): this.type = set("classes", value.asInstanceOf[js.Any])
