...
object Tab {
  ...
  object href {
    ...
    class Builder (val args: js.Array[Any]) extends StBuildingComponent[HTMLAnchorElement] {
      ...
      @scala.inline
      def classes(value: PartialTabClasses): this.type = set("classes", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def icon(value: String | Element): this.type = set("icon", value.asInstanceOf[js.Any])
      
      @scala.inline
      def iconPosition(value: top | bottom | start | end): this.type = set("iconPosition", value.asInstanceOf[js.Any])
