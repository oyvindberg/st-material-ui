...
object MobileStepper {
  ...
  @scala.inline
  def apply(steps: Double): Builder = {
    val __props = js.Dynamic.literal(steps = steps.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[MobileStepperProps]))
  }
  ...
  class Builder (val args: js.Array[Any]) extends StBuildingComponent[HTMLDivElement] {
    ...
    @scala.inline
    def LinearProgressProps(value: PartialLinearProgressProps): this.type = set("LinearProgressProps", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def backButton(value: VdomNode): this.type = set("backButton", value.rawNode.asInstanceOf[js.Any])
    
    @scala.inline
    def backButtonNull: this.type = set("backButton", null)
    
    @scala.inline
    def backButtonVarargs(value: (Empty | String | JsNumber | Element)*): this.type = set("backButton", js.Array(value :_*))
    
    @scala.inline
    def backButtonVdomElement(value: VdomElement): this.type = set("backButton", value.rawElement.asInstanceOf[js.Any])
    
    @scala.inline
    def className(value: String): this.type = set("className", value.asInstanceOf[js.Any])
    
    @scala.inline
    def classes(value: PartialMobileStepperClasses): this.type = set("classes", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def nextButton(value: VdomNode): this.type = set("nextButton", value.rawNode.asInstanceOf[js.Any])
    
    @scala.inline
    def nextButtonNull: this.type = set("nextButton", null)
    
    @scala.inline
    def nextButtonVarargs(value: (Empty | String | JsNumber | Element)*): this.type = set("nextButton", js.Array(value :_*))
    
    @scala.inline
    def nextButtonVdomElement(value: VdomElement): this.type = set("nextButton", value.rawElement.asInstanceOf[js.Any])
    ...
    @scala.inline
    def position(value: bottom | top | static): this.type = set("position", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def variant(value: text | dots | progress): this.type = set("variant", value.asInstanceOf[js.Any])
    
    @scala.inline
    def vocab(value: String): this.type = set("vocab", value.asInstanceOf[js.Any])
  }
  
  def withProps(p: MobileStepperProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
