...
object Collapse {
  ...
  class Builder (val args: js.Array[Any])
    ...
    @scala.inline
    def classes(value: PartialCollapseClasses): this.type = set("classes", value.asInstanceOf[js.Any])
    
    @scala.inline
    def collapsedSize(value: String | Double): this.type = set("collapsedSize", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def timeout(value: Any | auto): this.type = set("timeout", value.asInstanceOf[js.Any])
