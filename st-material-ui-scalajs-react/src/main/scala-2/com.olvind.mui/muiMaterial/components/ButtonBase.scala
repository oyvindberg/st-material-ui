...
import com.olvind.mui.muiMaterial.anon.PartialButtonBaseClasses
...
object ButtonBase {
  ...
  object href {
    ...
    def apply(href: String): Builder = {
      ...
      new Builder(js.Array(this.component, __props.asInstanceOf[OverridePropsExtendButtonBaseTypeMapButtAbout]))
    }
    ...
    class Builder (val args: js.Array[Any]) extends StBuildingComponent[HTMLAnchorElement] {
      ...
      @scala.inline
      def classes(value: PartialButtonBaseClasses): this.type = set("classes", value.asInstanceOf[js.Any])
    ...
    def withProps(p: OverridePropsExtendButtonBaseTypeMapButtAbout): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  ...
  object normal {
    ...
    def withProps(p: DefaultComponentPropsExtendButtonBaseTypAction): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
}
