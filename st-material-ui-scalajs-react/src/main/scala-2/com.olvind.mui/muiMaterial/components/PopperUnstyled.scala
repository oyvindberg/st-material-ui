...
object PopperUnstyled {
  ...
  @JSImport("@mui/material", "PopperUnstyled")
  @js.native
  ...
  class Builder (val args: js.Array[Any]) extends StBuildingComponent[HTMLDivElement] {
    ...
    @scala.inline
    def children(value: Node | (js.Function1[/* props */ Placement, Node])): this.type = set("children", value.asInstanceOf[js.Any])
    
    @scala.inline
    def childrenFunction1(value: /* props */ Placement => Node): this.type = set("children", js.Any.fromFunction1(value))
    
    @scala.inline
    def childrenNull: this.type = set("children", null)
    
    @scala.inline
    def childrenVarargs(value: (Empty | String | JsNumber | Element)*): this.type = set("children", js.Array(value :_*))
    
    @scala.inline
    def childrenVdomElement(value: VdomElement): this.type = set("children", value.rawElement.asInstanceOf[js.Any])
    ...
    @scala.inline
    def placement(value: PopperPlacementType): this.type = set("placement", value.asInstanceOf[js.Any])
    
    @scala.inline
    def popperOptions(value: js.Object): this.type = set("popperOptions", value.asInstanceOf[js.Any])
