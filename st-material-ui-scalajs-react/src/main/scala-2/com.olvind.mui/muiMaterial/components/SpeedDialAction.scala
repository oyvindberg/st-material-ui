...
object SpeedDialAction {
  ...
  class Builder (val args: js.Array[Any])
    ...
    @scala.inline
    def TooltipClasses(value: PartialTooltipClasses): this.type = set("TooltipClasses", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def classes(value: PartialSpeedDialActionClasses): this.type = set("classes", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def title(value: Element | String | Double | Any | ReactPortal | Boolean): this.type = set("title", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def tooltipPlacement(
      value: `bottom-end` | `bottom-start` | bottom | `left-end` | `left-start` | left | `right-end` | `right-start` | right | `top-end` | `top-start` | top
    ): this.type = set("tooltipPlacement", value.asInstanceOf[js.Any])
    
    @scala.inline
    def tooltipTitle(value: VdomNode): this.type = set("tooltipTitle", value.rawNode.asInstanceOf[js.Any])
    
    @scala.inline
    def tooltipTitleNull: this.type = set("tooltipTitle", null)
    
    @scala.inline
    def tooltipTitleVarargs(value: (Empty | String | JsNumber | Element)*): this.type = set("tooltipTitle", js.Array(value :_*))
    
    @scala.inline
    def tooltipTitleVdomElement(value: VdomElement): this.type = set("tooltipTitle", value.rawElement.asInstanceOf[js.Any])
