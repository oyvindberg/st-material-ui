...
import com.olvind.mui.muiMaterial.anon.PartialCardHeaderClasses
import com.olvind.mui.muiMaterial.anon.TypographyPropsspan
...
object CardHeader {
  ...
  class Builder (val args: js.Array[Any]) extends StBuildingComponent[HTMLDivElement] {
    ...
    @scala.inline
    def action(value: VdomNode): this.type = set("action", value.rawNode.asInstanceOf[js.Any])
    
    @scala.inline
    def actionNull: this.type = set("action", null)
    
    @scala.inline
    def actionVarargs(value: (Empty | String | JsNumber | Element)*): this.type = set("action", js.Array(value :_*))
    
    @scala.inline
    def actionVdomElement(value: VdomElement): this.type = set("action", value.rawElement.asInstanceOf[js.Any])
    ...
    @scala.inline
    def avatar(value: VdomNode): this.type = set("avatar", value.rawNode.asInstanceOf[js.Any])
    
    @scala.inline
    def avatarNull: this.type = set("avatar", null)
    
    @scala.inline
    def avatarVarargs(value: (Empty | String | JsNumber | Element)*): this.type = set("avatar", js.Array(value :_*))
    
    @scala.inline
    def avatarVdomElement(value: VdomElement): this.type = set("avatar", value.rawElement.asInstanceOf[js.Any])
    
    @scala.inline
    def className(value: String): this.type = set("className", value.asInstanceOf[js.Any])
    
    @scala.inline
    def classes(value: PartialCardHeaderClasses): this.type = set("classes", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def subheaderTypographyProps(value: TypographyPropsspan): this.type = set("subheaderTypographyProps", value.asInstanceOf[js.Any])
    
    @scala.inline
    def subheaderVarargs(value: (Empty | String | JsNumber | Element)*): this.type = set("subheader", js.Array(value :_*))
    ...
    @scala.inline
    def title(value: VdomNode): this.type = set("title", value.rawNode.asInstanceOf[js.Any])
    
    @scala.inline
    def titleNull: this.type = set("title", null)
    
    @scala.inline
    def titleTypographyProps(value: TypographyPropsspan): this.type = set("titleTypographyProps", value.asInstanceOf[js.Any])
  ...
  def withProps(p: /* props */ DefaultComponentPropsCardHeaderTypeMapdi): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
