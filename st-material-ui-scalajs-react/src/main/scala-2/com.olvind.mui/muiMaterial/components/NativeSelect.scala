...
import com.olvind.mui.muiMaterial.anon.PartialNativeSelectClasses
import com.olvind.mui.muiMaterial.anon.PartialNativeSelectInputProps
...
object NativeSelect {
  ...
  class Builder (val args: js.Array[Any])
    ...
    @scala.inline
    def classes(value: PartialNativeSelectClasses): this.type = set("classes", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def inputProps(value: PartialNativeSelectInputProps): this.type = set("inputProps", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def onChange(value: ReactEventFrom[HTMLSelectElement with org.scalajs.dom.Element] => Callback): this.type = set("onChange", js.Any.fromFunction1((t0: ReactEventFrom[HTMLSelectElement with org.scalajs.dom.Element]) => value(t0).runNow()))
