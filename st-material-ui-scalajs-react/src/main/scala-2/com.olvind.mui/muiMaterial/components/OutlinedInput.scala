...
object OutlinedInput {
  ...
  class Builder (val args: js.Array[Any])
    ...
    @scala.inline
    def classes(value: PartialOutlinedInputClasses): this.type = set("classes", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def notched(value: Boolean): this.type = set("notched", value.asInstanceOf[js.Any])
