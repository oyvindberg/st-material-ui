...
import com.olvind.mui.muiMaterial.anon.`14`
...
object ListItem {
  ...
  object href {
    ...
    class Builder (val args: js.Array[Any]) extends StBuildingComponent[HTMLAnchorElement] {
      ...
      @scala.inline
      def ContainerComponent(value: ElementType): this.type = set("ContainerComponent", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def alignItems(value: `flex-start` | center): this.type = set("alignItems", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def classes(value: PartialListItemClasses): this.type = set("classes", value.asInstanceOf[js.Any])
      
      @scala.inline
      def color(value: String): this.type = set("color", value.asInstanceOf[js.Any])
      
      @scala.inline
      def components(value: `14`): this.type = set("components", value.asInstanceOf[js.Any])
      
      @scala.inline
      def componentsProps(value: `15`): this.type = set("componentsProps", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def secondaryAction(value: VdomNode): this.type = set("secondaryAction", value.rawNode.asInstanceOf[js.Any])
      
      @scala.inline
      def secondaryActionNull: this.type = set("secondaryAction", null)
      
      @scala.inline
      def secondaryActionVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): this.type = set("secondaryAction", js.Array(value :_*))
      
      @scala.inline
      def secondaryActionVdomElement(value: VdomElement): this.type = set("secondaryAction", value.rawElement.asInstanceOf[js.Any])
