...
object Snackbar {
  ...
  class Builder (val args: js.Array[Any])
    ...
    @scala.inline
    def ClickAwayListenerProps(value: PartialClickAwayListenerProps): this.type = set("ClickAwayListenerProps", value.asInstanceOf[js.Any])
    
    @scala.inline
    def ContentProps(value: PartialSnackbarContentProps): this.type = set("ContentProps", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def autoHideDurationNull: this.type = set("autoHideDuration", null)
    ...
    @scala.inline
    def classes(value: PartialSnackbarClasses): this.type = set("classes", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def message(value: VdomNode): this.type = set("message", value.rawNode.asInstanceOf[js.Any])
    
    @scala.inline
    def messageNull: this.type = set("message", null)
    
    @scala.inline
    def messageVarargs(value: (Empty | String | JsNumber | Element)*): this.type = set("message", js.Array(value :_*))
    
    @scala.inline
    def messageVdomElement(value: VdomElement): this.type = set("message", value.rawElement.asInstanceOf[js.Any])
    ...
    ): this.type = set("onClose", js.Any.fromFunction2((t0: /* event */ (ReactEventFrom[Any with org.scalajs.dom.Element]) | Event, t1: /* reason */ SnackbarCloseReason) => (value(t0, t1)).runNow()))
