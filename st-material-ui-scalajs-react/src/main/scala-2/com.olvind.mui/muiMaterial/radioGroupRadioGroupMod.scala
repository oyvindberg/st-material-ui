...
object radioGroupRadioGroupMod {
  ...
  @JSImport("@mui/material/RadioGroup/RadioGroup", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @scala.inline
  def default(props: RadioGroupProps): Element = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(props.asInstanceOf[js.Any]).asInstanceOf[Element]
  
  type RadioGroupClassKey = /* keyof std.NonNullable<@mui/material.anon.PartialFormGroupClasses | undefined> */ String
  
  /* Inlined parent std.Omit<@mui/material.@mui/material/FormGroup.FormGroupProps, 'onChange'> */
  @js.native
  trait RadioGroupProps extends StObject {
    ...
    var classes: js.UndefOr[PartialFormGroupClasses] = js.native
  ...
  object RadioGroupProps {
    ...
    implicit class RadioGroupPropsMutableBuilder[Self <: RadioGroupProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClasses(value: PartialFormGroupClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setOnChange(value: (/* event */ ReactEventFrom[HTMLInputElement], /* value */ String) => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction2((t0: /* event */ ReactEventFrom[HTMLInputElement], t1: /* value */ String) => (value(t0, t1)).runNow()))
