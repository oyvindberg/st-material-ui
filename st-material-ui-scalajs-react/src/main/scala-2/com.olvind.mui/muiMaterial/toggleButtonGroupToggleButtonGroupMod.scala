...
object toggleButtonGroupToggleButtonGroupMod {
  ...
  @scala.inline
  def default(props: ToggleButtonGroupProps): Element = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(props.asInstanceOf[js.Any]).asInstanceOf[Element]
  ...
  trait ToggleButtonGroupProps extends StObject {
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialToggleButtonGroupClasses] = js.native
  ...
  object ToggleButtonGroupProps {
    ...
    implicit class ToggleButtonGroupPropsMutableBuilder[Self <: ToggleButtonGroupProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClasses(value: PartialToggleButtonGroupClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setOnChange(value: (/* event */ ReactMouseEventFrom[HTMLElement], /* value */ Any) => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction2((t0: /* event */ ReactMouseEventFrom[HTMLElement], t1: /* value */ Any) => (value(t0, t1)).runNow()))
