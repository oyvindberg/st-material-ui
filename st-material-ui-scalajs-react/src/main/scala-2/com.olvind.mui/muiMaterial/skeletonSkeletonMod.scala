...
object skeletonSkeletonMod extends Shortcut {
  ...
  object SkeletonTypeMap {
    ...
    @scala.inline
    def apply[P, D /* <: ElementType */](defaultComponent: D, props: P with Animation): SkeletonTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[SkeletonTypeMap[P, D]]
    }
    
    @scala.inline
    implicit class SkeletonTypeMapMutableBuilder[Self <: SkeletonTypeMap[_, _], P, D /* <: ElementType */] (val x: Self with (SkeletonTypeMap[P, D])) extends AnyVal {
