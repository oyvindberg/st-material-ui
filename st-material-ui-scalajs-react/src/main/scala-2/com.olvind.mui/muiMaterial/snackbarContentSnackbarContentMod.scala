...
import com.olvind.mui.muiMaterial.anon.PartialSnackbarContentClasses
...
object snackbarContentSnackbarContentMod {
  ...
  @JSImport("@mui/material/SnackbarContent/SnackbarContent", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @scala.inline
  def default(props: SnackbarContentProps): Element = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(props.asInstanceOf[js.Any]).asInstanceOf[Element]
  
  /* Inlined parent @mui/material.@mui/material.InternalStandardProps<@mui/material.@mui/material/Paper.PaperProps<@mui/material.@mui/material/Paper/Paper.PaperTypeMap<{}, 'div'>['defaultComponent'], {}>, 'children'> */
  @js.native
  trait SnackbarContentProps extends StObject {
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialSnackbarContentClasses] = js.native
  ...
  object SnackbarContentProps {
    ...
    implicit class SnackbarContentPropsMutableBuilder[Self <: SnackbarContentProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClasses(value: PartialSnackbarContentClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
