...
object tooltipTooltipMod {
  ...
  @JSImport("@mui/material/Tooltip/Tooltip", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @scala.inline
  def default(props: TooltipProps): Element = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(props.asInstanceOf[js.Any]).asInstanceOf[Element]
  
  @js.native
  trait TooltipComponentsPropsOverrides extends StObject
  
  /* Inlined parent @mui/material.@mui/material.InternalStandardProps<react.react.HTMLAttributes<std.HTMLDivElement>, 'title'> */
  @js.native
  trait TooltipProps extends StObject {
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialTooltipClasses] = js.native
    ...
    /**
      ...
      */
    var title: japgolly.scalajs.react.facade.React.Element | String | Double | Any | ReactPortal | Boolean = js.native
  ...
  object TooltipProps {
    ...
    implicit class TooltipPropsMutableBuilder[Self <: TooltipProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClasses(value: PartialTooltipClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
