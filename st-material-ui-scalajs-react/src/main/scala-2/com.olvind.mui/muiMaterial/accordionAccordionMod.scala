...
import com.olvind.mui.muiMaterial.anon.PartialAccordionClasses
import com.olvind.mui.muiMaterial.anon.TransitionProps
...
object accordionAccordionMod {
  ...
  @JSImport("@mui/material/Accordion/Accordion", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @scala.inline
  def default(props: AccordionProps): Element = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(props.asInstanceOf[js.Any]).asInstanceOf[Element]
  
  /* Inlined parent @mui/material.@mui/material.InternalStandardProps<@mui/material.@mui/material/Paper.PaperProps<@mui/material.@mui/material/Paper/Paper.PaperTypeMap<{}, 'div'>['defaultComponent'], {}>, 'onChange'> */
  @js.native
  trait AccordionProps extends StObject {
    ...
    /**
      ...
      */
    var children: japgolly.scalajs.react.facade.React.Element | String | Double | Any | ReactPortal | Boolean = js.native
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialAccordionClasses] = js.native
    ...
    var onChange: js.UndefOr[
        js.Function2[/* event */ ReactEventFrom[org.scalajs.dom.Element], /* expanded */ Boolean, Unit]
      ] = js.native
    ...
    var variant: js.UndefOr[elevation | outlined] = js.native
  ...
  object AccordionProps {
    ...
    @scala.inline
    def apply(
      children: japgolly.scalajs.react.facade.React.Element | String | Double | Any | ReactPortal | Boolean
    ): AccordionProps = {
    ...
    implicit class AccordionPropsMutableBuilder[Self <: AccordionProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setChildren(value: japgolly.scalajs.react.facade.React.Element | String | Double | Any | ReactPortal | Boolean): Self = StObject.set(x, "children", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setClasses(value: PartialAccordionClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setOnChange(value: (/* event */ ReactEventFrom[org.scalajs.dom.Element], /* expanded */ Boolean) => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction2((t0: /* event */ ReactEventFrom[org.scalajs.dom.Element], t1: /* expanded */ Boolean) => (value(t0, t1)).runNow()))
      ...
      @scala.inline
      def setVariant(value: elevation | outlined): Self = StObject.set(x, "variant", value.asInstanceOf[js.Any])
