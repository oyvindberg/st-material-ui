...
object gridGridMod extends Shortcut {
  ...
  */
  ...
  object GridTypeMap {
    ...
    @scala.inline
    def apply[P, D /* <: ElementType */](defaultComponent: D, props: P with SystemProps[Theme] with ColumnSpacing): GridTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[GridTypeMap[P, D]]
    }
    
    @scala.inline
    implicit class GridTypeMapMutableBuilder[Self <: GridTypeMap[_, _], P, D /* <: ElementType */] (val x: Self with (GridTypeMap[P, D])) extends AnyVal {
