...
object paperPaperMod extends Shortcut {
  ...
  object PaperTypeMap {
    ...
    @scala.inline
    def apply[P, D /* <: ElementType */](defaultComponent: D, props: P with Elevation): PaperTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[PaperTypeMap[P, D]]
    }
    
    @scala.inline
    implicit class PaperTypeMapMutableBuilder[Self <: PaperTypeMap[_, _], P, D /* <: ElementType */] (val x: Self with (PaperTypeMap[P, D])) extends AnyVal {
