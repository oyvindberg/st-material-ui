...
object listItemTextListItemTextMod {
  
  @JSImport("@mui/material/ListItemText/ListItemText", JSImport.Namespace)
  @js.native
  ...
  @js.native
  trait ListItemTextProps[PrimaryTypographyComponent /* <: ElementType */, SecondaryTypographyComponent /* <: ElementType */] extends StObject {
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialListItemTextClasses] = js.native
    ...
    /**
      ...
      */
    var primary: js.UndefOr[Node] = js.native
    
    /**
      * These props will be forwarded to the primary typography component
      * (as long as disableTypography is not `true`).
      */
    var primaryTypographyProps: js.UndefOr[TypographyProps[PrimaryTypographyComponent, `18`[PrimaryTypographyComponent]]] = js.native
    ...
    /**
      ...
      */
    var secondary: js.UndefOr[Node] = js.native
  ...
  object ListItemTextProps {
    ...
    @scala.inline
    def apply[PrimaryTypographyComponent /* <: ElementType */, SecondaryTypographyComponent /* <: ElementType */](): ListItemTextProps[PrimaryTypographyComponent, SecondaryTypographyComponent] = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[ListItemTextProps[PrimaryTypographyComponent, SecondaryTypographyComponent]]
    }
    
    @scala.inline
    implicit class ListItemTextPropsMutableBuilder[Self <: ListItemTextProps[_, _], PrimaryTypographyComponent /* <: ElementType */, SecondaryTypographyComponent /* <: ElementType */] (val x: Self with (ListItemTextProps[PrimaryTypographyComponent, SecondaryTypographyComponent])) extends AnyVal {
      ...
      @scala.inline
      def setClasses(value: PartialListItemTextClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setPrimary(value: VdomNode): Self = StObject.set(x, "primary", value.rawNode.asInstanceOf[js.Any])
      
      @scala.inline
      def setPrimaryNull: Self = StObject.set(x, "primary", null)
      
      @scala.inline
      def setPrimaryTypographyProps(value: TypographyProps[PrimaryTypographyComponent, `18`[PrimaryTypographyComponent]]): Self = StObject.set(x, "primaryTypographyProps", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setPrimaryVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): Self = StObject.set(x, "primary", js.Array(value :_*))
      
      @scala.inline
      def setPrimaryVdomElement(value: VdomElement): Self = StObject.set(x, "primary", value.rawElement.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setSecondary(value: VdomNode): Self = StObject.set(x, "secondary", value.rawNode.asInstanceOf[js.Any])
      
      @scala.inline
      def setSecondaryNull: Self = StObject.set(x, "secondary", null)
      
      @scala.inline
      def setSecondaryTypographyProps(value: TypographyProps[SecondaryTypographyComponent, `19`[SecondaryTypographyComponent]]): Self = StObject.set(x, "secondaryTypographyProps", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setSecondaryVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): Self = StObject.set(x, "secondary", js.Array(value :_*))
      
      @scala.inline
      def setSecondaryVdomElement(value: VdomElement): Self = StObject.set(x, "secondary", value.rawElement.asInstanceOf[js.Any])
