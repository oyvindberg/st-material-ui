...
import com.olvind.mui.muiMaterial.anon.PartialImageListItemBarClasses
...
import com.olvind.mui.muiMaterial.muiMaterialStrings.below
...
object imageListItemBarImageListItemBarMod {
  ...
  @JSImport("@mui/material/ImageListItemBar/ImageListItemBar", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @scala.inline
  def default(props: ImageListItemBarProps): Element = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(props.asInstanceOf[js.Any]).asInstanceOf[Element]
  ...
  trait ImageListItemBarProps extends StObject {
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialImageListItemBarClasses] = js.native
    ...
    /**
      ...
      * @default 'bottom'
      */
    var position: js.UndefOr[below | top | bottom] = js.native
  ...
  object ImageListItemBarProps {
    ...
    @scala.inline
    def apply(): ImageListItemBarProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[ImageListItemBarProps]
    }
    
    @scala.inline
    implicit class ImageListItemBarPropsMutableBuilder[Self <: ImageListItemBarProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setActionIcon(value: VdomNode): Self = StObject.set(x, "actionIcon", value.rawNode.asInstanceOf[js.Any])
      
      @scala.inline
      def setActionIconNull: Self = StObject.set(x, "actionIcon", null)
      
      @scala.inline
      def setActionIconUndefined: Self = StObject.set(x, "actionIcon", js.undefined)
      
      @scala.inline
      def setActionIconVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): Self = StObject.set(x, "actionIcon", js.Array(value :_*))
      
      @scala.inline
      def setActionIconVdomElement(value: VdomElement): Self = StObject.set(x, "actionIcon", value.rawElement.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setClasses(value: PartialImageListItemBarClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setPosition(value: below | top | bottom): Self = StObject.set(x, "position", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setSubtitle(value: VdomNode): Self = StObject.set(x, "subtitle", value.rawNode.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setSubtitleVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): Self = StObject.set(x, "subtitle", js.Array(value :_*))
      
      @scala.inline
      def setSubtitleVdomElement(value: VdomElement): Self = StObject.set(x, "subtitle", value.rawElement.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setTitleVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): Self = StObject.set(x, "title", js.Array(value :_*))
