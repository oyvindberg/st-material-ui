...
object buttonGroupButtonGroupMod extends Shortcut {
  ...
  object ButtonGroupTypeMap {
    ...
    @scala.inline
    def apply[P, D /* <: ElementType */](defaultComponent: D, props: P with DisableFocusRipple): ButtonGroupTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[ButtonGroupTypeMap[P, D]]
    }
    
    @scala.inline
    implicit class ButtonGroupTypeMapMutableBuilder[Self <: ButtonGroupTypeMap[_, _], P, D /* <: ElementType */] (val x: Self with (ButtonGroupTypeMap[P, D])) extends AnyVal {
