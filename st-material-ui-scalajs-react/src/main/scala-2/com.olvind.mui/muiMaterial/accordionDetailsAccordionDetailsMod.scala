...
object accordionDetailsAccordionDetailsMod {
  
  @JSImport("@mui/material/AccordionDetails/AccordionDetails", JSImport.Namespace)
  @js.native
  ...
  @js.native
  trait AccordionDetailsProps extends StObject {
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialAccordionDetailsClasses] = js.native
  ...
  object AccordionDetailsProps {
    
    @scala.inline
    def apply(): AccordionDetailsProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[AccordionDetailsProps]
    }
    
    @scala.inline
    implicit class AccordionDetailsPropsMutableBuilder[Self <: AccordionDetailsProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClasses(value: PartialAccordionDetailsClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
