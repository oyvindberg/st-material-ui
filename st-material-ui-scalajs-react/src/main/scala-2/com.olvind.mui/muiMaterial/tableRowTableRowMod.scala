...
object tableRowTableRowMod extends Shortcut {
  ...
  object TableRowTypeMap {
    ...
    @scala.inline
    def apply[P, D /* <: ElementType */](defaultComponent: D, props: P with Hover): TableRowTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[TableRowTypeMap[P, D]]
    }
    
    @scala.inline
    implicit class TableRowTypeMapMutableBuilder[Self <: TableRowTypeMap[_, _], P, D /* <: ElementType */] (val x: Self with (TableRowTypeMap[P, D])) extends AnyVal {
