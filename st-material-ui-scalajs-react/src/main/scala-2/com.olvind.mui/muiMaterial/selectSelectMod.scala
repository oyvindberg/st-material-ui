...
object selectSelectMod {
  ...
  trait SelectProps[T] extends StObject {
    ...
    /**
      ...
      */
    var onChange: js.UndefOr[js.Function2[/* event */ SelectChangeEvent[T], /* child */ Node, Unit]] = js.native
    ...
    /**
      ...
      * @returns {ReactNode}
      */
    var renderValue: js.UndefOr[js.Function1[/* value */ T, Node]] = js.native
  ...
  object SelectProps {
    ...
    implicit class SelectPropsMutableBuilder[Self <: SelectProps[_], T] (val x: Self with SelectProps[T]) extends AnyVal {
      ...
      @scala.inline
      def setOnChange(value: (/* event */ SelectChangeEvent[T], /* child */ Node) => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction2((t0: /* event */ SelectChangeEvent[T], t1: /* child */ Node) => (value(t0, t1)).runNow()))
      ...
      @scala.inline
      def setRenderValue(value: /* value */ T => Node): Self = StObject.set(x, "renderValue", js.Any.fromFunction1(value))
