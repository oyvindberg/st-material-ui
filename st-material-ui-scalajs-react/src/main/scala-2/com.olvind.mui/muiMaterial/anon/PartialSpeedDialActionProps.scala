...
/* Inlined std.Partial<@mui/material.@mui/material/SpeedDialAction.SpeedDialActionProps> */
@js.native
trait PartialSpeedDialActionProps extends StObject {
  
  var FabProps: js.UndefOr[PartialFabPropsdefaultComponent] = js.native
  ...
  var onClose: js.UndefOr[js.Function1[/* event */ ReactEventFrom[Element] | Event, Unit]] = js.native
  ...
  var tooltipTitle: js.UndefOr[japgolly.scalajs.react.facade.React.Node] = js.native
...
object PartialSpeedDialActionProps {
  
  @scala.inline
  def apply(): PartialSpeedDialActionProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialSpeedDialActionProps]
  }
  
  @scala.inline
  implicit class PartialSpeedDialActionPropsMutableBuilder[Self <: PartialSpeedDialActionProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFabProps(value: PartialFabPropsdefaultComponent): Self = StObject.set(x, "FabProps", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnClose(value: /* event */ ReactEventFrom[Element] | Event => Callback): Self = StObject.set(x, "onClose", js.Any.fromFunction1((t0: /* event */ ReactEventFrom[Element] | Event) => value(t0).runNow()))
    ...
    @scala.inline
    def setTransitionProps(value: com.olvind.mui.muiMaterial.transitionMod.TransitionProps): Self = StObject.set(x, "TransitionProps", value.asInstanceOf[js.Any])
