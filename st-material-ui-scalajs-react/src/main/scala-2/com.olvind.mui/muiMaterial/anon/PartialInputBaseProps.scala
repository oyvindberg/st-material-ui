...
/* Inlined std.Partial<@mui/material.@mui/material/InputBase.InputBaseProps> */
@js.native
trait PartialInputBaseProps extends StObject {
...
object PartialInputBaseProps {
  
  @scala.inline
  def apply(): PartialInputBaseProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialInputBaseProps]
  }
  
  @scala.inline
  implicit class PartialInputBasePropsMutableBuilder[Self <: PartialInputBaseProps] (val x: Self) extends AnyVal {
