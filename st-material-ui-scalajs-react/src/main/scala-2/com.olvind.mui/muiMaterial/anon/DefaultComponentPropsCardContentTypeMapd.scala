...
/* Inlined DefaultComponentProps<CardContentTypeMap<{}, 'div'>> & { readonly component :string | undefined} */
@js.native
trait DefaultComponentPropsCardContentTypeMapd extends StObject {
...
object DefaultComponentPropsCardContentTypeMapd {
  
  @scala.inline
  def apply(): DefaultComponentPropsCardContentTypeMapd = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsCardContentTypeMapd]
  }
  
  @scala.inline
  implicit class DefaultComponentPropsCardContentTypeMapdMutableBuilder[Self <: DefaultComponentPropsCardContentTypeMapd] (val x: Self) extends AnyVal {
