...
/* Inlined std.Partial<IconButtonProps<{}['defaultComponent'], {}>> */
@js.native
trait PartialIconButtonPropsdefaultComponent extends StObject {
...
object PartialIconButtonPropsdefaultComponent {
  
  @scala.inline
  def apply(): PartialIconButtonPropsdefaultComponent = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialIconButtonPropsdefaultComponent]
  }
  
  @scala.inline
  implicit class PartialIconButtonPropsdefaultComponentMutableBuilder[Self <: PartialIconButtonPropsdefaultComponent] (val x: Self) extends AnyVal {
