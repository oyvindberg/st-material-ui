...
/* Inlined @mui/material.@mui/material/Card.CardProps<@mui/material.@mui/material/Card/Card.CardTypeMap<{}, 'div'>['defaultComponent'], {}> */
@js.native
trait CardPropsCardTypeMapdivdefaultComponent extends StObject {
  ...
  /**
    * Override or extend the styles applied to the component.
    */
  var classes: js.UndefOr[PartialCardClasses] = js.native
...
object CardPropsCardTypeMapdivdefaultComponent {
  
  @scala.inline
  def apply(): CardPropsCardTypeMapdivdefaultComponent = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CardPropsCardTypeMapdivdefaultComponent]
  }
  
  @scala.inline
  implicit class CardPropsCardTypeMapdivdefaultComponentMutableBuilder[Self <: CardPropsCardTypeMapdivdefaultComponent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialCardClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
