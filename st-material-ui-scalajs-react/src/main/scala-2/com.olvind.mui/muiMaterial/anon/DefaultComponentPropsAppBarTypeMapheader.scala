...
/* Inlined DefaultComponentProps<AppBarTypeMap<{}, 'header'>> & { readonly component :string | undefined} */
@js.native
trait DefaultComponentPropsAppBarTypeMapheader extends StObject {
...
object DefaultComponentPropsAppBarTypeMapheader {
  
  @scala.inline
  def apply(): DefaultComponentPropsAppBarTypeMapheader = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsAppBarTypeMapheader]
  }
  
  @scala.inline
  implicit class DefaultComponentPropsAppBarTypeMapheaderMutableBuilder[Self <: DefaultComponentPropsAppBarTypeMapheader] (val x: Self) extends AnyVal {
