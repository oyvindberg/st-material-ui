...
/* Inlined @mui/material.@mui/material/OverridableComponent.DefaultComponentProps<@mui/material.@mui/material/ButtonBase/ButtonBase.ExtendButtonBaseTypeMap<@mui/material.@mui/material/Tab/Tab.TabTypeMap<{}, 'div'>>> */
@js.native
trait DefaultComponentPropsExtendButtonBaseTypAriacolindex extends StObject {
...
object DefaultComponentPropsExtendButtonBaseTypAriacolindex {
  
  @scala.inline
  def apply(): DefaultComponentPropsExtendButtonBaseTypAriacolindex = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsExtendButtonBaseTypAriacolindex]
  }
  
  @scala.inline
  implicit class DefaultComponentPropsExtendButtonBaseTypAriacolindexMutableBuilder[Self <: DefaultComponentPropsExtendButtonBaseTypAriacolindex] (val x: Self) extends AnyVal {
