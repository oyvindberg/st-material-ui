...
/* Inlined @mui/material.@mui/material/DialogContentText.DialogContentTextProps<@mui/material.@mui/material/DialogContentText/DialogContentText.DialogContentTextTypeMap<{}, @mui/material.@mui/material/Typography.TypographyTypeMap<{}, 'span'>['defaultComponent']>['defaultComponent'], {}> */
@js.native
trait DialogContentTextPropsDialogContentTextT extends StObject {
  ...
  /**
    * Override or extend the styles applied to the component.
    */
  var classes: js.UndefOr[PartialDialogContentTextClasses] = js.native
...
object DialogContentTextPropsDialogContentTextT {
  
  @scala.inline
  def apply(): DialogContentTextPropsDialogContentTextT = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DialogContentTextPropsDialogContentTextT]
  }
  
  @scala.inline
  implicit class DialogContentTextPropsDialogContentTextTMutableBuilder[Self <: DialogContentTextPropsDialogContentTextT] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialDialogContentTextClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
