...
/* Inlined @mui/material.@mui/material/OverridableComponent.DefaultComponentProps<@mui/material.@mui/material/ButtonBase/ButtonBase.ExtendButtonBaseTypeMap<@mui/material.@mui/material/StepButton/StepButton.StepButtonTypeMap<{}, @mui/material.@mui/material/ButtonBase.ButtonBaseTypeMap<{}, 'button'>['defaultComponent']>>> */
@js.native
trait DefaultComponentPropsExtendButtonBaseTypAriacolcount extends StObject {
...
object DefaultComponentPropsExtendButtonBaseTypAriacolcount {
  
  @scala.inline
  def apply(): DefaultComponentPropsExtendButtonBaseTypAriacolcount = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsExtendButtonBaseTypAriacolcount]
  }
  
  @scala.inline
  implicit class DefaultComponentPropsExtendButtonBaseTypAriacolcountMutableBuilder[Self <: DefaultComponentPropsExtendButtonBaseTypAriacolcount] (val x: Self) extends AnyVal {
