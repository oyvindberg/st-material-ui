...
/* Inlined @mui/material.@mui/material/FormControl.FormControlProps<@mui/material.@mui/material/FormControl/FormControl.FormControlTypeMap<{}, 'div'>['defaultComponent'], {}> */
@js.native
trait FormControlPropsFormControlTypeMapdivdef extends StObject {
  ...
  /**
    * Override or extend the styles applied to the component.
    */
  var classes: js.UndefOr[PartialFormControlClasses] = js.native
...
object FormControlPropsFormControlTypeMapdivdef {
  
  @scala.inline
  def apply(): FormControlPropsFormControlTypeMapdivdef = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[FormControlPropsFormControlTypeMapdivdef]
  }
  
  @scala.inline
  implicit class FormControlPropsFormControlTypeMapdivdefMutableBuilder[Self <: FormControlPropsFormControlTypeMapdivdef] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialFormControlClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
