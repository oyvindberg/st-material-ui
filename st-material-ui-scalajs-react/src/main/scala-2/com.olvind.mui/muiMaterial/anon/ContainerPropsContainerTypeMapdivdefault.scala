...
/* Inlined @mui/material.@mui/material/Container.ContainerProps<@mui/material.@mui/material/Container/Container.ContainerTypeMap<{}, 'div'>['defaultComponent'], {}> */
@js.native
trait ContainerPropsContainerTypeMapdivdefault extends StObject {
...
object ContainerPropsContainerTypeMapdivdefault {
  
  @scala.inline
  def apply(): ContainerPropsContainerTypeMapdivdefault = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ContainerPropsContainerTypeMapdivdefault]
  }
  
  @scala.inline
  implicit class ContainerPropsContainerTypeMapdivdefaultMutableBuilder[Self <: ContainerPropsContainerTypeMapdivdefault] (val x: Self) extends AnyVal {
