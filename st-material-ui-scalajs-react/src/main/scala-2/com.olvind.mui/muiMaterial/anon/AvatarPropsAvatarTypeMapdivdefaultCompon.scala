...
/* Inlined @mui/material.@mui/material/Avatar.AvatarProps<@mui/material.@mui/material/Avatar/Avatar.AvatarTypeMap<{}, 'div'>['defaultComponent'], {}> */
@js.native
...
object AvatarPropsAvatarTypeMapdivdefaultCompon {
  ...
  @scala.inline
  def apply(): AvatarPropsAvatarTypeMapdivdefaultCompon = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AvatarPropsAvatarTypeMapdivdefaultCompon]
  }
  
  @scala.inline
  implicit class AvatarPropsAvatarTypeMapdivdefaultComponMutableBuilder[Self <: AvatarPropsAvatarTypeMapdivdefaultCompon] (val x: Self) extends AnyVal {
