...
/* Inlined std.Partial<@mui/material.@mui/material/DialogActions.DialogActionsProps> */
@js.native
trait PartialDialogActionsProps extends StObject {
...
object PartialDialogActionsProps {
  ...
  @scala.inline
  def apply(): PartialDialogActionsProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialDialogActionsProps]
  }
  
  @scala.inline
  implicit class PartialDialogActionsPropsMutableBuilder[Self <: PartialDialogActionsProps] (val x: Self) extends AnyVal {
