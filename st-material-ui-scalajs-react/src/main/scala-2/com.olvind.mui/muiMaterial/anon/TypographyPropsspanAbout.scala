...
/* Inlined @mui/material.@mui/material/Typography.TypographyProps<'span', {}> */
@js.native
trait TypographyPropsspanAbout extends StObject {
...
object TypographyPropsspanAbout {
  
  @scala.inline
  def apply(): TypographyPropsspanAbout = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TypographyPropsspanAbout]
  }
  
  @scala.inline
  implicit class TypographyPropsspanAboutMutableBuilder[Self <: TypographyPropsspanAbout] (val x: Self) extends AnyVal {
