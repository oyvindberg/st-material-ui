...
/* Inlined std.Partial<@mui/material.@mui/material/StepIcon.StepIconProps> */
@js.native
trait PartialStepIconProps extends StObject {
...
object PartialStepIconProps {
  ...
  @scala.inline
  def apply(): PartialStepIconProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialStepIconProps]
  }
  
  @scala.inline
  implicit class PartialStepIconPropsMutableBuilder[Self <: PartialStepIconProps] (val x: Self) extends AnyVal {
