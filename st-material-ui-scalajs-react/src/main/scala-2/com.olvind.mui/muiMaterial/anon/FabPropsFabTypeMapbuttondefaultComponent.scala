...
/* Inlined @mui/material.@mui/material/Fab.FabProps<@mui/material.@mui/material/Fab/Fab.FabTypeMap<{}, 'button'>['defaultComponent'], {}> */
@js.native
trait FabPropsFabTypeMapbuttondefaultComponent extends StObject {
...
object FabPropsFabTypeMapbuttondefaultComponent {
  
  @scala.inline
  def apply(): FabPropsFabTypeMapbuttondefaultComponent = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[FabPropsFabTypeMapbuttondefaultComponent]
  }
  
  @scala.inline
  implicit class FabPropsFabTypeMapbuttondefaultComponentMutableBuilder[Self <: FabPropsFabTypeMapbuttondefaultComponent] (val x: Self) extends AnyVal {
