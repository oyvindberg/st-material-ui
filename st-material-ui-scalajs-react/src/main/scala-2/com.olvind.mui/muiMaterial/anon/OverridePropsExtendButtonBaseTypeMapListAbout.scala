...
/* Inlined {  href :string} & OverrideProps<ExtendButtonBaseTypeMap<ListItemButtonTypeMap<{}, 'div'>>, 'a'> */
@js.native
trait OverridePropsExtendButtonBaseTypeMapListAbout extends StObject {
...
object OverridePropsExtendButtonBaseTypeMapListAbout {
  
  @scala.inline
  def apply(href: String): OverridePropsExtendButtonBaseTypeMapListAbout = {
    val __obj = js.Dynamic.literal(href = href.asInstanceOf[js.Any])
    __obj.asInstanceOf[OverridePropsExtendButtonBaseTypeMapListAbout]
  }
  
  @scala.inline
  implicit class OverridePropsExtendButtonBaseTypeMapListAboutMutableBuilder[Self <: OverridePropsExtendButtonBaseTypeMapListAbout] (val x: Self) extends AnyVal {
