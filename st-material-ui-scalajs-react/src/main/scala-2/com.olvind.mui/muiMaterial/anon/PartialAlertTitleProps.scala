...
/* Inlined std.Partial<@mui/material.@mui/material/AlertTitle.AlertTitleProps> */
@js.native
trait PartialAlertTitleProps extends StObject {
  ...
  var classes: js.UndefOr[PartialAlertTitleClasses] = js.native
...
object PartialAlertTitleProps {
  
  @scala.inline
  def apply(): PartialAlertTitleProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialAlertTitleProps]
  }
  
  @scala.inline
  implicit class PartialAlertTitlePropsMutableBuilder[Self <: PartialAlertTitleProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialAlertTitleClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
