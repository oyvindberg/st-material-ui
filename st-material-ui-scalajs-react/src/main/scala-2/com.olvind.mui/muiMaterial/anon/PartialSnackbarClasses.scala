...
/* Inlined std.Partial<@mui/material.@mui/material/Snackbar/snackbarClasses.SnackbarClasses> */
@js.native
trait PartialSnackbarClasses extends StObject {
...
object PartialSnackbarClasses {
  
  @scala.inline
  def apply(): PartialSnackbarClasses = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialSnackbarClasses]
  }
  
  @scala.inline
  implicit class PartialSnackbarClassesMutableBuilder[Self <: PartialSnackbarClasses] (val x: Self) extends AnyVal {
