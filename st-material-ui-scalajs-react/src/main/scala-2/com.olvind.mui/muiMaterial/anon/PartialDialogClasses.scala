...
/* Inlined std.Partial<@mui/material.@mui/material/Dialog/dialogClasses.DialogClasses> */
@js.native
trait PartialDialogClasses extends StObject {
  ...
  var paperWidthFalse: js.UndefOr[String] = js.native
...
object PartialDialogClasses {
  
  @scala.inline
  def apply(): PartialDialogClasses = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialDialogClasses]
  }
  
  @scala.inline
  implicit class PartialDialogClassesMutableBuilder[Self <: PartialDialogClasses] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPaperWidthFalseUndefined: Self = StObject.set(x, "paperWidthFalse", js.undefined)
