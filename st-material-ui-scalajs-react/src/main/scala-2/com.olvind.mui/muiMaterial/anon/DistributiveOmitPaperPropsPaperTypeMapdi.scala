...
/* Inlined @mui/types.@mui/types.DistributiveOmit<PaperProps<PaperTypeMap<{}, 'div'>['defaultComponent'], {}>, 'position' | 'color' | 'classes'> */
@js.native
trait DistributiveOmitPaperPropsPaperTypeMapdi extends StObject {
...
object DistributiveOmitPaperPropsPaperTypeMapdi {
  
  @scala.inline
  def apply(): DistributiveOmitPaperPropsPaperTypeMapdi = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DistributiveOmitPaperPropsPaperTypeMapdi]
  }
  
  @scala.inline
  implicit class DistributiveOmitPaperPropsPaperTypeMapdiMutableBuilder[Self <: DistributiveOmitPaperPropsPaperTypeMapdi] (val x: Self) extends AnyVal {
