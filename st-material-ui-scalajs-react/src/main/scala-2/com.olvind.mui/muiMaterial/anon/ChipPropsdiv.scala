...
/* Inlined @mui/material.@mui/material/Chip.ChipProps<'div', {}> */
@js.native
trait ChipPropsdiv extends StObject {
...
object ChipPropsdiv {
  ...
  @scala.inline
  def apply(): ChipPropsdiv = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ChipPropsdiv]
  }
  
  @scala.inline
  implicit class ChipPropsdivMutableBuilder[Self <: ChipPropsdiv] (val x: Self) extends AnyVal {
