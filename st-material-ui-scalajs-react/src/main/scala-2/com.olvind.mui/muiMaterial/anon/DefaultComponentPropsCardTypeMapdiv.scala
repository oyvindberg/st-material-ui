...
/* Inlined DefaultComponentProps<CardTypeMap<{}, 'div'>> & { readonly component :string | undefined} */
@js.native
trait DefaultComponentPropsCardTypeMapdiv extends StObject {
...
object DefaultComponentPropsCardTypeMapdiv {
  
  @scala.inline
  def apply(): DefaultComponentPropsCardTypeMapdiv = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsCardTypeMapdiv]
  }
  
  @scala.inline
  implicit class DefaultComponentPropsCardTypeMapdivMutableBuilder[Self <: DefaultComponentPropsCardTypeMapdiv] (val x: Self) extends AnyVal {
