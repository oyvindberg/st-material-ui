...
/* Inlined std.Partial<PaperProps<PaperTypeMap<{}, 'div'>['defaultComponent'], {}>> */
@js.native
trait PartialPaperPropsPaperTypeMapdivdefaultC extends StObject {
...
object PartialPaperPropsPaperTypeMapdivdefaultC {
  
  @scala.inline
  def apply(): PartialPaperPropsPaperTypeMapdivdefaultC = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialPaperPropsPaperTypeMapdivdefaultC]
  }
  
  @scala.inline
  implicit class PartialPaperPropsPaperTypeMapdivdefaultCMutableBuilder[Self <: PartialPaperPropsPaperTypeMapdivdefaultC] (val x: Self) extends AnyVal {
