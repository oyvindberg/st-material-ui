...
/* Inlined std.Partial<@mui/material.@mui/material/StepConnector/stepConnectorClasses.StepConnectorClasses> */
@js.native
trait PartialStepConnectorClasses extends StObject {
...
object PartialStepConnectorClasses {
  
  @scala.inline
  def apply(): PartialStepConnectorClasses = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialStepConnectorClasses]
  }
  
  @scala.inline
  implicit class PartialStepConnectorClassesMutableBuilder[Self <: PartialStepConnectorClasses] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLineHorizontalUndefined: Self = StObject.set(x, "lineHorizontal", js.undefined)
    ...
    @scala.inline
    def setLineVerticalUndefined: Self = StObject.set(x, "lineVertical", js.undefined)
