...
/* Inlined std.Partial<@mui/material.@mui/material/Stepper.StepperProps> */
@js.native
trait PartialStepperProps extends StObject {
  ...
  var connector: js.UndefOr[Element | Null] = js.native
...
object PartialStepperProps {
  
  @scala.inline
  def apply(): PartialStepperProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialStepperProps]
  }
  
  @scala.inline
  implicit class PartialStepperPropsMutableBuilder[Self <: PartialStepperProps] (val x: Self) extends AnyVal {
