...
/* Inlined std.Partial<PaginationItemProps<'div', {}>> */
@js.native
trait PartialPaginationItemPropsdiv extends StObject {
...
object PartialPaginationItemPropsdiv {
  
  @scala.inline
  def apply(): PartialPaginationItemPropsdiv = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialPaginationItemPropsdiv]
  }
  
  @scala.inline
  implicit class PartialPaginationItemPropsdivMutableBuilder[Self <: PartialPaginationItemPropsdiv] (val x: Self) extends AnyVal {
