...
/* Inlined std.Partial<@mui/material.@mui/material/ListItemText.ListItemTextProps<'span', 'p'>> */
@js.native
trait PartialListItemTextPropsspanp extends StObject {
  ...
  var primary: js.UndefOr[japgolly.scalajs.react.facade.React.Node] = js.native
  
  var primaryTypographyProps: js.UndefOr[TypographyPropsspan] = js.native
  ...
  var secondary: js.UndefOr[japgolly.scalajs.react.facade.React.Node] = js.native
  
  var secondaryTypographyProps: js.UndefOr[TypographyPropsp] = js.native
...
object PartialListItemTextPropsspanp {
  
  @scala.inline
  def apply(): PartialListItemTextPropsspanp = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialListItemTextPropsspanp]
  }
  
  @scala.inline
  implicit class PartialListItemTextPropsspanpMutableBuilder[Self <: PartialListItemTextPropsspanp] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPrimaryTypographyProps(value: TypographyPropsspan): Self = StObject.set(x, "primaryTypographyProps", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPrimaryVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "primary", js.Array(value :_*))
    ...
    @scala.inline
    def setSecondaryTypographyProps(value: TypographyPropsp): Self = StObject.set(x, "secondaryTypographyProps", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSecondaryVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "secondary", js.Array(value :_*))
