...
/* Inlined DefaultComponentProps<ChipTypeMap<{}, 'div'>> & { readonly component :string | undefined} */
@js.native
trait DefaultComponentPropsChipTypeMapdiv extends StObject {
...
object DefaultComponentPropsChipTypeMapdiv {
  
  @scala.inline
  def apply(): DefaultComponentPropsChipTypeMapdiv = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsChipTypeMapdiv]
  }
  
  @scala.inline
  implicit class DefaultComponentPropsChipTypeMapdivMutableBuilder[Self <: DefaultComponentPropsChipTypeMapdiv] (val x: Self) extends AnyVal {
