...
/* Inlined std.Partial<AvatarProps<'div', {}>> */
@js.native
trait PartialAvatarPropsdiv extends StObject {
...
object PartialAvatarPropsdiv {
  
  @scala.inline
  def apply(): PartialAvatarPropsdiv = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialAvatarPropsdiv]
  }
  
  @scala.inline
  implicit class PartialAvatarPropsdivMutableBuilder[Self <: PartialAvatarPropsdiv] (val x: Self) extends AnyVal {
