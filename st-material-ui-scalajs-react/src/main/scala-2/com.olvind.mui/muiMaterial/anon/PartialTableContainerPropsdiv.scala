...
/* Inlined std.Partial<TableContainerProps<'div', {}>> */
@js.native
trait PartialTableContainerPropsdiv extends StObject {
...
object PartialTableContainerPropsdiv {
  
  @scala.inline
  def apply(): PartialTableContainerPropsdiv = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialTableContainerPropsdiv]
  }
  
  @scala.inline
  implicit class PartialTableContainerPropsdivMutableBuilder[Self <: PartialTableContainerPropsdiv] (val x: Self) extends AnyVal {
