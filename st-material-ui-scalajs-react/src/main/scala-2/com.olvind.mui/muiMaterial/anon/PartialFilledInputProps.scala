...
/* Inlined std.Partial<@mui/material.@mui/material/FilledInput.FilledInputProps> */
@js.native
trait PartialFilledInputProps extends StObject {
...
object PartialFilledInputProps {
  ...
  @scala.inline
  implicit class PartialFilledInputPropsMutableBuilder[Self <: PartialFilledInputProps] (val x: Self) extends AnyVal {
