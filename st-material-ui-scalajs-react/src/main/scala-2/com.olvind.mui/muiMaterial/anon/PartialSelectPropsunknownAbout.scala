...
/* Inlined std.Partial<@mui/material.@mui/material/Select.SelectProps<unknown>> */
@js.native
trait PartialSelectPropsunknownAbout extends StObject {
  ...
  var endAdornment: js.UndefOr[japgolly.scalajs.react.facade.React.Node] = js.native
  ...
  var inputComponent: js.UndefOr[ElementType] = js.native
  ...
  var onClose: js.UndefOr[js.Function1[/* event */ ReactEventFrom[org.scalajs.dom.Element], Unit]] = js.native
  ...
  var renderSuffix: js.UndefOr[js.Function1[/* state */ Disabled, japgolly.scalajs.react.facade.React.Node]] = js.native
  
  var renderValue: js.UndefOr[js.Function1[/* value */ Any, japgolly.scalajs.react.facade.React.Node]] = js.native
  ...
  var startAdornment: js.UndefOr[japgolly.scalajs.react.facade.React.Node] = js.native
...
object PartialSelectPropsunknownAbout {
  
  @scala.inline
  def apply(): PartialSelectPropsunknownAbout = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialSelectPropsunknownAbout]
  }
  
  @scala.inline
  implicit class PartialSelectPropsunknownAboutMutableBuilder[Self <: PartialSelectPropsunknownAbout] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setInput(value: VdomElement): Self = StObject.set(x, "input", value.rawElement.asInstanceOf[js.Any])
    
    @scala.inline
    def setInputComponent(value: ElementType): Self = StObject.set(x, "inputComponent", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMenuProps(value: PartialMenuPropsAbout): Self = StObject.set(x, "MenuProps", value.asInstanceOf[js.Any])
    ...
    ): Self = StObject.set(x, "onChange", js.Any.fromFunction2((t0: /* event */ SelectChangeEvent[Any], t1: /* child */ japgolly.scalajs.react.facade.React.Node) => (value(t0, t1)).runNow()))
    ...
    @scala.inline
    def setOnClose(value: /* event */ ReactEventFrom[org.scalajs.dom.Element] => Callback): Self = StObject.set(x, "onClose", js.Any.fromFunction1((t0: /* event */ ReactEventFrom[org.scalajs.dom.Element]) => value(t0).runNow()))
    ...
    ): Self = StObject.set(x, "onKeyDown", js.Any.fromFunction1((t0: ReactKeyboardEventFrom[(HTMLTextAreaElement | HTMLInputElement) with org.scalajs.dom.Element]) => value(t0).runNow()))
    ...
    def setOnKeyUp(
      value: ReactKeyboardEventFrom[(HTMLTextAreaElement | HTMLInputElement) with org.scalajs.dom.Element] => Callback
    ): Self = StObject.set(x, "onKeyUp", js.Any.fromFunction1((t0: ReactKeyboardEventFrom[(HTMLTextAreaElement | HTMLInputElement) with org.scalajs.dom.Element]) => value(t0).runNow()))
    ...
    @scala.inline
    def setRenderSuffix(value: /* state */ Disabled => japgolly.scalajs.react.facade.React.Node): Self = StObject.set(x, "renderSuffix", js.Any.fromFunction1(value))
    
    @scala.inline
    def setRenderSuffixUndefined: Self = StObject.set(x, "renderSuffix", js.undefined)
    
    @scala.inline
    def setRenderValue(value: /* value */ Any => japgolly.scalajs.react.facade.React.Node): Self = StObject.set(x, "renderValue", js.Any.fromFunction1(value))
