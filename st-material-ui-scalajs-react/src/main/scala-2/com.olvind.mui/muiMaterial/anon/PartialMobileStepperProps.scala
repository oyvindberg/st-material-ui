...
/* Inlined std.Partial<@mui/material.@mui/material/MobileStepper.MobileStepperProps> */
@js.native
trait PartialMobileStepperProps extends StObject {
  ...
  var backButton: js.UndefOr[japgolly.scalajs.react.facade.React.Node] = js.native
  ...
  var nextButton: js.UndefOr[japgolly.scalajs.react.facade.React.Node] = js.native
...
object PartialMobileStepperProps {
  ...
  @scala.inline
  def apply(): PartialMobileStepperProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMobileStepperProps]
  }
  
  @scala.inline
  implicit class PartialMobileStepperPropsMutableBuilder[Self <: PartialMobileStepperProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBackButtonVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "backButton", js.Array(value :_*))
    ...
    @scala.inline
    def setNextButtonVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "nextButton", js.Array(value :_*))
