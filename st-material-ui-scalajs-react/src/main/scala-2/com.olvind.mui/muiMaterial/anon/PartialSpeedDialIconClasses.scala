...
object PartialSpeedDialIconClasses {
  ...
  @scala.inline
  def apply(): PartialSpeedDialIconClasses = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialSpeedDialIconClasses]
  }
  
  @scala.inline
  implicit class PartialSpeedDialIconClassesMutableBuilder[Self <: PartialSpeedDialIconClasses] (val x: Self) extends AnyVal {
