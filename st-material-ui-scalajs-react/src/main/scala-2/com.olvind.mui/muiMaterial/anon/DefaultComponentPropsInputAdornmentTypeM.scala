...
/* Inlined DefaultComponentProps<InputAdornmentTypeMap<{}, 'div'>> & { readonly component :string | undefined} */
@js.native
trait DefaultComponentPropsInputAdornmentTypeM extends StObject {
...
object DefaultComponentPropsInputAdornmentTypeM {
  
  @scala.inline
  def apply(position: start | end): DefaultComponentPropsInputAdornmentTypeM = {
    val __obj = js.Dynamic.literal(position = position.asInstanceOf[js.Any])
    __obj.asInstanceOf[DefaultComponentPropsInputAdornmentTypeM]
  }
  
  @scala.inline
  implicit class DefaultComponentPropsInputAdornmentTypeMMutableBuilder[Self <: DefaultComponentPropsInputAdornmentTypeM] (val x: Self) extends AnyVal {
