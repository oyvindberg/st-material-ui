...
/* Inlined std.Partial<@mui/material.@mui/material/ListItemButton/listItemButtonClasses.ListItemButtonClasses> */
@js.native
trait PartialListItemButtonClasses extends StObject {
...
object PartialListItemButtonClasses {
  
  @scala.inline
  def apply(): PartialListItemButtonClasses = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialListItemButtonClasses]
  }
  
  @scala.inline
  implicit class PartialListItemButtonClassesMutableBuilder[Self <: PartialListItemButtonClasses] (val x: Self) extends AnyVal {
