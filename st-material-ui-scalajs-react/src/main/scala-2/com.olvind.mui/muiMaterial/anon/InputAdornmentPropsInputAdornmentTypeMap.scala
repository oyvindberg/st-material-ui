...
/* Inlined @mui/material.@mui/material/InputAdornment.InputAdornmentProps<@mui/material.@mui/material/InputAdornment/InputAdornment.InputAdornmentTypeMap<{}, 'div'>['defaultComponent'], {}> */
@js.native
trait InputAdornmentPropsInputAdornmentTypeMap extends StObject {
...
object InputAdornmentPropsInputAdornmentTypeMap {
  
  @scala.inline
  def apply(position: start | end): InputAdornmentPropsInputAdornmentTypeMap = {
    val __obj = js.Dynamic.literal(position = position.asInstanceOf[js.Any])
    __obj.asInstanceOf[InputAdornmentPropsInputAdornmentTypeMap]
  }
  
  @scala.inline
  implicit class InputAdornmentPropsInputAdornmentTypeMapMutableBuilder[Self <: InputAdornmentPropsInputAdornmentTypeMap] (val x: Self) extends AnyVal {
