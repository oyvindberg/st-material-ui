...
/* Inlined DefaultComponentProps<PaperTypeMap<{}, 'div'>> & { readonly component :string | undefined} */
@js.native
trait DefaultComponentPropsPaperTypeMapdiv extends StObject {
...
object DefaultComponentPropsPaperTypeMapdiv {
  
  @scala.inline
  def apply(): DefaultComponentPropsPaperTypeMapdiv = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsPaperTypeMapdiv]
  }
  
  @scala.inline
  implicit class DefaultComponentPropsPaperTypeMapdivMutableBuilder[Self <: DefaultComponentPropsPaperTypeMapdiv] (val x: Self) extends AnyVal {
