...
@js.native
trait PartialSnackbarContentProps extends StObject {
...
object PartialSnackbarContentProps {
  ...
  @scala.inline
  def apply(): PartialSnackbarContentProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialSnackbarContentProps]
  }
  
  @scala.inline
  implicit class PartialSnackbarContentPropsMutableBuilder[Self <: PartialSnackbarContentProps] (val x: Self) extends AnyVal {
