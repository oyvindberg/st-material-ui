...
/* Inlined DefaultComponentProps<GridTypeMap<{}, 'div'>> & { readonly component :string | undefined} */
@js.native
...
object DefaultComponentPropsGridTypeMapdiv {
  ...
  @scala.inline
  def apply(): DefaultComponentPropsGridTypeMapdiv = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsGridTypeMapdiv]
  }
  
  @scala.inline
  implicit class DefaultComponentPropsGridTypeMapdivMutableBuilder[Self <: DefaultComponentPropsGridTypeMapdiv] (val x: Self) extends AnyVal {
