...
/* Inlined DefaultComponentProps<ContainerTypeMap<{}, 'div'>> & { readonly component :string | undefined} */
@js.native
trait DefaultComponentPropsContainerTypeMapdiv extends StObject {
...
object DefaultComponentPropsContainerTypeMapdiv {
  
  @scala.inline
  def apply(): DefaultComponentPropsContainerTypeMapdiv = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsContainerTypeMapdiv]
  }
  
  @scala.inline
  implicit class DefaultComponentPropsContainerTypeMapdivMutableBuilder[Self <: DefaultComponentPropsContainerTypeMapdiv] (val x: Self) extends AnyVal {
