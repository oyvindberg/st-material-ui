...
object `9` {
  ...
  @scala.inline
  def apply[P, D /* <: ElementType */](defaultComponent: D, props: P with DisableRipple): `9`[P, D] = {
    val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
    __obj.asInstanceOf[`9`[P, D]]
  }
  
  @scala.inline
  implicit class `9MutableBuilder`[Self <: `9`[_, _], P, D /* <: ElementType */] (val x: Self with (`9`[P, D])) extends AnyVal {
