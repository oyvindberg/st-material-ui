...
/* Inlined DefaultComponentProps<CardMediaTypeMap<{}, 'div'>> & { readonly component :string | undefined} */
@js.native
trait DefaultComponentPropsCardMediaTypeMapdiv extends StObject {
  ...
  /**
    * Override or extend the styles applied to the component.
    */
  var classes: js.UndefOr[PartialCardMediaClasses] = js.native
...
object DefaultComponentPropsCardMediaTypeMapdiv {
  
  @scala.inline
  def apply(): DefaultComponentPropsCardMediaTypeMapdiv = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsCardMediaTypeMapdiv]
  }
  
  @scala.inline
  implicit class DefaultComponentPropsCardMediaTypeMapdivMutableBuilder[Self <: DefaultComponentPropsCardMediaTypeMapdiv] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialCardMediaClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
