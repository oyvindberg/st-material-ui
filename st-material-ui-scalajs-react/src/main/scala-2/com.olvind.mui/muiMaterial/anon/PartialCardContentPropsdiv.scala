...
/* Inlined std.Partial<CardContentProps<'div', {}>> */
@js.native
trait PartialCardContentPropsdiv extends StObject {
...
object PartialCardContentPropsdiv {
  
  @scala.inline
  def apply(): PartialCardContentPropsdiv = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialCardContentPropsdiv]
  }
  
  @scala.inline
  implicit class PartialCardContentPropsdivMutableBuilder[Self <: PartialCardContentPropsdiv] (val x: Self) extends AnyVal {
