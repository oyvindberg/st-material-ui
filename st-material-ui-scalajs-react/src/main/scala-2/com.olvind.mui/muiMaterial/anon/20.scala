...
object `20` {
  ...
  @scala.inline
  def apply[P, D /* <: ElementType */](defaultComponent: D, props: P with AutoFocus): `20`[P, D] = {
    val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
    __obj.asInstanceOf[`20`[P, D]]
  }
  
  @scala.inline
  implicit class `20MutableBuilder`[Self <: `20`[_, _], P, D /* <: ElementType */] (val x: Self with (`20`[P, D])) extends AnyVal {
