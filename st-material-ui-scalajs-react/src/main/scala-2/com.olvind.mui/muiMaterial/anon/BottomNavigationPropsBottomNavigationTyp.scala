...
/* Inlined @mui/material.@mui/material/BottomNavigation.BottomNavigationProps<@mui/material.@mui/material/BottomNavigation/BottomNavigation.BottomNavigationTypeMap<{}, 'div'>['defaultComponent'], {}> */
@js.native
trait BottomNavigationPropsBottomNavigationTyp extends StObject {
...
object BottomNavigationPropsBottomNavigationTyp {
  
  @scala.inline
  def apply(): BottomNavigationPropsBottomNavigationTyp = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[BottomNavigationPropsBottomNavigationTyp]
  }
  
  @scala.inline
  implicit class BottomNavigationPropsBottomNavigationTypMutableBuilder[Self <: BottomNavigationPropsBottomNavigationTyp] (val x: Self) extends AnyVal {
