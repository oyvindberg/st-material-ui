...
/* Inlined DefaultComponentProps<BoxTypeMap<{}, 'div'>> & { readonly component :string | undefined} */
@js.native
...
object DefaultComponentPropsBoxTypeMapdiv {
  ...
  @scala.inline
  def apply(): DefaultComponentPropsBoxTypeMapdiv = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsBoxTypeMapdiv]
  }
  
  @scala.inline
  implicit class DefaultComponentPropsBoxTypeMapdivMutableBuilder[Self <: DefaultComponentPropsBoxTypeMapdiv] (val x: Self) extends AnyVal {
