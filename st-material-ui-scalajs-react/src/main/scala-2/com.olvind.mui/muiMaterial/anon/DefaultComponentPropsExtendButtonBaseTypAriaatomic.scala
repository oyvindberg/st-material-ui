...
/* Inlined @mui/material.@mui/material/OverridableComponent.DefaultComponentProps<@mui/material.@mui/material/ButtonBase/ButtonBase.ExtendButtonBaseTypeMap<@mui/material.@mui/material/Fab/Fab.FabTypeMap<{}, 'button'>>> */
@js.native
trait DefaultComponentPropsExtendButtonBaseTypAriaatomic extends StObject {
...
object DefaultComponentPropsExtendButtonBaseTypAriaatomic {
  ...
  @scala.inline
  def apply(): DefaultComponentPropsExtendButtonBaseTypAriaatomic = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsExtendButtonBaseTypAriaatomic]
  }
  
  @scala.inline
  implicit class DefaultComponentPropsExtendButtonBaseTypAriaatomicMutableBuilder[Self <: DefaultComponentPropsExtendButtonBaseTypAriaatomic] (val x: Self) extends AnyVal {
