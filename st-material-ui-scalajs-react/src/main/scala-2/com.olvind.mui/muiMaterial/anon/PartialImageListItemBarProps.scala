...
/* Inlined std.Partial<@mui/material.@mui/material/ImageListItemBar.ImageListItemBarProps> */
@js.native
trait PartialImageListItemBarProps extends StObject {
  
  var about: js.UndefOr[String] = js.native
  
  var accessKey: js.UndefOr[String] = js.native
  
  var actionIcon: js.UndefOr[japgolly.scalajs.react.facade.React.Node] = js.native
  ...
  var subtitle: js.UndefOr[japgolly.scalajs.react.facade.React.Node] = js.native
...
object PartialImageListItemBarProps {
  
  @scala.inline
  def apply(): PartialImageListItemBarProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialImageListItemBarProps]
  }
  
  @scala.inline
  implicit class PartialImageListItemBarPropsMutableBuilder[Self <: PartialImageListItemBarProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setActionIconVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "actionIcon", js.Array(value :_*))
    ...
    @scala.inline
    def setSubtitleVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "subtitle", js.Array(value :_*))
