...
/* Inlined @mui/material.@mui/material/OverridableComponent.DefaultComponentProps<@mui/material.@mui/material/ButtonBase/ButtonBase.ExtendButtonBaseTypeMap<@mui/material.@mui/material/BottomNavigationAction/BottomNavigationAction.BottomNavigationActionTypeMap<{}, @mui/material.@mui/material/ButtonBase.ButtonBaseTypeMap<{}, 'button'>['defaultComponent']>>> */
@js.native
trait DefaultComponentPropsExtendButtonBaseTypAbout extends StObject {
...
object DefaultComponentPropsExtendButtonBaseTypAbout {
  
  @scala.inline
  def apply(): DefaultComponentPropsExtendButtonBaseTypAbout = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsExtendButtonBaseTypAbout]
  }
  
  @scala.inline
  implicit class DefaultComponentPropsExtendButtonBaseTypAboutMutableBuilder[Self <: DefaultComponentPropsExtendButtonBaseTypAbout] (val x: Self) extends AnyVal {
