...
/* Inlined std.Partial<ButtonProps<{}['defaultComponent'], {}>> */
@js.native
trait PartialButtonPropsdefaultComponent extends StObject {
...
object PartialButtonPropsdefaultComponent {
  
  @scala.inline
  def apply(): PartialButtonPropsdefaultComponent = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialButtonPropsdefaultComponent]
  }
  
  @scala.inline
  implicit class PartialButtonPropsdefaultComponentMutableBuilder[Self <: PartialButtonPropsdefaultComponent] (val x: Self) extends AnyVal {
