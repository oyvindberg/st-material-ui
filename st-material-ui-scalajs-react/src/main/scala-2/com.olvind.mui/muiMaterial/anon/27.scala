...
object `27` {
  ...
  @scala.inline
  def apply[P, D /* <: ElementType */](defaultComponent: D, props: P with Size): `27`[P, D] = {
    val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
    __obj.asInstanceOf[`27`[P, D]]
  }
  
  @scala.inline
  implicit class `27MutableBuilder`[Self <: `27`[_, _], P, D /* <: ElementType */] (val x: Self with (`27`[P, D])) extends AnyVal {
