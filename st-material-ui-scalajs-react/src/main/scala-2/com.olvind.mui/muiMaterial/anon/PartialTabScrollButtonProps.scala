...
/* Inlined std.Partial<@mui/material.@mui/material/TabScrollButton.TabScrollButtonProps> */
@js.native
trait PartialTabScrollButtonProps extends StObject {
...
object PartialTabScrollButtonProps {
  
  @scala.inline
  def apply(): PartialTabScrollButtonProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialTabScrollButtonProps]
  }
  
  @scala.inline
  implicit class PartialTabScrollButtonPropsMutableBuilder[Self <: PartialTabScrollButtonProps] (val x: Self) extends AnyVal {
