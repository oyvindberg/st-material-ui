...
object PartialMenuPropsAbout {
  ...
  implicit class PartialMenuPropsAboutMutableBuilder[Self <: PartialMenuPropsAbout] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setActionFunction1(value: PopoverActions | Null => Callback): Self = StObject.set(x, "action", js.Any.fromFunction1((t0: PopoverActions | Null) => value(t0).runNow()))
    ...
    @scala.inline
    def setOnBackdropClick(value: ReactEventFrom[js.Object with Element] => Callback): Self = StObject.set(x, "onBackdropClick", js.Any.fromFunction1((t0: ReactEventFrom[js.Object with Element]) => value(t0).runNow()))
