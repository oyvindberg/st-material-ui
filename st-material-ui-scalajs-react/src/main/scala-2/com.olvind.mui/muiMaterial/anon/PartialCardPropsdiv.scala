...
/* Inlined std.Partial<CardProps<'div', {}>> */
@js.native
trait PartialCardPropsdiv extends StObject {
...
object PartialCardPropsdiv {
  
  @scala.inline
  def apply(): PartialCardPropsdiv = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialCardPropsdiv]
  }
  
  @scala.inline
  implicit class PartialCardPropsdivMutableBuilder[Self <: PartialCardPropsdiv] (val x: Self) extends AnyVal {
