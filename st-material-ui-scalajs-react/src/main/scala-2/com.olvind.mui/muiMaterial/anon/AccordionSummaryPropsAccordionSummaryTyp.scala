...
/* Inlined @mui/material.@mui/material/AccordionSummary.AccordionSummaryProps<@mui/material.@mui/material/AccordionSummary/AccordionSummary.AccordionSummaryTypeMap<{}, 'div'>['defaultComponent'], {}> */
@js.native
trait AccordionSummaryPropsAccordionSummaryTyp extends StObject {
...
object AccordionSummaryPropsAccordionSummaryTyp {
  
  @scala.inline
  def apply(): AccordionSummaryPropsAccordionSummaryTyp = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AccordionSummaryPropsAccordionSummaryTyp]
  }
  
  @scala.inline
  implicit class AccordionSummaryPropsAccordionSummaryTypMutableBuilder[Self <: AccordionSummaryPropsAccordionSummaryTyp] (val x: Self) extends AnyVal {
