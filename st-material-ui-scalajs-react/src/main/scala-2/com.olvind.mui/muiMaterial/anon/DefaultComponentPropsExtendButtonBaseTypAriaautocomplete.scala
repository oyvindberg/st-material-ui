...
/* Inlined @mui/material.@mui/material/OverridableComponent.DefaultComponentProps<@mui/material.@mui/material/ButtonBase/ButtonBase.ExtendButtonBaseTypeMap<@mui/material.@mui/material/IconButton/IconButton.IconButtonTypeMap<{}, 'button'>>> */
@js.native
trait DefaultComponentPropsExtendButtonBaseTypAriaautocomplete extends StObject {
...
object DefaultComponentPropsExtendButtonBaseTypAriaautocomplete {
  
  @scala.inline
  def apply(): DefaultComponentPropsExtendButtonBaseTypAriaautocomplete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsExtendButtonBaseTypAriaautocomplete]
  }
  
  @scala.inline
  implicit class DefaultComponentPropsExtendButtonBaseTypAriaautocompleteMutableBuilder[Self <: DefaultComponentPropsExtendButtonBaseTypAriaautocomplete] (val x: Self) extends AnyVal {
