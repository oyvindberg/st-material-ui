...
/* Inlined std.Partial<AccordionSummaryProps<{}['defaultComponent'], {}>> */
@js.native
trait PartialAccordionSummaryPropsdefaultCompo extends StObject {
...
object PartialAccordionSummaryPropsdefaultCompo {
  
  @scala.inline
  def apply(): PartialAccordionSummaryPropsdefaultCompo = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialAccordionSummaryPropsdefaultCompo]
  }
  
  @scala.inline
  implicit class PartialAccordionSummaryPropsdefaultCompoMutableBuilder[Self <: PartialAccordionSummaryPropsdefaultCompo] (val x: Self) extends AnyVal {
