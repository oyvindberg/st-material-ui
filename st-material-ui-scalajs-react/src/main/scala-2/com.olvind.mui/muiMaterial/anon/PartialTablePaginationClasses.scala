...
trait PartialTablePaginationClasses extends StObject {
  ...
  var displayedRows: js.UndefOr[String] = js.native
  ...
  var selectLabel: js.UndefOr[String] = js.native
...
object PartialTablePaginationClasses {
  ...
  @scala.inline
  def apply(): PartialTablePaginationClasses = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialTablePaginationClasses]
  }
  
  @scala.inline
  implicit class PartialTablePaginationClassesMutableBuilder[Self <: PartialTablePaginationClasses] (val x: Self) extends AnyVal {
