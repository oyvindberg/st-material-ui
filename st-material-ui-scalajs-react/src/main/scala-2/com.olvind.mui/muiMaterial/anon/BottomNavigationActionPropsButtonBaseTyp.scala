...
/* Inlined @mui/material.@mui/material/BottomNavigationAction.BottomNavigationActionProps<@mui/material.@mui/material/ButtonBase.ButtonBaseTypeMap<{}, 'button'>['defaultComponent'], {}> */
@js.native
trait BottomNavigationActionPropsButtonBaseTyp extends StObject {
...
object BottomNavigationActionPropsButtonBaseTyp {
  
  @scala.inline
  def apply(): BottomNavigationActionPropsButtonBaseTyp = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[BottomNavigationActionPropsButtonBaseTyp]
  }
  
  @scala.inline
  implicit class BottomNavigationActionPropsButtonBaseTypMutableBuilder[Self <: BottomNavigationActionPropsButtonBaseTyp] (val x: Self) extends AnyVal {
