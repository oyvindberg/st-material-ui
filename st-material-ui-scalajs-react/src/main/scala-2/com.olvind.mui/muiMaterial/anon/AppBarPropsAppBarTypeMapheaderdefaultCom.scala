...
/* Inlined @mui/material.@mui/material/AppBar.AppBarProps<@mui/material.@mui/material/AppBar/AppBar.AppBarTypeMap<{}, 'header'>['defaultComponent'], {}> */
@js.native
trait AppBarPropsAppBarTypeMapheaderdefaultCom extends StObject {
  ...
  /**
    * Override or extend the styles applied to the component.
    */
  var classes: js.UndefOr[PartialAppBarClasses] = js.native
  
  /**
    * The color of the component. It supports those theme colors that make sense for this component.
    * @default 'primary'
    */
  var color: js.UndefOr[com.olvind.mui.muiMaterial.mod.PropTypes.Color | transparent] = js.native
  ...
  /**
    ...
    * @default false
    */
  var enableColorOnDark: js.UndefOr[Boolean] = js.native
...
object AppBarPropsAppBarTypeMapheaderdefaultCom {
  
  @scala.inline
  def apply(): AppBarPropsAppBarTypeMapheaderdefaultCom = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AppBarPropsAppBarTypeMapheaderdefaultCom]
  }
  
  @scala.inline
  implicit class AppBarPropsAppBarTypeMapheaderdefaultComMutableBuilder[Self <: AppBarPropsAppBarTypeMapheaderdefaultCom] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialAppBarClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setClassesUndefined: Self = StObject.set(x, "classes", js.undefined)
    
    @scala.inline
    def setColor(value: com.olvind.mui.muiMaterial.mod.PropTypes.Color | transparent): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setEnableColorOnDark(value: Boolean): Self = StObject.set(x, "enableColorOnDark", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setEnableColorOnDarkUndefined: Self = StObject.set(x, "enableColorOnDark", js.undefined)
    ...
    @scala.inline
    def setPosition(value: fixed | absolute | sticky | static | relative): Self = StObject.set(x, "position", value.asInstanceOf[js.Any])
