...
/* Inlined DefaultComponentProps<TypographyTypeMap<{}, 'span'>> & { readonly component :string | undefined} */
@js.native
...
object DefaultComponentPropsTypographyTypeMapsp {
  ...
  @scala.inline
  def apply(): DefaultComponentPropsTypographyTypeMapsp = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsTypographyTypeMapsp]
  }
  
  @scala.inline
  implicit class DefaultComponentPropsTypographyTypeMapspMutableBuilder[Self <: DefaultComponentPropsTypographyTypeMapsp] (val x: Self) extends AnyVal {
