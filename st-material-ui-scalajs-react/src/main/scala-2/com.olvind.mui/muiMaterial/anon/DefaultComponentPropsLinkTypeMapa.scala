...
/* Inlined DefaultComponentProps<LinkTypeMap<{}, 'a'>> & { readonly component :string | undefined} */
@js.native
trait DefaultComponentPropsLinkTypeMapa extends StObject {
...
object DefaultComponentPropsLinkTypeMapa {
  
  @scala.inline
  def apply(): DefaultComponentPropsLinkTypeMapa = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsLinkTypeMapa]
  }
  
  @scala.inline
  implicit class DefaultComponentPropsLinkTypeMapaMutableBuilder[Self <: DefaultComponentPropsLinkTypeMapa] (val x: Self) extends AnyVal {
