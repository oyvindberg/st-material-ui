...
/* Inlined std.Partial<@mui/material.@mui/material/OutlinedInput/outlinedInputClasses.OutlinedInputClasses> */
@js.native
trait PartialOutlinedInputClasses extends StObject {
...
object PartialOutlinedInputClasses {
  
  @scala.inline
  def apply(): PartialOutlinedInputClasses = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialOutlinedInputClasses]
  }
  
  @scala.inline
  implicit class PartialOutlinedInputClassesMutableBuilder[Self <: PartialOutlinedInputClasses] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNotchedOutlineUndefined: Self = StObject.set(x, "notchedOutline", js.undefined)
