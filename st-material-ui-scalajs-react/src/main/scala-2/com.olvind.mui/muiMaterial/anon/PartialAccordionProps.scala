...
/* Inlined std.Partial<@mui/material.@mui/material/Accordion.AccordionProps> */
@js.native
...
object PartialAccordionProps {
  ...
  @scala.inline
  def apply(): PartialAccordionProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialAccordionProps]
  }
  
  @scala.inline
  implicit class PartialAccordionPropsMutableBuilder[Self <: PartialAccordionProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTransitionComponent(value: TransitionProps => Element | Null): Self = StObject.set(x, "TransitionComponent", js.Any.fromFunction1(value))
