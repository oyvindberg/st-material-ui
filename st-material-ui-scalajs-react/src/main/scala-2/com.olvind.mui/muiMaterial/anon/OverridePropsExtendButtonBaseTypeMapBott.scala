...
/* Inlined {  href :string} & OverrideProps<ExtendButtonBaseTypeMap<BottomNavigationActionTypeMap<{}, ButtonBaseTypeMap<{}, 'button'>['defaultComponent']>>, 'a'> */
@js.native
trait OverridePropsExtendButtonBaseTypeMapBott extends StObject {
...
object OverridePropsExtendButtonBaseTypeMapBott {
  
  @scala.inline
  def apply(href: String): OverridePropsExtendButtonBaseTypeMapBott = {
    val __obj = js.Dynamic.literal(href = href.asInstanceOf[js.Any])
    __obj.asInstanceOf[OverridePropsExtendButtonBaseTypeMapBott]
  }
  
  @scala.inline
  implicit class OverridePropsExtendButtonBaseTypeMapBottMutableBuilder[Self <: OverridePropsExtendButtonBaseTypeMapBott] (val x: Self) extends AnyVal {
