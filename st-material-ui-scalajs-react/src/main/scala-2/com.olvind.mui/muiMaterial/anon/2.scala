...
object `2` {
  ...
  @scala.inline
  def apply[P, D /* <: ElementType */](defaultComponent: D, props: P with DisableElevation): `2`[P, D] = {
    val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
    __obj.asInstanceOf[`2`[P, D]]
  }
  
  @scala.inline
  implicit class `2MutableBuilder`[Self <: `2`[_, _], P, D /* <: ElementType */] (val x: Self with (`2`[P, D])) extends AnyVal {
