...
trait PartialAvatarGroupProps extends StObject {
  ...
  var classes: js.UndefOr[PartialAvatarGroupClasses] = js.native
...
object PartialAvatarGroupProps {
  ...
  @scala.inline
  def apply(): PartialAvatarGroupProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialAvatarGroupProps]
  }
  
  @scala.inline
  implicit class PartialAvatarGroupPropsMutableBuilder[Self <: PartialAvatarGroupProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialAvatarGroupClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
