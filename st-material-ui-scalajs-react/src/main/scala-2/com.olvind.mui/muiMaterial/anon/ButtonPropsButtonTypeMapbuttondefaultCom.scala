...
/* Inlined @mui/material.@mui/material/Button.ButtonProps<@mui/material.@mui/material/Button/Button.ButtonTypeMap<{}, 'button'>['defaultComponent'], {}> */
@js.native
trait ButtonPropsButtonTypeMapbuttondefaultCom extends StObject {
...
object ButtonPropsButtonTypeMapbuttondefaultCom {
  
  @scala.inline
  def apply(): ButtonPropsButtonTypeMapbuttondefaultCom = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ButtonPropsButtonTypeMapbuttondefaultCom]
  }
  
  @scala.inline
  implicit class ButtonPropsButtonTypeMapbuttondefaultComMutableBuilder[Self <: ButtonPropsButtonTypeMapbuttondefaultCom] (val x: Self) extends AnyVal {
