...
/* Inlined @mui/material.@mui/material/Stack.StackProps<@mui/material.@mui/material/Stack/Stack.StackTypeMap<{}, 'div'>['defaultComponent'], {}> */
@js.native
trait StackPropsStackTypeMapdivdefaultComponen extends StObject {
  ...
  /**
    ...
    * @default 0
    */
  var spacing: js.UndefOr[com.olvind.mui.muiSystem.mod.ResponsiveStyleValue[Double | String]] = js.native
...
object StackPropsStackTypeMapdivdefaultComponen {
  ...
  @scala.inline
  def apply(): StackPropsStackTypeMapdivdefaultComponen = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[StackPropsStackTypeMapdivdefaultComponen]
  }
  
  @scala.inline
  implicit class StackPropsStackTypeMapdivdefaultComponenMutableBuilder[Self <: StackPropsStackTypeMapdivdefaultComponen] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSpacing(value: com.olvind.mui.muiSystem.mod.ResponsiveStyleValue[Double | String]): Self = StObject.set(x, "spacing", value.asInstanceOf[js.Any])
