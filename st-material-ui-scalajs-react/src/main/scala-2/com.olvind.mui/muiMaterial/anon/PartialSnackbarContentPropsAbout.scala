...
/* Inlined std.Partial<@mui/material.@mui/material/SnackbarContent.SnackbarContentProps> */
@js.native
trait PartialSnackbarContentPropsAbout extends StObject {
  ...
  var role: js.UndefOr[
    /* import warning: importer.ImportType#apply Failed type conversion: @mui/material.anon.PaperPropsdiv['role'] */ js.Any
  ] = js.native
...
object PartialSnackbarContentPropsAbout {
  
  @scala.inline
  def apply(): PartialSnackbarContentPropsAbout = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialSnackbarContentPropsAbout]
  }
  
  @scala.inline
  implicit class PartialSnackbarContentPropsAboutMutableBuilder[Self <: PartialSnackbarContentPropsAbout] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRole(
      value: /* import warning: importer.ImportType#apply Failed type conversion: @mui/material.anon.PaperPropsdiv['role'] */ js.Any
