...
/* Inlined @mui/material.@mui/material/OverridableComponent.DefaultComponentProps<@mui/material.@mui/material/ButtonBase/ButtonBase.ExtendButtonBaseTypeMap<@mui/material.@mui/material/Button/Button.ButtonTypeMap<{}, 'button'>>> */
@js.native
trait DefaultComponentPropsExtendButtonBaseTypAccessKey extends StObject {
...
object DefaultComponentPropsExtendButtonBaseTypAccessKey {
  ...
  @scala.inline
  def apply(): DefaultComponentPropsExtendButtonBaseTypAccessKey = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsExtendButtonBaseTypAccessKey]
  }
  
  @scala.inline
  implicit class DefaultComponentPropsExtendButtonBaseTypAccessKeyMutableBuilder[Self <: DefaultComponentPropsExtendButtonBaseTypAccessKey] (val x: Self) extends AnyVal {
