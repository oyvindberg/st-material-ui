...
/* Inlined @mui/material.@mui/material/Paper.PaperProps<'div', {}> */
@js.native
trait PaperPropsdiv extends StObject {
...
object PaperPropsdiv {
  
  @scala.inline
  def apply(): PaperPropsdiv = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PaperPropsdiv]
  }
  
  @scala.inline
  implicit class PaperPropsdivMutableBuilder[Self <: PaperPropsdiv] (val x: Self) extends AnyVal {
