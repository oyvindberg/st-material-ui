...
/* Inlined DefaultComponentProps<DialogContentTextTypeMap<{}, TypographyTypeMap<{}, 'span'>['defaultComponent']>> & { readonly component :string | undefined} */
@js.native
trait DefaultComponentPropsDialogContentTextTy extends StObject {
...
object DefaultComponentPropsDialogContentTextTy {
  
  @scala.inline
  def apply(): DefaultComponentPropsDialogContentTextTy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsDialogContentTextTy]
  }
  
  @scala.inline
  implicit class DefaultComponentPropsDialogContentTextTyMutableBuilder[Self <: DefaultComponentPropsDialogContentTextTy] (val x: Self) extends AnyVal {
