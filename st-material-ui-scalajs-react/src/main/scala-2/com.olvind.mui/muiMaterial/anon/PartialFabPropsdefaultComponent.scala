...
/* Inlined std.Partial<FabProps<{}['defaultComponent'], {}>> */
@js.native
trait PartialFabPropsdefaultComponent extends StObject {
...
object PartialFabPropsdefaultComponent {
  
  @scala.inline
  def apply(): PartialFabPropsdefaultComponent = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialFabPropsdefaultComponent]
  }
  
  @scala.inline
  implicit class PartialFabPropsdefaultComponentMutableBuilder[Self <: PartialFabPropsdefaultComponent] (val x: Self) extends AnyVal {
