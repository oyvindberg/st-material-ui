...
/* Inlined std.Partial<@mui/material.@mui/material/Tooltip.TooltipProps> */
@js.native
trait PartialTooltipProps extends StObject {
  ...
  var title: js.UndefOr[Element | String | Double | Any | ReactPortal | Boolean] = js.native
...
object PartialTooltipProps {
  ...
  implicit class PartialTooltipPropsMutableBuilder[Self <: PartialTooltipProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPopperComponent(value: PopperProps => Element | Null): Self = StObject.set(x, "PopperComponent", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setTitle(value: Element | String | Double | Any | ReactPortal | Boolean): Self = StObject.set(x, "title", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTransitionComponent(value: TransitionPropsAbout => Element | Null): Self = StObject.set(x, "TransitionComponent", js.Any.fromFunction1(value))
