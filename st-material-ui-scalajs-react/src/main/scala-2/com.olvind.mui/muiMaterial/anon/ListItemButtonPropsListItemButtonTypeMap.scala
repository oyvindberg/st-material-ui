...
/* Inlined @mui/material.@mui/material/ListItemButton.ListItemButtonProps<@mui/material.@mui/material/ListItemButton/ListItemButton.ListItemButtonTypeMap<{}, 'div'>['defaultComponent'], {}> */
@js.native
trait ListItemButtonPropsListItemButtonTypeMap extends StObject {
...
object ListItemButtonPropsListItemButtonTypeMap {
  
  @scala.inline
  def apply(): ListItemButtonPropsListItemButtonTypeMap = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ListItemButtonPropsListItemButtonTypeMap]
  }
  
  @scala.inline
  implicit class ListItemButtonPropsListItemButtonTypeMapMutableBuilder[Self <: ListItemButtonPropsListItemButtonTypeMap] (val x: Self) extends AnyVal {
