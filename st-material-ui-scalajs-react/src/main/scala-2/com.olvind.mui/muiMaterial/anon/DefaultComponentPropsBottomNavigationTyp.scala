...
/* Inlined DefaultComponentProps<BottomNavigationTypeMap<{}, 'div'>> & { readonly component :string | undefined} */
@js.native
trait DefaultComponentPropsBottomNavigationTyp extends StObject {
...
object DefaultComponentPropsBottomNavigationTyp {
  
  @scala.inline
  def apply(): DefaultComponentPropsBottomNavigationTyp = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsBottomNavigationTyp]
  }
  
  @scala.inline
  implicit class DefaultComponentPropsBottomNavigationTypMutableBuilder[Self <: DefaultComponentPropsBottomNavigationTyp] (val x: Self) extends AnyVal {
