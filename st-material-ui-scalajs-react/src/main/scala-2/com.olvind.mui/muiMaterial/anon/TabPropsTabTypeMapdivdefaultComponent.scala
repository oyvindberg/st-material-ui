...
/* Inlined @mui/material.@mui/material/Tab.TabProps<@mui/material.@mui/material/Tab/Tab.TabTypeMap<{}, 'div'>['defaultComponent'], {}> */
@js.native
trait TabPropsTabTypeMapdivdefaultComponent extends StObject {
...
object TabPropsTabTypeMapdivdefaultComponent {
  
  @scala.inline
  def apply(): TabPropsTabTypeMapdivdefaultComponent = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TabPropsTabTypeMapdivdefaultComponent]
  }
  
  @scala.inline
  implicit class TabPropsTabTypeMapdivdefaultComponentMutableBuilder[Self <: TabPropsTabTypeMapdivdefaultComponent] (val x: Self) extends AnyVal {
