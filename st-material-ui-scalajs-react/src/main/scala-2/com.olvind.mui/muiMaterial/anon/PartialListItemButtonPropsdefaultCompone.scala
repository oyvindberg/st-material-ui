...
/* Inlined std.Partial<ListItemButtonProps<{}['defaultComponent'], {}>> */
@js.native
trait PartialListItemButtonPropsdefaultCompone extends StObject {
...
object PartialListItemButtonPropsdefaultCompone {
  
  @scala.inline
  def apply(): PartialListItemButtonPropsdefaultCompone = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialListItemButtonPropsdefaultCompone]
  }
  
  @scala.inline
  implicit class PartialListItemButtonPropsdefaultComponeMutableBuilder[Self <: PartialListItemButtonPropsdefaultCompone] (val x: Self) extends AnyVal {
