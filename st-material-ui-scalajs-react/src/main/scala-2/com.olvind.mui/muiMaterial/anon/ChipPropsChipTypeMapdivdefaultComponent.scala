...
/* Inlined @mui/material.@mui/material/Chip.ChipProps<@mui/material.@mui/material/Chip/Chip.ChipTypeMap<{}, 'div'>['defaultComponent'], {}> */
@js.native
trait ChipPropsChipTypeMapdivdefaultComponent extends StObject {
...
object ChipPropsChipTypeMapdivdefaultComponent {
  
  @scala.inline
  def apply(): ChipPropsChipTypeMapdivdefaultComponent = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ChipPropsChipTypeMapdivdefaultComponent]
  }
  
  @scala.inline
  implicit class ChipPropsChipTypeMapdivdefaultComponentMutableBuilder[Self <: ChipPropsChipTypeMapdivdefaultComponent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAvatar(value: VdomElement): Self = StObject.set(x, "avatar", value.rawElement.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDeleteIcon(value: VdomElement): Self = StObject.set(x, "deleteIcon", value.rawElement.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setIcon(value: VdomElement): Self = StObject.set(x, "icon", value.rawElement.asInstanceOf[js.Any])
