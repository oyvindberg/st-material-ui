...
/* Inlined std.Partial<FormControlProps<'div', {}>> */
@js.native
trait PartialFormControlPropsdiv extends StObject {
...
object PartialFormControlPropsdiv {
  
  @scala.inline
  def apply(): PartialFormControlPropsdiv = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialFormControlPropsdiv]
  }
  
  @scala.inline
  implicit class PartialFormControlPropsdivMutableBuilder[Self <: PartialFormControlPropsdiv] (val x: Self) extends AnyVal {
