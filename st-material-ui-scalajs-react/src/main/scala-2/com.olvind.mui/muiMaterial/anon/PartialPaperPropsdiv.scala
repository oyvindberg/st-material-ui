...
/* Inlined std.Partial<PaperProps<'div', {}>> */
@js.native
trait PartialPaperPropsdiv extends StObject {
...
object PartialPaperPropsdiv {
  
  @scala.inline
  def apply(): PartialPaperPropsdiv = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialPaperPropsdiv]
  }
  
  @scala.inline
  implicit class PartialPaperPropsdivMutableBuilder[Self <: PartialPaperPropsdiv] (val x: Self) extends AnyVal {
