...
/* Inlined std.Partial<@mui/material.@mui/material/RadioGroup.RadioGroupProps> */
@js.native
trait PartialRadioGroupProps extends StObject {
...
object PartialRadioGroupProps {
  
  @scala.inline
  def apply(): PartialRadioGroupProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialRadioGroupProps]
  }
  
  @scala.inline
  implicit class PartialRadioGroupPropsMutableBuilder[Self <: PartialRadioGroupProps] (val x: Self) extends AnyVal {
