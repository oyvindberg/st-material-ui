...
/* Inlined std.Partial<BottomNavigationActionProps<'button', {}>> */
@js.native
trait PartialBottomNavigationActionPropsbutton extends StObject {
...
object PartialBottomNavigationActionPropsbutton {
  
  @scala.inline
  def apply(): PartialBottomNavigationActionPropsbutton = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialBottomNavigationActionPropsbutton]
  }
  
  @scala.inline
  implicit class PartialBottomNavigationActionPropsbuttonMutableBuilder[Self <: PartialBottomNavigationActionPropsbutton] (val x: Self) extends AnyVal {
