...
trait PartialSnackbarProps extends StObject {
  ...
  var ContentProps: js.UndefOr[PartialSnackbarContentPropsAbout] = js.native
...
object PartialSnackbarProps {
  ...
  implicit class PartialSnackbarPropsMutableBuilder[Self <: PartialSnackbarProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setContentProps(value: PartialSnackbarContentPropsAbout): Self = StObject.set(x, "ContentProps", value.asInstanceOf[js.Any])
