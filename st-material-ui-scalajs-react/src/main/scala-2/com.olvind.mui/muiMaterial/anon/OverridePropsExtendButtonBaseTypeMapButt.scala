...
/* Inlined {  href :string} & OverrideProps<ExtendButtonBaseTypeMap<ButtonTypeMap<{}, 'button'>>, 'a'> */
@js.native
trait OverridePropsExtendButtonBaseTypeMapButt extends StObject {
...
object OverridePropsExtendButtonBaseTypeMapButt {
  ...
  @scala.inline
  def apply(href: String): OverridePropsExtendButtonBaseTypeMapButt = {
    val __obj = js.Dynamic.literal(href = href.asInstanceOf[js.Any])
    __obj.asInstanceOf[OverridePropsExtendButtonBaseTypeMapButt]
  }
  
  @scala.inline
  implicit class OverridePropsExtendButtonBaseTypeMapButtMutableBuilder[Self <: OverridePropsExtendButtonBaseTypeMapButt] (val x: Self) extends AnyVal {
