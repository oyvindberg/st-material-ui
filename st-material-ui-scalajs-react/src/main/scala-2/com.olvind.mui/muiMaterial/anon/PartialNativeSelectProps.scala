...
/* Inlined std.Partial<@mui/material.@mui/material/NativeSelect.NativeSelectProps> */
@js.native
...
object PartialNativeSelectProps {
  ...
  @scala.inline
  def apply(): PartialNativeSelectProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialNativeSelectProps]
  }
  
  @scala.inline
  implicit class PartialNativeSelectPropsMutableBuilder[Self <: PartialNativeSelectProps] (val x: Self) extends AnyVal {
