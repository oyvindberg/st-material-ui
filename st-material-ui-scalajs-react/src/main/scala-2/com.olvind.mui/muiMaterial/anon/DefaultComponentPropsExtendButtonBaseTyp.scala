...
object DefaultComponentPropsExtendButtonBaseTyp {
  ...
  @scala.inline
  def apply(): DefaultComponentPropsExtendButtonBaseTyp = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsExtendButtonBaseTyp]
  }
  
  @scala.inline
  implicit class DefaultComponentPropsExtendButtonBaseTypMutableBuilder[Self <: DefaultComponentPropsExtendButtonBaseTyp] (val x: Self) extends AnyVal {
