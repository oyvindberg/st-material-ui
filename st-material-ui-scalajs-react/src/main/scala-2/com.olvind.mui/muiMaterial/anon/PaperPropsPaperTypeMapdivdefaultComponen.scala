...
/* Inlined @mui/material.@mui/material/Paper.PaperProps<@mui/material.@mui/material/Paper/Paper.PaperTypeMap<{}, 'div'>['defaultComponent'], {}> */
@js.native
trait PaperPropsPaperTypeMapdivdefaultComponen extends StObject {
  ...
  /**
    * Override or extend the styles applied to the component.
    */
  var classes: js.UndefOr[PartialPaperClasses] = js.native
...
object PaperPropsPaperTypeMapdivdefaultComponen {
  
  @scala.inline
  def apply(): PaperPropsPaperTypeMapdivdefaultComponen = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PaperPropsPaperTypeMapdivdefaultComponen]
  }
  
  @scala.inline
  implicit class PaperPropsPaperTypeMapdivdefaultComponenMutableBuilder[Self <: PaperPropsPaperTypeMapdivdefaultComponen] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialPaperClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
