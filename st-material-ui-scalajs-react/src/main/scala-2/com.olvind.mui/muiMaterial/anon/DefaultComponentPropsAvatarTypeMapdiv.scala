...
/* Inlined DefaultComponentProps<AvatarTypeMap<{}, 'div'>> & { readonly component :string | undefined} */
@js.native
trait DefaultComponentPropsAvatarTypeMapdiv extends StObject {
...
object DefaultComponentPropsAvatarTypeMapdiv {
  
  @scala.inline
  def apply(): DefaultComponentPropsAvatarTypeMapdiv = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsAvatarTypeMapdiv]
  }
  
  @scala.inline
  implicit class DefaultComponentPropsAvatarTypeMapdivMutableBuilder[Self <: DefaultComponentPropsAvatarTypeMapdiv] (val x: Self) extends AnyVal {
