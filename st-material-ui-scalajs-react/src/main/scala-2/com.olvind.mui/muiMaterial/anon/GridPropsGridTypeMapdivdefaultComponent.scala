...
/* Inlined @mui/material.@mui/material/Grid.GridProps<@mui/material.@mui/material/Grid/Grid.GridTypeMap<{}, 'div'>['defaultComponent'], {}> */
@js.native
trait GridPropsGridTypeMapdivdefaultComponent extends StObject {
  ...
  /**
    ...
    */
  var columnSpacing: js.UndefOr[com.olvind.mui.muiSystem.mod.ResponsiveStyleValue[GridSpacing]] = js.native
  
  /**
    * The number of columns.
    * @default 12
    */
  var columns: js.UndefOr[com.olvind.mui.muiSystem.mod.ResponsiveStyleValue[Double]] = js.native
  ...
  /**
    ...
    * @default 'row'
    */
  var direction: js.UndefOr[com.olvind.mui.muiSystem.mod.ResponsiveStyleValue[GridDirection]] = js.native
  ...
  /**
    ...
    * It overrides the value of the `spacing` prop.
    */
  var rowSpacing: js.UndefOr[com.olvind.mui.muiSystem.mod.ResponsiveStyleValue[GridSpacing]] = js.native
  ...
  /**
    ...
    * @default 0
    */
  var spacing: js.UndefOr[com.olvind.mui.muiSystem.mod.ResponsiveStyleValue[GridSpacing]] = js.native
...
object GridPropsGridTypeMapdivdefaultComponent {
  ...
  @scala.inline
  def apply(): GridPropsGridTypeMapdivdefaultComponent = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GridPropsGridTypeMapdivdefaultComponent]
  }
  
  @scala.inline
  implicit class GridPropsGridTypeMapdivdefaultComponentMutableBuilder[Self <: GridPropsGridTypeMapdivdefaultComponent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setColumnSpacing(value: com.olvind.mui.muiSystem.mod.ResponsiveStyleValue[GridSpacing]): Self = StObject.set(x, "columnSpacing", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setColumns(value: com.olvind.mui.muiSystem.mod.ResponsiveStyleValue[Double]): Self = StObject.set(x, "columns", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDirection(value: com.olvind.mui.muiSystem.mod.ResponsiveStyleValue[GridDirection]): Self = StObject.set(x, "direction", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRowSpacing(value: com.olvind.mui.muiSystem.mod.ResponsiveStyleValue[GridSpacing]): Self = StObject.set(x, "rowSpacing", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSpacing(value: com.olvind.mui.muiSystem.mod.ResponsiveStyleValue[GridSpacing]): Self = StObject.set(x, "spacing", value.asInstanceOf[js.Any])
