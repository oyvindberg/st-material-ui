...
/* Inlined std.Partial<InputAdornmentProps<'div', {}>> */
@js.native
trait PartialInputAdornmentPropsdiv extends StObject {
...
object PartialInputAdornmentPropsdiv {
  
  @scala.inline
  def apply(): PartialInputAdornmentPropsdiv = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialInputAdornmentPropsdiv]
  }
  
  @scala.inline
  implicit class PartialInputAdornmentPropsdivMutableBuilder[Self <: PartialInputAdornmentPropsdiv] (val x: Self) extends AnyVal {
