...
object `36` {
  ...
  @scala.inline
  def apply[P, D /* <: ElementType */](defaultComponent: D, props: P with FullWidth): `36`[P, D] = {
    val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
    __obj.asInstanceOf[`36`[P, D]]
  }
  
  @scala.inline
  implicit class `36MutableBuilder`[Self <: `36`[_, _], P, D /* <: ElementType */] (val x: Self with (`36`[P, D])) extends AnyVal {
