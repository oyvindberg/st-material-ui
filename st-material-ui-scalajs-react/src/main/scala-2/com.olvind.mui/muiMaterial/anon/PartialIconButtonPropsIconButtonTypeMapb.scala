...
/* Inlined std.Partial<IconButtonProps<IconButtonTypeMap<{}, 'button'>['defaultComponent'], {}>> */
@js.native
trait PartialIconButtonPropsIconButtonTypeMapb extends StObject {
...
object PartialIconButtonPropsIconButtonTypeMapb {
  
  @scala.inline
  def apply(): PartialIconButtonPropsIconButtonTypeMapb = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialIconButtonPropsIconButtonTypeMapb]
  }
  
  @scala.inline
  implicit class PartialIconButtonPropsIconButtonTypeMapbMutableBuilder[Self <: PartialIconButtonPropsIconButtonTypeMapb] (val x: Self) extends AnyVal {
