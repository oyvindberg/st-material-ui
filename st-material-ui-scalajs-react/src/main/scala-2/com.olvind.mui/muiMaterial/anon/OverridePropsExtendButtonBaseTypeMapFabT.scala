...
/* Inlined {  href :string} & OverrideProps<ExtendButtonBaseTypeMap<FabTypeMap<{}, 'button'>>, 'a'> */
@js.native
trait OverridePropsExtendButtonBaseTypeMapFabT extends StObject {
...
object OverridePropsExtendButtonBaseTypeMapFabT {
  
  @scala.inline
  def apply(href: String): OverridePropsExtendButtonBaseTypeMapFabT = {
    val __obj = js.Dynamic.literal(href = href.asInstanceOf[js.Any])
    __obj.asInstanceOf[OverridePropsExtendButtonBaseTypeMapFabT]
  }
  
  @scala.inline
  implicit class OverridePropsExtendButtonBaseTypeMapFabTMutableBuilder[Self <: OverridePropsExtendButtonBaseTypeMapFabT] (val x: Self) extends AnyVal {
