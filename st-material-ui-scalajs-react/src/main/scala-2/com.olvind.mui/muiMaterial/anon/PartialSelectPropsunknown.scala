...
@js.native
trait PartialSelectPropsunknown extends StObject {
...
object PartialSelectPropsunknown {
  
  @scala.inline
  def apply(): PartialSelectPropsunknown = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialSelectPropsunknown]
  }
  
  @scala.inline
  implicit class PartialSelectPropsunknownMutableBuilder[Self <: PartialSelectPropsunknown] (val x: Self) extends AnyVal {
