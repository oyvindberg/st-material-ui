...
/* Inlined @mui/material.@mui/material/OverridableComponent.DefaultComponentProps<@mui/material.@mui/material/ButtonBase/ButtonBase.ExtendButtonBaseTypeMap<@mui/material.@mui/material/ListItemButton/ListItemButton.ListItemButtonTypeMap<{}, 'div'>>> */
@js.native
trait DefaultComponentPropsExtendButtonBaseTypAriabusy extends StObject {
...
object DefaultComponentPropsExtendButtonBaseTypAriabusy {
  
  @scala.inline
  def apply(): DefaultComponentPropsExtendButtonBaseTypAriabusy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsExtendButtonBaseTypAriabusy]
  }
  
  @scala.inline
  implicit class DefaultComponentPropsExtendButtonBaseTypAriabusyMutableBuilder[Self <: DefaultComponentPropsExtendButtonBaseTypAriabusy] (val x: Self) extends AnyVal {
