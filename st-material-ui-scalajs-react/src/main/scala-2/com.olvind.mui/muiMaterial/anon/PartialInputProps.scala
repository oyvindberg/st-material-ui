...
/* Inlined std.Partial<@mui/material.@mui/material/Input.InputProps> */
@js.native
trait PartialInputProps extends StObject {
  ...
  var classes: js.UndefOr[PartialInputClasses] = js.native
...
object PartialInputProps {
  ...
  @scala.inline
  def apply(): PartialInputProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialInputProps]
  }
  
  @scala.inline
  implicit class PartialInputPropsMutableBuilder[Self <: PartialInputProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialInputClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
