...
/* Inlined @mui/material.@mui/material/PaginationItem.PaginationItemProps<@mui/material.@mui/material/PaginationItem/PaginationItem.PaginationItemTypeMap<{}, 'div'>['defaultComponent'], {}> */
@js.native
trait PaginationItemPropsPaginationItemTypeMap extends StObject {
  ...
  /**
    ...
    */
  var page: js.UndefOr[japgolly.scalajs.react.facade.React.Node] = js.native
...
object PaginationItemPropsPaginationItemTypeMap {
  
  @scala.inline
  def apply(): PaginationItemPropsPaginationItemTypeMap = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PaginationItemPropsPaginationItemTypeMap]
  }
  
  @scala.inline
  implicit class PaginationItemPropsPaginationItemTypeMapMutableBuilder[Self <: PaginationItemPropsPaginationItemTypeMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPage(value: VdomNode): Self = StObject.set(x, "page", value.rawNode.asInstanceOf[js.Any])
    
    @scala.inline
    def setPageNull: Self = StObject.set(x, "page", null)
    
    @scala.inline
    def setPageUndefined: Self = StObject.set(x, "page", js.undefined)
    
    @scala.inline
    def setPageVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "page", js.Array(value :_*))
    
    @scala.inline
    def setPageVdomElement(value: VdomElement): Self = StObject.set(x, "page", value.rawElement.asInstanceOf[js.Any])
