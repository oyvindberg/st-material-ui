...
/* Inlined std.Partial<@mui/material.@mui/material/AccordionActions.AccordionActionsProps> */
@js.native
trait PartialAccordionActionsProps extends StObject {
...
object PartialAccordionActionsProps {
  
  @scala.inline
  def apply(): PartialAccordionActionsProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialAccordionActionsProps]
  }
  
  @scala.inline
  implicit class PartialAccordionActionsPropsMutableBuilder[Self <: PartialAccordionActionsProps] (val x: Self) extends AnyVal {
