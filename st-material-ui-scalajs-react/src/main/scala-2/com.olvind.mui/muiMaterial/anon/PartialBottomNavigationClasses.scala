...
object PartialBottomNavigationClasses {
  ...
  @scala.inline
  def apply(): PartialBottomNavigationClasses = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialBottomNavigationClasses]
  }
  
  @scala.inline
  implicit class PartialBottomNavigationClassesMutableBuilder[Self <: PartialBottomNavigationClasses] (val x: Self) extends AnyVal {
