...
/* Inlined std.Partial<ScopedCssBaselineProps<'div', {}>> */
@js.native
trait PartialScopedCssBaselinePropsdiv extends StObject {
...
object PartialScopedCssBaselinePropsdiv {
  
  @scala.inline
  def apply(): PartialScopedCssBaselinePropsdiv = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialScopedCssBaselinePropsdiv]
  }
  
  @scala.inline
  implicit class PartialScopedCssBaselinePropsdivMutableBuilder[Self <: PartialScopedCssBaselinePropsdiv] (val x: Self) extends AnyVal {
