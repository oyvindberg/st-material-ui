...
/* Inlined @mui/material.@mui/material/Typography.TypographyProps<'span', {  component :'span' | undefined}> */
@js.native
trait TypographyPropsspan extends StObject {
...
object TypographyPropsspan {
  
  @scala.inline
  def apply(): TypographyPropsspan = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TypographyPropsspan]
  }
  
  @scala.inline
  implicit class TypographyPropsspanMutableBuilder[Self <: TypographyPropsspan] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setComponent(value: span): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
