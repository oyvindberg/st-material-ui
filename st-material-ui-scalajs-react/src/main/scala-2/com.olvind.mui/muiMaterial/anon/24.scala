...
object `24` {
  ...
  @scala.inline
  def apply[P, D /* <: ElementType */](defaultComponent: D, props: P with BackdropComponent): `24`[P, D] = {
    val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
    __obj.asInstanceOf[`24`[P, D]]
  }
  
  @scala.inline
  implicit class `24MutableBuilder`[Self <: `24`[_, _], P, D /* <: ElementType */] (val x: Self with (`24`[P, D])) extends AnyVal {
