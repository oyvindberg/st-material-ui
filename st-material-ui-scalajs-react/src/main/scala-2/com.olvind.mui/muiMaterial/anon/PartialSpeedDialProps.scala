...
/* Inlined std.Partial<@mui/material.@mui/material/SpeedDial.SpeedDialProps> */
@js.native
trait PartialSpeedDialProps extends StObject {
  
  var FabProps: js.UndefOr[PartialFabPropsdefaultComponent] = js.native
  
  var TransitionComponent: js.UndefOr[JSXElementConstructor[com.olvind.mui.muiMaterial.transitionMod.TransitionProps]] = js.native
  ...
  var onClose: js.UndefOr[
    js.Function2[/* event */ ReactEventFrom[js.Object with Element], /* reason */ CloseReason, Unit]
  ] = js.native
  ...
  var onOpen: js.UndefOr[
    js.Function2[/* event */ ReactEventFrom[js.Object with Element], /* reason */ OpenReason, Unit]
  ] = js.native
...
object PartialSpeedDialProps {
  ...
  @scala.inline
  def apply(): PartialSpeedDialProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialSpeedDialProps]
  }
  
  @scala.inline
  implicit class PartialSpeedDialPropsMutableBuilder[Self <: PartialSpeedDialProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnClose(value: (/* event */ ReactEventFrom[js.Object with Element], /* reason */ CloseReason) => Callback): Self = StObject.set(x, "onClose", js.Any.fromFunction2((t0: /* event */ ReactEventFrom[js.Object with Element], t1: /* reason */ CloseReason) => (value(t0, t1)).runNow()))
    ...
    @scala.inline
    def setOnOpen(value: (/* event */ ReactEventFrom[js.Object with Element], /* reason */ OpenReason) => Callback): Self = StObject.set(x, "onOpen", js.Any.fromFunction2((t0: /* event */ ReactEventFrom[js.Object with Element], t1: /* reason */ OpenReason) => (value(t0, t1)).runNow()))
    ...
    def setTransitionComponent(
      value: com.olvind.mui.muiMaterial.transitionMod.TransitionProps => japgolly.scalajs.react.facade.React.Element | Null
    ): Self = StObject.set(x, "TransitionComponent", js.Any.fromFunction1(value))
