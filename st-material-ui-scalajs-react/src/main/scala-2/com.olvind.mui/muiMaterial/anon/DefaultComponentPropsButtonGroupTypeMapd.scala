...
/* Inlined DefaultComponentProps<ButtonGroupTypeMap<{}, 'div'>> & { readonly component :string | undefined} */
@js.native
trait DefaultComponentPropsButtonGroupTypeMapd extends StObject {
...
object DefaultComponentPropsButtonGroupTypeMapd {
  
  @scala.inline
  def apply(): DefaultComponentPropsButtonGroupTypeMapd = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsButtonGroupTypeMapd]
  }
  
  @scala.inline
  implicit class DefaultComponentPropsButtonGroupTypeMapdMutableBuilder[Self <: DefaultComponentPropsButtonGroupTypeMapd] (val x: Self) extends AnyVal {
