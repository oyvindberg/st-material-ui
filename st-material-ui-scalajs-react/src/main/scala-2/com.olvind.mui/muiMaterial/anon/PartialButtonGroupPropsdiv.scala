...
/* Inlined std.Partial<ButtonGroupProps<'div', {}>> */
@js.native
trait PartialButtonGroupPropsdiv extends StObject {
...
object PartialButtonGroupPropsdiv {
  
  @scala.inline
  def apply(): PartialButtonGroupPropsdiv = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialButtonGroupPropsdiv]
  }
  
  @scala.inline
  implicit class PartialButtonGroupPropsdivMutableBuilder[Self <: PartialButtonGroupPropsdiv] (val x: Self) extends AnyVal {
