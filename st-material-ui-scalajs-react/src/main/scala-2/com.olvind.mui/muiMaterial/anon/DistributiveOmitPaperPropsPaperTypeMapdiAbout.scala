...
/* Inlined @mui/types.@mui/types.DistributiveOmit<PaperProps<PaperTypeMap<{}, 'div'>['defaultComponent'], {}>, 'classes'> */
@js.native
trait DistributiveOmitPaperPropsPaperTypeMapdiAbout extends StObject {
...
object DistributiveOmitPaperPropsPaperTypeMapdiAbout {
  
  @scala.inline
  def apply(): DistributiveOmitPaperPropsPaperTypeMapdiAbout = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DistributiveOmitPaperPropsPaperTypeMapdiAbout]
  }
  
  @scala.inline
  implicit class DistributiveOmitPaperPropsPaperTypeMapdiAboutMutableBuilder[Self <: DistributiveOmitPaperPropsPaperTypeMapdiAbout] (val x: Self) extends AnyVal {
