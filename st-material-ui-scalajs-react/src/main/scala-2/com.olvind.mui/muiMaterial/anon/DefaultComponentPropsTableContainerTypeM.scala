...
/* Inlined DefaultComponentProps<TableContainerTypeMap<{}, 'div'>> & { readonly component :string | undefined} */
@js.native
trait DefaultComponentPropsTableContainerTypeM extends StObject {
...
object DefaultComponentPropsTableContainerTypeM {
  
  @scala.inline
  def apply(): DefaultComponentPropsTableContainerTypeM = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsTableContainerTypeM]
  }
  
  @scala.inline
  implicit class DefaultComponentPropsTableContainerTypeMMutableBuilder[Self <: DefaultComponentPropsTableContainerTypeM] (val x: Self) extends AnyVal {
