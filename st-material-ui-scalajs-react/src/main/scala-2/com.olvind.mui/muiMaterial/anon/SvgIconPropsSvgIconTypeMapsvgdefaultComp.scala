...
object SvgIconPropsSvgIconTypeMapsvgdefaultComp {
  ...
  @scala.inline
  def apply(): SvgIconPropsSvgIconTypeMapsvgdefaultComp = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SvgIconPropsSvgIconTypeMapsvgdefaultComp]
  }
  
  @scala.inline
  implicit class SvgIconPropsSvgIconTypeMapsvgdefaultCompMutableBuilder[Self <: SvgIconPropsSvgIconTypeMapsvgdefaultComp] (val x: Self) extends AnyVal {
