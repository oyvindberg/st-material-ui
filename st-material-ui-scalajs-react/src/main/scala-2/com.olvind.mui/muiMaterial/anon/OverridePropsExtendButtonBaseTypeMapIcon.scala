...
/* Inlined {  href :string} & OverrideProps<ExtendButtonBaseTypeMap<IconButtonTypeMap<{}, 'button'>>, 'a'> */
@js.native
trait OverridePropsExtendButtonBaseTypeMapIcon extends StObject {
...
object OverridePropsExtendButtonBaseTypeMapIcon {
  
  @scala.inline
  def apply(href: String): OverridePropsExtendButtonBaseTypeMapIcon = {
    val __obj = js.Dynamic.literal(href = href.asInstanceOf[js.Any])
    __obj.asInstanceOf[OverridePropsExtendButtonBaseTypeMapIcon]
  }
  
  @scala.inline
  implicit class OverridePropsExtendButtonBaseTypeMapIconMutableBuilder[Self <: OverridePropsExtendButtonBaseTypeMapIcon] (val x: Self) extends AnyVal {
