...
object DefaultComponentPropsExtendButtonBaseTypAlignItems {
  ...
  @scala.inline
  def apply(): DefaultComponentPropsExtendButtonBaseTypAlignItems = {
    val __obj = js.Dynamic.literal(button = true)
    __obj.asInstanceOf[DefaultComponentPropsExtendButtonBaseTypAlignItems]
  }
  
  @scala.inline
  implicit class DefaultComponentPropsExtendButtonBaseTypAlignItemsMutableBuilder[Self <: DefaultComponentPropsExtendButtonBaseTypAlignItems] (val x: Self) extends AnyVal {
