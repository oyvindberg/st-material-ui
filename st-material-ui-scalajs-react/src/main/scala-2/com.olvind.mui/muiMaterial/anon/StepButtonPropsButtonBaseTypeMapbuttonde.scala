...
/* Inlined @mui/material.@mui/material/StepButton.StepButtonProps<@mui/material.@mui/material/ButtonBase.ButtonBaseTypeMap<{}, 'button'>['defaultComponent'], {}> */
@js.native
trait StepButtonPropsButtonBaseTypeMapbuttonde extends StObject {
...
object StepButtonPropsButtonBaseTypeMapbuttonde {
  
  @scala.inline
  def apply(): StepButtonPropsButtonBaseTypeMapbuttonde = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[StepButtonPropsButtonBaseTypeMapbuttonde]
  }
  
  @scala.inline
  implicit class StepButtonPropsButtonBaseTypeMapbuttondeMutableBuilder[Self <: StepButtonPropsButtonBaseTypeMapbuttonde] (val x: Self) extends AnyVal {
