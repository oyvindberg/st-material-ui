...
/* Inlined @mui/types.@mui/types.DistributiveOmit<@mui/material.@mui/material/Link/Link.LinkBaseProps, 'classes'> */
@js.native
trait DistributiveOmitLinkBasePropsclasses extends StObject {
...
object DistributiveOmitLinkBasePropsclasses {
  
  @scala.inline
  def apply(): DistributiveOmitLinkBasePropsclasses = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DistributiveOmitLinkBasePropsclasses]
  }
  
  @scala.inline
  implicit class DistributiveOmitLinkBasePropsclassesMutableBuilder[Self <: DistributiveOmitLinkBasePropsclasses] (val x: Self) extends AnyVal {
