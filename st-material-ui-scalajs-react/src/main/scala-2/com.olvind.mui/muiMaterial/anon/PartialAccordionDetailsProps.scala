...
/* Inlined std.Partial<@mui/material.@mui/material/AccordionDetails.AccordionDetailsProps> */
@js.native
trait PartialAccordionDetailsProps extends StObject {
...
object PartialAccordionDetailsProps {
  
  @scala.inline
  def apply(): PartialAccordionDetailsProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialAccordionDetailsProps]
  }
  
  @scala.inline
  implicit class PartialAccordionDetailsPropsMutableBuilder[Self <: PartialAccordionDetailsProps] (val x: Self) extends AnyVal {
