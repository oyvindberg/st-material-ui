...
/* Inlined {  href :string} & OverrideProps<ExtendButtonBaseTypeMap<ListItemTypeMap<{}, 'div'>>, 'a'> */
@js.native
trait OverridePropsExtendButtonBaseTypeMapList extends StObject {
  ...
  /**
    ...
    */
  var secondaryAction: js.UndefOr[japgolly.scalajs.react.facade.React.Node] = js.native
...
object OverridePropsExtendButtonBaseTypeMapList {
  
  @scala.inline
  def apply(href: String): OverridePropsExtendButtonBaseTypeMapList = {
    val __obj = js.Dynamic.literal(button = true, href = href.asInstanceOf[js.Any])
    __obj.asInstanceOf[OverridePropsExtendButtonBaseTypeMapList]
  }
  
  @scala.inline
  implicit class OverridePropsExtendButtonBaseTypeMapListMutableBuilder[Self <: OverridePropsExtendButtonBaseTypeMapList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setButton(value: `true`): Self = StObject.set(x, "button", value.asInstanceOf[js.Any])
