...
/* Inlined @mui/material.@mui/material/Link.LinkProps<@mui/material.@mui/material/Link/Link.LinkTypeMap<{}, 'a'>['defaultComponent'], {}> */
@js.native
trait LinkPropsLinkTypeMapadefaultComponent extends StObject {
...
object LinkPropsLinkTypeMapadefaultComponent {
  
  @scala.inline
  def apply(): LinkPropsLinkTypeMapadefaultComponent = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[LinkPropsLinkTypeMapadefaultComponent]
  }
  
  @scala.inline
  implicit class LinkPropsLinkTypeMapadefaultComponentMutableBuilder[Self <: LinkPropsLinkTypeMapadefaultComponent] (val x: Self) extends AnyVal {
