...
/* Inlined @mui/material.@mui/material/Toolbar.ToolbarProps<@mui/material.@mui/material/Toolbar/Toolbar.ToolbarTypeMap<{}, 'div'>['defaultComponent'], {}> */
@js.native
trait ToolbarPropsToolbarTypeMapdivdefaultComp extends StObject {
  ...
  /**
    * Override or extend the styles applied to the component.
    */
  var classes: js.UndefOr[PartialToolbarClasses] = js.native
...
object ToolbarPropsToolbarTypeMapdivdefaultComp {
  
  @scala.inline
  def apply(): ToolbarPropsToolbarTypeMapdivdefaultComp = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ToolbarPropsToolbarTypeMapdivdefaultComp]
  }
  
  @scala.inline
  implicit class ToolbarPropsToolbarTypeMapdivdefaultCompMutableBuilder[Self <: ToolbarPropsToolbarTypeMapdivdefaultComp] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialToolbarClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
