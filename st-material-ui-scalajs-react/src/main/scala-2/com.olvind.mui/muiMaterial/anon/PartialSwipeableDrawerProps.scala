...
/* Inlined std.Partial<@mui/material.@mui/material/SwipeableDrawer.SwipeableDrawerProps> */
@js.native
trait PartialSwipeableDrawerProps extends StObject {
  
  var BackdropComponent: js.UndefOr[ElementType] = js.native
  
  var BackdropProps: js.UndefOr[PartialBackdropPropsspan] = js.native
  
  var ModalProps: js.UndefOr[PartialModalPropsdiv] = js.native
  ...
  var classes: js.UndefOr[PartialDrawerClasses] = js.native
  ...
  var onOpen: js.UndefOr[ReactEventHandler[js.Object]] = js.native
...
object PartialSwipeableDrawerProps {
  
  @scala.inline
  def apply(): PartialSwipeableDrawerProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialSwipeableDrawerProps]
  }
  
  @scala.inline
  implicit class PartialSwipeableDrawerPropsMutableBuilder[Self <: PartialSwipeableDrawerProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialDrawerClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setModalProps(value: PartialModalPropsdiv): Self = StObject.set(x, "ModalProps", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnClose(value: ReactEventFrom[js.Object with Element] => Callback): Self = StObject.set(x, "onClose", js.Any.fromFunction1((t0: ReactEventFrom[js.Object with Element]) => value(t0).runNow()))
    ...
    @scala.inline
    def setOnOpen(value: ReactEventFrom[js.Object with Element] => Callback): Self = StObject.set(x, "onOpen", js.Any.fromFunction1((t0: ReactEventFrom[js.Object with Element]) => value(t0).runNow()))
