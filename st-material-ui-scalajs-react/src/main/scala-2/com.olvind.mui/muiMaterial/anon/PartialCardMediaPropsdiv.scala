...
/* Inlined std.Partial<CardMediaProps<'div', {}>> */
@js.native
trait PartialCardMediaPropsdiv extends StObject {
...
object PartialCardMediaPropsdiv {
  
  @scala.inline
  def apply(): PartialCardMediaPropsdiv = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialCardMediaPropsdiv]
  }
  
  @scala.inline
  implicit class PartialCardMediaPropsdivMutableBuilder[Self <: PartialCardMediaPropsdiv] (val x: Self) extends AnyVal {
