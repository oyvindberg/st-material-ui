...
/* Inlined std.Partial<@mui/material.@mui/material/ListItemSecondaryAction.ListItemSecondaryActionProps> */
@js.native
trait PartialListItemSecondaryActionProps extends StObject {
  ...
  var classes: js.UndefOr[PartialListItemSecondaryActionClasses] = js.native
...
object PartialListItemSecondaryActionProps {
  ...
  @scala.inline
  def apply(): PartialListItemSecondaryActionProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialListItemSecondaryActionProps]
  }
  
  @scala.inline
  implicit class PartialListItemSecondaryActionPropsMutableBuilder[Self <: PartialListItemSecondaryActionProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialListItemSecondaryActionClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
