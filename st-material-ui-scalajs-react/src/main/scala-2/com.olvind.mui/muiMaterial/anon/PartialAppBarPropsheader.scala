...
/* Inlined std.Partial<AppBarProps<'header', {}>> */
@js.native
trait PartialAppBarPropsheader extends StObject {
...
object PartialAppBarPropsheader {
  
  @scala.inline
  def apply(): PartialAppBarPropsheader = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialAppBarPropsheader]
  }
  
  @scala.inline
  implicit class PartialAppBarPropsheaderMutableBuilder[Self <: PartialAppBarPropsheader] (val x: Self) extends AnyVal {
