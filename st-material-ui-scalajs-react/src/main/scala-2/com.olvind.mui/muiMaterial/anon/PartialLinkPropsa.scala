...
/* Inlined std.Partial<LinkProps<'a', {}>> */
@js.native
trait PartialLinkPropsa extends StObject {
...
object PartialLinkPropsa {
  
  @scala.inline
  def apply(): PartialLinkPropsa = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialLinkPropsa]
  }
  
  @scala.inline
  implicit class PartialLinkPropsaMutableBuilder[Self <: PartialLinkPropsa] (val x: Self) extends AnyVal {
