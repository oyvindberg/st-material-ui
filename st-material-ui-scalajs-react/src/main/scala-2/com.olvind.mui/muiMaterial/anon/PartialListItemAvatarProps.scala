...
/* Inlined std.Partial<@mui/material.@mui/material/ListItemAvatar.ListItemAvatarProps> */
@js.native
trait PartialListItemAvatarProps extends StObject {
  ...
  var classes: js.UndefOr[PartialListItemAvatarClasses] = js.native
...
object PartialListItemAvatarProps {
  ...
  @scala.inline
  def apply(): PartialListItemAvatarProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialListItemAvatarProps]
  }
  
  @scala.inline
  implicit class PartialListItemAvatarPropsMutableBuilder[Self <: PartialListItemAvatarProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialListItemAvatarClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
