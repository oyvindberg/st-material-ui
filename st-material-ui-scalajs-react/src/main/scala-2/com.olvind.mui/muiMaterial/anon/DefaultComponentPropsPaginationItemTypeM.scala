...
/* Inlined DefaultComponentProps<PaginationItemTypeMap<{}, 'div'>> & { readonly component :string | undefined} */
@js.native
trait DefaultComponentPropsPaginationItemTypeM extends StObject {
...
object DefaultComponentPropsPaginationItemTypeM {
  
  @scala.inline
  def apply(): DefaultComponentPropsPaginationItemTypeM = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsPaginationItemTypeM]
  }
  
  @scala.inline
  implicit class DefaultComponentPropsPaginationItemTypeMMutableBuilder[Self <: DefaultComponentPropsPaginationItemTypeM] (val x: Self) extends AnyVal {
