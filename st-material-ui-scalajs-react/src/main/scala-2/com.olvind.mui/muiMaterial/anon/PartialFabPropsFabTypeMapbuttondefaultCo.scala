...
/* Inlined std.Partial<FabProps<FabTypeMap<{}, 'button'>['defaultComponent'], {}>> */
@js.native
trait PartialFabPropsFabTypeMapbuttondefaultCo extends StObject {
...
object PartialFabPropsFabTypeMapbuttondefaultCo {
  
  @scala.inline
  def apply(): PartialFabPropsFabTypeMapbuttondefaultCo = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialFabPropsFabTypeMapbuttondefaultCo]
  }
  
  @scala.inline
  implicit class PartialFabPropsFabTypeMapbuttondefaultCoMutableBuilder[Self <: PartialFabPropsFabTypeMapbuttondefaultCo] (val x: Self) extends AnyVal {
