...
trait AllowScrollButtonsMobile extends StObject {
  ...
  /**
    ...
    */
  var ScrollButtonComponent: js.UndefOr[ElementType] = js.native
...
object AllowScrollButtonsMobile {
  ...
  implicit class AllowScrollButtonsMobileMutableBuilder[Self <: AllowScrollButtonsMobile] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setActionFunction1(value: TabsActions | Null => Callback): Self = StObject.set(x, "action", js.Any.fromFunction1((t0: TabsActions | Null) => value(t0).runNow()))
    ...
    @scala.inline
    def setScrollButtonComponent(value: ElementType): Self = StObject.set(x, "ScrollButtonComponent", value.asInstanceOf[js.Any])
