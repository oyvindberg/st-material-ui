...
/* Inlined std.Partial<CardHeaderProps<'div', {}, 'span', 'span'>> */
@js.native
trait PartialCardHeaderPropsdivspanspan extends StObject {
...
object PartialCardHeaderPropsdivspanspan {
  
  @scala.inline
  def apply(): PartialCardHeaderPropsdivspanspan = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialCardHeaderPropsdivspanspan]
  }
  
  @scala.inline
  implicit class PartialCardHeaderPropsdivspanspanMutableBuilder[Self <: PartialCardHeaderPropsdivspanspan] (val x: Self) extends AnyVal {
