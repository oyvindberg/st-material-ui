...
/* Inlined std.Partial<StepButtonProps<'button', {}>> */
@js.native
trait PartialStepButtonPropsbutton extends StObject {
...
object PartialStepButtonPropsbutton {
  
  @scala.inline
  def apply(): PartialStepButtonPropsbutton = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialStepButtonPropsbutton]
  }
  
  @scala.inline
  implicit class PartialStepButtonPropsbuttonMutableBuilder[Self <: PartialStepButtonPropsbutton] (val x: Self) extends AnyVal {
