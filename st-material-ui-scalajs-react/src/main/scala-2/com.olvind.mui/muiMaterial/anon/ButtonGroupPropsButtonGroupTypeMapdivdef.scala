...
/* Inlined @mui/material.@mui/material/ButtonGroup.ButtonGroupProps<@mui/material.@mui/material/ButtonGroup/ButtonGroup.ButtonGroupTypeMap<{}, 'div'>['defaultComponent'], {}> */
@js.native
trait ButtonGroupPropsButtonGroupTypeMapdivdef extends StObject {
...
object ButtonGroupPropsButtonGroupTypeMapdivdef {
  
  @scala.inline
  def apply(): ButtonGroupPropsButtonGroupTypeMapdivdef = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ButtonGroupPropsButtonGroupTypeMapdivdef]
  }
  
  @scala.inline
  implicit class ButtonGroupPropsButtonGroupTypeMapdivdefMutableBuilder[Self <: ButtonGroupPropsButtonGroupTypeMapdivdef] (val x: Self) extends AnyVal {
