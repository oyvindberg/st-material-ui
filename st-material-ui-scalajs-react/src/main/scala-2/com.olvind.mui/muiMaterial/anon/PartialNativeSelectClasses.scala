...
/* Inlined std.Partial<@mui/material.@mui/material/NativeSelect/nativeSelectClasses.NativeSelectClasses> */
@js.native
trait PartialNativeSelectClasses extends StObject {
  ...
  var iconOutlined: js.UndefOr[String] = js.native
  
  var iconStandard: js.UndefOr[String] = js.native
  
  var multiple: js.UndefOr[String] = js.native
  
  var nativeInput: js.UndefOr[String] = js.native
...
object PartialNativeSelectClasses {
  
  @scala.inline
  def apply(): PartialNativeSelectClasses = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialNativeSelectClasses]
  }
  
  @scala.inline
  implicit class PartialNativeSelectClassesMutableBuilder[Self <: PartialNativeSelectClasses] (val x: Self) extends AnyVal {
