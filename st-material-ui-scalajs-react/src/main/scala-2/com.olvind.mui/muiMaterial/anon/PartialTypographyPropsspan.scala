...
/* Inlined std.Partial<TypographyProps<'span', {}>> */
@js.native
trait PartialTypographyPropsspan extends StObject {
...
object PartialTypographyPropsspan {
  
  @scala.inline
  def apply(): PartialTypographyPropsspan = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialTypographyPropsspan]
  }
  
  @scala.inline
  implicit class PartialTypographyPropsspanMutableBuilder[Self <: PartialTypographyPropsspan] (val x: Self) extends AnyVal {
