...
/* Inlined DefaultComponentProps<ScopedCssBaselineTypeMap<{}, 'div'>> & { readonly component :string | undefined} */
@js.native
trait DefaultComponentPropsScopedCssBaselineTy extends StObject {
...
object DefaultComponentPropsScopedCssBaselineTy {
  
  @scala.inline
  def apply(): DefaultComponentPropsScopedCssBaselineTy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsScopedCssBaselineTy]
  }
  
  @scala.inline
  implicit class DefaultComponentPropsScopedCssBaselineTyMutableBuilder[Self <: DefaultComponentPropsScopedCssBaselineTy] (val x: Self) extends AnyVal {
