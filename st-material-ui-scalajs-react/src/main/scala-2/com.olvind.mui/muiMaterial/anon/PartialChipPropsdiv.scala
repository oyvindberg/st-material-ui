...
/* Inlined std.Partial<ChipProps<'div', {}>> */
@js.native
trait PartialChipPropsdiv extends StObject {
...
object PartialChipPropsdiv {
  
  @scala.inline
  def apply(): PartialChipPropsdiv = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialChipPropsdiv]
  }
  
  @scala.inline
  implicit class PartialChipPropsdivMutableBuilder[Self <: PartialChipPropsdiv] (val x: Self) extends AnyVal {
