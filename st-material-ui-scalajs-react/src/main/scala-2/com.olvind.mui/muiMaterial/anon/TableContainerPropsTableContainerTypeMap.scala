...
/* Inlined @mui/material.@mui/material/TableContainer.TableContainerProps<@mui/material.@mui/material/TableContainer/TableContainer.TableContainerTypeMap<{}, 'div'>['defaultComponent'], {}> */
@js.native
trait TableContainerPropsTableContainerTypeMap extends StObject {
  ...
  /**
    * Override or extend the styles applied to the component.
    */
  var classes: js.UndefOr[PartialTableContainerClasses] = js.native
...
object TableContainerPropsTableContainerTypeMap {
  
  @scala.inline
  def apply(): TableContainerPropsTableContainerTypeMap = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TableContainerPropsTableContainerTypeMap]
  }
  
  @scala.inline
  implicit class TableContainerPropsTableContainerTypeMapMutableBuilder[Self <: TableContainerPropsTableContainerTypeMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialTableContainerClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
