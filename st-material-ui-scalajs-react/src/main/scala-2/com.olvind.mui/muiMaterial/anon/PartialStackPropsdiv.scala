...
/* Inlined std.Partial<StackProps<'div', {}>> */
@js.native
trait PartialStackPropsdiv extends StObject {
...
object PartialStackPropsdiv {
  
  @scala.inline
  def apply(): PartialStackPropsdiv = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialStackPropsdiv]
  }
  
  @scala.inline
  implicit class PartialStackPropsdivMutableBuilder[Self <: PartialStackPropsdiv] (val x: Self) extends AnyVal {
