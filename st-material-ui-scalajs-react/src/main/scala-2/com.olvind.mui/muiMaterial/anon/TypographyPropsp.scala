...
/* Inlined @mui/material.@mui/material/Typography.TypographyProps<'p', {  component :'p' | undefined}> */
@js.native
trait TypographyPropsp extends StObject {
  ...
  var component: js.UndefOr[p] = js.native
...
object TypographyPropsp {
  
  @scala.inline
  def apply(): TypographyPropsp = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TypographyPropsp]
  }
  
  @scala.inline
  implicit class TypographyPropspMutableBuilder[Self <: TypographyPropsp] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setComponent(value: p): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
