...
object PartialDialogProps {
  ...
  implicit class PartialDialogPropsMutableBuilder[Self <: PartialDialogProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPaperComponent(value: PaperPropsdiv => japgolly.scalajs.react.facade.React.Element | Null): Self = StObject.set(x, "PaperComponent", js.Any.fromFunction1(value))
