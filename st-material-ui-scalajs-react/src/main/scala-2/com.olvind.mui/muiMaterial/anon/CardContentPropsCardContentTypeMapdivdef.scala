...
/* Inlined @mui/material.@mui/material/CardContent.CardContentProps<@mui/material.@mui/material/CardContent/CardContent.CardContentTypeMap<{}, 'div'>['defaultComponent'], {}> */
@js.native
trait CardContentPropsCardContentTypeMapdivdef extends StObject {
  ...
  /**
    * Override or extend the styles applied to the component.
    */
  var classes: js.UndefOr[PartialCardContentClasses] = js.native
...
object CardContentPropsCardContentTypeMapdivdef {
  
  @scala.inline
  def apply(): CardContentPropsCardContentTypeMapdivdef = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CardContentPropsCardContentTypeMapdivdef]
  }
  
  @scala.inline
  implicit class CardContentPropsCardContentTypeMapdivdefMutableBuilder[Self <: CardContentPropsCardContentTypeMapdivdef] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialCardContentClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
