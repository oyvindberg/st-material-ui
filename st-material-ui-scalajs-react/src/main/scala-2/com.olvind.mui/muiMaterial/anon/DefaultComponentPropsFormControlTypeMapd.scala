...
/* Inlined DefaultComponentProps<FormControlTypeMap<{}, 'div'>> & { readonly component :string | undefined} */
@js.native
...
object DefaultComponentPropsFormControlTypeMapd {
  ...
  @scala.inline
  def apply(): DefaultComponentPropsFormControlTypeMapd = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsFormControlTypeMapd]
  }
  
  @scala.inline
  implicit class DefaultComponentPropsFormControlTypeMapdMutableBuilder[Self <: DefaultComponentPropsFormControlTypeMapd] (val x: Self) extends AnyVal {
