...
/* Inlined std.Partial<DialogContentTextProps<'span', {}>> */
@js.native
trait PartialDialogContentTextPropsspan extends StObject {
...
object PartialDialogContentTextPropsspan {
  
  @scala.inline
  def apply(): PartialDialogContentTextPropsspan = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialDialogContentTextPropsspan]
  }
  
  @scala.inline
  implicit class PartialDialogContentTextPropsspanMutableBuilder[Self <: PartialDialogContentTextPropsspan] (val x: Self) extends AnyVal {
