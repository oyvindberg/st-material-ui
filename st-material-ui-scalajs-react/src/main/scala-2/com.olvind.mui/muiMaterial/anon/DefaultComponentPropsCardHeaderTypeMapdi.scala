...
/* Inlined DefaultComponentProps<CardHeaderTypeMap<{}, 'div', 'span', 'span'>> & { readonly component :string | undefined} */
@js.native
trait DefaultComponentPropsCardHeaderTypeMapdi extends StObject {
...
object DefaultComponentPropsCardHeaderTypeMapdi {
  
  @scala.inline
  def apply(): DefaultComponentPropsCardHeaderTypeMapdi = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsCardHeaderTypeMapdi]
  }
  
  @scala.inline
  implicit class DefaultComponentPropsCardHeaderTypeMapdiMutableBuilder[Self <: DefaultComponentPropsCardHeaderTypeMapdi] (val x: Self) extends AnyVal {
