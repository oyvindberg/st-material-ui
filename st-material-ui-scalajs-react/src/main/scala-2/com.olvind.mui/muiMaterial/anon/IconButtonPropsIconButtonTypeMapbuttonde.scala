...
/* Inlined @mui/material.@mui/material/IconButton.IconButtonProps<@mui/material.@mui/material/IconButton/IconButton.IconButtonTypeMap<{}, 'button'>['defaultComponent'], {}> */
@js.native
trait IconButtonPropsIconButtonTypeMapbuttonde extends StObject {
...
object IconButtonPropsIconButtonTypeMapbuttonde {
  
  @scala.inline
  def apply(): IconButtonPropsIconButtonTypeMapbuttonde = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[IconButtonPropsIconButtonTypeMapbuttonde]
  }
  
  @scala.inline
  implicit class IconButtonPropsIconButtonTypeMapbuttondeMutableBuilder[Self <: IconButtonPropsIconButtonTypeMapbuttonde] (val x: Self) extends AnyVal {
