...
import com.olvind.mui.muiMaterial.snackbarSnackbarMod.SnackbarOrigin
...
/* Inlined std.Partial<@mui/material.@mui/material/Snackbar.SnackbarProps> */
@js.native
trait PartialSnackbarPropsAbout extends StObject {
  ...
  var message: js.UndefOr[japgolly.scalajs.react.facade.React.Node] = js.native
...
object PartialSnackbarPropsAbout {
  
  @scala.inline
  def apply(): PartialSnackbarPropsAbout = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialSnackbarPropsAbout]
  }
  
  @scala.inline
  implicit class PartialSnackbarPropsAboutMutableBuilder[Self <: PartialSnackbarPropsAbout] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMessageVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "message", js.Array(value :_*))
