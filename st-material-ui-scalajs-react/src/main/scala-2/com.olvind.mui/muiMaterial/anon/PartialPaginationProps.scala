...
import com.olvind.mui.muiMaterial.paginationPaginationMod.PaginationRenderItemParams
...
/* Inlined std.Partial<@mui/material.@mui/material/Pagination.PaginationProps> */
@js.native
trait PartialPaginationProps extends StObject {
  ...
  var renderItem: js.UndefOr[
    js.Function1[/* params */ PaginationRenderItemParams, japgolly.scalajs.react.facade.React.Node]
  ] = js.native
...
object PartialPaginationProps {
  
  @scala.inline
  def apply(): PartialPaginationProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialPaginationProps]
  }
  
  @scala.inline
  implicit class PartialPaginationPropsMutableBuilder[Self <: PartialPaginationProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRenderItem(value: /* params */ PaginationRenderItemParams => japgolly.scalajs.react.facade.React.Node): Self = StObject.set(x, "renderItem", js.Any.fromFunction1(value))
