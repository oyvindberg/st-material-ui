...
/* Inlined std.Partial<ContainerProps<'div', {}>> */
@js.native
trait PartialContainerPropsdiv extends StObject {
...
object PartialContainerPropsdiv {
  
  @scala.inline
  def apply(): PartialContainerPropsdiv = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialContainerPropsdiv]
  }
  
  @scala.inline
  implicit class PartialContainerPropsdivMutableBuilder[Self <: PartialContainerPropsdiv] (val x: Self) extends AnyVal {
