...
/* Inlined @mui/material.@mui/material/Typography.TypographyProps<@mui/material.@mui/material/Typography/Typography.TypographyTypeMap<{}, 'span'>['defaultComponent'], {}> */
@js.native
...
object TypographyPropsTypographyTypeMapspandefa {
  ...
  @scala.inline
  def apply(): TypographyPropsTypographyTypeMapspandefa = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TypographyPropsTypographyTypeMapspandefa]
  }
  
  @scala.inline
  implicit class TypographyPropsTypographyTypeMapspandefaMutableBuilder[Self <: TypographyPropsTypographyTypeMapspandefa] (val x: Self) extends AnyVal {
