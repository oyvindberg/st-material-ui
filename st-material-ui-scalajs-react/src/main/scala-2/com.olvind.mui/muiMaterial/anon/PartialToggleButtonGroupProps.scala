...
/* Inlined std.Partial<@mui/material.@mui/material/ToggleButtonGroup.ToggleButtonGroupProps> */
@js.native
trait PartialToggleButtonGroupProps extends StObject {
...
object PartialToggleButtonGroupProps {
  
  @scala.inline
  def apply(): PartialToggleButtonGroupProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialToggleButtonGroupProps]
  }
  
  @scala.inline
  implicit class PartialToggleButtonGroupPropsMutableBuilder[Self <: PartialToggleButtonGroupProps] (val x: Self) extends AnyVal {
