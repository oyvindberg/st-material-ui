...
/* Inlined std.Partial<@mui/material.@mui/material/StepConnector.StepConnectorProps> */
@js.native
trait PartialStepConnectorProps extends StObject {
...
object PartialStepConnectorProps {
  ...
  @scala.inline
  def apply(): PartialStepConnectorProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialStepConnectorProps]
  }
  
  @scala.inline
  implicit class PartialStepConnectorPropsMutableBuilder[Self <: PartialStepConnectorProps] (val x: Self) extends AnyVal {
