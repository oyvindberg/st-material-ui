...
object DefaultComponentDProps {
  ...
  @scala.inline
  def apply[P, D /* <: ElementType */](defaultComponent: D, props: P with Icon): DefaultComponentDProps[P, D] = {
    val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
    __obj.asInstanceOf[DefaultComponentDProps[P, D]]
  }
  
  @scala.inline
  implicit class DefaultComponentDPropsMutableBuilder[Self <: DefaultComponentDProps[_, _], P, D /* <: ElementType */] (val x: Self with (DefaultComponentDProps[P, D])) extends AnyVal {
