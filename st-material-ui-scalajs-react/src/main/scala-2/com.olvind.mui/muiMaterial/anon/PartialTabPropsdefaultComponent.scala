...
/* Inlined std.Partial<TabProps<{}['defaultComponent'], {}>> */
@js.native
trait PartialTabPropsdefaultComponent extends StObject {
...
object PartialTabPropsdefaultComponent {
  
  @scala.inline
  def apply(): PartialTabPropsdefaultComponent = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialTabPropsdefaultComponent]
  }
  
  @scala.inline
  implicit class PartialTabPropsdefaultComponentMutableBuilder[Self <: PartialTabPropsdefaultComponent] (val x: Self) extends AnyVal {
