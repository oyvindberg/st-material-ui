...
/* Inlined std.Partial<@mui/material.@mui/material/StepContent.StepContentProps> */
@js.native
...
object PartialStepContentProps {
  ...
  implicit class PartialStepContentPropsMutableBuilder[Self <: PartialStepContentProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTransitionComponent(value: com.olvind.mui.muiMaterial.transitionMod.TransitionProps => Element | Null): Self = StObject.set(x, "TransitionComponent", js.Any.fromFunction1(value))
