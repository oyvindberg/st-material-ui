...
/* Inlined @mui/material.@mui/material/CardHeader.CardHeaderProps<@mui/material.@mui/material/CardHeader/CardHeader.CardHeaderTypeMap<{}, 'div', 'span', 'span'>['defaultComponent'], {}, 'span', 'span'> */
@js.native
trait CardHeaderPropsCardHeaderTypeMapdivspans extends StObject {
  ...
  /**
    ...
    */
  var subheaderTypographyProps: js.UndefOr[TypographyPropsspan] = js.native
  ...
  /**
    ...
    * (as long as disableTypography is not `true`).
    */
  var titleTypographyProps: js.UndefOr[TypographyPropsspan] = js.native
...
object CardHeaderPropsCardHeaderTypeMapdivspans {
  
  @scala.inline
  def apply(): CardHeaderPropsCardHeaderTypeMapdivspans = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CardHeaderPropsCardHeaderTypeMapdivspans]
  }
  
  @scala.inline
  implicit class CardHeaderPropsCardHeaderTypeMapdivspansMutableBuilder[Self <: CardHeaderPropsCardHeaderTypeMapdivspans] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSubheaderTypographyProps(value: TypographyPropsspan): Self = StObject.set(x, "subheaderTypographyProps", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTitleTypographyProps(value: TypographyPropsspan): Self = StObject.set(x, "titleTypographyProps", value.asInstanceOf[js.Any])
