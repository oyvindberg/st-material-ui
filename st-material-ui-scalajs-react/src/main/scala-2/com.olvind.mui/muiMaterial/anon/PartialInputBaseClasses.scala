...
/* Inlined std.Partial<@mui/material.@mui/material/InputBase/inputBaseClasses.InputBaseClasses> */
@js.native
trait PartialInputBaseClasses extends StObject {
  ...
  var hiddenLabel: js.UndefOr[String] = js.native
  ...
  var inputHiddenLabel: js.UndefOr[String] = js.native
  
  var inputMultiline: js.UndefOr[String] = js.native
  
  var inputSizeSmall: js.UndefOr[String] = js.native
...
object PartialInputBaseClasses {
  
  @scala.inline
  def apply(): PartialInputBaseClasses = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialInputBaseClasses]
  }
  
  @scala.inline
  implicit class PartialInputBaseClassesMutableBuilder[Self <: PartialInputBaseClasses] (val x: Self) extends AnyVal {
