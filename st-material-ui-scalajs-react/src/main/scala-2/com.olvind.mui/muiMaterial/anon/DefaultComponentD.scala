...
object DefaultComponentD {
  ...
  @scala.inline
  def apply[P, D /* <: ElementType */](defaultComponent: D, props: P with Color): DefaultComponentD[P, D] = {
    val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
    __obj.asInstanceOf[DefaultComponentD[P, D]]
  }
  
  @scala.inline
  implicit class DefaultComponentDMutableBuilder[Self <: DefaultComponentD[_, _], P, D /* <: ElementType */] (val x: Self with (DefaultComponentD[P, D])) extends AnyVal {
