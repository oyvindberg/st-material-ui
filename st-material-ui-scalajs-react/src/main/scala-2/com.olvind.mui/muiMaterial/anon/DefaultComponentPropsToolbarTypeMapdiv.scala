...
/* Inlined DefaultComponentProps<ToolbarTypeMap<{}, 'div'>> & { readonly component :string | undefined} */
@js.native
trait DefaultComponentPropsToolbarTypeMapdiv extends StObject {
...
object DefaultComponentPropsToolbarTypeMapdiv {
  
  @scala.inline
  def apply(): DefaultComponentPropsToolbarTypeMapdiv = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsToolbarTypeMapdiv]
  }
  
  @scala.inline
  implicit class DefaultComponentPropsToolbarTypeMapdivMutableBuilder[Self <: DefaultComponentPropsToolbarTypeMapdiv] (val x: Self) extends AnyVal {
