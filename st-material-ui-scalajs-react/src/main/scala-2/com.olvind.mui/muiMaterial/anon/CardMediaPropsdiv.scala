...
/* Inlined @mui/material.@mui/material/CardMedia.CardMediaProps<'div', {}> */
@js.native
trait CardMediaPropsdiv extends StObject {
...
object CardMediaPropsdiv {
  
  @scala.inline
  def apply(): CardMediaPropsdiv = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CardMediaPropsdiv]
  }
  
  @scala.inline
  implicit class CardMediaPropsdivMutableBuilder[Self <: CardMediaPropsdiv] (val x: Self) extends AnyVal {
