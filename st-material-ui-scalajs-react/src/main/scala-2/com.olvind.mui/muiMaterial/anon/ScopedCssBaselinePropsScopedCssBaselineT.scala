...
/* Inlined @mui/material.@mui/material/ScopedCssBaseline.ScopedCssBaselineProps<@mui/material.@mui/material/ScopedCssBaseline/ScopedCssBaseline.ScopedCssBaselineTypeMap<{}, 'div'>['defaultComponent'], {}> */
@js.native
trait ScopedCssBaselinePropsScopedCssBaselineT extends StObject {
...
object ScopedCssBaselinePropsScopedCssBaselineT {
  
  @scala.inline
  def apply(): ScopedCssBaselinePropsScopedCssBaselineT = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ScopedCssBaselinePropsScopedCssBaselineT]
  }
  
  @scala.inline
  implicit class ScopedCssBaselinePropsScopedCssBaselineTMutableBuilder[Self <: ScopedCssBaselinePropsScopedCssBaselineT] (val x: Self) extends AnyVal {
