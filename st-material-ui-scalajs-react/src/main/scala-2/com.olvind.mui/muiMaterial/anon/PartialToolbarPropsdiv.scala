...
/* Inlined std.Partial<ToolbarProps<'div', {}>> */
@js.native
trait PartialToolbarPropsdiv extends StObject {
...
object PartialToolbarPropsdiv {
  
  @scala.inline
  def apply(): PartialToolbarPropsdiv = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialToolbarPropsdiv]
  }
  
  @scala.inline
  implicit class PartialToolbarPropsdivMutableBuilder[Self <: PartialToolbarPropsdiv] (val x: Self) extends AnyVal {
