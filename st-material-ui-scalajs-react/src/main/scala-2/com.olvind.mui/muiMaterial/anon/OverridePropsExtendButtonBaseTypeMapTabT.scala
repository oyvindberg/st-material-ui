...
/* Inlined {  href :string} & OverrideProps<ExtendButtonBaseTypeMap<TabTypeMap<{}, 'div'>>, 'a'> */
@js.native
trait OverridePropsExtendButtonBaseTypeMapTabT extends StObject {
...
object OverridePropsExtendButtonBaseTypeMapTabT {
  
  @scala.inline
  def apply(href: String): OverridePropsExtendButtonBaseTypeMapTabT = {
    val __obj = js.Dynamic.literal(href = href.asInstanceOf[js.Any])
    __obj.asInstanceOf[OverridePropsExtendButtonBaseTypeMapTabT]
  }
  
  @scala.inline
  implicit class OverridePropsExtendButtonBaseTypeMapTabTMutableBuilder[Self <: OverridePropsExtendButtonBaseTypeMapTabT] (val x: Self) extends AnyVal {
