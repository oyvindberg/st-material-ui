...
object svgIconSvgIconMod {
  ...
  object SvgIconTypeMap {
    ...
    @scala.inline
    def apply[P, D /* <: ElementType */](defaultComponent: D, props: P with FontSize): SvgIconTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[SvgIconTypeMap[P, D]]
    }
    
    @scala.inline
    implicit class SvgIconTypeMapMutableBuilder[Self <: SvgIconTypeMap[_, _], P, D /* <: ElementType */] (val x: Self with (SvgIconTypeMap[P, D])) extends AnyVal {
