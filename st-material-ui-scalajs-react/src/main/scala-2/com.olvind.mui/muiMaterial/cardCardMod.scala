...
object cardCardMod extends Shortcut {
  ...
  object CardTypeMap {
    ...
    @scala.inline
    def apply[P, D /* <: ElementType */](defaultComponent: D, props: P with DistributiveOmitPaperPropsPaperTypeMapdiAbout with Raised): CardTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[CardTypeMap[P, D]]
    }
    
    @scala.inline
    implicit class CardTypeMapMutableBuilder[Self <: CardTypeMap[_, _], P, D /* <: ElementType */] (val x: Self with (CardTypeMap[P, D])) extends AnyVal {
