...
import com.olvind.mui.muiMaterial.anon.PartialStepIconClasses
...
object stepIconStepIconMod {
  
  @JSImport("@mui/material/StepIcon/StepIcon", JSImport.Namespace)
  @js.native
  ...
  type StepIconClasskey = /* keyof std.NonNullable<@mui/material.anon.PartialStepIconClasses | undefined> */ String
  ...
  trait StepIconProps extends StObject {
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialStepIconClasses] = js.native
  ...
  object StepIconProps {
    ...
    def apply(): StepIconProps = {
      val __obj = js.Dynamic.literal(icon = null)
    ...
    implicit class StepIconPropsMutableBuilder[Self <: StepIconProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClasses(value: PartialStepIconClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
