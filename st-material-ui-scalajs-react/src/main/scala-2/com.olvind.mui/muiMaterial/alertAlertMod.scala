...
import com.olvind.mui.muiMaterial.anon.PartialAlertClasses
import com.olvind.mui.muiMaterial.anon.PartialRecordAlertColorReactNode
...
object alertAlertMod {
  
  @JSImport("@mui/material/Alert/Alert", JSImport.Namespace)
  @js.native
  ...
  /* Rewritten from type alias, can be one of: 
    - `com.olvind.mui`.muiMaterial.muiMaterialStrings.success
    - `com.olvind.mui`.muiMaterial.muiMaterialStrings.info
    - `com.olvind.mui`.muiMaterial.muiMaterialStrings.warning
    - `com.olvind.mui`.muiMaterial.muiMaterialStrings.error
  */
  trait AlertColor extends StObject
  object AlertColor {
    ...
    @scala.inline
    def info: com.olvind.mui.muiMaterial.muiMaterialStrings.info = "info".asInstanceOf[com.olvind.mui.muiMaterial.muiMaterialStrings.info]
    
    @scala.inline
    def success: com.olvind.mui.muiMaterial.muiMaterialStrings.success = "success".asInstanceOf[com.olvind.mui.muiMaterial.muiMaterialStrings.success]
    
    @scala.inline
    def warning: com.olvind.mui.muiMaterial.muiMaterialStrings.warning = "warning".asInstanceOf[com.olvind.mui.muiMaterial.muiMaterialStrings.warning]
  }
  
  /* Inlined parent @mui/material.@mui/material.InternalStandardProps<@mui/material.@mui/material/Paper.PaperProps<@mui/material.@mui/material/Paper/Paper.PaperTypeMap<{}, 'div'>['defaultComponent'], {}>, 'variant'> */
  @js.native
  trait AlertProps extends StObject {
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialAlertClasses] = js.native
    ...
    /**
      ...
      */
    var color: js.UndefOr[AlertColor] = js.native
    ...
    /**
      ...
      */
    var iconMapping: js.UndefOr[PartialRecordAlertColorReactNode] = js.native
    ...
    /**
      ...
      * @default 'success'
      */
    var severity: js.UndefOr[AlertColor] = js.native
    ...
    /**
      ...
      * @default 'standard'
      */
    var variant: js.UndefOr[standard | filled | outlined] = js.native
  ...
  object AlertProps {
    ...
    implicit class AlertPropsMutableBuilder[Self <: AlertProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClasses(value: PartialAlertClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setColor(value: AlertColor): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setIconMapping(value: PartialRecordAlertColorReactNode): Self = StObject.set(x, "iconMapping", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setIconMappingUndefined: Self = StObject.set(x, "iconMapping", js.undefined)
      ...
      @scala.inline
      def setSeverity(value: AlertColor): Self = StObject.set(x, "severity", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setVariant(value: standard | filled | outlined): Self = StObject.set(x, "variant", value.asInstanceOf[js.Any])
