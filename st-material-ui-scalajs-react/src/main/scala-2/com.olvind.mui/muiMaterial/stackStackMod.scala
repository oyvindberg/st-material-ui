...
object stackStackMod extends Shortcut {
  ...
  object StackTypeMap {
    ...
    @scala.inline
    def apply[P, D /* <: ElementType */](defaultComponent: D, props: P with SystemProps[Theme] with Direction): StackTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[StackTypeMap[P, D]]
    }
    
    @scala.inline
    implicit class StackTypeMapMutableBuilder[Self <: StackTypeMap[_, _], P, D /* <: ElementType */] (val x: Self with (StackTypeMap[P, D])) extends AnyVal {
