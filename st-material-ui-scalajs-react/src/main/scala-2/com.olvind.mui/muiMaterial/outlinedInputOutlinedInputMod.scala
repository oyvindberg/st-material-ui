...
object outlinedInputOutlinedInputMod {
  ...
  object default {
    ...
    @scala.inline
    def apply(props: OutlinedInputProps): Element = ^.asInstanceOf[js.Dynamic].apply(props.asInstanceOf[js.Any]).asInstanceOf[Element]
    
    @JSImport("@mui/material/OutlinedInput/OutlinedInput", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@mui/material/OutlinedInput/OutlinedInput", "default.muiName")
    @js.native
  ...
  /* Inlined parent @mui/material.@mui/material.InternalStandardProps<@mui/material.@mui/material/InputBase.InputBaseProps, never> */
  @js.native
  trait OutlinedInputProps extends StObject {
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialOutlinedInputClasses] = js.native
  ...
  object OutlinedInputProps {
    ...
    implicit class OutlinedInputPropsMutableBuilder[Self <: OutlinedInputProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClasses(value: PartialOutlinedInputClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
