...
object dialogContentDialogContentMod {
  
  @JSImport("@mui/material/DialogContent/DialogContent", JSImport.Namespace)
  @js.native
  ...
  trait DialogContentProps extends StObject {
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialDialogContentClasses] = js.native
  ...
  object DialogContentProps {
    ...
    implicit class DialogContentPropsMutableBuilder[Self <: DialogContentProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClasses(value: PartialDialogContentClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
