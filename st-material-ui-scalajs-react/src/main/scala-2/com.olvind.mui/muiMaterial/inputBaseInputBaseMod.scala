...
import com.olvind.mui.muiMaterial.anon.PartialInputBaseClasses
...
object inputBaseInputBaseMod {
  
  @JSImport("@mui/material/InputBase/InputBase", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @scala.inline
  def default(props: InputBaseProps): Element = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(props.asInstanceOf[js.Any]).asInstanceOf[Element]
  
  @js.native
  trait InputBaseComponentProps
    extends StObject
       with HTMLAttributes[HTMLInputElement | HTMLTextAreaElement]
       with // Accommodate arbitrary additional props coming from the `inputProps` prop
  /* arbitrary */ StringDictionary[Any]
  ...
  @js.native
  trait InputBaseComponentsPropsOverrides extends StObject
  
  /* Inlined parent @mui/material.@mui/material.InternalStandardProps<react.react.HTMLAttributes<std.HTMLDivElement>, 'children' | 'onChange' | 'onKeyUp' | 'onKeyDown' | 'onBlur' | 'onFocus' | 'defaultValue'> */
  @js.native
  trait InputBaseProps extends StObject {
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialInputBaseClasses] = js.native
    ...
    var renderSuffix: js.UndefOr[js.Function1[/* state */ Disabled, Node]] = js.native
  ...
  object InputBaseProps {
    ...
    @scala.inline
    implicit class InputBasePropsMutableBuilder[Self <: InputBaseProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClasses(value: PartialInputBaseClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setEndAdornmentVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): Self = StObject.set(x, "endAdornment", js.Array(value :_*))
      ...
      @scala.inline
      def setRenderSuffix(value: /* state */ Disabled => Node): Self = StObject.set(x, "renderSuffix", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setStartAdornmentVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): Self = StObject.set(x, "startAdornment", js.Array(value :_*))
  ...
  @js.native
  trait InputBasePropsColorOverrides extends StObject
  
  @js.native
  trait InputBasePropsSizeOverrides extends StObject
}
