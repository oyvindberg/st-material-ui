...
object toolbarToolbarMod extends Shortcut {
  ...
  object ToolbarTypeMap {
    ...
    @scala.inline
    def apply[P, D /* <: ElementType */](defaultComponent: D, props: P with Variant): ToolbarTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[ToolbarTypeMap[P, D]]
    }
    
    @scala.inline
    implicit class ToolbarTypeMapMutableBuilder[Self <: ToolbarTypeMap[_, _], P, D /* <: ElementType */] (val x: Self with (ToolbarTypeMap[P, D])) extends AnyVal {
