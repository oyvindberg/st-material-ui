...
object cardActionsCardActionsMod {
  
  @JSImport("@mui/material/CardActions/CardActions", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @scala.inline
  def default(props: CardActionsProps): Element = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(props.asInstanceOf[js.Any]).asInstanceOf[Element]
  ...
  trait CardActionsProps extends StObject {
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialCardActionsClasses] = js.native
  ...
  object CardActionsProps {
    ...
    implicit class CardActionsPropsMutableBuilder[Self <: CardActionsProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClasses(value: PartialCardActionsClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
