...
import com.olvind.mui.muiMaterial.anon.PartialSpeedDialClasses
...
object speedDialSpeedDialMod {
  ...
  @JSImport("@mui/material/SpeedDial/SpeedDial", JSImport.Namespace)
  @js.native
  ...
  /* Rewritten from type alias, can be one of: 
    - `com.olvind.mui`.muiMaterial.muiMaterialStrings.toggle
    - `com.olvind.mui`.muiMaterial.muiMaterialStrings.blur
    - `com.olvind.mui`.muiMaterial.muiMaterialStrings.mouseLeave
    - `com.olvind.mui`.muiMaterial.muiMaterialStrings.escapeKeyDown
  */
  trait CloseReason extends StObject
  object CloseReason {
    
    @scala.inline
    def blur: com.olvind.mui.muiMaterial.muiMaterialStrings.blur = "blur".asInstanceOf[com.olvind.mui.muiMaterial.muiMaterialStrings.blur]
    
    @scala.inline
    def escapeKeyDown: com.olvind.mui.muiMaterial.muiMaterialStrings.escapeKeyDown = "escapeKeyDown".asInstanceOf[com.olvind.mui.muiMaterial.muiMaterialStrings.escapeKeyDown]
    
    @scala.inline
    def mouseLeave: com.olvind.mui.muiMaterial.muiMaterialStrings.mouseLeave = "mouseLeave".asInstanceOf[com.olvind.mui.muiMaterial.muiMaterialStrings.mouseLeave]
    
    @scala.inline
    def toggle: com.olvind.mui.muiMaterial.muiMaterialStrings.toggle = "toggle".asInstanceOf[com.olvind.mui.muiMaterial.muiMaterialStrings.toggle]
  }
  
  /* Rewritten from type alias, can be one of: 
    - `com.olvind.mui`.muiMaterial.muiMaterialStrings.toggle
    - `com.olvind.mui`.muiMaterial.muiMaterialStrings.focus
    - `com.olvind.mui`.muiMaterial.muiMaterialStrings.mouseEnter
  */
  trait OpenReason extends StObject
  object OpenReason {
    
    @scala.inline
    def focus: com.olvind.mui.muiMaterial.muiMaterialStrings.focus = "focus".asInstanceOf[com.olvind.mui.muiMaterial.muiMaterialStrings.focus]
    
    @scala.inline
    def mouseEnter: com.olvind.mui.muiMaterial.muiMaterialStrings.mouseEnter = "mouseEnter".asInstanceOf[com.olvind.mui.muiMaterial.muiMaterialStrings.mouseEnter]
    
    @scala.inline
    def toggle: com.olvind.mui.muiMaterial.muiMaterialStrings.toggle = "toggle".asInstanceOf[com.olvind.mui.muiMaterial.muiMaterialStrings.toggle]
  }
  
  /* Inlined parent @mui/material.@mui/material.InternalStandardProps<react.react.HTMLAttributes<std.HTMLDivElement>, 'children'> */
  @js.native
  trait SpeedDialProps extends StObject {
    ...
    /**
      ...
      * @default Zoom
      */
    var TransitionComponent: js.UndefOr[JSXElementConstructor[TransitionProps]] = js.native
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialSpeedDialClasses] = js.native
    ...
    var onClose: js.UndefOr[
        js.Function2[
          /* event */ ReactEventFrom[js.Object with org.scalajs.dom.Element], 
          /* reason */ CloseReason, 
          Unit
        ]
      ] = js.native
  ...
  object SpeedDialProps {
    ...
    @scala.inline
    def apply(ariaLabel: String): SpeedDialProps = {
    ...
    implicit class SpeedDialPropsMutableBuilder[Self <: SpeedDialProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClasses(value: PartialSpeedDialClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setOnClose(
        value: (/* event */ ReactEventFrom[js.Object with org.scalajs.dom.Element], /* reason */ CloseReason) => Callback
      ): Self = StObject.set(x, "onClose", js.Any.fromFunction2((t0: /* event */ ReactEventFrom[js.Object with org.scalajs.dom.Element], t1: /* reason */ CloseReason) => (value(t0, t1)).runNow()))
      ...
      @scala.inline
      def setOnOpen(
        value: (/* event */ ReactEventFrom[js.Object with org.scalajs.dom.Element], /* reason */ OpenReason) => Callback
      ): Self = StObject.set(x, "onOpen", js.Any.fromFunction2((t0: /* event */ ReactEventFrom[js.Object with org.scalajs.dom.Element], t1: /* reason */ OpenReason) => (value(t0, t1)).runNow()))
      ...
      @scala.inline
      def setTransitionComponent(value: TransitionProps => japgolly.scalajs.react.facade.React.Element | Null): Self = StObject.set(x, "TransitionComponent", js.Any.fromFunction1(value))
