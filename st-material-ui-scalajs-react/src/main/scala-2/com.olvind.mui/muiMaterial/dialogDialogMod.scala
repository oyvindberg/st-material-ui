...
object dialogDialogMod {
  ...
  object DialogProps {
    ...
    implicit class DialogPropsMutableBuilder[Self <: DialogProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setPaperComponent(
        value: PaperPropsPaperTypeMapdivdefaultComponen => japgolly.scalajs.react.facade.React.Element | Null
      ): Self = StObject.set(x, "PaperComponent", js.Any.fromFunction1(value))
