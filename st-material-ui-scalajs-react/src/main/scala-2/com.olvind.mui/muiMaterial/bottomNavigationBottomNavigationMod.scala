...
object bottomNavigationBottomNavigationMod extends Shortcut {
  ...
  object BottomNavigationTypeMap {
    ...
    @scala.inline
    def apply[P, D /* <: ElementType */](defaultComponent: D, props: P with OnChange): BottomNavigationTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[BottomNavigationTypeMap[P, D]]
    }
    
    @scala.inline
    implicit class BottomNavigationTypeMapMutableBuilder[Self <: BottomNavigationTypeMap[_, _], P, D /* <: ElementType */] (val x: Self with (BottomNavigationTypeMap[P, D])) extends AnyVal {
