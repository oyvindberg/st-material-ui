...
object stepConnectorStepConnectorMod {
  
  @JSImport("@mui/material/StepConnector/StepConnector", JSImport.Namespace)
  @js.native
  ...
  type StepConnectorClasskey = /* keyof std.NonNullable<@mui/material.anon.PartialStepConnectorClasses | undefined> */ String
  
  type StepConnectorIcon = japgolly.scalajs.react.facade.React.Element | String | Double
  
  /* Inlined parent @mui/material.@mui/material.InternalStandardProps<react.react.HTMLAttributes<std.HTMLDivElement>, 'children'> */
  @js.native
  trait StepConnectorProps extends StObject {
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialStepConnectorClasses] = js.native
  ...
  object StepConnectorProps {
    ...
    @scala.inline
    def apply(): StepConnectorProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[StepConnectorProps]
    }
    
    @scala.inline
    implicit class StepConnectorPropsMutableBuilder[Self <: StepConnectorProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClasses(value: PartialStepConnectorClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
