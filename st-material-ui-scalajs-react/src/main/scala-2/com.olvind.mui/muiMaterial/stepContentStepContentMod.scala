...
import com.olvind.mui.muiMaterial.anon.PartialStepContentClasses
...
object stepContentStepContentMod {
  ...
  @JSImport("@mui/material/StepContent/StepContent", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @scala.inline
  def default(props: StepContentProps): Element = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(props.asInstanceOf[js.Any]).asInstanceOf[Element]
  
  type StepContentClasskey = /* keyof std.NonNullable<@mui/material.anon.PartialStepContentClasses | undefined> */ String
  ...
  trait StepContentProps extends StObject {
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialStepContentClasses] = js.native
  ...
  object StepContentProps {
    ...
    implicit class StepContentPropsMutableBuilder[Self <: StepContentProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClasses(value: PartialStepContentClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
