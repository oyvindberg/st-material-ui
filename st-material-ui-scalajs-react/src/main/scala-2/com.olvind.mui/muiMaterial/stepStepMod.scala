...
object stepStepMod {
  ...
  @JSImport("@mui/material/Step/Step", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @scala.inline
  def default(props: StepProps): Element = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(props.asInstanceOf[js.Any]).asInstanceOf[Element]
  
  type StepClasskey = /* keyof std.NonNullable<@mui/material.anon.PartialStepClasses | undefined> */ String
  ...
  trait StepProps extends StObject {
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialStepClasses] = js.native
  ...
  object StepProps {
    ...
    implicit class StepPropsMutableBuilder[Self <: StepProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClasses(value: PartialStepClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
