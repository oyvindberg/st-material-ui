...
object swipeableDrawerSwipeableDrawerMod extends Shortcut {
  ...
  /* Inlined parent std.Omit<@mui/material.@mui/material/Drawer.DrawerProps, 'onClose' | 'open'> */
  @js.native
  trait SwipeableDrawerProps extends StObject {
    ...
    var ModalProps: js.UndefOr[PartialModalPropsdefaultComponent] = js.native
  ...
  object SwipeableDrawerProps {
    ...
    def apply(
      ...
      val __obj = js.Dynamic.literal(onClose = js.Any.fromFunction1((t0: ReactEventFrom[js.Object with Element]) => onClose(t0).runNow()), onOpen = js.Any.fromFunction1((t0: ReactEventFrom[js.Object with Element]) => onOpen(t0).runNow()), open = open.asInstanceOf[js.Any])
    ...
    implicit class SwipeableDrawerPropsMutableBuilder[Self <: SwipeableDrawerProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setModalProps(value: PartialModalPropsdefaultComponent): Self = StObject.set(x, "ModalProps", value.asInstanceOf[js.Any])
