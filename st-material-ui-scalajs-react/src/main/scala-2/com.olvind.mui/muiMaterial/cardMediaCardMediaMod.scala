...
object cardMediaCardMediaMod extends Shortcut {
  ...
  object CardMediaTypeMap {
    ...
    @scala.inline
    def apply[P, D /* <: ElementType */](defaultComponent: D, props: P with Image): CardMediaTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[CardMediaTypeMap[P, D]]
    }
    
    @scala.inline
    implicit class CardMediaTypeMapMutableBuilder[Self <: CardMediaTypeMap[_, _], P, D /* <: ElementType */] (val x: Self with (CardMediaTypeMap[P, D])) extends AnyVal {
