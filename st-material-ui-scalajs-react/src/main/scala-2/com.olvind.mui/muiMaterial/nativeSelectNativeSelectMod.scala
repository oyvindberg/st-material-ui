...
object nativeSelectNativeSelectMod {
  ...
  object default {
    ...
    @JSImport("@mui/material/NativeSelect/NativeSelect", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@mui/material/NativeSelect/NativeSelect", "default.muiName")
    @js.native
  ...
  /* Inlined parent @mui/material.@mui/material.InternalStandardProps<@mui/material.@mui/material/Input.InputProps, 'inputProps' | 'value' | 'onChange'> */
  @js.native
  trait NativeSelectProps extends StObject {
    ...
    /**
      ...
      * @default {}
      */
    var classes: js.UndefOr[PartialNativeSelectClasses] = js.native
    ...
    /**
      ...
      * @default <Input />
      */
    var input: js.UndefOr[japgolly.scalajs.react.facade.React.Element] = js.native
    ...
    /**
      ...
      */
    var inputProps: js.UndefOr[PartialNativeSelectInputProps] = js.native
  ...
  object NativeSelectProps {
    ...
    implicit class NativeSelectPropsMutableBuilder[Self <: NativeSelectProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClasses(value: PartialNativeSelectClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setInputProps(value: PartialNativeSelectInputProps): Self = StObject.set(x, "inputProps", value.asInstanceOf[js.Any])
