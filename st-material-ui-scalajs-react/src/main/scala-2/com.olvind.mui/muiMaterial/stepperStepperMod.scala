...
object stepperStepperMod {
  ...
  @JSImport("@mui/material/Stepper/Stepper", JSImport.Namespace)
  @js.native
  ...
  */
  ...
  object Orientation {
    ...
    @scala.inline
    def horizontal: com.olvind.mui.muiMaterial.muiMaterialStrings.horizontal = "horizontal".asInstanceOf[com.olvind.mui.muiMaterial.muiMaterialStrings.horizontal]
    
    @scala.inline
    def vertical: com.olvind.mui.muiMaterial.muiMaterialStrings.vertical = "vertical".asInstanceOf[com.olvind.mui.muiMaterial.muiMaterialStrings.vertical]
  }
  
  type StepperClasskey = /* keyof std.NonNullable<@mui/material.anon.PartialStepperClasses | undefined> */ String
  
  /* Inlined parent @mui/material.@mui/material.InternalStandardProps<@mui/material.@mui/material/Paper.PaperProps<@mui/material.@mui/material/Paper/Paper.PaperTypeMap<{}, 'div'>['defaultComponent'], {}>, never> */
  @js.native
  trait StepperProps extends StObject {
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialStepperClasses] = js.native
    ...
    /**
      ...
      */
    var connector: js.UndefOr[japgolly.scalajs.react.facade.React.Element | Null] = js.native
  ...
  object StepperProps {
    ...
    implicit class StepperPropsMutableBuilder[Self <: StepperProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClasses(value: PartialStepperClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setConnector(value: VdomElement): Self = StObject.set(x, "connector", value.rawElement.asInstanceOf[js.Any])
      
      @scala.inline
      def setConnectorNull: Self = StObject.set(x, "connector", null)
      ...
      @scala.inline
      def setNonLinear(value: Boolean): Self = StObject.set(x, "nonLinear", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setNonLinearUndefined: Self = StObject.set(x, "nonLinear", js.undefined)
