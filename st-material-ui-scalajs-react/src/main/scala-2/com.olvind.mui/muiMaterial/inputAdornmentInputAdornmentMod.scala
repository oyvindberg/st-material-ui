...
object inputAdornmentInputAdornmentMod extends Shortcut {
  ...
  object InputAdornmentTypeMap {
    ...
    @scala.inline
    def apply[P, D /* <: ElementType */](defaultComponent: D, props: P with DisablePointerEvents): InputAdornmentTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[InputAdornmentTypeMap[P, D]]
    }
    
    @scala.inline
    implicit class InputAdornmentTypeMapMutableBuilder[Self <: InputAdornmentTypeMap[_, _], P, D /* <: ElementType */] (val x: Self with (InputAdornmentTypeMap[P, D])) extends AnyVal {
