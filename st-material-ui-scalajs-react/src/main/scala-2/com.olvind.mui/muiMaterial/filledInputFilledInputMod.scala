...
object filledInputFilledInputMod {
  ...
  object default {
    ...
    @scala.inline
    def apply(props: FilledInputProps): Element = ^.asInstanceOf[js.Dynamic].apply(props.asInstanceOf[js.Any]).asInstanceOf[Element]
    
    @JSImport("@mui/material/FilledInput/FilledInput", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@mui/material/FilledInput/FilledInput", "default.muiName")
    @js.native
  ...
  trait FilledInputProps extends StObject {
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialFilledInputClasses] = js.native
  ...
  object FilledInputProps {
    ...
    implicit class FilledInputPropsMutableBuilder[Self <: FilledInputProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClasses(value: PartialFilledInputClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
