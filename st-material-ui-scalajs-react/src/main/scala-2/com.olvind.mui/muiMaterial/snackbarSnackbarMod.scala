...
import com.olvind.mui.muiMaterial.anon.PartialClickAwayListenerProps
import com.olvind.mui.muiMaterial.anon.PartialSnackbarClasses
...
object snackbarSnackbarMod {
  ...
  @JSImport("@mui/material/Snackbar/Snackbar", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @scala.inline
  def default(props: SnackbarProps): Element = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(props.asInstanceOf[js.Any]).asInstanceOf[Element]
  
  /* Rewritten from type alias, can be one of: 
    - `com.olvind.mui`.muiMaterial.muiMaterialStrings.timeout
    - `com.olvind.mui`.muiMaterial.muiMaterialStrings.clickaway
    - `com.olvind.mui`.muiMaterial.muiMaterialStrings.escapeKeyDown
  */
  trait SnackbarCloseReason extends StObject
  object SnackbarCloseReason {
    
    @scala.inline
    def clickaway: com.olvind.mui.muiMaterial.muiMaterialStrings.clickaway = "clickaway".asInstanceOf[com.olvind.mui.muiMaterial.muiMaterialStrings.clickaway]
  ...
  @js.native
  trait SnackbarOrigin extends StObject {
  ...
  object SnackbarOrigin {
    ...
    @scala.inline
    implicit class SnackbarOriginMutableBuilder[Self <: SnackbarOrigin] (val x: Self) extends AnyVal {
      
      @scala.inline
      def setHorizontal(value: left | center | right): Self = StObject.set(x, "horizontal", value.asInstanceOf[js.Any])
  ...
  trait SnackbarProps extends StObject {
    ...
    /**
      ...
      */
    var action: js.UndefOr[Node] = js.native
    ...
    /**
      ...
      * @default null
      */
    var autoHideDuration: js.UndefOr[Double | Null] = js.native
    ...
    /**
      ...
      */
    var children: js.UndefOr[japgolly.scalajs.react.facade.React.Element] = js.native
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialSnackbarClasses] = js.native
    ...
    /**
      ...
      */
    var key: js.UndefOr[Any] = js.native
    ...
    /**
      ...
      */
    var message: js.UndefOr[Node] = js.native
    ...
    var onClose: js.UndefOr[
        js.Function2[
          /* event */ (ReactEventFrom[Any with org.scalajs.dom.Element]) | Event, 
  ...
  object SnackbarProps {
    ...
    implicit class SnackbarPropsMutableBuilder[Self <: SnackbarProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setActionVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): Self = StObject.set(x, "action", js.Array(value :_*))
      ...
      @scala.inline
      def setAutoHideDurationNull: Self = StObject.set(x, "autoHideDuration", null)
      ...
      @scala.inline
      def setClasses(value: PartialSnackbarClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setClassesUndefined: Self = StObject.set(x, "classes", js.undefined)
      
      @scala.inline
      def setClickAwayListenerProps(value: PartialClickAwayListenerProps): Self = StObject.set(x, "ClickAwayListenerProps", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setContentProps(value: PartialSnackbarContentProps): Self = StObject.set(x, "ContentProps", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setKey(value: Any): Self = StObject.set(x, "key", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setMessage(value: VdomNode): Self = StObject.set(x, "message", value.rawNode.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setMessageVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): Self = StObject.set(x, "message", js.Array(value :_*))
      
      @scala.inline
      def setMessageVdomElement(value: VdomElement): Self = StObject.set(x, "message", value.rawElement.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setOnClose(
        value: (/* event */ (ReactEventFrom[Any with org.scalajs.dom.Element]) | Event, /* reason */ SnackbarCloseReason) => Callback
      ): Self = StObject.set(x, "onClose", js.Any.fromFunction2((t0: /* event */ (ReactEventFrom[Any with org.scalajs.dom.Element]) | Event, t1: /* reason */ SnackbarCloseReason) => (value(t0, t1)).runNow()))
