...
object listItemSecondaryActionListItemSecondaryActionMod {
  ...
  object default {
    ...
    @JSImport("@mui/material/ListItemSecondaryAction/ListItemSecondaryAction", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@mui/material/ListItemSecondaryAction/ListItemSecondaryAction", "default.muiName")
    @js.native
