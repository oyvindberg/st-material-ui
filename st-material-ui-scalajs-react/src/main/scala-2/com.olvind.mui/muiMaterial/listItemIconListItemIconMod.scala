...
object listItemIconListItemIconMod {
  
  @JSImport("@mui/material/ListItemIcon/ListItemIcon", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @scala.inline
  def default(props: ListItemIconProps): Element = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(props.asInstanceOf[js.Any]).asInstanceOf[Element]
  ...
  trait ListItemIconProps extends StObject {
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialListItemIconClasses] = js.native
  ...
  object ListItemIconProps {
    ...
    implicit class ListItemIconPropsMutableBuilder[Self <: ListItemIconProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClasses(value: PartialListItemIconClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
