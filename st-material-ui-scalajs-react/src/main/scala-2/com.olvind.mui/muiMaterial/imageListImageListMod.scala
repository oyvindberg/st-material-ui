...
object imageListImageListMod extends Shortcut {
  ...
  object ImageListTypeMap {
    ...
    @scala.inline
    def apply[P, D /* <: ElementType */](defaultComponent: D, props: P with Cols): ImageListTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[ImageListTypeMap[P, D]]
    }
    
    @scala.inline
    implicit class ImageListTypeMapMutableBuilder[Self <: ImageListTypeMap[_, _], P, D /* <: ElementType */] (val x: Self with (ImageListTypeMap[P, D])) extends AnyVal {
