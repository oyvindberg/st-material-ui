...
object dialogContentTextDialogContentTextMod extends Shortcut {
  ...
  object DialogContentTextTypeMap {
    ...
    @scala.inline
    def apply[P, D /* <: ElementType */](defaultComponent: D, props: P with ClassesSx with OmitTypographyTypeMapspanpropsclasses): DialogContentTextTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[DialogContentTextTypeMap[P, D]]
    }
    
    @scala.inline
    implicit class DialogContentTextTypeMapMutableBuilder[Self <: DialogContentTextTypeMap[_, _], P, D /* <: ElementType */] (val x: Self with (DialogContentTextTypeMap[P, D])) extends AnyVal {
