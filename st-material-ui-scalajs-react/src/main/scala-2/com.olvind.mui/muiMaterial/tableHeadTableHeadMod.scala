...
object tableHeadTableHeadMod extends Shortcut {
  ...
  object TableHeadTypeMap {
    ...
    @scala.inline
    def apply[P, D /* <: ElementType */](defaultComponent: D, props: P with `33`): TableHeadTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[TableHeadTypeMap[P, D]]
    }
    
    @scala.inline
    implicit class TableHeadTypeMapMutableBuilder[Self <: TableHeadTypeMap[_, _], P, D /* <: ElementType */] (val x: Self with (TableHeadTypeMap[P, D])) extends AnyVal {
