...
object paginationItemPaginationItemMod extends Shortcut {
  ...
  object PaginationItemTypeMap {
    ...
    @scala.inline
    def apply[P, D /* <: ElementType */](defaultComponent: D, props: P with Page): PaginationItemTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[PaginationItemTypeMap[P, D]]
    }
    
    @scala.inline
    implicit class PaginationItemTypeMapMutableBuilder[Self <: PaginationItemTypeMap[_, _], P, D /* <: ElementType */] (val x: Self with (PaginationItemTypeMap[P, D])) extends AnyVal {
