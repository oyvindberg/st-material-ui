...
object accordionActionsAccordionActionsMod {
  
  @JSImport("@mui/material/AccordionActions/AccordionActions", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @scala.inline
  def default(props: AccordionActionsProps): Element = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(props.asInstanceOf[js.Any]).asInstanceOf[Element]
  
  /* Inlined parent @mui/material.@mui/material.InternalStandardProps<react.react.HTMLAttributes<std.HTMLDivElement>, never> */
  @js.native
  trait AccordionActionsProps extends StObject {
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialAccordionActionsClasses] = js.native
    ...
    /**
      ...
      * @default false
      */
    var disableSpacing: js.UndefOr[Boolean] = js.native
  ...
  object AccordionActionsProps {
    
    @scala.inline
    def apply(): AccordionActionsProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[AccordionActionsProps]
    }
    
    @scala.inline
    implicit class AccordionActionsPropsMutableBuilder[Self <: AccordionActionsProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClasses(value: PartialAccordionActionsClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setDisableSpacing(value: Boolean): Self = StObject.set(x, "disableSpacing", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setDisableSpacingUndefined: Self = StObject.set(x, "disableSpacing", js.undefined)
