...
object stylesMod {
  ...
  @scala.inline
  def ThemeProvider[T](props: ThemeProviderProps[T]): japgolly.scalajs.react.facade.React.Element = ^.asInstanceOf[js.Dynamic].applyDynamic("ThemeProvider")(props.asInstanceOf[js.Any]).asInstanceOf[japgolly.scalajs.react.facade.React.Element]
