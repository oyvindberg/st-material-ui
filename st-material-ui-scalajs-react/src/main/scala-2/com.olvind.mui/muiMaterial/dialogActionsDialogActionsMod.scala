...
object dialogActionsDialogActionsMod {
  
  @JSImport("@mui/material/DialogActions/DialogActions", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @scala.inline
  def default(props: DialogActionsProps): Element = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(props.asInstanceOf[js.Any]).asInstanceOf[Element]
  ...
  trait DialogActionsProps extends StObject {
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialDialogActionsClasses] = js.native
  ...
  object DialogActionsProps {
    ...
    implicit class DialogActionsPropsMutableBuilder[Self <: DialogActionsProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClasses(value: PartialDialogActionsClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
