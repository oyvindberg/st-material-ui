...
object tabsTabsMod extends Shortcut {
  ...
  object TabsActions {
    ...
    @scala.inline
    def apply(updateIndicator: Callback, updateScrollButtons: Callback): TabsActions = {
    ...
    implicit class TabsActionsMutableBuilder[Self <: TabsActions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setUpdateIndicator(value: Callback): Self = StObject.set(x, "updateIndicator", value.toJsFn)
      
      @scala.inline
      def setUpdateScrollButtons(value: Callback): Self = StObject.set(x, "updateScrollButtons", value.toJsFn)
    }
  }
  ...
  object TabsTypeMap {
    ...
    @scala.inline
    def apply[P, D /* <: ElementType */](defaultComponent: D, props: P with AllowScrollButtonsMobile): TabsTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[TabsTypeMap[P, D]]
    }
    
    @scala.inline
    implicit class TabsTypeMapMutableBuilder[Self <: TabsTypeMap[_, _], P, D /* <: ElementType */] (val x: Self with (TabsTypeMap[P, D])) extends AnyVal {
