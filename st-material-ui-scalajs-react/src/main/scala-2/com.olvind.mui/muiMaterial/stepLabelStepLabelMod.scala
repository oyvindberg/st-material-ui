...
object stepLabelStepLabelMod {
  ...
  trait StepLabelProps extends StObject {
    ...
    /**
      ...
      */
    var StepIconComponent: js.UndefOr[ElementType] = js.native
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialStepLabelClasses] = js.native
    ...
    /**
      ...
      * @default {}
      */
    var componentsProps: js.UndefOr[Label] = js.native
  ...
  object StepLabelProps {
    ...
    implicit class StepLabelPropsMutableBuilder[Self <: StepLabelProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClasses(value: PartialStepLabelClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setComponentsProps(value: Label): Self = StObject.set(x, "componentsProps", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setOptionalVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): Self = StObject.set(x, "optional", js.Array(value :_*))
      ...
      @scala.inline
      def setStepIconComponent(value: ElementType): Self = StObject.set(x, "StepIconComponent", value.asInstanceOf[js.Any])
