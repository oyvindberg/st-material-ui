...
import com.olvind.mui.muiMaterial.anon.PartialMobileStepperClasses
...
import com.olvind.mui.muiMaterial.muiMaterialStrings.dots
...
import com.olvind.mui.muiMaterial.muiMaterialStrings.progress
...
object mobileStepperMobileStepperMod {
  
  @JSImport("@mui/material/MobileStepper/MobileStepper", JSImport.Namespace)
  @js.native
  ...
  /* Inlined parent @mui/material.@mui/material.InternalStandardProps<@mui/material.@mui/material/Paper.PaperProps<@mui/material.@mui/material/Paper/Paper.PaperTypeMap<{}, 'div'>['defaultComponent'], {}>, 'children' | 'variant'> */
  @js.native
  trait MobileStepperProps extends StObject {
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialMobileStepperClasses] = js.native
  ...
  object MobileStepperProps {
    ...
    @scala.inline
    def apply(steps: Double): MobileStepperProps = {
      val __obj = js.Dynamic.literal(steps = steps.asInstanceOf[js.Any], backButton = null, nextButton = null)
      __obj.asInstanceOf[MobileStepperProps]
    }
    
    @scala.inline
    implicit class MobileStepperPropsMutableBuilder[Self <: MobileStepperProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setBackButton(value: VdomNode): Self = StObject.set(x, "backButton", value.rawNode.asInstanceOf[js.Any])
      
      @scala.inline
      def setBackButtonNull: Self = StObject.set(x, "backButton", null)
      
      @scala.inline
      def setBackButtonVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): Self = StObject.set(x, "backButton", js.Array(value :_*))
      
      @scala.inline
      def setBackButtonVdomElement(value: VdomElement): Self = StObject.set(x, "backButton", value.rawElement.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setClasses(value: PartialMobileStepperClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setLinearProgressProps(value: PartialLinearProgressProps): Self = StObject.set(x, "LinearProgressProps", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setLinearProgressPropsUndefined: Self = StObject.set(x, "LinearProgressProps", js.undefined)
      
      @scala.inline
      def setNextButton(value: VdomNode): Self = StObject.set(x, "nextButton", value.rawNode.asInstanceOf[js.Any])
      
      @scala.inline
      def setNextButtonNull: Self = StObject.set(x, "nextButton", null)
      
      @scala.inline
      def setNextButtonVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): Self = StObject.set(x, "nextButton", js.Array(value :_*))
      
      @scala.inline
      def setNextButtonVdomElement(value: VdomElement): Self = StObject.set(x, "nextButton", value.rawElement.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setPosition(value: bottom | top | static): Self = StObject.set(x, "position", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setVariant(value: text | dots | progress): Self = StObject.set(x, "variant", value.asInstanceOf[js.Any])
