...
object mod {
  ...
  trait EmotionCache extends StObject {
    ...
    def insert(selector: String, serialized: SerializedStyles, sheet: StyleSheet, shouldCache: Boolean): String | Unit = js.native
  ...
  object EmotionCache {
    ...
    implicit class EmotionCacheMutableBuilder[Self <: EmotionCache] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setInsert(value: (String, SerializedStyles, StyleSheet, Boolean) => String | Unit): Self = StObject.set(x, "insert", js.Any.fromFunction4(value))
  ...
  object StyleSheet {
    ...
    implicit class StyleSheetMutableBuilder[Self <: StyleSheet] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFlush(value: Callback): Self = StObject.set(x, "flush", value.toJsFn)
      
      @scala.inline
      def setInsert(value: String => Callback): Self = StObject.set(x, "insert", js.Any.fromFunction1((t0: String) => value(t0).runNow()))
