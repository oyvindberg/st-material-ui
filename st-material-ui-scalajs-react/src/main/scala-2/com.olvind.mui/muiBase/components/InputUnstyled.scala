...
import com.olvind.mui.muiBase.anon.Input
import com.olvind.mui.muiBase.anon.InputRoot
...
object InputUnstyled {
  
  @JSImport("@mui/base", "InputUnstyled")
  @js.native
  ...
  class Builder (val args: js.Array[Any]) extends StBuildingComponent[HTMLDivElement] {
    ...
    @scala.inline
    def components(value: Input): this.type = set("components", value.asInstanceOf[js.Any])
    
    @scala.inline
    def componentsProps(value: InputRoot): this.type = set("componentsProps", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def onBlur(value: ReactFocusEventFrom[org.scalajs.dom.Element with org.scalajs.dom.Element] => Callback): this.type = set("onBlur", js.Any.fromFunction1((t0: ReactFocusEventFrom[org.scalajs.dom.Element with org.scalajs.dom.Element]) => value(t0).runNow()))
    ...
    @scala.inline
    def onChange(value: ReactEventFrom[HTMLInputElement with org.scalajs.dom.Element] => Callback): this.type = set("onChange", js.Any.fromFunction1((t0: ReactEventFrom[HTMLInputElement with org.scalajs.dom.Element]) => value(t0).runNow()))
    
    @scala.inline
    def onClick(value: ReactMouseEventFrom[org.scalajs.dom.Element with org.scalajs.dom.Element] => Callback): this.type = set("onClick", js.Any.fromFunction1((t0: ReactMouseEventFrom[org.scalajs.dom.Element with org.scalajs.dom.Element]) => value(t0).runNow()))
    ...
    @scala.inline
    def onFocus(value: ReactFocusEventFrom[org.scalajs.dom.Element with org.scalajs.dom.Element] => Callback): this.type = set("onFocus", js.Any.fromFunction1((t0: ReactFocusEventFrom[org.scalajs.dom.Element with org.scalajs.dom.Element]) => value(t0).runNow()))
    ...
    @scala.inline
    def onKeyDown(value: ReactKeyboardEventFrom[HTMLInputElement with org.scalajs.dom.Element] => Callback): this.type = set("onKeyDown", js.Any.fromFunction1((t0: ReactKeyboardEventFrom[HTMLInputElement with org.scalajs.dom.Element]) => value(t0).runNow()))
    ...
    @scala.inline
    def onKeyUp(value: ReactKeyboardEventFrom[HTMLInputElement with org.scalajs.dom.Element] => Callback): this.type = set("onKeyUp", js.Any.fromFunction1((t0: ReactKeyboardEventFrom[HTMLInputElement with org.scalajs.dom.Element]) => value(t0).runNow()))
  ...
  implicit def make(companion: InputUnstyled.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
