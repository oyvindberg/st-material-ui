...
object popperUnstyledPopperUnstyledMod {
  ...
  /* Inlined parent std.Omit<react.react.HTMLAttributes<std.HTMLDivElement>, 'children'> */
  @js.native
  trait PopperUnstyledProps extends StObject {
    ...
    /**
      ...
      */
    var children: js.UndefOr[Node | (js.Function1[/* props */ Placement, Node])] = js.native
  ...
  object PopperUnstyledProps {
    
    @scala.inline
    def apply(open: Boolean): PopperUnstyledProps = {
      val __obj = js.Dynamic.literal(open = open.asInstanceOf[js.Any])
      __obj.asInstanceOf[PopperUnstyledProps]
    }
    
    @scala.inline
    implicit class PopperUnstyledPropsMutableBuilder[Self <: PopperUnstyledProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setChildren(value: Node | (js.Function1[/* props */ Placement, Node])): Self = StObject.set(x, "children", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setChildrenFunction1(value: /* props */ Placement => Node): Self = StObject.set(x, "children", js.Any.fromFunction1(value))
