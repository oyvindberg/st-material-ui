...
/* Inlined std.Partial<BackdropUnstyledProps<BackdropUnstyledTypeMap<{}, 'div'>['defaultComponent'], {}>> */
@js.native
trait PartialBackdropUnstyledPropsBackdropUnst extends StObject {
...
object PartialBackdropUnstyledPropsBackdropUnst {
  
  @scala.inline
  def apply(): PartialBackdropUnstyledPropsBackdropUnst = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialBackdropUnstyledPropsBackdropUnst]
  }
  
  @scala.inline
  implicit class PartialBackdropUnstyledPropsBackdropUnstMutableBuilder[Self <: PartialBackdropUnstyledPropsBackdropUnst] (val x: Self) extends AnyVal {
