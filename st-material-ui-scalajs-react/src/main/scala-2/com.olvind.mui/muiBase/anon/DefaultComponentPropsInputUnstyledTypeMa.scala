...
/* Inlined @mui/types.@mui/types.DefaultComponentProps<@mui/base.@mui/base/InputUnstyled/InputUnstyledProps.InputUnstyledTypeMap<{}, 'div'>> */
@js.native
trait DefaultComponentPropsInputUnstyledTypeMa extends StObject {
  ...
  /**
    ...
    * @default {}
    */
  var components: js.UndefOr[Input] = js.native
  
  /**
    * The props used for each slot inside the Input.
    * @default {}
    */
  var componentsProps: js.UndefOr[InputRoot] = js.native
...
object DefaultComponentPropsInputUnstyledTypeMa {
  
  @scala.inline
  def apply(): DefaultComponentPropsInputUnstyledTypeMa = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsInputUnstyledTypeMa]
  }
  
  @scala.inline
  implicit class DefaultComponentPropsInputUnstyledTypeMaMutableBuilder[Self <: DefaultComponentPropsInputUnstyledTypeMa] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setComponents(value: Input): Self = StObject.set(x, "components", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setComponentsProps(value: InputRoot): Self = StObject.set(x, "componentsProps", value.asInstanceOf[js.Any])
