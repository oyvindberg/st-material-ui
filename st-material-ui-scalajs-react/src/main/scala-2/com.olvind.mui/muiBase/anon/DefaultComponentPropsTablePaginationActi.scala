...
/* Inlined @mui/types.@mui/types.DefaultComponentProps<@mui/base.@mui/base/TablePaginationUnstyled/TablePaginationActionsUnstyledProps.TablePaginationActionsUnstyledTypeMap<{}, 'button'>> */
@js.native
trait DefaultComponentPropsTablePaginationActi extends StObject {
  ...
  /**
    ...
    * @default {}
    */
  var components: js.UndefOr[BackButton] = js.native
  
  /**
    * The props used for each slot inside the TablePagination.
    * @default {}
    */
  var componentsProps: js.UndefOr[FirstButton] = js.native
