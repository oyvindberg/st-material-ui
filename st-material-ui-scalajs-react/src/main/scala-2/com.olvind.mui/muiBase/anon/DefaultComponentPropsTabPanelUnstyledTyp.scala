...
/* Inlined @mui/types.@mui/types.DefaultComponentProps<@mui/base.@mui/base/TabPanelUnstyled/TabPanelUnstyledProps.TabPanelUnstyledTypeMap<{}, 'div'>> */
@js.native
trait DefaultComponentPropsTabPanelUnstyledTyp extends StObject {
  ...
  /**
    ...
    * @default {}
    */
  var componentsProps: js.UndefOr[`5`] = js.native
...
object DefaultComponentPropsTabPanelUnstyledTyp {
  
  @scala.inline
  def apply(value: Double | String): DefaultComponentPropsTabPanelUnstyledTyp = {
    val __obj = js.Dynamic.literal(value = value.asInstanceOf[js.Any])
    __obj.asInstanceOf[DefaultComponentPropsTabPanelUnstyledTyp]
  }
  
  @scala.inline
  implicit class DefaultComponentPropsTabPanelUnstyledTypMutableBuilder[Self <: DefaultComponentPropsTabPanelUnstyledTyp] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setComponentsProps(value: `5`): Self = StObject.set(x, "componentsProps", value.asInstanceOf[js.Any])
