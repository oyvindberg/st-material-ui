...
/* Inlined @mui/types.@mui/types.DefaultComponentProps<@mui/base.@mui/base/FormControlUnstyled/FormControlUnstyledProps.FormControlUnstyledTypeMap<{}, 'div'>> */
@js.native
trait DefaultComponentPropsFormControlUnstyled extends StObject {
  ...
  var componentsProps: js.UndefOr[`2`] = js.native
  ...
  /**
    ...
    * @default {}
    */
  var extraContextProperties: js.UndefOr[js.Object] = js.native
...
object DefaultComponentPropsFormControlUnstyled {
  
  @scala.inline
  def apply(): DefaultComponentPropsFormControlUnstyled = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsFormControlUnstyled]
  }
  
  @scala.inline
  implicit class DefaultComponentPropsFormControlUnstyledMutableBuilder[Self <: DefaultComponentPropsFormControlUnstyled] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setComponentsProps(value: `2`): Self = StObject.set(x, "componentsProps", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setExtraContextProperties(value: js.Object): Self = StObject.set(x, "extraContextProperties", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setExtraContextPropertiesUndefined: Self = StObject.set(x, "extraContextProperties", js.undefined)
    ...
    @scala.inline
    def setOnChange(value: ReactEventFrom[NativeFormControlElement with org.scalajs.dom.Element] => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: ReactEventFrom[NativeFormControlElement with org.scalajs.dom.Element]) => value(t0).runNow()))
