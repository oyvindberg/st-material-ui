...
/* Inlined @mui/types.@mui/types.DefaultComponentProps<@mui/base.@mui/base/TabsListUnstyled/TabsListUnstyledProps.TabsListUnstyledTypeMap<{}, 'div'>> */
@js.native
trait DefaultComponentPropsTabsListUnstyledTyp extends StObject {
  ...
  /**
    ...
    * @default {}
    */
  var componentsProps: js.UndefOr[`8`] = js.native
...
object DefaultComponentPropsTabsListUnstyledTyp {
  
  @scala.inline
  def apply(): DefaultComponentPropsTabsListUnstyledTyp = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsTabsListUnstyledTyp]
  }
  
  @scala.inline
  implicit class DefaultComponentPropsTabsListUnstyledTypMutableBuilder[Self <: DefaultComponentPropsTabsListUnstyledTyp] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setComponentsProps(value: `8`): Self = StObject.set(x, "componentsProps", value.asInstanceOf[js.Any])
