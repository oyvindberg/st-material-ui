...
/* Inlined react.react.ComponentPropsWithRef<'div'> & {  ownerState :@mui/base.@mui/base/InputUnstyled/InputUnstyledProps.InputOwnerState} */
@js.native
trait ComponentPropsWithRefdiv extends StObject {
...
object ComponentPropsWithRefdiv {
  
  @scala.inline
  def apply(ownerState: InputOwnerState): ComponentPropsWithRefdiv = {
    val __obj = js.Dynamic.literal(ownerState = ownerState.asInstanceOf[js.Any])
    __obj.asInstanceOf[ComponentPropsWithRefdiv]
  }
  
  @scala.inline
  implicit class ComponentPropsWithRefdivMutableBuilder[Self <: ComponentPropsWithRefdiv] (val x: Self) extends AnyVal {
