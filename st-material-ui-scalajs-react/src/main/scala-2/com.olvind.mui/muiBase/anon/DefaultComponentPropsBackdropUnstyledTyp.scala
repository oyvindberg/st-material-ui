...
/* Inlined @mui/types.@mui/types.DefaultComponentProps<@mui/base.@mui/base/BackdropUnstyled/BackdropUnstyled.BackdropUnstyledTypeMap<{}, 'div'>> */
@js.native
trait DefaultComponentPropsBackdropUnstyledTyp extends StObject {
  ...
  /**
    ...
    * @default {}
    */
  var componentsProps: js.UndefOr[`0`] = js.native
...
object DefaultComponentPropsBackdropUnstyledTyp {
  
  @scala.inline
  def apply(): DefaultComponentPropsBackdropUnstyledTyp = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsBackdropUnstyledTyp]
  }
  
  @scala.inline
  implicit class DefaultComponentPropsBackdropUnstyledTypMutableBuilder[Self <: DefaultComponentPropsBackdropUnstyledTyp] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setComponentsProps(value: `0`): Self = StObject.set(x, "componentsProps", value.asInstanceOf[js.Any])
