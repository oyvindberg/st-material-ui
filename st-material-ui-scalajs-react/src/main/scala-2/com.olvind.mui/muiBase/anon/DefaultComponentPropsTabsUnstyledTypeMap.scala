...
/* Inlined @mui/types.@mui/types.DefaultComponentProps<@mui/base.@mui/base/TabsUnstyled/TabsUnstyledProps.TabsUnstyledTypeMap<{}, 'div'>> */
@js.native
trait DefaultComponentPropsTabsUnstyledTypeMap extends StObject {
  ...
  /**
    ...
    * @default {}
    */
  var componentsProps: js.UndefOr[`9`] = js.native
...
object DefaultComponentPropsTabsUnstyledTypeMap {
  
  @scala.inline
  def apply(): DefaultComponentPropsTabsUnstyledTypeMap = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsTabsUnstyledTypeMap]
  }
  
  @scala.inline
  implicit class DefaultComponentPropsTabsUnstyledTypeMapMutableBuilder[Self <: DefaultComponentPropsTabsUnstyledTypeMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setComponentsProps(value: `9`): Self = StObject.set(x, "componentsProps", value.asInstanceOf[js.Any])
