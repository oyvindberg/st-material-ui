...
object inputUnstyledPropsMod {
  
  /* Inlined parent std.Omit<@mui/base.@mui/base/InputUnstyled/InputUnstyledProps.InputUnstyledProps<@mui/base.@mui/base/InputUnstyled/InputUnstyledProps.InputUnstyledTypeMap<{}, 'div'>['defaultComponent'], {}>, 'component' | 'components' | 'componentsProps'> */
  @js.native
  trait InputOwnerState extends StObject {
    ...
    var formControl: FormControlUnstyledState = js.native
  ...
  object InputOwnerState {
    ...
    @scala.inline
    def apply(focused: Boolean, formControl: FormControlUnstyledState): InputOwnerState = {
      val __obj = js.Dynamic.literal(focused = focused.asInstanceOf[js.Any], formControl = formControl.asInstanceOf[js.Any])
      __obj.asInstanceOf[InputOwnerState]
    }
    
    @scala.inline
    implicit class InputOwnerStateMutableBuilder[Self <: InputOwnerState] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFormControl(value: FormControlUnstyledState): Self = StObject.set(x, "formControl", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setOnKeyDown(value: ReactKeyboardEventFrom[HTMLInputElement with Element] => Callback): Self = StObject.set(x, "onKeyDown", js.Any.fromFunction1((t0: ReactKeyboardEventFrom[HTMLInputElement with Element]) => value(t0).runNow()))
      ...
      @scala.inline
      def setOnKeyUp(value: ReactKeyboardEventFrom[HTMLInputElement with Element] => Callback): Self = StObject.set(x, "onKeyUp", js.Any.fromFunction1((t0: ReactKeyboardEventFrom[HTMLInputElement with Element]) => value(t0).runNow()))
  ...
  object UseInputProps {
    ...
    @scala.inline
    def apply(): UseInputProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[UseInputProps]
    }
    
    @scala.inline
    implicit class UseInputPropsMutableBuilder[Self <: UseInputProps] (val x: Self) extends AnyVal {
