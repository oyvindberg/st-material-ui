...
object flourescentTwoToneMod {
  ...
  object default {
    ...
    @JSImport("@mui/icons-material/FlourescentTwoTone", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@mui/icons-material/FlourescentTwoTone", "default.muiName")
    @js.native
