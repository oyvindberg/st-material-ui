package com.olvind.mui.muiIconsMaterial
...
object signalWifiStatusbarConnectedNoInternet4OutlinedMod {
  ...
  object default {
    ...
    @JSImport("@mui/icons-material/SignalWifiStatusbarConnectedNoInternet4Outlined", "default.muiName")
    @js.native
