...
import com.olvind.mui.muiSystem.anon.DefaultComponentPropsStackTypeMapdiv
...
object Stack {
  ...
  @JSImport("@mui/system/Stack/Stack", JSImport.Default)
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def direction(value: ResponsiveStyleValue["row" | "row-reverse" | "column" | "column-reverse"]): this.type = set("direction", value.asInstanceOf[js.Any])
    
    inline def directionVarargs(value: (("row" | "row-reverse" | "column" | "column-reverse") | Null)*): this.type = set("direction", js.Array(value*))
    ...
    inline def divider(value: VdomNode): this.type = set("divider", value.rawNode.asInstanceOf[js.Any])
    ...
    inline def spacing(value: ResponsiveStyleValue[Double | String]): this.type = set("spacing", value.asInstanceOf[js.Any])
    
    inline def spacingVarargs(value: ((Double | String) | Null)*): this.type = set("spacing", js.Array(value*))
  ...
  type Props = /* props */ DefaultComponentPropsStackTypeMapdiv
  
  implicit def make(companion: Stack.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def styled: com.olvind.mui.StyledComponent.Builder[/* props */ DefaultComponentPropsStackTypeMapdiv, Builder] = new com.olvind.mui.StyledComponent.Builder[/* props */ DefaultComponentPropsStackTypeMapdiv, Builder](this.component, new js.Object, js.Array(), (newComponent: Any) => new Builder(js.Array(newComponent, js.Dictionary.empty)))
  
  def withProps(p: /* props */ DefaultComponentPropsStackTypeMapdiv): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
