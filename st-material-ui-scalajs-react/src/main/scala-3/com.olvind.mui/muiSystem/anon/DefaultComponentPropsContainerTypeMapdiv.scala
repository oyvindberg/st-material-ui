...
/* Inlined @mui/types.@mui/types.DefaultComponentProps<@mui/system.@mui/system/Container/ContainerProps.ContainerTypeMap<{}, 'div'>> */
...
object DefaultComponentPropsContainerTypeMapdiv {
  ...
  inline def apply(): DefaultComponentPropsContainerTypeMapdiv = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsContainerTypeMapdiv]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DefaultComponentPropsContainerTypeMapdiv] (val x: Self) extends AnyVal {
