...
object shapeMod extends Shortcut {
  ...
  object Shape {
    ...
    inline def apply(borderRadius: Double | String): Shape = {
    ...
    extension [Self <: Shape](x: Self) {
      ...
      inline def setBorderRadius(value: Double | String): Self = StObject.set(x, "borderRadius", value.asInstanceOf[js.Any])
    }
  }
  ...
  trait ShapeOptions extends StObject {
    ...
    var borderRadius: js.UndefOr[Double | String] = js.undefined
  }
  object ShapeOptions {
