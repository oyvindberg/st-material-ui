...
object FlourescentTwoTone {
  
  @JSImport("@mui/icons-material", "FlourescentTwoTone")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: FlourescentTwoTone.type): SharedBuilder_DefaultComponentPropsSvgIconTypeMapsvg1028217032[SVGSVGElement] = new SharedBuilder_DefaultComponentPropsSvgIconTypeMapsvg1028217032[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
