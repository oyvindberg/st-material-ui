...
trait EventTarget extends StObject {
  ...
  def addEventListener(`type`: java.lang.String, listener: Null, options: Boolean): Unit = js.native
  ...
  def removeEventListener(`type`: java.lang.String, callback: EventListenerOrEventListenerObject, options: Boolean): Unit = js.native
  def removeEventListener(`type`: java.lang.String, callback: Null, options: org.scalajs.dom.EventListenerOptions): Unit = js.native
  def removeEventListener(`type`: java.lang.String, callback: Null, options: Boolean): Unit = js.native
}
