...
trait Event extends StObject {
  ...
  def initEvent(`type`: java.lang.String, bubbles: Boolean): Unit = js.native
  def initEvent(`type`: java.lang.String, bubbles: Boolean, cancelable: Boolean): Unit = js.native
  def initEvent(`type`: java.lang.String, bubbles: Unit, cancelable: Boolean): Unit = js.native
