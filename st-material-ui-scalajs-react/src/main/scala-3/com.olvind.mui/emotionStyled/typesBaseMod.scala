...
object typesBaseMod extends Shortcut {
  ...
  trait CreateStyled extends StObject {
    ...
    def apply[ForwardedProps /* <: /* keyof react.react.ComponentProps<react.react.ComponentClass<react.react.ComponentProps<any>, react.react.ComponentState>> */ String */](
      component: ComponentClassP[ComponentProps[Any] & js.Object],
      options: FilteringStyledOptions[ComponentProps[ComponentClassP[ComponentProps[Any] & js.Object]], ForwardedProps]
    ): CreateStyledComponent[
        (Pick[PropsOf[ComponentClassP[ComponentProps[Any] & js.Object]], ForwardedProps]) & `0`, 
        js.Object, 
        js.Object
      ] = js.native
    @JSName("<apply>")
