...
/* Rewritten from type alias, can be one of: 
  ...
  - `com.olvind.mui`.csstype.csstypeStrings.balance
  - `com.olvind.mui`.csstype.csstypeStrings.`balance-all`
...
*/
trait ColumnFill extends StObject
object ColumnFill {
  ...
  inline def balance: com.olvind.mui.csstype.csstypeStrings.balance = "balance".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.balance]
  
  inline def `balance-all`: com.olvind.mui.csstype.csstypeStrings.`balance-all` = "balance-all".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.`balance-all`]
