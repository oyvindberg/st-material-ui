...
object ColorAdjust {
  ...
  inline def economy: com.olvind.mui.csstype.csstypeStrings.economy = "economy".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.economy]
  
  inline def exact: com.olvind.mui.csstype.csstypeStrings.exact = "exact".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.exact]
