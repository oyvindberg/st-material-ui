...
/* Rewritten from type alias, can be one of: 
  - `com.olvind.mui`.csstype.csstypeStrings.flat
  - `com.olvind.mui`.csstype.csstypeStrings.`preserve-3d`
...
object TransformStyle {
  ...
  inline def flat: com.olvind.mui.csstype.csstypeStrings.flat = "flat".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.flat]
  ...
  inline def `preserve-3d`: com.olvind.mui.csstype.csstypeStrings.`preserve-3d` = "preserve-3d".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.`preserve-3d`]
