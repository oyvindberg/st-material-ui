...
/* Rewritten from type alias, can be one of: 
  - `com.olvind.mui`.csstype.csstypeStrings.ltr
  - `com.olvind.mui`.csstype.csstypeStrings.rtl
...
object Direction {
  ...
  inline def ltr: com.olvind.mui.csstype.csstypeStrings.ltr = "ltr".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.ltr]
  ...
  inline def rtl: com.olvind.mui.csstype.csstypeStrings.rtl = "rtl".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.rtl]
