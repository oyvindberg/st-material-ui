...
object VectorEffect {
  ...
  inline def `non-scaling-stroke`: com.olvind.mui.csstype.csstypeStrings.`non-scaling-stroke` = "non-scaling-stroke".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.`non-scaling-stroke`]
