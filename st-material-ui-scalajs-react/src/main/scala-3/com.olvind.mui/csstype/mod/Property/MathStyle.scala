...
/* Rewritten from type alias, can be one of: 
  - `com.olvind.mui`.csstype.csstypeStrings.compact
...
object MathStyle {
  ...
  inline def compact: com.olvind.mui.csstype.csstypeStrings.compact = "compact".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.compact]
