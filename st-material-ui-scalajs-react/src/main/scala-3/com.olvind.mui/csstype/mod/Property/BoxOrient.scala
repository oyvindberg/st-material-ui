...
/* Rewritten from type alias, can be one of: 
  - `com.olvind.mui`.csstype.csstypeStrings.`block-axis`
  - `com.olvind.mui`.csstype.csstypeStrings.horizontal
  - `com.olvind.mui`.csstype.csstypeStrings.inherit
  - `com.olvind.mui`.csstype.csstypeStrings.`inline-axis`
...
object BoxOrient {
  ...
  inline def `block-axis`: com.olvind.mui.csstype.csstypeStrings.`block-axis` = "block-axis".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.`block-axis`]
  ...
  inline def `inline-axis`: com.olvind.mui.csstype.csstypeStrings.`inline-axis` = "inline-axis".asInstanceOf[com.olvind.mui.csstype.csstypeStrings.`inline-axis`]
