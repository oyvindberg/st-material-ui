...
object StandardLonghandProperties {
  ...
  extension [Self <: StandardLonghandProperties[?, ?], TLength, TTime](x: Self & (StandardLonghandProperties[TLength, TTime])) {
    ...
    inline def setColorAdjust(value: ColorAdjust): Self = StObject.set(x, "colorAdjust", value.asInstanceOf[js.Any])
    ...
    inline def setTextDecorationWidth(value: TextDecorationThickness[TLength]): Self = StObject.set(x, "textDecorationWidth", value.asInstanceOf[js.Any])
