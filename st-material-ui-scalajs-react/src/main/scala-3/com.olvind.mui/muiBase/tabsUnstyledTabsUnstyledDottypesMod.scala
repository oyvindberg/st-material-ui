...
object tabsUnstyledTabsUnstyledDottypesMod {
  
  object TabsUnstyledDirection {
  ...
  object TabsUnstyledOrientation {
  ...
  /* Inlined @mui/base.@mui/base/TabsUnstyled/TabsUnstyled.types.TabsUnstyledProps<@mui/base.@mui/base/TabsUnstyled/TabsUnstyled.types.TabsUnstyledTypeMap<{}, 'div'>['defaultComponent'], {}> & {  orientation :@mui/base.@mui/base/TabsUnstyled/TabsUnstyled.types.TabsUnstyledOrientation,   direction :@mui/base.@mui/base/TabsUnstyled/TabsUnstyled.types.TabsUnstyledDirection} */
  trait TabsUnstyledOwnerState extends StObject {
    ...
    /**
      ...
      * @default {}
      */
    var slots: js.UndefOr[TabsUnstyledSlots] = js.undefined
  ...
  object TabsUnstyledOwnerState {
    
    inline def apply(): TabsUnstyledOwnerState = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[TabsUnstyledOwnerState]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: TabsUnstyledOwnerState] (val x: Self) extends AnyVal {
      ...
      inline def setSlots(value: TabsUnstyledSlots): Self = StObject.set(x, "slots", value.asInstanceOf[js.Any])
  ...
  trait TabsUnstyledRootSlotPropsOverrides extends StObject
  
  trait TabsUnstyledSlots extends StObject {
  ...
  object TabsUnstyledSlots {
    
    inline def apply(): TabsUnstyledSlots = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[TabsUnstyledSlots]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: TabsUnstyledSlots] (val x: Self) extends AnyVal {
