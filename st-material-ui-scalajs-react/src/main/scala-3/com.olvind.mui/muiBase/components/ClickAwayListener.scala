...
object ClickAwayListener {
  ...
  @JSImport("@mui/base/ClickAwayListener/ClickAwayListener", JSImport.Default)
  @js.native
  ...
  def styled: com.olvind.mui.StyledComponent.Builder[ClickAwayListenerProps, Builder] = new com.olvind.mui.StyledComponent.Builder[ClickAwayListenerProps, Builder](this.component, new js.Object, js.Array(), (newComponent: Any) => new Builder(js.Array(newComponent, js.Dictionary.empty)))
