...
import com.olvind.mui.muiBase.anon.DefaultComponentPropsSnackbarUnstyledTyp
...
object SnackbarUnstyled {
  ...
  @JSImport("@mui/base/SnackbarUnstyled", JSImport.Default)
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def exited(value: Boolean): this.type = set("exited", value.asInstanceOf[js.Any])
    ...
    inline def onClose(
      value: (/* event */ (ReactEventFrom[Any & Element]) | Event | Null, /* reason */ SnackbarCloseReason) => Callback
    ): this.type = set("onClose", js.Any.fromFunction2((t0: /* event */ (ReactEventFrom[Any & Element]) | Event | Null, t1: /* reason */ SnackbarCloseReason) => (value(t0, t1)).runNow()))
    ...
    inline def slotProps(value: com.olvind.mui.muiBase.anon.ClickAwayListener): this.type = set("slotProps", value.asInstanceOf[js.Any])
    
    inline def slots(value: SnackbarUnstyledSlots): this.type = set("slots", value.asInstanceOf[js.Any])
  ...
  type Props = /* props */ DefaultComponentPropsSnackbarUnstyledTyp
  
  implicit def make(companion: SnackbarUnstyled.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def styled: com.olvind.mui.StyledComponent.Builder[/* props */ DefaultComponentPropsSnackbarUnstyledTyp, Builder] = new com.olvind.mui.StyledComponent.Builder[/* props */ DefaultComponentPropsSnackbarUnstyledTyp, Builder](this.component, new js.Object, js.Array(), (newComponent: Any) => new Builder(js.Array(newComponent, js.Dictionary.empty)))
  
  def withProps(p: /* props */ DefaultComponentPropsSnackbarUnstyledTyp): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
