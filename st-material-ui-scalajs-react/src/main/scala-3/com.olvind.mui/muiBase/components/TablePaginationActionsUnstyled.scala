...
import com.olvind.mui.muiBase.tablePaginationUnstyledTablePaginationActionsUnstyledDottypesMod.TablePaginationActionsUnstyledSlots
...
object TablePaginationActionsUnstyled {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def slotProps(value: BackButton): this.type = set("slotProps", value.asInstanceOf[js.Any])
    
    inline def slots(value: TablePaginationActionsUnstyledSlots): this.type = set("slots", value.asInstanceOf[js.Any])
  ...
  type Props = /* props */ DefaultComponentPropsTablePaginationActi
  
  def styled: com.olvind.mui.StyledComponent.Builder[/* props */ DefaultComponentPropsTablePaginationActi, Builder] = new com.olvind.mui.StyledComponent.Builder[/* props */ DefaultComponentPropsTablePaginationActi, Builder](this.component, new js.Object, js.Array(), (newComponent: Any) => new Builder(js.Array(newComponent, js.Dictionary.empty)))
