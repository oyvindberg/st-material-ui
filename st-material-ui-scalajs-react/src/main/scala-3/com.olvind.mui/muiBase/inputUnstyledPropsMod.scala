...
object inputUnstyledPropsMod {
  ...
  trait InputOwnerState extends StObject {
    ...
    var formControl: FormControlUnstyledState
  ...
  object InputOwnerState {
    ...
    inline def apply(focused: Boolean, formControl: FormControlUnstyledState): InputOwnerState = {
    ...
    extension [Self <: InputOwnerState](x: Self) {
      ...
      inline def setFormControl(value: FormControlUnstyledState): Self = StObject.set(x, "formControl", value.asInstanceOf[js.Any])
