...
import com.olvind.mui.muiBase.tabsListUnstyledTabsListUnstyledDottypesMod.TabsListUnstyledSlots
...
/* Inlined @mui/types.@mui/types.DefaultComponentProps<@mui/base.@mui/base/TabsListUnstyled/TabsListUnstyled.types.TabsListUnstyledTypeMap<{}, 'div'>> */
