...
/* Inlined @mui/types.@mui/types.DefaultComponentProps<@mui/base.@mui/base/TabPanelUnstyled/TabPanelUnstyled.types.TabPanelUnstyledTypeMap<{}, 'div'>> */
...
object DefaultComponentPropsTabPanelUnstyledTyp {
  ...
  inline def apply(value: Double | String): DefaultComponentPropsTabPanelUnstyledTyp = {
    val __obj = js.Dynamic.literal(value = value.asInstanceOf[js.Any])
    __obj.asInstanceOf[DefaultComponentPropsTabPanelUnstyledTyp]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DefaultComponentPropsTabPanelUnstyledTyp] (val x: Self) extends AnyVal {
