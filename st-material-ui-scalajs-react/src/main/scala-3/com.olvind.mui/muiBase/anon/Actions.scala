...
import com.olvind.mui.muiBase.tablePaginationUnstyledTablePaginationActionsUnstyledDottypesMod.TablePaginationActionsUnstyledTypeMap
...
trait Actions extends StObject {
  ...
  var actions: js.UndefOr[
    SlotComponentProps[
      OverridableComponent[TablePaginationActionsUnstyledTypeMap[js.Object, "button"]], 
  ...
  implicit open class MutableBuilder[Self <: Actions] (val x: Self) extends AnyVal {
    ...
    inline def setActionsFunction1(
      value: TablePaginationUnstyledOwnerState => (Partial[
          ComponentPropsWithRef[OverridableComponent[TablePaginationActionsUnstyledTypeMap[js.Object, "button"]]]
        ]) & TablePaginationUnstyledActionsSlotPropsOverrides
