...
/* Inlined @mui/types.@mui/types.DefaultComponentProps<@mui/base.@mui/base/InputUnstyled/InputUnstyled.types.InputUnstyledTypeMap<{}, 'div'>> */
trait DefaultComponentPropsInputUnstyledTypeMa extends StObject {
  ...
  /**
    ...
    * @default {}
    */
  var slots: js.UndefOr[InputUnstyledSlots] = js.undefined
...
object DefaultComponentPropsInputUnstyledTypeMa {
  ...
  inline def apply(`type`: Unit): DefaultComponentPropsInputUnstyledTypeMa = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DefaultComponentPropsInputUnstyledTypeMa] (val x: Self) extends AnyVal {
    ...
    inline def setSlots(value: InputUnstyledSlots): Self = StObject.set(x, "slots", value.asInstanceOf[js.Any])
