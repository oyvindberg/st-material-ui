...
trait DefaultComponentPropsInputUnstyledTypeMa extends StObject {
  ...
  /**
    ...
    * @default {}
    */
  var components: js.UndefOr[Input] = js.undefined
...
object DefaultComponentPropsInputUnstyledTypeMa {
  ...
  inline def apply(): DefaultComponentPropsInputUnstyledTypeMa = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsInputUnstyledTypeMa]
  }
  
  extension [Self <: DefaultComponentPropsInputUnstyledTypeMa](x: Self) {
    ...
    inline def setComponents(value: Input): Self = StObject.set(x, "components", value.asInstanceOf[js.Any])
