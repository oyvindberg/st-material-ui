...
/* Inlined @mui/types.@mui/types.DefaultComponentProps<@mui/base.@mui/base/SnackbarUnstyled/SnackbarUnstyled.types.SnackbarUnstyledTypeMap<{}, 'div'>> */
trait DefaultComponentPropsSnackbarUnstyledTyp extends StObject {
  ...
  /**
    ...
    * @default true
    */
  var exited: js.UndefOr[Boolean] = js.undefined
  ...
  var onClose: js.UndefOr[
    js.Function2[
      /* event */ (ReactEventFrom[Any & Element]) | Event | Null, 
  ...
  /**
    ...
    * @default {}
    */
  var slotProps: js.UndefOr[ClickAwayListener] = js.undefined
...
object DefaultComponentPropsSnackbarUnstyledTyp {
  
  inline def apply(): DefaultComponentPropsSnackbarUnstyledTyp = {
  ...
  extension [Self <: DefaultComponentPropsSnackbarUnstyledTyp](x: Self) {
    ...
    ): Self = StObject.set(x, "onClose", js.Any.fromFunction2((t0: /* event */ (ReactEventFrom[Any & Element]) | Event | Null, t1: /* reason */ SnackbarCloseReason) => (value(t0, t1)).runNow()))
    ...
    inline def setSlotProps(value: ClickAwayListener): Self = StObject.set(x, "slotProps", value.asInstanceOf[js.Any])
