...
/* Inlined Omit<InputUnstyledProps<InputUnstyledTypeMap<{}, 'div'>['defaultComponent'], {}>, 'component' | 'slots' | 'slotProps'> & {  formControlContext :@mui/base.@mui/base/FormControlUnstyled.FormControlUnstyledState | undefined,   focused :boolean,   type :react.react.InputHTMLAttributes<std.HTMLInputElement>['type'] | undefined} */
trait OmitInputUnstyledPropsInputUnstyledTypeM extends StObject {
...
object OmitInputUnstyledPropsInputUnstyledTypeM {
  
  inline def apply(focused: Boolean, `type`: Unit): OmitInputUnstyledPropsInputUnstyledTypeM = {
    val __obj = js.Dynamic.literal(focused = focused.asInstanceOf[js.Any], multiline = true)
