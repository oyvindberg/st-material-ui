...
/* Inlined @mui/types.@mui/types.DefaultComponentProps<@mui/base.@mui/base/FormControlUnstyled/FormControlUnstyled.types.FormControlUnstyledTypeMap<{}, 'div'>> */
...
object DefaultComponentPropsFormControlUnstyled {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DefaultComponentPropsFormControlUnstyled] (val x: Self) extends AnyVal {
