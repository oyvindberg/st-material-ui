...
object PickTextareaAutosizePropshiddencolorstyl {
  ...
  implicit open class MutableBuilder[Self <: PickTextareaAutosizePropshiddencolorstyl] (val x: Self) extends AnyVal {
    ...
    inline def setOnChange(value: ReactEventFrom[HTMLTextAreaElement & Element] => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: ReactEventFrom[HTMLTextAreaElement & Element]) => value(t0).runNow()))
    ...
    inline def setOnInput(value: ReactEventFrom[HTMLTextAreaElement & Element] => Callback): Self = StObject.set(x, "onInput", js.Any.fromFunction1((t0: ReactEventFrom[HTMLTextAreaElement & Element]) => value(t0).runNow()))
    ...
    inline def setOnResize(value: ReactEventFrom[HTMLTextAreaElement & Element] => Callback): Self = StObject.set(x, "onResize", js.Any.fromFunction1((t0: ReactEventFrom[HTMLTextAreaElement & Element]) => value(t0).runNow()))
