...
trait SingleLineInputUnstyledPropsOmitUseInput extends StObject {
  ...
  /**
    ...
    * @default false
    */
  var multiline: js.UndefOr[false] = js.undefined
...
object SingleLineInputUnstyledPropsOmitUseInput {
  
  inline def apply(maxRows: Unit, minRows: Unit, rows: Unit): SingleLineInputUnstyledPropsOmitUseInput = {
    val __obj = js.Dynamic.literal(maxRows = maxRows.asInstanceOf[js.Any], minRows = minRows.asInstanceOf[js.Any], rows = rows.asInstanceOf[js.Any])
    __obj.asInstanceOf[SingleLineInputUnstyledPropsOmitUseInput]
  }
  
  extension [Self <: SingleLineInputUnstyledPropsOmitUseInput](x: Self) {
    ...
    inline def setMaxRows(value: Unit): Self = StObject.set(x, "maxRows", value.asInstanceOf[js.Any])
    
    inline def setMinRows(value: Unit): Self = StObject.set(x, "minRows", value.asInstanceOf[js.Any])
    
    inline def setMultiline(value: false): Self = StObject.set(x, "multiline", value.asInstanceOf[js.Any])
    ...
    inline def setRows(value: Unit): Self = StObject.set(x, "rows", value.asInstanceOf[js.Any])
