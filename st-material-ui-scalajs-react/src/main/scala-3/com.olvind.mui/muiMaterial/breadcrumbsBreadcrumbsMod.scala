...
object breadcrumbsBreadcrumbsMod extends Shortcut {
  ...
  trait BreadcrumbsCollapsedIconSlotPropsOverrides extends StObject
  
  /* Inlined parent @mui/material.@mui/material/Breadcrumbs/Breadcrumbs.BreadcrumbsProps<@mui/material.@mui/material/Breadcrumbs/Breadcrumbs.BreadcrumbsTypeMap<{}, 'nav'>['defaultComponent'], {}> */
  ...
  object BreadcrumbsOwnerState {
    ...
    inline def apply(expanded: Boolean): BreadcrumbsOwnerState = {
