...
object stylesMod {
  ...
  /* import warning: parser.TsParser#tsDeclVar Dropped IArray(useColorScheme, getInitColorSchemeScript) */ inline def ExperimentalCssVarsProvider(props: PropsWithChildrenPartialCssVarsProviderC): Element = ^.asInstanceOf[js.Dynamic].applyDynamic("Experimental_CssVarsProvider")(props.asInstanceOf[js.Any]).asInstanceOf[Element]
  
  inline def StyledEngineProvider(props: StyledEngineProviderProps): com.olvind.mui.react.mod.global.JSX.Element = ^.asInstanceOf[js.Dynamic].applyDynamic("StyledEngineProvider")(props.asInstanceOf[js.Any]).asInstanceOf[com.olvind.mui.react.mod.global.JSX.Element]
