...
object backdropBackdropMod extends Shortcut {
  ...
  type BackdropProps[D /* <: ElementType */, P] = OverrideProps[BackdropTypeMap[D, P], D]
  ...
  type BackdropTypeMap[D /* <: ElementType */, P] = ExtendBackdropUnstyledTypeMap[DefaultComponentProps[P, D]]
