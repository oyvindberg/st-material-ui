...
/* Inlined std.Partial<@mui/material.@mui/material/SvgIcon/svgIconClasses.SvgIconClasses> */
trait PartialSvgIconClasses extends StObject {
...
object PartialSvgIconClasses {
  
  inline def apply(): PartialSvgIconClasses = {
