...
trait PartialInputProps extends StObject {
  ...
  var classes: js.UndefOr[PartialInputClasses] = js.undefined
...
object PartialInputProps {
  ...
  inline def apply(): PartialInputProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialInputProps]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialInputProps] (val x: Self) extends AnyVal {
    ...
    inline def setClasses(value: PartialInputClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
