...
object PartialLinearProgressProps {
  ...
  extension [Self <: PartialLinearProgressProps](x: Self) {
    ...
    inline def setOnChange(value: ReactEventFrom[HTMLSpanElement & Element] => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: ReactEventFrom[HTMLSpanElement & Element]) => value(t0).runNow()))
