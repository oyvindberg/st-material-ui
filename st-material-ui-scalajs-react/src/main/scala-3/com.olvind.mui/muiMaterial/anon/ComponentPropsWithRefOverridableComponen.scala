...
/* Inlined ComponentPropsWithRef<OverridableComponent<AvatarTypeMap<{}, 'div'>>> & @mui/material.@mui/material/AvatarGroup/AvatarGroup.AvatarGroupComponentsPropsOverrides */
trait ComponentPropsWithRefOverridableComponen extends StObject {
...
object ComponentPropsWithRefOverridableComponen {
  
  inline def apply(): ComponentPropsWithRefOverridableComponen = {
