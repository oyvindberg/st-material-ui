...
trait `80` extends StObject {
  ...
  var styleOverrides: js.UndefOr[PartialOverridesStyleRulesImageListClass] = js.undefined
...
object `80` {
  ...
  extension [Self <: `80`](x: Self) {
    ...
    inline def setStyleOverrides(value: PartialOverridesStyleRulesImageListClass): Self = StObject.set(x, "styleOverrides", value.asInstanceOf[js.Any])
