...
/* Inlined std.Partial<@mui/material.@mui/material/Tooltip/tooltipClasses.TooltipClasses> */
trait PartialTooltipClasses extends StObject {
  ...
  var popperClose: js.UndefOr[String] = js.undefined
...
object PartialTooltipClasses {
  
  inline def apply(): PartialTooltipClasses = {
  ...
  extension [Self <: PartialTooltipClasses](x: Self) {
    ...
    inline def setPopperCloseUndefined: Self = StObject.set(x, "popperClose", js.undefined)
