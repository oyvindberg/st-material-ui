...
trait Overlap extends StObject {
  ...
  var classes: js.UndefOr[
    (/* import warning: importer.ImportType#apply Failed type conversion: @mui/material.anon.BadgeUnstyledTypeMapspanprops['classes'] */ js.Any) & AnchorOriginBottomLeftCircular
  ] = js.undefined
...
object Overlap {
  ...
  extension [Self <: Overlap](x: Self) {
    ...
    inline def setClasses(
      value: (/* import warning: importer.ImportType#apply Failed type conversion: @mui/material.anon.BadgeUnstyledTypeMapspanprops['classes'] */ js.Any) & AnchorOriginBottomLeftCircular
