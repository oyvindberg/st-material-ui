...
trait PartialMobileStepperProps extends StObject {
  ...
  var backButton: js.UndefOr[japgolly.scalajs.react.facade.React.Node] = js.undefined
  ...
  var nextButton: js.UndefOr[japgolly.scalajs.react.facade.React.Node] = js.undefined
...
object PartialMobileStepperProps {
  ...
  inline def apply(): PartialMobileStepperProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMobileStepperProps]
  }
  
  extension [Self <: PartialMobileStepperProps](x: Self) {
    ...
    inline def setBackButtonVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "backButton", js.Array(value*))
