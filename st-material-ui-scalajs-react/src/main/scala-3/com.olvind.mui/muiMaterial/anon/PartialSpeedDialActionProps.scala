...
trait PartialSpeedDialActionProps extends StObject {
  ...
  var FabProps: js.UndefOr[PartialFabPropsdefaultComponent] = js.undefined
  
  var PopperComponent: js.UndefOr[JSXElementConstructor[PopperProps]] = js.undefined
  
  var PopperProps: js.UndefOr[PartialPopperPropsAbout] = js.undefined
  
  var TooltipClasses: js.UndefOr[PartialTooltipClasses] = js.undefined
  ...
  var classes: js.UndefOr[PartialSpeedDialActionClasses] = js.undefined
  
  var color: js.UndefOr[String] = js.undefined
  
  var components: js.UndefOr[Tooltip] = js.undefined
  
  var componentsProps: js.UndefOr[Transition] = js.undefined
  ...
  var onClose: js.UndefOr[js.Function1[/* event */ ReactEventFrom[Element] | Event, Unit]] = js.undefined
  ...
  var slotProps: js.UndefOr[Transition] = js.undefined
  ...
  var tooltipTitle: js.UndefOr[japgolly.scalajs.react.facade.React.Node] = js.undefined
...
object PartialSpeedDialActionProps {
  ...
  inline def apply(): PartialSpeedDialActionProps = {
  ...
  extension [Self <: PartialSpeedDialActionProps](x: Self) {
    ...
    inline def setClasses(value: PartialSpeedDialActionClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
    ...
    inline def setComponentsProps(value: Transition): Self = StObject.set(x, "componentsProps", value.asInstanceOf[js.Any])
    ...
    inline def setFabProps(value: PartialFabPropsdefaultComponent): Self = StObject.set(x, "FabProps", value.asInstanceOf[js.Any])
    ...
    inline def setOnClose(value: /* event */ ReactEventFrom[Element] | Event => Callback): Self = StObject.set(x, "onClose", js.Any.fromFunction1((t0: /* event */ ReactEventFrom[Element] | Event) => value(t0).runNow()))
    ...
    inline def setPopperProps(value: PartialPopperPropsAbout): Self = StObject.set(x, "PopperProps", value.asInstanceOf[js.Any])
    ...
    inline def setSlotProps(value: Transition): Self = StObject.set(x, "slotProps", value.asInstanceOf[js.Any])
    ...
    inline def setTooltipClasses(value: PartialTooltipClasses): Self = StObject.set(x, "TooltipClasses", value.asInstanceOf[js.Any])
    
    inline def setTooltipClassesUndefined: Self = StObject.set(x, "TooltipClasses", js.undefined)
    
    inline def setTooltipOpen(value: Boolean): Self = StObject.set(x, "tooltipOpen", value.asInstanceOf[js.Any])
    ...
    inline def setTooltipTitle(value: VdomNode): Self = StObject.set(x, "tooltipTitle", value.rawNode.asInstanceOf[js.Any])
    
    inline def setTooltipTitleNull: Self = StObject.set(x, "tooltipTitle", null)
    
    inline def setTooltipTitleUndefined: Self = StObject.set(x, "tooltipTitle", js.undefined)
    
    inline def setTooltipTitleVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): Self = StObject.set(x, "tooltipTitle", js.Array(value*))
    
    inline def setTooltipTitleVdomElement(value: VdomElement): Self = StObject.set(x, "tooltipTitle", value.rawElement.asInstanceOf[js.Any])
    
    inline def setTransitionComponent(value: TransitionPropsAbout => japgolly.scalajs.react.facade.React.Element | Null): Self = StObject.set(x, "TransitionComponent", js.Any.fromFunction1(value))
    
    inline def setTransitionComponentUndefined: Self = StObject.set(x, "TransitionComponent", js.undefined)
    
    inline def setTransitionProps(value: com.olvind.mui.muiMaterial.transitionsTransitionMod.TransitionProps): Self = StObject.set(x, "TransitionProps", value.asInstanceOf[js.Any])
