...
object PartialSpeedDialActionProps {
  ...
  extension [Self <: PartialSpeedDialActionProps](x: Self) {
    ...
    inline def setTransitionProps(value: com.olvind.mui.muiMaterial.transitionMod.TransitionProps): Self = StObject.set(x, "TransitionProps", value.asInstanceOf[js.Any])
