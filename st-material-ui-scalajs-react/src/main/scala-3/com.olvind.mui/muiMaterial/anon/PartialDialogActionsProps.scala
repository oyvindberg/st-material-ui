...
trait PartialDialogActionsProps extends StObject {
  ...
  var classes: js.UndefOr[PartialDialogActionsClasses] = js.undefined
...
object PartialDialogActionsProps {
  ...
  inline def apply(): PartialDialogActionsProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialDialogActionsProps]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialDialogActionsProps] (val x: Self) extends AnyVal {
    ...
    inline def setClasses(value: PartialDialogActionsClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
