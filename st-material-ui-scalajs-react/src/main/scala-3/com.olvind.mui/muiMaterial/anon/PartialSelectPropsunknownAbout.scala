...
trait PartialSelectPropsunknownAbout extends StObject {
  ...
  var MenuProps: js.UndefOr[PartialMenuPropsAbout] = js.undefined
  ...
  var endAdornment: js.UndefOr[japgolly.scalajs.react.facade.React.Node] = js.undefined
  ...
  var renderSuffix: js.UndefOr[js.Function1[/* state */ Disabled, japgolly.scalajs.react.facade.React.Node]] = js.undefined
  
  var renderValue: js.UndefOr[js.Function1[/* value */ Any, japgolly.scalajs.react.facade.React.Node]] = js.undefined
...
object PartialSelectPropsunknownAbout {
  ...
  inline def apply(): PartialSelectPropsunknownAbout = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialSelectPropsunknownAbout]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialSelectPropsunknownAbout] (val x: Self) extends AnyVal {
    ...
    inline def setInput(value: VdomElement): Self = StObject.set(x, "input", value.rawElement.asInstanceOf[js.Any])
    
    inline def setInputComponent(value: ElementType): Self = StObject.set(x, "inputComponent", value.asInstanceOf[js.Any])
    ...
    inline def setMenuProps(value: PartialMenuPropsAbout): Self = StObject.set(x, "MenuProps", value.asInstanceOf[js.Any])
    ...
    ): Self = StObject.set(x, "onKeyDown", js.Any.fromFunction1((t0: ReactKeyboardEventFrom[(HTMLTextAreaElement | HTMLInputElement) & org.scalajs.dom.Element]) => value(t0).runNow()))
    ...
    inline def setOnKeyUp(
      value: ReactKeyboardEventFrom[(HTMLTextAreaElement | HTMLInputElement) & org.scalajs.dom.Element] => Callback
    ): Self = StObject.set(x, "onKeyUp", js.Any.fromFunction1((t0: ReactKeyboardEventFrom[(HTMLTextAreaElement | HTMLInputElement) & org.scalajs.dom.Element]) => value(t0).runNow()))
    ...
    inline def setRenderSuffix(value: /* state */ Disabled => japgolly.scalajs.react.facade.React.Node): Self = StObject.set(x, "renderSuffix", js.Any.fromFunction1(value))
    
    inline def setRenderSuffixUndefined: Self = StObject.set(x, "renderSuffix", js.undefined)
    
    inline def setRenderValue(value: /* value */ Any => japgolly.scalajs.react.facade.React.Node): Self = StObject.set(x, "renderValue", js.Any.fromFunction1(value))
