...
/* Inlined std.Partial<@mui/material.@mui/material/Tab/tabClasses.TabClasses> */
trait PartialTabClasses extends StObject {
  
  var disabled: js.UndefOr[String] = js.undefined
  
  var fullWidth: js.UndefOr[String] = js.undefined
  
  var iconWrapper: js.UndefOr[String] = js.undefined
  ...
  var wrapped: js.UndefOr[String] = js.undefined
}
object PartialTabClasses {
  
  inline def apply(): PartialTabClasses = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialTabClasses]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialTabClasses] (val x: Self) extends AnyVal {
    ...
    inline def setLabelIconUndefined: Self = StObject.set(x, "labelIcon", js.undefined)
    ...
    inline def setTextColorInheritUndefined: Self = StObject.set(x, "textColorInherit", js.undefined)
