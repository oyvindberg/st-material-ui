...
/* Inlined @mui/types.@mui/types.DefaultComponentProps<@mui/material.@mui/material/Unstable_Grid2/Grid2Props.Grid2TypeMap<{}, 'div'>> */
trait DefaultComponentPropsGrid2TypeMapdiv extends StObject {
...
object DefaultComponentPropsGrid2TypeMapdiv {
  
  inline def apply(): DefaultComponentPropsGrid2TypeMapdiv = {
