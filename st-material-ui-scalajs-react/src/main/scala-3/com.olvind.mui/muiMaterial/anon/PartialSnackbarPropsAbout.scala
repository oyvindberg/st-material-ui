...
trait PartialSnackbarPropsAbout extends StObject {
  ...
  var message: js.UndefOr[japgolly.scalajs.react.facade.React.Node] = js.undefined
...
object PartialSnackbarPropsAbout {
  ...
  inline def apply(): PartialSnackbarPropsAbout = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialSnackbarPropsAbout]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialSnackbarPropsAbout] (val x: Self) extends AnyVal {
