...
trait PartialRatingProps extends StObject {
  ...
  var emptyIcon: js.UndefOr[japgolly.scalajs.react.facade.React.Node] = js.undefined
  ...
  var onChangeActive: js.UndefOr[js.Function2[/* event */ ReactEventFrom[Element], /* value */ Double, Unit]] = js.undefined
...
object PartialRatingProps {
  ...
  implicit open class MutableBuilder[Self <: PartialRatingProps] (val x: Self) extends AnyVal {
    ...
    inline def setOnChange(value: (/* event */ ReactEventFrom[Element], /* value */ Double | Null) => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction2((t0: /* event */ ReactEventFrom[Element], t1: /* value */ Double | Null) => (value(t0, t1)).runNow()))
    
    inline def setOnChangeActive(value: (/* event */ ReactEventFrom[Element], /* value */ Double) => Callback): Self = StObject.set(x, "onChangeActive", js.Any.fromFunction2((t0: /* event */ ReactEventFrom[Element], t1: /* value */ Double) => (value(t0, t1)).runNow()))
