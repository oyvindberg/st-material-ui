...
trait `104` extends StObject {
  ...
  var styleOverrides: js.UndefOr[PartialOverridesStyleRulesOutlinedInputC] = js.undefined
...
object `104` {
  ...
  extension [Self <: `104`](x: Self) {
    ...
    inline def setStyleOverrides(value: PartialOverridesStyleRulesOutlinedInputC): Self = StObject.set(x, "styleOverrides", value.asInstanceOf[js.Any])
