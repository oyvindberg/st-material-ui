...
trait BackdropPropsBackdropTypeMapdivdefaultCo extends StObject {
...
object BackdropPropsBackdropTypeMapdivdefaultCo {
  
  inline def apply(open: Boolean): BackdropPropsBackdropTypeMapdivdefaultCo = {
    val __obj = js.Dynamic.literal(open = open.asInstanceOf[js.Any])
    __obj.asInstanceOf[BackdropPropsBackdropTypeMapdivdefaultCo]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: BackdropPropsBackdropTypeMapdivdefaultCo] (val x: Self) extends AnyVal {
