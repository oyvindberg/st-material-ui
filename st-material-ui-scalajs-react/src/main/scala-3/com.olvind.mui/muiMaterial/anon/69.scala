...
trait `69` extends StObject {
  ...
  var styleOverrides: js.UndefOr[PartialOverridesStyleRulesAccordionDetai] = js.undefined
...
object `69` {
  ...
  extension [Self <: `69`](x: Self) {
    ...
    inline def setStyleOverrides(value: PartialOverridesStyleRulesAccordionDetai): Self = StObject.set(x, "styleOverrides", value.asInstanceOf[js.Any])
