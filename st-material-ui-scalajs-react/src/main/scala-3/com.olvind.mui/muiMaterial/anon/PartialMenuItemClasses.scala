...
/* Inlined std.Partial<@mui/material.@mui/material/MenuItem/menuItemClasses.MenuItemClasses> */
trait PartialMenuItemClasses extends StObject {
...
object PartialMenuItemClasses {
  
  inline def apply(): PartialMenuItemClasses = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMenuItemClasses]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMenuItemClasses] (val x: Self) extends AnyVal {
