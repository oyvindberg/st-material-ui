...
trait PartialFilledInputProps extends StObject {
  ...
  var classes: js.UndefOr[PartialFilledInputClasses] = js.undefined
...
object PartialFilledInputProps {
  ...
  inline def apply(): PartialFilledInputProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialFilledInputProps]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialFilledInputProps] (val x: Self) extends AnyVal {
    ...
    inline def setClasses(value: PartialFilledInputClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
