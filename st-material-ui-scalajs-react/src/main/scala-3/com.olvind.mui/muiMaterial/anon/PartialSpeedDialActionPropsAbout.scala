...
trait PartialSpeedDialActionPropsAbout extends StObject {
...
object PartialSpeedDialActionPropsAbout {
  
  inline def apply(): PartialSpeedDialActionPropsAbout = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialSpeedDialActionPropsAbout]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialSpeedDialActionPropsAbout] (val x: Self) extends AnyVal {
