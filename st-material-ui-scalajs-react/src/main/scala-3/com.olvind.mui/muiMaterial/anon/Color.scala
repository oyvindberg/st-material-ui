...
trait Color extends StObject {
  ...
  var componentsProps: js.UndefOr[
    /* import warning: importer.ImportType#apply Failed type conversion: @mui/material.anon.BadgeUnstyledTypeMapspanprops['slotProps'] */ js.Any
  ] = js.undefined
...
object Color {
  ...
  extension [Self <: Color](x: Self) {
    ...
    inline def setComponentsProps(
      value: /* import warning: importer.ImportType#apply Failed type conversion: @mui/material.anon.BadgeUnstyledTypeMapspanprops['slotProps'] */ js.Any
