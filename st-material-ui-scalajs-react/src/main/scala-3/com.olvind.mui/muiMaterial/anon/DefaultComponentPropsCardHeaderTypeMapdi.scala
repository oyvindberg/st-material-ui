...
trait DefaultComponentPropsCardHeaderTypeMapdi extends StObject {
  ...
  /**
    ...
    */
  var subheaderTypographyProps: js.UndefOr[TypographyPropsspan] = js.undefined
  ...
  /**
    ...
    * (as long as disableTypography is not `true`).
    */
  var titleTypographyProps: js.UndefOr[TypographyPropsspan] = js.undefined
...
object DefaultComponentPropsCardHeaderTypeMapdi {
  ...
  inline def apply(): DefaultComponentPropsCardHeaderTypeMapdi = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsCardHeaderTypeMapdi]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DefaultComponentPropsCardHeaderTypeMapdi] (val x: Self) extends AnyVal {
    ...
    inline def setSubheaderTypographyProps(value: TypographyPropsspan): Self = StObject.set(x, "subheaderTypographyProps", value.asInstanceOf[js.Any])
    ...
    inline def setTitleTypographyProps(value: TypographyPropsspan): Self = StObject.set(x, "titleTypographyProps", value.asInstanceOf[js.Any])
