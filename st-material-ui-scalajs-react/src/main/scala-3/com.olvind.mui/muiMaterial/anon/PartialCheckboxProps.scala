...
trait PartialCheckboxProps extends StObject {
  ...
  var checkedIcon: js.UndefOr[japgolly.scalajs.react.facade.React.Node] = js.undefined
  ...
  var indeterminateIcon: js.UndefOr[japgolly.scalajs.react.facade.React.Node] = js.undefined
