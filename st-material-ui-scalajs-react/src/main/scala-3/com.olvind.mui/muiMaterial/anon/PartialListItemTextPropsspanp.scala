...
trait PartialListItemTextPropsspanp extends StObject {
  ...
  var primary: js.UndefOr[japgolly.scalajs.react.facade.React.Node] = js.undefined
  
  var primaryTypographyProps: js.UndefOr[TypographyPropsspan] = js.undefined
  ...
  var secondary: js.UndefOr[japgolly.scalajs.react.facade.React.Node] = js.undefined
  
  var secondaryTypographyProps: js.UndefOr[TypographyPropsp] = js.undefined
...
object PartialListItemTextPropsspanp {
  ...
  inline def apply(): PartialListItemTextPropsspanp = {
  ...
  implicit open class MutableBuilder[Self <: PartialListItemTextPropsspanp] (val x: Self) extends AnyVal {
    ...
    inline def setPrimaryTypographyProps(value: TypographyPropsspan): Self = StObject.set(x, "primaryTypographyProps", value.asInstanceOf[js.Any])
    
    inline def setPrimaryTypographyPropsUndefined: Self = StObject.set(x, "primaryTypographyProps", js.undefined)
    
    inline def setPrimaryUndefined: Self = StObject.set(x, "primary", js.undefined)
    
    inline def setPrimaryVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "primary", js.Array(value*))
    ...
    inline def setSecondaryTypographyProps(value: TypographyPropsp): Self = StObject.set(x, "secondaryTypographyProps", value.asInstanceOf[js.Any])
    
    inline def setSecondaryTypographyPropsUndefined: Self = StObject.set(x, "secondaryTypographyProps", js.undefined)
    
    inline def setSecondaryUndefined: Self = StObject.set(x, "secondary", js.undefined)
    
    inline def setSecondaryVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "secondary", js.Array(value*))
