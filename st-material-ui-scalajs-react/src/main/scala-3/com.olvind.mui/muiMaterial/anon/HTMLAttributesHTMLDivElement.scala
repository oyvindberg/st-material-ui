...
/* Inlined react.react.HTMLAttributes<std.HTMLDivElement> & {  sx :@mui/system.@mui/system.SxProps<@mui/material.@mui/material/styles.Theme> | undefined} */
trait HTMLAttributesHTMLDivElement extends StObject {
...
object HTMLAttributesHTMLDivElement {
  
  inline def apply(): HTMLAttributesHTMLDivElement = {
