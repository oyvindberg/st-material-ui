...
trait PartialAccordionProps extends StObject {
  ...
  var children: js.UndefOr[Element | String | Double | Any | ReactPortal | Boolean] = js.undefined
...
object PartialAccordionProps {
  ...
  implicit open class MutableBuilder[Self <: PartialAccordionProps] (val x: Self) extends AnyVal {
    ...
    inline def setTransitionComponent(value: TransitionProps => Element | Null): Self = StObject.set(x, "TransitionComponent", js.Any.fromFunction1(value))
