...
/* Inlined std.Partial<@mui/material.@mui/material/FormLabel/formLabelClasses.FormLabelClasses> */
trait PartialFormLabelClasses extends StObject {
...
object PartialFormLabelClasses {
  
  inline def apply(): PartialFormLabelClasses = {
