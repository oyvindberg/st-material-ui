...
/* Inlined Omit<PopperUnstyledProps<'div', {}>, 'direction'> & {  components :{  Root :react.react.ElementType<any> | undefined} | undefined,   componentsProps :PopperUnstyledProps<'div', {}>['slotProps'] | undefined,   sx :@mui/system.@mui/system.SxProps<@mui/material.@mui/material/styles.Theme> | undefined} & react.react.RefAttributes<std.HTMLDivElement> */
trait OmitPopperUnstyledPropsdivdirectionRefAt extends StObject {
...
object OmitPopperUnstyledPropsdivdirectionRefAt {
  
  inline def apply(open: Boolean): OmitPopperUnstyledPropsdivdirectionRefAt = {
    val __obj = js.Dynamic.literal(open = open.asInstanceOf[js.Any])
    __obj.asInstanceOf[OmitPopperUnstyledPropsdivdirectionRefAt]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: OmitPopperUnstyledPropsdivdirectionRefAt] (val x: Self) extends AnyVal {
