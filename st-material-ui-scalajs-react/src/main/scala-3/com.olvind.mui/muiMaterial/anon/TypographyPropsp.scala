...
trait TypographyPropsp extends StObject {
  ...
  var component: js.UndefOr["p"] = js.undefined
...
object TypographyPropsp {
  ...
  inline def apply(): TypographyPropsp = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TypographyPropsp]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TypographyPropsp] (val x: Self) extends AnyVal {
    ...
    inline def setComponent(value: "p"): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
