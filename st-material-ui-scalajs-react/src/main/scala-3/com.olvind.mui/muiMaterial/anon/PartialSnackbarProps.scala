...
trait PartialSnackbarProps extends StObject {
  ...
  var ContentProps: js.UndefOr[PartialSnackbarContentPropsAbout] = js.undefined
...
object PartialSnackbarProps {
  ...
  inline def apply(): PartialSnackbarProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialSnackbarProps]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialSnackbarProps] (val x: Self) extends AnyVal {
    ...
    inline def setContentProps(value: PartialSnackbarContentPropsAbout): Self = StObject.set(x, "ContentProps", value.asInstanceOf[js.Any])
