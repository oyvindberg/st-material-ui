...
trait PartialPopoverProps extends StObject {
  ...
  var classes: js.UndefOr[PartialPopoverClasses] = js.undefined
...
object PartialPopoverProps {
  ...
  implicit open class MutableBuilder[Self <: PartialPopoverProps] (val x: Self) extends AnyVal {
    ...
    inline def setClasses(value: PartialPopoverClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
