...
/* Inlined std.Partial<@mui/material.@mui/material/Avatar/avatarClasses.AvatarClasses> */
trait PartialAvatarClasses extends StObject {
...
object PartialAvatarClasses {
  
  inline def apply(): PartialAvatarClasses = {
