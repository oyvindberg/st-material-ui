...
trait PartialAutocompletePropsanyanyanyanydiv extends StObject {
  ...
  var componentsProps: js.UndefOr[`38`] = js.undefined
  ...
  var getOptionLabel: js.UndefOr[js.Function1[/* option */ Any, String]] = js.undefined
...
object PartialAutocompletePropsanyanyanyanydiv {
  ...
  extension [Self <: PartialAutocompletePropsanyanyanyanydiv](x: Self) {
    ...
    inline def setComponentsProps(value: `38`): Self = StObject.set(x, "componentsProps", value.asInstanceOf[js.Any])
    ...
    inline def setGetOptionLabel(value: /* option */ Any => String): Self = StObject.set(x, "getOptionLabel", js.Any.fromFunction1(value))
    ...
    inline def setRenderTags(
      value: (/* value */ js.Array[Any], /* getTagProps */ AutocompleteRenderGetTagProps) => japgolly.scalajs.react.facade.React.Node
    ): Self = StObject.set(x, "renderTags", js.Any.fromFunction2(value))
