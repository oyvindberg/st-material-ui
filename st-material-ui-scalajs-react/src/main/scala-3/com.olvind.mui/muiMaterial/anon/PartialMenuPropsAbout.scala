...
trait PartialMenuPropsAbout extends StObject {
  ...
  var MenuListProps: js.UndefOr[PartialMenuListPropsdefaultComponent] = js.undefined
  
  var PaperProps: js.UndefOr[PartialPaperPropsdiv] = js.undefined
  
  var PopoverClasses: js.UndefOr[PartialPopoverClasses] = js.undefined
  ...
  var action: js.UndefOr[com.olvind.mui.react.mod.Ref[PopoverActions]] = js.undefined
  ...
  var classes: js.UndefOr[PartialMenuClasses] = js.undefined
  ...
  var componentsProps: js.UndefOr[
    /* import warning: importer.ImportType#apply Failed type conversion: @mui/material.anon.ModalUnstyledOwnProps['slotProps'] */ js.Any
  ] = js.undefined
  ...
  var onClose: js.UndefOr[
    /* import warning: importer.ImportType#apply Failed type conversion: @mui/material.anon.ModalPropsModalTypeMapdivdefaultComponen['onClose'] */ js.Any
  ] = js.undefined
...
object PartialMenuPropsAbout {
  ...
  inline def apply(): PartialMenuPropsAbout = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMenuPropsAbout]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMenuPropsAbout] (val x: Self) extends AnyVal {
    ...
    inline def setAction(value: com.olvind.mui.react.mod.Ref[PopoverActions]): Self = StObject.set(x, "action", value.asInstanceOf[js.Any])
    
    inline def setActionFunction1(value: PopoverActions | Null => Callback): Self = StObject.set(x, "action", js.Any.fromFunction1((t0: PopoverActions | Null) => value(t0).runNow()))
    ...
    inline def setClasses(value: PartialMenuClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
    ...
    inline def setComponentsProps(
      value: /* import warning: importer.ImportType#apply Failed type conversion: @mui/material.anon.ModalUnstyledOwnProps['slotProps'] */ js.Any
    ...
    inline def setMenuListProps(value: PartialMenuListPropsdefaultComponent): Self = StObject.set(x, "MenuListProps", value.asInstanceOf[js.Any])
    ...
    inline def setOnBackdropClick(value: ReactEventFrom[js.Object & Element] => Callback): Self = StObject.set(x, "onBackdropClick", js.Any.fromFunction1((t0: ReactEventFrom[js.Object & Element]) => value(t0).runNow()))
    ...
    inline def setOnClose(
      value: /* import warning: importer.ImportType#apply Failed type conversion: @mui/material.anon.ModalPropsModalTypeMapdivdefaultComponen['onClose'] */ js.Any
    ...
    inline def setPopoverClasses(value: PartialPopoverClasses): Self = StObject.set(x, "PopoverClasses", value.asInstanceOf[js.Any])
