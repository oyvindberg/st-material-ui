...
trait PartialDialogProps extends StObject {
  ...
  var PaperComponent: js.UndefOr[JSXElementConstructor[PaperPropsdiv]] = js.undefined
  ...
  var classes: js.UndefOr[PartialDialogClasses] = js.undefined
...
object PartialDialogProps {
  ...
  extension [Self <: PartialDialogProps](x: Self) {
    ...
    inline def setClasses(value: PartialDialogClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
    ...
    inline def setPaperComponent(value: PaperPropsdiv => japgolly.scalajs.react.facade.React.Element | Null): Self = StObject.set(x, "PaperComponent", js.Any.fromFunction1(value))
