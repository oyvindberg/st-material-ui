...
/* Inlined std.Partial<@mui/material.@mui/material/Alert.AlertProps> */
trait PartialAlertProps extends StObject {
  ...
  var componentsProps: js.UndefOr[`39`] = js.undefined
  ...
  var slotProps: js.UndefOr[`39`] = js.undefined
...
object PartialAlertProps {
  
  inline def apply(): PartialAlertProps = {
  ...
  implicit open class MutableBuilder[Self <: PartialAlertProps] (val x: Self) extends AnyVal {
    ...
    inline def setComponentsProps(value: `39`): Self = StObject.set(x, "componentsProps", value.asInstanceOf[js.Any])
    ...
    inline def setSlotProps(value: `39`): Self = StObject.set(x, "slotProps", value.asInstanceOf[js.Any])
