...
/* Inlined std.Partial<@mui/material.@mui/material/ToggleButton/toggleButtonClasses.ToggleButtonClasses> */
trait PartialToggleButtonClasses extends StObject {
...
object PartialToggleButtonClasses {
  
  inline def apply(): PartialToggleButtonClasses = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialToggleButtonClasses]
  }
  
  extension [Self <: PartialToggleButtonClasses](x: Self) {
