...
trait `115` extends StObject {
  ...
  var styleOverrides: js.UndefOr[PartialOverridesStyleRulesSnackbarClassK] = js.undefined
...
object `115` {
  ...
  extension [Self <: `115`](x: Self) {
    ...
    inline def setStyleOverrides(value: PartialOverridesStyleRulesSnackbarClassK): Self = StObject.set(x, "styleOverrides", value.asInstanceOf[js.Any])
