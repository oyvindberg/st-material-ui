...
trait DefaultComponentPropsImageListTypeMapul extends StObject {
  ...
  /**
    ...
    */
  var children: Element | String | Double | Any | ReactPortal | Boolean
...
object DefaultComponentPropsImageListTypeMapul {
  ...
  inline def apply(children: Element | String | Double | Any | ReactPortal | Boolean): DefaultComponentPropsImageListTypeMapul = {
