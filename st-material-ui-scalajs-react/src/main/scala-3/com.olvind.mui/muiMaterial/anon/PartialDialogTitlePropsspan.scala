...
/* Inlined std.Partial<DialogTitleProps<'span', {}>> */
trait PartialDialogTitlePropsspan extends StObject {
...
object PartialDialogTitlePropsspan {
  
  inline def apply(): PartialDialogTitlePropsspan = {
