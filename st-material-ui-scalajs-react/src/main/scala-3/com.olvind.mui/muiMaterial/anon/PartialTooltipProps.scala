...
trait PartialTooltipProps extends StObject {
  ...
  var title: js.UndefOr[Element | String | Double | Any | ReactPortal | Boolean] = js.undefined
...
object PartialTooltipProps {
  ...
  extension [Self <: PartialTooltipProps](x: Self) {
    ...
    inline def setTitle(value: Element | String | Double | Any | ReactPortal | Boolean): Self = StObject.set(x, "title", value.asInstanceOf[js.Any])
