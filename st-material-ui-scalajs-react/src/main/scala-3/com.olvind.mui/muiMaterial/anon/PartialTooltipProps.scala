...
trait PartialTooltipProps extends StObject {
  ...
  var classes: js.UndefOr[PartialTooltipClasses] = js.undefined
...
object PartialTooltipProps {
  ...
  implicit open class MutableBuilder[Self <: PartialTooltipProps] (val x: Self) extends AnyVal {
    ...
    inline def setClasses(value: PartialTooltipClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
    ...
    inline def setPopperComponent(value: PopperProps => Element | Null): Self = StObject.set(x, "PopperComponent", js.Any.fromFunction1(value))
