...
/* Inlined std.Partial<@mui/material.@mui/material/Rating/ratingClasses.RatingClasses> */
trait PartialRatingClasses extends StObject {
  ...
  var labelEmptyValueActive: js.UndefOr[String] = js.undefined
...
object PartialRatingClasses {
  
  inline def apply(): PartialRatingClasses = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialRatingClasses]
  }
  
  extension [Self <: PartialRatingClasses](x: Self) {
    ...
    inline def setLabelEmptyValueActiveUndefined: Self = StObject.set(x, "labelEmptyValueActive", js.undefined)
