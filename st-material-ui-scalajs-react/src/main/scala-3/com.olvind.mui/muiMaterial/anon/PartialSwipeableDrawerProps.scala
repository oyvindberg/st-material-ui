...
trait PartialSwipeableDrawerProps extends StObject {
  ...
  var classes: js.UndefOr[PartialDrawerClasses] = js.undefined
...
object PartialSwipeableDrawerProps {
  ...
  inline def apply(): PartialSwipeableDrawerProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialSwipeableDrawerProps]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialSwipeableDrawerProps] (val x: Self) extends AnyVal {
    ...
    inline def setClasses(value: PartialDrawerClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
    ...
    inline def setOnClose(value: ReactEventFrom[js.Object & Element] => Callback): Self = StObject.set(x, "onClose", js.Any.fromFunction1((t0: ReactEventFrom[js.Object & Element]) => value(t0).runNow()))
    ...
    inline def setOnOpen(value: ReactEventFrom[js.Object & Element] => Callback): Self = StObject.set(x, "onOpen", js.Any.fromFunction1((t0: ReactEventFrom[js.Object & Element]) => value(t0).runNow()))
