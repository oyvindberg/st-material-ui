...
trait PartialSpeedDialProps extends StObject {
  ...
  var TransitionComponent: js.UndefOr[
    JSXElementConstructor[com.olvind.mui.muiMaterial.transitionsTransitionMod.TransitionProps]
  ] = js.undefined
...
object PartialSpeedDialProps {
  ...
  extension [Self <: PartialSpeedDialProps](x: Self) {
    ...
    inline def setTransitionComponent(
      value: com.olvind.mui.muiMaterial.transitionsTransitionMod.TransitionProps => japgolly.scalajs.react.facade.React.Element | Null
