...
trait PartialSpeedDialProps extends StObject {
  ...
  var TransitionComponent: js.UndefOr[JSXElementConstructor[com.olvind.mui.muiMaterial.transitionMod.TransitionProps]] = js.undefined
  ...
  var onClose: js.UndefOr[
    js.Function2[/* event */ ReactEventFrom[js.Object & Element], /* reason */ CloseReason, Unit]
  ] = js.undefined
  ...
  var onOpen: js.UndefOr[
    js.Function2[/* event */ ReactEventFrom[js.Object & Element], /* reason */ OpenReason, Unit]
  ] = js.undefined
...
object PartialSpeedDialProps {
  ...
  extension [Self <: PartialSpeedDialProps](x: Self) {
    ...
    inline def setOnClose(value: (/* event */ ReactEventFrom[js.Object & Element], /* reason */ CloseReason) => Callback): Self = StObject.set(x, "onClose", js.Any.fromFunction2((t0: /* event */ ReactEventFrom[js.Object & Element], t1: /* reason */ CloseReason) => (value(t0, t1)).runNow()))
    ...
    inline def setOnOpen(value: (/* event */ ReactEventFrom[js.Object & Element], /* reason */ OpenReason) => Callback): Self = StObject.set(x, "onOpen", js.Any.fromFunction2((t0: /* event */ ReactEventFrom[js.Object & Element], t1: /* reason */ OpenReason) => (value(t0, t1)).runNow()))
