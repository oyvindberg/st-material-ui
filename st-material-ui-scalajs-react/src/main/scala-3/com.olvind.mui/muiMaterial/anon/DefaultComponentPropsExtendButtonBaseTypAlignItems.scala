...
/* Inlined @mui/material.@mui/material/OverridableComponent.DefaultComponentProps<@mui/material.@mui/material/ButtonBase/ButtonBase.ExtendButtonBaseTypeMap<@mui/material.@mui/material/ListItem/ListItem.ListItemTypeMap<{  button :true}, 'div'>>> */
trait DefaultComponentPropsExtendButtonBaseTypAlignItems extends StObject {
  ...
  /**
    ...
    * @deprecated
    */
  var ContainerComponent: js.UndefOr[ElementType] = js.undefined
  ...
  /**
    ...
    */
  var secondaryAction: js.UndefOr[japgolly.scalajs.react.facade.React.Node] = js.undefined
...
object DefaultComponentPropsExtendButtonBaseTypAlignItems {
  
  inline def apply(): DefaultComponentPropsExtendButtonBaseTypAlignItems = {
    val __obj = js.Dynamic.literal(button = true)
  ...
  extension [Self <: DefaultComponentPropsExtendButtonBaseTypAlignItems](x: Self) {
    ...
    inline def setContainerComponent(value: ElementType): Self = StObject.set(x, "ContainerComponent", value.asInstanceOf[js.Any])
    ...
    inline def setSecondaryAction(value: VdomNode): Self = StObject.set(x, "secondaryAction", value.rawNode.asInstanceOf[js.Any])
    
    inline def setSecondaryActionNull: Self = StObject.set(x, "secondaryAction", null)
    
    inline def setSecondaryActionUndefined: Self = StObject.set(x, "secondaryAction", js.undefined)
    
    inline def setSecondaryActionVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "secondaryAction", js.Array(value*))
    
    inline def setSecondaryActionVdomElement(value: VdomElement): Self = StObject.set(x, "secondaryAction", value.rawElement.asInstanceOf[js.Any])
