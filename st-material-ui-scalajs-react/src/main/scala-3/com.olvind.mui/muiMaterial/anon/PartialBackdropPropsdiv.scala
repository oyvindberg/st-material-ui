...
/* Inlined std.Partial<BackdropProps<'div', {}>> */
trait PartialBackdropPropsdiv extends StObject {
...
object PartialBackdropPropsdiv {
  
  inline def apply(): PartialBackdropPropsdiv = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialBackdropPropsdiv]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialBackdropPropsdiv] (val x: Self) extends AnyVal {
