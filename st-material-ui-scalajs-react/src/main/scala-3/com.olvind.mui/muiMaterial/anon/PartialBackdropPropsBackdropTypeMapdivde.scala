...
/* Inlined std.Partial<BackdropProps<BackdropTypeMap<{}, 'div'>['defaultComponent'], {}>> */
trait PartialBackdropPropsBackdropTypeMapdivde extends StObject {
...
object PartialBackdropPropsBackdropTypeMapdivde {
  
  inline def apply(): PartialBackdropPropsBackdropTypeMapdivde = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialBackdropPropsBackdropTypeMapdivde]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialBackdropPropsBackdropTypeMapdivde] (val x: Self) extends AnyVal {
