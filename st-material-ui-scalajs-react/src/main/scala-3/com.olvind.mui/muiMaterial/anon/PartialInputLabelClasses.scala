...
/* Inlined std.Partial<@mui/material.@mui/material/InputLabel/inputLabelClasses.InputLabelClasses> */
trait PartialInputLabelClasses extends StObject {
...
object PartialInputLabelClasses {
  
  inline def apply(): PartialInputLabelClasses = {
