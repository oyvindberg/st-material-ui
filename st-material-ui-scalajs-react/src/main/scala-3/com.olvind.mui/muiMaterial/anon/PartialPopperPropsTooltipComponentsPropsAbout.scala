...
/* Inlined Partial<PopperProps> & @mui/material.@mui/material/Tooltip/Tooltip.TooltipComponentsPropsOverrides */
trait PartialPopperPropsTooltipComponentsPropsAbout extends StObject {
  ...
  var componentsProps: js.UndefOr[
    /* import warning: importer.ImportType#apply Failed type conversion: @mui/material.anon.PopperUnstyledPropsdiv['slotProps'] */ js.Any
  ] = js.undefined
...
object PartialPopperPropsTooltipComponentsPropsAbout {
  
  inline def apply(): PartialPopperPropsTooltipComponentsPropsAbout = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialPopperPropsTooltipComponentsPropsAbout]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialPopperPropsTooltipComponentsPropsAbout] (val x: Self) extends AnyVal {
    ...
    inline def setComponentsProps(
      value: /* import warning: importer.ImportType#apply Failed type conversion: @mui/material.anon.PopperUnstyledPropsdiv['slotProps'] */ js.Any
