...
object PartialNativeSelectInputProps {
  ...
  implicit open class MutableBuilder[Self <: PartialNativeSelectInputProps] (val x: Self) extends AnyVal {
    ...
    inline def setOnResize(value: ReactEventFrom[HTMLSelectElement & org.scalajs.dom.Element] => Callback): Self = StObject.set(x, "onResize", js.Any.fromFunction1((t0: ReactEventFrom[HTMLSelectElement & org.scalajs.dom.Element]) => value(t0).runNow()))
