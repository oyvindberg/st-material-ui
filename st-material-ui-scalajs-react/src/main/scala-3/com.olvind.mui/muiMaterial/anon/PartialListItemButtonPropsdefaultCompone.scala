...
object PartialListItemButtonPropsdefaultCompone {
  ...
  inline def apply(): PartialListItemButtonPropsdefaultCompone = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialListItemButtonPropsdefaultCompone]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialListItemButtonPropsdefaultCompone] (val x: Self) extends AnyVal {
