...
/* Inlined std.Partial<Record<Variant | 'inherit', string>> */
trait PartialRecordVariantinheritstring extends StObject {
...
object PartialRecordVariantinheritstring {
  
  inline def apply(): PartialRecordVariantinheritstring = {
