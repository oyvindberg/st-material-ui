...
/* Inlined std.Partial<@mui/material.@mui/material/Switch/switchClasses.SwitchClasses> */
trait PartialSwitchClasses extends StObject {
...
object PartialSwitchClasses {
  
  inline def apply(): PartialSwitchClasses = {
