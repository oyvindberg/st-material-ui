...
trait `119` extends StObject {
  ...
  var styleOverrides: js.UndefOr[PartialOverridesStyleRulesSpeedDialIconC] = js.undefined
...
object `119` {
  ...
  extension [Self <: `119`](x: Self) {
    ...
    inline def setStyleOverrides(value: PartialOverridesStyleRulesSpeedDialIconC): Self = StObject.set(x, "styleOverrides", value.asInstanceOf[js.Any])
