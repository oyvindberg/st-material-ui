...
trait `75` extends StObject {
  ...
  var styleOverrides: js.UndefOr[PartialOverridesStyleRulesFormControlLab] = js.undefined
...
object `75` {
  ...
  extension [Self <: `75`](x: Self) {
    ...
    inline def setStyleOverrides(value: PartialOverridesStyleRulesFormControlLab): Self = StObject.set(x, "styleOverrides", value.asInstanceOf[js.Any])
