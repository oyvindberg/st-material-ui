...
object ImgHTMLAttributesHTMLImageElement {
  ...
  implicit open class MutableBuilder[Self <: ImgHTMLAttributesHTMLImageElement] (val x: Self) extends AnyVal {
    ...
    inline def setOnResize(value: ReactEventFrom[HTMLImageElement & org.scalajs.dom.Element] => Callback): Self = StObject.set(x, "onResize", js.Any.fromFunction1((t0: ReactEventFrom[HTMLImageElement & org.scalajs.dom.Element]) => value(t0).runNow()))
