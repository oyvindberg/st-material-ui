...
trait `89` extends StObject {
  ...
  var styleOverrides: js.UndefOr[PartialOverridesStyleRulesLinearProgress] = js.undefined
...
object `89` {
  ...
  extension [Self <: `89`](x: Self) {
    ...
    inline def setStyleOverrides(value: PartialOverridesStyleRulesLinearProgress): Self = StObject.set(x, "styleOverrides", value.asInstanceOf[js.Any])
