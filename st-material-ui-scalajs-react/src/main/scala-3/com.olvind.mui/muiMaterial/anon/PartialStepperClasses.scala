...
/* Inlined std.Partial<@mui/material.@mui/material/Stepper/stepperClasses.StepperClasses> */
trait PartialStepperClasses extends StObject {
...
object PartialStepperClasses {
  
  inline def apply(): PartialStepperClasses = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialStepperClasses]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialStepperClasses] (val x: Self) extends AnyVal {
