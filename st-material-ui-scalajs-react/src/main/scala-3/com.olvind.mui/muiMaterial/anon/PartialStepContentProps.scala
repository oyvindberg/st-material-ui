...
object PartialStepContentProps {
  ...
  extension [Self <: PartialStepContentProps](x: Self) {
    ...
    inline def setTransitionComponent(value: com.olvind.mui.muiMaterial.transitionMod.TransitionProps => Element | Null): Self = StObject.set(x, "TransitionComponent", js.Any.fromFunction1(value))
