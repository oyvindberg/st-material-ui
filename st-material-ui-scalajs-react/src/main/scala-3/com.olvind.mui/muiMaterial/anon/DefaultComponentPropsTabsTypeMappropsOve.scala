...
/* Inlined DefaultComponentProps<TabsTypeMap<{}, (props : {} & OverrideProps<ExtendButtonBaseTypeMap<ButtonBaseTypeMap<{}, 'button'>>, 'a'> | DefaultComponentProps<ExtendButtonBaseTypeMap<ButtonBaseTypeMap<{}, 'button'>>>): ReactElement | null>> & { readonly component :string | undefined} */
trait DefaultComponentPropsTabsTypeMappropsOve extends StObject {
...
object DefaultComponentPropsTabsTypeMappropsOve {
  
  inline def apply(): DefaultComponentPropsTabsTypeMappropsOve = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsTabsTypeMappropsOve]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DefaultComponentPropsTabsTypeMappropsOve] (val x: Self) extends AnyVal {
    ...
    inline def setOnFocusVisible(value: ReactFocusEventFrom[Any & Element] => Callback): Self = StObject.set(x, "onFocusVisible", js.Any.fromFunction1((t0: ReactFocusEventFrom[Any & Element]) => value(t0).runNow()))
