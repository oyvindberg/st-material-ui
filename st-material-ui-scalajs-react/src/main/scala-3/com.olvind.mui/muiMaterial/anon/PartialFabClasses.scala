...
/* Inlined std.Partial<@mui/material.@mui/material/Fab/fabClasses.FabClasses> */
trait PartialFabClasses extends StObject {
...
object PartialFabClasses {
  
  inline def apply(): PartialFabClasses = {
