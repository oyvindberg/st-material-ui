...
trait PartialSwipeableDrawerPropsAbout extends StObject {
...
object PartialSwipeableDrawerPropsAbout {
  
  inline def apply(): PartialSwipeableDrawerPropsAbout = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialSwipeableDrawerPropsAbout]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialSwipeableDrawerPropsAbout] (val x: Self) extends AnyVal {
