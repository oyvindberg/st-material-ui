...
/* Inlined DefaultComponentProps<DialogTitleTypeMap<{}, TypographyTypeMap<{}, 'span'>['defaultComponent']>> & { readonly component :string | undefined} */
trait DefaultComponentPropsDialogTitleTypeMapT extends StObject {
...
object DefaultComponentPropsDialogTitleTypeMapT {
  
  inline def apply(): DefaultComponentPropsDialogTitleTypeMapT = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsDialogTitleTypeMapT]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DefaultComponentPropsDialogTitleTypeMapT] (val x: Self) extends AnyVal {
    ...
    inline def setBorderFunction1(
      value: /* theme */ Theme => ResponsiveStyleValue[js.UndefOr[(com.olvind.mui.csstype.mod.Property.Border[String | 0]) | Double]]
