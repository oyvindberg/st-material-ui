...
/* Inlined @mui/material.@mui/material/Backdrop.BackdropProps<'div', {}> */
trait BackdropPropsdiv extends StObject {
...
object BackdropPropsdiv {
  
  inline def apply(open: Boolean): BackdropPropsdiv = {
    val __obj = js.Dynamic.literal(open = open.asInstanceOf[js.Any])
    __obj.asInstanceOf[BackdropPropsdiv]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: BackdropPropsdiv] (val x: Self) extends AnyVal {
