...
/* Inlined @mui/base.@mui/base/PopperUnstyled.PopperUnstyledProps<'div', {}> */
trait PopperUnstyledPropsdiv extends StObject {
...
object PopperUnstyledPropsdiv {
  
  inline def apply(open: Boolean): PopperUnstyledPropsdiv = {
