...
/* Inlined std.Partial<@mui/material.@mui/material/ListItem/listItemClasses.ListItemClasses> */
trait PartialListItemClasses extends StObject {
...
object PartialListItemClasses {
  
  inline def apply(): PartialListItemClasses = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialListItemClasses]
  }
  
  extension [Self <: PartialListItemClasses](x: Self) {
