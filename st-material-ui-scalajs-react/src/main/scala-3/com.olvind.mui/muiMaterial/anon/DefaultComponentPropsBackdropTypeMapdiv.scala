...
/* Inlined DefaultComponentProps<BackdropTypeMap<{}, 'div'>> & { readonly component :string | undefined} */
trait DefaultComponentPropsBackdropTypeMapdiv extends StObject {
...
object DefaultComponentPropsBackdropTypeMapdiv {
  
  inline def apply(open: Boolean): DefaultComponentPropsBackdropTypeMapdiv = {
    val __obj = js.Dynamic.literal(open = open.asInstanceOf[js.Any])
    __obj.asInstanceOf[DefaultComponentPropsBackdropTypeMapdiv]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DefaultComponentPropsBackdropTypeMapdiv] (val x: Self) extends AnyVal {
