...
object CardContentPropsCardContentTypeMapdivdef {
  ...
  inline def apply(): CardContentPropsCardContentTypeMapdivdef = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CardContentPropsCardContentTypeMapdivdef]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CardContentPropsCardContentTypeMapdivdef] (val x: Self) extends AnyVal {
