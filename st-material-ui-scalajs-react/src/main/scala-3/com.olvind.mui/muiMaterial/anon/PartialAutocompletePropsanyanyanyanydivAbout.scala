...
trait PartialAutocompletePropsanyanyanyanydivAbout extends StObject {
  ...
  var componentsProps: js.UndefOr[PopupIndicator] = js.undefined
  ...
  var slotProps: js.UndefOr[PopupIndicator] = js.undefined
...
object PartialAutocompletePropsanyanyanyanydivAbout {
  
  inline def apply(): PartialAutocompletePropsanyanyanyanydivAbout = {
  ...
  implicit open class MutableBuilder[Self <: PartialAutocompletePropsanyanyanyanydivAbout] (val x: Self) extends AnyVal {
    ...
    inline def setComponentsProps(value: PopupIndicator): Self = StObject.set(x, "componentsProps", value.asInstanceOf[js.Any])
    ...
    inline def setSlotProps(value: PopupIndicator): Self = StObject.set(x, "slotProps", value.asInstanceOf[js.Any])
