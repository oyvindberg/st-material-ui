...
object paginationPaginationMod {
  ...
  object PaginationRenderItemParams {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(disabled = disabled.asInstanceOf[js.Any], onClick = js.Any.fromFunction1((t0: ReactEventFrom[org.scalajs.dom.Element & org.scalajs.dom.Element]) => onClick(t0).runNow()), page = page.asInstanceOf[js.Any], selected = selected.asInstanceOf[js.Any])
