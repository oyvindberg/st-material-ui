...
object paginationPaginationMod {
  ...
  trait PaginationProps extends StObject {
    ...
    var onChange: js.UndefOr[
        js.Function2[/* event */ ReactEventFrom[Any & org.scalajs.dom.Element], /* page */ Double, Unit]
      ] = js.undefined
    ...
    /**
      ...
      */
    var renderItem: js.UndefOr[js.Function1[/* params */ PaginationRenderItemParams, Node]] = js.undefined
  ...
  object PaginationProps {
    ...
    extension [Self <: PaginationProps](x: Self) {
      ...
      inline def setOnChange(value: (/* event */ ReactEventFrom[Any & org.scalajs.dom.Element], /* page */ Double) => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction2((t0: /* event */ ReactEventFrom[Any & org.scalajs.dom.Element], t1: /* page */ Double) => (value(t0, t1)).runNow()))
      ...
      inline def setOnResize(value: ReactEventFrom[HTMLElement & org.scalajs.dom.Element] => Callback): Self = StObject.set(x, "onResize", js.Any.fromFunction1((t0: ReactEventFrom[HTMLElement & org.scalajs.dom.Element]) => value(t0).runNow()))
      ...
      inline def setRenderItem(value: /* params */ PaginationRenderItemParams => Node): Self = StObject.set(x, "renderItem", js.Any.fromFunction1(value))
  ...
  object PaginationRenderItemParams {
    ...
    inline def apply(
      disabled: Boolean,
      onClick: ReactEventFrom[org.scalajs.dom.Element & org.scalajs.dom.Element] => Callback,
      selected: Boolean,
      `type`: "page" | "first" | "last" | "next" | "previous" | "start-ellipsis" | "end-ellipsis"
    ): PaginationRenderItemParams = {
      val __obj = js.Dynamic.literal(disabled = disabled.asInstanceOf[js.Any], onClick = js.Any.fromFunction1((t0: ReactEventFrom[org.scalajs.dom.Element & org.scalajs.dom.Element]) => onClick(t0).runNow()), selected = selected.asInstanceOf[js.Any], page = null)
