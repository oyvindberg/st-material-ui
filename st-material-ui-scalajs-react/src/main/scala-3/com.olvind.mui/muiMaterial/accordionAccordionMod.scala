...
object accordionAccordionMod {
  ...
  trait AccordionProps extends StObject {
    ...
    /**
      ...
      */
    var children: japgolly.scalajs.react.facade.React.Element | String | Double | Any | ReactPortal | Boolean
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialAccordionClasses] = js.undefined
  ...
  object AccordionProps {
    ...
    implicit open class MutableBuilder[Self <: AccordionProps] (val x: Self) extends AnyVal {
      ...
      inline def setChildren(value: japgolly.scalajs.react.facade.React.Element | String | Double | Any | ReactPortal | Boolean): Self = StObject.set(x, "children", value.asInstanceOf[js.Any])
      ...
      inline def setClasses(value: PartialAccordionClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      inline def setOnChange(value: (/* event */ ReactEventFrom[org.scalajs.dom.Element], /* expanded */ Boolean) => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction2((t0: /* event */ ReactEventFrom[org.scalajs.dom.Element], t1: /* expanded */ Boolean) => (value(t0, t1)).runNow()))
