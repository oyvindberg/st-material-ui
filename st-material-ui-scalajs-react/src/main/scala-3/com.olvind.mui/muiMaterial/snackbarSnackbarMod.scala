...
object snackbarSnackbarMod {
  ...
  */
  ...
  object SnackbarCloseReason {
    ...
    inline def clickaway: com.olvind.mui.muiMaterial.muiMaterialStrings.clickaway = "clickaway".asInstanceOf[com.olvind.mui.muiMaterial.muiMaterialStrings.clickaway]
  ...
  object SnackbarOrigin {
    ...
    inline def apply(horizontal: left | center | right, vertical: top | bottom): SnackbarOrigin = {
  ...
  trait SnackbarProps extends StObject {
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialSnackbarClasses] = js.undefined
    ...
    var onClose: js.UndefOr[
        js.Function2[
          /* event */ (ReactEventFrom[Any & org.scalajs.dom.Element]) | Event, 
  ...
  object SnackbarProps {
    ...
    extension [Self <: SnackbarProps](x: Self) {
      ...
      inline def setActionVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): Self = StObject.set(x, "action", js.Array(value*))
      
      inline def setActionVdomElement(value: VdomElement): Self = StObject.set(x, "action", value.rawElement.asInstanceOf[js.Any])
      
      inline def setAnchorOrigin(value: SnackbarOrigin): Self = StObject.set(x, "anchorOrigin", value.asInstanceOf[js.Any])
      ...
      inline def setClasses(value: PartialSnackbarClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      
      inline def setClassesUndefined: Self = StObject.set(x, "classes", js.undefined)
      
      inline def setClickAwayListenerProps(value: PartialClickAwayListenerProps): Self = StObject.set(x, "ClickAwayListenerProps", value.asInstanceOf[js.Any])
      
      inline def setClickAwayListenerPropsUndefined: Self = StObject.set(x, "ClickAwayListenerProps", js.undefined)
      ...
      inline def setContentProps(value: PartialSnackbarContentProps): Self = StObject.set(x, "ContentProps", value.asInstanceOf[js.Any])
      ...
      inline def setDisableWindowBlurListener(value: Boolean): Self = StObject.set(x, "disableWindowBlurListener", value.asInstanceOf[js.Any])
      
      inline def setDisableWindowBlurListenerUndefined: Self = StObject.set(x, "disableWindowBlurListener", js.undefined)
      ...
      inline def setMessageVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): Self = StObject.set(x, "message", js.Array(value*))
      ...
      inline def setOnClose(
        value: (/* event */ (ReactEventFrom[Any & org.scalajs.dom.Element]) | Event, /* reason */ SnackbarCloseReason) => Callback
      ): Self = StObject.set(x, "onClose", js.Any.fromFunction2((t0: /* event */ (ReactEventFrom[Any & org.scalajs.dom.Element]) | Event, t1: /* reason */ SnackbarCloseReason) => (value(t0, t1)).runNow()))
