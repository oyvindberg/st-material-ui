...
object autocompleteAutocompleteMod {
  ...
  object AutocompleteProps {
    ...
    inline def apply[T, Multiple /* <: js.UndefOr[Boolean] */, DisableClearable /* <: js.UndefOr[Boolean] */, FreeSolo /* <: js.UndefOr[Boolean] */, ChipComponent /* <: ElementType */](options: js.Array[T], renderInput: AutocompleteRenderInputParams => Node): AutocompleteProps[T, Multiple, DisableClearable, FreeSolo, ChipComponent] = {
