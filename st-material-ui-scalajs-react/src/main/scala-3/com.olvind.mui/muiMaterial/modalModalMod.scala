...
object modalModalMod extends Shortcut {
  ...
  object ModalOwnerState {
    ...
    inline def apply(children: VdomElement, exited: Boolean, open: Boolean): ModalOwnerState = {
      val __obj = js.Dynamic.literal(children = children.rawElement.asInstanceOf[js.Any], exited = exited.asInstanceOf[js.Any], open = open.asInstanceOf[js.Any])
  ...
  trait ModalTypeMap[D /* <: ElementType */, P] extends StObject {
  ...
  object ModalTypeMap {
    ...
    inline def apply[D /* <: ElementType */, P](defaultComponent: D, props: P & BackdropComponent & OmitModalUnstyledTypeMapdivpropsslotProp): ModalTypeMap[D, P] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[ModalTypeMap[D, P]]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: ModalTypeMap[?, ?], D /* <: ElementType */, P] (val x: Self & (ModalTypeMap[D, P])) extends AnyVal {
