...
object cardCardMod extends Shortcut {
  ...
  object CardTypeMap {
    ...
    inline def apply[P, D /* <: ElementType */](defaultComponent: D, props: P & DistributiveOmitPaperPropsPaperTypeMapdiAbout & Raised): CardTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[CardTypeMap[P, D]]
    }
    
    extension [Self <: CardTypeMap[?, ?], P, D /* <: ElementType */](x: Self & (CardTypeMap[P, D])) {
