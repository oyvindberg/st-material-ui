...
object popoverPopoverMod {
  ...
  object PopoverActions {
    ...
    inline def apply(updatePosition: Callback): PopoverActions = {
  ...
  object PopoverPosition {
    ...
    inline def apply(left: Double, top: Double): PopoverPosition = {
  ...
  object PopoverProps {
    ...
    inline def apply(open: Boolean): PopoverProps = {
    ...
    implicit open class MutableBuilder[Self <: PopoverProps] (val x: Self) extends AnyVal {
      ...
      inline def setPaperProps(value: PartialPaperPropsPaperTypeMapdivdefaultC): Self = StObject.set(x, "PaperProps", value.asInstanceOf[js.Any])
