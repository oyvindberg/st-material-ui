...
object outlinedInputOutlinedInputMod {
  ...
  trait OutlinedInputProps extends StObject {
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialOutlinedInputClasses] = js.undefined
  ...
  object OutlinedInputProps {
    ...
    extension [Self <: OutlinedInputProps](x: Self) {
      ...
      inline def setClasses(value: PartialOutlinedInputClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
