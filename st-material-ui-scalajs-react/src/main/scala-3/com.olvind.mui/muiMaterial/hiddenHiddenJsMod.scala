...
object hiddenHiddenJsMod extends Shortcut {
  
  @JSImport("@mui/material/Hidden/HiddenJs", JSImport.Default)
  @js.native
  val default: JSXElementConstructor[HiddenJsProps] = js.native
  ...
  type _To = JSXElementConstructor[HiddenJsProps]
  
  /* This means you don't have to write `default`, but can instead just say `hiddenHiddenJsMod.foo` */
  override def _to: JSXElementConstructor[HiddenJsProps] = default
}
