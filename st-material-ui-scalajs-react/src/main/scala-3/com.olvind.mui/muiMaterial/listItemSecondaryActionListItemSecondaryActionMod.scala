...
object listItemSecondaryActionListItemSecondaryActionMod {
  ...
  trait ListItemSecondaryActionProps extends StObject {
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialListItemSecondaryActionClasses] = js.undefined
  ...
  object ListItemSecondaryActionProps {
    ...
    inline def apply(): ListItemSecondaryActionProps = {
    ...
    implicit open class MutableBuilder[Self <: ListItemSecondaryActionProps] (val x: Self) extends AnyVal {
      ...
      inline def setClasses(value: PartialListItemSecondaryActionClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
