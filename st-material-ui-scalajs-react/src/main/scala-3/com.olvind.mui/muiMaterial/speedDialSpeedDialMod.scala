...
object speedDialSpeedDialMod {
  ...
  */
  ...
  object CloseReason {
    ...
    inline def blur: com.olvind.mui.muiMaterial.muiMaterialStrings.blur = "blur".asInstanceOf[com.olvind.mui.muiMaterial.muiMaterialStrings.blur]
    
    inline def escapeKeyDown: com.olvind.mui.muiMaterial.muiMaterialStrings.escapeKeyDown = "escapeKeyDown".asInstanceOf[com.olvind.mui.muiMaterial.muiMaterialStrings.escapeKeyDown]
    
    inline def mouseLeave: com.olvind.mui.muiMaterial.muiMaterialStrings.mouseLeave = "mouseLeave".asInstanceOf[com.olvind.mui.muiMaterial.muiMaterialStrings.mouseLeave]
    
    inline def toggle: com.olvind.mui.muiMaterial.muiMaterialStrings.toggle = "toggle".asInstanceOf[com.olvind.mui.muiMaterial.muiMaterialStrings.toggle]
  }
  ...
  */
  ...
  object OpenReason {
    ...
    inline def focus: com.olvind.mui.muiMaterial.muiMaterialStrings.focus = "focus".asInstanceOf[com.olvind.mui.muiMaterial.muiMaterialStrings.focus]
    
    inline def mouseEnter: com.olvind.mui.muiMaterial.muiMaterialStrings.mouseEnter = "mouseEnter".asInstanceOf[com.olvind.mui.muiMaterial.muiMaterialStrings.mouseEnter]
  ...
  trait SpeedDialProps extends StObject {
    ...
    /**
      ...
      * @default {}
      */
    var FabProps: js.UndefOr[PartialFabPropsFabTypeMapbuttondefaultCo] = js.undefined
    ...
    /**
      ...
      * @default Zoom
      */
    var TransitionComponent: js.UndefOr[JSXElementConstructor[TransitionProps]] = js.undefined
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialSpeedDialClasses] = js.undefined
  ...
  object SpeedDialProps {
    ...
    inline def apply(ariaLabel: String): SpeedDialProps = {
    ...
    extension [Self <: SpeedDialProps](x: Self) {
      ...
      inline def setClasses(value: PartialSpeedDialClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      inline def setFabProps(value: PartialFabPropsFabTypeMapbuttondefaultCo): Self = StObject.set(x, "FabProps", value.asInstanceOf[js.Any])
      ...
      inline def setOnClose(
        value: (/* event */ ReactEventFrom[js.Object & org.scalajs.dom.Element], /* reason */ CloseReason) => Callback
      ): Self = StObject.set(x, "onClose", js.Any.fromFunction2((t0: /* event */ ReactEventFrom[js.Object & org.scalajs.dom.Element], t1: /* reason */ CloseReason) => (value(t0, t1)).runNow()))
      ...
      inline def setOnOpen(
        value: (/* event */ ReactEventFrom[js.Object & org.scalajs.dom.Element], /* reason */ OpenReason) => Callback
      ): Self = StObject.set(x, "onOpen", js.Any.fromFunction2((t0: /* event */ ReactEventFrom[js.Object & org.scalajs.dom.Element], t1: /* reason */ OpenReason) => (value(t0, t1)).runNow()))
      ...
      inline def setTransitionComponent(value: TransitionProps => japgolly.scalajs.react.facade.React.Element | Null): Self = StObject.set(x, "TransitionComponent", js.Any.fromFunction1(value))
