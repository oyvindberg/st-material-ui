...
object speedDialActionSpeedDialActionMod {
  ...
  inline def default(props: SpeedDialActionProps): Element = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(props.asInstanceOf[js.Any]).asInstanceOf[Element]
  ...
  trait SpeedDialActionProps extends StObject {
    ...
    var onClose: js.UndefOr[js.Function1[/* event */ ReactEventFrom[org.scalajs.dom.Element] | Event, Unit]] = js.undefined
    ...
    /**
      ...
      */
    var tooltipTitle: js.UndefOr[Node] = js.undefined
  ...
  object SpeedDialActionProps {
    ...
    inline def apply(): SpeedDialActionProps = {
    ...
    extension [Self <: SpeedDialActionProps](x: Self) {
      ...
      inline def setOnClose(value: /* event */ ReactEventFrom[org.scalajs.dom.Element] | Event => Callback): Self = StObject.set(x, "onClose", js.Any.fromFunction1((t0: /* event */ ReactEventFrom[org.scalajs.dom.Element] | Event) => value(t0).runNow()))
