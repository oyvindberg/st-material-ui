...
object inputBaseInputBaseMod {
  ...
  object InputBaseComponentProps {
    ...
    inline def apply(): InputBaseComponentProps = {
  ...
  /* Inlined parent @mui/material.@mui/material.InternalStandardProps<react.react.HTMLAttributes<std.HTMLDivElement>, 'children' | 'defaultValue' | 'onBlur' | 'onChange' | 'onFocus' | 'onInvalid' | 'onKeyDown' | 'onKeyUp'> */
  trait InputBaseProps extends StObject {
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialInputBaseClasses] = js.undefined
  ...
  object InputBaseProps {
    ...
    inline def apply(): InputBaseProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[InputBaseProps]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: InputBaseProps] (val x: Self) extends AnyVal {
      ...
      inline def setClasses(value: PartialInputBaseClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
