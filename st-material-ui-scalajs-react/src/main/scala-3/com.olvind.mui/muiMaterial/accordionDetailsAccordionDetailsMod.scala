...
object accordionDetailsAccordionDetailsMod {
  ...
  inline def default(props: AccordionDetailsProps): Element = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(props.asInstanceOf[js.Any]).asInstanceOf[Element]
  ...
  trait AccordionDetailsProps extends StObject {
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialAccordionDetailsClasses] = js.undefined
  ...
  object AccordionDetailsProps {
    ...
    inline def apply(): AccordionDetailsProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[AccordionDetailsProps]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: AccordionDetailsProps] (val x: Self) extends AnyVal {
      ...
      inline def setClasses(value: PartialAccordionDetailsClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
