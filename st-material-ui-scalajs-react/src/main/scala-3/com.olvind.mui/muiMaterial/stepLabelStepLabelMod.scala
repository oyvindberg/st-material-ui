...
import com.olvind.mui.muiMaterial.anon.Label
import com.olvind.mui.muiMaterial.anon.PartialStepIconProps
import com.olvind.mui.muiMaterial.anon.PartialStepLabelClasses
...
object stepLabelStepLabelMod {
  ...
  object default {
    ...
    @JSImport("@mui/material/StepLabel/StepLabel", "default.muiName")
    @js.native
  ...
  type StepLabelClasskey = /* keyof std.NonNullable<@mui/material.anon.PartialStepLabelClasses | undefined> */ String
  ...
  trait StepLabelProps extends StObject {
    ...
    /**
      ...
      */
    var StepIconComponent: js.UndefOr[ElementType] = js.undefined
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialStepLabelClasses] = js.undefined
    ...
    /**
      ...
      * @default {}
      */
    var componentsProps: js.UndefOr[Label] = js.undefined
    ...
    /**
      ...
      */
    var optional: js.UndefOr[Node] = js.undefined
  ...
  object StepLabelProps {
    ...
    implicit open class MutableBuilder[Self <: StepLabelProps] (val x: Self) extends AnyVal {
      ...
      inline def setClasses(value: PartialStepLabelClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      inline def setComponentsProps(value: Label): Self = StObject.set(x, "componentsProps", value.asInstanceOf[js.Any])
      ...
      inline def setOptionalVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): Self = StObject.set(x, "optional", js.Array(value*))
      ...
      inline def setStepIconComponent(value: ElementType): Self = StObject.set(x, "StepIconComponent", value.asInstanceOf[js.Any])
      
      inline def setStepIconComponentUndefined: Self = StObject.set(x, "StepIconComponent", js.undefined)
      
      inline def setStepIconProps(value: PartialStepIconProps): Self = StObject.set(x, "StepIconProps", value.asInstanceOf[js.Any])
      
      inline def setStepIconPropsUndefined: Self = StObject.set(x, "StepIconProps", js.undefined)
