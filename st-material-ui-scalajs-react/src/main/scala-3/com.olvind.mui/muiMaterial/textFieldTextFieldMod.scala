...
object textFieldTextFieldMod {
  ...
  trait BaseTextFieldProps extends StObject {
    ...
    /**
      ...
      */
    var InputLabelProps: js.UndefOr[PartialInputLabelPropsInputLabelTypeMapl] = js.undefined
  ...
  object BaseTextFieldProps {
    ...
    implicit open class MutableBuilder[Self <: BaseTextFieldProps] (val x: Self) extends AnyVal {
      ...
      inline def setClasses(value: PartialTextFieldClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      inline def setFormHelperTextProps(value: PartialFormHelperTextPropsFormHelperText): Self = StObject.set(x, "FormHelperTextProps", value.asInstanceOf[js.Any])
      ...
      inline def setInputLabelProps(value: PartialInputLabelPropsInputLabelTypeMapl): Self = StObject.set(x, "InputLabelProps", value.asInstanceOf[js.Any])
