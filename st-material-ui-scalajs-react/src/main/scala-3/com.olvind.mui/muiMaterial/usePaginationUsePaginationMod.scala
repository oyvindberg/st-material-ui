...
object usePaginationUsePaginationMod {
  ...
  object UsePaginationItem {
    ...
    inline def apply(
      disabled: Boolean,
      onClick: ReactEventFrom[Element & Element] => Callback,
      page: Double,
      selected: Boolean,
      `type`: page | first | last | next | previous | `start-ellipsis` | `end-ellipsis`
    ): UsePaginationItem = {
      val __obj = js.Dynamic.literal(disabled = disabled.asInstanceOf[js.Any], onClick = js.Any.fromFunction1((t0: ReactEventFrom[Element & Element]) => onClick(t0).runNow()), page = page.asInstanceOf[js.Any], selected = selected.asInstanceOf[js.Any])
    ...
    extension [Self <: UsePaginationItem](x: Self) {
      ...
      inline def setOnClick(value: ReactEventFrom[Element & Element] => Callback): Self = StObject.set(x, "onClick", js.Any.fromFunction1((t0: ReactEventFrom[Element & Element]) => value(t0).runNow()))
