...
object usePaginationUsePaginationMod {
  ...
  object UsePaginationItem {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(disabled = disabled.asInstanceOf[js.Any], onClick = js.Any.fromFunction1((t0: ReactEventFrom[Element & Element]) => onClick(t0).runNow()), selected = selected.asInstanceOf[js.Any], page = null)
