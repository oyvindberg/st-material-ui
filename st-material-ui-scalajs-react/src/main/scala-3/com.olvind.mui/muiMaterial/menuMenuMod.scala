...
object menuMenuMod {
  ...
  trait MenuProps extends StObject {
    ...
    /**
      ...
      * @default {}
      */
    var MenuListProps: js.UndefOr[PartialMenuListPropsMenuListTypeMapuldef] = js.undefined
  ...
  object MenuProps {
    ...
    inline def apply(open: Boolean): MenuProps = {
    ...
    extension [Self <: MenuProps](x: Self) {
      ...
      inline def setAnchorElFunction1(value: /* element */ org.scalajs.dom.Element => org.scalajs.dom.Element): Self = StObject.set(x, "anchorEl", js.Any.fromFunction1(value))
      ...
      inline def setMenuListProps(value: PartialMenuListPropsMenuListTypeMapuldef): Self = StObject.set(x, "MenuListProps", value.asInstanceOf[js.Any])
