...
object toggleButtonGroupToggleButtonGroupMod {
  ...
  @JSImport("@mui/material/ToggleButtonGroup/ToggleButtonGroup", JSImport.Namespace)
  @js.native
  ...
  /* Inlined parent @mui/material.@mui/material.InternalStandardProps<react.react.HTMLAttributes<std.HTMLDivElement>, 'onChange' | 'children'> */
  trait ToggleButtonGroupProps extends StObject {
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialToggleButtonGroupClasses] = js.undefined
  ...
  object ToggleButtonGroupProps {
    ...
    inline def apply(): ToggleButtonGroupProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[ToggleButtonGroupProps]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: ToggleButtonGroupProps] (val x: Self) extends AnyVal {
      ...
      inline def setClasses(value: PartialToggleButtonGroupClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
  ...
  trait ToggleButtonGroupPropsColorOverrides extends StObject
  
  trait ToggleButtonGroupPropsSizeOverrides extends StObject
}
