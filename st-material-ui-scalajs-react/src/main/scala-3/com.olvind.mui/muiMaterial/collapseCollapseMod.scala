...
object collapseCollapseMod {
  ...
  trait CollapseProps extends StObject {
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialCollapseClasses] = js.undefined
  ...
  object CollapseProps {
    ...
    implicit open class MutableBuilder[Self <: CollapseProps] (val x: Self) extends AnyVal {
      ...
      inline def setClasses(value: PartialCollapseClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
