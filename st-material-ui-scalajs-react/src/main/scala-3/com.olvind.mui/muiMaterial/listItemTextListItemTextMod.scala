...
object listItemTextListItemTextMod {
  ...
  trait ListItemTextProps[PrimaryTypographyComponent /* <: ElementType */, SecondaryTypographyComponent /* <: ElementType */] extends StObject {
    ...
    /**
      ...
      */
    var primary: js.UndefOr[Node] = js.undefined
    ...
    /**
      ...
      */
    var secondary: js.UndefOr[Node] = js.undefined
  ...
  object ListItemTextProps {
    ...
    inline def apply[PrimaryTypographyComponent /* <: ElementType */, SecondaryTypographyComponent /* <: ElementType */](): ListItemTextProps[PrimaryTypographyComponent, SecondaryTypographyComponent] = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[ListItemTextProps[PrimaryTypographyComponent, SecondaryTypographyComponent]]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: ListItemTextProps[?, ?], PrimaryTypographyComponent /* <: ElementType */, SecondaryTypographyComponent /* <: ElementType */] (val x: Self & (ListItemTextProps[PrimaryTypographyComponent, SecondaryTypographyComponent])) extends AnyVal {
      ...
      inline def setClasses(value: PartialListItemTextClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      inline def setPrimary(value: VdomNode): Self = StObject.set(x, "primary", value.rawNode.asInstanceOf[js.Any])
      ...
      inline def setPrimaryVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): Self = StObject.set(x, "primary", js.Array(value*))
      
      inline def setPrimaryVdomElement(value: VdomElement): Self = StObject.set(x, "primary", value.rawElement.asInstanceOf[js.Any])
      ...
      inline def setSecondary(value: VdomNode): Self = StObject.set(x, "secondary", value.rawNode.asInstanceOf[js.Any])
      ...
      inline def setSecondaryVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): Self = StObject.set(x, "secondary", js.Array(value*))
      
      inline def setSecondaryVdomElement(value: VdomElement): Self = StObject.set(x, "secondary", value.rawElement.asInstanceOf[js.Any])
