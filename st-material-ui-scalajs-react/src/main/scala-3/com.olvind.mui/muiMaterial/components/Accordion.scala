...
object Accordion {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def classes(value: PartialAccordionClasses): this.type = set("classes", value.asInstanceOf[js.Any])
    ...
    inline def defaultExpanded(value: Boolean): this.type = set("defaultExpanded", value.asInstanceOf[js.Any])
    ...
    inline def onChange(value: (/* event */ ReactEventFrom[org.scalajs.dom.Element], /* expanded */ Boolean) => Callback): this.type = set("onChange", js.Any.fromFunction2((t0: /* event */ ReactEventFrom[org.scalajs.dom.Element], t1: /* expanded */ Boolean) => (value(t0, t1)).runNow()))
