...
object BottomNavigationAction {
  ...
  object href {
    ...
    open class Builder (val args: js.Array[Any])
      ...
      inline def classes(value: PartialBottomNavigationActionClasses): this.type = set("classes", value.asInstanceOf[js.Any])
    ...
    type Props = OverridePropsExtendButtonBaseTypeMapBott
  ...
  object normal {
    ...
    type Props = DefaultComponentPropsExtendButtonBaseTypAbout
