...
object ListItemText {
  ...
  inline def apply[PrimaryTypographyComponent /* <: ElementType */, SecondaryTypographyComponent /* <: ElementType */](): Builder[PrimaryTypographyComponent, SecondaryTypographyComponent] = {
  ...
  @scala.inline
  open class Builder[PrimaryTypographyComponent /* <: ElementType */, SecondaryTypographyComponent /* <: ElementType */] (val args: js.Array[Any])
    extends AnyVal
    ...
    inline def primary(value: VdomNode): this.type = set("primary", value.rawNode.asInstanceOf[js.Any])
    
    inline def primaryNull: this.type = set("primary", null)
    ...
    inline def primaryVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): this.type = set("primary", js.Array(value*))
    
    inline def primaryVdomElement(value: VdomElement): this.type = set("primary", value.rawElement.asInstanceOf[js.Any])
    ...
    inline def secondary(value: VdomNode): this.type = set("secondary", value.rawNode.asInstanceOf[js.Any])
    
    inline def secondaryNull: this.type = set("secondary", null)
    ...
    inline def secondaryVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): this.type = set("secondary", js.Array(value*))
    
    inline def secondaryVdomElement(value: VdomElement): this.type = set("secondary", value.rawElement.asInstanceOf[js.Any])
