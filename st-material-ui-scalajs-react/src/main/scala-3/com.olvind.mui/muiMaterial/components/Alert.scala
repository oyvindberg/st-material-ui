...
object Alert {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def classes(value: PartialAlertClasses): this.type = set("classes", value.asInstanceOf[js.Any])
    
    inline def closeText(value: String): this.type = set("closeText", value.asInstanceOf[js.Any])
    
    inline def color(value: AlertColor): this.type = set("color", value.asInstanceOf[js.Any])
    
    inline def components(value: CloseButton): this.type = set("components", value.asInstanceOf[js.Any])
    
    inline def componentsProps(value: CloseIcon): this.type = set("componentsProps", value.asInstanceOf[js.Any])
    ...
    inline def iconMapping(value: PartialRecordAlertColorReactNode): this.type = set("iconMapping", value.asInstanceOf[js.Any])
    ...
    inline def onClose(value: /* event */ ReactEventFrom[org.scalajs.dom.Element] => Callback): this.type = set("onClose", js.Any.fromFunction1((t0: /* event */ ReactEventFrom[org.scalajs.dom.Element]) => value(t0).runNow()))
    ...
    inline def severity(value: AlertColor): this.type = set("severity", value.asInstanceOf[js.Any])
    
    inline def slot(value: String): this.type = set("slot", value.asInstanceOf[js.Any])
    
    inline def slotProps(value: CloseIcon): this.type = set("slotProps", value.asInstanceOf[js.Any])
    
    inline def slots(value: CloseButtonCloseIcon): this.type = set("slots", value.asInstanceOf[js.Any])
    ...
    inline def variant(value: "standard" | "filled" | "outlined"): this.type = set("variant", value.asInstanceOf[js.Any])
