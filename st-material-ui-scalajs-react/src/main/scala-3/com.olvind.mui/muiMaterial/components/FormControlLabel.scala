...
object FormControlLabel {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def onChange(value: (/* event */ ReactEventFrom[org.scalajs.dom.Element], /* checked */ Boolean) => Callback): this.type = set("onChange", js.Any.fromFunction2((t0: /* event */ ReactEventFrom[org.scalajs.dom.Element], t1: /* checked */ Boolean) => (value(t0, t1)).runNow()))
    ...
    inline def onResize(value: ReactEventFrom[HTMLLabelElement & org.scalajs.dom.Element] => Callback): this.type = set("onResize", js.Any.fromFunction1((t0: ReactEventFrom[HTMLLabelElement & org.scalajs.dom.Element]) => value(t0).runNow()))
