...
object ButtonBase {
  ...
  object href {
    ...
    open class Builder (val args: js.Array[Any])
      ...
      inline def classes(value: PartialButtonBaseClasses): this.type = set("classes", value.asInstanceOf[js.Any])
    ...
    type Props = OverridePropsExtendButtonBaseTypeMapButtAbout
    
    def styled: com.olvind.mui.StyledComponent.Builder[OverridePropsExtendButtonBaseTypeMapButtAbout, Builder] = new com.olvind.mui.StyledComponent.Builder[OverridePropsExtendButtonBaseTypeMapButtAbout, Builder](this.component, new js.Object, js.Array(), (newComponent: Any) => new Builder(js.Array(newComponent, js.Dictionary.empty)))
  ...
  object normal {
    ...
    type Props = DefaultComponentPropsExtendButtonBaseTypAction
    
    implicit def make(companion: normal.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
    
    def styled: com.olvind.mui.StyledComponent.Builder[DefaultComponentPropsExtendButtonBaseTypAction, Builder] = new com.olvind.mui.StyledComponent.Builder[DefaultComponentPropsExtendButtonBaseTypAction, Builder](this.component, new js.Object, js.Array(), (newComponent: Any) => new Builder(js.Array(newComponent, js.Dictionary.empty)))
