...
object RadioGroup {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def classes(value: PartialFormGroupClasses): this.type = set("classes", value.asInstanceOf[js.Any])
    ...
    inline def onChange(value: (/* event */ ReactEventFrom[HTMLInputElement], /* value */ String) => Callback): this.type = set("onChange", js.Any.fromFunction2((t0: /* event */ ReactEventFrom[HTMLInputElement], t1: /* value */ String) => (value(t0, t1)).runNow()))
  ...
  def styled: com.olvind.mui.StyledComponent.Builder[RadioGroupProps, Builder] = new com.olvind.mui.StyledComponent.Builder[RadioGroupProps, Builder](this.component, new js.Object, js.Array(), (newComponent: Any) => new Builder(js.Array(newComponent, js.Dictionary.empty)))
