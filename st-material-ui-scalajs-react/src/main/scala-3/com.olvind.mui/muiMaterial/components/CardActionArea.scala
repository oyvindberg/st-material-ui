...
object CardActionArea {
  ...
  object href {
    ...
    open class Builder (val args: js.Array[Any])
      ...
      inline def classes(value: PartialCardActionAreaClasses): this.type = set("classes", value.asInstanceOf[js.Any])
    ...
    type Props = OverridePropsExtendButtonBaseTypeMapCard
  ...
  object normal {
    ...
    type Props = DefaultComponentPropsExtendButtonBaseTypAriaactivedescendant
