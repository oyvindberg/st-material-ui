...
object IconButton {
  ...
  object href {
    ...
    open class Builder (val args: js.Array[Any])
      ...
      inline def classes(value: PartialIconButtonClasses): this.type = set("classes", value.asInstanceOf[js.Any])
      
      inline def color(value: "inherit" | "default" | "primary" | "secondary" | "error" | "info" | "success" | "warning"): this.type = set("color", value.asInstanceOf[js.Any])
      ...
      inline def edge(value: "start" | "end" | false): this.type = set("edge", value.asInstanceOf[js.Any])
      ...
      inline def onResize(value: ReactEventFrom[HTMLAnchorElement & Element] => Callback): this.type = set("onResize", js.Any.fromFunction1((t0: ReactEventFrom[HTMLAnchorElement & Element]) => value(t0).runNow()))
    ...
    type Props = OverridePropsExtendButtonBaseTypeMapIcon
    
    def styled: com.olvind.mui.StyledComponent.Builder[OverridePropsExtendButtonBaseTypeMapIcon, Builder] = new com.olvind.mui.StyledComponent.Builder[OverridePropsExtendButtonBaseTypeMapIcon, Builder](this.component, new js.Object, js.Array(), (newComponent: Any) => new Builder(js.Array(newComponent, js.Dictionary.empty)))
  ...
  object normal {
    ...
    type Props = DefaultComponentPropsExtendButtonBaseTypAriaautocomplete
    
    implicit def make(companion: normal.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
    
    def styled: com.olvind.mui.StyledComponent.Builder[DefaultComponentPropsExtendButtonBaseTypAriaautocomplete, Builder] = new com.olvind.mui.StyledComponent.Builder[DefaultComponentPropsExtendButtonBaseTypAriaautocomplete, Builder](this.component, new js.Object, js.Array(), (newComponent: Any) => new Builder(js.Array(newComponent, js.Dictionary.empty)))
