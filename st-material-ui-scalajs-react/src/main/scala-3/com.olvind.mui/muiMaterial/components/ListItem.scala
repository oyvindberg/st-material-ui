...
object ListItem {
  ...
  object href {
    ...
    open class Builder (val args: js.Array[Any])
      ...
      inline def ContainerComponent(value: ElementType): this.type = set("ContainerComponent", value.asInstanceOf[js.Any])
      ...
      inline def secondaryAction(value: VdomNode): this.type = set("secondaryAction", value.rawNode.asInstanceOf[js.Any])
      
      inline def secondaryActionNull: this.type = set("secondaryAction", null)
      
      inline def secondaryActionVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): this.type = set("secondaryAction", js.Array(value*))
      
      inline def secondaryActionVdomElement(value: VdomElement): this.type = set("secondaryAction", value.rawElement.asInstanceOf[js.Any])
    ...
    type Props = OverridePropsExtendButtonBaseTypeMapList
  ...
  object normal {
    ...
    type Props = DefaultComponentPropsExtendButtonBaseTypAlignItems
