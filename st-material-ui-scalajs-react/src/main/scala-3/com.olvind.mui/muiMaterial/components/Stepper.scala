...
object Stepper {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def alternativeLabel(value: Boolean): this.type = set("alternativeLabel", value.asInstanceOf[js.Any])
    ...
    inline def classes(value: PartialStepperClasses): this.type = set("classes", value.asInstanceOf[js.Any])
    
    inline def color(value: String): this.type = set("color", value.asInstanceOf[js.Any])
    
    inline def component(value: String): this.type = set("component", value.asInstanceOf[js.Any])
    
    inline def connector(value: VdomElement): this.type = set("connector", value.rawElement.asInstanceOf[js.Any])
    
    inline def connectorNull: this.type = set("connector", null)
    ...
    inline def nonLinear(value: Boolean): this.type = set("nonLinear", value.asInstanceOf[js.Any])
  ...
  type Props = /* props */ DefaultComponentPropsStepperTypeMapdiv
  
  implicit def make(companion: Stepper.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def styled: com.olvind.mui.StyledComponent.Builder[/* props */ DefaultComponentPropsStepperTypeMapdiv, Builder] = new com.olvind.mui.StyledComponent.Builder[/* props */ DefaultComponentPropsStepperTypeMapdiv, Builder](this.component, new js.Object, js.Array(), (newComponent: Any) => new Builder(js.Array(newComponent, js.Dictionary.empty)))
  
  def withProps(p: /* props */ DefaultComponentPropsStepperTypeMapdiv): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
