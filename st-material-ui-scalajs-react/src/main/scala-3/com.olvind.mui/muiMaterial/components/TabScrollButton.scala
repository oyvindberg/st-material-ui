...
object TabScrollButton {
  ...
  inline def apply(direction: "left" | "right", orientation: "horizontal" | "vertical"): Builder = {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def classes(value: PartialTabScrollButtonClasses): this.type = set("classes", value.asInstanceOf[js.Any])
    ...
    inline def slotProps(value: StartScrollButtonIcon): this.type = set("slotProps", value.asInstanceOf[js.Any])
  ...
  def styled: com.olvind.mui.StyledComponent.Builder[TabScrollButtonProps, Builder] = new com.olvind.mui.StyledComponent.Builder[TabScrollButtonProps, Builder](this.component, new js.Object, js.Array(), (newComponent: Any) => new Builder(js.Array(newComponent, js.Dictionary.empty)))
