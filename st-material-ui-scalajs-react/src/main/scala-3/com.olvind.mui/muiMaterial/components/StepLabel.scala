...
object StepLabel {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def StepIconComponent(value: ElementType): this.type = set("StepIconComponent", value.asInstanceOf[js.Any])
    
    inline def StepIconProps(value: PartialStepIconProps): this.type = set("StepIconProps", value.asInstanceOf[js.Any])
    ...
    inline def classes(value: PartialStepLabelClasses): this.type = set("classes", value.asInstanceOf[js.Any])
    
    inline def color(value: String): this.type = set("color", value.asInstanceOf[js.Any])
    
    inline def componentsProps(value: Label): this.type = set("componentsProps", value.asInstanceOf[js.Any])
