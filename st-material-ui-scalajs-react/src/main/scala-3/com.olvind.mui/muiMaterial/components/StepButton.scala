...
object StepButton {
  ...
  object href {
    ...
    open class Builder (val args: js.Array[Any])
      ...
      inline def classes(value: PartialStepButtonClasses): this.type = set("classes", value.asInstanceOf[js.Any])
      ...
      inline def optional(value: VdomNode): this.type = set("optional", value.rawNode.asInstanceOf[js.Any])
      
      inline def optionalNull: this.type = set("optional", null)
      
      inline def optionalVarargs(value: (Empty | String | JsNumber | Element)*): this.type = set("optional", js.Array(value*))
      
      inline def optionalVdomElement(value: VdomElement): this.type = set("optional", value.rawElement.asInstanceOf[js.Any])
    ...
    type Props = OverridePropsExtendButtonBaseTypeMapStep
    
    def styled: com.olvind.mui.StyledComponent.Builder[OverridePropsExtendButtonBaseTypeMapStep, Builder] = new com.olvind.mui.StyledComponent.Builder[OverridePropsExtendButtonBaseTypeMapStep, Builder](this.component, new js.Object, js.Array(), (newComponent: Any) => new Builder(js.Array(newComponent, js.Dictionary.empty)))
  ...
  object normal {
    ...
    type Props = DefaultComponentPropsExtendButtonBaseTypAriacolcount
    
    implicit def make(companion: normal.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
    
    def styled: com.olvind.mui.StyledComponent.Builder[DefaultComponentPropsExtendButtonBaseTypAriacolcount, Builder] = new com.olvind.mui.StyledComponent.Builder[DefaultComponentPropsExtendButtonBaseTypAriacolcount, Builder](this.component, new js.Object, js.Array(), (newComponent: Any) => new Builder(js.Array(newComponent, js.Dictionary.empty)))
