...
import com.olvind.mui.muiMaterial.anon.PartialDialogContentTextClasses
...
object DialogContentText {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def classes(value: PartialDialogContentTextClasses): this.type = set("classes", value.asInstanceOf[js.Any])
  ...
  def withProps(p: /* props */ DefaultComponentPropsDialogContentTextTy): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
