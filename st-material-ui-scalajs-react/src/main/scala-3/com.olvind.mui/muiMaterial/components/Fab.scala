...
object Fab {
  ...
  object href {
    ...
    open class Builder (val args: js.Array[Any])
      ...
      inline def variant(value: "circular" | "extended"): this.type = set("variant", value.asInstanceOf[js.Any])
      
      inline def vocab(value: String): this.type = set("vocab", value.asInstanceOf[js.Any])
    }
    
    type Props = OverridePropsExtendButtonBaseTypeMapFabT
    
    def styled: com.olvind.mui.StyledComponent.Builder[OverridePropsExtendButtonBaseTypeMapFabT, Builder] = new com.olvind.mui.StyledComponent.Builder[OverridePropsExtendButtonBaseTypeMapFabT, Builder](this.component, new js.Object, js.Array(), (newComponent: Any) => new Builder(js.Array(newComponent, js.Dictionary.empty)))
    
    def withProps(p: OverridePropsExtendButtonBaseTypeMapFabT): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  ...
  object normal {
    ...
    type Props = DefaultComponentPropsExtendButtonBaseTypAriaatomic
    
    implicit def make(companion: normal.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
    
    def styled: com.olvind.mui.StyledComponent.Builder[DefaultComponentPropsExtendButtonBaseTypAriaatomic, Builder] = new com.olvind.mui.StyledComponent.Builder[DefaultComponentPropsExtendButtonBaseTypAriaatomic, Builder](this.component, new js.Object, js.Array(), (newComponent: Any) => new Builder(js.Array(newComponent, js.Dictionary.empty)))
    
    def withProps(p: DefaultComponentPropsExtendButtonBaseTypAriaatomic): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
}
