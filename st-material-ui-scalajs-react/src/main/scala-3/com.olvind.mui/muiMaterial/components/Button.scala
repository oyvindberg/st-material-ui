...
object Button {
  ...
  object href {
    ...
    inline def apply(href: String): Builder = {
      ...
      new Builder(js.Array(this.component, __props.asInstanceOf[OverridePropsExtendButtonBaseTypeMapButt]))
    }
    ...
    open class Builder (val args: js.Array[Any])
      ...
      inline def disableElevation(value: Boolean): this.type = set("disableElevation", value.asInstanceOf[js.Any])
      ...
      inline def endIcon(value: VdomNode): this.type = set("endIcon", value.rawNode.asInstanceOf[js.Any])
      
      inline def endIconNull: this.type = set("endIcon", null)
      
      inline def endIconVarargs(value: (Empty | String | JsNumber | Element)*): this.type = set("endIcon", js.Array(value*))
      
      inline def endIconVdomElement(value: VdomElement): this.type = set("endIcon", value.rawElement.asInstanceOf[js.Any])
      ...
      inline def startIcon(value: VdomNode): this.type = set("startIcon", value.rawNode.asInstanceOf[js.Any])
      
      inline def startIconNull: this.type = set("startIcon", null)
      
      inline def startIconVarargs(value: (Empty | String | JsNumber | Element)*): this.type = set("startIcon", js.Array(value*))
      
      inline def startIconVdomElement(value: VdomElement): this.type = set("startIcon", value.rawElement.asInstanceOf[js.Any])
      ...
      inline def variant(value: "text" | "outlined" | "contained"): this.type = set("variant", value.asInstanceOf[js.Any])
      
      inline def vocab(value: String): this.type = set("vocab", value.asInstanceOf[js.Any])
    }
    
    type Props = OverridePropsExtendButtonBaseTypeMapButt
    
    def styled: com.olvind.mui.StyledComponent.Builder[OverridePropsExtendButtonBaseTypeMapButt, Builder] = new com.olvind.mui.StyledComponent.Builder[OverridePropsExtendButtonBaseTypeMapButt, Builder](this.component, new js.Object, js.Array(), (newComponent: Any) => new Builder(js.Array(newComponent, js.Dictionary.empty)))
    
    def withProps(p: OverridePropsExtendButtonBaseTypeMapButt): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  ...
  object normal {
    ...
    open class Builder (val args: js.Array[Any])
      ...
      inline def onResize(value: ReactEventFrom[HTMLButtonElement & org.scalajs.dom.Element] => Callback): this.type = set("onResize", js.Any.fromFunction1((t0: ReactEventFrom[HTMLButtonElement & org.scalajs.dom.Element]) => value(t0).runNow()))
    ...
    type Props = DefaultComponentPropsExtendButtonBaseTypAccessKey
    
    implicit def make(companion: normal.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
    
    def styled: com.olvind.mui.StyledComponent.Builder[DefaultComponentPropsExtendButtonBaseTypAccessKey, Builder] = new com.olvind.mui.StyledComponent.Builder[DefaultComponentPropsExtendButtonBaseTypAccessKey, Builder](this.component, new js.Object, js.Array(), (newComponent: Any) => new Builder(js.Array(newComponent, js.Dictionary.empty)))
    
    def withProps(p: DefaultComponentPropsExtendButtonBaseTypAccessKey): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
}
