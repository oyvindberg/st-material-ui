...
object SpeedDial {
  ...
  inline def apply(ariaLabel: String): Builder = {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def TransitionComponent(value: TransitionProps => Element | Null): this.type = set("TransitionComponent", js.Any.fromFunction1(value))
    ...
    inline def classes(value: PartialSpeedDialClasses): this.type = set("classes", value.asInstanceOf[js.Any])
    ...
    inline def direction(value: "up" | "down" | "left" | "right"): this.type = set("direction", value.asInstanceOf[js.Any])
    ...
    ): this.type = set("onClose", js.Any.fromFunction2((t0: /* event */ ReactEventFrom[js.Object & org.scalajs.dom.Element], t1: /* reason */ CloseReason) => (value(t0, t1)).runNow()))
    ...
    ): this.type = set("onOpen", js.Any.fromFunction2((t0: /* event */ ReactEventFrom[js.Object & org.scalajs.dom.Element], t1: /* reason */ OpenReason) => (value(t0, t1)).runNow()))
