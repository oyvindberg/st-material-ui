...
object Select {
  ...
  open class Builder[T] (val args: js.Array[Any])
    ...
    inline def input(value: VdomElement): this.type = set("input", value.rawElement.asInstanceOf[js.Any])
    ...
    inline def onChange(value: (/* event */ SelectChangeEvent[T], /* child */ Node) => Callback): this.type = set("onChange", js.Any.fromFunction2((t0: /* event */ SelectChangeEvent[T], t1: /* child */ Node) => (value(t0, t1)).runNow()))
    ...
    inline def renderValue(value: T => Node): this.type = set("renderValue", js.Any.fromFunction1(value))
