...
import com.olvind.mui.muiMaterial.anon.ImgHTMLAttributesHTMLImageElement
...
object Avatar {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def classes(value: PartialAvatarClasses): this.type = set("classes", value.asInstanceOf[js.Any])
    ...
    inline def variant(value: "circular" | "rounded" | "square"): this.type = set("variant", value.asInstanceOf[js.Any])
