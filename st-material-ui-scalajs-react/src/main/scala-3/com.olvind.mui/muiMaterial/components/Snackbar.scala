...
object Snackbar {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def ClickAwayListenerProps(value: PartialClickAwayListenerProps): this.type = set("ClickAwayListenerProps", value.asInstanceOf[js.Any])
    
    inline def ContentProps(value: PartialSnackbarContentProps): this.type = set("ContentProps", value.asInstanceOf[js.Any])
    ...
    inline def classes(value: PartialSnackbarClasses): this.type = set("classes", value.asInstanceOf[js.Any])
    ...
    ): this.type = set("onClose", js.Any.fromFunction2((t0: /* event */ (ReactEventFrom[Any & org.scalajs.dom.Element]) | Event, t1: /* reason */ SnackbarCloseReason) => (value(t0, t1)).runNow()))
  ...
  def styled: com.olvind.mui.StyledComponent.Builder[SnackbarProps, Builder] = new com.olvind.mui.StyledComponent.Builder[SnackbarProps, Builder](this.component, new js.Object, js.Array(), (newComponent: Any) => new Builder(js.Array(newComponent, js.Dictionary.empty)))
