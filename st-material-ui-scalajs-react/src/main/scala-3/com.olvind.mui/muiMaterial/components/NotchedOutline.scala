...
object NotchedOutline {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def onResize(value: ReactEventFrom[HTMLFieldSetElement & org.scalajs.dom.Element] => Callback): this.type = set("onResize", js.Any.fromFunction1((t0: ReactEventFrom[HTMLFieldSetElement & org.scalajs.dom.Element]) => value(t0).runNow()))
