...
object MobileStepper {
  ...
  inline def apply(steps: Double): Builder = {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def LinearProgressProps(value: PartialLinearProgressProps): this.type = set("LinearProgressProps", value.asInstanceOf[js.Any])
    ...
    inline def backButton(value: VdomNode): this.type = set("backButton", value.rawNode.asInstanceOf[js.Any])
    
    inline def backButtonNull: this.type = set("backButton", null)
    
    inline def backButtonVarargs(value: (Empty | String | JsNumber | Element)*): this.type = set("backButton", js.Array(value*))
    
    inline def backButtonVdomElement(value: VdomElement): this.type = set("backButton", value.rawElement.asInstanceOf[js.Any])
    
    inline def className(value: String): this.type = set("className", value.asInstanceOf[js.Any])
    
    inline def classes(value: PartialMobileStepperClasses): this.type = set("classes", value.asInstanceOf[js.Any])
    ...
    inline def position(value: "bottom" | "top" | "static"): this.type = set("position", value.asInstanceOf[js.Any])
    ...
    inline def variant(value: "text" | "dots" | "progress"): this.type = set("variant", value.asInstanceOf[js.Any])
  ...
  def styled: com.olvind.mui.StyledComponent.Builder[MobileStepperProps, Builder] = new com.olvind.mui.StyledComponent.Builder[MobileStepperProps, Builder](this.component, new js.Object, js.Array(), (newComponent: Any) => new Builder(js.Array(newComponent, js.Dictionary.empty)))
