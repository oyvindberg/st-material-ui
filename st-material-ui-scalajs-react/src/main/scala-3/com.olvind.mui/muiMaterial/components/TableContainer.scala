...
object TableContainer {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def classes(value: PartialTableContainerClasses): this.type = set("classes", value.asInstanceOf[js.Any])
  ...
  type Props = /* props */ DefaultComponentPropsTableContainerTypeM
