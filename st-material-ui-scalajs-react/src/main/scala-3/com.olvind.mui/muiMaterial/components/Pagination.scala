...
object Pagination {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def onChange(value: (/* event */ ReactEventFrom[Any & Element], /* page */ Double) => Callback): this.type = set("onChange", js.Any.fromFunction2((t0: /* event */ ReactEventFrom[Any & Element], t1: /* page */ Double) => (value(t0, t1)).runNow()))
    ...
    inline def renderItem(value: /* params */ PaginationRenderItemParams => Node): this.type = set("renderItem", js.Any.fromFunction1(value))
