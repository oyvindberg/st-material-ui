...
object PaginationItem {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def classes(value: PartialPaginationItemClasses): this.type = set("classes", value.asInstanceOf[js.Any])
    
    inline def color(value: "standard" | "primary" | "secondary"): this.type = set("color", value.asInstanceOf[js.Any])
    
    inline def component(value: String): this.type = set("component", value.asInstanceOf[js.Any])
    
    inline def components(value: First): this.type = set("components", value.asInstanceOf[js.Any])
    ...
    inline def page(value: VdomNode): this.type = set("page", value.rawNode.asInstanceOf[js.Any])
    
    inline def pageNull: this.type = set("page", null)
    
    inline def pageVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): this.type = set("page", js.Array(value*))
    
    inline def pageVdomElement(value: VdomElement): this.type = set("page", value.rawElement.asInstanceOf[js.Any])
    ...
    inline def shape(value: "circular" | "rounded"): this.type = set("shape", value.asInstanceOf[js.Any])
    
    inline def size(value: "small" | "medium" | "large"): this.type = set("size", value.asInstanceOf[js.Any])
    
    inline def slot(value: String): this.type = set("slot", value.asInstanceOf[js.Any])
    
    inline def slots(value: First): this.type = set("slots", value.asInstanceOf[js.Any])
    ...
    inline def `type`(value: "page" | "first" | "last" | "next" | "previous" | "start-ellipsis" | "end-ellipsis"): this.type = set("type", value.asInstanceOf[js.Any])
    
    inline def typeof(value: String): this.type = set("typeof", value.asInstanceOf[js.Any])
    
    inline def unselectable(value: "on" | "off"): this.type = set("unselectable", value.asInstanceOf[js.Any])
    
    inline def variant(value: "text" | "outlined"): this.type = set("variant", value.asInstanceOf[js.Any])
    
    inline def vocab(value: String): this.type = set("vocab", value.asInstanceOf[js.Any])
  }
  
  type Props = /* props */ DefaultComponentPropsPaginationItemTypeM
  
  implicit def make(companion: PaginationItem.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def styled: com.olvind.mui.StyledComponent.Builder[/* props */ DefaultComponentPropsPaginationItemTypeM, Builder] = new com.olvind.mui.StyledComponent.Builder[/* props */ DefaultComponentPropsPaginationItemTypeM, Builder](this.component, new js.Object, js.Array(), (newComponent: Any) => new Builder(js.Array(newComponent, js.Dictionary.empty)))
