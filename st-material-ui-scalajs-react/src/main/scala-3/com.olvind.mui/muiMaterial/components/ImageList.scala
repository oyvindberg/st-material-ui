...
object ImageList {
  ...
  inline def apply(children: Element | String | Double | Any | ReactPortal | Boolean): Builder = {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def onClick(value: ReactMouseEventFrom[HTMLUListElement & org.scalajs.dom.Element] => Callback): this.type = set("onClick", js.Any.fromFunction1((t0: ReactMouseEventFrom[HTMLUListElement & org.scalajs.dom.Element]) => value(t0).runNow()))
    ...
    inline def onResize(value: ReactEventFrom[HTMLUListElement & org.scalajs.dom.Element] => Callback): this.type = set("onResize", js.Any.fromFunction1((t0: ReactEventFrom[HTMLUListElement & org.scalajs.dom.Element]) => value(t0).runNow()))
    ...
    inline def onSelect(value: ReactEventFrom[HTMLUListElement & org.scalajs.dom.Element] => Callback): this.type = set("onSelect", js.Any.fromFunction1((t0: ReactEventFrom[HTMLUListElement & org.scalajs.dom.Element]) => value(t0).runNow()))
