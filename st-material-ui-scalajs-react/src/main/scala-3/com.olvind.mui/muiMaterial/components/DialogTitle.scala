...
object DialogTitle {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def classes(value: PartialDialogTitleClasses): this.type = set("classes", value.asInstanceOf[js.Any])
    ...
    inline def gutterBottom(value: Boolean): this.type = set("gutterBottom", value.asInstanceOf[js.Any])
    ...
    inline def noWrap(value: Boolean): this.type = set("noWrap", value.asInstanceOf[js.Any])
    ...
    inline def onChange(value: ReactEventFrom[HTMLSpanElement & Element] => Callback): this.type = set("onChange", js.Any.fromFunction1((t0: ReactEventFrom[HTMLSpanElement & Element]) => value(t0).runNow()))
    ...
    inline def paragraph(value: Boolean): this.type = set("paragraph", value.asInstanceOf[js.Any])
    ...
    inline def variant(value: Variant | "inherit"): this.type = set("variant", value.asInstanceOf[js.Any])
    
    inline def variantMapping(value: PartialRecordVariantinheritstring): this.type = set("variantMapping", value.asInstanceOf[js.Any])
  ...
  type Props = /* props */ DefaultComponentPropsDialogTitleTypeMapT
  
  implicit def make(companion: DialogTitle.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def styled: com.olvind.mui.StyledComponent.Builder[/* props */ DefaultComponentPropsDialogTitleTypeMapT, Builder] = new com.olvind.mui.StyledComponent.Builder[/* props */ DefaultComponentPropsDialogTitleTypeMapT, Builder](this.component, new js.Object, js.Array(), (newComponent: Any) => new Builder(js.Array(newComponent, js.Dictionary.empty)))
  
  def withProps(p: /* props */ DefaultComponentPropsDialogTitleTypeMapT): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
