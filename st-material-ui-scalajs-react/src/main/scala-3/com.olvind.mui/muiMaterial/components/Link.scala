...
object Link {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def TypographyClasses(value: js.UndefOr[PartialTypographyClasses] & js.UndefOr[Partial[ClassNameMap[scala.Nothing]]]): this.type = set("TypographyClasses", value.asInstanceOf[js.Any])
    ...
    inline def classes(value: PartialLinkClasses): this.type = set("classes", value.asInstanceOf[js.Any])
