...
object Tabs {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def ScrollButtonComponent(value: ElementType): this.type = set("ScrollButtonComponent", value.asInstanceOf[js.Any])
    
    inline def TabIndicatorProps(value: HTMLAttributesHTMLDivElement): this.type = set("TabIndicatorProps", value.asInstanceOf[js.Any])
    
    inline def TabScrollButtonProps(value: PartialTabScrollButtonProps): this.type = set("TabScrollButtonProps", value.asInstanceOf[js.Any])
    ...
    inline def action(value: Ref[TabsActions]): this.type = set("action", value.asInstanceOf[js.Any])
    
    inline def actionFunction1(value: TabsActions | Null => Callback): this.type = set("action", js.Any.fromFunction1((t0: TabsActions | Null) => value(t0).runNow()))
    
    inline def actionNull: this.type = set("action", null)
    
    inline def allowScrollButtonsMobile(value: Boolean): this.type = set("allowScrollButtonsMobile", value.asInstanceOf[js.Any])
    ...
    inline def classes(value: PartialTabsClasses): this.type = set("classes", value.asInstanceOf[js.Any])
    ...
    inline def indicatorColor(value: "secondary" | "primary"): this.type = set("indicatorColor", value.asInstanceOf[js.Any])
    ...
    inline def onChange(value: (/* event */ ReactEventFrom[Element], /* value */ Any) => Callback): this.type = set("onChange", js.Any.fromFunction2((t0: /* event */ ReactEventFrom[Element], t1: /* value */ Any) => (value(t0, t1)).runNow()))
    ...
    inline def onFocusVisible(value: ReactFocusEventFrom[Any & Element] => Callback): this.type = set("onFocusVisible", js.Any.fromFunction1((t0: ReactFocusEventFrom[Any & Element]) => value(t0).runNow()))
    ...
    inline def onResize(value: ReactEventFrom[HTMLButtonElement & Element] => Callback): this.type = set("onResize", js.Any.fromFunction1((t0: ReactEventFrom[HTMLButtonElement & Element]) => value(t0).runNow()))
    ...
    inline def scrollButtons(value: "auto" | true | false): this.type = set("scrollButtons", value.asInstanceOf[js.Any])
    ...
    inline def textColor(value: "secondary" | "primary" | "inherit"): this.type = set("textColor", value.asInstanceOf[js.Any])
    ...
    inline def variant(value: "standard" | "scrollable" | "fullWidth"): this.type = set("variant", value.asInstanceOf[js.Any])
    
    inline def visibleScrollbar(value: Boolean): this.type = set("visibleScrollbar", value.asInstanceOf[js.Any])
    
    inline def vocab(value: String): this.type = set("vocab", value.asInstanceOf[js.Any])
  }
  
  type Props = /* props */ DefaultComponentPropsTabsTypeMappropsOve
