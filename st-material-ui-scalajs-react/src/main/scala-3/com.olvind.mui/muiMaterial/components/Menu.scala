...
object Menu {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def actionFunction1(value: PopoverActions | Null => Callback): this.type = set("action", js.Any.fromFunction1((t0: PopoverActions | Null) => value(t0).runNow()))
    ...
    inline def anchorElFunction1(value: /* element */ org.scalajs.dom.Element => org.scalajs.dom.Element): this.type = set("anchorEl", js.Any.fromFunction1(value))
