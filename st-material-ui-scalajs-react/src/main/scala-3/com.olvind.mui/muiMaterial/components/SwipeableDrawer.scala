...
object SwipeableDrawer {
  ...
  inline def apply(
    ...
    val __props = js.Dynamic.literal(onClose = js.Any.fromFunction1((t0: ReactEventFrom[js.Object & Element]) => onClose(t0).runNow()), onOpen = js.Any.fromFunction1((t0: ReactEventFrom[js.Object & Element]) => onOpen(t0).runNow()))
