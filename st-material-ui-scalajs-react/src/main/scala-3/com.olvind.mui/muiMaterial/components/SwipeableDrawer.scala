...
object SwipeableDrawer {
  ...
  inline def apply(
    ...
    val __props = js.Dynamic.literal(onClose = js.Any.fromFunction1((t0: ReactEventFrom[js.Object & Element]) => onClose(t0).runNow()), onOpen = js.Any.fromFunction1((t0: ReactEventFrom[js.Object & Element]) => onOpen(t0).runNow()), open = open.asInstanceOf[js.Any])
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def SlideProps(value: PartialSlideProps): this.type = set("SlideProps", value.asInstanceOf[js.Any])
    
    inline def SwipeAreaProps(value: js.Object): this.type = set("SwipeAreaProps", value.asInstanceOf[js.Any])
    ...
    inline def classes(value: PartialDrawerClasses): this.type = set("classes", value.asInstanceOf[js.Any])
    ...
    inline def disableBackdropTransition(value: Boolean): this.type = set("disableBackdropTransition", value.asInstanceOf[js.Any])
    
    inline def disableDiscovery(value: Boolean): this.type = set("disableDiscovery", value.asInstanceOf[js.Any])
    ...
    inline def hysteresis(value: Double): this.type = set("hysteresis", value.asInstanceOf[js.Any])
    ...
    inline def minFlingVelocity(value: Double): this.type = set("minFlingVelocity", value.asInstanceOf[js.Any])
    ...
    inline def onBackdropClick(value: ReactEventFrom[js.Object & Element] => Callback): this.type = set("onBackdropClick", js.Any.fromFunction1((t0: ReactEventFrom[js.Object & Element]) => value(t0).runNow()))
    ...
    inline def variant(value: permanent | persistent | temporary): this.type = set("variant", value.asInstanceOf[js.Any])
