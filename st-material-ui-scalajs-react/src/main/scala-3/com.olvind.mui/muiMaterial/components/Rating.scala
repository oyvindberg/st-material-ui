...
object Rating {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def IconContainerComponent(value: ElementType): this.type = set("IconContainerComponent", value.asInstanceOf[js.Any])
    ...
    inline def emptyIcon(value: VdomNode): this.type = set("emptyIcon", value.rawNode.asInstanceOf[js.Any])
    
    inline def emptyIconNull: this.type = set("emptyIcon", null)
    
    inline def emptyIconVarargs(value: (Empty | String | JsNumber | Element)*): this.type = set("emptyIcon", js.Array(value*))
    
    inline def emptyIconVdomElement(value: VdomElement): this.type = set("emptyIcon", value.rawElement.asInstanceOf[js.Any])
    
    inline def emptyLabelText(value: VdomNode): this.type = set("emptyLabelText", value.rawNode.asInstanceOf[js.Any])
    
    inline def emptyLabelTextNull: this.type = set("emptyLabelText", null)
    
    inline def emptyLabelTextVarargs(value: (Empty | String | JsNumber | Element)*): this.type = set("emptyLabelText", js.Array(value*))
    
    inline def emptyLabelTextVdomElement(value: VdomElement): this.type = set("emptyLabelText", value.rawElement.asInstanceOf[js.Any])
    ...
    inline def onChangeActive(value: (/* event */ ReactEventFrom[org.scalajs.dom.Element], /* value */ Double) => Callback): this.type = set("onChangeActive", js.Any.fromFunction2((t0: /* event */ ReactEventFrom[org.scalajs.dom.Element], t1: /* value */ Double) => (value(t0, t1)).runNow()))
