...
object DialogContent {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def classes(value: PartialDialogContentClasses): this.type = set("classes", value.asInstanceOf[js.Any])
    ...
    inline def dividers(value: Boolean): this.type = set("dividers", value.asInstanceOf[js.Any])
  ...
  def styled: com.olvind.mui.StyledComponent.Builder[DialogContentProps, Builder] = new com.olvind.mui.StyledComponent.Builder[DialogContentProps, Builder](this.component, new js.Object, js.Array(), (newComponent: Any) => new Builder(js.Array(newComponent, js.Dictionary.empty)))
