...
object Chip {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def deleteIcon(value: VdomElement): this.type = set("deleteIcon", value.rawElement.asInstanceOf[js.Any])
    ...
    inline def onDelete(value: Any => Callback): this.type = set("onDelete", js.Any.fromFunction1((t0: Any) => value(t0).runNow()))
