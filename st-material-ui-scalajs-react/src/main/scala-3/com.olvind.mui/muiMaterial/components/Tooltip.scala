...
object Tooltip {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def classes(value: PartialTooltipClasses): this.type = set("classes", value.asInstanceOf[js.Any])
    
    inline def color(value: String): this.type = set("color", value.asInstanceOf[js.Any])
    
    inline def components(value: com.olvind.mui.muiMaterial.anon.Tooltip): this.type = set("components", value.asInstanceOf[js.Any])
    
    inline def componentsProps(value: com.olvind.mui.muiMaterial.anon.Popper): this.type = set("componentsProps", value.asInstanceOf[js.Any])
    ...
    inline def onClose(value: /* event */ ReactEventFrom[org.scalajs.dom.Element] | Event => Callback): this.type = set("onClose", js.Any.fromFunction1((t0: /* event */ ReactEventFrom[org.scalajs.dom.Element] | Event) => value(t0).runNow()))
    ...
    inline def slotProps(value: com.olvind.mui.muiMaterial.anon.Popper): this.type = set("slotProps", value.asInstanceOf[js.Any])
