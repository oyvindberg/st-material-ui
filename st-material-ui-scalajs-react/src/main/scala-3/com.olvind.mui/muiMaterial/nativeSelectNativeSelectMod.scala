...
object nativeSelectNativeSelectMod {
  ...
  trait NativeSelectProps extends StObject {
    ...
    /**
      ...
      * @default {}
      */
    var classes: js.UndefOr[PartialNativeSelectClasses] = js.undefined
    ...
    var endAdornment: js.UndefOr[Node] = js.undefined
    ...
    /**
      ...
      * @default <Input />
      */
    var input: js.UndefOr[japgolly.scalajs.react.facade.React.Element] = js.undefined
    ...
    /**
      ...
      */
    var inputProps: js.UndefOr[PartialNativeSelectInputProps] = js.undefined
  ...
  object NativeSelectProps {
    ...
    inline def apply(): NativeSelectProps = {
    ...
    implicit open class MutableBuilder[Self <: NativeSelectProps] (val x: Self) extends AnyVal {
      ...
      inline def setClasses(value: PartialNativeSelectClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      inline def setEndAdornmentVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): Self = StObject.set(x, "endAdornment", js.Array(value*))
      ...
      inline def setInputProps(value: PartialNativeSelectInputProps): Self = StObject.set(x, "inputProps", value.asInstanceOf[js.Any])
      ...
      inline def setRenderSuffix(value: /* state */ Disabled => Node): Self = StObject.set(x, "renderSuffix", js.Any.fromFunction1(value))
      ...
      inline def setStartAdornmentVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): Self = StObject.set(x, "startAdornment", js.Array(value*))
