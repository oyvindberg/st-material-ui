...
object tableContextMod extends Shortcut {
  ...
  trait TableContextProps extends StObject {
    ...
    var padding: com.olvind.mui.muiMaterial.muiMaterialStrings.default | checkbox | none
    
    var size: com.olvind.mui.muiMaterial.muiMaterialStrings.default | checkbox | none
  }
  object TableContextProps {
    ...
    extension [Self <: TableContextProps](x: Self) {
      ...
      inline def setPadding(value: com.olvind.mui.muiMaterial.muiMaterialStrings.default | checkbox | none): Self = StObject.set(x, "padding", value.asInstanceOf[js.Any])
      
      inline def setSize(value: com.olvind.mui.muiMaterial.muiMaterialStrings.default | checkbox | none): Self = StObject.set(x, "size", value.asInstanceOf[js.Any])
    }
  }
