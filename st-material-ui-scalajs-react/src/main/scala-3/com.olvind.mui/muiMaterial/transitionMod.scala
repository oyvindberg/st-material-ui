...
object transitionMod {
  ...
  */
  ...
  object TransitionHandlerKeys {
    ...
    inline def onEnter: com.olvind.mui.muiMaterial.muiMaterialStrings.onEnter = "onEnter".asInstanceOf[com.olvind.mui.muiMaterial.muiMaterialStrings.onEnter]
    
    inline def onEntered: com.olvind.mui.muiMaterial.muiMaterialStrings.onEntered = "onEntered".asInstanceOf[com.olvind.mui.muiMaterial.muiMaterialStrings.onEntered]
    
    inline def onEntering: com.olvind.mui.muiMaterial.muiMaterialStrings.onEntering = "onEntering".asInstanceOf[com.olvind.mui.muiMaterial.muiMaterialStrings.onEntering]
    
    inline def onExit: com.olvind.mui.muiMaterial.muiMaterialStrings.onExit = "onExit".asInstanceOf[com.olvind.mui.muiMaterial.muiMaterialStrings.onExit]
    
    inline def onExited: com.olvind.mui.muiMaterial.muiMaterialStrings.onExited = "onExited".asInstanceOf[com.olvind.mui.muiMaterial.muiMaterialStrings.onExited]
    
    inline def onExiting: com.olvind.mui.muiMaterial.muiMaterialStrings.onExiting = "onExiting".asInstanceOf[com.olvind.mui.muiMaterial.muiMaterialStrings.onExiting]
  }
  ...
  */
  ...
  object TransitionKeys {
    ...
    inline def addEndListener: com.olvind.mui.muiMaterial.muiMaterialStrings.addEndListener = "addEndListener".asInstanceOf[com.olvind.mui.muiMaterial.muiMaterialStrings.addEndListener]
    
    inline def easing: com.olvind.mui.muiMaterial.muiMaterialStrings.easing = "easing".asInstanceOf[com.olvind.mui.muiMaterial.muiMaterialStrings.easing]
    
    inline def in: com.olvind.mui.muiMaterial.muiMaterialStrings.in = "in".asInstanceOf[com.olvind.mui.muiMaterial.muiMaterialStrings.in]
    
    inline def mountOnEnter: com.olvind.mui.muiMaterial.muiMaterialStrings.mountOnEnter = "mountOnEnter".asInstanceOf[com.olvind.mui.muiMaterial.muiMaterialStrings.mountOnEnter]
    ...
    inline def timeout: com.olvind.mui.muiMaterial.muiMaterialStrings.timeout = "timeout".asInstanceOf[com.olvind.mui.muiMaterial.muiMaterialStrings.timeout]
    
    inline def unmountOnExit: com.olvind.mui.muiMaterial.muiMaterialStrings.unmountOnExit = "unmountOnExit".asInstanceOf[com.olvind.mui.muiMaterial.muiMaterialStrings.unmountOnExit]
  }
  ...
  object TransitionProps {
    ...
    extension [Self <: TransitionProps](x: Self) {
      ...
      inline def setOnDoubleClick(value: ReactMouseEventFrom[HTMLElement & org.scalajs.dom.Element] => Callback): Self = StObject.set(x, "onDoubleClick", js.Any.fromFunction1((t0: ReactMouseEventFrom[HTMLElement & org.scalajs.dom.Element]) => value(t0).runNow()))
      ...
      inline def setOnProgress(value: ReactEventFrom[HTMLElement & org.scalajs.dom.Element] => Callback): Self = StObject.set(x, "onProgress", js.Any.fromFunction1((t0: ReactEventFrom[HTMLElement & org.scalajs.dom.Element]) => value(t0).runNow()))
      ...
      inline def setOnTouchEnd(value: ReactTouchEventFrom[HTMLElement & org.scalajs.dom.Element] => Callback): Self = StObject.set(x, "onTouchEnd", js.Any.fromFunction1((t0: ReactTouchEventFrom[HTMLElement & org.scalajs.dom.Element]) => value(t0).runNow()))
      
      inline def setOnTouchEndUndefined: Self = StObject.set(x, "onTouchEnd", js.undefined)
      
      inline def setOnTouchMove(value: ReactTouchEventFrom[HTMLElement & org.scalajs.dom.Element] => Callback): Self = StObject.set(x, "onTouchMove", js.Any.fromFunction1((t0: ReactTouchEventFrom[HTMLElement & org.scalajs.dom.Element]) => value(t0).runNow()))
      ...
      inline def setOnTransitionEnd(value: ReactTransitionEventFrom[HTMLElement & org.scalajs.dom.Element] => Callback): Self = StObject.set(x, "onTransitionEnd", js.Any.fromFunction1((t0: ReactTransitionEventFrom[HTMLElement & org.scalajs.dom.Element]) => value(t0).runNow()))
