...
object stepIconStepIconMod {
  ...
  trait StepIconProps extends StObject {
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialStepIconClasses] = js.undefined
  ...
  object StepIconProps {
    ...
    inline def apply(): StepIconProps = {
    ...
    implicit open class MutableBuilder[Self <: StepIconProps] (val x: Self) extends AnyVal {
      ...
      inline def setClasses(value: PartialStepIconClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
