...
object mobileStepperMobileStepperMod {
  ...
  trait MobileStepperProps extends StObject {
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialMobileStepperClasses] = js.undefined
  ...
  object MobileStepperProps {
    ...
    inline def apply(steps: Double): MobileStepperProps = {
    ...
    extension [Self <: MobileStepperProps](x: Self) {
      ...
      inline def setBackButton(value: VdomNode): Self = StObject.set(x, "backButton", value.rawNode.asInstanceOf[js.Any])
      
      inline def setBackButtonNull: Self = StObject.set(x, "backButton", null)
      
      inline def setBackButtonVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): Self = StObject.set(x, "backButton", js.Array(value*))
      
      inline def setBackButtonVdomElement(value: VdomElement): Self = StObject.set(x, "backButton", value.rawElement.asInstanceOf[js.Any])
      
      inline def setClassName(value: String): Self = StObject.set(x, "className", value.asInstanceOf[js.Any])
      
      inline def setClassNameUndefined: Self = StObject.set(x, "className", js.undefined)
      
      inline def setClasses(value: PartialMobileStepperClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      inline def setLinearProgressProps(value: PartialLinearProgressProps): Self = StObject.set(x, "LinearProgressProps", value.asInstanceOf[js.Any])
      
      inline def setLinearProgressPropsUndefined: Self = StObject.set(x, "LinearProgressProps", js.undefined)
      ...
      inline def setNextButtonVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): Self = StObject.set(x, "nextButton", js.Array(value*))
      ...
      inline def setPosition(value: bottom | top | static): Self = StObject.set(x, "position", value.asInstanceOf[js.Any])
      ...
      inline def setVariant(value: text | dots | progress): Self = StObject.set(x, "variant", value.asInstanceOf[js.Any])
