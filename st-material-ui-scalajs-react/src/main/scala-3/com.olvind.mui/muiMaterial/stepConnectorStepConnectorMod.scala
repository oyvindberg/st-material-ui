...
object stepConnectorStepConnectorMod {
  ...
  trait StepConnectorProps extends StObject {
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialStepConnectorClasses] = js.undefined
  ...
  object StepConnectorProps {
    ...
    inline def apply(): StepConnectorProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[StepConnectorProps]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: StepConnectorProps] (val x: Self) extends AnyVal {
      ...
      inline def setClasses(value: PartialStepConnectorClasses): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
