...
object base {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def onResize(value: ReactEventFrom[HTMLBaseElement & Element] => Callback): this.type = set("onResize", js.Any.fromFunction1((t0: ReactEventFrom[HTMLBaseElement & Element]) => value(t0).runNow()))
  ...
  def styled: com.olvind.mui.StyledComponent.Builder[DetailedHTMLProps[BaseHTMLAttributes[HTMLBaseElement], HTMLBaseElement], Builder] = new com.olvind.mui.StyledComponent.Builder[DetailedHTMLProps[BaseHTMLAttributes[HTMLBaseElement], HTMLBaseElement], Builder](this.component, new js.Object, js.Array(), (newComponent: Any) => new Builder(js.Array(newComponent, js.Dictionary.empty)))
