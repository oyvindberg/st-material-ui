...
object ellipse {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[SVGEllipseElement] {
    ...
    inline def onAbort(value: ReactEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onAbort", js.Any.fromFunction1((t0: ReactEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onAnimationEnd(value: ReactAnimationEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onAnimationEnd", js.Any.fromFunction1((t0: ReactAnimationEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onAnimationIteration(value: ReactAnimationEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onAnimationIteration", js.Any.fromFunction1((t0: ReactAnimationEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onAnimationStart(value: ReactAnimationEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onAnimationStart", js.Any.fromFunction1((t0: ReactAnimationEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onAuxClick(value: ReactMouseEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onAuxClick", js.Any.fromFunction1((t0: ReactMouseEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onBeforeInput(value: ReactEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onBeforeInput", js.Any.fromFunction1((t0: ReactEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onBlur(value: ReactFocusEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onBlur", js.Any.fromFunction1((t0: ReactFocusEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onCanPlay(value: ReactEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onCanPlay", js.Any.fromFunction1((t0: ReactEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onCanPlayThrough(value: ReactEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onCanPlayThrough", js.Any.fromFunction1((t0: ReactEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onChange(value: ReactEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onChange", js.Any.fromFunction1((t0: ReactEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onClick(value: ReactMouseEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onClick", js.Any.fromFunction1((t0: ReactMouseEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onCompositionEnd(value: ReactCompositionEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onCompositionEnd", js.Any.fromFunction1((t0: ReactCompositionEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onCompositionStart(value: ReactCompositionEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onCompositionStart", js.Any.fromFunction1((t0: ReactCompositionEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onCompositionUpdate(value: ReactCompositionEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onCompositionUpdate", js.Any.fromFunction1((t0: ReactCompositionEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onContextMenu(value: ReactMouseEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onContextMenu", js.Any.fromFunction1((t0: ReactMouseEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onCopy(value: ReactClipboardEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onCopy", js.Any.fromFunction1((t0: ReactClipboardEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onCut(value: ReactClipboardEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onCut", js.Any.fromFunction1((t0: ReactClipboardEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onDoubleClick(value: ReactMouseEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onDoubleClick", js.Any.fromFunction1((t0: ReactMouseEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onDrag(value: ReactDragEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onDrag", js.Any.fromFunction1((t0: ReactDragEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onDragEnd(value: ReactDragEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onDragEnd", js.Any.fromFunction1((t0: ReactDragEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onDragEnter(value: ReactDragEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onDragEnter", js.Any.fromFunction1((t0: ReactDragEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onDragExit(value: ReactDragEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onDragExit", js.Any.fromFunction1((t0: ReactDragEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onDragLeave(value: ReactDragEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onDragLeave", js.Any.fromFunction1((t0: ReactDragEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onDragOver(value: ReactDragEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onDragOver", js.Any.fromFunction1((t0: ReactDragEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onDragStart(value: ReactDragEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onDragStart", js.Any.fromFunction1((t0: ReactDragEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onDrop(value: ReactDragEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onDrop", js.Any.fromFunction1((t0: ReactDragEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onDurationChange(value: ReactEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onDurationChange", js.Any.fromFunction1((t0: ReactEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onEmptied(value: ReactEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onEmptied", js.Any.fromFunction1((t0: ReactEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onEncrypted(value: ReactEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onEncrypted", js.Any.fromFunction1((t0: ReactEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onEnded(value: ReactEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onEnded", js.Any.fromFunction1((t0: ReactEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onError(value: ReactEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onError", js.Any.fromFunction1((t0: ReactEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onFocus(value: ReactFocusEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onFocus", js.Any.fromFunction1((t0: ReactFocusEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onInput(value: ReactEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onInput", js.Any.fromFunction1((t0: ReactEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onInvalid(value: ReactEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onInvalid", js.Any.fromFunction1((t0: ReactEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onKeyDown(value: ReactKeyboardEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onKeyDown", js.Any.fromFunction1((t0: ReactKeyboardEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onKeyPress(value: ReactKeyboardEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onKeyPress", js.Any.fromFunction1((t0: ReactKeyboardEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onKeyUp(value: ReactKeyboardEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onKeyUp", js.Any.fromFunction1((t0: ReactKeyboardEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onLoad(value: ReactEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onLoad", js.Any.fromFunction1((t0: ReactEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onLoadStart(value: ReactEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onLoadStart", js.Any.fromFunction1((t0: ReactEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onLoadedData(value: ReactEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onLoadedData", js.Any.fromFunction1((t0: ReactEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onLoadedMetadata(value: ReactEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onLoadedMetadata", js.Any.fromFunction1((t0: ReactEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onMouseDown(value: ReactMouseEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onMouseDown", js.Any.fromFunction1((t0: ReactMouseEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onMouseEnter(value: ReactMouseEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onMouseEnter", js.Any.fromFunction1((t0: ReactMouseEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onMouseLeave(value: ReactMouseEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onMouseLeave", js.Any.fromFunction1((t0: ReactMouseEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onMouseMove(value: ReactMouseEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onMouseMove", js.Any.fromFunction1((t0: ReactMouseEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onMouseOut(value: ReactMouseEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onMouseOut", js.Any.fromFunction1((t0: ReactMouseEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onMouseOver(value: ReactMouseEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onMouseOver", js.Any.fromFunction1((t0: ReactMouseEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onMouseUp(value: ReactMouseEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onMouseUp", js.Any.fromFunction1((t0: ReactMouseEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onPaste(value: ReactClipboardEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onPaste", js.Any.fromFunction1((t0: ReactClipboardEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onPause(value: ReactEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onPause", js.Any.fromFunction1((t0: ReactEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onPlay(value: ReactEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onPlay", js.Any.fromFunction1((t0: ReactEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onPlaying(value: ReactEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onPlaying", js.Any.fromFunction1((t0: ReactEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onPointerCancel(value: ReactPointerEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onPointerCancel", js.Any.fromFunction1((t0: ReactPointerEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onPointerDown(value: ReactPointerEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onPointerDown", js.Any.fromFunction1((t0: ReactPointerEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onPointerEnter(value: ReactPointerEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onPointerEnter", js.Any.fromFunction1((t0: ReactPointerEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onPointerLeave(value: ReactPointerEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onPointerLeave", js.Any.fromFunction1((t0: ReactPointerEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onPointerMove(value: ReactPointerEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onPointerMove", js.Any.fromFunction1((t0: ReactPointerEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onPointerOut(value: ReactPointerEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onPointerOut", js.Any.fromFunction1((t0: ReactPointerEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onPointerOver(value: ReactPointerEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onPointerOver", js.Any.fromFunction1((t0: ReactPointerEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onPointerUp(value: ReactPointerEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onPointerUp", js.Any.fromFunction1((t0: ReactPointerEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onProgress(value: ReactEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onProgress", js.Any.fromFunction1((t0: ReactEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onRateChange(value: ReactEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onRateChange", js.Any.fromFunction1((t0: ReactEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onReset(value: ReactEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onReset", js.Any.fromFunction1((t0: ReactEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onResize(value: ReactEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onResize", js.Any.fromFunction1((t0: ReactEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onScroll(value: ReactUIEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onScroll", js.Any.fromFunction1((t0: ReactUIEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onSeeked(value: ReactEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onSeeked", js.Any.fromFunction1((t0: ReactEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onSeeking(value: ReactEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onSeeking", js.Any.fromFunction1((t0: ReactEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onSelect(value: ReactEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onSelect", js.Any.fromFunction1((t0: ReactEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onStalled(value: ReactEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onStalled", js.Any.fromFunction1((t0: ReactEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onSubmit(value: ReactEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onSubmit", js.Any.fromFunction1((t0: ReactEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onSuspend(value: ReactEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onSuspend", js.Any.fromFunction1((t0: ReactEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onTimeUpdate(value: ReactEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onTimeUpdate", js.Any.fromFunction1((t0: ReactEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onTouchCancel(value: ReactTouchEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onTouchCancel", js.Any.fromFunction1((t0: ReactTouchEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onTouchEnd(value: ReactTouchEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onTouchEnd", js.Any.fromFunction1((t0: ReactTouchEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onTouchMove(value: ReactTouchEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onTouchMove", js.Any.fromFunction1((t0: ReactTouchEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onTouchStart(value: ReactTouchEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onTouchStart", js.Any.fromFunction1((t0: ReactTouchEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onTransitionEnd(value: ReactTransitionEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onTransitionEnd", js.Any.fromFunction1((t0: ReactTransitionEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onVolumeChange(value: ReactEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onVolumeChange", js.Any.fromFunction1((t0: ReactEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onWaiting(value: ReactEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onWaiting", js.Any.fromFunction1((t0: ReactEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
    
    inline def onWheel(value: ReactWheelEventFrom[SVGEllipseElement & Element] => Callback): this.type = set("onWheel", js.Any.fromFunction1((t0: ReactWheelEventFrom[SVGEllipseElement & Element]) => value(t0).runNow()))
  ...
  def styled: com.olvind.mui.StyledComponent.Builder[SVGProps[SVGEllipseElement], Builder] = new com.olvind.mui.StyledComponent.Builder[SVGProps[SVGEllipseElement], Builder](this.component, new js.Object, js.Array(), (newComponent: Any) => new Builder(js.Array(newComponent, js.Dictionary.empty)))
  
  def withProps(p: SVGProps[SVGEllipseElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
