...
object form {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[HTMLFormElement] {
    ...
    inline def onChange(value: ReactEventFrom[HTMLFormElement & Element] => Callback): this.type = set("onChange", js.Any.fromFunction1((t0: ReactEventFrom[HTMLFormElement & Element]) => value(t0).runNow()))
    ...
    inline def onReset(value: ReactEventFrom[HTMLFormElement & Element] => Callback): this.type = set("onReset", js.Any.fromFunction1((t0: ReactEventFrom[HTMLFormElement & Element]) => value(t0).runNow()))
    
    inline def onResize(value: ReactEventFrom[HTMLFormElement & Element] => Callback): this.type = set("onResize", js.Any.fromFunction1((t0: ReactEventFrom[HTMLFormElement & Element]) => value(t0).runNow()))
    ...
    inline def onSubmit(value: ReactEventFrom[HTMLFormElement & Element] => Callback): this.type = set("onSubmit", js.Any.fromFunction1((t0: ReactEventFrom[HTMLFormElement & Element]) => value(t0).runNow()))
