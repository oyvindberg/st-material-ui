...
object canvas {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def onBlur(value: ReactFocusEventFrom[HTMLCanvasElement & Element] => Callback): this.type = set("onBlur", js.Any.fromFunction1((t0: ReactFocusEventFrom[HTMLCanvasElement & Element]) => value(t0).runNow()))
    ...
    inline def onFocus(value: ReactFocusEventFrom[HTMLCanvasElement & Element] => Callback): this.type = set("onFocus", js.Any.fromFunction1((t0: ReactFocusEventFrom[HTMLCanvasElement & Element]) => value(t0).runNow()))
    ...
    inline def onResize(value: ReactEventFrom[HTMLCanvasElement & Element] => Callback): this.type = set("onResize", js.Any.fromFunction1((t0: ReactEventFrom[HTMLCanvasElement & Element]) => value(t0).runNow()))
