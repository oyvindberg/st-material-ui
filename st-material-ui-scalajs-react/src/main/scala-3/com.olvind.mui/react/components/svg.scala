...
object svg {
  ...
  def styled: com.olvind.mui.StyledComponent.Builder[SVGProps[SVGSVGElement], Builder] = new com.olvind.mui.StyledComponent.Builder[SVGProps[SVGSVGElement], Builder](this.component, new js.Object, js.Array(), (newComponent: Any) => new Builder(js.Array(newComponent, js.Dictionary.empty)))
