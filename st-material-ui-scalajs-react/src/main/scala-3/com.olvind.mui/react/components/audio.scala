...
object audio {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def onResize(value: ReactEventFrom[HTMLAudioElement & Element] => Callback): this.type = set("onResize", js.Any.fromFunction1((t0: ReactEventFrom[HTMLAudioElement & Element]) => value(t0).runNow()))
