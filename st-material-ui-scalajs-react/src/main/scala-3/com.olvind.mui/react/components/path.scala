...
object path {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def onBlur(value: ReactFocusEventFrom[SVGPathElement & Element] => Callback): this.type = set("onBlur", js.Any.fromFunction1((t0: ReactFocusEventFrom[SVGPathElement & Element]) => value(t0).runNow()))
    ...
    inline def onFocus(value: ReactFocusEventFrom[SVGPathElement & Element] => Callback): this.type = set("onFocus", js.Any.fromFunction1((t0: ReactFocusEventFrom[SVGPathElement & Element]) => value(t0).runNow()))
    ...
    inline def onMouseDown(value: ReactMouseEventFrom[SVGPathElement & Element] => Callback): this.type = set("onMouseDown", js.Any.fromFunction1((t0: ReactMouseEventFrom[SVGPathElement & Element]) => value(t0).runNow()))
    
    inline def onMouseEnter(value: ReactMouseEventFrom[SVGPathElement & Element] => Callback): this.type = set("onMouseEnter", js.Any.fromFunction1((t0: ReactMouseEventFrom[SVGPathElement & Element]) => value(t0).runNow()))
    
    inline def onMouseLeave(value: ReactMouseEventFrom[SVGPathElement & Element] => Callback): this.type = set("onMouseLeave", js.Any.fromFunction1((t0: ReactMouseEventFrom[SVGPathElement & Element]) => value(t0).runNow()))
    ...
    inline def onMouseUp(value: ReactMouseEventFrom[SVGPathElement & Element] => Callback): this.type = set("onMouseUp", js.Any.fromFunction1((t0: ReactMouseEventFrom[SVGPathElement & Element]) => value(t0).runNow()))
    ...
    inline def onResize(value: ReactEventFrom[SVGPathElement & Element] => Callback): this.type = set("onResize", js.Any.fromFunction1((t0: ReactEventFrom[SVGPathElement & Element]) => value(t0).runNow()))
