...
object pattern {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[SVGPatternElement] {
    ...
    inline def onAbort(value: ReactEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onAbort", js.Any.fromFunction1((t0: ReactEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onAnimationEnd(value: ReactAnimationEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onAnimationEnd", js.Any.fromFunction1((t0: ReactAnimationEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onAnimationIteration(value: ReactAnimationEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onAnimationIteration", js.Any.fromFunction1((t0: ReactAnimationEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onAnimationStart(value: ReactAnimationEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onAnimationStart", js.Any.fromFunction1((t0: ReactAnimationEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onAuxClick(value: ReactMouseEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onAuxClick", js.Any.fromFunction1((t0: ReactMouseEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onBeforeInput(value: ReactEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onBeforeInput", js.Any.fromFunction1((t0: ReactEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onBlur(value: ReactFocusEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onBlur", js.Any.fromFunction1((t0: ReactFocusEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onCanPlay(value: ReactEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onCanPlay", js.Any.fromFunction1((t0: ReactEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onCanPlayThrough(value: ReactEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onCanPlayThrough", js.Any.fromFunction1((t0: ReactEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onChange(value: ReactEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onChange", js.Any.fromFunction1((t0: ReactEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onClick(value: ReactMouseEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onClick", js.Any.fromFunction1((t0: ReactMouseEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onCompositionEnd(value: ReactCompositionEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onCompositionEnd", js.Any.fromFunction1((t0: ReactCompositionEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onCompositionStart(value: ReactCompositionEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onCompositionStart", js.Any.fromFunction1((t0: ReactCompositionEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onCompositionUpdate(value: ReactCompositionEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onCompositionUpdate", js.Any.fromFunction1((t0: ReactCompositionEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onContextMenu(value: ReactMouseEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onContextMenu", js.Any.fromFunction1((t0: ReactMouseEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onCopy(value: ReactClipboardEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onCopy", js.Any.fromFunction1((t0: ReactClipboardEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onCut(value: ReactClipboardEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onCut", js.Any.fromFunction1((t0: ReactClipboardEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onDoubleClick(value: ReactMouseEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onDoubleClick", js.Any.fromFunction1((t0: ReactMouseEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onDrag(value: ReactDragEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onDrag", js.Any.fromFunction1((t0: ReactDragEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onDragEnd(value: ReactDragEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onDragEnd", js.Any.fromFunction1((t0: ReactDragEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onDragEnter(value: ReactDragEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onDragEnter", js.Any.fromFunction1((t0: ReactDragEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onDragExit(value: ReactDragEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onDragExit", js.Any.fromFunction1((t0: ReactDragEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onDragLeave(value: ReactDragEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onDragLeave", js.Any.fromFunction1((t0: ReactDragEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onDragOver(value: ReactDragEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onDragOver", js.Any.fromFunction1((t0: ReactDragEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onDragStart(value: ReactDragEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onDragStart", js.Any.fromFunction1((t0: ReactDragEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onDrop(value: ReactDragEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onDrop", js.Any.fromFunction1((t0: ReactDragEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onDurationChange(value: ReactEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onDurationChange", js.Any.fromFunction1((t0: ReactEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onEmptied(value: ReactEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onEmptied", js.Any.fromFunction1((t0: ReactEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onEncrypted(value: ReactEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onEncrypted", js.Any.fromFunction1((t0: ReactEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onEnded(value: ReactEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onEnded", js.Any.fromFunction1((t0: ReactEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onError(value: ReactEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onError", js.Any.fromFunction1((t0: ReactEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onFocus(value: ReactFocusEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onFocus", js.Any.fromFunction1((t0: ReactFocusEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onInput(value: ReactEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onInput", js.Any.fromFunction1((t0: ReactEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onInvalid(value: ReactEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onInvalid", js.Any.fromFunction1((t0: ReactEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onKeyDown(value: ReactKeyboardEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onKeyDown", js.Any.fromFunction1((t0: ReactKeyboardEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onKeyPress(value: ReactKeyboardEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onKeyPress", js.Any.fromFunction1((t0: ReactKeyboardEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onKeyUp(value: ReactKeyboardEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onKeyUp", js.Any.fromFunction1((t0: ReactKeyboardEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onLoad(value: ReactEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onLoad", js.Any.fromFunction1((t0: ReactEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onLoadStart(value: ReactEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onLoadStart", js.Any.fromFunction1((t0: ReactEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onLoadedData(value: ReactEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onLoadedData", js.Any.fromFunction1((t0: ReactEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onLoadedMetadata(value: ReactEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onLoadedMetadata", js.Any.fromFunction1((t0: ReactEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onMouseDown(value: ReactMouseEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onMouseDown", js.Any.fromFunction1((t0: ReactMouseEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onMouseEnter(value: ReactMouseEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onMouseEnter", js.Any.fromFunction1((t0: ReactMouseEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onMouseLeave(value: ReactMouseEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onMouseLeave", js.Any.fromFunction1((t0: ReactMouseEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onMouseMove(value: ReactMouseEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onMouseMove", js.Any.fromFunction1((t0: ReactMouseEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onMouseOut(value: ReactMouseEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onMouseOut", js.Any.fromFunction1((t0: ReactMouseEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onMouseOver(value: ReactMouseEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onMouseOver", js.Any.fromFunction1((t0: ReactMouseEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onMouseUp(value: ReactMouseEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onMouseUp", js.Any.fromFunction1((t0: ReactMouseEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onPaste(value: ReactClipboardEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onPaste", js.Any.fromFunction1((t0: ReactClipboardEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onPause(value: ReactEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onPause", js.Any.fromFunction1((t0: ReactEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onPlay(value: ReactEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onPlay", js.Any.fromFunction1((t0: ReactEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onPlaying(value: ReactEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onPlaying", js.Any.fromFunction1((t0: ReactEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onPointerCancel(value: ReactPointerEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onPointerCancel", js.Any.fromFunction1((t0: ReactPointerEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onPointerDown(value: ReactPointerEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onPointerDown", js.Any.fromFunction1((t0: ReactPointerEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onPointerEnter(value: ReactPointerEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onPointerEnter", js.Any.fromFunction1((t0: ReactPointerEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onPointerLeave(value: ReactPointerEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onPointerLeave", js.Any.fromFunction1((t0: ReactPointerEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onPointerMove(value: ReactPointerEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onPointerMove", js.Any.fromFunction1((t0: ReactPointerEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onPointerOut(value: ReactPointerEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onPointerOut", js.Any.fromFunction1((t0: ReactPointerEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onPointerOver(value: ReactPointerEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onPointerOver", js.Any.fromFunction1((t0: ReactPointerEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onPointerUp(value: ReactPointerEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onPointerUp", js.Any.fromFunction1((t0: ReactPointerEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onProgress(value: ReactEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onProgress", js.Any.fromFunction1((t0: ReactEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onRateChange(value: ReactEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onRateChange", js.Any.fromFunction1((t0: ReactEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onReset(value: ReactEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onReset", js.Any.fromFunction1((t0: ReactEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onResize(value: ReactEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onResize", js.Any.fromFunction1((t0: ReactEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onScroll(value: ReactUIEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onScroll", js.Any.fromFunction1((t0: ReactUIEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onSeeked(value: ReactEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onSeeked", js.Any.fromFunction1((t0: ReactEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onSeeking(value: ReactEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onSeeking", js.Any.fromFunction1((t0: ReactEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onSelect(value: ReactEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onSelect", js.Any.fromFunction1((t0: ReactEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onStalled(value: ReactEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onStalled", js.Any.fromFunction1((t0: ReactEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onSubmit(value: ReactEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onSubmit", js.Any.fromFunction1((t0: ReactEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onSuspend(value: ReactEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onSuspend", js.Any.fromFunction1((t0: ReactEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onTimeUpdate(value: ReactEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onTimeUpdate", js.Any.fromFunction1((t0: ReactEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onTouchCancel(value: ReactTouchEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onTouchCancel", js.Any.fromFunction1((t0: ReactTouchEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onTouchEnd(value: ReactTouchEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onTouchEnd", js.Any.fromFunction1((t0: ReactTouchEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onTouchMove(value: ReactTouchEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onTouchMove", js.Any.fromFunction1((t0: ReactTouchEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onTouchStart(value: ReactTouchEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onTouchStart", js.Any.fromFunction1((t0: ReactTouchEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onTransitionEnd(value: ReactTransitionEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onTransitionEnd", js.Any.fromFunction1((t0: ReactTransitionEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onVolumeChange(value: ReactEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onVolumeChange", js.Any.fromFunction1((t0: ReactEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onWaiting(value: ReactEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onWaiting", js.Any.fromFunction1((t0: ReactEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
    
    inline def onWheel(value: ReactWheelEventFrom[SVGPatternElement & Element] => Callback): this.type = set("onWheel", js.Any.fromFunction1((t0: ReactWheelEventFrom[SVGPatternElement & Element]) => value(t0).runNow()))
  ...
  def styled: com.olvind.mui.StyledComponent.Builder[SVGProps[SVGPatternElement], Builder] = new com.olvind.mui.StyledComponent.Builder[SVGProps[SVGPatternElement], Builder](this.component, new js.Object, js.Array(), (newComponent: Any) => new Builder(js.Array(newComponent, js.Dictionary.empty)))
  
  def withProps(p: SVGProps[SVGPatternElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
