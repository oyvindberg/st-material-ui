...
open class SharedBuilder_DetailedHTMLProps556941009[R <: js.Object] (val args: js.Array[Any])
  ...
  inline def onResize(value: ReactEventFrom[HTMLHeadingElement & Element] => Callback): this.type = set("onResize", js.Any.fromFunction1((t0: ReactEventFrom[HTMLHeadingElement & Element]) => value(t0).runNow()))
