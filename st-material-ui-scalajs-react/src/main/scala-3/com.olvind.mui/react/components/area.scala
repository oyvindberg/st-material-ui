...
object area {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def onResize(value: ReactEventFrom[HTMLAreaElement & Element] => Callback): this.type = set("onResize", js.Any.fromFunction1((t0: ReactEventFrom[HTMLAreaElement & Element]) => value(t0).runNow()))
