...
object details {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def onToggle(value: ReactEventFrom[HTMLElement & Element] => Callback): this.type = set("onToggle", js.Any.fromFunction1((t0: ReactEventFrom[HTMLElement & Element]) => value(t0).runNow()))
