...
object iconButtonIconButtonMod extends Shortcut {
  ...
  @js.native
  val IconButtonRoot: js.Function1[/* props */ PickMUIStyledCommonPropsThemeClassAttrib, ReactElement | Null] = js.native
  
  @JSImport("@mui/joy/IconButton/IconButton", "StyledIconButton")
  @js.native
  val StyledIconButton: js.Function1[/* props */ MUIStyledCommonPropsThemeDetailedHTMLProAbout, ReactElement | Null] = js.native
