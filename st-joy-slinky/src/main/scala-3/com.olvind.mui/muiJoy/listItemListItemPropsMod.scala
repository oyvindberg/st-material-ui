...
import com.olvind.mui.muiJoy.anon.EndActionRoot
...
object listItemListItemPropsMod {
  ...
  /* Inlined parent @mui/joy.@mui/joy/ListItem/ListItemProps.ListItemProps<@mui/joy.@mui/joy/ListItem/ListItemProps.ListItemTypeMap<{}, 'li'>['defaultComponent'], {  component :react.react.ElementType<any> | undefined}> */
  trait ListItemOwnerState extends StObject {
  ...
  type ListItemSlotsAndSlotProps = CreateSlotsAndSlotProps[ListItemSlot, EndActionRoot]
