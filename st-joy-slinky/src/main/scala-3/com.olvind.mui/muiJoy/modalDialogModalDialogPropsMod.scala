...
object modalDialogModalDialogPropsMod {
  ...
  /* Inlined parent @mui/joy.@mui/joy/ModalDialog/ModalDialogProps.ModalDialogProps<@mui/joy.@mui/joy/ModalDialog/ModalDialogProps.ModalDialogTypeMap<{}, 'div'>['defaultComponent'], {  component :react.react.ElementType<any> | undefined}> */
  trait ModalDialogOwnerState extends StObject {
  ...
  object ModalDialogOwnerState {
    
    inline def apply(): ModalDialogOwnerState = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[ModalDialogOwnerState]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: ModalDialogOwnerState] (val x: Self) extends AnyVal {
  ...
  type ModalDialogProps[D /* <: ReactElement */, P] = OverrideProps[ModalDialogTypeMap[P, D], D]
  ...
  trait ModalDialogTypeMap[P, D /* <: ReactElement */] extends StObject {
  ...
  object ModalDialogTypeMap {
    ...
    inline def apply[P, D /* <: ReactElement */](defaultComponent: D, props: P & Layout): ModalDialogTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[ModalDialogTypeMap[P, D]]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: ModalDialogTypeMap[?, ?], P, D /* <: ReactElement */] (val x: Self & (ModalDialogTypeMap[P, D])) extends AnyVal {
