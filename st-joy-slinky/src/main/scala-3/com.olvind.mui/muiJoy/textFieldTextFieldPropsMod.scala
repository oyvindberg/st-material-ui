...
import com.olvind.mui.muiJoy.anon.HelperText
import com.olvind.mui.muiJoy.anon.HelperTextInput
import com.olvind.mui.muiJoy.anon.Id
import com.olvind.mui.muiJoy.anon.InputPropsInputTypeMapdivdefaultComponenAbout
...
object textFieldTextFieldPropsMod {
  
  object InputRootKeys {
  ...
  /* Inlined parent @mui/joy.@mui/joy/TextField/TextFieldProps.TextFieldProps<@mui/joy.@mui/joy/TextField/TextFieldProps.TextFieldTypeMap<{}, 'div'>['defaultComponent'], {  component :react.react.ElementType<any> | undefined}> */
  trait TextFieldOwnerState extends StObject {
    ...
    var slotProps: js.UndefOr[HelperTextInput] = js.undefined
  ...
  object TextFieldOwnerState {
    
    inline def apply(): TextFieldOwnerState = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[TextFieldOwnerState]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: TextFieldOwnerState] (val x: Self) extends AnyVal {
      ...
      inline def setSlotProps(value: HelperTextInput): Self = StObject.set(x, "slotProps", value.asInstanceOf[js.Any])
  ...
  type TextFieldProps[D /* <: ReactElement */, P] = OverrideProps[TextFieldTypeMap[P, D], D]
  
  type TextFieldSlot = "root"
  
  trait TextFieldTypeMap[P, D /* <: ReactElement */] extends StObject {
    
    var defaultComponent: D
    
    var props: P & (Pick[InputPropsInputTypeMapdivdefaultComponenAbout[P], InputRootKeys]) & Id[P]
  }
  object TextFieldTypeMap {
    
    inline def apply[P, D /* <: ReactElement */](
      defaultComponent: D,
      props: P & (Pick[InputPropsInputTypeMapdivdefaultComponenAbout[P], InputRootKeys]) & Id[P]
    ): TextFieldTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[TextFieldTypeMap[P, D]]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: TextFieldTypeMap[?, ?], P, D /* <: ReactElement */] (val x: Self & (TextFieldTypeMap[P, D])) extends AnyVal {
      
      inline def setDefaultComponent(value: D): Self = StObject.set(x, "defaultComponent", value.asInstanceOf[js.Any])
      
      inline def setProps(value: P & (Pick[InputPropsInputTypeMapdivdefaultComponenAbout[P], InputRootKeys]) & Id[P]): Self = StObject.set(x, "props", value.asInstanceOf[js.Any])
    }
  }
}
