...
object cardOverflowCardOverflowClassesMod {
  
  @JSImport("@mui/joy/CardOverflow/cardOverflowClasses", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@mui/joy/CardOverflow/cardOverflowClasses", JSImport.Default)
  @js.native
  val default: CardOverflowClasses = js.native
