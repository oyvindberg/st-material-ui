...
import com.olvind.mui.muiJoy.anon.Wrap
...
object listListPropsMod {
  ...
  /* Inlined parent @mui/joy.@mui/joy/List/ListProps.ListProps<@mui/joy.@mui/joy/List/ListProps.ListTypeMap<{}, 'ul'>['defaultComponent'], {  component :react.react.ElementType<any> | undefined}> */
  trait ListOwnerState extends StObject {
  ...
  object ListTypeMap {
    ...
    inline def apply[P, D /* <: ReactElement */](defaultComponent: D, props: P & Wrap): ListTypeMap[P, D] = {
    ...
    implicit open class MutableBuilder[Self <: ListTypeMap[?, ?], P, D /* <: ReactElement */] (val x: Self & (ListTypeMap[P, D])) extends AnyVal {
      ...
      inline def setProps(value: P & Wrap): Self = StObject.set(x, "props", value.asInstanceOf[js.Any])
    }
  }
}
