...
import com.olvind.mui.muiJoy.anon.AvatarPropsAvatarTypeMapdivdefaultComponAbout
import com.olvind.mui.muiJoy.anon.ChildrenColor
...
object avatarGroupAvatarGroupPropsMod {
  
  /* Inlined parent @mui/joy.@mui/joy/AvatarGroup/AvatarGroupProps.AvatarGroupProps<@mui/joy.@mui/joy/AvatarGroup/AvatarGroupProps.AvatarGroupTypeMap<{}, 'div'>['defaultComponent'], {  component :react.react.ElementType<any> | undefined}> */
  trait AvatarGroupOwnerState extends StObject {
    ...
    /**
      ...
      * @default 'md'
      */
    var size: js.UndefOr[OverridableStringUnion["sm" | "md" | "lg", AvatarPropsSizeOverrides]] = js.undefined
  ...
  object AvatarGroupOwnerState {
    
    inline def apply(): AvatarGroupOwnerState = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[AvatarGroupOwnerState]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: AvatarGroupOwnerState] (val x: Self) extends AnyVal {
      ...
      inline def setVariant(value: OverridableStringUnion[VariantProp, AvatarPropsVariantOverrides]): Self = StObject.set(x, "variant", value.asInstanceOf[js.Any])
  ...
  type AvatarGroupProps[D /* <: ReactElement */, P] = OverrideProps[AvatarGroupTypeMap[P, D], D]
  
  type AvatarGroupSlot = "root"
  
  trait AvatarGroupTypeMap[P, D /* <: ReactElement */] extends StObject {
    
    var defaultComponent: D
    
    var props: P & (Pick[AvatarPropsAvatarTypeMapdivdefaultComponAbout[P], "color" | "size" | "variant"]) & ChildrenColor
  }
  object AvatarGroupTypeMap {
    
    inline def apply[P, D /* <: ReactElement */](
      defaultComponent: D,
      props: P & (Pick[AvatarPropsAvatarTypeMapdivdefaultComponAbout[P], "color" | "size" | "variant"]) & ChildrenColor
    ): AvatarGroupTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[AvatarGroupTypeMap[P, D]]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: AvatarGroupTypeMap[?, ?], P, D /* <: ReactElement */] (val x: Self & (AvatarGroupTypeMap[P, D])) extends AnyVal {
      
      inline def setDefaultComponent(value: D): Self = StObject.set(x, "defaultComponent", value.asInstanceOf[js.Any])
      
      inline def setProps(
        value: P & (Pick[AvatarPropsAvatarTypeMapdivdefaultComponAbout[P], "color" | "size" | "variant"]) & ChildrenColor
