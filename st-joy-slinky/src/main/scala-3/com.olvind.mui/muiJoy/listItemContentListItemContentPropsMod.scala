...
object listItemContentListItemContentPropsMod {
  
  /* Inlined parent @mui/joy.@mui/joy/ListItemContent/ListItemContentProps.ListItemContentProps<@mui/joy.@mui/joy/ListItemContent/ListItemContentProps.ListItemContentTypeMap<{}, 'div'>['defaultComponent'], {  component :react.react.ElementType<any> | undefined}> */
  trait ListItemContentOwnerState extends StObject {
  ...
  object ListItemContentOwnerState {
    
    inline def apply(): ListItemContentOwnerState = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[ListItemContentOwnerState]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: ListItemContentOwnerState] (val x: Self) extends AnyVal {
  ...
  type ListItemContentProps[D /* <: ReactElement */, P] = OverrideProps[ListItemContentTypeMap[P, D], D]
  
  type ListItemContentSlot = "root"
  
  trait ListItemContentTypeMap[P, D /* <: ReactElement */] extends StObject {
  ...
  object ListItemContentTypeMap {
    ...
    inline def apply[P, D /* <: ReactElement */](defaultComponent: D, props: P & ChildrenSx): ListItemContentTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[ListItemContentTypeMap[P, D]]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: ListItemContentTypeMap[?, ?], P, D /* <: ReactElement */] (val x: Self & (ListItemContentTypeMap[P, D])) extends AnyVal {
