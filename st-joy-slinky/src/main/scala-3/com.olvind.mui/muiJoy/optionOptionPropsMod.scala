...
object optionOptionPropsMod {
  ...
  /* Inlined parent std.Omit<@mui/joy.@mui/joy/Option/OptionProps.OptionProps<@mui/joy.@mui/joy/Option/OptionProps.OptionTypeMap<{}, 'li'>['defaultComponent'], {  component :react.react.ElementType<any> | undefined}>, 'disabled'> */
  /* Inlined parent @mui/base.@mui/base/ListboxUnstyled.OptionState */
  trait OptionOwnerState extends StObject {
  ...
  object OptionOwnerState {
    ...
    inline def apply(disabled: Boolean, highlighted: Boolean, selected: Boolean): OptionOwnerState = {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: OptionOwnerState] (val x: Self) extends AnyVal {
