...
object cardContentCardContentMod extends Shortcut {
  ...
  type _To = js.Function1[/* props */ DefaultComponentPropsCardContentTypeMapd, Element | Null]
  
  /* This means you don't have to write `default`, but can instead just say `cardContentCardContentMod.foo` */
  override def _to: js.Function1[/* props */ DefaultComponentPropsCardContentTypeMapd, Element | Null] = default
}
