...
object mod {
  ...
  inline def GlobalStyles(props: GlobalStylesProps[Theme]): ReactElement = ^.asInstanceOf[js.Dynamic].applyDynamic("GlobalStyles")(props.asInstanceOf[js.Any]).asInstanceOf[ReactElement]
