...
object chipDeleteChipDeletePropsMod {
  ...
  /* Inlined parent @mui/joy.@mui/joy/ChipDelete/ChipDeleteProps.ChipDeleteProps<@mui/joy.@mui/joy/ChipDelete/ChipDeleteProps.ChipDeleteTypeMap<{}, 'button'>['defaultComponent'], {  component :react.react.ElementType<any> | undefined}> */
  trait ChipDeleteOwnerState extends StObject {
