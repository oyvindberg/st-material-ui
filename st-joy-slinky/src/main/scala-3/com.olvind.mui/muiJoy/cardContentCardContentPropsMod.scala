...
object cardContentCardContentPropsMod {
  
  /* Inlined parent @mui/joy.@mui/joy/CardContent/CardContentProps.CardContentProps<@mui/joy.@mui/joy/CardContent/CardContentProps.CardContentTypeMap<{}, 'div'>['defaultComponent'], {  component :react.react.ElementType<any> | undefined}> */
  trait CardContentOwnerState extends StObject {
  ...
  object CardContentOwnerState {
    
    inline def apply(): CardContentOwnerState = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[CardContentOwnerState]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: CardContentOwnerState] (val x: Self) extends AnyVal {
  ...
  object CardContentTypeMap {
    ...
    inline def apply[P, D /* <: ReactElement */](defaultComponent: D, props: P & ChildrenSx): CardContentTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[CardContentTypeMap[P, D]]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: CardContentTypeMap[?, ?], P, D /* <: ReactElement */] (val x: Self & (CardContentTypeMap[P, D])) extends AnyVal {
