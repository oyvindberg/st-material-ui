...
trait VariantSolidActive extends StObject {
...
object VariantSolidActive {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[VariantSolidActive]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: VariantSolidActive] (val x: Self) extends AnyVal {
