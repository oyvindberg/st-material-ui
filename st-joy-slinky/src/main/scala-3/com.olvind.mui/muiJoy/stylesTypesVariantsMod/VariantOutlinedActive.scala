...
trait VariantOutlinedActive extends StObject {
...
object VariantOutlinedActive {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[VariantOutlinedActive]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: VariantOutlinedActive] (val x: Self) extends AnyVal {
