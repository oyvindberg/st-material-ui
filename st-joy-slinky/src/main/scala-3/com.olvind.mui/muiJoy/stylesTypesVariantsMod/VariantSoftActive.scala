...
trait VariantSoftActive extends StObject {
...
object VariantSoftActive {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[VariantSoftActive]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: VariantSoftActive] (val x: Self) extends AnyVal {
