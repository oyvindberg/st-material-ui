...
trait VariantOutlined extends StObject {
...
object VariantOutlined {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[VariantOutlined]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: VariantOutlined] (val x: Self) extends AnyVal {
