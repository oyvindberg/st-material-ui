...
trait ColorInversion extends StObject {
...
object ColorInversion {
  ...
  inline def apply(soft: VariantSoftInversion, solid: VariantSolidInversion): ColorInversion = {
    val __obj = js.Dynamic.literal(soft = soft.asInstanceOf[js.Any], solid = solid.asInstanceOf[js.Any])
    __obj.asInstanceOf[ColorInversion]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ColorInversion] (val x: Self) extends AnyVal {
