...
trait VariantPlainInversion extends StObject {
...
object VariantPlainInversion {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[VariantPlainInversion]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: VariantPlainInversion] (val x: Self) extends AnyVal {
