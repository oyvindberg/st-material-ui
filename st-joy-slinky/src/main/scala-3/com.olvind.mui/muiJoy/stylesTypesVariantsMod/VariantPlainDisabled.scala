...
trait VariantPlainDisabled extends StObject {
...
object VariantPlainDisabled {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[VariantPlainDisabled]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: VariantPlainDisabled] (val x: Self) extends AnyVal {
