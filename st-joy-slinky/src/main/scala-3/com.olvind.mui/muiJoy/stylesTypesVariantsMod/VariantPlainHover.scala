...
trait VariantPlainHover extends StObject {
...
object VariantPlainHover {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[VariantPlainHover]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: VariantPlainHover] (val x: Self) extends AnyVal {
