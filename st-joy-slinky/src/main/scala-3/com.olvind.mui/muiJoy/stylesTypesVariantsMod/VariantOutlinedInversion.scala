...
/* Inlined parent std.Record<@mui/joy.@mui/joy/styles/types/colorSystem.ColorPaletteProp, @mui/system.@mui/system.CSSObject> */
trait VariantOutlinedInversion extends StObject {
...
object VariantOutlinedInversion {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[VariantOutlinedInversion]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: VariantOutlinedInversion] (val x: Self) extends AnyVal {
