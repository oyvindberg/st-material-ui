...
trait VariantSoftDisabled extends StObject {
...
object VariantSoftDisabled {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[VariantSoftDisabled]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: VariantSoftDisabled] (val x: Self) extends AnyVal {
