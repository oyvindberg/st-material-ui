...
trait VariantSoftInversion extends StObject {
...
object VariantSoftInversion {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[VariantSoftInversion]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: VariantSoftInversion] (val x: Self) extends AnyVal {
