...
trait VariantSolidHover extends StObject {
...
object VariantSolidHover {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[VariantSolidHover]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: VariantSolidHover] (val x: Self) extends AnyVal {
