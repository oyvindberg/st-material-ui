...
trait VariantSolidInversion extends StObject {
...
object VariantSolidInversion {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[VariantSolidInversion]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: VariantSolidInversion] (val x: Self) extends AnyVal {
