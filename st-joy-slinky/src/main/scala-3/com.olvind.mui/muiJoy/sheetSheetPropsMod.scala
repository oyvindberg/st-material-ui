...
object sheetSheetPropsMod {
  ...
  /* Inlined parent @mui/joy.@mui/joy/Sheet/SheetProps.SheetProps<@mui/joy.@mui/joy/Sheet/SheetProps.SheetTypeMap<{}, 'div'>['defaultComponent'], {  component :react.react.ElementType<any> | undefined}> */
  trait SheetOwnerState extends StObject {
  ...
  object SheetOwnerState {
    
    inline def apply(): SheetOwnerState = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[SheetOwnerState]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: SheetOwnerState] (val x: Self) extends AnyVal {
  ...
  type SheetProps[D /* <: ReactElement */, P] = OverrideProps[SheetTypeMap[P, D], D]
  ...
  trait SheetTypeMap[P, D /* <: ReactElement */] extends StObject {
  ...
  object SheetTypeMap {
    ...
    inline def apply[P, D /* <: ReactElement */](defaultComponent: D, props: P & InvertedColors): SheetTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[SheetTypeMap[P, D]]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: SheetTypeMap[?, ?], P, D /* <: ReactElement */] (val x: Self & (SheetTypeMap[P, D])) extends AnyVal {
