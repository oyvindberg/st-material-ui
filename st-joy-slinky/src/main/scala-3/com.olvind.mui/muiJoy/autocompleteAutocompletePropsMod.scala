...
object autocompleteAutocompletePropsMod {
  ...
  object AutocompleteOwnProps {
    ...
    implicit open class MutableBuilder[Self <: AutocompleteOwnProps[?, ?, ?, ?], T, Multiple /* <: js.UndefOr[Boolean] */, DisableClearable /* <: js.UndefOr[Boolean] */, FreeSolo /* <: js.UndefOr[Boolean] */] (val x: Self & (AutocompleteOwnProps[T, Multiple, DisableClearable, FreeSolo])) extends AnyVal {
      ...
      inline def setRenderOption(
        value: (/* props */ OmitHTMLAttributesHTMLLIElementcolor, /* option */ T, /* state */ AutocompleteRenderOptionState) => ReactElement
  ...
  trait AutocompleteSlots extends StObject {
    ...
    /**
      ...
      * @default 'button'
      */
    var clearIndicator: ReactElement
    ...
    /**
      ...
      * @default 'li'
      */
    var loading: ReactElement
    
    /**
      * The component that renders the no-options.
      * @default 'li'
      */
    var noOptions: ReactElement
    ...
    /**
      ...
      * @default 'button'
      */
    var popupIndicator: ReactElement
  ...
  object AutocompleteSlots {
    ...
    inline def apply(
      clearIndicator: ReactElement,
      endDecorator: ReactElement,
      input: ReactElement,
      limitTag: ReactElement,
      listbox: ReactElement,
      loading: ReactElement,
      noOptions: ReactElement,
      option: ReactElement,
      popupIndicator: ReactElement,
      root: ReactElement,
