...
/* Inlined std.Omit<InputProps<InputTypeMap<{}, 'div'>['defaultComponent'], {}>, @mui/joy.@mui/joy/TextField/TextFieldProps.InputRootKeys> */
trait OmitInputPropsInputTypeMapdivdefaultComp extends StObject {
...
object OmitInputPropsInputTypeMapdivdefaultComp {
  
  inline def apply(): OmitInputPropsInputTypeMapdivdefaultComp = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[OmitInputPropsInputTypeMapdivdefaultComp]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: OmitInputPropsInputTypeMapdivdefaultComp] (val x: Self) extends AnyVal {
