...
/* Inlined @mui/types.@mui/types.DefaultComponentProps<@mui/joy.@mui/joy/Box/BoxProps.BoxTypeMap<{}, 'div'>> */
trait DefaultComponentPropsBoxTypeMapdiv extends StObject {
...
object DefaultComponentPropsBoxTypeMapdiv {
  
  inline def apply(): DefaultComponentPropsBoxTypeMapdiv = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsBoxTypeMapdiv]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DefaultComponentPropsBoxTypeMapdiv] (val x: Self) extends AnyVal {
