...
/* Inlined @mui/joy.@mui/joy/Tabs/TabsProps.TabsProps<@mui/joy.@mui/joy/Tabs/TabsProps.TabsTypeMap<{}, 'div'>['defaultComponent'], {  component :react.react.ElementType<any> | undefined}> */
trait TabsPropsTabsTypeMapdivdefaultComponent extends StObject {
...
object TabsPropsTabsTypeMapdivdefaultComponent {
  
  inline def apply(): TabsPropsTabsTypeMapdivdefaultComponent = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TabsPropsTabsTypeMapdivdefaultComponent]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TabsPropsTabsTypeMapdivdefaultComponent] (val x: Self) extends AnyVal {
