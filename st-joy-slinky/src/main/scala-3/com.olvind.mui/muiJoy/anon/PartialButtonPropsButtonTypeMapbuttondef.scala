...
/* Inlined std.Partial<ButtonProps<ButtonTypeMap<{}, 'button'>['defaultComponent'], {}>> */
trait PartialButtonPropsButtonTypeMapbuttondef extends StObject {
...
object PartialButtonPropsButtonTypeMapbuttondef {
  
  inline def apply(): PartialButtonPropsButtonTypeMapbuttondef = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialButtonPropsButtonTypeMapbuttondef]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialButtonPropsButtonTypeMapbuttondef] (val x: Self) extends AnyVal {
