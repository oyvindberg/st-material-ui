...
/* Inlined @mui/types.@mui/types.DefaultComponentProps<@mui/joy.@mui/joy/ModalDialog/ModalDialogProps.ModalDialogTypeMap<{}, 'div'>> */
trait DefaultComponentPropsModalDialogTypeMapd extends StObject {
...
object DefaultComponentPropsModalDialogTypeMapd {
  
  inline def apply(): DefaultComponentPropsModalDialogTypeMapd = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsModalDialogTypeMapd]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DefaultComponentPropsModalDialogTypeMapd] (val x: Self) extends AnyVal {
