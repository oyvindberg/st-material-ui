...
/* Inlined @mui/joy.@mui/joy/TabList/TabListProps.TabListProps<@mui/joy.@mui/joy/TabList/TabListProps.TabListTypeMap<{}, 'div'>['defaultComponent'], {  component :react.react.ElementType<any> | undefined}> */
trait TabListPropsTabListTypeMapdivdefaultComp extends StObject {
...
object TabListPropsTabListTypeMapdivdefaultComp {
  
  inline def apply(): TabListPropsTabListTypeMapdivdefaultComp = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TabListPropsTabListTypeMapdivdefaultComp]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TabListPropsTabListTypeMapdivdefaultComp] (val x: Self) extends AnyVal {
