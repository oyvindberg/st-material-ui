...
/* Inlined @mui/joy.@mui/joy/Sheet/SheetProps.SheetProps<@mui/joy.@mui/joy/Sheet/SheetProps.SheetTypeMap<{}, 'div'>['defaultComponent'], {  component :react.react.ElementType<any> | undefined}> */
trait SheetPropsSheetTypeMapdivdefaultComponen extends StObject {
...
object SheetPropsSheetTypeMapdivdefaultComponen {
  
  inline def apply(): SheetPropsSheetTypeMapdivdefaultComponen = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SheetPropsSheetTypeMapdivdefaultComponen]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SheetPropsSheetTypeMapdivdefaultComponen] (val x: Self) extends AnyVal {
