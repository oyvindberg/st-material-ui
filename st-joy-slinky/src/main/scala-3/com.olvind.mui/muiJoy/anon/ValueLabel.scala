...
trait ValueLabel extends StObject {
  ...
  var mark: js.UndefOr[
    com.olvind.mui.muiJoy.utilsTypesMod.SlotProps["span", js.Object, SliderOwnerStateAriaactivedescendant]
  ] = js.undefined
...
object ValueLabel {
  ...
  inline def apply(): ValueLabel = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ValueLabel]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ValueLabel] (val x: Self) extends AnyVal {
    ...
    inline def setMark(
      value: com.olvind.mui.muiJoy.utilsTypesMod.SlotProps["span", js.Object, SliderOwnerStateAriaactivedescendant]
    ): Self = StObject.set(x, "mark", value.asInstanceOf[js.Any])
    
    inline def setMarkFunction1(
      value: SliderOwnerStateAriaactivedescendant => (Omit[ComponentPropsWithRef["span"], "color"]) & js.Object & SlotCommonProps & (Record[String, Any])
