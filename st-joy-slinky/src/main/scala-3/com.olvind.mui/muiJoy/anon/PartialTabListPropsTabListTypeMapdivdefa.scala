...
/* Inlined std.Partial<TabListProps<TabListTypeMap<{}, 'div'>['defaultComponent'], {}>> */
trait PartialTabListPropsTabListTypeMapdivdefa extends StObject {
...
object PartialTabListPropsTabListTypeMapdivdefa {
  
  inline def apply(): PartialTabListPropsTabListTypeMapdivdefa = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialTabListPropsTabListTypeMapdivdefa]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialTabListPropsTabListTypeMapdivdefa] (val x: Self) extends AnyVal {
