...
/* Inlined @mui/joy.@mui/joy/Slider/SliderProps.SliderProps<@mui/joy.@mui/joy/Slider/SliderProps.SliderTypeMap<'span', {}>['defaultComponent'], {  component :react.react.ElementType<any> | undefined}> */
trait SliderPropsSliderTypeMapspandefaultCompo extends StObject {
  ...
  var slots: js.UndefOr[PartialSliderSlots] = js.undefined
...
object SliderPropsSliderTypeMapspandefaultCompo {
  ...
  inline def apply(): SliderPropsSliderTypeMapspandefaultCompo = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SliderPropsSliderTypeMapspandefaultCompo]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SliderPropsSliderTypeMapspandefaultCompo] (val x: Self) extends AnyVal {
    ...
    inline def setSlots(value: PartialSliderSlots): Self = StObject.set(x, "slots", value.asInstanceOf[js.Any])
