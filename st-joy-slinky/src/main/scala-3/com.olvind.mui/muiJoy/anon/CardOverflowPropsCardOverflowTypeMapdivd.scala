...
/* Inlined @mui/joy.@mui/joy/CardOverflow/CardOverflowProps.CardOverflowProps<@mui/joy.@mui/joy/CardOverflow/CardOverflowProps.CardOverflowTypeMap<{}, 'div'>['defaultComponent'], {  component :react.react.ElementType<any> | undefined}> */
trait CardOverflowPropsCardOverflowTypeMapdivd extends StObject {
...
object CardOverflowPropsCardOverflowTypeMapdivd {
  
  inline def apply(): CardOverflowPropsCardOverflowTypeMapdivd = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CardOverflowPropsCardOverflowTypeMapdivd]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CardOverflowPropsCardOverflowTypeMapdivd] (val x: Self) extends AnyVal {
