...
/* Inlined @mui/joy.@mui/joy/ListSubheader/ListSubheaderProps.ListSubheaderProps<@mui/joy.@mui/joy/ListSubheader/ListSubheaderProps.ListSubheaderTypeMap<{}, 'div'>['defaultComponent'], {  component :react.react.ElementType<any> | undefined}> */
trait ListSubheaderPropsListSubheaderTypeMapdi extends StObject {
...
object ListSubheaderPropsListSubheaderTypeMapdi {
  
  inline def apply(): ListSubheaderPropsListSubheaderTypeMapdi = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ListSubheaderPropsListSubheaderTypeMapdi]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ListSubheaderPropsListSubheaderTypeMapdi] (val x: Self) extends AnyVal {
