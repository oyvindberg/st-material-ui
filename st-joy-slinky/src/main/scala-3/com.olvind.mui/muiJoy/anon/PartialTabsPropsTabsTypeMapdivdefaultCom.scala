...
/* Inlined std.Partial<TabsProps<TabsTypeMap<{}, 'div'>['defaultComponent'], {}>> */
trait PartialTabsPropsTabsTypeMapdivdefaultCom extends StObject {
...
object PartialTabsPropsTabsTypeMapdivdefaultCom {
  
  inline def apply(): PartialTabsPropsTabsTypeMapdivdefaultCom = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialTabsPropsTabsTypeMapdivdefaultCom]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialTabsPropsTabsTypeMapdivdefaultCom] (val x: Self) extends AnyVal {
