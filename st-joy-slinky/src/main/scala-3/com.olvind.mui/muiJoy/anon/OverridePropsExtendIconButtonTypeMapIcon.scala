...
/* Inlined @mui/types.@mui/types.OverrideProps<@mui/joy.@mui/joy/IconButton/IconButtonProps.ExtendIconButtonTypeMap<@mui/joy.@mui/joy/IconButton/IconButtonProps.IconButtonTypeMap<{}, 'button'>>, 'a'> */
trait OverridePropsExtendIconButtonTypeMapIcon extends StObject {
...
object OverridePropsExtendIconButtonTypeMapIcon {
  
  inline def apply(): OverridePropsExtendIconButtonTypeMapIcon = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[OverridePropsExtendIconButtonTypeMapIcon]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: OverridePropsExtendIconButtonTypeMapIcon] (val x: Self) extends AnyVal {
