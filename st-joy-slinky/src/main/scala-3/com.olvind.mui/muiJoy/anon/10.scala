...
trait `10`[Theme] extends StObject {
...
object `10` {
  ...
  inline def apply[Theme](): `10`[Theme] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[`10`[Theme]]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `10`[?], Theme] (val x: Self & `10`[Theme]) extends AnyVal {
