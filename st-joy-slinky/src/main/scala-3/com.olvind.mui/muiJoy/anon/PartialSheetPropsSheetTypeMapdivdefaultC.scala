...
/* Inlined std.Partial<SheetProps<SheetTypeMap<{}, 'div'>['defaultComponent'], {}>> */
trait PartialSheetPropsSheetTypeMapdivdefaultC extends StObject {
...
object PartialSheetPropsSheetTypeMapdivdefaultC {
  
  inline def apply(): PartialSheetPropsSheetTypeMapdivdefaultC = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialSheetPropsSheetTypeMapdivdefaultC]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialSheetPropsSheetTypeMapdivdefaultC] (val x: Self) extends AnyVal {
