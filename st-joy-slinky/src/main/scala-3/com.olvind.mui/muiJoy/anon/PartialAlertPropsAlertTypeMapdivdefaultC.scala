...
/* Inlined std.Partial<AlertProps<AlertTypeMap<{}, 'div'>['defaultComponent'], {}>> */
trait PartialAlertPropsAlertTypeMapdivdefaultC extends StObject {
...
object PartialAlertPropsAlertTypeMapdivdefaultC {
  
  inline def apply(): PartialAlertPropsAlertTypeMapdivdefaultC = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialAlertPropsAlertTypeMapdivdefaultC]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialAlertPropsAlertTypeMapdivdefaultC] (val x: Self) extends AnyVal {
