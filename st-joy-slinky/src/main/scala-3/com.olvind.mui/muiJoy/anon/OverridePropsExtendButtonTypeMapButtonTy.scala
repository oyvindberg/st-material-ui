...
/* Inlined @mui/types.@mui/types.OverrideProps<@mui/joy.@mui/joy/Button/ButtonProps.ExtendButtonTypeMap<@mui/joy.@mui/joy/Button/ButtonProps.ButtonTypeMap<{}, 'button'>>, 'a'> */
trait OverridePropsExtendButtonTypeMapButtonTy extends StObject {
...
object OverridePropsExtendButtonTypeMapButtonTy {
  
  inline def apply(): OverridePropsExtendButtonTypeMapButtonTy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[OverridePropsExtendButtonTypeMapButtonTy]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: OverridePropsExtendButtonTypeMapButtonTy] (val x: Self) extends AnyVal {
