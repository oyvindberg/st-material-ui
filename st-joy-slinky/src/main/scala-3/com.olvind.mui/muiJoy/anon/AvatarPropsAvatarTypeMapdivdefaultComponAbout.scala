...
trait AvatarPropsAvatarTypeMapdivdefaultComponAbout[P] extends StObject {
...
object AvatarPropsAvatarTypeMapdivdefaultComponAbout {
  
  inline def apply[P](): AvatarPropsAvatarTypeMapdivdefaultComponAbout[P] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AvatarPropsAvatarTypeMapdivdefaultComponAbout[P]]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: AvatarPropsAvatarTypeMapdivdefaultComponAbout[?], P] (val x: Self & AvatarPropsAvatarTypeMapdivdefaultComponAbout[P]) extends AnyVal {
