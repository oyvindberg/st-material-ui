...
trait SliderOwnerStateAriaatomic extends StObject {
  ...
  var slotProps: js.UndefOr[InputMark] = js.undefined
...
object SliderOwnerStateAriaatomic {
  
  inline def apply(dragging: Boolean, marked: Boolean): SliderOwnerStateAriaatomic = {
    val __obj = js.Dynamic.literal(dragging = dragging.asInstanceOf[js.Any], marked = marked.asInstanceOf[js.Any])
    __obj.asInstanceOf[SliderOwnerStateAriaatomic]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SliderOwnerStateAriaatomic] (val x: Self) extends AnyVal {
    ...
    inline def setSlotProps(value: InputMark): Self = StObject.set(x, "slotProps", value.asInstanceOf[js.Any])
