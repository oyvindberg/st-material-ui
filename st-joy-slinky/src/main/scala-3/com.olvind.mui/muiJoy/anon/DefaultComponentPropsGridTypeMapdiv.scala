...
/* Inlined @mui/types.@mui/types.DefaultComponentProps<@mui/joy.@mui/joy/Grid/GridProps.GridTypeMap<{}, 'div'>> */
...
object DefaultComponentPropsGridTypeMapdiv {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DefaultComponentPropsGridTypeMapdiv] (val x: Self) extends AnyVal {
