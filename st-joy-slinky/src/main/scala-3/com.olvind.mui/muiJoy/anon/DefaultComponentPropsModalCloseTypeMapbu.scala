...
/* Inlined @mui/types.@mui/types.DefaultComponentProps<@mui/joy.@mui/joy/ModalClose/ModalCloseProps.ModalCloseTypeMap<{}, 'button'>> */
trait DefaultComponentPropsModalCloseTypeMapbu extends StObject {
...
object DefaultComponentPropsModalCloseTypeMapbu {
  
  inline def apply(): DefaultComponentPropsModalCloseTypeMapbu = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsModalCloseTypeMapbu]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DefaultComponentPropsModalCloseTypeMapbu] (val x: Self) extends AnyVal {
