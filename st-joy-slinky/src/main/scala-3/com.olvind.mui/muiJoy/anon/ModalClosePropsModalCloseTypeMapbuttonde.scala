...
/* Inlined @mui/joy.@mui/joy/ModalClose/ModalCloseProps.ModalCloseProps<@mui/joy.@mui/joy/ModalClose/ModalCloseProps.ModalCloseTypeMap<{}, 'button'>['defaultComponent'], {  component :react.react.ElementType<any> | undefined}> */
trait ModalClosePropsModalCloseTypeMapbuttonde extends StObject {
...
object ModalClosePropsModalCloseTypeMapbuttonde {
  
  inline def apply(): ModalClosePropsModalCloseTypeMapbuttonde = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ModalClosePropsModalCloseTypeMapbuttonde]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ModalClosePropsModalCloseTypeMapbuttonde] (val x: Self) extends AnyVal {
