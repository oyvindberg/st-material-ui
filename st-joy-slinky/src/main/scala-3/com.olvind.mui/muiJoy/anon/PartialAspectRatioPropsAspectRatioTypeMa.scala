...
/* Inlined std.Partial<AspectRatioProps<AspectRatioTypeMap<{}, 'div'>['defaultComponent'], {}>> */
trait PartialAspectRatioPropsAspectRatioTypeMa extends StObject {
...
object PartialAspectRatioPropsAspectRatioTypeMa {
  
  inline def apply(): PartialAspectRatioPropsAspectRatioTypeMa = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialAspectRatioPropsAspectRatioTypeMa]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialAspectRatioPropsAspectRatioTypeMa] (val x: Self) extends AnyVal {
