...
trait SliderOwnerStateAriaautocomplete extends StObject {
  ...
  var slotProps: js.UndefOr[MarkLabelRail] = js.undefined
...
object SliderOwnerStateAriaautocomplete {
  
  inline def apply(dragging: Boolean, marked: Boolean): SliderOwnerStateAriaautocomplete = {
    val __obj = js.Dynamic.literal(dragging = dragging.asInstanceOf[js.Any], marked = marked.asInstanceOf[js.Any])
    __obj.asInstanceOf[SliderOwnerStateAriaautocomplete]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SliderOwnerStateAriaautocomplete] (val x: Self) extends AnyVal {
    ...
    inline def setSlotProps(value: MarkLabelRail): Self = StObject.set(x, "slotProps", value.asInstanceOf[js.Any])
