...
/* Inlined @mui/joy.@mui/joy/Button/ButtonProps.ButtonProps<@mui/joy.@mui/joy/Button/ButtonProps.ButtonTypeMap<{}, 'button'>['defaultComponent'], {  component :react.react.ElementType<any> | undefined}> */
...
object ButtonPropsButtonTypeMapbuttondefaultCom {
  ...
  inline def apply(): ButtonPropsButtonTypeMapbuttondefaultCom = {
