...
/* Inlined @mui/joy.@mui/joy/MenuItem/MenuItemProps.MenuItemProps<@mui/joy.@mui/joy/MenuItem/MenuItemProps.MenuItemTypeMap<{}, 'div'>['defaultComponent'], {  component :react.react.ElementType<any> | undefined}> */
trait MenuItemPropsMenuItemTypeMapdivdefaultCo extends StObject {
...
object MenuItemPropsMenuItemTypeMapdivdefaultCo {
  
  inline def apply(): MenuItemPropsMenuItemTypeMapdivdefaultCo = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[MenuItemPropsMenuItemTypeMapdivdefaultCo]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: MenuItemPropsMenuItemTypeMapdivdefaultCo] (val x: Self) extends AnyVal {
