...
/* Inlined @mui/joy.@mui/joy/LinearProgress/LinearProgressProps.LinearProgressProps<@mui/joy.@mui/joy/LinearProgress/LinearProgressProps.LinearProgressTypeMap<{}, 'div'>['defaultComponent'], {  component :react.react.ElementType<any> | undefined}> */
trait LinearProgressPropsLinearProgressTypeMap extends StObject {
...
object LinearProgressPropsLinearProgressTypeMap {
  
  inline def apply(): LinearProgressPropsLinearProgressTypeMap = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[LinearProgressPropsLinearProgressTypeMap]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: LinearProgressPropsLinearProgressTypeMap] (val x: Self) extends AnyVal {
