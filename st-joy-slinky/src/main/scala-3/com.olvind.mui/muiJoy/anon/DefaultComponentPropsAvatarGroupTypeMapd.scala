...
/* Inlined @mui/types.@mui/types.DefaultComponentProps<@mui/joy.@mui/joy/AvatarGroup/AvatarGroupProps.AvatarGroupTypeMap<{}, 'div'>> */
trait DefaultComponentPropsAvatarGroupTypeMapd extends StObject {
...
object DefaultComponentPropsAvatarGroupTypeMapd {
  
  inline def apply(): DefaultComponentPropsAvatarGroupTypeMapd = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsAvatarGroupTypeMapd]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DefaultComponentPropsAvatarGroupTypeMapd] (val x: Self) extends AnyVal {
