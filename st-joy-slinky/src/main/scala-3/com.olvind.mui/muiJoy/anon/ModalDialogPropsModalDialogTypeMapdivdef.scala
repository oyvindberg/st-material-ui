...
/* Inlined @mui/joy.@mui/joy/ModalDialog/ModalDialogProps.ModalDialogProps<@mui/joy.@mui/joy/ModalDialog/ModalDialogProps.ModalDialogTypeMap<{}, 'div'>['defaultComponent'], {  component :react.react.ElementType<any> | undefined}> */
trait ModalDialogPropsModalDialogTypeMapdivdef extends StObject {
...
object ModalDialogPropsModalDialogTypeMapdivdef {
  
  inline def apply(): ModalDialogPropsModalDialogTypeMapdivdef = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ModalDialogPropsModalDialogTypeMapdivdef]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ModalDialogPropsModalDialogTypeMapdivdef] (val x: Self) extends AnyVal {
