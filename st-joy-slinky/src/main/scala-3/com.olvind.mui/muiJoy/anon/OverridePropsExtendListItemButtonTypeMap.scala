...
/* Inlined @mui/types.@mui/types.OverrideProps<@mui/joy.@mui/joy/ListItemButton/ListItemButtonProps.ExtendListItemButtonTypeMap<@mui/joy.@mui/joy/ListItemButton/ListItemButtonProps.ListItemButtonTypeMap<{}, 'div'>>, 'a'> */
trait OverridePropsExtendListItemButtonTypeMap extends StObject {
...
object OverridePropsExtendListItemButtonTypeMap {
  
  inline def apply(): OverridePropsExtendListItemButtonTypeMap = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[OverridePropsExtendListItemButtonTypeMap]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: OverridePropsExtendListItemButtonTypeMap] (val x: Self) extends AnyVal {
