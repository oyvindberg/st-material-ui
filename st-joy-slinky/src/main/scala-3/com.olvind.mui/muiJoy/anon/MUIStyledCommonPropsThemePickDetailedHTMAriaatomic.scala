...
trait MUIStyledCommonPropsThemePickDetailedHTMAriaatomic extends StObject {
...
object MUIStyledCommonPropsThemePickDetailedHTMAriaatomic {
  
  inline def apply(ownerState: SheetOwnerState): MUIStyledCommonPropsThemePickDetailedHTMAriaatomic = {
    val __obj = js.Dynamic.literal(ownerState = ownerState.asInstanceOf[js.Any])
    __obj.asInstanceOf[MUIStyledCommonPropsThemePickDetailedHTMAriaatomic]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: MUIStyledCommonPropsThemePickDetailedHTMAriaatomic] (val x: Self) extends AnyVal {
