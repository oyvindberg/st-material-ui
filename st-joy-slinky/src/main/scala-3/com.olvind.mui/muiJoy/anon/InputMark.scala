...
trait InputMark extends StObject {
  ...
  var mark: js.UndefOr[
    com.olvind.mui.muiJoy.utilsTypesMod.SlotProps[
      "span", 
      js.Object, 
      com.olvind.mui.muiJoy.sliderSliderPropsMod.SliderOwnerState & Percent
    ]
  ] = js.undefined
...
object InputMark {
  ...
  inline def apply(): InputMark = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[InputMark]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: InputMark] (val x: Self) extends AnyVal {
    ...
    inline def setMarkFunction1(
      value: com.olvind.mui.muiJoy.sliderSliderPropsMod.SliderOwnerState & Percent => (Omit[ComponentPropsWithRef["span"], "color"]) & js.Object & SlotCommonProps & (Record[String, Any])
