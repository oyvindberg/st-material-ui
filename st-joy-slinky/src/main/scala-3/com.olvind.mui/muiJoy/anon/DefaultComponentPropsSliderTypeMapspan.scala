...
/* Inlined @mui/types.@mui/types.DefaultComponentProps<@mui/joy.@mui/joy/Slider/SliderProps.SliderTypeMap<'span', {}>> */
trait DefaultComponentPropsSliderTypeMapspan extends StObject {
...
object DefaultComponentPropsSliderTypeMapspan {
  
  inline def apply(): DefaultComponentPropsSliderTypeMapspan = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsSliderTypeMapspan]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DefaultComponentPropsSliderTypeMapspan] (val x: Self) extends AnyVal {
