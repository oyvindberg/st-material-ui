...
trait BackdropSlotProps extends StObject {
...
object BackdropSlotProps {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[BackdropSlotProps]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: BackdropSlotProps] (val x: Self) extends AnyVal {
