...
/* Inlined react.react.PropsWithChildren<Partial<CssVarsProviderConfig<DefaultColorScheme>> & {}> */
trait PropsWithChildrenPartialCssVarsProviderC extends StObject {
  ...
  var defaultColorScheme: js.UndefOr[DefaultColorScheme | Dark[DefaultColorScheme]] = js.undefined
...
object PropsWithChildrenPartialCssVarsProviderC {
  ...
  implicit open class MutableBuilder[Self <: PropsWithChildrenPartialCssVarsProviderC] (val x: Self) extends AnyVal {
    ...
    inline def setDefaultColorScheme(value: DefaultColorScheme | Dark[DefaultColorScheme]): Self = StObject.set(x, "defaultColorScheme", value.asInstanceOf[js.Any])
