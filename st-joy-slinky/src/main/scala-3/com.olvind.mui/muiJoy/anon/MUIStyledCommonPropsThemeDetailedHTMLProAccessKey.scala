...
trait MUIStyledCommonPropsThemeDetailedHTMLProAccessKey extends StObject {
...
object MUIStyledCommonPropsThemeDetailedHTMLProAccessKey {
  
  inline def apply(ownerState: InputOwnerState): MUIStyledCommonPropsThemeDetailedHTMLProAccessKey = {
    val __obj = js.Dynamic.literal(ownerState = ownerState.asInstanceOf[js.Any])
    __obj.asInstanceOf[MUIStyledCommonPropsThemeDetailedHTMLProAccessKey]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: MUIStyledCommonPropsThemeDetailedHTMLProAccessKey] (val x: Self) extends AnyVal {
