...
/* Inlined std.Partial<ContainerProps<ContainerTypeMap<{}, 'div'>['defaultComponent'], {}>> */
trait PartialContainerPropsContainerTypeMapdiv extends StObject {
...
object PartialContainerPropsContainerTypeMapdiv {
  
  inline def apply(): PartialContainerPropsContainerTypeMapdiv = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialContainerPropsContainerTypeMapdiv]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialContainerPropsContainerTypeMapdiv] (val x: Self) extends AnyVal {
