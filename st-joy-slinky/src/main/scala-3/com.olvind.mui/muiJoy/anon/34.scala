...
trait `34`[Theme] extends StObject {
...
object `34` {
  ...
  inline def apply[Theme](): `34`[Theme] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[`34`[Theme]]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `34`[?], Theme] (val x: Self & `34`[Theme]) extends AnyVal {
