...
/* Inlined @mui/types.@mui/types.DefaultComponentProps<@mui/joy.@mui/joy/ScopedCssBaseline/ScopedCssBaselineProps.ScopedCssBaselineTypeMap<{}, 'div'>> */
...
object DefaultComponentPropsScopedCssBaselineTy {
  ...
  inline def apply(): DefaultComponentPropsScopedCssBaselineTy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsScopedCssBaselineTy]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DefaultComponentPropsScopedCssBaselineTy] (val x: Self) extends AnyVal {
