...
/* Inlined std.Partial<TextareaProps<TextareaTypeMap<{}, 'div'>['defaultComponent'], {}>> */
trait PartialTextareaPropsTextareaTypeMapdivde extends StObject {
...
object PartialTextareaPropsTextareaTypeMapdivde {
  
  inline def apply(): PartialTextareaPropsTextareaTypeMapdivde = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialTextareaPropsTextareaTypeMapdivde]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialTextareaPropsTextareaTypeMapdivde] (val x: Self) extends AnyVal {
