...
/* Inlined @mui/joy.@mui/joy/IconButton/IconButtonProps.IconButtonProps<@mui/joy.@mui/joy/IconButton/IconButtonProps.IconButtonTypeMap<{}, 'button'>['defaultComponent'], {  component :react.react.ElementType<any> | undefined}> */
...
object IconButtonPropsIconButtonTypeMapbuttonde {
  ...
  inline def apply(): IconButtonPropsIconButtonTypeMapbuttonde = {
