...
/* Inlined @mui/types.@mui/types.DefaultComponentProps<@mui/joy.@mui/joy/TabPanel/TabPanelProps.TabPanelTypeMap<{}, 'div'>> */
trait DefaultComponentPropsTabPanelTypeMapdiv extends StObject {
...
object DefaultComponentPropsTabPanelTypeMapdiv {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DefaultComponentPropsTabPanelTypeMapdiv] (val x: Self) extends AnyVal {
