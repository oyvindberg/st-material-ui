...
trait EndDecoratorSlotProps extends StObject {
  
  var endDecorator: com.olvind.mui.muiJoy.utilsTypesMod.SlotProps["span", js.Object, TypographyOwnerState]
  
  var root: com.olvind.mui.muiJoy.utilsTypesMod.SlotProps["a", js.Object, TypographyOwnerState]
  
  var startDecorator: com.olvind.mui.muiJoy.utilsTypesMod.SlotProps["span", js.Object, TypographyOwnerState]
}
object EndDecoratorSlotProps {
  
  inline def apply(
    endDecorator: com.olvind.mui.muiJoy.utilsTypesMod.SlotProps["span", js.Object, TypographyOwnerState],
    root: com.olvind.mui.muiJoy.utilsTypesMod.SlotProps["a", js.Object, TypographyOwnerState],
    startDecorator: com.olvind.mui.muiJoy.utilsTypesMod.SlotProps["span", js.Object, TypographyOwnerState]
  ): EndDecoratorSlotProps = {
    ...
    __obj.asInstanceOf[EndDecoratorSlotProps]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: EndDecoratorSlotProps] (val x: Self) extends AnyVal {
