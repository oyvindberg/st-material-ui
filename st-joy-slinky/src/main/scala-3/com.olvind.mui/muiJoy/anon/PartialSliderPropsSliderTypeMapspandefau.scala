...
/* Inlined std.Partial<SliderProps<SliderTypeMap<'span', {}>['defaultComponent'], {}>> */
trait PartialSliderPropsSliderTypeMapspandefau extends StObject {
  ...
  var slotProps: js.UndefOr[TrackValueLabel] = js.undefined
...
object PartialSliderPropsSliderTypeMapspandefau {
  
  inline def apply(): PartialSliderPropsSliderTypeMapspandefau = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialSliderPropsSliderTypeMapspandefau]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialSliderPropsSliderTypeMapspandefau] (val x: Self) extends AnyVal {
    ...
    inline def setSlotProps(value: TrackValueLabel): Self = StObject.set(x, "slotProps", value.asInstanceOf[js.Any])
