...
trait TrackValueLabel extends StObject {
  
  var input: js.UndefOr[
    com.olvind.mui.muiJoy.utilsTypesMod.SlotProps["input", js.Object, com.olvind.mui.muiJoy.sliderSliderPropsMod.SliderOwnerState]
  ] = js.undefined
  
  var mark: js.UndefOr[
    com.olvind.mui.muiJoy.utilsTypesMod.SlotProps["span", js.Object, SliderOwnerStateAriachecked]
  ] = js.undefined
...
object TrackValueLabel {
  
  inline def apply(): TrackValueLabel = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TrackValueLabel]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TrackValueLabel] (val x: Self) extends AnyVal {
    
    inline def setInput(
      value: com.olvind.mui.muiJoy.utilsTypesMod.SlotProps["input", js.Object, com.olvind.mui.muiJoy.sliderSliderPropsMod.SliderOwnerState]
    ): Self = StObject.set(x, "input", value.asInstanceOf[js.Any])
    
    inline def setInputFunction1(
      value: com.olvind.mui.muiJoy.sliderSliderPropsMod.SliderOwnerState => (Omit[ComponentPropsWithRef["input"], "color"]) & js.Object & SlotCommonProps & (Record[String, Any])
    ): Self = StObject.set(x, "input", js.Any.fromFunction1(value))
    
    inline def setInputUndefined: Self = StObject.set(x, "input", js.undefined)
    
    inline def setMark(
      value: com.olvind.mui.muiJoy.utilsTypesMod.SlotProps["span", js.Object, SliderOwnerStateAriachecked]
    ): Self = StObject.set(x, "mark", value.asInstanceOf[js.Any])
    
    inline def setMarkFunction1(
      value: SliderOwnerStateAriachecked => (Omit[ComponentPropsWithRef["span"], "color"]) & js.Object & SlotCommonProps & (Record[String, Any])
