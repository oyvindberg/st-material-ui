...
/* Inlined std.Partial<SvgIconProps<SvgIconTypeMap<{}, 'svg'>['defaultComponent'], {}>> */
trait PartialSvgIconPropsSvgIconTypeMapsvgdefa extends StObject {
...
object PartialSvgIconPropsSvgIconTypeMapsvgdefa {
  
  inline def apply(): PartialSvgIconPropsSvgIconTypeMapsvgdefa = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialSvgIconPropsSvgIconTypeMapsvgdefa]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialSvgIconPropsSvgIconTypeMapsvgdefa] (val x: Self) extends AnyVal {
