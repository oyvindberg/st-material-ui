...
/* Inlined @mui/joy.@mui/joy/Menu/MenuProps.MenuProps<@mui/joy.@mui/joy/Menu/MenuProps.MenuTypeMap<{}, 'ul'>['defaultComponent'], {}> */
trait MenuPropsMenuTypeMapuldefaultComponent extends StObject {
...
object MenuPropsMenuTypeMapuldefaultComponent {
  
  inline def apply(): MenuPropsMenuTypeMapuldefaultComponent = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[MenuPropsMenuTypeMapuldefaultComponent]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: MenuPropsMenuTypeMapuldefaultComponent] (val x: Self) extends AnyVal {
