...
/* Inlined std.Partial<ChipDeleteProps<ChipDeleteTypeMap<{}, 'button'>['defaultComponent'], {}>> */
trait PartialChipDeletePropsChipDeleteTypeMapb extends StObject {
...
object PartialChipDeletePropsChipDeleteTypeMapb {
  
  inline def apply(): PartialChipDeletePropsChipDeleteTypeMapb = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialChipDeletePropsChipDeleteTypeMapb]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialChipDeletePropsChipDeleteTypeMapb] (val x: Self) extends AnyVal {
