...
/* Inlined std.Partial<BoxProps<BoxTypeMap<{}, 'div'>['defaultComponent'], {}>> */
trait PartialBoxPropsBoxTypeMapdivdefaultCompo extends StObject {
...
object PartialBoxPropsBoxTypeMapdivdefaultCompo {
  
  inline def apply(): PartialBoxPropsBoxTypeMapdivdefaultCompo = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialBoxPropsBoxTypeMapdivdefaultCompo]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialBoxPropsBoxTypeMapdivdefaultCompo] (val x: Self) extends AnyVal {
