...
trait EndDecoratorInputRoot extends StObject {
...
object EndDecoratorInputRoot {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[EndDecoratorInputRoot]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: EndDecoratorInputRoot] (val x: Self) extends AnyVal {
