...
/* Inlined @mui/types.@mui/types.DefaultComponentProps<@mui/joy.@mui/joy/RadioGroup/RadioGroupProps.RadioGroupTypeMap<{}, 'div'>> */
trait DefaultComponentPropsRadioGroupTypeMapdi extends StObject {
...
object DefaultComponentPropsRadioGroupTypeMapdi {
  
  inline def apply(): DefaultComponentPropsRadioGroupTypeMapdi = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsRadioGroupTypeMapdi]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DefaultComponentPropsRadioGroupTypeMapdi] (val x: Self) extends AnyVal {
