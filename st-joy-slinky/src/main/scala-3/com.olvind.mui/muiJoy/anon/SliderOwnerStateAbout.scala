...
trait SliderOwnerStateAbout extends StObject {
  ...
  var slotProps: js.UndefOr[Rail] = js.undefined
...
object SliderOwnerStateAbout {
  
  inline def apply(dragging: Boolean, marked: Boolean): SliderOwnerStateAbout = {
    val __obj = js.Dynamic.literal(dragging = dragging.asInstanceOf[js.Any], marked = marked.asInstanceOf[js.Any])
    __obj.asInstanceOf[SliderOwnerStateAbout]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SliderOwnerStateAbout] (val x: Self) extends AnyVal {
    ...
    inline def setSlotProps(value: Rail): Self = StObject.set(x, "slotProps", value.asInstanceOf[js.Any])
