...
/* Inlined MUIStyledCommonProps<Theme> & {} & react.react.DetailedHTMLProps<react.react.HTMLAttributes<std.HTMLDivElement>, std.HTMLDivElement> & {} */
trait MUIStyledCommonPropsThemeDetailedHTMLProAriaautocomplete extends StObject {
  ...
  var ownerState: ListItemButtonOwnerState
...
object MUIStyledCommonPropsThemeDetailedHTMLProAriaautocomplete {
  
  inline def apply(ownerState: ListItemButtonOwnerState): MUIStyledCommonPropsThemeDetailedHTMLProAriaautocomplete = {
    val __obj = js.Dynamic.literal(ownerState = ownerState.asInstanceOf[js.Any])
    __obj.asInstanceOf[MUIStyledCommonPropsThemeDetailedHTMLProAriaautocomplete]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: MUIStyledCommonPropsThemeDetailedHTMLProAriaautocomplete] (val x: Self) extends AnyVal {
    ...
    inline def setOwnerState(value: ListItemButtonOwnerState): Self = StObject.set(x, "ownerState", value.asInstanceOf[js.Any])
