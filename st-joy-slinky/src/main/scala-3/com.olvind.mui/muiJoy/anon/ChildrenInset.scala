...
trait ChildrenInset extends StObject {
...
object ChildrenInset {
  
  inline def apply(): ChildrenInset = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ChildrenInset]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ChildrenInset] (val x: Self) extends AnyVal {
