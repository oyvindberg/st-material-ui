...
object PartialAutocompletePropsanyanyanyany {
  ...
  implicit open class MutableBuilder[Self <: PartialAutocompletePropsanyanyanyany] (val x: Self) extends AnyVal {
    ...
    inline def setOnKeyDown(value: /* event */ KeyboardEventHTMLDivElement => Unit): Self = StObject.set(x, "onKeyDown", js.Any.fromFunction1(value))
    ...
    inline def setRenderOption(
      value: (/* props */ OmitHTMLAttributesHTMLLIElementcolor, /* option */ Any, /* state */ AutocompleteRenderOptionState) => ReactElement
    ...
    inline def setRenderTags(
      value: (/* value */ js.Array[Any], /* getTagProps */ AutocompleteRenderGetTagProps, /* ownerState */ AutocompleteOwnerState[Any, Any, Any, Any]) => ReactElement
