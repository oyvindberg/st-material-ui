...
trait Mark extends StObject {
  ...
  var input: js.UndefOr[
    com.olvind.mui.muiJoy.utilsTypesMod.SlotProps["input", js.Object, SliderOwnerState]
  ] = js.undefined
  
  var mark: js.UndefOr[
    com.olvind.mui.muiJoy.utilsTypesMod.SlotProps["span", js.Object, SliderOwnerState & Percent]
  ] = js.undefined
