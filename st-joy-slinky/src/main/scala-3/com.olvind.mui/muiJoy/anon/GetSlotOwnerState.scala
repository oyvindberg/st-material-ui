...
trait GetSlotOwnerState[ElementType /* <: ReactElement */, OwnerState /* <: js.Object */, ExternalForwardedProps /* <: /* import warning: importer.ImportType#apply Failed type conversion: {  component :react.react.ElementType<any> | undefined,   slots :{[ k in T ]:? react.react.ElementType<any>} | undefined,   slotProps :{[ k in T ]:? ExternalSlotProps | (ownerState : OwnerState): ExternalSlotProps} | undefined} */ js.Any */, SlotProps, AdditionalProps, ExternalSlotProps /* <: /* import warning: importer.ImportType#apply Failed type conversion: {  component :react.react.ElementType<any> | undefined,   ref :react.react.Ref<any> | undefined} */ js.Any */, T /* <: String */, SlotOwnerState /* <: js.Object */] extends StObject {
