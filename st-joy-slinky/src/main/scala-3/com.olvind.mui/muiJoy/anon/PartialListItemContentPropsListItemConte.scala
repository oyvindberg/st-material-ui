...
/* Inlined std.Partial<ListItemContentProps<ListItemContentTypeMap<{}, 'div'>['defaultComponent'], {}>> */
trait PartialListItemContentPropsListItemConte extends StObject {
...
object PartialListItemContentPropsListItemConte {
  
  inline def apply(): PartialListItemContentPropsListItemConte = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialListItemContentPropsListItemConte]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialListItemContentPropsListItemConte] (val x: Self) extends AnyVal {
