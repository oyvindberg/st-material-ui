...
/* Inlined @mui/joy.@mui/joy/SvgIcon/SvgIconProps.SvgIconProps<@mui/joy.@mui/joy/SvgIcon/SvgIconProps.SvgIconTypeMap<{}, 'svg'>['defaultComponent'], {  component :react.react.ElementType<any> | undefined}> */
...
object SvgIconPropsSvgIconTypeMapsvgdefaultComp {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SvgIconPropsSvgIconTypeMapsvgdefaultComp] (val x: Self) extends AnyVal {
