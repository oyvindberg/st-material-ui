...
/* Inlined std.Partial<ModalCloseProps<ModalCloseTypeMap<{}, 'button'>['defaultComponent'], {}>> */
trait PartialModalClosePropsModalCloseTypeMapb extends StObject {
...
object PartialModalClosePropsModalCloseTypeMapb {
  
  inline def apply(): PartialModalClosePropsModalCloseTypeMapb = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialModalClosePropsModalCloseTypeMapb]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialModalClosePropsModalCloseTypeMapb] (val x: Self) extends AnyVal {
