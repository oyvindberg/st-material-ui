...
trait ColorInvertedColors extends StObject {
...
object ColorInvertedColors {
  
  inline def apply(): ColorInvertedColors = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ColorInvertedColors]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ColorInvertedColors] (val x: Self) extends AnyVal {
