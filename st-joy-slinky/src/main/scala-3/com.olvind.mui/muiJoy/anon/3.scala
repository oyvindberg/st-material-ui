...
trait `3`[Theme] extends StObject {
...
object `3` {
  ...
  inline def apply[Theme](): `3`[Theme] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[`3`[Theme]]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `3`[?], Theme] (val x: Self & `3`[Theme]) extends AnyVal {
