...
/* Inlined @mui/joy.@mui/joy/Link/LinkProps.LinkProps<@mui/joy.@mui/joy/Link/LinkProps.LinkTypeMap<{}, 'a'>['defaultComponent'], {  component :react.react.ElementType<any> | undefined,   focusVisible :boolean | undefined}> */
...
object LinkPropsLinkTypeMapadefaultComponent {
  ...
  inline def apply(): LinkPropsLinkTypeMapadefaultComponent = {
