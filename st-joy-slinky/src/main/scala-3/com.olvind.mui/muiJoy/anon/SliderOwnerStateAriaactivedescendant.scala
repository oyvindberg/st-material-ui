...
trait SliderOwnerStateAriaactivedescendant extends StObject {
...
object SliderOwnerStateAriaactivedescendant {
  
  inline def apply(dragging: Boolean, marked: Boolean): SliderOwnerStateAriaactivedescendant = {
    val __obj = js.Dynamic.literal(dragging = dragging.asInstanceOf[js.Any], marked = marked.asInstanceOf[js.Any])
    __obj.asInstanceOf[SliderOwnerStateAriaactivedescendant]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SliderOwnerStateAriaactivedescendant] (val x: Self) extends AnyVal {
