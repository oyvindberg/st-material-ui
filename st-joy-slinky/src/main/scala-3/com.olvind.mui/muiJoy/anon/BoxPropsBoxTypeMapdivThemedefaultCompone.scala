...
/* Inlined @mui/joy.@mui/joy/Box/BoxProps.BoxProps<@mui/system.@mui/system.BoxTypeMap<{}, 'div', @mui/system.@mui/system/createTheme/createTheme.Theme>['defaultComponent'], {}> */
trait BoxPropsBoxTypeMapdivThemedefaultCompone extends StObject {
...
object BoxPropsBoxTypeMapdivThemedefaultCompone {
  
  inline def apply(): BoxPropsBoxTypeMapdivThemedefaultCompone = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[BoxPropsBoxTypeMapdivThemedefaultCompone]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: BoxPropsBoxTypeMapdivThemedefaultCompone] (val x: Self) extends AnyVal {
