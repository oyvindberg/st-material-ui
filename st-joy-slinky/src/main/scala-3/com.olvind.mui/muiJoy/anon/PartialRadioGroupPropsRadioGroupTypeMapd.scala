...
/* Inlined std.Partial<RadioGroupProps<RadioGroupTypeMap<{}, 'div'>['defaultComponent'], {}>> */
trait PartialRadioGroupPropsRadioGroupTypeMapd extends StObject {
...
object PartialRadioGroupPropsRadioGroupTypeMapd {
  
  inline def apply(): PartialRadioGroupPropsRadioGroupTypeMapd = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialRadioGroupPropsRadioGroupTypeMapd]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialRadioGroupPropsRadioGroupTypeMapd] (val x: Self) extends AnyVal {
