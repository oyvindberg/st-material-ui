...
/* Inlined @mui/joy.@mui/joy/AspectRatio/AspectRatioProps.AspectRatioProps<@mui/joy.@mui/joy/AspectRatio/AspectRatioProps.AspectRatioTypeMap<{}, 'div'>['defaultComponent'], {  component :react.react.ElementType<any> | undefined}> */
trait AspectRatioPropsAspectRatioTypeMapdivdef extends StObject {
  ...
  var slotProps: js.UndefOr[Content] = js.undefined
  
  var slots: js.UndefOr[PartialAspectRatioSlots] = js.undefined
...
object AspectRatioPropsAspectRatioTypeMapdivdef {
  
  inline def apply(): AspectRatioPropsAspectRatioTypeMapdivdef = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AspectRatioPropsAspectRatioTypeMapdivdef]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: AspectRatioPropsAspectRatioTypeMapdivdef] (val x: Self) extends AnyVal {
    ...
    inline def setSlotProps(value: Content): Self = StObject.set(x, "slotProps", value.asInstanceOf[js.Any])
    
    inline def setSlotPropsUndefined: Self = StObject.set(x, "slotProps", js.undefined)
    
    inline def setSlotUndefined: Self = StObject.set(x, "slot", js.undefined)
    
    inline def setSlots(value: PartialAspectRatioSlots): Self = StObject.set(x, "slots", value.asInstanceOf[js.Any])
