...
/* Inlined @mui/types.@mui/types.DefaultComponentProps<@mui/joy.@mui/joy/ChipDelete/ChipDeleteProps.ChipDeleteTypeMap<{}, 'button'>> */
trait DefaultComponentPropsChipDeleteTypeMapbu extends StObject {
...
object DefaultComponentPropsChipDeleteTypeMapbu {
  
  inline def apply(): DefaultComponentPropsChipDeleteTypeMapbu = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsChipDeleteTypeMapbu]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DefaultComponentPropsChipDeleteTypeMapbu] (val x: Self) extends AnyVal {
