...
/* Inlined @mui/joy.@mui/joy/Textarea/TextareaProps.TextareaProps<@mui/joy.@mui/joy/Textarea/TextareaProps.TextareaTypeMap<{}, 'div'>['defaultComponent'], {  component :react.react.ElementType<any> | undefined}> */
trait TextareaPropsTextareaTypeMapdivdefaultCo extends StObject {
...
object TextareaPropsTextareaTypeMapdivdefaultCo {
  
  inline def apply(): TextareaPropsTextareaTypeMapdivdefaultCo = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TextareaPropsTextareaTypeMapdivdefaultCo]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TextareaPropsTextareaTypeMapdivdefaultCo] (val x: Self) extends AnyVal {
