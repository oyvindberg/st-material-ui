...
/* Inlined @mui/joy.@mui/joy/Switch/SwitchProps.SwitchProps<@mui/joy.@mui/joy/Switch/SwitchProps.SwitchTypeMap<{}, 'div'>['defaultComponent'], {  component :react.react.ElementType<any> | undefined}> */
trait SwitchPropsSwitchTypeMapdivdefaultCompon extends StObject {
  ...
  var slots: js.UndefOr[PartialSwitchSlots] = js.undefined
...
object SwitchPropsSwitchTypeMapdivdefaultCompon {
  
  inline def apply(): SwitchPropsSwitchTypeMapdivdefaultCompon = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SwitchPropsSwitchTypeMapdivdefaultCompon]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SwitchPropsSwitchTypeMapdivdefaultCompon] (val x: Self) extends AnyVal {
    ...
    inline def setEndDecorator(value: ReactElement | (js.Function1[SwitchPropsSwitchTypeMapdivdefaultCompon, ReactElement])): Self = StObject.set(x, "endDecorator", value.asInstanceOf[js.Any])
    
    inline def setEndDecoratorFunction1(value: SwitchPropsSwitchTypeMapdivdefaultCompon => ReactElement): Self = StObject.set(x, "endDecorator", js.Any.fromFunction1(value))
    ...
    inline def setSlots(value: PartialSwitchSlots): Self = StObject.set(x, "slots", value.asInstanceOf[js.Any])
    ...
    inline def setStartDecorator(value: ReactElement | (js.Function1[SwitchPropsSwitchTypeMapdivdefaultCompon, ReactElement])): Self = StObject.set(x, "startDecorator", value.asInstanceOf[js.Any])
    
    inline def setStartDecoratorFunction1(value: SwitchPropsSwitchTypeMapdivdefaultCompon => ReactElement): Self = StObject.set(x, "startDecorator", js.Any.fromFunction1(value))
