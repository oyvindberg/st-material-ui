...
/* Inlined @mui/joy.@mui/joy/ChipDelete/ChipDeleteProps.ChipDeleteProps<@mui/joy.@mui/joy/ChipDelete/ChipDeleteProps.ChipDeleteTypeMap<{}, 'button'>['defaultComponent'], {  component :react.react.ElementType<any> | undefined}> */
trait ChipDeletePropsChipDeleteTypeMapbuttonde extends StObject {
...
object ChipDeletePropsChipDeleteTypeMapbuttonde {
  
  inline def apply(): ChipDeletePropsChipDeleteTypeMapbuttonde = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ChipDeletePropsChipDeleteTypeMapbuttonde]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ChipDeletePropsChipDeleteTypeMapbuttonde] (val x: Self) extends AnyVal {
    ...
    inline def setOnDelete(value: SyntheticMouseEvent[HTMLButtonElement] | SyntheticKeyboardEvent[HTMLButtonElement] => Unit): Self = StObject.set(x, "onDelete", js.Any.fromFunction1(value))
