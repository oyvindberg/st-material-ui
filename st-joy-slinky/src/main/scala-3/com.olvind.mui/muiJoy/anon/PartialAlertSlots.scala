...
/* Inlined std.Partial<@mui/joy.@mui/joy/Alert/AlertProps.AlertSlots> */
trait PartialAlertSlots extends StObject {
...
object PartialAlertSlots {
  
  inline def apply(): PartialAlertSlots = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialAlertSlots]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialAlertSlots] (val x: Self) extends AnyVal {
