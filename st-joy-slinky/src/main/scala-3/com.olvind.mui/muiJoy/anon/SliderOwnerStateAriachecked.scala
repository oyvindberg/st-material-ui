...
trait SliderOwnerStateAriachecked extends StObject {
  ...
  var slotProps: js.UndefOr[RootThumb] = js.undefined
...
object SliderOwnerStateAriachecked {
  
  inline def apply(dragging: Boolean, marked: Boolean): SliderOwnerStateAriachecked = {
    val __obj = js.Dynamic.literal(dragging = dragging.asInstanceOf[js.Any], marked = marked.asInstanceOf[js.Any])
    __obj.asInstanceOf[SliderOwnerStateAriachecked]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SliderOwnerStateAriachecked] (val x: Self) extends AnyVal {
    ...
    inline def setSlotProps(value: RootThumb): Self = StObject.set(x, "slotProps", value.asInstanceOf[js.Any])
