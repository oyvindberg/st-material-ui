...
trait DefaultComponentPropsChipTypeMapdiv extends StObject {
  ...
  var slotProps: js.UndefOr[ActionEndDecorator] = js.undefined
  
  var slots: js.UndefOr[PartialChipSlots] = js.undefined
...
object DefaultComponentPropsChipTypeMapdiv {
  ...
  implicit open class MutableBuilder[Self <: DefaultComponentPropsChipTypeMapdiv] (val x: Self) extends AnyVal {
    ...
    inline def setSlotProps(value: ActionEndDecorator): Self = StObject.set(x, "slotProps", value.asInstanceOf[js.Any])
    
    inline def setSlotPropsUndefined: Self = StObject.set(x, "slotProps", js.undefined)
    
    inline def setSlotUndefined: Self = StObject.set(x, "slot", js.undefined)
    
    inline def setSlots(value: PartialChipSlots): Self = StObject.set(x, "slots", value.asInstanceOf[js.Any])
