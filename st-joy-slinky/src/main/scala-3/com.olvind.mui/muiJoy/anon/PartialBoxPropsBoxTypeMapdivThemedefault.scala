...
/* Inlined std.Partial<BoxProps<BoxTypeMap<{}, 'div', Theme>['defaultComponent'], {}>> */
trait PartialBoxPropsBoxTypeMapdivThemedefault extends StObject {
...
object PartialBoxPropsBoxTypeMapdivThemedefault {
  
  inline def apply(): PartialBoxPropsBoxTypeMapdivThemedefault = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialBoxPropsBoxTypeMapdivThemedefault]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialBoxPropsBoxTypeMapdivThemedefault] (val x: Self) extends AnyVal {
