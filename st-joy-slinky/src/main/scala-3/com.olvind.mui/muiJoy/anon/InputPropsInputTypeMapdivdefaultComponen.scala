...
trait InputPropsInputTypeMapdivdefaultComponen extends StObject {
  ...
  var slotProps: js.UndefOr[EndDecoratorInput] = js.undefined
  
  var slots: js.UndefOr[PartialInputSlots] = js.undefined
...
object InputPropsInputTypeMapdivdefaultComponen {
  
  inline def apply(): InputPropsInputTypeMapdivdefaultComponen = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[InputPropsInputTypeMapdivdefaultComponen]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: InputPropsInputTypeMapdivdefaultComponen] (val x: Self) extends AnyVal {
    ...
    inline def setSlotProps(value: EndDecoratorInput): Self = StObject.set(x, "slotProps", value.asInstanceOf[js.Any])
    
    inline def setSlotPropsUndefined: Self = StObject.set(x, "slotProps", js.undefined)
    
    inline def setSlotUndefined: Self = StObject.set(x, "slot", js.undefined)
    
    inline def setSlots(value: PartialInputSlots): Self = StObject.set(x, "slots", value.asInstanceOf[js.Any])
