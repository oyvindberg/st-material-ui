...
/* Inlined std.Omit<@mui/joy.@mui/joy/styles/types.SystemProps, 'color'> */
trait OmitSystemPropscolor extends StObject {
...
object OmitSystemPropscolor {
  
  inline def apply(): OmitSystemPropscolor = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[OmitSystemPropscolor]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: OmitSystemPropscolor] (val x: Self) extends AnyVal {
