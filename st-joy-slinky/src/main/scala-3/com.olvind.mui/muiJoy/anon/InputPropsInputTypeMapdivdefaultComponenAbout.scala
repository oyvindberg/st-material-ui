...
/* Inlined @mui/joy.@mui/joy/Input/InputProps.InputProps<@mui/joy.@mui/joy/Input/InputProps.InputTypeMap<{}, 'div'>['defaultComponent'], {  component :react.react.ElementType<any> | undefined}> */
trait InputPropsInputTypeMapdivdefaultComponenAbout[P] extends StObject {
  ...
  /**
    ...
    * @default 'neutral'
    */
  var color: js.UndefOr[OverridableStringUnion[ColorPaletteProp, InputPropsColorOverrides]] = js.undefined
  ...
  /**
    ...
    * @default 'md'
    */
  var size: js.UndefOr[OverridableStringUnion["sm" | "md" | "lg", InputPropsSizeOverrides]] = js.undefined
  
  var slot: js.UndefOr[String] = js.undefined
  
  var slotProps: js.UndefOr[
    /* import warning: importer.ImportType#apply Failed type conversion: {[ P in keyof {  root :@mui/joy.@mui/joy/utils/types.SlotProps<'div', {}, @mui/joy.@mui/joy/Input/InputProps.InputOwnerState>,   input :@mui/joy.@mui/joy/utils/types.SlotProps<'input', {}, @mui/joy.@mui/joy/Input/InputProps.InputOwnerState>,   startDecorator :@mui/joy.@mui/joy/utils/types.SlotProps<'span', {}, @mui/joy.@mui/joy/Input/InputProps.InputOwnerState>,   endDecorator :@mui/joy.@mui/joy/utils/types.SlotProps<'span', {}, @mui/joy.@mui/joy/Input/InputProps.InputOwnerState>} ]:? {  root :@mui/joy.@mui/joy/utils/types.SlotProps<'div', {}, @mui/joy.@mui/joy/Input/InputProps.InputOwnerState>,   input :@mui/joy.@mui/joy/utils/types.SlotProps<'input', {}, @mui/joy.@mui/joy/Input/InputProps.InputOwnerState>,   startDecorator :@mui/joy.@mui/joy/utils/types.SlotProps<'span', {}, @mui/joy.@mui/joy/Input/InputProps.InputOwnerState>,   endDecorator :@mui/joy.@mui/joy/utils/types.SlotProps<'span', {}, @mui/joy.@mui/joy/Input/InputProps.InputOwnerState>}[P]} */ js.Any
  ] = js.undefined
  
  var slots: js.UndefOr[EndDecoratorInput] = js.undefined
...
object InputPropsInputTypeMapdivdefaultComponenAbout {
  
  inline def apply[P](): InputPropsInputTypeMapdivdefaultComponenAbout[P] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[InputPropsInputTypeMapdivdefaultComponenAbout[P]]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: InputPropsInputTypeMapdivdefaultComponenAbout[?], P] (val x: Self & InputPropsInputTypeMapdivdefaultComponenAbout[P]) extends AnyVal {
    ...
    inline def setColor(value: OverridableStringUnion[ColorPaletteProp, InputPropsColorOverrides]): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
    ...
    inline def setSize(value: OverridableStringUnion["sm" | "md" | "lg", InputPropsSizeOverrides]): Self = StObject.set(x, "size", value.asInstanceOf[js.Any])
    ...
    inline def setSlotProps(
      value: /* import warning: importer.ImportType#apply Failed type conversion: {[ P in keyof {  root :@mui/joy.@mui/joy/utils/types.SlotProps<'div', {}, @mui/joy.@mui/joy/Input/InputProps.InputOwnerState>,   input :@mui/joy.@mui/joy/utils/types.SlotProps<'input', {}, @mui/joy.@mui/joy/Input/InputProps.InputOwnerState>,   startDecorator :@mui/joy.@mui/joy/utils/types.SlotProps<'span', {}, @mui/joy.@mui/joy/Input/InputProps.InputOwnerState>,   endDecorator :@mui/joy.@mui/joy/utils/types.SlotProps<'span', {}, @mui/joy.@mui/joy/Input/InputProps.InputOwnerState>} ]:? {  root :@mui/joy.@mui/joy/utils/types.SlotProps<'div', {}, @mui/joy.@mui/joy/Input/InputProps.InputOwnerState>,   input :@mui/joy.@mui/joy/utils/types.SlotProps<'input', {}, @mui/joy.@mui/joy/Input/InputProps.InputOwnerState>,   startDecorator :@mui/joy.@mui/joy/utils/types.SlotProps<'span', {}, @mui/joy.@mui/joy/Input/InputProps.InputOwnerState>,   endDecorator :@mui/joy.@mui/joy/utils/types.SlotProps<'span', {}, @mui/joy.@mui/joy/Input/InputProps.InputOwnerState>}[P]} */ js.Any
    ...
    inline def setSlots(value: EndDecoratorInput): Self = StObject.set(x, "slots", value.asInstanceOf[js.Any])
    ...
    inline def setVariant(value: OverridableStringUnion[VariantProp, InputPropsVariantOverrides]): Self = StObject.set(x, "variant", value.asInstanceOf[js.Any])
