...
/* Inlined @mui/types.@mui/types.DefaultComponentProps<@mui/joy.@mui/joy/TabList/TabListProps.TabListTypeMap<{}, 'div'>> */
trait DefaultComponentPropsTabListTypeMapdiv extends StObject {
...
object DefaultComponentPropsTabListTypeMapdiv {
  
  inline def apply(): DefaultComponentPropsTabListTypeMapdiv = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsTabListTypeMapdiv]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DefaultComponentPropsTabListTypeMapdiv] (val x: Self) extends AnyVal {
