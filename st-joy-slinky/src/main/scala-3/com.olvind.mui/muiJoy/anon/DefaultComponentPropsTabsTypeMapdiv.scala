...
/* Inlined @mui/types.@mui/types.DefaultComponentProps<@mui/joy.@mui/joy/Tabs/TabsProps.TabsTypeMap<{}, 'div'>> */
trait DefaultComponentPropsTabsTypeMapdiv extends StObject {
...
object DefaultComponentPropsTabsTypeMapdiv {
  
  inline def apply(): DefaultComponentPropsTabsTypeMapdiv = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsTabsTypeMapdiv]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DefaultComponentPropsTabsTypeMapdiv] (val x: Self) extends AnyVal {
