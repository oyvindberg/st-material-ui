...
/* Inlined @mui/types.@mui/types.DefaultComponentProps<@mui/joy.@mui/joy/Textarea/TextareaProps.TextareaTypeMap<{}, 'div'>> */
trait DefaultComponentPropsTextareaTypeMapdiv extends StObject {
...
object DefaultComponentPropsTextareaTypeMapdiv {
  
  inline def apply(): DefaultComponentPropsTextareaTypeMapdiv = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsTextareaTypeMapdiv]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DefaultComponentPropsTextareaTypeMapdiv] (val x: Self) extends AnyVal {
