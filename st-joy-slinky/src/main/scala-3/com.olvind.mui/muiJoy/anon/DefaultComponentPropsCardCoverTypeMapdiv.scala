...
/* Inlined @mui/types.@mui/types.DefaultComponentProps<@mui/joy.@mui/joy/CardCover/CardCoverProps.CardCoverTypeMap<{}, 'div'>> */
trait DefaultComponentPropsCardCoverTypeMapdiv extends StObject {
...
object DefaultComponentPropsCardCoverTypeMapdiv {
  
  inline def apply(): DefaultComponentPropsCardCoverTypeMapdiv = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultComponentPropsCardCoverTypeMapdiv]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DefaultComponentPropsCardCoverTypeMapdiv] (val x: Self) extends AnyVal {
