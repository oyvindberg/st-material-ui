...
/* Inlined std.Partial<TabPanelProps<TabPanelTypeMap<{}, 'div'>['defaultComponent'], {}>> */
trait PartialTabPanelPropsTabPanelTypeMapdivde extends StObject {
...
object PartialTabPanelPropsTabPanelTypeMapdivde {
  
  inline def apply(): PartialTabPanelPropsTabPanelTypeMapdivde = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialTabPanelPropsTabPanelTypeMapdivde]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialTabPanelPropsTabPanelTypeMapdivde] (val x: Self) extends AnyVal {
