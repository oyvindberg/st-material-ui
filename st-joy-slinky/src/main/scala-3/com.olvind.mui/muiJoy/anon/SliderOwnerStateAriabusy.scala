...
trait SliderOwnerStateAriabusy extends StObject {
  ...
  var slotProps: js.UndefOr[RailRoot] = js.undefined
...
object SliderOwnerStateAriabusy {
  
  inline def apply(dragging: Boolean, marked: Boolean): SliderOwnerStateAriabusy = {
    val __obj = js.Dynamic.literal(dragging = dragging.asInstanceOf[js.Any], marked = marked.asInstanceOf[js.Any])
    __obj.asInstanceOf[SliderOwnerStateAriabusy]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SliderOwnerStateAriabusy] (val x: Self) extends AnyVal {
    ...
    inline def setSlotProps(value: RailRoot): Self = StObject.set(x, "slotProps", value.asInstanceOf[js.Any])
