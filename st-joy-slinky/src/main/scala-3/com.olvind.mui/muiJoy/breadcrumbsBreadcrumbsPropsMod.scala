...
object breadcrumbsBreadcrumbsPropsMod {
  ...
  object BreadcrumbsOwnerState {
    ...
    implicit open class MutableBuilder[Self <: BreadcrumbsOwnerState] (val x: Self) extends AnyVal {
      ...
      inline def setRefReactRef(value: ReactRef[HTMLElement]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
  ...
  object BreadcrumbsTypeMap {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: BreadcrumbsTypeMap[?, ?], P, D /* <: ReactElement */] (val x: Self & (BreadcrumbsTypeMap[P, D])) extends AnyVal {
