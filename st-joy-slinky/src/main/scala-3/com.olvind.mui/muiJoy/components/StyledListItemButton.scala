...
object StyledListItemButton {
  
  inline def apply(ownerState: ListItemButtonOwnerState): Builder = {
    val __props = js.Dynamic.literal(ownerState = ownerState.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[/* props */ MUIStyledCommonPropsThemeDetailedHTMLProAriaautocomplete]))
  }
  ...
  type Props = /* props */ MUIStyledCommonPropsThemeDetailedHTMLProAriaautocomplete
  
  def styled: com.olvind.mui.StyledComponent.Builder[/* props */ MUIStyledCommonPropsThemeDetailedHTMLProAriaautocomplete, Builder] = new com.olvind.mui.StyledComponent.Builder[/* props */ MUIStyledCommonPropsThemeDetailedHTMLProAriaautocomplete, Builder](this.component, new js.Object, js.Array(), (newComponent: Any) => new Builder(js.Array(newComponent, js.Dictionary.empty)))
  
  def withProps(p: /* props */ MUIStyledCommonPropsThemeDetailedHTMLProAriaautocomplete): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
