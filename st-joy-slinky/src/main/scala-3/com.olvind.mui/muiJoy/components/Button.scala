...
object Button {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def actionFunction1(value: /* instance */ FocusVisible | Null => Unit): this.type = set("action", js.Any.fromFunction1(value))
    
    inline def actionNull: this.type = set("action", null)
    
    inline def actionReactRef(value: ReactRef[FocusVisible]): this.type = set("action", value.asInstanceOf[js.Any])
    ...
    inline def loadingIndicator(value: ReactElement): this.type = set("loadingIndicator", value.asInstanceOf[js.Any])
