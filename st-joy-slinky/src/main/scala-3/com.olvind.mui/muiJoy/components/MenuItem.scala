...
object MenuItem {
  ...
  type Props = /* props */ OverridePropsExtendMenuItemTypeMapMenuIt
  
  implicit def make(companion: MenuItem.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def styled: com.olvind.mui.StyledComponent.Builder[/* props */ OverridePropsExtendMenuItemTypeMapMenuIt, Builder] = new com.olvind.mui.StyledComponent.Builder[/* props */ OverridePropsExtendMenuItemTypeMapMenuIt, Builder](this.component, new js.Object, js.Array(), (newComponent: Any) => new Builder(js.Array(newComponent, js.Dictionary.empty)))
  
  def withProps(p: /* props */ OverridePropsExtendMenuItemTypeMapMenuIt): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
