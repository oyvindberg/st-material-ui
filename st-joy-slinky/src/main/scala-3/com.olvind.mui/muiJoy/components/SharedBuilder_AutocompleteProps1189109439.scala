...
open class SharedBuilder_AutocompleteProps1189109439[T, Multiple /* <: js.UndefOr[Boolean] */, DisableClearable /* <: js.UndefOr[Boolean] */, FreeSolo /* <: js.UndefOr[Boolean] */] (val args: js.Array[Any])
  ...
  inline def getLimitTagsText(value: /* more */ String | Double => ReactElement): this.type = set("getLimitTagsText", js.Any.fromFunction1(value))
  ...
  inline def onKeyDown(value: /* event */ KeyboardEventHTMLDivElement => Unit): this.type = set("onKeyDown", js.Any.fromFunction1(value))
  ...
  inline def renderOption(
    value: (/* props */ OmitHTMLAttributesHTMLLIElementcolor, T, /* state */ AutocompleteRenderOptionState) => ReactElement
  ): this.type = set("renderOption", js.Any.fromFunction3(value))
  
  inline def renderTags(
    value: (/* value */ js.Array[T], /* getTagProps */ AutocompleteRenderGetTagProps, /* ownerState */ AutocompleteOwnerState[T, Multiple, DisableClearable, FreeSolo]) => ReactElement
