...
object AvatarGroup {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def size(value: OverridableStringUnion["sm" | "md" | "lg", AvatarPropsSizeOverrides]): this.type = set("size", value.asInstanceOf[js.Any])
    ...
    inline def variant(value: OverridableStringUnion[VariantProp, AvatarPropsVariantOverrides]): this.type = set("variant", value.asInstanceOf[js.Any])
    
    inline def vocab(value: String): this.type = set("vocab", value.asInstanceOf[js.Any])
  }
  
  type Props = /* props */ DefaultComponentPropsAvatarGroupTypeMapd
  
  implicit def make(companion: AvatarGroup.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def styled: com.olvind.mui.StyledComponent.Builder[/* props */ DefaultComponentPropsAvatarGroupTypeMapd, Builder] = new com.olvind.mui.StyledComponent.Builder[/* props */ DefaultComponentPropsAvatarGroupTypeMapd, Builder](this.component, new js.Object, js.Array(), (newComponent: Any) => new Builder(js.Array(newComponent, js.Dictionary.empty)))
  
  def withProps(p: /* props */ DefaultComponentPropsAvatarGroupTypeMapd): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
