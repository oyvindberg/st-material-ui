...
import com.olvind.mui.muiJoy.anon.PartialTypographySlots
...
object Typography {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def color(value: OverridableStringUnion[ColorPaletteProp, TypographyPropsColorOverrides]): this.type = set("color", value.asInstanceOf[js.Any])
    ...
    inline def endDecorator(value: ReactElement): this.type = set("endDecorator", value.asInstanceOf[js.Any])
    ...
    ): this.type = set("levelMapping", value.asInstanceOf[js.Any])
    ...
    inline def onChange(value: SyntheticEvent[EventTarget & HTMLSpanElement, Event] => Unit): this.type = set("onChange", js.Any.fromFunction1(value))
    ...
    inline def slotProps(value: EndDecoratorRootStartDecorator): this.type = set("slotProps", value.asInstanceOf[js.Any])
    
    inline def slots(value: PartialTypographySlots): this.type = set("slots", value.asInstanceOf[js.Any])
    
    inline def spellCheck(value: Booleanish): this.type = set("spellCheck", value.asInstanceOf[js.Any])
    
    inline def startDecorator(value: ReactElement): this.type = set("startDecorator", value.asInstanceOf[js.Any])
    ...
    inline def variant(value: OverridableStringUnion[VariantProp, TypographyPropsVariantOverrides]): this.type = set("variant", value.asInstanceOf[js.Any])
