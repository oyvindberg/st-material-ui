...
object Breadcrumbs {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def size(value: OverridableStringUnion["sm" | "md" | "lg", BreadcrumbsPropsSizeOverrides]): this.type = set("size", value.asInstanceOf[js.Any])
    
    inline def slot(value: String): this.type = set("slot", value.asInstanceOf[js.Any])
    
    inline def slotProps(value: Li): this.type = set("slotProps", value.asInstanceOf[js.Any])
    
    inline def slots(value: PartialBreadcrumbsSlots): this.type = set("slots", value.asInstanceOf[js.Any])
