...
object Breadcrumbs {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def slotProps(value: Ol): this.type = set("slotProps", value.asInstanceOf[js.Any])
    
    inline def slots(value: Li): this.type = set("slots", value.asInstanceOf[js.Any])
