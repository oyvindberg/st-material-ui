...
object ModalOverflowRoot {
  
  inline def apply(ownerState: ModalOverflowOwnerState): Builder = {
    val __props = js.Dynamic.literal(ownerState = ownerState.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[/* props */ MUIStyledCommonPropsThemePickDetailedHTMAriaactivedescendant]))
  }
  ...
  type Props = /* props */ MUIStyledCommonPropsThemePickDetailedHTMAriaactivedescendant
  
  def styled: com.olvind.mui.StyledComponent.Builder[/* props */ MUIStyledCommonPropsThemePickDetailedHTMAriaactivedescendant, Builder] = new com.olvind.mui.StyledComponent.Builder[/* props */ MUIStyledCommonPropsThemePickDetailedHTMAriaactivedescendant, Builder](this.component, new js.Object, js.Array(), (newComponent: Any) => new Builder(js.Array(newComponent, js.Dictionary.empty)))
  
  def withProps(p: /* props */ MUIStyledCommonPropsThemePickDetailedHTMAriaactivedescendant): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
