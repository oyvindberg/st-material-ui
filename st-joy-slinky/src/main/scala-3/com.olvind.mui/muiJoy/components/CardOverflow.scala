...
object CardOverflow {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def color(value: OverridableStringUnion[ColorPaletteProp, CardOverflowPropsColorOverrides]): this.type = set("color", value.asInstanceOf[js.Any])
    ...
    inline def variant(value: OverridableStringUnion[VariantProp, CardOverflowPropsVariantOverrides]): this.type = set("variant", value.asInstanceOf[js.Any])
    
    inline def vocab(value: String): this.type = set("vocab", value.asInstanceOf[js.Any])
  }
  
  type Props = /* props */ DefaultComponentPropsCardOverflowTypeMap
  
  implicit def make(companion: CardOverflow.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def styled: com.olvind.mui.StyledComponent.Builder[/* props */ DefaultComponentPropsCardOverflowTypeMap, Builder] = new com.olvind.mui.StyledComponent.Builder[/* props */ DefaultComponentPropsCardOverflowTypeMap, Builder](this.component, new js.Object, js.Array(), (newComponent: Any) => new Builder(js.Array(newComponent, js.Dictionary.empty)))
  
  def withProps(p: /* props */ DefaultComponentPropsCardOverflowTypeMap): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
