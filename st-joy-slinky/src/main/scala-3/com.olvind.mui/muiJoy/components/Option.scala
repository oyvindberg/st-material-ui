...
object Option {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def color(value: OverridableStringUnion[ColorPaletteProp, OptionPropsColorOverrides]): this.type = set("color", value.asInstanceOf[js.Any])
    ...
    inline def label(value: String | ReactElement): this.type = set("label", value.asInstanceOf[js.Any])
    ...
    inline def variant(value: OverridableStringUnion[VariantProp, OptionPropsVariantOverrides]): this.type = set("variant", value.asInstanceOf[js.Any])
    
    inline def vocab(value: String): this.type = set("vocab", value.asInstanceOf[js.Any])
  }
  
  type Props = /* props */ OverridePropsExtendOptionTypeMapOptionTy
  
  implicit def make(companion: Option.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def styled: com.olvind.mui.StyledComponent.Builder[/* props */ OverridePropsExtendOptionTypeMapOptionTy, Builder] = new com.olvind.mui.StyledComponent.Builder[/* props */ OverridePropsExtendOptionTypeMapOptionTy, Builder](this.component, new js.Object, js.Array(), (newComponent: Any) => new Builder(js.Array(newComponent, js.Dictionary.empty)))
  
  def withProps(p: /* props */ OverridePropsExtendOptionTypeMapOptionTy): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
