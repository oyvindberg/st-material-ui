...
object ChipDelete {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def onDelete(value: SyntheticMouseEvent[HTMLButtonElement] | SyntheticKeyboardEvent[HTMLButtonElement] => Unit): this.type = set("onDelete", js.Any.fromFunction1(value))
