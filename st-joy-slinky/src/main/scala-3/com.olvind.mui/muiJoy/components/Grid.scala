...
object Grid {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def columnSpacing(value: com.olvind.mui.muiSystem.unstableGridGridPropsMod.ResponsiveStyleValue[GridSpacing]): this.type = set("columnSpacing", value.asInstanceOf[js.Any])
    
    inline def columnSpacingVarargs(value: (GridSpacing | Null)*): this.type = set("columnSpacing", js.Array(value*))
    
    inline def columns(value: com.olvind.mui.muiSystem.unstableGridGridPropsMod.ResponsiveStyleValue[Double]): this.type = set("columns", value.asInstanceOf[js.Any])
    ...
    inline def direction(value: com.olvind.mui.muiSystem.unstableGridGridPropsMod.ResponsiveStyleValue[GridDirection]): this.type = set("direction", value.asInstanceOf[js.Any])
    
    inline def directionVarargs(value: (GridDirection | Null)*): this.type = set("direction", js.Array(value*))
    
    inline def disableEqualOverflow(value: Boolean): this.type = set("disableEqualOverflow", value.asInstanceOf[js.Any])
    ...
    inline def rowSpacing(value: com.olvind.mui.muiSystem.unstableGridGridPropsMod.ResponsiveStyleValue[GridSpacing]): this.type = set("rowSpacing", value.asInstanceOf[js.Any])
