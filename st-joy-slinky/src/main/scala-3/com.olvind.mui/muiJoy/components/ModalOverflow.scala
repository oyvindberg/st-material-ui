...
object ModalOverflow {
  ...
  type Props = /* props */ DefaultComponentPropsModalOverflowTypeMa
  
  implicit def make(companion: ModalOverflow.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def styled: com.olvind.mui.StyledComponent.Builder[/* props */ DefaultComponentPropsModalOverflowTypeMa, Builder] = new com.olvind.mui.StyledComponent.Builder[/* props */ DefaultComponentPropsModalOverflowTypeMa, Builder](this.component, new js.Object, js.Array(), (newComponent: Any) => new Builder(js.Array(newComponent, js.Dictionary.empty)))
  
  def withProps(p: /* props */ DefaultComponentPropsModalOverflowTypeMa): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
