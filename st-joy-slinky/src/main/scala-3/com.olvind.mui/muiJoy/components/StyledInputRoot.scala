...
object StyledInputRoot {
  ...
  inline def apply(ownerState: InputOwnerState): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[/* props */ MUIStyledCommonPropsThemeDetailedHTMLProAccessKey]))
  }
  ...
  type Props = /* props */ MUIStyledCommonPropsThemeDetailedHTMLProAccessKey
  
  def styled: com.olvind.mui.StyledComponent.Builder[/* props */ MUIStyledCommonPropsThemeDetailedHTMLProAccessKey, Builder] = new com.olvind.mui.StyledComponent.Builder[/* props */ MUIStyledCommonPropsThemeDetailedHTMLProAccessKey, Builder](this.component, new js.Object, js.Array(), (newComponent: Any) => new Builder(js.Array(newComponent, js.Dictionary.empty)))
  
  def withProps(p: /* props */ MUIStyledCommonPropsThemeDetailedHTMLProAccessKey): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
