...
object RadioGroup {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def onChange(value: /* event */ ChangeEvent[HTMLInputElement] => Unit): this.type = set("onChange", js.Any.fromFunction1(value))
  ...
  type Props = /* props */ DefaultComponentPropsRadioGroupTypeMapdi
  
  implicit def make(companion: RadioGroup.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def styled: com.olvind.mui.StyledComponent.Builder[/* props */ DefaultComponentPropsRadioGroupTypeMapdi, Builder] = new com.olvind.mui.StyledComponent.Builder[/* props */ DefaultComponentPropsRadioGroupTypeMapdi, Builder](this.component, new js.Object, js.Array(), (newComponent: Any) => new Builder(js.Array(newComponent, js.Dictionary.empty)))
  
  def withProps(p: /* props */ DefaultComponentPropsRadioGroupTypeMapdi): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
