...
object StyledInputHtml {
  
  inline def apply(ownerState: InputOwnerState): Builder = {
    val __props = js.Dynamic.literal(ownerState = ownerState.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[/* props */ MUIStyledCommonPropsThemeDetailedHTMLProAccept]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def onResize(value: SyntheticEvent[Event, HTMLInputElement] => Unit): this.type = set("onResize", js.Any.fromFunction1(value))
  ...
  type Props = /* props */ MUIStyledCommonPropsThemeDetailedHTMLProAccept
  
  def styled: com.olvind.mui.StyledComponent.Builder[/* props */ MUIStyledCommonPropsThemeDetailedHTMLProAccept, Builder] = new com.olvind.mui.StyledComponent.Builder[/* props */ MUIStyledCommonPropsThemeDetailedHTMLProAccept, Builder](this.component, new js.Object, js.Array(), (newComponent: Any) => new Builder(js.Array(newComponent, js.Dictionary.empty)))
  
  def withProps(p: /* props */ MUIStyledCommonPropsThemeDetailedHTMLProAccept): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
