...
object ModalDialog {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def color(value: OverridableStringUnion[ColorPaletteProp, ModalDialogPropsColorOverrides]): this.type = set("color", value.asInstanceOf[js.Any])
    ...
    inline def layout(value: "center" | "fullscreen"): this.type = set("layout", value.asInstanceOf[js.Any])
    ...
    inline def size(value: OverridableStringUnion["sm" | "md" | "lg", ModalDialogPropsSizeOverrides]): this.type = set("size", value.asInstanceOf[js.Any])
    ...
    inline def variant(value: OverridableStringUnion[VariantProp, ModalDialogPropsVariantOverrides]): this.type = set("variant", value.asInstanceOf[js.Any])
    
    inline def vocab(value: String): this.type = set("vocab", value.asInstanceOf[js.Any])
  }
  
  type Props = /* props */ DefaultComponentPropsModalDialogTypeMapd
  
  implicit def make(companion: ModalDialog.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def styled: com.olvind.mui.StyledComponent.Builder[/* props */ DefaultComponentPropsModalDialogTypeMapd, Builder] = new com.olvind.mui.StyledComponent.Builder[/* props */ DefaultComponentPropsModalDialogTypeMapd, Builder](this.component, new js.Object, js.Array(), (newComponent: Any) => new Builder(js.Array(newComponent, js.Dictionary.empty)))
  
  def withProps(p: /* props */ DefaultComponentPropsModalDialogTypeMapd): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
