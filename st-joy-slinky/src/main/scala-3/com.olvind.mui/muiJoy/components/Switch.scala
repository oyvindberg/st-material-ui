...
object Switch {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def endDecorator(value: ReactElement | (js.Function1[/* ownerState */ SwitchOwnerState, ReactElement])): this.type = set("endDecorator", value.asInstanceOf[js.Any])
    
    inline def endDecoratorFunction1(value: /* ownerState */ SwitchOwnerState => ReactElement): this.type = set("endDecorator", js.Any.fromFunction1(value))
    
    inline def endDecoratorReactElement(value: ReactElement): this.type = set("endDecorator", value.asInstanceOf[js.Any])
    ...
    inline def startDecorator(value: ReactElement | (js.Function1[/* ownerState */ SwitchOwnerState, ReactElement])): this.type = set("startDecorator", value.asInstanceOf[js.Any])
    
    inline def startDecoratorFunction1(value: /* ownerState */ SwitchOwnerState => ReactElement): this.type = set("startDecorator", js.Any.fromFunction1(value))
    
    inline def startDecoratorReactElement(value: ReactElement): this.type = set("startDecorator", value.asInstanceOf[js.Any])
