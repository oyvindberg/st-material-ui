...
import com.olvind.mui.muiJoy.anon.Row
...
object cardCardPropsMod {
  ...
  /* Inlined parent @mui/joy.@mui/joy/Card/CardProps.CardProps<@mui/joy.@mui/joy/Card/CardProps.CardTypeMap<{}, 'div'>['defaultComponent'], {  component :react.react.ElementType<any> | undefined}> */
  trait CardOwnerState extends StObject {
  ...
  object CardOwnerState {
    
    inline def apply(): CardOwnerState = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[CardOwnerState]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: CardOwnerState] (val x: Self) extends AnyVal {
  ...
  object CardTypeMap {
    ...
    inline def apply[P, D /* <: ReactElement */](defaultComponent: D, props: P & Row): CardTypeMap[P, D] = {
    ...
    implicit open class MutableBuilder[Self <: CardTypeMap[?, ?], P, D /* <: ReactElement */] (val x: Self & (CardTypeMap[P, D])) extends AnyVal {
      ...
      inline def setProps(value: P & Row): Self = StObject.set(x, "props", value.asInstanceOf[js.Any])
    }
  }
}
