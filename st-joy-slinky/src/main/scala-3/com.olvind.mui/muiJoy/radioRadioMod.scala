...
object radioRadioMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@mui/joy/Radio/Radio", JSImport.Default)
  @js.native
  val default: js.Function1[/* props */ DefaultComponentPropsRadioTypeMapspan, Element | Null] = js.native
  
  type _To = js.Function1[/* props */ DefaultComponentPropsRadioTypeMapspan, Element | Null]
  
  /* This means you don't have to write `default`, but can instead just say `radioRadioMod.foo` */
  override def _to: js.Function1[/* props */ DefaultComponentPropsRadioTypeMapspan, Element | Null] = default
}
