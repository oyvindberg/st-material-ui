...
object switchSwitchPropsMod {
  ...
  trait SwitchOwnerState extends StObject {
    ...
    /**
      ...
      */
    var endDecorator: js.UndefOr[ReactElement | (js.Function1[/* ownerState */ this.type, ReactElement])] = js.undefined
    ...
    /**
      * The element that appears at the end of the switch.
      */
    var startDecorator: js.UndefOr[ReactElement | (js.Function1[/* ownerState */ this.type, ReactElement])] = js.undefined
  ...
  object SwitchOwnerState {
    ...
    implicit open class MutableBuilder[Self <: SwitchOwnerState] (val x: Self) extends AnyVal {
      ...
      inline def setEndDecorator(value: ReactElement | (js.Function1[SwitchOwnerState, ReactElement])): Self = StObject.set(x, "endDecorator", value.asInstanceOf[js.Any])
      
      inline def setEndDecoratorFunction1(value: SwitchOwnerState => ReactElement): Self = StObject.set(x, "endDecorator", js.Any.fromFunction1(value))
      ...
      inline def setStartDecorator(value: ReactElement | (js.Function1[SwitchOwnerState, ReactElement])): Self = StObject.set(x, "startDecorator", value.asInstanceOf[js.Any])
      
      inline def setStartDecoratorFunction1(value: SwitchOwnerState => ReactElement): Self = StObject.set(x, "startDecorator", js.Any.fromFunction1(value))
