...
object cardCoverCardCoverPropsMod {
  
  /* Inlined parent @mui/joy.@mui/joy/CardCover/CardCoverProps.CardCoverProps<@mui/joy.@mui/joy/CardCover/CardCoverProps.CardCoverTypeMap<{}, 'div'>['defaultComponent'], {  component :react.react.ElementType<any> | undefined}> */
  trait CardCoverOwnerState extends StObject {
  ...
  object CardCoverOwnerState {
    
    inline def apply(): CardCoverOwnerState = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[CardCoverOwnerState]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: CardCoverOwnerState] (val x: Self) extends AnyVal {
  ...
  type CardCoverProps[D /* <: ReactElement */, P] = OverrideProps[CardCoverTypeMap[P, D], D]
  
  type CardCoverSlot = "root"
  
  trait CardCoverTypeMap[P, D /* <: ReactElement */] extends StObject {
    
    var defaultComponent: D
    
    var props: P & ChildrenSx
  }
  object CardCoverTypeMap {
    
    inline def apply[P, D /* <: ReactElement */](defaultComponent: D, props: P & ChildrenSx): CardCoverTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[CardCoverTypeMap[P, D]]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: CardCoverTypeMap[?, ?], P, D /* <: ReactElement */] (val x: Self & (CardCoverTypeMap[P, D])) extends AnyVal {
