...
object modalModalPropsMod {
  ...
  type ModalProps[D /* <: ReactElement */, P] = OverrideProps[ModalTypeMap[P, D], D]
  ...
  object ModalSlots {
    ...
    inline def apply(backdrop: ReactElement, root: ReactElement): ModalSlots = {
  ...
  trait ModalTypeMap[P, D /* <: ReactElement */] extends StObject {
  ...
  object ModalTypeMap {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: ModalTypeMap[?, ?], P, D /* <: ReactElement */] (val x: Self & (ModalTypeMap[P, D])) extends AnyVal {
