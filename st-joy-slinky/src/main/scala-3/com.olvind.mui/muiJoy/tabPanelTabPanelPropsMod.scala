...
object tabPanelTabPanelPropsMod {
  
  /* Inlined parent @mui/joy.@mui/joy/TabPanel/TabPanelProps.TabPanelProps<@mui/joy.@mui/joy/TabPanel/TabPanelProps.TabPanelTypeMap<{}, 'div'>['defaultComponent'], {  component :react.react.ElementType<any> | undefined}> */
  trait TabPanelOwnerState extends StObject {
  ...
  object TabPanelOwnerState {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: TabPanelOwnerState] (val x: Self) extends AnyVal {
  ...
  type TabPanelProps[D /* <: ReactElement */, P] = OverrideProps[TabPanelTypeMap[P, D], D]
  
  trait TabPanelPropsSizeOverrides extends StObject
  
  type TabPanelSlot = "root"
  
  trait TabPanelTypeMap[P, D /* <: ReactElement */] extends StObject {
  ...
  object TabPanelTypeMap {
    ...
    inline def apply[P, D /* <: ReactElement */](defaultComponent: D, props: P & OmitTabPanelUnstyledOwnPropsvalueslotssl & SxValue): TabPanelTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[TabPanelTypeMap[P, D]]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: TabPanelTypeMap[?, ?], P, D /* <: ReactElement */] (val x: Self & (TabPanelTypeMap[P, D])) extends AnyVal {
