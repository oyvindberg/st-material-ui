...
import com.olvind.mui.muiJoy.anon.DefaultValue
...
object radioGroupRadioGroupPropsMod {
  
  /* Inlined parent @mui/joy.@mui/joy/RadioGroup/RadioGroupProps.RadioGroupProps<@mui/joy.@mui/joy/RadioGroup/RadioGroupProps.RadioGroupTypeMap<{}, 'div'>['defaultComponent'], {  component :react.react.ElementType<any> | undefined}> */
  trait RadioGroupOwnerState extends StObject {
  ...
  object RadioGroupOwnerState {
    
    inline def apply(): RadioGroupOwnerState = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[RadioGroupOwnerState]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: RadioGroupOwnerState] (val x: Self) extends AnyVal {
  ...
  type RadioGroupProps[D /* <: ReactElement */, P] = OverrideProps[RadioGroupTypeMap[P, D], D]
  
  type RadioGroupSlot = "root"
  
  trait RadioGroupTypeMap[P, D /* <: ReactElement */] extends StObject {
    
    var defaultComponent: D
    
    var props: P & DefaultValue
  }
  object RadioGroupTypeMap {
    
    inline def apply[P, D /* <: ReactElement */](defaultComponent: D, props: P & DefaultValue): RadioGroupTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[RadioGroupTypeMap[P, D]]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: RadioGroupTypeMap[?, ?], P, D /* <: ReactElement */] (val x: Self & (RadioGroupTypeMap[P, D])) extends AnyVal {
      
      inline def setDefaultComponent(value: D): Self = StObject.set(x, "defaultComponent", value.asInstanceOf[js.Any])
      
      inline def setProps(value: P & DefaultValue): Self = StObject.set(x, "props", value.asInstanceOf[js.Any])
    }
  }
}
