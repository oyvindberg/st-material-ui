...
import com.olvind.mui.muiJoy.anon.FallbackImg
...
object avatarAvatarPropsMod {
  ...
  /* Inlined parent @mui/joy.@mui/joy/Avatar/AvatarProps.AvatarProps<@mui/joy.@mui/joy/Avatar/AvatarProps.AvatarTypeMap<{}, 'div'>['defaultComponent'], {  component :react.react.ElementType<any> | undefined}> */
  trait AvatarOwnerState extends StObject {
  ...
  type AvatarSlotsAndSlotProps = CreateSlotsAndSlotProps[AvatarSlot, FallbackImg]
  ...
  object AvatarTypeMap {
    ...
    inline def apply[P, D /* <: ReactElement */](defaultComponent: D, props: P & AvatarSlotsAndSlotProps & Alt): AvatarTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[AvatarTypeMap[P, D]]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: AvatarTypeMap[?, ?], P, D /* <: ReactElement */] (val x: Self & (AvatarTypeMap[P, D])) extends AnyVal {
