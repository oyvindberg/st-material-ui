...
object circularProgressCircularProgressPropsMod {
  ...
  object CircularProgressSlots {
    ...
    inline def apply(progress: ReactElement, root: ReactElement, svg: ReactElement, track: ReactElement): CircularProgressSlots = {
