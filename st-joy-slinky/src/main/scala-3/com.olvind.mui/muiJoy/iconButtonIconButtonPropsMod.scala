...
object iconButtonIconButtonPropsMod {
  ...
  /* Inlined parent @mui/joy.@mui/joy/IconButton/IconButtonProps.IconButtonProps<@mui/joy.@mui/joy/IconButton/IconButtonProps.IconButtonTypeMap<{}, 'button'>['defaultComponent'], {  component :react.react.ElementType<any> | undefined}> */
  trait IconButtonOwnerState extends StObject {
