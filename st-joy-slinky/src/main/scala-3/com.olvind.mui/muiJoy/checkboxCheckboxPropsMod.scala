...
import com.olvind.mui.muiBase.switchUnstyledUseSwitchDottypesMod.UseSwitchParameters
import com.olvind.mui.muiJoy.anon.ActionCheckbox
import com.olvind.mui.muiJoy.anon.Checkbox
...
object checkboxCheckboxPropsMod {
  ...
  /* Inlined parent @mui/joy.@mui/joy/Checkbox/CheckboxProps.CheckboxProps<@mui/joy.@mui/joy/Checkbox/CheckboxProps.CheckboxTypeMap<{}, 'span'>['defaultComponent'], {  component :react.react.ElementType<any> | undefined}> */
  trait CheckboxOwnerState extends StObject {
    ...
    var slots: js.UndefOr[Checkbox] = js.undefined
  ...
  object CheckboxOwnerState {
    ...
    implicit open class MutableBuilder[Self <: CheckboxOwnerState] (val x: Self) extends AnyVal {
      ...
      inline def setSlots(value: Checkbox): Self = StObject.set(x, "slots", value.asInstanceOf[js.Any])
  ...
  type CheckboxProps[D /* <: ReactElement */, P] = OverrideProps[CheckboxTypeMap[P, D], D]
  ...
  type CheckboxSlotsAndSlotProps = CreateSlotsAndSlotProps[CheckboxSlot, ActionCheckbox]
  
  trait CheckboxTypeMap[P, D /* <: ReactElement */] extends StObject {
  ...
  object CheckboxTypeMap {
    ...
    inline def apply[P, D /* <: ReactElement */](defaultComponent: D, props: P & UseSwitchParameters & CheckboxSlotsAndSlotProps & CheckedIcon): CheckboxTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[CheckboxTypeMap[P, D]]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: CheckboxTypeMap[?, ?], P, D /* <: ReactElement */] (val x: Self & (CheckboxTypeMap[P, D])) extends AnyVal {
