...
object avatarAvatarMod extends Shortcut {
  ...
  type _To = js.Function1[/* props */ DefaultComponentPropsAvatarTypeMapdiv, Element | Null]
  
  /* This means you don't have to write `default`, but can instead just say `avatarAvatarMod.foo` */
  override def _to: js.Function1[/* props */ DefaultComponentPropsAvatarTypeMapdiv, Element | Null] = default
}
