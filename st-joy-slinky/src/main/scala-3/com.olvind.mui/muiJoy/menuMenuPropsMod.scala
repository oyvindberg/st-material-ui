...
object menuMenuPropsMod {
  ...
  /* Inlined parent @mui/joy.@mui/joy/Menu/MenuProps.MenuProps<@mui/joy.@mui/joy/Menu/MenuProps.MenuTypeMap<{}, 'ul'>['defaultComponent'], {}> */
  trait MenuOwnerState extends StObject {
  ...
  object MenuOwnerState {
    
    inline def apply(): MenuOwnerState = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[MenuOwnerState]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: MenuOwnerState] (val x: Self) extends AnyVal {
  ...
  trait MenuTypeMap[P, D /* <: ReactElement */] extends StObject {
    ...
    var props: P & OmitPopperUnstyledPropsdivchildrenopen & Actions
  }
  object MenuTypeMap {
    
    inline def apply[P, D /* <: ReactElement */](defaultComponent: D, props: P & OmitPopperUnstyledPropsdivchildrenopen & Actions): MenuTypeMap[P, D] = {
    ...
    implicit open class MutableBuilder[Self <: MenuTypeMap[?, ?], P, D /* <: ReactElement */] (val x: Self & (MenuTypeMap[P, D])) extends AnyVal {
      ...
      inline def setProps(value: P & OmitPopperUnstyledPropsdivchildrenopen & Actions): Self = StObject.set(x, "props", value.asInstanceOf[js.Any])
    }
  }
}
