...
object tabTabPropsMod {
  ...
  trait TabTypeMap[P, D /* <: ReactElement */] extends StObject {
  ...
  object TabTypeMap {
    ...
    inline def apply[P, D /* <: ReactElement */](defaultComponent: D, props: P & OnChange): TabTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[TabTypeMap[P, D]]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: TabTypeMap[?, ?], P, D /* <: ReactElement */] (val x: Self & (TabTypeMap[P, D])) extends AnyVal {
