...
object modalCloseModalClosePropsMod {
  ...
  /* Inlined parent @mui/joy.@mui/joy/ModalClose/ModalCloseProps.ModalCloseProps<@mui/joy.@mui/joy/ModalClose/ModalCloseProps.ModalCloseTypeMap<{}, 'button'>['defaultComponent'], {  component :react.react.ElementType<any> | undefined}> */
  trait ModalCloseOwnerState extends StObject {
