...
import com.olvind.mui.muiJoy.anon.ActionIcon
...
object radioRadioPropsMod {
  ...
  /* Inlined parent @mui/joy.@mui/joy/Radio/RadioProps.RadioProps<@mui/joy.@mui/joy/Radio/RadioProps.RadioTypeMap<{}, 'span'>['defaultComponent'], {  component :react.react.ElementType<any> | undefined}> */
  trait RadioOwnerState extends StObject {
    ...
    var slotProps: js.UndefOr[Radio] = js.undefined
    
    var slots: js.UndefOr[Icon] = js.undefined
  ...
  object RadioOwnerState {
    ...
    implicit open class MutableBuilder[Self <: RadioOwnerState] (val x: Self) extends AnyVal {
      ...
      inline def setSlotProps(value: Radio): Self = StObject.set(x, "slotProps", value.asInstanceOf[js.Any])
      
      inline def setSlotPropsUndefined: Self = StObject.set(x, "slotProps", js.undefined)
      
      inline def setSlotUndefined: Self = StObject.set(x, "slot", js.undefined)
      
      inline def setSlots(value: Icon): Self = StObject.set(x, "slots", value.asInstanceOf[js.Any])
  ...
  type RadioSlotsAndSlotProps = CreateSlotsAndSlotProps[RadioSlot, ActionIcon]
