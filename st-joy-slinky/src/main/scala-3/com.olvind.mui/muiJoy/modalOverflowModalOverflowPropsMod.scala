...
object modalOverflowModalOverflowPropsMod {
  
  /* Inlined parent @mui/joy.@mui/joy/ModalOverflow/ModalOverflowProps.ModalOverflowProps<@mui/joy.@mui/joy/ModalOverflow/ModalOverflowProps.ModalOverflowTypeMap<{}, 'div'>['defaultComponent'], {  component :react.react.ElementType<any> | undefined}> */
  trait ModalOverflowOwnerState extends StObject {
  ...
  object ModalOverflowOwnerState {
    
    inline def apply(): ModalOverflowOwnerState = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[ModalOverflowOwnerState]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: ModalOverflowOwnerState] (val x: Self) extends AnyVal {
  ...
  type ModalOverflowProps[D /* <: ReactElement */, P] = OverrideProps[ModalOverflowTypeMap[P, D], D]
  
  type ModalOverflowSlot = "root"
  
  trait ModalOverflowTypeMap[P, D /* <: ReactElement */] extends StObject {
    
    var defaultComponent: D
    
    var props: P & `0`
  }
  object ModalOverflowTypeMap {
    
    inline def apply[P, D /* <: ReactElement */](defaultComponent: D, props: P & `0`): ModalOverflowTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[ModalOverflowTypeMap[P, D]]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: ModalOverflowTypeMap[?, ?], P, D /* <: ReactElement */] (val x: Self & (ModalOverflowTypeMap[P, D])) extends AnyVal {
