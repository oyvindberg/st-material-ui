...
object tooltipTooltipPropsMod {
  ...
  object TooltipOwnerState {
    ...
    inline def apply(children: ReactElement, title: ReactElement, touch: Boolean): TooltipOwnerState = {
      val __obj = js.Dynamic.literal(children = children.asInstanceOf[js.Any], title = title.asInstanceOf[js.Any], touch = touch.asInstanceOf[js.Any])
