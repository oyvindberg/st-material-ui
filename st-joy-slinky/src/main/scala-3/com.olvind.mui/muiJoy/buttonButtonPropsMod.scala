...
import com.olvind.mui.muiJoy.anon.LoadingIndicatorCenterRoot
...
object buttonButtonPropsMod {
  ...
  /* Inlined parent std.Omit<@mui/joy.@mui/joy/Button/ButtonProps.ButtonProps<@mui/joy.@mui/joy/Button/ButtonProps.ButtonTypeMap<{}, 'button'>['defaultComponent'], {  component :react.react.ElementType<any> | undefined}>, 'color'> */
  trait ButtonOwnerState extends StObject {
    ...
    var color: js.UndefOr[
        (OverridableStringUnion[ColorPaletteProp, ButtonPropsColorOverrides]) | "context"
      ] = js.undefined
    ...
    var slotProps: js.UndefOr[RootStartDecorator] = js.undefined
  ...
  object ButtonOwnerState {
    ...
    implicit open class MutableBuilder[Self <: ButtonOwnerState] (val x: Self) extends AnyVal {
      ...
      inline def setColor(value: (OverridableStringUnion[ColorPaletteProp, ButtonPropsColorOverrides]) | "context"): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
      ...
      inline def setSlotProps(value: RootStartDecorator): Self = StObject.set(x, "slotProps", value.asInstanceOf[js.Any])
  ...
  type ButtonSlotsAndSlotProps = CreateSlotsAndSlotProps[ButtonSlot, LoadingIndicatorCenterRoot]
  
  trait ButtonTypeMap[P, D /* <: ReactElement */] extends StObject {
  ...
  object ButtonTypeMap {
    ...
    inline def apply[P, D /* <: ReactElement */](defaultComponent: D, props: P & ButtonSlotsAndSlotProps & Action): ButtonTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[ButtonTypeMap[P, D]]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: ButtonTypeMap[?, ?], P, D /* <: ReactElement */] (val x: Self & (ButtonTypeMap[P, D])) extends AnyVal {
