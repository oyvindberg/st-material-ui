...
object alertAlertPropsMod {
  ...
  /* Inlined parent @mui/joy.@mui/joy/Alert/AlertProps.AlertProps<@mui/joy.@mui/joy/Alert/AlertProps.AlertTypeMap<{}, 'div'>['defaultComponent'], {  component :react.react.ElementType<any> | undefined}> */
  trait AlertOwnerState extends StObject {
  ...
  object AlertOwnerState {
    
    inline def apply(): AlertOwnerState = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[AlertOwnerState]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: AlertOwnerState] (val x: Self) extends AnyVal {
  ...
  type AlertSlotsAndSlotProps = CreateSlotsAndSlotProps[AlertSlot, StartDecorator]
