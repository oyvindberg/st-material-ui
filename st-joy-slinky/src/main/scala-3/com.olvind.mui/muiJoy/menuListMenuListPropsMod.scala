...
object menuListMenuListPropsMod {
  ...
  /* Inlined parent @mui/joy.@mui/joy/MenuList/MenuListProps.MenuListProps<@mui/joy.@mui/joy/MenuList/MenuListProps.MenuListTypeMap<{}, 'ul'>['defaultComponent'], {  component :react.react.ElementType<any> | undefined}> */
  trait MenuListOwnerState extends StObject {
  ...
  object MenuListOwnerState {
    
    inline def apply(): MenuListOwnerState = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[MenuListOwnerState]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: MenuListOwnerState] (val x: Self) extends AnyVal {
